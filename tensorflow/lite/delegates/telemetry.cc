...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPStelemetryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPStelemetryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPStelemetryDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ReportDelegateSettings(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPStelemetryDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/telemetry.cc", "ReportDelegateSettings");
...
TfLiteStatus ReportDelegateStatus(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPStelemetryDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/delegates/telemetry.cc", "ReportDelegateStatus");
