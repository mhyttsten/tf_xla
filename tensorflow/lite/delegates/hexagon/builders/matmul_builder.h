...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmatmul_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmatmul_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmatmul_builderDTh() {
      // Check if tracing is enabled
...
class MatMulWithConstWeightsOpBuilder : public OpBuilder {
 public:
  explicit MatMulWithConstWeightsOpBuilder(GraphBuilder* graph_builder,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmatmul_builderDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/hexagon/builders/matmul_builder.h", "MatMulWithConstWeightsOpBuilder");
}
...
class MatMulOpBuilder : public OpBuilder {
 public:
  explicit MatMulOpBuilder(GraphBuilder* graph_builder, int op_type)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmatmul_builderDTh mht_1(mht_1_v, 222, "", "./tensorflow/lite/delegates/hexagon/builders/matmul_builder.h", "MatMulOpBuilder");
}
  TfLiteStatus PopulateSubGraph(const TfLiteIntArray* inputs,
                                const TfLiteIntArray* outputs,
                                TfLiteContext* context) override;
