...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ArgMinMaxOpBuilder::PopulateSubGraph(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/hexagon/builders/arg_min_max_builder.cc", "ArgMinMaxOpBuilder::PopulateSubGraph");
...
TfLiteStatus ArgMinMaxOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc mht_1(mht_1_v, 247, "", "./tensorflow/lite/delegates/hexagon/builders/arg_min_max_builder.cc", "ArgMinMaxOpBuilder::RegisterOutputs");
...
ArgMinMaxOpBuilder::~ArgMinMaxOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc mht_2(mht_2_v, 257, "", "./tensorflow/lite/delegates/hexagon/builders/arg_min_max_builder.cc", "ArgMinMaxOpBuilder::~ArgMinMaxOpBuilder");
}

OpBuilder* CreateArgMinMaxOpBuilder(GraphBuilder* graph_builder, int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarg_min_max_builderDTcc mht_3(mht_3_v, 262, "", "./tensorflow/lite/delegates/hexagon/builders/arg_min_max_builder.cc", "CreateArgMinMaxOpBuilder");
