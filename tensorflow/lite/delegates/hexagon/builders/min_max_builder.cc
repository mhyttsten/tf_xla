...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmin_max_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmin_max_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmin_max_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus MinMaxOpBuilder::PopulateSubGraph(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmin_max_builderDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/delegates/hexagon/builders/min_max_builder.cc", "MinMaxOpBuilder::PopulateSubGraph");
...
TfLiteStatus MinMaxOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmin_max_builderDTcc mht_1(mht_1_v, 229, "", "./tensorflow/lite/delegates/hexagon/builders/min_max_builder.cc", "MinMaxOpBuilder::RegisterOutputs");
...
OpBuilder* CreateMinMaxBuilder(GraphBuilder* graph_builder, int op_type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmin_max_builderDTcc mht_2(mht_2_v, 240, "", "./tensorflow/lite/delegates/hexagon/builders/min_max_builder.cc", "CreateMinMaxBuilder");
