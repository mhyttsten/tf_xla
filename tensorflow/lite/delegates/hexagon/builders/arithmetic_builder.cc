...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ArithmeticOpBuilder::PopulateSubGraph(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/hexagon/builders/arithmetic_builder.cc", "ArithmeticOpBuilder::PopulateSubGraph");
...
TfLiteStatus ArithmeticOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc mht_1(mht_1_v, 282, "", "./tensorflow/lite/delegates/hexagon/builders/arithmetic_builder.cc", "ArithmeticOpBuilder::RegisterOutputs");
...
ArithmeticOpBuilder::~ArithmeticOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc mht_2(mht_2_v, 292, "", "./tensorflow/lite/delegates/hexagon/builders/arithmetic_builder.cc", "ArithmeticOpBuilder::~ArithmeticOpBuilder");
}

OpBuilder* CreateArithmeticBuilder(GraphBuilder* graph_builder, int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSarithmetic_builderDTcc mht_3(mht_3_v, 297, "", "./tensorflow/lite/delegates/hexagon/builders/arithmetic_builder.cc", "CreateArithmeticBuilder");
