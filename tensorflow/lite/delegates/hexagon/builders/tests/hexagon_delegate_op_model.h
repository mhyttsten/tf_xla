...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPShexagon_delegate_op_modelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPShexagon_delegate_op_modelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPShexagon_delegate_op_modelDTh() {
      // Check if tracing is enabled
...
class SingleOpModelWithHexagon : public SingleOpModel {
 public:
  SingleOpModelWithHexagon() : delegate_(nullptr, [](TfLiteDelegate*) {}) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPShexagon_delegate_op_modelDTh mht_0(mht_0_v, 204, "", "./tensorflow/lite/delegates/hexagon/builders/tests/hexagon_delegate_op_model.h", "SingleOpModelWithHexagon");
}

  void ApplyDelegateAndInvoke() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPShexagon_delegate_op_modelDTh mht_1(mht_1_v, 209, "", "./tensorflow/lite/delegates/hexagon/builders/tests/hexagon_delegate_op_model.h", "ApplyDelegateAndInvoke");
