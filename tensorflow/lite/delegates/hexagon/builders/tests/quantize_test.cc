...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSquantize_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSquantize_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSquantize_testDTcc() {
      // Check if tracing is enabled
...
class QuantizeOpModel : public SingleOpModelWithHexagon {
 public:
  explicit QuantizeOpModel(const TensorData& input, const TensorData& output) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSquantize_testDTcc mht_0(mht_0_v, 192, "", "./tensorflow/lite/delegates/hexagon/builders/tests/quantize_test.cc", "QuantizeOpModel");
  ...
  void SetInput(const std::vector<float>& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSquantize_testDTcc mht_1(mht_1_v, 204, "", "./tensorflow/lite/delegates/hexagon/builders/tests/quantize_test.cc", "SetInput");
