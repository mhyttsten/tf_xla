...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc() {
      // Check if tracing is enabled
...
class SquaredDifferenceOpModel : public SingleOpModelWithHexagon {
 public:
  SquaredDifferenceOpModel(const TensorData& input1, const TensorData& input2,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/delegates/hexagon/builders/tests/squared_difference_test.cc", "SquaredDifferenceOpModel");
  ...
  int input1() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/lite/delegates/hexagon/builders/tests/squared_difference_test.cc", "input1");
 return input1_; }
  int input2() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc mht_2(mht_2_v, 210, "", "./tensorflow/lite/delegates/hexagon/builders/tests/squared_difference_test.cc", "input2");
 return input2_; }
...
float GetTolerance(int min, int max) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsquared_difference_testDTcc mht_3(mht_3_v, 227, "", "./tensorflow/lite/delegates/hexagon/builders/tests/squared_difference_test.cc", "GetTolerance");
