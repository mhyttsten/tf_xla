...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSl2_norm_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSl2_norm_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSl2_norm_testDTcc() {
      // Check if tracing is enabled
...
class L2NormOpModel : public SingleOpModelWithHexagon {
 public:
  L2NormOpModel(const std::initializer_list<int> input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSl2_norm_testDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/delegates/hexagon/builders/tests/l2_norm_test.cc", "L2NormOpModel");
  ...
  void SetInput(std::initializer_list<float> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSl2_norm_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/lite/delegates/hexagon/builders/tests/l2_norm_test.cc", "SetInput");
  ...
  int input() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSl2_norm_testDTcc mht_2(mht_2_v, 232, "", "./tensorflow/lite/delegates/hexagon/builders/tests/l2_norm_test.cc", "input");
 return input_; }
