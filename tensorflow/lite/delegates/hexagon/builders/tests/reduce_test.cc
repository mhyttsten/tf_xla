...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSreduce_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSreduce_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSreduce_testDTcc() {
      // Check if tracing is enabled
...
class ReduceOpModel : public SingleOpModelWithHexagon {
 public:
  ReduceOpModel(BuiltinOperator type, const TensorData& input,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSreduce_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/hexagon/builders/tests/reduce_test.cc", "ReduceOpModel");
  ...
  int Input() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSreduce_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/lite/delegates/hexagon/builders/tests/reduce_test.cc", "Input");
 return input_; }
