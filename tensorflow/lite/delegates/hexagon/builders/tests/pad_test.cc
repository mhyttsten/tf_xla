...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSpad_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSpad_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSpad_testDTcc() {
      // Check if tracing is enabled
...
class PadOpConstModel : public SingleOpModelWithHexagon {
 public:
  PadOpConstModel(const TensorData& input,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSpad_testDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/delegates/hexagon/builders/tests/pad_test.cc", "PadOpConstModel");
  ...
  void SetQuantizedInput(std::initializer_list<float> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSpad_testDTcc mht_1(mht_1_v, 209, "", "./tensorflow/lite/delegates/hexagon/builders/tests/pad_test.cc", "SetQuantizedInput");
  ...
  void SetPaddings(std::initializer_list<int> paddings) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSpad_testDTcc mht_2(mht_2_v, 216, "", "./tensorflow/lite/delegates/hexagon/builders/tests/pad_test.cc", "SetPaddings");
