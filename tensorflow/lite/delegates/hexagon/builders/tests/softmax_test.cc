...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsoftmax_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsoftmax_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsoftmax_testDTcc() {
      // Check if tracing is enabled
...
class SoftmaxOpModel : public SingleOpModelWithHexagon {
 public:
  SoftmaxOpModel(float softmax_beta, const TensorData& input) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsoftmax_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/lite/delegates/hexagon/builders/tests/softmax_test.cc", "SoftmaxOpModel");
  ...
  void SetInput(const std::vector<float>& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStestsPSsoftmax_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/lite/delegates/hexagon/builders/tests/softmax_test.cc", "SetInput");
