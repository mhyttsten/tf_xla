...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStranspose_conv_2d_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStranspose_conv_2d_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStranspose_conv_2d_builderDTh() {
      // Check if tracing is enabled
...
class TransposeConv2dOpBuilder : public OpBuilder {
 public:
  explicit TransposeConv2dOpBuilder(GraphBuilder* graph_builder, int op_type)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPStranspose_conv_2d_builderDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/delegates/hexagon/builders/transpose_conv_2d_builder.h", "TransposeConv2dOpBuilder");
}
