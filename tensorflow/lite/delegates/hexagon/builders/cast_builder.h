...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPScast_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPScast_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPScast_builderDTh() {
      // Check if tracing is enabled
...
class CastOpBuilder : public OpBuilder {
 public:
  explicit CastOpBuilder(GraphBuilder* graph_builder, int op_type)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPScast_builderDTh mht_0(mht_0_v, 202, "", "./tensorflow/lite/delegates/hexagon/builders/cast_builder.h", "CastOpBuilder");
}
