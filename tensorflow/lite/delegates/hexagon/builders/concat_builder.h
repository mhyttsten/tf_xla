...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTh() {
      // Check if tracing is enabled
...
class ConcatOpBuilder : public OpBuilder {
 public:
  explicit ConcatOpBuilder(GraphBuilder* graph_builder, int op_type)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTh mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/hexagon/builders/concat_builder.h", "ConcatOpBuilder");
}
