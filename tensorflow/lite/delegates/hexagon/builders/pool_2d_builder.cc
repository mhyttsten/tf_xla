...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Pool2dOpBuilder::PopulateSubGraph(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/hexagon/builders/pool_2d_builder.cc", "Pool2dOpBuilder::PopulateSubGraph");
...
TfLiteStatus Pool2dOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc mht_1(mht_1_v, 280, "", "./tensorflow/lite/delegates/hexagon/builders/pool_2d_builder.cc", "Pool2dOpBuilder::RegisterOutputs");
...
Pool2dOpBuilder::~Pool2dOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc mht_2(mht_2_v, 291, "", "./tensorflow/lite/delegates/hexagon/builders/pool_2d_builder.cc", "Pool2dOpBuilder::~Pool2dOpBuilder");
}

OpBuilder* CreatePool2DBuilder(GraphBuilder* graph_builder, int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTcc mht_3(mht_3_v, 296, "", "./tensorflow/lite/delegates/hexagon/builders/pool_2d_builder.cc", "CreatePool2DBuilder");
