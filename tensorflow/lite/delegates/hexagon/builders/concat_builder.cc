...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ConcatOpBuilder::PopulateSubGraph(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/delegates/hexagon/builders/concat_builder.cc", "ConcatOpBuilder::PopulateSubGraph");
...
TfLiteStatus ConcatOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc mht_1(mht_1_v, 301, "", "./tensorflow/lite/delegates/hexagon/builders/concat_builder.cc", "ConcatOpBuilder::RegisterOutputs");
...
ConcatOpBuilder::~ConcatOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc mht_2(mht_2_v, 311, "", "./tensorflow/lite/delegates/hexagon/builders/concat_builder.cc", "ConcatOpBuilder::~ConcatOpBuilder");
}

OpBuilder* CreateConcatBuilder(GraphBuilder* graph_builder, int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSconcat_builderDTcc mht_3(mht_3_v, 316, "", "./tensorflow/lite/delegates/hexagon/builders/concat_builder.cc", "CreateConcatBuilder");
