...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTh() {
      // Check if tracing is enabled
...
class Pool2dOpBuilder : public OpBuilder {
 public:
  explicit Pool2dOpBuilder(GraphBuilder* graph_builder, int op_type)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpool_2d_builderDTh mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/hexagon/builders/pool_2d_builder.h", "Pool2dOpBuilder");
}
