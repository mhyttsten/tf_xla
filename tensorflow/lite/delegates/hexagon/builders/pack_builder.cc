...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc() {
      // Check if tracing is enabled
...
int GetAxis(int axis, const TfLiteIntArray* inputs, TfLiteContext* context) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/hexagon/builders/pack_builder.cc", "GetAxis");
...
TfLiteStatus PackOpBuilder::PopulateSubGraph(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc mht_1(mht_1_v, 215, "", "./tensorflow/lite/delegates/hexagon/builders/pack_builder.cc", "PackOpBuilder::PopulateSubGraph");
...
TfLiteStatus PackOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc mht_2(mht_2_v, 295, "", "./tensorflow/lite/delegates/hexagon/builders/pack_builder.cc", "PackOpBuilder::RegisterOutputs");
...
OpBuilder* CreatePackBuilder(GraphBuilder* graph_builder, int op_type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSpack_builderDTcc mht_3(mht_3_v, 305, "", "./tensorflow/lite/delegates/hexagon/builders/pack_builder.cc", "CreatePackBuilder");
