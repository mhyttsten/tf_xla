...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ResizeNearestNeighborOpBuilder::PopulateSubGraph(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/delegates/hexagon/builders/resize_nearest_neighbor_builder.cc", "ResizeNearestNeighborOpBuilder::PopulateSubGraph");
...
TfLiteStatus ResizeNearestNeighborOpBuilder::RegisterOutputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc mht_1(mht_1_v, 253, "", "./tensorflow/lite/delegates/hexagon/builders/resize_nearest_neighbor_builder.cc", "ResizeNearestNeighborOpBuilder::RegisterOutputs");
...
ResizeNearestNeighborOpBuilder::~ResizeNearestNeighborOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc mht_2(mht_2_v, 263, "", "./tensorflow/lite/delegates/hexagon/builders/resize_nearest_neighbor_builder.cc", "ResizeNearestNeighborOpBuilder::~ResizeNearestNeighborOpBuilder");
}

OpBuilder* CreateResizeNearestNeighborBuilder(GraphBuilder* graph_builder,
                                              int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_nearest_neighbor_builderDTcc mht_3(mht_3_v, 269, "", "./tensorflow/lite/delegates/hexagon/builders/resize_nearest_neighbor_builder.cc", "CreateResizeNearestNeighborBuilder");
