...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus MirrorPadOpBuilder::PopulateSubGraph(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/hexagon/builders/mirror_pad_builder.cc", "MirrorPadOpBuilder::PopulateSubGraph");
...
TfLiteStatus MirrorPadOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc mht_1(mht_1_v, 257, "", "./tensorflow/lite/delegates/hexagon/builders/mirror_pad_builder.cc", "MirrorPadOpBuilder::RegisterOutputs");
...
MirrorPadOpBuilder::~MirrorPadOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc mht_2(mht_2_v, 267, "", "./tensorflow/lite/delegates/hexagon/builders/mirror_pad_builder.cc", "MirrorPadOpBuilder::~MirrorPadOpBuilder");
}

OpBuilder* CreateMirrorPadBuilder(GraphBuilder* graph_builder, int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSmirror_pad_builderDTcc mht_3(mht_3_v, 272, "", "./tensorflow/lite/delegates/hexagon/builders/mirror_pad_builder.cc", "CreateMirrorPadBuilder");
