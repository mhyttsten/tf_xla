...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ResizeBilinearOpBuilder::PopulateSubGraph(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/delegates/hexagon/builders/resize_bilinear_builder.cc", "ResizeBilinearOpBuilder::PopulateSubGraph");
...
TfLiteStatus ResizeBilinearOpBuilder::RegisterOutputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc mht_1(mht_1_v, 254, "", "./tensorflow/lite/delegates/hexagon/builders/resize_bilinear_builder.cc", "ResizeBilinearOpBuilder::RegisterOutputs");
...
ResizeBilinearOpBuilder::~ResizeBilinearOpBuilder() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc mht_2(mht_2_v, 264, "", "./tensorflow/lite/delegates/hexagon/builders/resize_bilinear_builder.cc", "ResizeBilinearOpBuilder::~ResizeBilinearOpBuilder");
}

OpBuilder* CreateResizeBilinearOpBuilder(GraphBuilder* graph_builder,
                                         int op_type) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPSbuildersPSresize_bilinear_builderDTcc mht_3(mht_3_v, 270, "", "./tensorflow/lite/delegates/hexagon/builders/resize_bilinear_builder.cc", "CreateResizeBilinearOpBuilder");
