...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_implementationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_implementationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_implementationDTcc() {
      // Check if tracing is enabled
...
void* LoadFunction(void* dl_handle, const char* name) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_implementationDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/hexagon/hexagon_implementation.cc", "LoadFunction");
...
HexagonNN CreateNewHexagonInterface() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_implementationDTcc mht_1(mht_1_v, 219, "", "./tensorflow/lite/delegates/hexagon/hexagon_implementation.cc", "CreateNewHexagonInterface");
...
const HexagonNN* HexagonNNImplementation() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_implementationDTcc mht_2(mht_2_v, 263, "", "./tensorflow/lite/delegates/hexagon/hexagon_implementation.cc", "HexagonNNImplementation");
