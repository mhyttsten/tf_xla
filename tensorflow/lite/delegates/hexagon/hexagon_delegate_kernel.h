...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_delegate_kernelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_delegate_kernelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_delegate_kernelDTh() {
      // Check if tracing is enabled
...
class HexagonDelegateKernel : public SimpleDelegateKernelInterface {
 public:
  explicit HexagonDelegateKernel(const ::TfLiteHexagonDelegateOptions& params)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPShexagonPShexagon_delegate_kernelDTh mht_0(mht_0_v, 214, "", "./tensorflow/lite/delegates/hexagon/hexagon_delegate_kernel.h", "HexagonDelegateKernel");
}
