...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSinterpreter_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSinterpreter_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSinterpreter_utilsDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus InterpreterUtils::InvokeWithCPUFallback(Interpreter* interpreter) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSinterpreter_utilsDTcc mht_0(mht_0_v, 189, "", "./tensorflow/lite/delegates/interpreter_utils.cc", "InterpreterUtils::InvokeWithCPUFallback");
