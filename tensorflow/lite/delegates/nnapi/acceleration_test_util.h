...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSnnapiPSacceleration_test_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSnnapiPSacceleration_test_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSnnapiPSacceleration_test_utilDTh() {
      // Check if tracing is enabled
...
class NnapiAccelerationTestParams {
 public:
  ...
  explicit NnapiAccelerationTestParams(int min_android_sdk_version)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSnnapiPSacceleration_test_utilDTh mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/nnapi/acceleration_test_util.h", "NnapiAccelerationTestParams");
};

  NnapiAccelerationTestParams()
      : min_android_sdk_version_{delegate::nnapi::kMinSdkVersionForNNAPI} {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSnnapiPSacceleration_test_utilDTh mht_1(mht_1_v, 209, "", "./tensorflow/lite/delegates/nnapi/acceleration_test_util.h", "NnapiAccelerationTestParams");
};

  // Minimum SDK version to apply the acceleration validation to.
  int MinAndroidSdkVersion() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSnnapiPSacceleration_test_utilDTh mht_2(mht_2_v, 215, "", "./tensorflow/lite/delegates/nnapi/acceleration_test_util.h", "MinAndroidSdkVersion");
 return min_android_sdk_version_; }
