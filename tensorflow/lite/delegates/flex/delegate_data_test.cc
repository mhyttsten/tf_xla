...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSdelegate_data_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSdelegate_data_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSdelegate_data_testDTcc() {
      // Check if tracing is enabled
...
TEST(DelegateDataTest, CheckFunctionDef) {
  ...
  auto select_subgraphs_to_register =
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSdelegate_data_testDTcc mht_0(mht_0_v, 239, "", "./tensorflow/lite/delegates/flex/delegate_data_test.cc", "lambda");
...
TEST(DelegateDataTest, CheckFunctionDefWithOnlyMainGraph) {
  ...
  auto select_subgraphs_to_register =
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSdelegate_data_testDTcc mht_1(mht_1_v, 387, "", "./tensorflow/lite/delegates/flex/delegate_data_test.cc", "lambda");
