...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc() {
      // Check if tracing is enabled
...
const std::set<std::string>& GetFlexAllowlist() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc mht_0(mht_0_v, 194, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops.cc", "GetFlexAllowlist");
...
const std::set<std::string>& GetTFTextFlexAllowlist() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc mht_1(mht_1_v, 951, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops.cc", "GetTFTextFlexAllowlist");
...
bool IsAllowedTFTextOpForFlex(const std::string& op_name) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc mht_2(mht_2_v, 985, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops.cc", "IsAllowedTFTextOpForFlex");
...
const std::set<std::string>& GetSentencePieceFlexAllowlist() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc mht_3(mht_3_v, 993, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops.cc", "GetSentencePieceFlexAllowlist");
...
bool IsAllowedSentencePieceOpForFlex(const std::string& op_name) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc mht_4(mht_4_v, 1014, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops.cc", "IsAllowedSentencePieceOpForFlex");
...
bool IsAllowlistedFlexOp(const std::string& tensorflow_op_name) {
   ...
   mht_5_v.push_back("tensorflow_op_name: \"" + tensorflow_op_name + "\"");
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_opsDTcc mht_5(mht_5_v, 1023, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops.cc", "IsAllowlistedFlexOp");
