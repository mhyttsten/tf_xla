...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc() {
      // Check if tracing is enabled
...
class TestFlexDelegate : public FlexDelegate {
 protected:
  bool IsNodeSupportedByDelegate(const TfLiteRegistration* registration,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/lite/delegates/flex/kernel_test.cc", "IsNodeSupportedByDelegate");
...
class KernelTest : public testing::FlexModelTest {
 public:
  ...
  KernelTest() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc mht_1(mht_1_v, 223, "", "./tensorflow/lite/delegates/flex/kernel_test.cc", "KernelTest");
 interpreter_.reset(new Interpreter(&error_reporter_)); }
  ...
  void ApplyFlexDelegate(std::unique_ptr<FlexDelegate> delegate = nullptr) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc mht_2(mht_2_v, 228, "", "./tensorflow/lite/delegates/flex/kernel_test.cc", "ApplyFlexDelegate");
...
class MultipleSubgraphsTest : public KernelTest {
 public:
  ...
  void PrepareInterpreter(const std::vector<float>& input) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc mht_3(mht_3_v, 507, "", "./tensorflow/lite/delegates/flex/kernel_test.cc", "PrepareInterpreter");
...
tensorflow::OpDef MakeOpDef(int num_inputs, int num_outputs) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc mht_4(mht_4_v, 631, "", "./tensorflow/lite/delegates/flex/kernel_test.cc", "MakeOpDef");
...
tensorflow::PartialTensorShape S(std::initializer_list<int64_t> dims) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSkernel_testDTcc mht_5(mht_5_v, 647, "", "./tensorflow/lite/delegates/flex/kernel_test.cc", "S");
