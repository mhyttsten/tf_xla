...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_ops_testDTcc() {
      // Check if tracing is enabled
...
std::set<std::string> GetAllCpuKernels() {
  auto is_cpu_kernel = [](const tensorflow::KernelDef& def) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSallowlisted_flex_ops_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/flex/allowlisted_flex_ops_test.cc", "lambda");
