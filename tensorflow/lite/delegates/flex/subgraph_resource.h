...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSsubgraph_resourceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSsubgraph_resourceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSsubgraph_resourceDTh() {
      // Check if tracing is enabled
...
class TFLiteSubgraphResource : public tensorflow::ResourceBase {
 public:
  explicit TFLiteSubgraphResource(Subgraph& subgraph, TfLiteDelegate* delegate)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSsubgraph_resourceDTh mht_0(mht_0_v, 204, "", "./tensorflow/lite/delegates/flex/subgraph_resource.h", "TFLiteSubgraphResource");
}
  ...
  std::string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSsubgraph_resourceDTh mht_1(mht_1_v, 216, "", "./tensorflow/lite/delegates/flex/subgraph_resource.h", "DebugString");
 return "TFLiteSubgraphResource"; }
  ...
  TfLiteDelegate* GetFlexDelegate() TF_EXCLUSIVE_LOCKS_REQUIRED(mutex_) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPSsubgraph_resourceDTh mht_2(mht_2_v, 233, "", "./tensorflow/lite/delegates/flex/subgraph_resource.h", "GetFlexDelegate");
