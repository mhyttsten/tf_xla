...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh() {
      // Check if tracing is enabled
...
class FlexModelTest : public ::testing::Test {
 public:
  FlexModelTest() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh mht_0(mht_0_v, 214, "", "./tensorflow/lite/delegates/flex/test_util.h", "FlexModelTest");
}
  ~FlexModelTest() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh mht_1(mht_1_v, 218, "", "./tensorflow/lite/delegates/flex/test_util.h", "~FlexModelTest");
}
  ...
  void SetTypedValues(int tensor_index, const std::vector<T>& values) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh mht_2(mht_2_v, 227, "", "./tensorflow/lite/delegates/flex/test_util.h", "SetTypedValues");
  ...
  void SetValues(int tensor_index, const std::vector<float>& values) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh mht_3(mht_3_v, 244, "", "./tensorflow/lite/delegates/flex/test_util.h", "SetValues");
  ...
  const TestErrorReporter& error_reporter() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSflexPStest_utilDTh mht_4(mht_4_v, 270, "", "./tensorflow/lite/delegates/flex/test_util.h", "error_reporter");
