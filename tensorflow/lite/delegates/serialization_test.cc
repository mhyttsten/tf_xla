...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc() {
      // Check if tracing is enabled
...
void EmptyReportError(TfLiteContext* context, const char* format, ...) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/delegates/serialization_test.cc", "EmptyReportError");
}
...
class SerializationTest : public ::testing::Test {
 protected:
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/lite/delegates/serialization_test.cc", "TearDown");
  ...
  std::string getSerializationDir() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc mht_2(mht_2_v, 215, "", "./tensorflow/lite/delegates/serialization_test.cc", "getSerializationDir");
  ...
  TfLiteContext GenerateTfLiteContext(int num_tensors) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc mht_3(mht_3_v, 227, "", "./tensorflow/lite/delegates/serialization_test.cc", "GenerateTfLiteContext");
  ...
  TfLiteDelegateParams GenerateTfLiteDelegateParams(int num_nodes,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSserialization_testDTcc mht_4(mht_4_v, 248, "", "./tensorflow/lite/delegates/serialization_test.cc", "GenerateTfLiteDelegateParams");
