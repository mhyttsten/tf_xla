...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSunary_elementwise_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSunary_elementwise_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSunary_elementwise_testerDTcc() {
      // Check if tracing is enabled
...
void UnaryElementwiseTester::Test(tflite::BuiltinOperator unary_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSunary_elementwise_testerDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/delegates/xnnpack/unary_elementwise_tester.cc", "UnaryElementwiseTester::Test");
...
std::vector<char> UnaryElementwiseTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSunary_elementwise_testerDTcc mht_1(mht_1_v, 300, "", "./tensorflow/lite/delegates/xnnpack/unary_elementwise_tester.cc", "UnaryElementwiseTester::CreateTfLiteModel");
...
int32_t UnaryElementwiseTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSunary_elementwise_testerDTcc mht_2(mht_2_v, 354, "", "./tensorflow/lite/delegates/xnnpack/unary_elementwise_tester.cc", "UnaryElementwiseTester::ComputeSize");
