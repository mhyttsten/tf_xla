...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_depthwise_conv_2d_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_depthwise_conv_2d_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_depthwise_conv_2d_testerDTcc() {
      // Check if tracing is enabled
...
void QuantizedDepthwiseConv2DTester::Test(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_depthwise_conv_2d_testerDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/delegates/xnnpack/quantized_depthwise_conv_2d_tester.cc", "QuantizedDepthwiseConv2DTester::Test");
...
void QuantizedDepthwiseConv2DTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_depthwise_conv_2d_testerDTcc mht_1(mht_1_v, 258, "", "./tensorflow/lite/delegates/xnnpack/quantized_depthwise_conv_2d_tester.cc", "QuantizedDepthwiseConv2DTester::Test");
...
std::vector<char> QuantizedDepthwiseConv2DTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_depthwise_conv_2d_testerDTcc mht_2(mht_2_v, 301, "", "./tensorflow/lite/delegates/xnnpack/quantized_depthwise_conv_2d_tester.cc", "QuantizedDepthwiseConv2DTester::CreateTfLiteModel");
