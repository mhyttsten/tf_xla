...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc() {
      // Check if tracing is enabled
...
void DequantizeTester::Test(Interpreter* delegate_interpreter,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/xnnpack/dequantize_tester.cc", "DequantizeTester::Test");
...
void DequantizeTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc mht_1(mht_1_v, 240, "", "./tensorflow/lite/delegates/xnnpack/dequantize_tester.cc", "DequantizeTester::Test");
...
std::vector<char> DequantizeTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc mht_2(mht_2_v, 283, "", "./tensorflow/lite/delegates/xnnpack/dequantize_tester.cc", "DequantizeTester::CreateTfLiteModel");
...
int32_t DequantizeTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSdequantize_testerDTcc mht_3(mht_3_v, 342, "", "./tensorflow/lite/delegates/xnnpack/dequantize_tester.cc", "DequantizeTester::ComputeSize");
