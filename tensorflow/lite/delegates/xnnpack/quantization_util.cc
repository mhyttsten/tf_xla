...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantization_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantization_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantization_utilDTcc() {
      // Check if tracing is enabled
...
void DequantizeFloat16(const uint16_t *packed_fp16_data,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantization_utilDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/xnnpack/quantization_util.cc", "DequantizeFloat16");
...
void DequantizeInt8(const int8_t *packed_s8_data, float *unpacked_fp32_data,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantization_utilDTcc mht_1(mht_1_v, 208, "", "./tensorflow/lite/delegates/xnnpack/quantization_util.cc", "DequantizeInt8");
...
void PerChannelDequantizeInt8(const int8_t* packed_s8_data,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantization_utilDTcc mht_2(mht_2_v, 223, "", "./tensorflow/lite/delegates/xnnpack/quantization_util.cc", "PerChannelDequantizeInt8");
