...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc() {
      // Check if tracing is enabled
...
std::vector<int32_t> FullyConnectedTester::OutputShape() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc mht_0(mht_0_v, 209, "", "./tensorflow/lite/delegates/xnnpack/fully_connected_tester.cc", "FullyConnectedTester::OutputShape");
...
void FullyConnectedTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/delegates/xnnpack/fully_connected_tester.cc", "FullyConnectedTester::Test");
...
std::vector<char> FullyConnectedTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc mht_2(mht_2_v, 291, "", "./tensorflow/lite/delegates/xnnpack/fully_connected_tester.cc", "FullyConnectedTester::CreateTfLiteModel");
...
int32_t FullyConnectedTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSfully_connected_testerDTcc mht_3(mht_3_v, 531, "", "./tensorflow/lite/delegates/xnnpack/fully_connected_tester.cc", "FullyConnectedTester::ComputeSize");
