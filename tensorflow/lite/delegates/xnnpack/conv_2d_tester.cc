...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSconv_2d_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSconv_2d_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSconv_2d_testerDTcc() {
      // Check if tracing is enabled
...
void Conv2DTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSconv_2d_testerDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/xnnpack/conv_2d_tester.cc", "Conv2DTester::Test");
...
std::vector<char> Conv2DTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSconv_2d_testerDTcc mht_1(mht_1_v, 288, "", "./tensorflow/lite/delegates/xnnpack/conv_2d_tester.cc", "Conv2DTester::CreateTfLiteModel");
