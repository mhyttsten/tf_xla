...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreduce_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreduce_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreduce_testerDTcc() {
      // Check if tracing is enabled
...
void ReduceTester::Test(tflite::BuiltinOperator reduce_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreduce_testerDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/delegates/xnnpack/reduce_tester.cc", "ReduceTester::Test");
...
std::vector<char> ReduceTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreduce_testerDTcc mht_1(mht_1_v, 276, "", "./tensorflow/lite/delegates/xnnpack/reduce_tester.cc", "ReduceTester::CreateTfLiteModel");
...
int32_t ReduceTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreduce_testerDTcc mht_2(mht_2_v, 344, "", "./tensorflow/lite/delegates/xnnpack/reduce_tester.cc", "ReduceTester::ComputeSize");
