...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc() {
      // Check if tracing is enabled
...
std::vector<int32_t> QuantizedBinaryElementwiseTester::OutputShape() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/quantized_binary_elementwise_tester.cc", "QuantizedBinaryElementwiseTester::OutputShape");
...
void QuantizedBinaryElementwiseTester::Test(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc mht_1(mht_1_v, 235, "", "./tensorflow/lite/delegates/xnnpack/quantized_binary_elementwise_tester.cc", "QuantizedBinaryElementwiseTester::Test");
...
void QuantizedBinaryElementwiseTester::Test(tflite::BuiltinOperator binary_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc mht_2(mht_2_v, 290, "", "./tensorflow/lite/delegates/xnnpack/quantized_binary_elementwise_tester.cc", "QuantizedBinaryElementwiseTester::Test");
...
std::vector<char> QuantizedBinaryElementwiseTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc mht_3(mht_3_v, 343, "", "./tensorflow/lite/delegates/xnnpack/quantized_binary_elementwise_tester.cc", "QuantizedBinaryElementwiseTester::CreateTfLiteModel");
...
int32_t QuantizedBinaryElementwiseTester::ComputeSize(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_binary_elementwise_testerDTcc mht_4(mht_4_v, 460, "", "./tensorflow/lite/delegates/xnnpack/quantized_binary_elementwise_tester.cc", "QuantizedBinaryElementwiseTester::ComputeSize");
