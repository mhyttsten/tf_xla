...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc() {
      // Check if tracing is enabled
...
std::vector<int32_t> QuantizedPadTester::OutputShape() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/quantized_pad_tester.cc", "QuantizedPadTester::OutputShape");
...
void QuantizedPadTester::Test(Interpreter* delegate_interpreter,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc mht_1(mht_1_v, 227, "", "./tensorflow/lite/delegates/xnnpack/quantized_pad_tester.cc", "QuantizedPadTester::Test");
...
void QuantizedPadTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc mht_2(mht_2_v, 258, "", "./tensorflow/lite/delegates/xnnpack/quantized_pad_tester.cc", "QuantizedPadTester::Test");
...
std::vector<char> QuantizedPadTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc mht_3(mht_3_v, 304, "", "./tensorflow/lite/delegates/xnnpack/quantized_pad_tester.cc", "QuantizedPadTester::CreateTfLiteModel");
...
int32_t QuantizedPadTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pad_testerDTcc mht_4(mht_4_v, 385, "", "./tensorflow/lite/delegates/xnnpack/quantized_pad_tester.cc", "QuantizedPadTester::ComputeSize");
