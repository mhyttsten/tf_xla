...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSsoftmax_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSsoftmax_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSsoftmax_testerDTcc() {
      // Check if tracing is enabled
...
void SoftmaxTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSsoftmax_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/softmax_tester.cc", "SoftmaxTester::Test");
...
std::vector<char> SoftmaxTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSsoftmax_testerDTcc mht_1(mht_1_v, 271, "", "./tensorflow/lite/delegates/xnnpack/softmax_tester.cc", "SoftmaxTester::CreateTfLiteModel");
...
int32_t SoftmaxTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSsoftmax_testerDTcc mht_2(mht_2_v, 329, "", "./tensorflow/lite/delegates/xnnpack/softmax_tester.cc", "SoftmaxTester::ComputeSize");
