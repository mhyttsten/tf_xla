...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pool_2d_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pool_2d_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pool_2d_testerDTcc() {
      // Check if tracing is enabled
...
void QuantizedPool2DTester::Test(tflite::BuiltinOperator pool_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pool_2d_testerDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/delegates/xnnpack/quantized_pool_2d_tester.cc", "QuantizedPool2DTester::Test");
...
void QuantizedPool2DTester::Test(tflite::BuiltinOperator pool_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pool_2d_testerDTcc mht_1(mht_1_v, 263, "", "./tensorflow/lite/delegates/xnnpack/quantized_pool_2d_tester.cc", "QuantizedPool2DTester::Test");
...
std::vector<char> QuantizedPool2DTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_pool_2d_testerDTcc mht_2(mht_2_v, 309, "", "./tensorflow/lite/delegates/xnnpack/quantized_pool_2d_tester.cc", "QuantizedPool2DTester::CreateTfLiteModel");
