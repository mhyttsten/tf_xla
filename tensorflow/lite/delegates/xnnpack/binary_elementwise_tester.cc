...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc() {
      // Check if tracing is enabled
...
std::vector<int32_t> BinaryElementwiseTester::OutputShape() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc mht_0(mht_0_v, 209, "", "./tensorflow/lite/delegates/xnnpack/binary_elementwise_tester.cc", "BinaryElementwiseTester::OutputShape");
...
void BinaryElementwiseTester::Test(tflite::BuiltinOperator binary_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc mht_1(mht_1_v, 237, "", "./tensorflow/lite/delegates/xnnpack/binary_elementwise_tester.cc", "BinaryElementwiseTester::Test");
...
std::vector<char> BinaryElementwiseTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc mht_2(mht_2_v, 354, "", "./tensorflow/lite/delegates/xnnpack/binary_elementwise_tester.cc", "BinaryElementwiseTester::CreateTfLiteModel");
...
int32_t BinaryElementwiseTester::ComputeSize(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSbinary_elementwise_testerDTcc mht_3(mht_3_v, 689, "", "./tensorflow/lite/delegates/xnnpack/binary_elementwise_tester.cc", "BinaryElementwiseTester::ComputeSize");
