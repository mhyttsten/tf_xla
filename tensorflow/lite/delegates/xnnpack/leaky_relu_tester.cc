...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSleaky_relu_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSleaky_relu_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSleaky_relu_testerDTcc() {
      // Check if tracing is enabled
...
void LeakyReluTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSleaky_relu_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/leaky_relu_tester.cc", "LeakyReluTester::Test");
...
std::vector<char> LeakyReluTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSleaky_relu_testerDTcc mht_1(mht_1_v, 269, "", "./tensorflow/lite/delegates/xnnpack/leaky_relu_tester.cc", "LeakyReluTester::CreateTfLiteModel");
...
int32_t LeakyReluTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSleaky_relu_testerDTcc mht_2(mht_2_v, 327, "", "./tensorflow/lite/delegates/xnnpack/leaky_relu_tester.cc", "LeakyReluTester::ComputeSize");
