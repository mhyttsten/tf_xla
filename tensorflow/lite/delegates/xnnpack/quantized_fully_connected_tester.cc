...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc() {
      // Check if tracing is enabled
...
std::vector<int32_t> QuantizedFullyConnectedTester::OutputShape() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/quantized_fully_connected_tester.cc", "QuantizedFullyConnectedTester::OutputShape");
...
void QuantizedFullyConnectedTester::Test(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc mht_1(mht_1_v, 225, "", "./tensorflow/lite/delegates/xnnpack/quantized_fully_connected_tester.cc", "QuantizedFullyConnectedTester::Test");
...
void QuantizedFullyConnectedTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc mht_2(mht_2_v, 257, "", "./tensorflow/lite/delegates/xnnpack/quantized_fully_connected_tester.cc", "QuantizedFullyConnectedTester::Test");
...
std::vector<char> QuantizedFullyConnectedTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc mht_3(mht_3_v, 300, "", "./tensorflow/lite/delegates/xnnpack/quantized_fully_connected_tester.cc", "QuantizedFullyConnectedTester::CreateTfLiteModel");
...
int32_t QuantizedFullyConnectedTester::ComputeSize(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_fully_connected_testerDTcc mht_4(mht_4_v, 422, "", "./tensorflow/lite/delegates/xnnpack/quantized_fully_connected_tester.cc", "QuantizedFullyConnectedTester::ComputeSize");
