...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc() {
      // Check if tracing is enabled
...
void QuantizeTester::Test(Interpreter* delegate_interpreter,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/xnnpack/quantize_tester.cc", "QuantizeTester::Test");
...
void QuantizeTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc mht_1(mht_1_v, 241, "", "./tensorflow/lite/delegates/xnnpack/quantize_tester.cc", "QuantizeTester::Test");
...
std::vector<char> QuantizeTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc mht_2(mht_2_v, 284, "", "./tensorflow/lite/delegates/xnnpack/quantize_tester.cc", "QuantizeTester::CreateTfLiteModel");
...
int32_t QuantizeTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantize_testerDTcc mht_3(mht_3_v, 343, "", "./tensorflow/lite/delegates/xnnpack/quantize_tester.cc", "QuantizeTester::ComputeSize");
