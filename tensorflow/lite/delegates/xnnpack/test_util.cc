...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc() {
      // Check if tracing is enabled
...
int8_t QuantizeInt8(float value, int32_t zero_point, float scale) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/xnnpack/test_util.cc", "QuantizeInt8");
...
void QuantizeInt8PerChannel(const float* scale, const int64_t* zero_point,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/delegates/xnnpack/test_util.cc", "QuantizeInt8PerChannel");
...
float GetInt8QuantizationScaleFromMinMax(float min, float max) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc mht_2(mht_2_v, 231, "", "./tensorflow/lite/delegates/xnnpack/test_util.cc", "GetInt8QuantizationScaleFromMinMax");
...
float GetInt8QuantizationScale(const std::vector<float>& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPStest_utilDTcc mht_3(mht_3_v, 247, "", "./tensorflow/lite/delegates/xnnpack/test_util.cc", "GetInt8QuantizationScale");
