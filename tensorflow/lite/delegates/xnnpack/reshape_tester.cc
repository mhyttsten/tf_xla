...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreshape_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreshape_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreshape_testerDTcc() {
      // Check if tracing is enabled
...
void ReshapeTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreshape_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/reshape_tester.cc", "ReshapeTester::Test");
...
std::vector<char> ReshapeTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreshape_testerDTcc mht_1(mht_1_v, 271, "", "./tensorflow/lite/delegates/xnnpack/reshape_tester.cc", "ReshapeTester::CreateTfLiteModel");
...
int32_t ReshapeTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSreshape_testerDTcc mht_2(mht_2_v, 354, "", "./tensorflow/lite/delegates/xnnpack/reshape_tester.cc", "ReshapeTester::ComputeSize");
