...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSresize_bilinear_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSresize_bilinear_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSresize_bilinear_testerDTcc() {
      // Check if tracing is enabled
...
void ResizeBilinearTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSresize_bilinear_testerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/xnnpack/resize_bilinear_tester.cc", "ResizeBilinearTester::Test");
...
std::vector<char> ResizeBilinearTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSresize_bilinear_testerDTcc mht_1(mht_1_v, 286, "", "./tensorflow/lite/delegates/xnnpack/resize_bilinear_tester.cc", "ResizeBilinearTester::CreateTfLiteModel");
