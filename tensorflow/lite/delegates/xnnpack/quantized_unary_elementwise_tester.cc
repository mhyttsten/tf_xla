...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc() {
      // Check if tracing is enabled
...
void QuantizedUnaryElementwiseTester::Test(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/xnnpack/quantized_unary_elementwise_tester.cc", "QuantizedUnaryElementwiseTester::Test");
...
void QuantizedUnaryElementwiseTester::Test(tflite::BuiltinOperator unary_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc mht_1(mht_1_v, 243, "", "./tensorflow/lite/delegates/xnnpack/quantized_unary_elementwise_tester.cc", "QuantizedUnaryElementwiseTester::Test");
...
std::vector<char> QuantizedUnaryElementwiseTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc mht_2(mht_2_v, 287, "", "./tensorflow/lite/delegates/xnnpack/quantized_unary_elementwise_tester.cc", "QuantizedUnaryElementwiseTester::CreateTfLiteModel");
...
int32_t QuantizedUnaryElementwiseTester::ComputeSize(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_unary_elementwise_testerDTcc mht_3(mht_3_v, 352, "", "./tensorflow/lite/delegates/xnnpack/quantized_unary_elementwise_tester.cc", "QuantizedUnaryElementwiseTester::ComputeSize");
