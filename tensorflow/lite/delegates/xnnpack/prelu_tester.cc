...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSprelu_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSprelu_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSprelu_testerDTcc() {
      // Check if tracing is enabled
...
void PreluTester::Test(TfLiteDelegate* delegate) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSprelu_testerDTcc mht_0(mht_0_v, 209, "", "./tensorflow/lite/delegates/xnnpack/prelu_tester.cc", "PreluTester::Test");
...
std::vector<char> PreluTester::CreateTfLiteModel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSprelu_testerDTcc mht_1(mht_1_v, 277, "", "./tensorflow/lite/delegates/xnnpack/prelu_tester.cc", "PreluTester::CreateTfLiteModel");
...
int32_t PreluTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSprelu_testerDTcc mht_2(mht_2_v, 463, "", "./tensorflow/lite/delegates/xnnpack/prelu_tester.cc", "PreluTester::ComputeSize");
