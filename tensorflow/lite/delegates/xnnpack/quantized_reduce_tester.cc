...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc() {
      // Check if tracing is enabled
...
void QuantizedReduceTester::Test(Interpreter* delegate_interpreter,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/xnnpack/quantized_reduce_tester.cc", "QuantizedReduceTester::Test");
...
void QuantizedReduceTester::Test(tflite::BuiltinOperator reduce_op,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc mht_1(mht_1_v, 245, "", "./tensorflow/lite/delegates/xnnpack/quantized_reduce_tester.cc", "QuantizedReduceTester::Test");
...
std::vector<char> QuantizedReduceTester::CreateTfLiteModel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc mht_2(mht_2_v, 289, "", "./tensorflow/lite/delegates/xnnpack/quantized_reduce_tester.cc", "QuantizedReduceTester::CreateTfLiteModel");
...
int32_t QuantizedReduceTester::ComputeSize(const std::vector<int32_t>& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSquantized_reduce_testerDTcc mht_3(mht_3_v, 367, "", "./tensorflow/lite/delegates/xnnpack/quantized_reduce_tester.cc", "QuantizedReduceTester::ComputeSize");
