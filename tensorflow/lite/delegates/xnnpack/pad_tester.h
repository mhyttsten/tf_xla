...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh() {
      // Check if tracing is enabled
...
class PadTester {
 public:
  ...
  inline PadTester& InputShape(std::initializer_list<int32_t> shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/xnnpack/pad_tester.h", "InputShape");
  ...
  inline const std::vector<int32_t>& InputShape() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh mht_1(mht_1_v, 214, "", "./tensorflow/lite/delegates/xnnpack/pad_tester.h", "InputShape");
 return input_shape_; }

  inline PadTester& InputPrePaddings(std::initializer_list<int32_t> paddings) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh mht_2(mht_2_v, 219, "", "./tensorflow/lite/delegates/xnnpack/pad_tester.h", "InputPrePaddings");
  ...
  inline PadTester& InputPostPaddings(std::initializer_list<int32_t> paddings) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSxnnpackPSpad_testerDTh mht_3(mht_3_v, 235, "", "./tensorflow/lite/delegates/xnnpack/pad_tester.h", "InputPostPaddings");
