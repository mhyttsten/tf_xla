...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc() {
      // Check if tracing is enabled
...
const std::string& MulOpBuilder::DebugName() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "MulOpBuilder::DebugName");
...
CoreML::Specification::NeuralNetworkLayer* MulOpBuilder::Build() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_1(mht_1_v, 207, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "MulOpBuilder::Build");
...
TfLiteStatus MulOpBuilder::PopulateSubgraph(TfLiteContext* context) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_2(mht_2_v, 226, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "MulOpBuilder::PopulateSubgraph");
...
TfLiteStatus MulOpBuilder::RegisterInputs(const TfLiteIntArray* inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_3(mht_3_v, 248, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "MulOpBuilder::RegisterInputs");
...
TfLiteStatus MulOpBuilder::RegisterOutputs(const TfLiteIntArray* outputs,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_4(mht_4_v, 274, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "MulOpBuilder::RegisterOutputs");
...
void MulOpBuilder::SetAlpha(float alpha) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_5(mht_5_v, 291, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "MulOpBuilder::SetAlpha");
 alpha_ = alpha; }

OpBuilder* CreateMulOpBuilder(GraphBuilder* graph_builder) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSmul_op_builderDTcc mht_6(mht_6_v, 296, "", "./tensorflow/lite/delegates/coreml/builders/mul_op_builder.cc", "CreateMulOpBuilder");
