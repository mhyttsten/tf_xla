...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc() {
      // Check if tracing is enabled
...
const std::string& ResizeBilinearOpBuilder::DebugName() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/coreml/builders/resize_bilinear_op_builder.cc", "ResizeBilinearOpBuilder::DebugName");
...
CoreML::Specification::NeuralNetworkLayer* ResizeBilinearOpBuilder::Build() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc mht_1(mht_1_v, 209, "", "./tensorflow/lite/delegates/coreml/builders/resize_bilinear_op_builder.cc", "ResizeBilinearOpBuilder::Build");
...
TfLiteStatus ResizeBilinearOpBuilder::RegisterInputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc mht_2(mht_2_v, 238, "", "./tensorflow/lite/delegates/coreml/builders/resize_bilinear_op_builder.cc", "ResizeBilinearOpBuilder::RegisterInputs");
...
TfLiteStatus ResizeBilinearOpBuilder::RegisterOutputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc mht_3(mht_3_v, 254, "", "./tensorflow/lite/delegates/coreml/builders/resize_bilinear_op_builder.cc", "ResizeBilinearOpBuilder::RegisterOutputs");
...
OpBuilder* CreateResizeBilinearOpBuilder(GraphBuilder* graph_builder) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc mht_4(mht_4_v, 266, "", "./tensorflow/lite/delegates/coreml/builders/resize_bilinear_op_builder.cc", "CreateResizeBilinearOpBuilder");
...
bool IsResizeBilinearOpSupported(const TfLiteRegistration* registration,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSresize_bilinear_op_builderDTcc mht_5(mht_5_v, 275, "", "./tensorflow/lite/delegates/coreml/builders/resize_bilinear_op_builder.cc", "IsResizeBilinearOpSupported");
