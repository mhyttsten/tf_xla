...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSreshape_op_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSreshape_op_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSreshape_op_builderDTh() {
      // Check if tracing is enabled
...
class ReshapeOpBuilder : public OpBuilder {
 public:
  explicit ReshapeOpBuilder(GraphBuilder* graph_builder)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSreshape_op_builderDTh mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/coreml/builders/reshape_op_builder.h", "ReshapeOpBuilder");
}
