...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSconvolution_op_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSconvolution_op_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSconvolution_op_builderDTh() {
      // Check if tracing is enabled
...
class ConvolutionOpBuilder : public OpBuilder {
 public:
  explicit ConvolutionOpBuilder(GraphBuilder* graph_builder,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSconvolution_op_builderDTh mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/coreml/builders/convolution_op_builder.h", "ConvolutionOpBuilder");
}
