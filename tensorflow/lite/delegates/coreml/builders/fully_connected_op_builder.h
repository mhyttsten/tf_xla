...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSfully_connected_op_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSfully_connected_op_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSfully_connected_op_builderDTh() {
      // Check if tracing is enabled
...
class FullyConnectedOpBuilder : public OpBuilder {
 public:
  explicit FullyConnectedOpBuilder(GraphBuilder* graph_builder)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSfully_connected_op_builderDTh mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/coreml/builders/fully_connected_op_builder.h", "FullyConnectedOpBuilder");
}
