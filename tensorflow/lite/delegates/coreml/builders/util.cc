...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSutilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSutilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSutilDTcc() {
      // Check if tracing is enabled
...
void Get4DShape(const TfLiteTensor* tensor, std::vector<int>* shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSutilDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/delegates/coreml/builders/util.cc", "Get4DShape");
...
bool IsBroadcastable(const TfLiteTensor* input_0, const TfLiteTensor* input_1) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSutilDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/delegates/coreml/builders/util.cc", "IsBroadcastable");
...
bool IsBinaryOpSupported(const TfLiteRegistration* registration,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSutilDTcc mht_2(mht_2_v, 255, "", "./tensorflow/lite/delegates/coreml/builders/util.cc", "IsBinaryOpSupported");
