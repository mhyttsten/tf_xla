...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSdummy_op_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSdummy_op_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSdummy_op_builderDTh() {
      // Check if tracing is enabled
...
class DummyOpBuilder : public OpBuilder {
 public:
  explicit DummyOpBuilder(GraphBuilder* graph_builder)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSdummy_op_builderDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/coreml/builders/dummy_op_builder.h", "DummyOpBuilder");
}
