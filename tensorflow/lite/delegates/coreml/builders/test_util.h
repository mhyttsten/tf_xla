...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPStest_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPStest_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPStest_utilDTh() {
      // Check if tracing is enabled
...
class SingleOpModelWithCoreMlDelegate : public tflite::SingleOpModel {
 public:
  ...
  tflite::Interpreter* interpreter() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPStest_utilDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/coreml/builders/test_util.h", "interpreter");
