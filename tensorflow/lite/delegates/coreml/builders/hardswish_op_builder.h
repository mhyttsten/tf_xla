...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPShardswish_op_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPShardswish_op_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPShardswish_op_builderDTh() {
      // Check if tracing is enabled
...
class HardSwishOpBuilder : public OpBuilder {
 public:
  explicit HardSwishOpBuilder(GraphBuilder* graph_builder)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPShardswish_op_builderDTh mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/coreml/builders/hardswish_op_builder.h", "HardSwishOpBuilder");
}
