...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSpad_op_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSpad_op_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSpad_op_builderDTh() {
      // Check if tracing is enabled
...
class PadOpBuilder : public OpBuilder {
 public:
  explicit PadOpBuilder(GraphBuilder* graph_builder, PadType padding_type)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPSbuildersPSpad_op_builderDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/coreml/builders/pad_op_builder.h", "PadOpBuilder");
}
