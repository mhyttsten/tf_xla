...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPScoreml_delegate_kernelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPScoreml_delegate_kernelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPScoreml_delegate_kernelDTh() {
      // Check if tracing is enabled
...
class CoreMlDelegateKernel {
 public:
  explicit CoreMlDelegateKernel(int coreml_version)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPScoremlPScoreml_delegate_kernelDTh mht_0(mht_0_v, 201, "", "./tensorflow/lite/delegates/coreml/coreml_delegate_kernel.h", "CoreMlDelegateKernel");
}
