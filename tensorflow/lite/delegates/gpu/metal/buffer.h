...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh() {
      // Check if tracing is enabled
...
class Buffer : public GPUObject {
 public:
  Buffer() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh mht_0(mht_0_v, 204, "", "./tensorflow/lite/delegates/gpu/metal/buffer.h", "Buffer");
  ...
  uint64_t GetMemorySizeInBytes() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh mht_1(mht_1_v, 219, "", "./tensorflow/lite/delegates/gpu/metal/buffer.h", "GetMemorySizeInBytes");
 return size_; }
...
absl::Status Buffer::WriteData(const absl::Span<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh mht_2(mht_2_v, 251, "", "./tensorflow/lite/delegates/gpu/metal/buffer.h", "Buffer::WriteData");
...
absl::Status Buffer::ReadData(std::vector<T>* result) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSbufferDTh mht_3(mht_3_v, 264, "", "./tensorflow/lite/delegates/gpu/metal/buffer.h", "Buffer::ReadData");
