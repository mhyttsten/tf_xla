...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh() {
      // Check if tracing is enabled
...
class ComputeTask {
 public:
  ...
  const GPUOperation& GetGpuOperation() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh mht_0(mht_0_v, 223, "", "./tensorflow/lite/delegates/gpu/metal/compute_task.h", "GetGpuOperation");
 return *operation_; }
  ...
  int3 GetWorkGroupSize() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh mht_1(mht_1_v, 251, "", "./tensorflow/lite/delegates/gpu/metal/compute_task.h", "GetWorkGroupSize");
 return operation_->work_group_size_; }
  void SetWorkGroupSize(const int3& work_group_size);

  const std::string& GetCode() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh mht_2(mht_2_v, 257, "", "./tensorflow/lite/delegates/gpu/metal/compute_task.h", "GetCode");
 return operation_->code_; }
  const std::map<std::string, std::string>& GetDefines() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPScompute_taskDTh mht_3(mht_3_v, 261, "", "./tensorflow/lite/delegates/gpu/metal/compute_task.h", "GetDefines");
