...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSkernelsPStest_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSkernelsPStest_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSkernelsPStest_utilDTh() {
      // Check if tracing is enabled
...
class MetalExecutionEnvironment : public TestExecutionEnvironment {
 public:
  ...
  const GpuInfo& GetGpuInfo() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSkernelsPStest_utilDTh mht_0(mht_0_v, 215, "", "./tensorflow/lite/delegates/gpu/metal/kernels/test_util.h", "GetGpuInfo");
