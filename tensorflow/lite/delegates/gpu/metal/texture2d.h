...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh() {
      // Check if tracing is enabled
...
class Texture2D : public GPUObject {
 public:
  Texture2D() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh mht_0(mht_0_v, 205, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.h", "Texture2D");
  ...
  ~Texture2D() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh mht_1(mht_1_v, 217, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.h", "~Texture2D");
 Release(); }
...
absl::Status Texture2D::WriteData(id<MTLDevice> device,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh mht_2(mht_2_v, 259, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.h", "Texture2D::WriteData");
...
absl::Status Texture2D::ReadData(id<MTLDevice> device,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTh mht_3(mht_3_v, 276, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.h", "Texture2D::ReadData");
