...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSlinear_storageDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSlinear_storageDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSlinear_storageDTh() {
      // Check if tracing is enabled
...
class LinearStorage : public GPUObject {
 public:
  LinearStorage() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSlinear_storageDTh mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/gpu/metal/linear_storage.h", "LinearStorage");
}
  ~LinearStorage() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPSlinear_storageDTh mht_1(mht_1_v, 212, "", "./tensorflow/lite/delegates/gpu/metal/linear_storage.h", "~LinearStorage");
 Release(); }
