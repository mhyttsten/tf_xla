...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc() {
      // Check if tracing is enabled
...
absl::Status CreateTexture2D(int width, int height, DataType type, void* data,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_0(mht_0_v, 194, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "CreateTexture2D");
...
Texture2D::Texture2D(id<MTLTexture> texture, int width, int height,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_1(mht_1_v, 229, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "Texture2D::Texture2D");
}
...
Texture2D::Texture2D(Texture2D&& texture)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_2(mht_2_v, 238, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "Texture2D::Texture2D");
...
Texture2D& Texture2D::operator=(Texture2D&& texture) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_3(mht_3_v, 247, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "=");
...
void Texture2D::Release() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_4(mht_4_v, 261, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "Texture2D::Release");
...
absl::Status Texture2D::GetGPUResources(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_5(mht_5_v, 274, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "Texture2D::GetGPUResources");
...
absl::Status Texture2D::CreateFromTexture2DDescriptor(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_6(mht_6_v, 288, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "Texture2D::CreateFromTexture2DDescriptor");
...
absl::Status CreateTexture2DRGBA32F(int width, int height, id<MTLDevice> device,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_7(mht_7_v, 322, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "CreateTexture2DRGBA32F");
...
absl::Status CreateTexture2DRGBA16F(int width, int height, id<MTLDevice> device,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_8(mht_8_v, 332, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "CreateTexture2DRGBA16F");
...
absl::Status CreateTexture2DRGBA(DataType type, int width, int height,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_9(mht_9_v, 341, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "CreateTexture2DRGBA");
...
absl::Status CreateTexture2DRGBA(DataType type, int width, int height,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSmetalPStexture2dDTcc mht_10(mht_10_v, 350, "", "./tensorflow/lite/delegates/gpu/metal/texture2d.cc", "CreateTexture2DRGBA");
