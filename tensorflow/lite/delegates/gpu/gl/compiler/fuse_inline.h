...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTh() {
      // Check if tracing is enabled
...
class FuseAutoOutputWithInline : public SequenceTransformation {
 public:
  int ExpectedSequenceLength() const final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTh mht_0(mht_0_v, 216, "", "./tensorflow/lite/delegates/gpu/gl/compiler/fuse_inline.h", "ExpectedSequenceLength");
 return 2; }
