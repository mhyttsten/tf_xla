...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSshader_codeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSshader_codeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSshader_codeDTh() {
      // Check if tracing is enabled
...
struct ShaderCode {
  ...
  ShaderCode(const std::vector<Variable>& in_parameters,
   ...
   mht_0_v.push_back("in_source_code: \"" + in_source_code + "\"");
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSshader_codeDTh mht_0(mht_0_v, 213, "", "./tensorflow/lite/delegates/gpu/gl/compiler/shader_code.h", "ShaderCode");
}
