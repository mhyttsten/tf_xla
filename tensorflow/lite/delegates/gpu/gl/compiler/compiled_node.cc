...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPScompiled_nodeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPScompiled_nodeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPScompiled_nodeDTcc() {
      // Check if tracing is enabled
...
absl::Status MergeCode(CompiledNodeAttributes* attr,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPScompiled_nodeDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/gl/compiler/compiled_node.cc", "MergeCode");
