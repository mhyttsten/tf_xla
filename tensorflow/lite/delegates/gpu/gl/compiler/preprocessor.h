...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSpreprocessorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSpreprocessorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSpreprocessorDTh() {
      // Check if tracing is enabled
...
class TextPreprocessor {
 public:
  ...
  TextPreprocessor(char inline_delimiter, bool keep_unknown_rewrites)
   ...
   mht_0_v.push_back("inline_delimiter: '" + std::string(1, inline_delimiter) + "'");
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSpreprocessorDTh mht_0(mht_0_v, 224, "", "./tensorflow/lite/delegates/gpu/gl/compiler/preprocessor.h", "TextPreprocessor");
}

  void AddRewrite(InlineRewrite* rewrite) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSpreprocessorDTh mht_1(mht_1_v, 229, "", "./tensorflow/lite/delegates/gpu/gl/compiler/preprocessor.h", "AddRewrite");
