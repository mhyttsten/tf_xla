...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSvariable_accessorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSvariable_accessorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSvariable_accessorDTh() {
      // Check if tracing is enabled
...
class VariableAccessor : public InlineRewrite {
 public:
  explicit VariableAccessor(bool inline_values, bool vulkan_support = false)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSvariable_accessorDTh mht_0(mht_0_v, 219, "", "./tensorflow/lite/delegates/gpu/gl/compiler/variable_accessor.h", "VariableAccessor");
}
