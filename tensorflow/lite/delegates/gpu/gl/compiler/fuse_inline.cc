...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTcc() {
      // Check if tracing is enabled
...
TransformResult FuseAutoOutputWithInline::ApplyToNodesSequence(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inlineDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/gl/compiler/fuse_inline.cc", "FuseAutoOutputWithInline::ApplyToNodesSequence");
