...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inplaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inplaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inplaceDTh() {
      // Check if tracing is enabled
...
class FuseInplaceUpdate : public SequenceTransformation {
 public:
  int ExpectedSequenceLength() const final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScompilerPSfuse_inplaceDTh mht_0(mht_0_v, 220, "", "./tensorflow/lite/delegates/gpu/gl/compiler/fuse_inplace.h", "ExpectedSequenceLength");
 return 2; }
