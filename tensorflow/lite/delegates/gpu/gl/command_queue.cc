...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc() {
      // Check if tracing is enabled
...
class DefaultCommandQueue : public CommandQueue {
 public:
  absl::Status Dispatch(const GlProgram& program,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "Dispatch");
  ...
  absl::Status WaitForCompletion() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_1(mht_1_v, 211, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "WaitForCompletion");
  ...
  absl::Status Flush() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_2(mht_2_v, 219, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "Flush");
...
class AdrenoCommandQueue : public DefaultCommandQueue {
 public:
  explicit AdrenoCommandQueue(int flush_every_n)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_3(mht_3_v, 234, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "AdrenoCommandQueue");
}

  absl::Status Dispatch(const GlProgram& program,
                        const uint3& workgroups) final {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_4(mht_4_v, 240, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "Dispatch");
  ...
  absl::Status WaitForCompletion() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_5(mht_5_v, 251, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "WaitForCompletion");
  ...
  absl::Status Flush() final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPScommand_queueDTcc mht_6(mht_6_v, 259, "", "./tensorflow/lite/delegates/gpu/gl/command_queue.cc", "Flush");
