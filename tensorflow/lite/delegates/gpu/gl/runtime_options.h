...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntime_optionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntime_optionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntime_optionsDTh() {
      // Check if tracing is enabled
...
struct RuntimeOptions {
  RuntimeOptions()
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntime_optionsDTh mht_0(mht_0_v, 194, "", "./tensorflow/lite/delegates/gpu/gl/runtime_options.h", "RuntimeOptions");
}
