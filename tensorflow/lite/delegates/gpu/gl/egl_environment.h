...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSegl_environmentDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSegl_environmentDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSegl_environmentDTh() {
      // Check if tracing is enabled
...
class EglEnvironment {
 public:
  ...
  const EglContext& context() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSegl_environmentDTh mht_0(mht_0_v, 214, "", "./tensorflow/lite/delegates/gpu/gl/egl_environment.h", "context");
 return context_; }
  EGLDisplay display() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSegl_environmentDTh mht_1(mht_1_v, 218, "", "./tensorflow/lite/delegates/gpu/gl/egl_environment.h", "display");
 return display_; }
  const GpuInfo& gpu_info() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSegl_environmentDTh mht_2(mht_2_v, 222, "", "./tensorflow/lite/delegates/gpu/gl/egl_environment.h", "gpu_info");
 return gpu_info_; }
