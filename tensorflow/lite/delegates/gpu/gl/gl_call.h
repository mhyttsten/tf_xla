...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_callDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_callDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_callDTh() {
      // Check if tracing is enabled
...
absl::Status CallAndCheckError(const std::string& context, F func,
   ...
   mht_0_v.push_back("context: \"" + context + "\"");
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_callDTh mht_0(mht_0_v, 253, "", "./tensorflow/lite/delegates/gpu/gl/gl_call.h", "CallAndCheckError");
...
absl::Status CallAndCheckError(const std::string& context, F func,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_callDTh mht_1(mht_1_v, 264, "", "./tensorflow/lite/delegates/gpu/gl/gl_call.h", "CallAndCheckError");
