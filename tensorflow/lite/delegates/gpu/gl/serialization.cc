...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc() {
      // Check if tracing is enabled
...
data::DataType ToFB(DataType type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_0(mht_0_v, 375, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ToFB");
...
data::ObjectType ToFB(ObjectType type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_1(mht_1_v, 393, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ToFB");
...
data::AccessType ToFB(AccessType type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_2(mht_2_v, 467, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ToFB");
...
void SerializedCompiledModelBuilder::AddShader(const std::string& shader_src) {
   ...
   mht_3_v.push_back("shader_src: \"" + shader_src + "\"");
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_3(mht_3_v, 500, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "SerializedCompiledModelBuilder::AddShader");
...
void SerializedCompiledModelBuilder::AddProgram(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_4(mht_4_v, 510, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "SerializedCompiledModelBuilder::AddProgram");
...
absl::Span<const uint8_t> SerializedCompiledModelBuilder::Finalize(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_5(mht_5_v, 564, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "SerializedCompiledModelBuilder::Finalize");
...
absl::Status ParseParameter(const data::UniformParameter& fb_parameter,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_6(mht_6_v, 582, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ParseParameter");
...
DataType ToEnum(data::DataType type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_7(mht_7_v, 677, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ToEnum");
...
ObjectType ToEnum(data::ObjectType type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_8(mht_8_v, 695, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ToEnum");
...
AccessType ToEnum(data::AccessType type) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_9(mht_9_v, 709, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ToEnum");
...
absl::Status ParseObject(const data::Object& fb_object, Object* object) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_10(mht_10_v, 723, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ParseObject");
...
CompiledModelOptions ParseParameters(const data::Parameters& fb_parameters) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_11(mht_11_v, 772, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "ParseParameters");
...
absl::Status DeserializeCompiledModel(absl::Span<const uint8_t> serialized,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTcc mht_12(mht_12_v, 784, "", "./tensorflow/lite/delegates/gpu/gl/serialization.cc", "DeserializeCompiledModel");
