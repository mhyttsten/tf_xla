...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTh() {
      // Check if tracing is enabled
...
class SerializedCompiledModelBuilder {
 public:
  SerializedCompiledModelBuilder() : builder_(32 * 1024) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSserializationDTh mht_0(mht_0_v, 214, "", "./tensorflow/lite/delegates/gpu/gl/serialization.h", "SerializedCompiledModelBuilder");
}
