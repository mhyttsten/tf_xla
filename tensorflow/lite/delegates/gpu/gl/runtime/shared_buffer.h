...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh() {
      // Check if tracing is enabled
...
class SharedBufferData {
 public:
  SharedBufferData() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh mht_0(mht_0_v, 207, "", "./tensorflow/lite/delegates/gpu/gl/runtime/shared_buffer.h", "SharedBufferData");
  ...
  bool Add(const ObjectData& data, GlBuffer* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh mht_1(mht_1_v, 215, "", "./tensorflow/lite/delegates/gpu/gl/runtime/shared_buffer.h", "Add");
  ...
  bool empty() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh mht_2(mht_2_v, 230, "", "./tensorflow/lite/delegates/gpu/gl/runtime/shared_buffer.h", "empty");
 return shared_data_.empty(); }

  // Returns a single GlBuffer that owns entire shared data.
  absl::Status CreateSharedGlBuffer(GlBuffer* gl_buffer) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSruntimePSshared_bufferDTh mht_3(mht_3_v, 236, "", "./tensorflow/lite/delegates/gpu/gl/runtime/shared_buffer.h", "CreateSharedGlBuffer");
