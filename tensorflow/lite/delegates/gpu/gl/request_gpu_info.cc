...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSrequest_gpu_infoDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSrequest_gpu_infoDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSrequest_gpu_infoDTcc() {
      // Check if tracing is enabled
...
absl::Status RequestOpenGlInfo(OpenGlInfo* gl_info) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSrequest_gpu_infoDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/gpu/gl/request_gpu_info.cc", "RequestOpenGlInfo");
...
absl::Status RequestGpuInfo(GpuInfo* gpu_info) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSrequest_gpu_infoDTcc mht_1(mht_1_v, 225, "", "./tensorflow/lite/delegates/gpu/gl/request_gpu_info.cc", "RequestGpuInfo");
