...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc() {
      // Check if tracing is enabled
...
struct IdealByCase {
  bool ParamsAccepted(OperationType in_op_type, HW in_kernel,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc mht_0(mht_0_v, 209, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/ideal_workgroup_picker.cc", "ParamsAccepted");
...
struct IdealByType {
  bool ParamsAccepted(OperationType in_op_type) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/ideal_workgroup_picker.cc", "ParamsAccepted");
...
uint3 GetIdealWorkgroupIfPossible(const GpuInfo& gpu_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc mht_2(mht_2_v, 334, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/ideal_workgroup_picker.cc", "GetIdealWorkgroupIfPossible");
...
uint3 GetIdealWorkgroupIfPossible(const GpuInfo& gpu_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPSideal_workgroup_pickerDTcc mht_3(mht_3_v, 377, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/ideal_workgroup_picker.cc", "GetIdealWorkgroupIfPossible");
