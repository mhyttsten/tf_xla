...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPScalculator_from_metadataDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPScalculator_from_metadataDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPScalculator_from_metadataDTcc() {
      // Check if tracing is enabled
...
class WorkgroupsCalculatorFromMetadata : public WorkgroupsCalculator {
 public:
  WorkgroupsCalculatorFromMetadata(const data::HardcodedWorkgroups& workgroups,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPScalculator_from_metadataDTcc mht_0(mht_0_v, 214, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/calculator_from_metadata.cc", "WorkgroupsCalculatorFromMetadata");
  ...
  uint3 CalculateInternal(const ShaderCode& shader_code) const final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPScalculator_from_metadataDTcc mht_1(mht_1_v, 229, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/calculator_from_metadata.cc", "CalculateInternal");
...
const data::HardcodedWorkgroups* FindWorkgroups(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSworkgroupsPScalculator_from_metadataDTcc mht_2(mht_2_v, 245, "", "./tensorflow/lite/delegates/gpu/gl/workgroups/calculator_from_metadata.cc", "FindWorkgroups");
