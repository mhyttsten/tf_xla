...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSfloat16_conversionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSfloat16_conversionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSfloat16_conversionsDTcc() {
      // Check if tracing is enabled
...
bool ToFloat16(std::vector<uint8_t>* values) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSfloat16_conversionsDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/delegates/gpu/gl/float16_conversions.cc", "ToFloat16");
...
bool MaybeConvertToFloat16(Object* object) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSfloat16_conversionsDTcc mht_1(mht_1_v, 234, "", "./tensorflow/lite/delegates/gpu/gl/float16_conversions.cc", "MaybeConvertToFloat16");
