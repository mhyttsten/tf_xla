...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSstatsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSstatsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSstatsDTh() {
      // Check if tracing is enabled
...
inline std::string ToString(const ObjectStats& stats) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSstatsDTh mht_0(mht_0_v, 222, "", "./tensorflow/lite/delegates/gpu/gl/stats.h", "ToString");
