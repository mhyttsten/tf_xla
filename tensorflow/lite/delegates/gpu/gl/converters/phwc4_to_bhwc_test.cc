...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwc_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwc_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwc_testDTcc() {
      // Check if tracing is enabled
...
absl::Status RunTest(const BHWC& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwc_testDTcc mht_0(mht_0_v, 213, "", "./tensorflow/lite/delegates/gpu/gl/converters/phwc4_to_bhwc_test.cc", "RunTest");
