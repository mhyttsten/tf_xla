...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwcDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwcDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwcDTcc() {
      // Check if tracing is enabled
...
absl::Status ConverterPhwc4ToBhwc::Create(ConverterPhwc4ToBhwc* converter) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwcDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/gpu/gl/converters/phwc4_to_bhwc.cc", "ConverterPhwc4ToBhwc::Create");
...
absl::Status ConverterPhwc4ToBhwc::Convert(const BHWC& shape,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSphwc4_to_bhwcDTcc mht_1(mht_1_v, 243, "", "./tensorflow/lite/delegates/gpu/gl/converters/phwc4_to_bhwc.cc", "ConverterPhwc4ToBhwc::Convert");
