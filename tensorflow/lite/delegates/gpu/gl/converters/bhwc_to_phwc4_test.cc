...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSbhwc_to_phwc4_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSbhwc_to_phwc4_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSbhwc_to_phwc4_testDTcc() {
      // Check if tracing is enabled
...
absl::Status RunTest(const BHWC& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSconvertersPSbhwc_to_phwc4_testDTcc mht_0(mht_0_v, 213, "", "./tensorflow/lite/delegates/gpu/gl/converters/bhwc_to_phwc4_test.cc", "RunTest");
