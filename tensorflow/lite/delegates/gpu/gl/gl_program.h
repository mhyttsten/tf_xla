...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh() {
      // Check if tracing is enabled
...
class GlProgram {
 public:
  ...
  GlProgram() : id_(0) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/gl/gl_program.h", "GlProgram");
}
  ...
  GLuint id() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh mht_1(mht_1_v, 231, "", "./tensorflow/lite/delegates/gpu/gl/gl_program.h", "id");
 return id_; }
  ...
  bool is_valid() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh mht_2(mht_2_v, 245, "", "./tensorflow/lite/delegates/gpu/gl/gl_program.h", "is_valid");
 return id_ != 0; }

 private:
  explicit GlProgram(GLuint program_id) : id_(program_id) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSgl_programDTh mht_3(mht_3_v, 251, "", "./tensorflow/lite/delegates/gpu/gl/gl_program.h", "GlProgram");
}
