...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTh() {
      // Check if tracing is enabled
...
class SingleOpModel {
 public:
  ...
  const std::vector<float>& GetOutput(int index) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTh mht_0(mht_0_v, 225, "", "./tensorflow/lite/delegates/gpu/gl/kernels/test_util.h", "GetOutput");
