...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSmax_unpoolingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSmax_unpoolingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSmax_unpoolingDTcc() {
      // Check if tracing is enabled
...
class MaxUnpooling : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSmax_unpoolingDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/gl/kernels/max_unpooling.cc", "GenerateCode");
