...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSreshapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSreshapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSreshapeDTcc() {
      // Check if tracing is enabled
...
class Reshape : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSreshapeDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/delegates/gpu/gl/kernels/reshape.cc", "GenerateCode");
