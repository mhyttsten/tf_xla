...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSlstmDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSlstmDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSlstmDTcc() {
      // Check if tracing is enabled
...
class LstmNodeShader : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSlstmDTcc mht_0(mht_0_v, 216, "", "./tensorflow/lite/delegates/gpu/gl/kernels/lstm.cc", "GenerateCode");
