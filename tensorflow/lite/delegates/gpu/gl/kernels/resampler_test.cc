...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSresampler_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSresampler_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSresampler_testDTcc() {
      // Check if tracing is enabled
...
absl::Status ResamplerIdentityTest(const BHWC& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSresampler_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/gpu/gl/kernels/resampler_test.cc", "ResamplerIdentityTest");
