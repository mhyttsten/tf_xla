...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc() {
      // Check if tracing is enabled
...
SingleOpModel::SingleOpModel(Operation&& operation,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc mht_0(mht_0_v, 210, "", "./tensorflow/lite/delegates/gpu/gl/kernels/test_util.cc", "SingleOpModel::SingleOpModel");
...
bool SingleOpModel::PopulateTensor(int index, std::vector<float>&& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc mht_1(mht_1_v, 234, "", "./tensorflow/lite/delegates/gpu/gl/kernels/test_util.cc", "SingleOpModel::PopulateTensor");
...
absl::Status SingleOpModel::Invoke(const CompilationOptions& compile_options,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc mht_2(mht_2_v, 248, "", "./tensorflow/lite/delegates/gpu/gl/kernels/test_util.cc", "SingleOpModel::Invoke");
...
absl::Status SingleOpModel::Invoke(const NodeShader& shader) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPStest_utilDTcc mht_3(mht_3_v, 309, "", "./tensorflow/lite/delegates/gpu/gl/kernels/test_util.cc", "SingleOpModel::Invoke");
