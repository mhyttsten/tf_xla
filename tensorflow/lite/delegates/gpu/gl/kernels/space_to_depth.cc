...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSspace_to_depthDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSspace_to_depthDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSspace_to_depthDTcc() {
      // Check if tracing is enabled
...
class SpaceToDepth : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSspace_to_depthDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/delegates/gpu/gl/kernels/space_to_depth.cc", "GenerateCode");
...
class DepthToSpace : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSspace_to_depthDTcc mht_1(mht_1_v, 241, "", "./tensorflow/lite/delegates/gpu/gl/kernels/space_to_depth.cc", "GenerateCode");
