...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSpreluDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSpreluDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSpreluDTcc() {
      // Check if tracing is enabled
...
class PReLULinearAlpha : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSpreluDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/gpu/gl/kernels/prelu.cc", "GenerateCode");
...
class PReLUFull : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSpreluDTcc mht_1(mht_1_v, 260, "", "./tensorflow/lite/delegates/gpu/gl/kernels/prelu.cc", "GenerateCode");
...
class PReLU : public NodeShader {
 public:
  absl::Status GenerateCode(const GenerationContext& ctx,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSglPSkernelsPSpreluDTcc mht_2(mht_2_v, 330, "", "./tensorflow/lite/delegates/gpu/gl/kernels/prelu.cc", "GenerateCode");
