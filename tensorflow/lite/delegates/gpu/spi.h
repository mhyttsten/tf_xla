...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSspiDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSspiDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSspiDTh() {
      // Check if tracing is enabled
...
class TensorTie {
 public:
  explicit TensorTie(const TensorTieDef& def) : def_(def) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSspiDTh mht_0(mht_0_v, 234, "", "./tensorflow/lite/delegates/gpu/spi.h", "TensorTie");
}
  ...
  const TensorTieDef& def() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSspiDTh mht_1(mht_1_v, 249, "", "./tensorflow/lite/delegates/gpu/spi.h", "def");
 return def_; }
