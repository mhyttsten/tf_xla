...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmodel_transformationsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmodel_transformationsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmodel_transformationsDTcc() {
      // Check if tracing is enabled
...
bool ApplyGeneralTransformations(ModelTransformer* transformer) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmodel_transformationsDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/delegates/gpu/common/transformations/model_transformations.cc", "ApplyGeneralTransformations");
...
bool ApplyModelTransformations(ModelTransformer* transformer) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmodel_transformationsDTcc mht_1(mht_1_v, 244, "", "./tensorflow/lite/delegates/gpu/common/transformations/model_transformations.cc", "ApplyModelTransformations");
