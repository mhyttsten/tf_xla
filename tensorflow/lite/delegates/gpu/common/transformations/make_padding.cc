...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_paddingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_paddingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_paddingDTcc() {
      // Check if tracing is enabled
...
bool IsConstZeros(const Node& node) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_paddingDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/delegates/gpu/common/transformations/make_padding.cc", "IsConstZeros");
...
class MakePaddingFromZerosConcat : public NodeTransformation {
 public:
  TransformResult ApplyToNode(Node* node, GraphFloat32* graph) final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_paddingDTcc mht_1(mht_1_v, 224, "", "./tensorflow/lite/delegates/gpu/common/transformations/make_padding.cc", "ApplyToNode");
