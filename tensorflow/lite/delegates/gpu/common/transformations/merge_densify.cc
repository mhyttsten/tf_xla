...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmerge_densifyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmerge_densifyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmerge_densifyDTcc() {
      // Check if tracing is enabled
...
class MergeDensify : public NodeTransformation {
 public:
  TransformResult ApplyToNode(Node* node, GraphFloat32* graph) final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmerge_densifyDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/delegates/gpu/common/transformations/merge_densify.cc", "ApplyToNode");
