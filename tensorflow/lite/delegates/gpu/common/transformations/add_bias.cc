...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSadd_biasDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSadd_biasDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSadd_biasDTcc() {
      // Check if tracing is enabled
...
TransformResult FillBias(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSadd_biasDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/common/transformations/add_bias.cc", "FillBias");
...
class AddBias : public NodeTransformation {
 public:
  TransformResult ApplyToNode(Node* node, GraphFloat32* graph) final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSadd_biasDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/delegates/gpu/common/transformations/add_bias.cc", "ApplyToNode");
