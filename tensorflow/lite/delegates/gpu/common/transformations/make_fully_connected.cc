...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_fully_connectedDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_fully_connectedDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_fully_connectedDTcc() {
      // Check if tracing is enabled
...
bool IsConvEquivalentToFullyConnected(const Convolution2DAttributes& attr) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_fully_connectedDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/gpu/common/transformations/make_fully_connected.cc", "IsConvEquivalentToFullyConnected");
...
class MakeFullyConnectedFromConvolution : public NodeTransformation {
 public:
  TransformResult ApplyToNode(Node* node, GraphFloat32* graph) final {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStransformationsPSmake_fully_connectedDTcc mht_1(mht_1_v, 217, "", "./tensorflow/lite/delegates/gpu/common/transformations/make_fully_connected.cc", "ApplyToNode");
