...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmodel_hintsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmodel_hintsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmodel_hintsDTh() {
      // Check if tracing is enabled
...
struct ModelHints {
  ...
  void Add(ModelHint hint) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmodel_hintsDTh mht_0(mht_0_v, 218, "", "./tensorflow/lite/delegates/gpu/common/model_hints.h", "Add");
  ...
  bool Check(ModelHint hint) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmodel_hintsDTh mht_1(mht_1_v, 229, "", "./tensorflow/lite/delegates/gpu/common/model_hints.h", "Check");
 return hints & hint; }
