...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSprofiling_infoDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSprofiling_infoDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSprofiling_infoDTcc() {
      // Check if tracing is enabled
...
absl::Duration ProfilingInfo::GetTotalTime() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSprofiling_infoDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/delegates/gpu/common/task/profiling_info.cc", "ProfilingInfo::GetTotalTime");
...
std::string ProfilingInfo::GetDetailedReport() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSprofiling_infoDTcc mht_1(mht_1_v, 204, "", "./tensorflow/lite/delegates/gpu/common/task/profiling_info.cc", "ProfilingInfo::GetDetailedReport");
