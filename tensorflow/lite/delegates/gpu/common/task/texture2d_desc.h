...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStexture2d_descDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStexture2d_descDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStexture2d_descDTh() {
      // Check if tracing is enabled
...
struct Texture2DDescriptor : public GPUObjectDescriptor {
  ...
  uint64_t GetSizeInBytes() const override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStexture2d_descDTh mht_0(mht_0_v, 227, "", "./tensorflow/lite/delegates/gpu/common/task/texture2d_desc.h", "GetSizeInBytes");
 return data.size(); };
};
