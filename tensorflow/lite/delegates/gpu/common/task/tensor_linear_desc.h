...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStensor_linear_descDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStensor_linear_descDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStensor_linear_descDTh() {
      // Check if tracing is enabled
...
struct TensorLinearDescriptor : public GPUObjectDescriptor {
  ...
  uint64_t GetSizeInBytes() const override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStensor_linear_descDTh mht_0(mht_0_v, 232, "", "./tensorflow/lite/delegates/gpu/common/task/tensor_linear_desc.h", "GetSizeInBytes");
 return data.size(); };
};
