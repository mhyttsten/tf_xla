...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSbuffer_descDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSbuffer_descDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSbuffer_descDTh() {
      // Check if tracing is enabled
...
struct BufferDescriptor : public GPUObjectDescriptor {
  ...
  uint64_t GetSizeInBytes() const override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPSbuffer_descDTh mht_0(mht_0_v, 230, "", "./tensorflow/lite/delegates/gpu/common/task/buffer_desc.h", "GetSizeInBytes");
 return data.size(); };
};
