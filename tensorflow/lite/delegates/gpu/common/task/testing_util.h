...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh() {
      // Check if tracing is enabled
...
class TestExecutionEnvironment {
 public:
  ...
  absl::Status ExecuteGPUOperation(const TensorFloat32& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh mht_0(mht_0_v, 237, "", "./tensorflow/lite/delegates/gpu/common/task/testing_util.h", "ExecuteGPUOperation");
  ...
  absl::Status ExecuteGPUOperation(const Tensor5DFloat32& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh mht_1(mht_1_v, 248, "", "./tensorflow/lite/delegates/gpu/common/task/testing_util.h", "ExecuteGPUOperation");
  ...
  absl::Status ExecuteGPUOperation(const std::vector<TensorFloat32>& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh mht_2(mht_2_v, 259, "", "./tensorflow/lite/delegates/gpu/common/task/testing_util.h", "ExecuteGPUOperation");
  ...
  absl::Status ExecuteGPUOperation(const std::vector<Tensor5DFloat32>& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStaskPStesting_utilDTh mht_3(mht_3_v, 271, "", "./tensorflow/lite/delegates/gpu/common/task/testing_util.h", "ExecuteGPUOperation");
