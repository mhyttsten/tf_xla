...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSutilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSutilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSutilDTh() {
      // Check if tracing is enabled
...
inline uint3 DivideRoundUp(uint3 n, uint3 divisor) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSutilDTh mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/gpu/common/util.h", "DivideRoundUp");
