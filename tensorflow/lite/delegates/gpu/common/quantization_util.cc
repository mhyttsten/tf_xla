...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc() {
      // Check if tracing is enabled
...
void DequantizeInput(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/delegates/gpu/common/quantization_util.cc", "DequantizeInput");
...
void QuantizeOutput(TfLiteContext* context, int output_index,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc mht_1(mht_1_v, 233, "", "./tensorflow/lite/delegates/gpu/common/quantization_util.cc", "QuantizeOutput");
...
absl::Status DequantizeInputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc mht_2(mht_2_v, 266, "", "./tensorflow/lite/delegates/gpu/common/quantization_util.cc", "DequantizeInputs");
...
absl::Status DequantizeInputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc mht_3(mht_3_v, 278, "", "./tensorflow/lite/delegates/gpu/common/quantization_util.cc", "DequantizeInputs");
...
absl::Status QuantizeOutputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc mht_4(mht_4_v, 290, "", "./tensorflow/lite/delegates/gpu/common/quantization_util.cc", "QuantizeOutputs");
...
absl::Status QuantizeOutputs(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSquantization_utilDTcc mht_5(mht_5_v, 303, "", "./tensorflow/lite/delegates/gpu/common/quantization_util.cc", "QuantizeOutputs");
