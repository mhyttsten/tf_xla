...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc() {
      // Check if tracing is enabled
...
bool IsRecommendedForWinograd4x4To6x6(const Convolution2DAttributes& attr,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc mht_0(mht_0_v, 220, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.cc", "IsRecommendedForWinograd4x4To6x6");
...
absl::Status WinogradFromNode(const GpuInfo& gpu_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc mht_1(mht_1_v, 257, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.cc", "WinogradFromNode");
...
absl::Status AddDynamicConv(ModelHints hints, const GpuInfo& gpu_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc mht_2(mht_2_v, 341, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.cc", "AddDynamicConv");
...
void AddConvSharedWeights(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc mht_3(mht_3_v, 425, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.cc", "AddConvSharedWeights");
...
absl::Status GPUOperationFromNodePart0(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc mht_4(mht_4_v, 497, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.cc", "GPUOperationFromNodePart0");
...
absl::Status GPUOperationFromNode(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTcc mht_5(mht_5_v, 939, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.cc", "GPUOperationFromNode");
