...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTh() {
      // Check if tracing is enabled
...
struct SharedWeightsConvDesc {
  ...
  void RemapIds(const absl::flat_hash_map<int, ValueId>& mapping) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSselectorsPSoperation_selectorDTh mht_0(mht_0_v, 211, "", "./tensorflow/lite/delegates/gpu/common/selectors/operation_selector.h", "RemapIds");
