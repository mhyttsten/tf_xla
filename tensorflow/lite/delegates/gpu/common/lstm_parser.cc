...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc() {
      // Check if tracing is enabled
...
Value* CreateNewSimilarValue(GraphFloat32* graph, const Value* old_value) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_0(mht_0_v, 215, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "CreateNewSimilarValue");
...
absl::Status GetFullyConnectedNode(int weights_tensor_id, int bias_tensor_id,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_1(mht_1_v, 228, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "GetFullyConnectedNode");
...
bool HasTensor(const TfLiteNode* node, const int index) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_2(mht_2_v, 276, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "HasTensor");
...
bool HasCifg(const TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_3(mht_3_v, 284, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "HasCifg");
...
bool HasPeephole(const TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_4(mht_4_v, 292, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "HasPeephole");
...
bool HasNormalization(const TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_5(mht_5_v, 302, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "HasNormalization");
...
bool HasProjection(const TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_6(mht_6_v, 311, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "HasProjection");
...
absl::Status BuildLstmGate(GraphFloat32* graph, ObjectReader* reader,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_7(mht_7_v, 344, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "BuildLstmGate");
...
absl::Status BuildCellStateUpdate(GraphFloat32* graph, ObjectReader* reader,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_8(mht_8_v, 470, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "BuildCellStateUpdate");
...
absl::Status BuildOutputStateUpdate(GraphFloat32* graph, ObjectReader* reader,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_9(mht_9_v, 561, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "BuildOutputStateUpdate");
...
absl::Status ParseLSTMAttributes(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSlstm_parserDTcc mht_10(mht_10_v, 663, "", "./tensorflow/lite/delegates/gpu/common/lstm_parser.cc", "ParseLSTMAttributes");
