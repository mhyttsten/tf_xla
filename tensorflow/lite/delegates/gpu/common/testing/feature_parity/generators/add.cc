...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc() {
      // Check if tracing is enabled
...
class AddModelBuilder {
 public:
  ...
  void SetInputShape(uint32_t input, std::vector<int32_t>&& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc mht_0(mht_0_v, 255, "", "./tensorflow/lite/delegates/gpu/common/testing/feature_parity/generators/add.cc", "SetInputShape");
  ...
  void SetOutputShape(std::vector<int32_t>&& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc mht_1(mht_1_v, 266, "", "./tensorflow/lite/delegates/gpu/common/testing/feature_parity/generators/add.cc", "SetOutputShape");
...
TestParams Add2SameShapeTensors() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc mht_2(mht_2_v, 279, "", "./tensorflow/lite/delegates/gpu/common/testing/feature_parity/generators/add.cc", "Add2SameShapeTensors");
...
TestParams AddBroadcast() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStestingPSfeature_parityPSgeneratorsPSaddDTcc mht_3(mht_3_v, 290, "", "./tensorflow/lite/delegates/gpu/common/testing/feature_parity/generators/add.cc", "AddBroadcast");
