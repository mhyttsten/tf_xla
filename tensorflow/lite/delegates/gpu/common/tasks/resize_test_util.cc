...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status ResizeBilinearAlignedTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeBilinearAlignedTest");
...
absl::Status ResizeBilinearNonAlignedTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_1(mht_1_v, 232, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeBilinearNonAlignedTest");
...
absl::Status ResizeBilinearWithoutHalfPixelTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_2(mht_2_v, 267, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeBilinearWithoutHalfPixelTest");
...
absl::Status ResizeBilinearWithHalfPixelTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_3(mht_3_v, 302, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeBilinearWithHalfPixelTest");
...
absl::Status ResizeNearestTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_4(mht_4_v, 337, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeNearestTest");
...
absl::Status ResizeNearestAlignCornersTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_5(mht_5_v, 372, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeNearestAlignCornersTest");
...
absl::Status ResizeNearestHalfPixelCentersTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSresize_test_utilDTcc mht_6(mht_6_v, 407, "", "./tensorflow/lite/delegates/gpu/common/tasks/resize_test_util.cc", "ResizeNearestHalfPixelCentersTest");
