...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_stride_h2DTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_stride_h2DTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_stride_h2DTh() {
      // Check if tracing is enabled
...
class DepthWiseConv3x3StrideH2 : public GPUOperation {
 ...
 private:
  explicit DepthWiseConv3x3StrideH2(const OperationDef& definition)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_stride_h2DTh mht_0(mht_0_v, 222, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_3x3_stride_h2.h", "DepthWiseConv3x3StrideH2");
}
...
void DepthWiseConv3x3StrideH2::UploadWeightsAndBiases(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_stride_h2DTh mht_1(mht_1_v, 245, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_3x3_stride_h2.h", "DepthWiseConv3x3StrideH2::UploadWeightsAndBiases");
