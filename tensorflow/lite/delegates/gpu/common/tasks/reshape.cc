...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSreshapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSreshapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSreshapeDTcc() {
      // Check if tracing is enabled
...
std::string GetReshapeCode(const OperationDef& op_def) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSreshapeDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/delegates/gpu/common/tasks/reshape.cc", "GetReshapeCode");
...
GPUOperation CreateReshape(const OperationDef& definition) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSreshapeDTcc mht_1(mht_1_v, 255, "", "./tensorflow/lite/delegates/gpu/common/tasks/reshape.cc", "CreateReshape");
