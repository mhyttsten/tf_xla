...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc() {
      // Check if tracing is enabled
...
std::string GlobalIdsGen(const GlobalIdsParams& params) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_0(mht_0_v, 226, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GlobalIdsGen");
...
std::string GenerateUploadByThreads(const std::string& local_ptr_name,
   ...
   mht_1_v.push_back("lid_name: \"" + lid_name + "\"");
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_1(mht_1_v, 301, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GenerateUploadByThreads");
...
std::string GenerateConvolution(const ConvolutionMetal::ConvParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_2(mht_2_v, 329, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GenerateConvolution");
...
kernel void ComputeFunction(
  ...
  auto for_every_yx =
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_3(mht_3_v, 435, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "lambda");
  ...
  auto declare_src = [&]() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_4(mht_4_v, 610, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "lambda");
  ...
  auto read_src = [&]() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_5(mht_5_v, 621, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "lambda");
  ...
  auto conv_core = [&](int offset) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_6(mht_6_v, 662, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "lambda");
...
int GetGroupsCount(const BHWC& dst_shape, const int3& wg_size,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_7(mht_7_v, 829, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetGroupsCount");
...
int GetGroupsCountForLinearWH(const BHWC& dst_shape, const int3& wg_size,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_8(mht_8_v, 844, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetGroupsCountForLinearWH");
...
int GetGroupsCountForLinearWHS(const BHWC& dst_shape, const int3& wg_size,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_9(mht_9_v, 859, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetGroupsCountForLinearWHS");
...
bool IsKernelXIs1(const Convolution2DAttributes& attr) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_10(mht_10_v, 872, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "IsKernelXIs1");
...
bool IsKernelYIs1(const Convolution2DAttributes& attr) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_11(mht_11_v, 881, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "IsKernelYIs1");
...
int GetMaximumPossibleWavesCount(const AppleInfo& apple_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_12(mht_12_v, 891, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetMaximumPossibleWavesCount");
...
int GetRecommendedBlockSize(const AppleInfo& apple_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_13(mht_13_v, 903, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetRecommendedBlockSize");
...
WorkGroupSizeOption CreateWorkGroupSizeOption(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_14(mht_14_v, 931, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "CreateWorkGroupSizeOption");
...
ConvolutionMetal::ConvParams GetConvParamsForA7A8(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_15(mht_15_v, 955, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetConvParamsForA7A8");
...
ConvolutionMetal::ConvParams GetConvParamsForA9AndHigher(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_16(mht_16_v, 1090, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetConvParamsForA9AndHigher");
...
ConvolutionMetal::ConvParams GetConvParamsForIntel(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_17(mht_17_v, 1176, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetConvParamsForIntel");
...
ConvolutionMetal::ConvParams GetConvParamsForAMD(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_18(mht_18_v, 1222, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetConvParamsForAMD");
...
ConvolutionMetal::ConvParams GetConvParams(const GpuInfo& gpu_info,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_19(mht_19_v, 1250, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "GetConvParams");
...
absl::Status ConvolutionMetal::BindArguments(ArgumentsBinder* args) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_20(mht_20_v, 1286, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "ConvolutionMetal::BindArguments");
...
int3 ConvolutionMetal::GetGridSize() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_21(mht_21_v, 1300, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "ConvolutionMetal::GetGridSize");
...
ConvolutionMetal CreateConvolutionMetal(const OperationDef& definition,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_22(mht_22_v, 1324, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "CreateConvolutionMetal");
...
ConvolutionMetal CreateConvolutionMetalWino4x4To6x6(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_23(mht_23_v, 1430, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "CreateConvolutionMetalWino4x4To6x6");
...
bool IsConvolutionMetalSupported(const OperationDef& definition) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTcc mht_24(mht_24_v, 1543, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.cc", "IsConvolutionMetalSupported");
