...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPScastDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPScastDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPScastDTcc() {
      // Check if tracing is enabled
...
std::string GetCastKernelCode(const OperationDef& op_def,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPScastDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/cast.cc", "GetCastKernelCode");
...
GPUOperation CreateCast(const OperationDef& definition,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPScastDTcc mht_1(mht_1_v, 243, "", "./tensorflow/lite/delegates/gpu/common/tasks/cast.cc", "CreateCast");
