...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStileDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStileDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStileDTcc() {
      // Check if tracing is enabled
...
std::string GetTileCode(const OperationDef& op_def, bool src_channels_x4) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStileDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile.cc", "GetTileCode");
...
GPUOperation CreateTile(const OperationDef& op_def, int src_channels) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStileDTcc mht_1(mht_1_v, 271, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile.cc", "CreateTile");
