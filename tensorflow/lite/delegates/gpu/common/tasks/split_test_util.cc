...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status SplitChannelsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/split_test_util.cc", "SplitChannelsTest");
...
absl::Status SplitChannelsX4Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc mht_1(mht_1_v, 243, "", "./tensorflow/lite/delegates/gpu/common/tasks/split_test_util.cc", "SplitChannelsX4Test");
...
absl::Status SplitWidthTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc mht_2(mht_2_v, 291, "", "./tensorflow/lite/delegates/gpu/common/tasks/split_test_util.cc", "SplitWidthTest");
...
absl::Status SplitHeightTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc mht_3(mht_3_v, 337, "", "./tensorflow/lite/delegates/gpu/common/tasks/split_test_util.cc", "SplitHeightTest");
...
absl::Status SplitBatchTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc mht_4(mht_4_v, 382, "", "./tensorflow/lite/delegates/gpu/common/tasks/split_test_util.cc", "SplitBatchTest");
...
absl::Status SplitDepthTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsplit_test_utilDTcc mht_5(mht_5_v, 427, "", "./tensorflow/lite/delegates/gpu/common/tasks/split_test_util.cc", "SplitDepthTest");
