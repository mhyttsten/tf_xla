...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax1x1DTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax1x1DTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax1x1DTh() {
      // Check if tracing is enabled
...
class Softmax1x1 : public GPUOperation {
 public:
  ...
  void GetPossibleKernelWorkGroups(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax1x1DTh mht_0(mht_0_v, 201, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax1x1.h", "GetPossibleKernelWorkGroups");
