...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconvolution_transposed_4x4DTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconvolution_transposed_4x4DTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconvolution_transposed_4x4DTh() {
      // Check if tracing is enabled
...
class ConvolutionTransposed4x4 : public GPUOperation {
 public:
  ...
  void GetPossibleKernelWorkGroups(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconvolution_transposed_4x4DTh mht_0(mht_0_v, 212, "", "./tensorflow/lite/delegates/gpu/common/tasks/convolution_transposed_4x4.h", "GetPossibleKernelWorkGroups");
  ...
  WeightsDescription GetWeightsDescription() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconvolution_transposed_4x4DTh mht_1(mht_1_v, 228, "", "./tensorflow/lite/delegates/gpu/common/tasks/convolution_transposed_4x4.h", "GetWeightsDescription");
