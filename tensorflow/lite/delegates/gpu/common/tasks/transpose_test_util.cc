...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStranspose_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStranspose_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStranspose_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status TransposeIntTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStranspose_test_utilDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/gpu/common/tasks/transpose_test_util.cc", "TransposeIntTest");
...
absl::Status TransposeUintTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStranspose_test_utilDTcc mht_1(mht_1_v, 243, "", "./tensorflow/lite/delegates/gpu/common/tasks/transpose_test_util.cc", "TransposeUintTest");
...
absl::Status TransposeTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStranspose_test_utilDTcc mht_2(mht_2_v, 289, "", "./tensorflow/lite/delegates/gpu/common/tasks/transpose_test_util.cc", "TransposeTest");
