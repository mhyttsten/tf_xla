...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status DepthwiseConvSimpleWeightsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_test_util.cc", "DepthwiseConvSimpleWeightsTest");
...
absl::Status DepthwiseConvNoMultiplierTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_test_utilDTcc mht_1(mht_1_v, 237, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_test_util.cc", "DepthwiseConvNoMultiplierTest");
...
absl::Status DepthwiseConvMultiplier2Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_test_utilDTcc mht_2(mht_2_v, 277, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_test_util.cc", "DepthwiseConvMultiplier2Test");
