...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status AveragePoolingTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/pooling_test_util.cc", "AveragePoolingTest");
...
absl::Status AveragePoolingNonEmptyPaddingTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc mht_1(mht_1_v, 231, "", "./tensorflow/lite/delegates/gpu/common/tasks/pooling_test_util.cc", "AveragePoolingNonEmptyPaddingTest");
...
absl::Status MaxPoolingTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc mht_2(mht_2_v, 266, "", "./tensorflow/lite/delegates/gpu/common/tasks/pooling_test_util.cc", "MaxPoolingTest");
...
absl::Status MaxPoolingIndicesTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSpooling_test_utilDTcc mht_3(mht_3_v, 300, "", "./tensorflow/lite/delegates/gpu/common/tasks/pooling_test_util.cc", "MaxPoolingIndicesTest");
