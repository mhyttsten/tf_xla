...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status TileChannelsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile_test_util.cc", "TileChannelsTest");
...
absl::Status TileChannelsX4Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc mht_1(mht_1_v, 227, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile_test_util.cc", "TileChannelsX4Test");
...
absl::Status TileWidthTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc mht_2(mht_2_v, 258, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile_test_util.cc", "TileWidthTest");
...
absl::Status TileHeightTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc mht_3(mht_3_v, 288, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile_test_util.cc", "TileHeightTest");
...
absl::Status TileHWCTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPStile_test_utilDTcc mht_4(mht_4_v, 318, "", "./tensorflow/lite/delegates/gpu/common/tasks/tile_test_util.cc", "TileHWCTest");
