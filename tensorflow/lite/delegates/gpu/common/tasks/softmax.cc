...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmaxDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmaxDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmaxDTcc() {
      // Check if tracing is enabled
...
std::string GetSoftmaxKernelCode(const OperationDef& op_def) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmaxDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax.cc", "GetSoftmaxKernelCode");
...
GPUOperation CreateSoftmax(const OperationDef& definition) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmaxDTcc mht_1(mht_1_v, 238, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax.cc", "CreateSoftmax");
