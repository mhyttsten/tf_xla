...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_buffer_1x1_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_buffer_1x1_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_buffer_1x1_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status ConvBuffer1x1SimpleWeightsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_buffer_1x1_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_buffer_1x1_test_util.cc", "ConvBuffer1x1SimpleWeightsTest");
...
absl::Status ConvBuffer1x1Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_buffer_1x1_test_utilDTcc mht_1(mht_1_v, 236, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_buffer_1x1_test_util.cc", "ConvBuffer1x1Test");
