...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status QuantAndDequant_Dim2Bits8Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/gpu/common/tasks/quantize_and_dequantize_test_util.cc", "QuantAndDequant_Dim2Bits8Test");
...
absl::Status QuantAndDequant_Dim3Bits8_NegativeRangeTest(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc mht_1(mht_1_v, 236, "", "./tensorflow/lite/delegates/gpu/common/tasks/quantize_and_dequantize_test_util.cc", "QuantAndDequant_Dim3Bits8_NegativeRangeTest");
...
absl::Status QuantAndDequant_Dim3Bits16Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc mht_2(mht_2_v, 275, "", "./tensorflow/lite/delegates/gpu/common/tasks/quantize_and_dequantize_test_util.cc", "QuantAndDequant_Dim3Bits16Test");
...
absl::Status QuantAndDequant_Dim2Bits16_NegativeRangeTest(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSquantize_and_dequantize_test_utilDTcc mht_3(mht_3_v, 315, "", "./tensorflow/lite/delegates/gpu/common/tasks/quantize_and_dequantize_test_util.cc", "QuantAndDequant_Dim2Bits16_NegativeRangeTest");
