...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status AddTwoEqualIntTensorsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/gpu/common/tasks/add_test_util.cc", "AddTwoEqualIntTensorsTest");
...
absl::Status AddTwoEqualUintTensorsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc mht_1(mht_1_v, 243, "", "./tensorflow/lite/delegates/gpu/common/tasks/add_test_util.cc", "AddTwoEqualUintTensorsTest");
...
absl::Status AddTwoEqualTensorsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc mht_2(mht_2_v, 289, "", "./tensorflow/lite/delegates/gpu/common/tasks/add_test_util.cc", "AddTwoEqualTensorsTest");
...
absl::Status AddFirstTensorHasMoreChannelsThanSecondTest(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc mht_3(mht_3_v, 329, "", "./tensorflow/lite/delegates/gpu/common/tasks/add_test_util.cc", "AddFirstTensorHasMoreChannelsThanSecondTest");
...
absl::Status AddFirstTensorHasLessChannelsThanSecond(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSadd_test_utilDTcc mht_4(mht_4_v, 363, "", "./tensorflow/lite/delegates/gpu/common/tasks/add_test_util.cc", "AddFirstTensorHasLessChannelsThanSecond");
