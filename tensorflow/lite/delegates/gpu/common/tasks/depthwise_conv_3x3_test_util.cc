...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status DepthwiseConv3x3SimpleWeightsTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_test_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_3x3_test_util.cc", "DepthwiseConv3x3SimpleWeightsTest");
...
absl::Status DepthwiseConv3x3Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSdepthwise_conv_3x3_test_utilDTcc mht_1(mht_1_v, 238, "", "./tensorflow/lite/delegates/gpu/common/tasks/depthwise_conv_3x3_test_util.cc", "DepthwiseConv3x3Test");
