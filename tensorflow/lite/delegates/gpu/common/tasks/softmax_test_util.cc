...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc() {
      // Check if tracing is enabled
...
absl::Status SoftmaxTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax_test_util.cc", "SoftmaxTest");
...
absl::Status SoftmaxBigNumberTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc mht_1(mht_1_v, 228, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax_test_util.cc", "SoftmaxBigNumberTest");
...
absl::Status Softmax1x1Test(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc mht_2(mht_2_v, 274, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax_test_util.cc", "Softmax1x1Test");
...
absl::Status Softmax1x1BigNumberTest(TestExecutionEnvironment* env) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSsoftmax_test_utilDTcc mht_3(mht_3_v, 303, "", "./tensorflow/lite/delegates/gpu/common/tasks/softmax_test_util.cc", "Softmax1x1BigNumberTest");
