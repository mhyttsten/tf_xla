...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSmean_stddev_normalizationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSmean_stddev_normalizationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSmean_stddev_normalizationDTh() {
      // Check if tracing is enabled
...
class MeanStdDevNormalization : public GPUOperation {
 public:
  ...
  void GetPossibleKernelWorkGroups(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSmean_stddev_normalizationDTh mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/common/tasks/mean_stddev_normalization.h", "GetPossibleKernelWorkGroups");
