...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSspecialPSfc_fc_addDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSspecialPSfc_fc_addDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSspecialPSfc_fc_addDTh() {
      // Check if tracing is enabled
...
class FCFCAdd : public GPUOperation {
 public:
  ...
  void GetPossibleKernelWorkGroups(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSspecialPSfc_fc_addDTh mht_0(mht_0_v, 267, "", "./tensorflow/lite/delegates/gpu/common/tasks/special/fc_fc_add.h", "GetPossibleKernelWorkGroups");
...
void FCFCAdd::UploadWeights(const tflite::gpu::Tensor<OHWI, T>& weights,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSspecialPSfc_fc_addDTh mht_1(mht_1_v, 309, "", "./tensorflow/lite/delegates/gpu/common/tasks/special/fc_fc_add.h", "FCFCAdd::UploadWeights");
