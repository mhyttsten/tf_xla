...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTh() {
      // Check if tracing is enabled
...
class ConvolutionMetal : public GPUOperation {
 public:
  ...
  void GetPossibleKernelWorkGroups(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTh mht_0(mht_0_v, 230, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.h", "GetPossibleKernelWorkGroups");
  ...
  WeightsDescription GetWeightsDescription() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTh mht_1(mht_1_v, 245, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.h", "GetWeightsDescription");
 ...
 private:
  explicit ConvolutionMetal(const OperationDef& definition)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPStasksPSconv_metalDTh mht_2(mht_2_v, 258, "", "./tensorflow/lite/delegates/gpu/common/tasks/conv_metal.h", "ConvolutionMetal");
}
