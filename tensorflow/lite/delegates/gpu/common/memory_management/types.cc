...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPStypesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPStypesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPStypesDTcc() {
      // Check if tracing is enabled
...
void BFS(size_t start, const UsageGraph& deps_graph,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPStypesDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/delegates/gpu/common/memory_management/types.cc", "BFS");
...
UsageGraph ReallocationGraph(const UsageGraph& deps_graph) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPStypesDTcc mht_1(mht_1_v, 222, "", "./tensorflow/lite/delegates/gpu/common/memory_management/types.cc", "ReallocationGraph");
