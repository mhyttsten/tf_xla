...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPSnaive_assignmentDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPSnaive_assignmentDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPSnaive_assignmentDTh() {
      // Check if tracing is enabled
...
absl::Status NaiveAssignment(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementPSnaive_assignmentDTh mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/common/memory_management/naive_assignment.h", "NaiveAssignment");
