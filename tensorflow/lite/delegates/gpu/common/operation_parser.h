...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSoperation_parserDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSoperation_parserDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSoperation_parserDTh() {
      // Check if tracing is enabled
...
void UpdatePadding(const TfLitePadding& padding, const BHWC& input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSoperation_parserDTh mht_0(mht_0_v, 231, "", "./tensorflow/lite/delegates/gpu/common/operation_parser.h", "UpdatePadding");
