...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementDTh() {
      // Check if tracing is enabled
...
absl::Status AssignObjectsToTensors(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPScommonPSmemory_managementDTh mht_0(mht_0_v, 262, "", "./tensorflow/lite/delegates/gpu/common/memory_management.h", "AssignObjectsToTensors");
