...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh() {
      // Check if tracing is enabled
...
class Texture2D : public GPUObject {
 public:
  Texture2D() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh mht_0(mht_0_v, 207, "", "./tensorflow/lite/delegates/gpu/cl/texture2d.h", "Texture2D");
}  // just for using Texture2D as a class members
  ...
  ~Texture2D() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh mht_1(mht_1_v, 219, "", "./tensorflow/lite/delegates/gpu/cl/texture2d.h", "~Texture2D");
 Release(); }

  cl_mem GetMemoryPtr() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh mht_2(mht_2_v, 224, "", "./tensorflow/lite/delegates/gpu/cl/texture2d.h", "GetMemoryPtr");
 return texture_; }
...
absl::Status Texture2D::WriteData(CLCommandQueue* queue,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh mht_3(mht_3_v, 272, "", "./tensorflow/lite/delegates/gpu/cl/texture2d.h", "Texture2D::WriteData");
...
absl::Status Texture2D::ReadData(CLCommandQueue* queue,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPStexture2dDTh mht_4(mht_4_v, 294, "", "./tensorflow/lite/delegates/gpu/cl/texture2d.h", "Texture2D::ReadData");
