...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh() {
      // Check if tracing is enabled
...
class Buffer : public GPUObject {
 public:
  Buffer() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_0(mht_0_v, 206, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "Buffer");
}  // just for using Buffer as a class members
  ...
  ~Buffer() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_1(mht_1_v, 218, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "~Buffer");
 Release(); }

  // for profiling and memory statistics
  uint64_t GetMemorySizeInBytes() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_2(mht_2_v, 224, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "GetMemorySizeInBytes");
 return size_; }

  cl_mem GetMemoryPtr() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_3(mht_3_v, 229, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "GetMemoryPtr");
 return buffer_; }

  bool IsSubBuffer() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_4(mht_4_v, 234, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "IsSubBuffer");
 return is_sub_buffer_; }
...
absl::Status Buffer::WriteData(CLCommandQueue* queue,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_5(mht_5_v, 278, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "Buffer::WriteData");
...
absl::Status Buffer::ReadData(CLCommandQueue* queue,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSbufferDTh mht_6(mht_6_v, 292, "", "./tensorflow/lite/delegates/gpu/cl/buffer.h", "Buffer::ReadData");
