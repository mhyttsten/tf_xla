...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc() {
      // Check if tracing is enabled
...
absl::Status ClExecutionEnvironment::Init() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::Init");
 return CreateEnvironment(&env_); }

std::vector<CalculationsPrecision>
ClExecutionEnvironment::GetSupportedPrecisions() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_1(mht_1_v, 200, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::GetSupportedPrecisions");
...
std::vector<TensorStorageType> ClExecutionEnvironment::GetSupportedStorages(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_2(mht_2_v, 208, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::GetSupportedStorages");
...
ClExecutionEnvironment::GetSupportedStoragesWithHWZeroClampSupport(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_3(mht_3_v, 217, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::GetSupportedStoragesWithHWZeroClampSupport");
...
const GpuInfo& ClExecutionEnvironment::GetGpuInfo() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_4(mht_4_v, 224, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::GetGpuInfo");
...
absl::Status ClExecutionEnvironment::ExecuteGPUOperation(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_5(mht_5_v, 235, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::ExecuteGPUOperation");
...
absl::Status ClExecutionEnvironment::ExecuteGPUOperation(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_6(mht_6_v, 292, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::ExecuteGPUOperation");
...
absl::Status ClExecutionEnvironment::ExecuteGPUOperation(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_7(mht_7_v, 348, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ClExecutionEnvironment::ExecuteGPUOperation");
...
absl::Status ExecuteGPUOperation(const std::vector<TensorFloat32>& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_8(mht_8_v, 402, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ExecuteGPUOperation");
...
absl::Status ExecuteGPUOperation(const std::vector<TensorFloat32>& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_9(mht_9_v, 452, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ExecuteGPUOperation");
...
absl::Status ExecuteGPUOperation(const TensorFloat32& src_cpu,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTcc mht_10(mht_10_v, 465, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.cc", "ExecuteGPUOperation");
