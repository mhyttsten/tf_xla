...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTh() {
      // Check if tracing is enabled
...
class OpenCLOperationTest : public ::testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPScl_testDTh mht_0(mht_0_v, 246, "", "./tensorflow/lite/delegates/gpu/cl/kernels/cl_test.h", "SetUp");
