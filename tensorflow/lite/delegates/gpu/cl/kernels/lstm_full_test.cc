...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc() {
      // Check if tracing is enabled
...
class LSTMOpModel : public SingleOpModel {
 public:
  LSTMOpModel(int n_batch, int n_input, int n_cell, int n_output, bool use_cifg,
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_0(mht_0_v, 233, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "LSTMOpModel");
  ...
  ~LSTMOpModel() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_1(mht_1_v, 344, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "~LSTMOpModel");
 EXPECT_EQ(CountOpsExecutedByCpuKernel(), 0); }

  void SetInput(int offset, const float* begin, const float* end) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_2(mht_2_v, 349, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "SetInput");
  ...
  int num_inputs() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_3(mht_3_v, 359, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "num_inputs");
 return n_input_; }
  int num_outputs() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_4(mht_4_v, 363, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "num_outputs");
 return n_output_; }
  int num_batches() {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_5(mht_5_v, 367, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "num_batches");
 return n_batch_; }
...
class LstmOpTest : public ::testing::TestWithParam<bool> {
 protected:
  ...
  void VerifyGoldens(LSTMOpModel* lstm, float tolerance) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSkernelsPSlstm_full_testDTcc mht_6(mht_6_v, 415, "", "./tensorflow/lite/delegates/gpu/cl/kernels/lstm_full_test.cc", "VerifyGoldens");
