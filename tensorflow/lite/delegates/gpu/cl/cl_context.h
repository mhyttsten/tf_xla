...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_contextDTh() {
      // Check if tracing is enabled
...
class CLContext {
 public:
  CLContext() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_contextDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/delegates/gpu/cl/cl_context.h", "CLContext");
}
  ...
  cl_context context() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_contextDTh mht_1(mht_1_v, 214, "", "./tensorflow/lite/delegates/gpu/cl/cl_context.h", "context");
 return context_; }
