...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_programDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_programDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_programDTh() {
      // Check if tracing is enabled
...
class CLProgram {
 public:
  CLProgram() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_programDTh mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/gpu/cl/cl_program.h", "CLProgram");
}
  ...
  cl_program program() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_programDTh mht_1(mht_1_v, 222, "", "./tensorflow/lite/delegates/gpu/cl/cl_program.h", "program");
 return program_; }
  ...
  cl_device_id GetDeviceId() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_programDTh mht_2(mht_2_v, 231, "", "./tensorflow/lite/delegates/gpu/cl/cl_program.h", "GetDeviceId");
 return device_id_; }
