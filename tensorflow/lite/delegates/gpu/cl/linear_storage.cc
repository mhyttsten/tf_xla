...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc() {
      // Check if tracing is enabled
...
void LinearStorage::Release() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/delegates/gpu/cl/linear_storage.cc", "LinearStorage::Release");
...
LinearStorage::LinearStorage(LinearStorage&& storage)
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc mht_1(mht_1_v, 210, "", "./tensorflow/lite/delegates/gpu/cl/linear_storage.cc", "LinearStorage::LinearStorage");
...
LinearStorage& LinearStorage::operator=(LinearStorage&& storage) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc mht_2(mht_2_v, 217, "", "./tensorflow/lite/delegates/gpu/cl/linear_storage.cc", "=");
...
absl::Status LinearStorage::GetGPUResources(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc mht_3(mht_3_v, 233, "", "./tensorflow/lite/delegates/gpu/cl/linear_storage.cc", "LinearStorage::GetGPUResources");
...
absl::Status LinearStorage::CreateFromTensorLinearDescriptor(
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPSlinear_storageDTcc mht_4(mht_4_v, 256, "", "./tensorflow/lite/delegates/gpu/cl/linear_storage.cc", "LinearStorage::CreateFromTensorLinearDescriptor");
