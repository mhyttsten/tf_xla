...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh() {
      // Check if tracing is enabled
...
class CLKernel {
 public:
  CLKernel() {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh mht_0(mht_0_v, 208, "", "./tensorflow/lite/delegates/gpu/cl/cl_kernel.h", "CLKernel");
}
  ...
  cl_kernel kernel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh mht_1(mht_1_v, 221, "", "./tensorflow/lite/delegates/gpu/cl/cl_kernel.h", "kernel");
 return kernel_; }
  ...
  absl::Status SetBytes(int index, const T& value) const {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh mht_2(mht_2_v, 232, "", "./tensorflow/lite/delegates/gpu/cl/cl_kernel.h", "SetBytes");
  ...
  absl::Status SetBytesAuto(const T& value) {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh mht_3(mht_3_v, 239, "", "./tensorflow/lite/delegates/gpu/cl/cl_kernel.h", "SetBytesAuto");

    return SetBytesAuto(static_cast<const void*>(&value), sizeof(T));
  }

  int GetBindingCounter() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh mht_4(mht_4_v, 246, "", "./tensorflow/lite/delegates/gpu/cl/cl_kernel.h", "GetBindingCounter");
 return binding_counter_; }
  void ResetBindingCounter() {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPSlitePSdelegatesPSgpuPSclPScl_kernelDTh mht_5(mht_5_v, 250, "", "./tensorflow/lite/delegates/gpu/cl/cl_kernel.h", "ResetBindingCounter");
 binding_counter_ = 0; }
