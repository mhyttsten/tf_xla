...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSdelegatesPSutilsPSsimple_delegate_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSutilsPSsimple_delegate_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSdelegatesPSutilsPSsimple_delegate_testDTcc() {
      // Check if tracing is enabled
...
class TestDelegate : public ::testing::Test {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSutilsPSsimple_delegate_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/delegates/utils/simple_delegate_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPSlitePSdelegatesPSutilsPSsimple_delegate_testDTcc mht_1(mht_1_v, 229, "", "./tensorflow/lite/delegates/utils/simple_delegate_test.cc", "TearDown");
 interpreter_.reset(); }
