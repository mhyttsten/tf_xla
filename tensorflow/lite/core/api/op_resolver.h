...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh() {
      // Check if tracing is enabled
...
class OpResolver {
 public:
  ...
  virtual TfLiteDelegatePtrVector GetDelegates(int num_threads) const {
   ...
   MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh mht_0(mht_0_v, 215, "", "./tensorflow/lite/core/api/op_resolver.h", "GetDelegates");
  ...
  virtual TfLiteDelegateCreators GetDelegateCreators() const {
   ...
   MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh mht_1(mht_1_v, 230, "", "./tensorflow/lite/core/api/op_resolver.h", "GetDelegateCreators");
 return {}; }

  virtual ~OpResolver() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh mht_2(mht_2_v, 235, "", "./tensorflow/lite/core/api/op_resolver.h", "~OpResolver");
}
 ...
 private:
  ...
  virtual bool MayContainUserDefinedOps() const {
   ...
   MHTracer_DTPStensorflowPSlitePScorePSapiPSop_resolverDTh mht_3(mht_3_v, 252, "", "./tensorflow/lite/core/api/op_resolver.h", "MayContainUserDefinedOps");
 return true; }
