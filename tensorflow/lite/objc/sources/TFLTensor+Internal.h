...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSobjcPSsourcesPSTFLTensor+InternalDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSobjcPSsourcesPSTFLTensor+InternalDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSobjcPSsourcesPSTFLTensor+InternalDTh() {
      // Check if tracing is enabled
...
typedef NS_ENUM(NSUInteger, TFLTensorType) {
   ...
   MHTracer_DTPStensorflowPSlitePSobjcPSsourcesPSTFLTensor+InternalDTh mht_0(mht_0_v, 194, "", "./tensorflow/lite/objc/sources/TFLTensor+Internal.h", "NS_ENUM");
