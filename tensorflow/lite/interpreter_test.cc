...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc() {
      // Check if tracing is enabled
...
TfLiteRegistration GetPassthroughOpRegistration() {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_0(mht_0_v, 781, "", "./tensorflow/lite/interpreter_test.cc", "GetPassthroughOpRegistration");
  ...
  reg.free = [](TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_1(mht_1_v, 791, "", "./tensorflow/lite/interpreter_test.cc", "lambda");

    delete static_cast<int*>(buffer);
  };
  reg.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_2(mht_2_v, 797, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_3(mht_3_v, 817, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  reg.invoke = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_4(mht_4_v, 832, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_5(mht_5_v, 839, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
TEST(BasicInterpreter, ThreeStepAllocate) {
  ...
  reg_copy.invoke = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_6(mht_6_v, 973, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  reg_len.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_7(mht_7_v, 990, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  reg_len.invoke = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_8(mht_8_v, 1000, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
TEST(BasicInterpreter, AllocateTwice) {
  ...
  reg.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_9(mht_9_v, 1055, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  reg.invoke = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_10(mht_10_v, 1066, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
TEST(BasicInterpreter, TestUnsupportedDelegateFunctions) {
  ...
  registration.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_11(mht_11_v, 1180, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
TEST(InterpreterTensorsCapacityTest, TestWithinHeadroom) {
  ...
  registration.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_12(mht_12_v, 1326, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
TEST(InterpreterTensorsCapacityTest, TestExceedHeadroom) {
  ...
  registration.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_13(mht_13_v, 1349, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
struct TestExternalContext : public TfLiteExternalContext {
  ...
  static TestExternalContext* Get(TfLiteContext* context) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_14(mht_14_v, 1373, "", "./tensorflow/lite/interpreter_test.cc", "Get");
  ...
  static void Set(TfLiteContext* context, TestExternalContext* value) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_15(mht_15_v, 1381, "", "./tensorflow/lite/interpreter_test.cc", "Set");
...
TEST_F(InterpreterTest, GetSetResetExternalContexts) {
  ...
  external_context.Refresh = [](TfLiteContext* context) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_16(mht_16_v, 1395, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
...
struct TestCpuBackendContext : public TfLiteInternalBackendContext {
  ...
  void ClearCaches() override {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_17(mht_17_v, 1437, "", "./tensorflow/lite/interpreter_test.cc", "ClearCaches");
 ++num_calls; }
  void SetMaxNumThreads(int num_threads) override {
   std::vector<std::string> mht_18_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_18(mht_18_v, 1441, "", "./tensorflow/lite/interpreter_test.cc", "SetMaxNumThreads");
}
  int num_calls = 0;
};
...
class TestExecutionPlan : public InterpreterTest {
  ...
  class CallReporting {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_19(mht_19_v, 1477, "", "./tensorflow/lite/interpreter_test.cc", "CallReporting");
}

    void Record() {
   std::vector<std::string> mht_20_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_20(mht_20_v, 1482, "", "./tensorflow/lite/interpreter_test.cc", "Record");
 run_order_->push_back(node_id_); }
  ...
  TfLiteRegistration CopyOpRegistration() {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_21(mht_21_v, 1496, "", "./tensorflow/lite/interpreter_test.cc", "CopyOpRegistration");

    TfLiteRegistration reg = {nullptr, nullptr, nullptr, nullptr};

    reg.prepare = [](TfLiteContext* context, TfLiteNode* node) {
   std::vector<std::string> mht_22_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_22(mht_22_v, 1502, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_23(mht_23_v, 1515, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  void MakeCopyNode(int input, int output) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_24(mht_24_v, 1540, "", "./tensorflow/lite/interpreter_test.cc", "MakeCopyNode");
  ...
  void SetUp() final {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_25(mht_25_v, 1557, "", "./tensorflow/lite/interpreter_test.cc", "SetUp");
...
TEST(TestDelegateOwnership, ProperlyDisposed) {
  struct TfLiteInterpreterOwnedDelegate : public TfLiteDelegate {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_26(mht_26_v, 1618, "", "./tensorflow/lite/interpreter_test.cc", "TfLiteInterpreterOwnedDelegate");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_27(mht_27_v, 1629, "", "./tensorflow/lite/interpreter_test.cc", "~TfLiteInterpreterOwnedDelegate");
 *destroyed = true; }
...
bool CheckCancellation(void* data) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_28(mht_28_v, 1680, "", "./tensorflow/lite/interpreter_test.cc", "CheckCancellation");
...
class CancellationTest : public InterpreterTest {
 public:
  TfLiteStatus Invoke() {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_29(mht_29_v, 1694, "", "./tensorflow/lite/interpreter_test.cc", "Invoke");
 return interpreter_->Invoke(); }
  void Cancel() {
   std::vector<std::string> mht_30_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_30(mht_30_v, 1698, "", "./tensorflow/lite/interpreter_test.cc", "Cancel");
 cancellation_data_.is_cancelled = true; }
  ...
  void MakeCancelNode(int input, int output) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_31(mht_31_v, 1704, "", "./tensorflow/lite/interpreter_test.cc", "MakeCancelNode");
  ...
  void MakeOkNode(int input, int output) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_32(mht_32_v, 1716, "", "./tensorflow/lite/interpreter_test.cc", "MakeOkNode");
 ...
 private:
  ...
  TfLiteRegistration CancelOpRegistration() {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_33(mht_33_v, 1729, "", "./tensorflow/lite/interpreter_test.cc", "CancelOpRegistration");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_34(mht_34_v, 1737, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_35(mht_35_v, 1749, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  TfLiteRegistration OkOpRegistration() {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_36(mht_36_v, 1760, "", "./tensorflow/lite/interpreter_test.cc", "OkOpRegistration");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_37(mht_37_v, 1768, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_38(mht_38_v, 1780, "", "./tensorflow/lite/interpreter_test.cc", "lambda");
  ...
  void SetUp() final {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_39(mht_39_v, 1789, "", "./tensorflow/lite/interpreter_test.cc", "SetUp");
...
class TestCustomAllocation : public InterpreterTest {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_40(mht_40_v, 1838, "", "./tensorflow/lite/interpreter_test.cc", "SetUp");
  ...
  void AssignCustomAllocForTensor(int tensor_idx, int required_alignment) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_41(mht_41_v, 1886, "", "./tensorflow/lite/interpreter_test.cc", "AssignCustomAllocForTensor");
  ...
  void VerifyInvoke() {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_42(mht_42_v, 1897, "", "./tensorflow/lite/interpreter_test.cc", "VerifyInvoke");
  ...
  TfLiteCustomAllocation NewCustomAlloc(size_t num_bytes,
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_43(mht_43_v, 1924, "", "./tensorflow/lite/interpreter_test.cc", "NewCustomAlloc");
  ...
  intptr_t AlignTo(size_t alignment, intptr_t offset) {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_44(mht_44_v, 1938, "", "./tensorflow/lite/interpreter_test.cc", "AlignTo");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_45(mht_45_v, 1946, "", "./tensorflow/lite/interpreter_test.cc", "TearDown");
...
class TestLazyDelegateProvider : public InterpreterTest {
 protected:
  class DummyLazyDelegateKernel : public SimpleDelegateKernelInterface {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_46(mht_46_v, 2296, "", "./tensorflow/lite/interpreter_test.cc", "DummyLazyDelegateKernel");
}
    TfLiteStatus Init(TfLiteContext* context,
                      const TfLiteDelegateParams* params) override {
   std::vector<std::string> mht_47_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_47(mht_47_v, 2301, "", "./tensorflow/lite/interpreter_test.cc", "Init");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_48(mht_48_v, 2308, "", "./tensorflow/lite/interpreter_test.cc", "Prepare");
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_49(mht_49_v, 2315, "", "./tensorflow/lite/interpreter_test.cc", "Eval");
  ...
  class DummyLazyDelegate : public SimpleDelegateInterface {
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_50(mht_50_v, 2329, "", "./tensorflow/lite/interpreter_test.cc", "DummyLazyDelegate");
}
    bool IsNodeSupportedByDelegate(const TfLiteRegistration* registration,
                                   const TfLiteNode* node,
                                   TfLiteContext* context) const override {
   std::vector<std::string> mht_51_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_51(mht_51_v, 2335, "", "./tensorflow/lite/interpreter_test.cc", "IsNodeSupportedByDelegate");

      return true;
    }
    TfLiteStatus Initialize(TfLiteContext* context) override {
   std::vector<std::string> mht_52_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_52(mht_52_v, 2341, "", "./tensorflow/lite/interpreter_test.cc", "Initialize");

      return kTfLiteOk;
    }
    const char* Name() const override {
   std::vector<std::string> mht_53_v;
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_53(mht_53_v, 2347, "", "./tensorflow/lite/interpreter_test.cc", "Name");
 return "DummyLazyDelegateForTest"; }
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_54(mht_54_v, 2356, "", "./tensorflow/lite/interpreter_test.cc", "DelegateOptions");
  ...
  void InitWithLazyDelegate(bool create_dyanmic_tensor = false,
   ...
   MHTracer_DTPStensorflowPSlitePSinterpreter_testDTcc mht_55(mht_55_v, 2368, "", "./tensorflow/lite/interpreter_test.cc", "InitWithLazyDelegate");
