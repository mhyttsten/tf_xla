...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc() {
      // Check if tracing is enabled
...
T AlignTo(size_t alignment, T offset) {
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/simple_memory_arena.cc", "AlignTo");
...
TfLiteStatus SimpleMemoryArena::Allocate(
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_1(mht_1_v, 218, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::Allocate");
...
TfLiteStatus SimpleMemoryArena::Deallocate(
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_2(mht_2_v, 270, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::Deallocate");
...
TfLiteStatus SimpleMemoryArena::Commit(TfLiteContext* context) {
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_3(mht_3_v, 292, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::Commit");
...
TfLiteStatus SimpleMemoryArena::ResolveAlloc(
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_4(mht_4_v, 324, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::ResolveAlloc");
...
TfLiteStatus SimpleMemoryArena::ClearPlan() {
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_5(mht_5_v, 340, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::ClearPlan");
...
TfLiteStatus SimpleMemoryArena::ReleaseBuffer() {
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_6(mht_6_v, 350, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::ReleaseBuffer");
...
TFLITE_ATTRIBUTE_WEAK void DumpArenaInfo(
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_7(mht_7_v, 365, "", "./tensorflow/lite/simple_memory_arena.cc", "DumpArenaInfo");
...
void SimpleMemoryArena::DumpDebugInfo(
   ...
   MHTracer_DTPStensorflowPSlitePSsimple_memory_arenaDTcc mht_8(mht_8_v, 373, "", "./tensorflow/lite/simple_memory_arena.cc", "SimpleMemoryArena::DumpDebugInfo");
