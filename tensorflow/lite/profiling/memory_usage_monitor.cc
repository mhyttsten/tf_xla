...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc() {
      // Check if tracing is enabled
...
MemoryUsageMonitor::MemoryUsageMonitor(int sampling_interval_ms,
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/profiling/memory_usage_monitor.cc", "MemoryUsageMonitor::MemoryUsageMonitor");
...
void MemoryUsageMonitor::Start() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/profiling/memory_usage_monitor.cc", "MemoryUsageMonitor::Start");
...
void MemoryUsageMonitor::Stop() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc mht_2(mht_2_v, 236, "", "./tensorflow/lite/profiling/memory_usage_monitor.cc", "MemoryUsageMonitor::Stop");
...
void MemoryUsageMonitor::StopInternal() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitorDTcc mht_3(mht_3_v, 249, "", "./tensorflow/lite/profiling/memory_usage_monitor.cc", "MemoryUsageMonitor::StopInternal");
