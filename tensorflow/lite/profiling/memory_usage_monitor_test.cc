...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc() {
      // Check if tracing is enabled
...
class MemoryUsageNotSupportedSampler : public MemoryUsageMonitor::Sampler {
 public:
  bool IsSupported() override {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/profiling/memory_usage_monitor_test.cc", "IsSupported");
 return false; }
};
...
class MemoryUsageMonitorTest : public ::testing::Test {
 protected:
  class FakeMemoryUsageSampler : public MemoryUsageMonitor::Sampler {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc mht_1(mht_1_v, 222, "", "./tensorflow/lite/profiling/memory_usage_monitor_test.cc", "FakeMemoryUsageSampler");
}
    bool IsSupported() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc mht_2(mht_2_v, 226, "", "./tensorflow/lite/profiling/memory_usage_monitor_test.cc", "IsSupported");
 return true; }
    MemoryUsage GetMemoryUsage() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc mht_3(mht_3_v, 230, "", "./tensorflow/lite/profiling/memory_usage_monitor_test.cc", "GetMemoryUsage");
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc mht_4(mht_4_v, 238, "", "./tensorflow/lite/profiling/memory_usage_monitor_test.cc", "SleepFor");
  ...
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSmemory_usage_monitor_testDTcc mht_5(mht_5_v, 250, "", "./tensorflow/lite/profiling/memory_usage_monitor_test.cc", "SetUp");
