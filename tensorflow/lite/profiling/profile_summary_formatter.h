...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh() {
      // Check if tracing is enabled
...
class ProfileSummaryFormatter {
 public:
  ProfileSummaryFormatter() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh mht_0(mht_0_v, 202, "", "./tensorflow/lite/profiling/profile_summary_formatter.h", "ProfileSummaryFormatter");
}
  virtual ~ProfileSummaryFormatter() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh mht_1(mht_1_v, 206, "", "./tensorflow/lite/profiling/profile_summary_formatter.h", "~ProfileSummaryFormatter");
}
...
class ProfileSummaryDefaultFormatter : public ProfileSummaryFormatter {
 public:
  ProfileSummaryDefaultFormatter() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh mht_2(mht_2_v, 228, "", "./tensorflow/lite/profiling/profile_summary_formatter.h", "ProfileSummaryDefaultFormatter");
}
  ~ProfileSummaryDefaultFormatter() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh mht_3(mht_3_v, 232, "", "./tensorflow/lite/profiling/profile_summary_formatter.h", "~ProfileSummaryDefaultFormatter");
}
...
class ProfileSummaryCSVFormatter : public ProfileSummaryDefaultFormatter {
 public:
  ProfileSummaryCSVFormatter() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summary_formatterDTh mht_4(mht_4_v, 258, "", "./tensorflow/lite/profiling/profile_summary_formatter.h", "ProfileSummaryCSVFormatter");
}
  tensorflow::StatSummarizerOptions GetStatSummarizerOptions() const override;
};
