...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh() {
      // Check if tracing is enabled
...
class ProfileSummarizer {
 public:
  ...
  virtual ~ProfileSummarizer() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh mht_0(mht_0_v, 206, "", "./tensorflow/lite/profiling/profile_summarizer.h", "~ProfileSummarizer");
}
  ...
  std::string GetOutputString() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh mht_1(mht_1_v, 217, "", "./tensorflow/lite/profiling/profile_summarizer.h", "GetOutputString");
  ...
  std::string GetShortSummary() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh mht_2(mht_2_v, 225, "", "./tensorflow/lite/profiling/profile_summarizer.h", "GetShortSummary");
  ...
  bool HasProfiles() {
   ...
   MHTracer_DTPStensorflowPSlitePSprofilingPSprofile_summarizerDTh mht_3(mht_3_v, 235, "", "./tensorflow/lite/profiling/profile_summarizer.h", "HasProfiles");
