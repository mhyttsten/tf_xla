...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_utilsDTh() {
      // Check if tracing is enabled
...
bool SplitAndParse(const std::string& str, char delim, std::vector<T>* values) {
   ...
   mht_0_v.push_back("delim: '" + std::string(1, delim) + "'");
   MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_utilsDTh mht_0(mht_0_v, 205, "", "./tensorflow/lite/tools/benchmark/benchmark_utils.h", "SplitAndParse");
