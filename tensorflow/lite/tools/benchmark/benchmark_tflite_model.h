...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_tflite_modelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_tflite_modelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_tflite_modelDTh() {
      // Check if tracing is enabled
...
class BenchmarkTfLiteModel : public BenchmarkModel {
 public:
  struct InputLayerInfo {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_tflite_modelDTh mht_0(mht_0_v, 208, "", "./tensorflow/lite/tools/benchmark/benchmark_tflite_model.h", "InputLayerInfo");
}
 ...
 private:
  ...
  void AddOwnedListener(std::unique_ptr<BenchmarkListener> listener) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSbenchmarkPSbenchmark_tflite_modelDTh mht_1(mht_1_v, 273, "", "./tensorflow/lite/tools/benchmark/benchmark_tflite_model.h", "AddOwnedListener");
