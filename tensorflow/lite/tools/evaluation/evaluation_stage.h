...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSevaluation_stageDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSevaluation_stageDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSevaluation_stageDTh() {
      // Check if tracing is enabled
...
class EvaluationStage {
 ...
 protected:
  ...
  explicit EvaluationStage(const EvaluationStageConfig& config)
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSevaluation_stageDTh mht_0(mht_0_v, 225, "", "./tensorflow/lite/tools/evaluation/evaluation_stage.h", "EvaluationStage");
}
