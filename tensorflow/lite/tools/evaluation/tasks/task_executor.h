...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPStasksPStask_executorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPStasksPStask_executorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPStasksPStask_executorDTh() {
      // Check if tracing is enabled
...
class TaskExecutor {
 public:
  virtual ~TaskExecutor() {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPStasksPStask_executorDTh mht_0(mht_0_v, 198, "", "./tensorflow/lite/tools/evaluation/tasks/task_executor.h", "~TaskExecutor");
}
