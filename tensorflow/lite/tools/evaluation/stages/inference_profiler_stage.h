...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stageDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stageDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stageDTh() {
      // Check if tracing is enabled
...
class InferenceProfilerStage : public EvaluationStage {
 public:
  explicit InferenceProfilerStage(const EvaluationStageConfig& config)
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stageDTh mht_0(mht_0_v, 210, "", "./tensorflow/lite/tools/evaluation/stages/inference_profiler_stage.h", "InferenceProfilerStage");
}

  TfLiteStatus Init() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stageDTh mht_1(mht_1_v, 215, "", "./tensorflow/lite/tools/evaluation/stages/inference_profiler_stage.h", "Init");
 return Init(nullptr); }
