...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh() {
      // Check if tracing is enabled
...
class TopkAccuracyEvalStage : public EvaluationStage {
 public:
  explicit TopkAccuracyEvalStage(const EvaluationStageConfig& config)
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh mht_0(mht_0_v, 203, "", "./tensorflow/lite/tools/evaluation/stages/topk_accuracy_eval_stage.h", "TopkAccuracyEvalStage");
}
  ...
  ~TopkAccuracyEvalStage() {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh mht_1(mht_1_v, 214, "", "./tensorflow/lite/tools/evaluation/stages/topk_accuracy_eval_stage.h", "~TopkAccuracyEvalStage");
}
  ...
  void SetTaskInfo(const std::vector<std::string>& all_labels,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh mht_2(mht_2_v, 224, "", "./tensorflow/lite/tools/evaluation/stages/topk_accuracy_eval_stage.h", "SetTaskInfo");
  ...
  void SetEvalInputs(void* model_raw_output, std::string* ground_truth_label) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPStopk_accuracy_eval_stageDTh mht_3(mht_3_v, 236, "", "./tensorflow/lite/tools/evaluation/stages/topk_accuracy_eval_stage.h", "SetEvalInputs");
