...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stage_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stage_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stage_testDTcc() {
      // Check if tracing is enabled
...
EvaluationStageConfig GetInferenceProfilerStageConfig(int num_threads = 1) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSinference_profiler_stage_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/tools/evaluation/stages/inference_profiler_stage_test.cc", "GetInferenceProfilerStageConfig");
