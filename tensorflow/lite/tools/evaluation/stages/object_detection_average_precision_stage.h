...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSobject_detection_average_precision_stageDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSobject_detection_average_precision_stageDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSobject_detection_average_precision_stageDTh() {
      // Check if tracing is enabled
...
class ObjectDetectionAveragePrecisionStage : public EvaluationStage {
 public:
  explicit ObjectDetectionAveragePrecisionStage(
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSobject_detection_average_precision_stageDTh mht_0(mht_0_v, 205, "", "./tensorflow/lite/tools/evaluation/stages/object_detection_average_precision_stage.h", "ObjectDetectionAveragePrecisionStage");
}
  ...
  void SetEvalInputs(const ObjectDetectionResult& predicted_objects,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSevaluationPSstagesPSobject_detection_average_precision_stageDTh mht_1(mht_1_v, 218, "", "./tensorflow/lite/tools/evaluation/stages/object_detection_average_precision_stage.h", "SetEvalInputs");
