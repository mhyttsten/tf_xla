...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSlist_flex_ops_no_kernelDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSlist_flex_ops_no_kernelDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSlist_flex_ops_no_kernelDTcc() {
      // Check if tracing is enabled
...
std::string OpListToJSONString(const OpKernelSet& flex_ops) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSlist_flex_ops_no_kernelDTcc mht_0(mht_0_v, 191, "", "./tensorflow/lite/tools/list_flex_ops_no_kernel.cc", "OpListToJSONString");
...
void AddFlexOpsFromModel(const tflite::Model* model, OpKernelSet* flex_ops) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSlist_flex_ops_no_kernelDTcc mht_1(mht_1_v, 202, "", "./tensorflow/lite/tools/list_flex_ops_no_kernel.cc", "AddFlexOpsFromModel");
