...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSgen_op_registrationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSgen_op_registrationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSgen_op_registrationDTcc() {
      // Check if tracing is enabled
...
string NormalizeCustomOpName(const string& op) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSgen_op_registrationDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/tools/gen_op_registration.cc", "NormalizeCustomOpName");
...
void ReadOpsFromModel(const ::tflite::Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSgen_op_registrationDTcc mht_1(mht_1_v, 208, "", "./tensorflow/lite/tools/gen_op_registration.cc", "ReadOpsFromModel");
