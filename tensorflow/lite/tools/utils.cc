...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSutilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSutilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSutilsDTcc() {
      // Check if tracing is enabled
...
std::mt19937* get_random_engine() {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSutilsDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/tools/utils.cc", "get_random_engine");
...
InputTensorData CreateRandomTensorData(const TfLiteTensor& tensor,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSutilsDTcc mht_1(mht_1_v, 231, "", "./tensorflow/lite/tools/utils.cc", "CreateRandomTensorData");
...
void GetDataRangesForType(TfLiteType type, float* low_range,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSutilsDTcc mht_2(mht_2_v, 326, "", "./tensorflow/lite/tools/utils.cc", "GetDataRangesForType");
