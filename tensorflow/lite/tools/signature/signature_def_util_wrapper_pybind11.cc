...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_util_wrapper_pybind11DTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_util_wrapper_pybind11DTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_util_wrapper_pybind11DTcc() {
      // Check if tracing is enabled
...
py::bytes WrappedSetSignatureDefMap(
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_util_wrapper_pybind11DTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/tools/signature/signature_def_util_wrapper_pybind11.cc", "WrappedSetSignatureDefMap");
...
py::bytes WrappedClearSignatureDefs(const std::vector<uint8_t>& model_buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_util_wrapper_pybind11DTcc mht_1(mht_1_v, 241, "", "./tensorflow/lite/tools/signature/signature_def_util_wrapper_pybind11.cc", "WrappedClearSignatureDefs");
