...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc() {
      // Check if tracing is enabled
...
const Metadata* GetSignatureDefMetadata(const Model* model) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/tools/signature/signature_def_util.cc", "GetSignatureDefMetadata");
...
Status ReadSignatureDefMap(const Model* model, const Metadata* metadata,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc mht_1(mht_1_v, 221, "", "./tensorflow/lite/tools/signature/signature_def_util.cc", "ReadSignatureDefMap");
...
Status SetSignatureDefMap(const Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc mht_2(mht_2_v, 244, "", "./tensorflow/lite/tools/signature/signature_def_util.cc", "SetSignatureDefMap");
...
bool HasSignatureDef(const Model* model, const std::string& signature_key) {
   ...
   mht_3_v.push_back("signature_key: \"" + signature_key + "\"");
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc mht_3(mht_3_v, 287, "", "./tensorflow/lite/tools/signature/signature_def_util.cc", "HasSignatureDef");
...
Status GetSignatureDefMap(const Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc mht_4(mht_4_v, 307, "", "./tensorflow/lite/tools/signature/signature_def_util.cc", "GetSignatureDefMap");
...
Status ClearSignatureDefMap(const Model* model, std::string* model_data) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSsignaturePSsignature_def_utilDTcc mht_5(mht_5_v, 336, "", "./tensorflow/lite/tools/signature/signature_def_util.cc", "ClearSignatureDefMap");
