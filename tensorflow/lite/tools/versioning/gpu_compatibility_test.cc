...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSgpu_compatibility_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSgpu_compatibility_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSgpu_compatibility_testDTcc() {
      // Check if tracing is enabled
...
absl::Status CheckGpuDelegateCompatibility(const tflite::Model* model) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSgpu_compatibility_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/tools/versioning/gpu_compatibility_test.cc", "CheckGpuDelegateCompatibility");
