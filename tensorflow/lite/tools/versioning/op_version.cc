...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc() {
      // Check if tracing is enabled
...
bool NeedBroadcastForBinaryInputs(const OpSignature& op_sig) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/tools/versioning/op_version.cc", "NeedBroadcastForBinaryInputs");
...
int GetInputMaxDims(const OpSignature& op_sig) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc mht_1(mht_1_v, 214, "", "./tensorflow/lite/tools/versioning/op_version.cc", "GetInputMaxDims");
...
int GetBuiltinOperatorVersion(const OpSignature& op_sig) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc mht_2(mht_2_v, 229, "", "./tensorflow/lite/tools/versioning/op_version.cc", "GetBuiltinOperatorVersion");
...
void UpdateOpVersion(uint8_t* model_buffer_pointer) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSversioningPSop_versionDTcc mht_3(mht_3_v, 1021, "", "./tensorflow/lite/tools/versioning/op_version.cc", "UpdateOpVersion");
