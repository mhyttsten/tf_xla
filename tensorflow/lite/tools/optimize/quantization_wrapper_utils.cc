...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc() {
      // Check if tracing is enabled
...
string CreateTensorName(int op_index, int tensor_index) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc mht_0(mht_0_v, 211, "", "./tensorflow/lite/tools/optimize/quantization_wrapper_utils.cc", "CreateTensorName");
...
bool IntermediateTensorExists(ModelT* model) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc mht_1(mht_1_v, 219, "", "./tensorflow/lite/tools/optimize/quantization_wrapper_utils.cc", "IntermediateTensorExists");
...
TfLiteStatus LoadModel(const string& path, ModelT* model) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc mht_2(mht_2_v, 238, "", "./tensorflow/lite/tools/optimize/quantization_wrapper_utils.cc", "LoadModel");
...
TfLiteStatus AddIntermediateTensorsToFusedOp(
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc mht_3(mht_3_v, 255, "", "./tensorflow/lite/tools/optimize/quantization_wrapper_utils.cc", "AddIntermediateTensorsToFusedOp");
...
bool WriteFile(const std::string& out_file, const uint8_t* bytes,
   ...
   mht_4_v.push_back("out_file: \"" + out_file + "\"");
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapper_utilsDTcc mht_4(mht_4_v, 305, "", "./tensorflow/lite/tools/optimize/quantization_wrapper_utils.cc", "WriteFile");
