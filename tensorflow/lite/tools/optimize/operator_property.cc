...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSoperator_propertyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSoperator_propertyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSoperator_propertyDTcc() {
      // Check if tracing is enabled
...
const OpVariant GetOperatorVariant(const ModelT* model, int subgraph_index,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSoperator_propertyDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/tools/optimize/operator_property.cc", "GetOperatorVariant");
...
OperatorProperty GetOperatorProperty(const ModelT* model, int subgraph_index,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSoperator_propertyDTcc mht_1(mht_1_v, 228, "", "./tensorflow/lite/tools/optimize/operator_property.cc", "GetOperatorProperty");
...
OperatorProperty GetOperatorProperty(OpVariant op_variant) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSoperator_propertyDTcc mht_2(mht_2_v, 239, "", "./tensorflow/lite/tools/optimize/operator_property.cc", "GetOperatorProperty");
