...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapperDTcc() {
      // Check if tracing is enabled
...
bool CreateModelForCalibration(const std::string& input_path,
   ...
   mht_0_v.push_back("input_path: \"" + input_path + "\"");
   mht_0_v.push_back("output_path: \"" + output_path + "\"");
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapperDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/tools/optimize/quantization_wrapper.cc", "CreateModelForCalibration");
...
bool CreateQuantizedModel(const std::string& path) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePSquantization_wrapperDTcc mht_1(mht_1_v, 211, "", "./tensorflow/lite/tools/optimize/quantization_wrapper.cc", "CreateQuantizedModel");
