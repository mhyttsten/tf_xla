...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc() {
      // Check if tracing is enabled
...
inline void LstmStepWithAuxInput(
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc mht_0(mht_0_v, 238, "", "./tensorflow/lite/tools/optimize/calibration/custom_logging_ops/lstm.cc", "LstmStepWithAuxInput");
...
TfLiteStatus EvalFloat(
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc mht_1(mht_1_v, 541, "", "./tensorflow/lite/tools/optimize/calibration/custom_logging_ops/lstm.cc", "EvalFloat");
...
TfLiteStatus lstm_eval(TfLiteContext* context, const int subgraph_index,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc mht_2(mht_2_v, 720, "", "./tensorflow/lite/tools/optimize/calibration/custom_logging_ops/lstm.cc", "lstm_eval");
...
TfLiteStatus lstm_logging_kernel(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScustom_logging_opsPSlstmDTcc mht_3(mht_3_v, 834, "", "./tensorflow/lite/tools/optimize/calibration/custom_logging_ops/lstm.cc", "lstm_logging_kernel");
