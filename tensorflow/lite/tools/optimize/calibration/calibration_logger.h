...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTh() {
      // Check if tracing is enabled
...
class MinMax {
 public:
  ...
  bool HasValues() const {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTh mht_0(mht_0_v, 202, "", "./tensorflow/lite/tools/optimize/calibration/calibration_logger.h", "HasValues");
 return has_values_; }

  TfLiteStatus Get(float* min_val, float* max_val) const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTh mht_1(mht_1_v, 207, "", "./tensorflow/lite/tools/optimize/calibration/calibration_logger.h", "Get");
...
class Logger {
 public:
  ...
  TfLiteStatus LogTensorValue(int subgraph_index, int tensor_index,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTh mht_2(mht_2_v, 229, "", "./tensorflow/lite/tools/optimize/calibration/calibration_logger.h", "LogTensorValue");
