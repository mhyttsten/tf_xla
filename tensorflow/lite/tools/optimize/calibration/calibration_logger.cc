...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus MinMax::Update(const float* values, size_t tensor_size,
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_loggerDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/tools/optimize/calibration/calibration_logger.cc", "MinMax::Update");
