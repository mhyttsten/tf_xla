...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibrator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibrator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibrator_testDTcc() {
      // Check if tracing is enabled
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibrator_testDTcc mht_0(mht_0_v, 785, "", "./tensorflow/lite/tools/optimize/calibration/calibrator_test.cc", "main");
