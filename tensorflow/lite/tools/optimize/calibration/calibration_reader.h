...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_readerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_readerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_readerDTh() {
      // Check if tracing is enabled
...
class CalibrationReader {
 public:
  ...
  explicit CalibrationReader(const Logger* logger) : logger_(logger) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_readerDTh mht_0(mht_0_v, 204, "", "./tensorflow/lite/tools/optimize/calibration/calibration_reader.h", "CalibrationReader");
}
  ...
  virtual ~CalibrationReader() {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSoptimizePScalibrationPScalibration_readerDTh mht_1(mht_1_v, 220, "", "./tensorflow/lite/tools/optimize/calibration/calibration_reader.h", "~CalibrationReader");
}
