...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSstrip_buffersPSreconstitute_buffers_into_fbDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSstrip_buffersPSreconstitute_buffers_into_fbDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSstrip_buffersPSreconstitute_buffers_into_fbDTcc() {
      // Check if tracing is enabled
...
int Main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSstrip_buffersPSreconstitute_buffers_into_fbDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/tools/strip_buffers/reconstitute_buffers_into_fb.cc", "Main");
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSstrip_buffersPSreconstitute_buffers_into_fbDTcc mht_1(mht_1_v, 254, "", "./tensorflow/lite/tools/strip_buffers/reconstitute_buffers_into_fb.cc", "main");
