...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStoolsPSverifierDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSverifierDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStoolsPSverifierDTh() {
      // Check if tracing is enabled
...
class AlwaysTrueResolver : public OpResolver {
 public:
  AlwaysTrueResolver() {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSverifierDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/tools/verifier.h", "AlwaysTrueResolver");
}
  const TfLiteRegistration* FindOp(tflite::BuiltinOperator op,
                                   int version) const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePStoolsPSverifierDTh mht_1(mht_1_v, 204, "", "./tensorflow/lite/tools/verifier.h", "FindOp");
  ...
  const TfLiteRegistration* FindOp(const char* op, int version) const override {
   ...
   MHTracer_DTPStensorflowPSlitePStoolsPSverifierDTh mht_2(mht_2_v, 213, "", "./tensorflow/lite/tools/verifier.h", "FindOp");
