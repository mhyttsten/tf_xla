...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc() {
      // Check if tracing is enabled
...
bool IsControlFlowOp(const std::string& tensorflow_op) {
   ...
   mht_0_v.push_back("tensorflow_op: \"" + tensorflow_op + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_0(mht_0_v, 226, "", "./tensorflow/lite/toco/tflite/export.cc", "IsControlFlowOp");
...
bool IsUnsupportedFlexOp(const std::string& tensorflow_op) {
   ...
   mht_1_v.push_back("tensorflow_op: \"" + tensorflow_op + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_1(mht_1_v, 246, "", "./tensorflow/lite/toco/tflite/export.cc", "IsUnsupportedFlexOp");
...
void WriteModelToString(const flatbuffers::FlatBufferBuilder& builder,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_2(mht_2_v, 280, "", "./tensorflow/lite/toco/tflite/export.cc", "WriteModelToString");
...
OperatorKey::OperatorKey(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_3(mht_3_v, 296, "", "./tensorflow/lite/toco/tflite/export.cc", "OperatorKey::OperatorKey");
...
void LoadTensorsMap(const Model& model, TensorsMap* tensors_map) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_4(mht_4_v, 360, "", "./tensorflow/lite/toco/tflite/export.cc", "LoadTensorsMap");
...
void LoadOperatorsMap(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_5(mht_5_v, 381, "", "./tensorflow/lite/toco/tflite/export.cc", "LoadOperatorsMap");
...
Offset<Vector<Offset<Operator>>> ExportOperators(
  ...
  auto is_tflite_builtin = [](const BaseOperator* op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_6(mht_6_v, 533, "", "./tensorflow/lite/toco/tflite/export.cc", "lambda");
...
tensorflow::Status Export(const Model& model, std::string* output_file_contents,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_7(mht_7_v, 625, "", "./tensorflow/lite/toco/tflite/export.cc", "Export");
...
void ParseControlFlowErrors(std::set<std::string>* custom_ops,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_8(mht_8_v, 634, "", "./tensorflow/lite/toco/tflite/export.cc", "ParseControlFlowErrors");
...
tensorflow::Status Export(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_9(mht_9_v, 683, "", "./tensorflow/lite/toco/tflite/export.cc", "Export");
  ...
  if (!custom_ops.empty()) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexportDTcc mht_10(mht_10_v, 744, "", "./tensorflow/lite/toco/tflite/export.cc", "lambda");
