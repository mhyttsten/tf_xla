...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStflitePScustom_operatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePScustom_operatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStflitePScustom_operatorDTh() {
      // Check if tracing is enabled
...
class CustomOperator : public BaseOperator {
 public:
  ...
  virtual void WriteOptions(const TocoOperator& op,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePScustom_operatorDTh mht_0(mht_0_v, 210, "", "./tensorflow/lite/toco/tflite/custom_operator.h", "WriteOptions");
}
  ...
  virtual void ReadOptions(const flexbuffers::Map& m, TocoOperator* op) const {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePScustom_operatorDTh mht_1(mht_1_v, 217, "", "./tensorflow/lite/toco/tflite/custom_operator.h", "ReadOptions");
}

  Options Serialize(const Operator& op,
                    flatbuffers::FlatBufferBuilder* builder) const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePStocoPStflitePScustom_operatorDTh mht_2(mht_2_v, 223, "", "./tensorflow/lite/toco/tflite/custom_operator.h", "Serialize");
