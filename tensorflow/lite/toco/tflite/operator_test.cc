...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc() {
      // Check if tracing is enabled
...
class OperatorTest : public ::testing::Test {
 protected:
  ...
  const BaseOperator& GetOperator(const std::string& name, OperatorType type) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "GetOperator");
  ...
  void CheckSimpleOperator(const std::string& name, OperatorType type) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_1(mht_1_v, 263, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "CheckSimpleOperator");
  ...
  void CheckReducerOperator(const std::string& name, OperatorType type) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_2(mht_2_v, 280, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "CheckReducerOperator");
...
void SimpleVersioningTest() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_3(mht_3_v, 977, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "SimpleVersioningTest");
...
void SimpleOutputVersioningTest() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_4(mht_4_v, 1002, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "SimpleOutputVersioningTest");
...
void SimpleMulVersioningTest(ArrayDataType data_type, float multiplier,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_5(mht_5_v, 1222, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "SimpleMulVersioningTest");
...
void SimpleTwoInputsVersioningTest(ArrayDataType data_type, Shape shape1,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSoperator_testDTcc mht_6(mht_6_v, 1256, "", "./tensorflow/lite/toco/tflite/operator_test.cc", "SimpleTwoInputsVersioningTest");
