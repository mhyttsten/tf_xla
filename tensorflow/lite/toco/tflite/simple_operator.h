...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh() {
      // Check if tracing is enabled
...
class SimpleOperator : public BaseOperator {
 public:
  ...
  SimpleOperator(::tflite::BuiltinOperator op, OperatorType type)
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh mht_0(mht_0_v, 207, "", "./tensorflow/lite/toco/tflite/simple_operator.h", "SimpleOperator");
}

  Options Serialize(const Operator& op,
                    flatbuffers::FlatBufferBuilder* builder) const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh mht_1(mht_1_v, 213, "", "./tensorflow/lite/toco/tflite/simple_operator.h", "Serialize");
  ...
  int GetVersion(const OperatorSignature& op_signature) const override {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh mht_2(mht_2_v, 225, "", "./tensorflow/lite/toco/tflite/simple_operator.h", "GetVersion");
  ...
  ::tflite::BuiltinOperator builtin_op() const {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSsimple_operatorDTh mht_3(mht_3_v, 233, "", "./tensorflow/lite/toco/tflite/simple_operator.h", "builtin_op");
 return builtin_op_; }
