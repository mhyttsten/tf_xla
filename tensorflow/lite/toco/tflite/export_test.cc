...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc() {
      // Check if tracing is enabled
...
class ExportTest : public ::testing::Test {
 protected:
  void ResetOperators() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/toco/tflite/export_test.cc", "ResetOperators");
 input_model_.operators.clear(); }
  void AddTensorsByName(std::initializer_list<std::string> names) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/lite/toco/tflite/export_test.cc", "AddTensorsByName");
  ...
  void AddOperatorsByName(std::initializer_list<std::string> names) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_2(mht_2_v, 218, "", "./tensorflow/lite/toco/tflite/export_test.cc", "AddOperatorsByName");
  ...
  void BuildQuantizableTestModel() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_3(mht_3_v, 280, "", "./tensorflow/lite/toco/tflite/export_test.cc", "BuildQuantizableTestModel");
  ...
  tensorflow::Status ExportAndReturnStatus(const ExportParams& params) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_4(mht_4_v, 337, "", "./tensorflow/lite/toco/tflite/export_test.cc", "ExportAndReturnStatus");
...
class OpSetsTest : public ExportTest {
 public:
  ...
  void SetAllowedOpSets(std::initializer_list<OpSet> sets) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_5(mht_5_v, 611, "", "./tensorflow/lite/toco/tflite/export_test.cc", "SetAllowedOpSets");
...
class FakeConvolutionOperator
 ...
 public:
  FakeConvolutionOperator()
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_6(mht_6_v, 712, "", "./tensorflow/lite/toco/tflite/export_test.cc", "FakeConvolutionOperator");
}

  // Returning the op version according to the op parameters.
  int GetVersion(const OperatorSignature& op_signature) const override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_7(mht_7_v, 718, "", "./tensorflow/lite/toco/tflite/export_test.cc", "GetVersion");
  ...
  void ReadOptions(const TfLiteOptions& options,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_8(mht_8_v, 750, "", "./tensorflow/lite/toco/tflite/export_test.cc", "ReadOptions");
...
class VersionedOpExportTest : public ::testing::Test {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_9(mht_9_v, 766, "", "./tensorflow/lite/toco/tflite/export_test.cc", "SetUp");
  ...
  void AddConvOp(bool use_dilation) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStflitePSexport_testDTcc mht_10(mht_10_v, 774, "", "./tensorflow/lite/toco/tflite/export_test.cc", "AddConvOp");
