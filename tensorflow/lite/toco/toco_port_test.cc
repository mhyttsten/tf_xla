...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStoco_port_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_port_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStoco_port_testDTcc() {
      // Check if tracing is enabled
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_port_testDTcc mht_0(mht_0_v, 230, "", "./tensorflow/lite/toco/toco_port_test.cc", "main");
