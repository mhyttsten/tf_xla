...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSallocate_transient_arraysDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSallocate_transient_arraysDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSallocate_transient_arraysDTh() {
      // Check if tracing is enabled
...
inline std::size_t RoundUpToNextMultipleOf(std::size_t dividend,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSallocate_transient_arraysDTh mht_0(mht_0_v, 204, "", "./tensorflow/lite/toco/allocate_transient_arrays.h", "RoundUpToNextMultipleOf");
