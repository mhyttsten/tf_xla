...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_rangeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_rangeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_rangeDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ResolveConstantRange::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_rangeDTcc mht_0(mht_0_v, 214, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_range.cc", "ResolveConstantRange::Run");
