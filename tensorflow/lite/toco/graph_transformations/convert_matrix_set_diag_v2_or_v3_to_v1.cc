...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_matrix_set_diag_v2_or_v3_to_v1DTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_matrix_set_diag_v2_or_v3_to_v1DTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_matrix_set_diag_v2_or_v3_to_v1DTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ConvertMatrixSetDiagV2OrV3ToV1::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_matrix_set_diag_v2_or_v3_to_v1DTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/toco/graph_transformations/convert_matrix_set_diag_v2_or_v3_to_v1.cc", "ConvertMatrixSetDiagV2OrV3ToV1::Run");
