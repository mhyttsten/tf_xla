...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_nearest_upsampleDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_nearest_upsampleDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_nearest_upsampleDTcc() {
      // Check if tracing is enabled
...
void CopyShape(const std::vector<int>& new_shape, Array* array) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_nearest_upsampleDTcc mht_0(mht_0_v, 221, "", "./tensorflow/lite/toco/graph_transformations/identify_nearest_upsample.cc", "CopyShape");
...
std::vector<std::unique_ptr<Operator>>::iterator FindOperator(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_nearest_upsampleDTcc mht_1(mht_1_v, 242, "", "./tensorflow/lite/toco/graph_transformations/identify_nearest_upsample.cc", "FindOperator");
...
::tensorflow::Status IdentifyNearestUpsample::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_nearest_upsampleDTcc mht_2(mht_2_v, 258, "", "./tensorflow/lite/toco/graph_transformations/identify_nearest_upsample.cc", "IdentifyNearestUpsample::Run");
