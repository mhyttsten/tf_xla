...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_reduce_attributesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_reduce_attributesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_reduce_attributesDTcc() {
      // Check if tracing is enabled
...
bool ResolveAttributes(Model* model, T* op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_reduce_attributesDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/toco/graph_transformations/resolve_reduce_attributes.cc", "ResolveAttributes");
...
::tensorflow::Status ResolveReduceAttributes::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_reduce_attributesDTcc mht_1(mht_1_v, 221, "", "./tensorflow/lite/toco/graph_transformations/resolve_reduce_attributes.cc", "ResolveReduceAttributes::Run");
