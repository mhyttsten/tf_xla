...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_fillDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_fillDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_fillDTcc() {
      // Check if tracing is enabled
...
bool ComputeFillArray(Model* model, FillOperator* op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_fillDTcc mht_0(mht_0_v, 194, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_fill.cc", "ComputeFillArray");
...
::tensorflow::Status ResolveConstantFill::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_fillDTcc mht_1(mht_1_v, 218, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_fill.cc", "ResolveConstantFill::Run");
