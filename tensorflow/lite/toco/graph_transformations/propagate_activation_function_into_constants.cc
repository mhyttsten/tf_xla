...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_activation_function_into_constantsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_activation_function_into_constantsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_activation_function_into_constantsDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status PropagateActivationFunctionIntoConstants::Run(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_activation_function_into_constantsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/propagate_activation_function_into_constants.cc", "PropagateActivationFunctionIntoConstants::Run");
