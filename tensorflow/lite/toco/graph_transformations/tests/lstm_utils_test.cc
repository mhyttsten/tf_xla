...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc() {
      // Check if tracing is enabled
...
class CopyArrayDataTest : public ::testing::Test {
 public:
  CopyArrayDataTest() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/lite/toco/graph_transformations/tests/lstm_utils_test.cc", "CopyArrayDataTest");
}
  ...
  void PrepareBuffers(Model* model, std::initializer_list<float> src_data,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc mht_1(mht_1_v, 220, "", "./tensorflow/lite/toco/graph_transformations/tests/lstm_utils_test.cc", "PrepareBuffers");
  ...
  Buffer<ArrayDataType::kFloat>* GetSrcBuffer() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc mht_2(mht_2_v, 236, "", "./tensorflow/lite/toco/graph_transformations/tests/lstm_utils_test.cc", "GetSrcBuffer");
 return src_buffer_; }
  Buffer<ArrayDataType::kFloat>* GetDstBuffer() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc mht_3(mht_3_v, 240, "", "./tensorflow/lite/toco/graph_transformations/tests/lstm_utils_test.cc", "GetDstBuffer");
 return dst_buffer_; }

  void PopulateBuffer(Buffer<ArrayDataType::kFloat>* buffer,
                      const std::vector<float>& init_data) {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc mht_4(mht_4_v, 246, "", "./tensorflow/lite/toco/graph_transformations/tests/lstm_utils_test.cc", "PopulateBuffer");
  ...
  void UpdateBuffer(Buffer<ArrayDataType::kFloat>* buffer,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSlstm_utils_testDTcc mht_5(mht_5_v, 255, "", "./tensorflow/lite/toco/graph_transformations/tests/lstm_utils_test.cc", "UpdateBuffer");
