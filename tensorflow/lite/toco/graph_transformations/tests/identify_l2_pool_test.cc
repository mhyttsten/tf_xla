...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSidentify_l2_pool_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSidentify_l2_pool_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSidentify_l2_pool_testDTcc() {
      // Check if tracing is enabled
...
void RunIdentifyL2Pool(const std::vector<float>& input,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSidentify_l2_pool_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/tests/identify_l2_pool_test.cc", "RunIdentifyL2Pool");
