...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc() {
      // Check if tracing is enabled
...
class FuseBinaryIntoPrecedingAffineTest : public ::testing::Test {
 protected:
  FuseBinaryIntoPrecedingAffineTest() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/lite/toco/graph_transformations/tests/fuse_binary_into_preceding_affine_test.cc", "FuseBinaryIntoPrecedingAffineTest");
}

  void SetUp() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc mht_1(mht_1_v, 216, "", "./tensorflow/lite/toco/graph_transformations/tests/fuse_binary_into_preceding_affine_test.cc", "SetUp");
 model_.reset(new Model); }

  void CreateArray(const std::string& name, const std::vector<int>& shape) {
   std::vector<std::string> mht_2_v;
   mht_2_v.push_back("name: \"" + name + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc mht_2(mht_2_v, 222, "", "./tensorflow/lite/toco/graph_transformations/tests/fuse_binary_into_preceding_affine_test.cc", "CreateArray");
  ...
  void CreateConstantArray(const std::string& name,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPStestsPSfuse_binary_into_preceding_affine_testDTcc mht_3(mht_3_v, 235, "", "./tensorflow/lite/toco/graph_transformations/tests/fuse_binary_into_preceding_affine_test.cc", "CreateConstantArray");
