...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSunfuse_activation_functionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSunfuse_activation_functionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSunfuse_activation_functionsDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status UnfuseActivationFunctions::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSunfuse_activation_functionsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/unfuse_activation_functions.cc", "UnfuseActivationFunctions::Run");
