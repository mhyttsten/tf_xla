...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_min_maxDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_min_maxDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_min_maxDTcc() {
      // Check if tracing is enabled
...
bool IsTrivialMinMax(GraphTransformation* transformation, const Model& model,
   ...
   mht_0_v.push_back("clamp_value_array_name: \"" + clamp_value_array_name + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_min_maxDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_quantized_min_max.cc", "IsTrivialMinMax");
...
::tensorflow::Status RemoveTrivialQuantizedMinMax::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_min_maxDTcc mht_1(mht_1_v, 248, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_quantized_min_max.cc", "RemoveTrivialQuantizedMinMax::Run");
