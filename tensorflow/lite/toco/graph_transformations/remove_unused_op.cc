...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_unused_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_unused_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_unused_opDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status RemoveUnusedOp::Run(Model* model, std::size_t op_index,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_unused_opDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/toco/graph_transformations/remove_unused_op.cc", "RemoveUnusedOp::Run");
