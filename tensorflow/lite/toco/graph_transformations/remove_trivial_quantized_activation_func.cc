...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_activation_funcDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_activation_funcDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_activation_funcDTcc() {
      // Check if tracing is enabled
...
bool IsTrivialUnfusedActivationFunc(GraphTransformation* transformation,
   ...
   mht_0_v.push_back("input_array_name: \"" + input_array_name + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_activation_funcDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_quantized_activation_func.cc", "IsTrivialUnfusedActivationFunc");
...
bool IsTrivialFusedActivationFunc(
   ...
   mht_1_v.push_back("output_array_name: \"" + output_array_name + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_activation_funcDTcc mht_1(mht_1_v, 237, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_quantized_activation_func.cc", "IsTrivialFusedActivationFunc");
...
::tensorflow::Status RemoveTrivialQuantizedActivationFunc::Run(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_quantized_activation_funcDTcc mht_2(mht_2_v, 275, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_quantized_activation_func.cc", "RemoveTrivialQuantizedActivationFunc::Run");
