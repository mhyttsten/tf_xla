...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_sliceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_sliceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_sliceDTcc() {
      // Check if tracing is enabled
...
bool Slice(SliceOperator const& op, Array const& input_array,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_sliceDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_slice.cc", "Slice");
...
::tensorflow::Status ResolveConstantSlice::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_sliceDTcc mht_1(mht_1_v, 263, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_slice.cc", "ResolveConstantSlice::Run");
