...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSreorder_elementwise_unaryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSreorder_elementwise_unaryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSreorder_elementwise_unaryDTcc() {
      // Check if tracing is enabled
...
bool IsElementwiseOperator(OperatorType optype) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSreorder_elementwise_unaryDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/reorder_elementwise_unary.cc", "IsElementwiseOperator");
...
bool IsMoveOperator(OperatorType optype) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSreorder_elementwise_unaryDTcc mht_1(mht_1_v, 222, "", "./tensorflow/lite/toco/graph_transformations/reorder_elementwise_unary.cc", "IsMoveOperator");
...
::tensorflow::Status ReorderElementwiseUnary::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSreorder_elementwise_unaryDTcc mht_2(mht_2_v, 245, "", "./tensorflow/lite/toco/graph_transformations/reorder_elementwise_unary.cc", "ReorderElementwiseUnary::Run");
