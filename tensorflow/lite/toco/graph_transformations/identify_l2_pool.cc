...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_l2_poolDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_l2_poolDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_l2_poolDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status IdentifyL2Pool::Run(Model* model, std::size_t op_index,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSidentify_l2_poolDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/toco/graph_transformations/identify_l2_pool.cc", "IdentifyL2Pool::Run");
