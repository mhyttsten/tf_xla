...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_space_to_batch_nd_attributesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_space_to_batch_nd_attributesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_space_to_batch_nd_attributesDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ResolveSpaceToBatchNDAttributes::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_space_to_batch_nd_attributesDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/toco/graph_transformations/resolve_space_to_batch_nd_attributes.cc", "ResolveSpaceToBatchNDAttributes::Run");
