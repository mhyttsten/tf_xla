...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_reshapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_reshapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_reshapeDTcc() {
      // Check if tracing is enabled
...
bool IsReshapeTrivial(const Model& model, const Operator& op,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_reshapeDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_reshape.cc", "IsReshapeTrivial");
...
::tensorflow::Status RemoveTrivialReshape::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_reshapeDTcc mht_1(mht_1_v, 258, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_reshape.cc", "RemoveTrivialReshape::Run");
