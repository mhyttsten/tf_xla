...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSread_array_minmax_and_narrow_range_from_fake_quantDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSread_array_minmax_and_narrow_range_from_fake_quantDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSread_array_minmax_and_narrow_range_from_fake_quantDTcc() {
      // Check if tracing is enabled
...
bool ApplyAttrsToArray(GraphTransformation* transformation, Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSread_array_minmax_and_narrow_range_from_fake_quantDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/toco/graph_transformations/read_array_minmax_and_narrow_range_from_fake_quant.cc", "ApplyAttrsToArray");
...
::tensorflow::Status ReadArrayMinmaxAndNarrowRangeFromFakeQuant::Run(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSread_array_minmax_and_narrow_range_from_fake_quantDTcc mht_1(mht_1_v, 228, "", "./tensorflow/lite/toco/graph_transformations/read_array_minmax_and_narrow_range_from_fake_quant.cc", "ReadArrayMinmaxAndNarrowRangeFromFakeQuant::Run");
