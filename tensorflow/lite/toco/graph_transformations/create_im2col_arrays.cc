...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPScreate_im2col_arraysDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPScreate_im2col_arraysDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPScreate_im2col_arraysDTcc() {
      // Check if tracing is enabled
...
bool ProcessConvOperator(Model* model, ConvOperator* op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPScreate_im2col_arraysDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/toco/graph_transformations/create_im2col_arrays.cc", "ProcessConvOperator");
...
bool ProcessTransposeConvOperator(Model* model, TransposeConvOperator* op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPScreate_im2col_arraysDTcc mht_1(mht_1_v, 232, "", "./tensorflow/lite/toco/graph_transformations/create_im2col_arrays.cc", "ProcessTransposeConvOperator");
...
::tensorflow::Status CreateIm2colArrays::Run(Model* model, std::size_t op_index,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPScreate_im2col_arraysDTcc mht_2(mht_2_v, 252, "", "./tensorflow/lite/toco/graph_transformations/create_im2col_arrays.cc", "CreateIm2colArrays::Run");
