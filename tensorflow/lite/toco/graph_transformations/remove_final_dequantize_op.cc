...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_final_dequantize_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_final_dequantize_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_final_dequantize_opDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status RemoveFinalDequantizeOp::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_final_dequantize_opDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/remove_final_dequantize_op.cc", "RemoveFinalDequantizeOp::Run");
