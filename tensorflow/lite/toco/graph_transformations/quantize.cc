...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc() {
      // Check if tracing is enabled
...
bool SupportsQuantization(Model* model, const Operator& op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "SupportsQuantization");
...
bool SupportOutputTypeFloatInQuantizedOp(const Operator& op) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_1(mht_1_v, 288, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "SupportOutputTypeFloatInQuantizedOp");
...
const MinMax& GetOrComputeMinMax(Model* model, const std::string& array_name) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_2(mht_2_v, 300, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "GetOrComputeMinMax");
...
QuantizationPoints GetQuantizationPoints() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_3(mht_3_v, 378, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "GetQuantizationPoints");
...
QuantizationPoints GetQuantizationPoints(ArrayDataType data_type) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_4(mht_4_v, 393, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "GetQuantizationPoints");
...
bool ChooseQuantizationForOperatorInput(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_5(mht_5_v, 412, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "ChooseQuantizationForOperatorInput");
...
bool IsExactlyRepresentable(double real_value, ArrayDataType data_type,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_6(mht_6_v, 499, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "IsExactlyRepresentable");
...
bool ChooseHardcodedQuantizationForOperatorOutput(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_7(mht_7_v, 522, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "ChooseHardcodedQuantizationForOperatorOutput");
...
bool ChooseQuantizationForOperatorOutput(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_8(mht_8_v, 584, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "ChooseQuantizationForOperatorOutput");
...
void FixMinMaxPostQuantization(GraphTransformation* transformation,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_9(mht_9_v, 665, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "FixMinMaxPostQuantization");
...
::tensorflow::Status Quantize::Run(Model* model, std::size_t op_index,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSquantizeDTcc mht_10(mht_10_v, 699, "", "./tensorflow/lite/toco/graph_transformations/quantize.cc", "Quantize::Run");
