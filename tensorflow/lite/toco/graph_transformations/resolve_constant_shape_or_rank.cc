...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_shape_or_rankDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_shape_or_rankDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_shape_or_rankDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ResolveConstantShapeOrRank::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_shape_or_rankDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_shape_or_rank.cc", "ResolveConstantShapeOrRank::Run");
