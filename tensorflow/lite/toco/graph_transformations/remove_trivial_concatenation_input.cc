...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_concatenation_inputDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_concatenation_inputDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_concatenation_inputDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status RemoveTrivialConcatenationInput::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSremove_trivial_concatenation_inputDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/remove_trivial_concatenation_input.cc", "RemoveTrivialConcatenationInput::Run");
