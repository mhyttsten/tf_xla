...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSfuse_activation_functionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSfuse_activation_functionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSfuse_activation_functionsDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status FuseActivationFunctions::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSfuse_activation_functionsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/fuse_activation_functions.cc", "FuseActivationFunctions::Run");
