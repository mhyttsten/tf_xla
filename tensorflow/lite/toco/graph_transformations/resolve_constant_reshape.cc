...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_reshapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_reshapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_reshapeDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ResolveConstantReshape::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_reshapeDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_reshape.cc", "ResolveConstantReshape::Run");
