...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_default_min_maxDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_default_min_maxDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_default_min_maxDTcc() {
      // Check if tracing is enabled
...
bool SupportsMinMax(const Array& array) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_default_min_maxDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/propagate_default_min_max.cc", "SupportsMinMax");
...
::tensorflow::Status PropagateDefaultMinMax::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_default_min_maxDTcc mht_1(mht_1_v, 216, "", "./tensorflow/lite/toco/graph_transformations/propagate_default_min_max.cc", "PropagateDefaultMinMax::Run");
...
bool PropagateDefaultMinMax::SetArrayMinMax(const std::string& array_name,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSpropagate_default_min_maxDTcc mht_2(mht_2_v, 250, "", "./tensorflow/lite/toco/graph_transformations/propagate_default_min_max.cc", "PropagateDefaultMinMax::SetArrayMinMax");
