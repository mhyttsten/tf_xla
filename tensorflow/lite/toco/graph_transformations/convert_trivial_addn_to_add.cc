...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_addn_to_addDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_addn_to_addDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_addn_to_addDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ConvertTrivialAddNToAdd::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_addn_to_addDTcc mht_0(mht_0_v, 195, "", "./tensorflow/lite/toco/graph_transformations/convert_trivial_addn_to_add.cc", "ConvertTrivialAddNToAdd::Run");
