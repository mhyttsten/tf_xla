...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSdrop_fake_quantDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSdrop_fake_quantDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSdrop_fake_quantDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status DropFakeQuant::Run(Model* model, std::size_t op_index,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSdrop_fake_quantDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/toco/graph_transformations/drop_fake_quant.cc", "DropFakeQuant::Run");
