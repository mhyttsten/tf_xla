...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_tileDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_tileDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_tileDTcc() {
      // Check if tracing is enabled
...
void CopyMultipleTimes(const T* in_data, int32_t in_size, int32_t multiplier,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_tileDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_tile.cc", "CopyMultipleTimes");
...
inline void Tile(const Array& input_array, const Array& multiples_array,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_tileDTcc mht_1(mht_1_v, 246, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_tile.cc", "Tile");
...
::tensorflow::Status ResolveConstantTile::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSresolve_constant_tileDTcc mht_2(mht_2_v, 278, "", "./tensorflow/lite/toco/graph_transformations/resolve_constant_tile.cc", "ResolveConstantTile::Run");
