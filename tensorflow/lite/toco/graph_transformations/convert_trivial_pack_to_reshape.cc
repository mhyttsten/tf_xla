...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_pack_to_reshapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_pack_to_reshapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_pack_to_reshapeDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ConvertTrivialPackToReshape::Run(Model* model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPSgraph_transformationsPSconvert_trivial_pack_to_reshapeDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/toco/graph_transformations/convert_trivial_pack_to_reshape.cc", "ConvertTrivialPackToReshape::Run");
