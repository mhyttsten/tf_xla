...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc() {
      // Check if tracing is enabled
...
void CheckOutputFilePermissions(const Arg<std::string>& output_file) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/toco/toco_convert.cc", "CheckOutputFilePermissions");
...
void CheckFrozenModelPermissions(const Arg<std::string>& input_file) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc mht_1(mht_1_v, 215, "", "./tensorflow/lite/toco/toco_convert.cc", "CheckFrozenModelPermissions");
...
void ReadInputData(const ParsedTocoFlags& parsed_toco_flags,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc mht_2(mht_2_v, 232, "", "./tensorflow/lite/toco/toco_convert.cc", "ReadInputData");
...
tensorflow::Status Convert(const std::string& graph_def_contents,
   ...
   mht_3_v.push_back("graph_def_contents: \"" + graph_def_contents + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc mht_3(mht_3_v, 256, "", "./tensorflow/lite/toco/toco_convert.cc", "Convert");
...
tensorflow::Status Convert(const ParsedTocoFlags& parsed_toco_flags,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_convertDTcc mht_4(mht_4_v, 272, "", "./tensorflow/lite/toco/toco_convert.cc", "Convert");
