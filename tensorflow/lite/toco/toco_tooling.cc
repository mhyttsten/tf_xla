...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc() {
      // Check if tracing is enabled
...
void CheckUnsupportedOperations(const Model& model) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/toco/toco_tooling.cc", "CheckUnsupportedOperations");
...
void MakeGeneralGraphTransformationsSet(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/toco/toco_tooling.cc", "MakeGeneralGraphTransformationsSet");
...
bool SupportsQuantization(FileFormat format) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_2(mht_2_v, 304, "", "./tensorflow/lite/toco/toco_tooling.cc", "SupportsQuantization");
...
bool SupportsFusedActivationFunction(FileFormat format) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_3(mht_3_v, 311, "", "./tensorflow/lite/toco/toco_tooling.cc", "SupportsFusedActivationFunction");
...
bool SupportsLstmCell(FileFormat format) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_4(mht_4_v, 318, "", "./tensorflow/lite/toco/toco_tooling.cc", "SupportsLstmCell");
...
bool SupportsPreallocatedWorkspace(FileFormat format) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_5(mht_5_v, 326, "", "./tensorflow/lite/toco/toco_tooling.cc", "SupportsPreallocatedWorkspace");
...
bool SupportsShuffledFCWeights(FileFormat format) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_6(mht_6_v, 333, "", "./tensorflow/lite/toco/toco_tooling.cc", "SupportsShuffledFCWeights");
 return format == TFLITE; }

bool IsRealValued(toco::ArrayDataType type) {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_7(mht_7_v, 338, "", "./tensorflow/lite/toco/toco_tooling.cc", "IsRealValued");
...
void SetFinalDataTypeOnInputs(const TocoFlags& toco_flags, Model* model) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_8(mht_8_v, 352, "", "./tensorflow/lite/toco/toco_tooling.cc", "SetFinalDataTypeOnInputs");
...
tensorflow::Status TransformWithStatus(const TocoFlags& toco_flags,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_9(mht_9_v, 441, "", "./tensorflow/lite/toco/toco_tooling.cc", "TransformWithStatus");
...
tensorflow::Status Export(const TocoFlags& toco_flags, const Model& model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTcc mht_10(mht_10_v, 676, "", "./tensorflow/lite/toco/toco_tooling.cc", "Export");
