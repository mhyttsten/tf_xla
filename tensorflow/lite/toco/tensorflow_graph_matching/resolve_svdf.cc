...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc() {
      // Check if tracing is enabled
...
void FilterPartitionedConstNodes(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc mht_0(mht_0_v, 222, "", "./tensorflow/lite/toco/tensorflow_graph_matching/resolve_svdf.cc", "FilterPartitionedConstNodes");
...
int SvdfCluster::InferFilterRank() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc mht_1(mht_1_v, 253, "", "./tensorflow/lite/toco/tensorflow_graph_matching/resolve_svdf.cc", "SvdfCluster::InferFilterRank");
...
void SvdfCluster::CreateNodes() {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc mht_2(mht_2_v, 275, "", "./tensorflow/lite/toco/tensorflow_graph_matching/resolve_svdf.cc", "SvdfCluster::CreateNodes");
...
void SvdfCluster::CreateConstNode(const std::string& const_pattern) {
   ...
   mht_3_v.push_back("const_pattern: \"" + const_pattern + "\"");
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc mht_3(mht_3_v, 328, "", "./tensorflow/lite/toco/tensorflow_graph_matching/resolve_svdf.cc", "SvdfCluster::CreateConstNode");
...
void SvdfCluster::MaybeMergeConstNodes(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc mht_4(mht_4_v, 350, "", "./tensorflow/lite/toco/tensorflow_graph_matching/resolve_svdf.cc", "SvdfCluster::MaybeMergeConstNodes");
...
std::unique_ptr<Cluster> SvdfClusterFactory::CreateCluster(
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStensorflow_graph_matchingPSresolve_svdfDTcc mht_5(mht_5_v, 440, "", "./tensorflow/lite/toco/tensorflow_graph_matching/resolve_svdf.cc", "SvdfClusterFactory::CreateCluster");
