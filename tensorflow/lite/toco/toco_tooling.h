...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTh() {
      // Check if tracing is enabled
...
inline void Transform(const TocoFlags& toco_flags, Model* model) {
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTh mht_0(mht_0_v, 205, "", "./tensorflow/lite/toco/toco_tooling.h", "Transform");
...
inline void Export(const TocoFlags& toco_flags, const Model& model,
   ...
   MHTracer_DTPStensorflowPSlitePStocoPStoco_toolingDTh mht_1(mht_1_v, 222, "", "./tensorflow/lite/toco/toco_tooling.h", "Export");
