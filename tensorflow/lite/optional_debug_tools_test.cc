...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSoptional_debug_tools_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSoptional_debug_tools_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSoptional_debug_tools_testDTcc() {
      // Check if tracing is enabled
...
void InitInputTensorData(Interpreter* interpreter) {
   ...
   MHTracer_DTPStensorflowPSlitePSoptional_debug_tools_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/optional_debug_tools_test.cc", "InitInputTensorData");
