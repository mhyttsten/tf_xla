...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh() {
      // Check if tracing is enabled
...
class TfDriver : public TestRunner {
 public:
  ...
  ~TfDriver() override {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh mht_0(mht_0_v, 210, "", "./tensorflow/lite/testing/tf_driver.h", "~TfDriver");
}

  void LoadModel(const string& bin_file_path) override;
  void LoadModel(const string& bin_file_path, const string&) override {
   std::vector<std::string> mht_1_v;
   mht_1_v.push_back("bin_file_path: \"" + bin_file_path + "\"");
   MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh mht_1(mht_1_v, 217, "", "./tensorflow/lite/testing/tf_driver.h", "LoadModel");
  ...
  bool CheckResults(
   ...
   MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh mht_2(mht_2_v, 234, "", "./tensorflow/lite/testing/tf_driver.h", "CheckResults");
  ...
  void AllocateTensors() override {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPStf_driverDTh mht_3(mht_3_v, 243, "", "./tensorflow/lite/testing/tf_driver.h", "AllocateTensors");
}
