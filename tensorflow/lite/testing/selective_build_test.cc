...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStestingPSselective_build_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSselective_build_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStestingPSselective_build_testDTcc() {
      // Check if tracing is enabled
...
bool RunWithRandomInputs(const std::string& filename) {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSselective_build_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/testing/selective_build_test.cc", "RunWithRandomInputs");
