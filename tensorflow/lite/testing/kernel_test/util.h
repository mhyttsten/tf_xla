...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStestingPSkernel_testPSutilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSkernel_testPSutilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStestingPSkernel_testPSutilDTh() {
      // Check if tracing is enabled
...
TestOptions ParseTfliteKernelTestFlags(int* argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSkernel_testPSutilDTh mht_0(mht_0_v, 214, "", "./tensorflow/lite/testing/kernel_test/util.h", "ParseTfliteKernelTestFlags");
...
TfLiteStatus RunKernelTest(const kernel_test::TestOptions& options,
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSkernel_testPSutilDTh mht_1(mht_1_v, 240, "", "./tensorflow/lite/testing/kernel_test/util.h", "RunKernelTest");
