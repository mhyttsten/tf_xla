...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc() {
      // Check if tracing is enabled
...
class MessageStack : public TokenProcessor {
 public:
  ...
  explicit MessageStack(Message* first_node) {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/testing/message.cc", "MessageStack");
  ...
  void ConsumeToken(std::string* token) override {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc mht_1(mht_1_v, 208, "", "./tensorflow/lite/testing/message.cc", "ConsumeToken");
  ...
  bool valid() const {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc mht_2(mht_2_v, 256, "", "./tensorflow/lite/testing/message.cc", "valid");
 return valid_; }
...
bool Message::Read(std::istream* input, Message* message) {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSmessageDTcc mht_3(mht_3_v, 267, "", "./tensorflow/lite/testing/message.cc", "Message::Read");
