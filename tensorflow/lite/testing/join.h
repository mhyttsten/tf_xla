...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh() {
      // Check if tracing is enabled
...
string JoinDefault(T* data, size_t len, const string& delimiter) {
   ...
   mht_0_v.push_back("delimiter: \"" + delimiter + "\"");
   MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/testing/join.h", "JoinDefault");
...
string Join(T* data, size_t len, const string& delimiter) {
   ...
   MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh mht_1(mht_1_v, 217, "", "./tensorflow/lite/testing/join.h", "Join");
...
inline string Join<uint8_t>(uint8_t* data, size_t len,
   ...
   mht_2_v.push_back("delimiter: \"" + delimiter + "\"");
   MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh mht_2(mht_2_v, 237, "", "./tensorflow/lite/testing/join.h", "Join<uint8_t>");
...
inline string Join<int8_t>(int8_t* data, size_t len, const string& delimiter) {
   ...
   mht_3_v.push_back("delimiter: \"" + delimiter + "\"");
   MHTracer_DTPStensorflowPSlitePStestingPSjoinDTh mht_3(mht_3_v, 256, "", "./tensorflow/lite/testing/join.h", "Join<int8_t>");
