...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus ResizeOutputTensor(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc mht_0(mht_0_v, 218, "", "./tensorflow/lite/kernels/resize_bilinear.cc", "ResizeOutputTensor");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc mht_1(mht_1_v, 234, "", "./tensorflow/lite/kernels/resize_bilinear.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc mht_2(mht_2_v, 276, "", "./tensorflow/lite/kernels/resize_bilinear.cc", "Eval");
...
TfLiteRegistration* Register_RESIZE_BILINEAR_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc mht_3(mht_3_v, 337, "", "./tensorflow/lite/kernels/resize_bilinear.cc", "Register_RESIZE_BILINEAR_REF");
...
TfLiteRegistration* Register_RESIZE_BILINEAR() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinearDTcc mht_4(mht_4_v, 347, "", "./tensorflow/lite/kernels/resize_bilinear.cc", "Register_RESIZE_BILINEAR");
