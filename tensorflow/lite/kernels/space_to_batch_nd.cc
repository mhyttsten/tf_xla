...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc() {
      // Check if tracing is enabled
...
struct SpaceToBatchNDContext {
  SpaceToBatchNDContext(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "SpaceToBatchNDContext");
...
TfLiteStatus ResizeOutputTensor(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_1(mht_1_v, 230, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "ResizeOutputTensor");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_2(mht_2_v, 270, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_3(mht_3_v, 294, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "Eval");
...
TfLiteRegistration* Register_SPACE_TO_BATCH_ND_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_4(mht_4_v, 368, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "Register_SPACE_TO_BATCH_ND_REF");
...
TfLiteRegistration* Register_SPACE_TO_BATCH_ND_GENERIC_OPT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_5(mht_5_v, 378, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "Register_SPACE_TO_BATCH_ND_GENERIC_OPT");
...
TfLiteRegistration* Register_SPACE_TO_BATCH_ND() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_batch_ndDTcc mht_6(mht_6_v, 388, "", "./tensorflow/lite/kernels/space_to_batch_nd.cc", "Register_SPACE_TO_BATCH_ND");
