...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/kernels/matrix_set_diag.cc", "Prepare");
...
void FillDiagImpl(const T* in, const T* diag, T* out, const int batch_size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc mht_1(mht_1_v, 237, "", "./tensorflow/lite/kernels/matrix_set_diag.cc", "FillDiagImpl");
...
void FillDiag(const TfLiteTensor* input, const TfLiteTensor* diag,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc mht_2(mht_2_v, 262, "", "./tensorflow/lite/kernels/matrix_set_diag.cc", "FillDiag");
...
void FillDiagHelper(const TfLiteTensor* input, const TfLiteTensor* diag,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc mht_3(mht_3_v, 273, "", "./tensorflow/lite/kernels/matrix_set_diag.cc", "FillDiagHelper");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc mht_4(mht_4_v, 312, "", "./tensorflow/lite/kernels/matrix_set_diag.cc", "Eval");
...
TfLiteRegistration* Register_MATRIX_SET_DIAG() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diagDTcc mht_5(mht_5_v, 330, "", "./tensorflow/lite/kernels/matrix_set_diag.cc", "Register_MATRIX_SET_DIAG");
