...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPStest_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPStest_mainDTcc() {
      // Check if tracing is enabled
...
bool InitKernelTest(int* argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_mainDTcc mht_0(mht_0_v, 194, "", "./tensorflow/lite/kernels/test_main.cc", "InitKernelTest");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_mainDTcc mht_1(mht_1_v, 220, "", "./tensorflow/lite/kernels/test_main.cc", "main");
