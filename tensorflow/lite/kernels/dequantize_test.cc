...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc() {
      // Check if tracing is enabled
...
class DequantizeOpModel : public SingleOpModel {
 public:
  explicit DequantizeOpModel() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/lite/kernels/dequantize_test.cc", "DequantizeOpModel");
}

  DequantizeOpModel(TensorType type, std::initializer_list<int> shape,
                    float scale, int32_t zero_point, int version) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc mht_1(mht_1_v, 222, "", "./tensorflow/lite/kernels/dequantize_test.cc", "DequantizeOpModel");
  ...
  void SetInput(std::initializer_list<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc mht_2(mht_2_v, 240, "", "./tensorflow/lite/kernels/dequantize_test.cc", "SetInput");
...
class DequantizePerChannelOpModel : public DequantizeOpModel {
 public:
  DequantizePerChannelOpModel(TensorType type, std::initializer_list<int> shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdequantize_testDTcc mht_3(mht_3_v, 304, "", "./tensorflow/lite/kernels/dequantize_test.cc", "DequantizePerChannelOpModel");
