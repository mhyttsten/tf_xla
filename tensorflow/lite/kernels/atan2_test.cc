...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSatan2_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSatan2_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSatan2_testDTcc() {
      // Check if tracing is enabled
...
tflite::TensorType GetTTEnum<float>() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSatan2_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/atan2_test.cc", "GetTTEnum<float>");
...
tflite::TensorType GetTTEnum<double>() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSatan2_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/lite/kernels/atan2_test.cc", "GetTTEnum<double>");
...
class Atan2Model : public tflite::SingleOpModel {
 public:
  Atan2Model(tflite::TensorData y,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSatan2_testDTcc mht_2(mht_2_v, 219, "", "./tensorflow/lite/kernels/atan2_test.cc", "Atan2Model");
