...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSreverseDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverseDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSreverseDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverseDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/kernels/reverse.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverseDTcc mht_1(mht_1_v, 246, "", "./tensorflow/lite/kernels/reverse.cc", "Eval");
...
TfLiteRegistration* Register_REVERSE_V2() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverseDTcc mht_2(mht_2_v, 317, "", "./tensorflow/lite/kernels/reverse.cc", "Register_REVERSE_V2");
