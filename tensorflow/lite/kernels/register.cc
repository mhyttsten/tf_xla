...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTcc() {
      // Check if tracing is enabled
...
BuiltinOpResolver::BuiltinOpResolver() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/kernels/register.cc", "BuiltinOpResolver::BuiltinOpResolver");
