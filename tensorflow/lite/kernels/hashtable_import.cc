...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_importDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_importDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_importDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus PrepareHashtableImport(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_importDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/hashtable_import.cc", "PrepareHashtableImport");
...
TfLiteStatus EvalHashtableImport(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_importDTcc mht_1(mht_1_v, 230, "", "./tensorflow/lite/kernels/hashtable_import.cc", "EvalHashtableImport");
...
TfLiteRegistration* Register_HASHTABLE_IMPORT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_importDTcc mht_2(mht_2_v, 260, "", "./tensorflow/lite/kernels/hashtable_import.cc", "Register_HASHTABLE_IMPORT");
