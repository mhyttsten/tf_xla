...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc() {
      // Check if tracing is enabled
...
void GruImpl(const TfLiteTensor* input, const TfLiteTensor* input_state,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/kernels/unidirectional_sequence_gru.cc", "GruImpl");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc mht_1(mht_1_v, 294, "", "./tensorflow/lite/kernels/unidirectional_sequence_gru.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc mht_2(mht_2_v, 303, "", "./tensorflow/lite/kernels/unidirectional_sequence_gru.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc mht_3(mht_3_v, 310, "", "./tensorflow/lite/kernels/unidirectional_sequence_gru.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc mht_4(mht_4_v, 415, "", "./tensorflow/lite/kernels/unidirectional_sequence_gru.cc", "Eval");
...
TfLiteRegistration* Register_UNIDIRECTIONAL_SEQUENCE_GRU() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_gruDTcc mht_5(mht_5_v, 463, "", "./tensorflow/lite/kernels/unidirectional_sequence_gru.cc", "Register_UNIDIRECTIONAL_SEQUENCE_GRU");
