...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_utilDTh() {
      // Check if tracing is enabled
...
QuantizationParams ChooseQuantizationParams(double rmin, double rmax,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_utilDTh mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/internal/quantization_util.h", "ChooseQuantizationParams");
...
QuantizationParams ChooseQuantizationParams(double rmin, double rmax) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_utilDTh mht_1(mht_1_v, 274, "", "./tensorflow/lite/kernels/internal/quantization_util.h", "ChooseQuantizationParams");
