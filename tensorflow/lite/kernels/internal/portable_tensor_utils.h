...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh() {
      // Check if tracing is enabled
...
void VectorBatchVectorAdd(const T* vector, int v_size, int n_batch,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_0(mht_0_v, 221, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "VectorBatchVectorAdd");
...
inline void VectorVectorCwiseProduct(const T* vector1, const T* vector2,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_1(mht_1_v, 236, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "VectorVectorCwiseProduct");
...
inline void VectorBatchVectorCwiseProduct(const T* vector, int v_size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_2(mht_2_v, 249, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "VectorBatchVectorCwiseProduct");
...
inline void VectorVectorCwiseProductAccumulate(const T* __restrict__ vector1,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_3(mht_3_v, 267, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "VectorVectorCwiseProductAccumulate");
...
inline void VectorBatchVectorCwiseProductAccumulate(const T* vector, int v_size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_4(mht_4_v, 282, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "VectorBatchVectorCwiseProductAccumulate");
...
void VectorBatchVectorAssign(const T* vector, int v_size, int n_batch,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_5(mht_5_v, 297, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "VectorBatchVectorAssign");
...
inline void BatchQuantizeFloats(const float* float_data_ptr, int n_batch,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_6(mht_6_v, 343, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "BatchQuantizeFloats");
...
inline void BatchVectorBatchVectorDotProduct(const T* vector1, const T* vector2,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSportable_tensor_utilsDTh mht_7(mht_7_v, 610, "", "./tensorflow/lite/kernels/internal/portable_tensor_utils.h", "BatchVectorBatchVectorDotProduct");
