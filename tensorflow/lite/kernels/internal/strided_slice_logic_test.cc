...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSstrided_slice_logic_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSstrided_slice_logic_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSstrided_slice_logic_testDTcc() {
      // Check if tracing is enabled
...
void RunStridedSlicePadIndices(std::initializer_list<int> begin,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSstrided_slice_logic_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/lite/kernels/internal/strided_slice_logic_test.cc", "RunStridedSlicePadIndices");
