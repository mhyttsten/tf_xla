...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc() {
      // Check if tracing is enabled
...
void PickOutputMultiplier(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc mht_0(mht_0_v, 213, "", "./tensorflow/lite/kernels/internal/conv_per_channel_quantized_16x8_test.cc", "PickOutputMultiplier");
...
void PickReasonableMultiplier(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc mht_1(mht_1_v, 294, "", "./tensorflow/lite/kernels/internal/conv_per_channel_quantized_16x8_test.cc", "PickReasonableMultiplier");
...
bool GenerateValidShapeConfigurations(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc mht_2(mht_2_v, 321, "", "./tensorflow/lite/kernels/internal/conv_per_channel_quantized_16x8_test.cc", "GenerateValidShapeConfigurations");
...
void IntToFloat(std::vector<float>* d, std::vector<std::int8_t>* s) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc mht_3(mht_3_v, 349, "", "./tensorflow/lite/kernels/internal/conv_per_channel_quantized_16x8_test.cc", "IntToFloat");
...
void IntToFloat(std::vector<float>* d, std::vector<std::int64_t>* s) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc mht_4(mht_4_v, 358, "", "./tensorflow/lite/kernels/internal/conv_per_channel_quantized_16x8_test.cc", "IntToFloat");
...
void TryTestOneConvFilter(int test_num) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSconv_per_channel_quantized_16x8_testDTcc mht_5(mht_5_v, 367, "", "./tensorflow/lite/kernels/internal/conv_per_channel_quantized_16x8_test.cc", "TryTestOneConvFilter");
