...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc() {
      // Check if tracing is enabled
...
TEST(QuantizationUtilTest, QuantizeMultiplierSmallerThanOneExp) {
  auto quantize = [](double d) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_0(mht_0_v, 506, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
...
TEST(QuantizationUtilTest, QuantizeMultiplierGreaterThanOne) {
  auto quantize = [](double d) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_1(mht_1_v, 537, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
...
TEST(QuantizationUtilTest, QuantizeMultiplierUnderflow) {
  auto quantize = [](double d) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_2(mht_2_v, 564, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
...
TEST(QuantizationUtilTest, GetInvSqrtQuantizedMultiplierExp) {
  auto inv_sqrt = [](std::int32_t input) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_3(mht_3_v, 582, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
...
TEST(QuantizationUtilTest, MultiplyByQuantizedMultiplierInt32) {
  auto quant_and_multiply = [](int32_t x, double multiplier) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_4(mht_4_v, 607, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
...
TEST(QuantizationUtilTest, MultiplyByQuantizedMultiplierInt64) {
  auto quant_and_multiply = [](int64_t x, double multiplier) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_5(mht_5_v, 650, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
...
TEST(QuantizationUtilTest, PreprocessSoftmaxScaling) {
  auto quantize = [](double beta, double scale, int integer_bits) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSquantization_util_testDTcc mht_6(mht_6_v, 683, "", "./tensorflow/lite/kernels/internal/quantization_util_test.cc", "lambda");
