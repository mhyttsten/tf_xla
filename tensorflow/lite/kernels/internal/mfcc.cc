...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTcc() {
      // Check if tracing is enabled
...
Mfcc::Mfcc()
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/kernels/internal/mfcc.cc", "Mfcc::Mfcc");
}

bool Mfcc::Initialize(int input_length, double input_sample_rate) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTcc mht_1(mht_1_v, 208, "", "./tensorflow/lite/kernels/internal/mfcc.cc", "Mfcc::Initialize");
...
void Mfcc::Compute(const std::vector<double>& spectrogram_frame,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTcc mht_2(mht_2_v, 222, "", "./tensorflow/lite/kernels/internal/mfcc.cc", "Mfcc::Compute");
