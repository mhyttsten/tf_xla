...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmaxpool_quantized_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmaxpool_quantized_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmaxpool_quantized_testDTcc() {
      // Check if tracing is enabled
...
void RunOneMaxPoolTest(const PoolParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmaxpool_quantized_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/kernels/internal/maxpool_quantized_test.cc", "RunOneMaxPoolTest");
...
void CreateDataAndRunMaxPool(bool padding_same) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmaxpool_quantized_testDTcc mht_1(mht_1_v, 230, "", "./tensorflow/lite/kernels/internal/maxpool_quantized_test.cc", "CreateDataAndRunMaxPool");
  ...
  auto compute_padding = [](int stride, int in_size, int filter_size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmaxpool_quantized_testDTcc mht_2(mht_2_v, 271, "", "./tensorflow/lite/kernels/internal/maxpool_quantized_test.cc", "lambda");
