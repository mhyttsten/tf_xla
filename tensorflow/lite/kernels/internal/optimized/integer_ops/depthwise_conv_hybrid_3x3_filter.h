...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh() {
      // Check if tracing is enabled
...
struct DepthwiseConvHybridWindowPerChannel<DepthwiseConvOutputRounding::kUpward,
 ...
 public:
  static inline void Run(const float* input_scale,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_0(mht_0_v, 305, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
struct DepthwiseConvHybridWindowPerChannel<DepthwiseConvOutputRounding::kUpward,
  ...
  static inline void Run(const float* input_scale, const int8* input_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_1(mht_1_v, 1242, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
struct DepthwiseConvHybridPartialPerChannel<
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_2(mht_2_v, 2250, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
struct DepthwiseConvHybridPartialPerChannel<
  ...
  static inline void Run(const float* input_scale, const int8* input_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_3(mht_3_v, 2369, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
struct DepthwiseConvHybridPartialPerChannel<
  ...
  static inline void Run(const float* input_scale, const int8* input_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_4(mht_4_v, 2542, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
struct DepthwiseConvHybridPartialPerChannel<
  ...
  static inline void Run(const float* input_scale, const int8* input_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_5(mht_5_v, 2749, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
struct DepthwiseConvHybridMultiRowPerChannel {
  ...
  static inline void Run(const float* input_scale, const int8* input_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_6(mht_6_v, 3018, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "Run");
...
template <DepthwiseConvOutputRounding output_rounding>
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_7(mht_7_v, 3126, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "DepthwiseConvHybridHandlePaddingPerChannel");
...
inline void DepthwiseConvHybrid3x3FilterPerChannel(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_hybrid_3x3_filterDTh mht_8(mht_8_v, 3245, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_hybrid_3x3_filter.h", "DepthwiseConvHybrid3x3FilterPerChannel");
