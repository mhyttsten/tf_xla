...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh() {
      // Check if tracing is enabled
...
inline void AddElementwiseInt8(int size, const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh mht_0(mht_0_v, 207, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/add.h", "AddElementwiseInt8");
...
inline void AddElementwiseInt16(int size, const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh mht_1(mht_1_v, 342, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/add.h", "AddElementwiseInt16");
...
inline void AddScalarBroadcast(int size, const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh mht_2(mht_2_v, 537, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/add.h", "AddScalarBroadcast");
...
inline void Add(const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh mht_3(mht_3_v, 639, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/add.h", "Add");
...
inline void Add(const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh mht_4(mht_4_v, 659, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/add.h", "Add");
...
inline void BroadcastAddDispatch(const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSaddDTh mht_5(mht_5_v, 682, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/add.h", "BroadcastAddDispatch");
