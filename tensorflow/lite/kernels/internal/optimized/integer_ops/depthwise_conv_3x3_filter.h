...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh() {
      // Check if tracing is enabled
...
struct DepthwiseConvWindowPerChannel<DepthwiseConvOutputRounding::kUpward, 8, 1,
 ...
 public:
  static inline void Run(const int32* output_multiplier_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_0(mht_0_v, 287, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
struct DepthwiseConvWindowPerChannel<DepthwiseConvOutputRounding::kUpward, 8, 2,
  ...
  static inline void Run(const int32* output_multiplier_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_1(mht_1_v, 1145, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward,
  ...
  static inline void Run(const int32* output_multiplier_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_2(mht_2_v, 2108, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward,
  ...
  static inline void Run(const int32* output_multiplier_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_3(mht_3_v, 2223, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward,
  ...
  static inline void Run(const int32* output_multiplier_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_4(mht_4_v, 2390, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
struct DepthwiseConvPartialPerChannel<DepthwiseConvOutputRounding::kUpward,
  ...
  static inline void Run(const int32* output_multiplier_ptr,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_5(mht_5_v, 2590, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
struct DepthwiseConvMultiRowPerChannel {
  ...
  static inline void Run(const int32* output_multiplier,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_6(mht_6_v, 2851, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "Run");
...
inline void DepthwiseConvHandlePaddingPerChannel(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_7(mht_7_v, 2958, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "DepthwiseConvHandlePaddingPerChannel");
...
inline void DepthwiseConv3x3FilterPerChannel(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSinteger_opsPSdepthwise_conv_3x3_filterDTh mht_8(mht_8_v, 3078, "", "./tensorflow/lite/kernels/internal/optimized/integer_ops/depthwise_conv_3x3_filter.h", "DepthwiseConv3x3FilterPerChannel");
