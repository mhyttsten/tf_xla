...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTh() {
      // Check if tracing is enabled
...
inline void GetCpuFlags(CpuFlags* cpu_flags) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTh mht_0(mht_0_v, 203, "", "./tensorflow/lite/kernels/internal/optimized/cpu_check.h", "GetCpuFlags");
