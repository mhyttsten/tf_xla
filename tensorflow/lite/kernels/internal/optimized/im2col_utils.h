...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh() {
      // Check if tracing is enabled
...
inline void ExtractPatchIntoBufferColumn(const RuntimeShape& input_shape, int w,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_0(mht_0_v, 204, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "ExtractPatchIntoBufferColumn");
...
void DilatedIm2col(const ConvParams& params, const RuntimeShape& input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_1(mht_1_v, 294, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "DilatedIm2col");
...
void DilatedIm2col(const ConvParams& params, uint8 zero_byte,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_2(mht_2_v, 382, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "DilatedIm2col");
...
void Im2col(const ConvParams& params, int kheight, int kwidth, uint8 zero_byte,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_3(mht_3_v, 394, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "Im2col");
...
void Im2col(const ConvParams& params, int kheight, int kwidth,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_4(mht_4_v, 433, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "Im2col");
...
inline void ExtractPatchIntoBufferColumn3D(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_5(mht_5_v, 478, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "ExtractPatchIntoBufferColumn3D");
...
void Im2col3D(const Conv3DParams& params, int kdepth, int kheight, int kwidth,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_6(mht_6_v, 564, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "Im2col3D");
...
inline void DilatedIm2col3D(const Conv3DParams& params, int filter_depth,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPSim2col_utilsDTh mht_7(mht_7_v, 612, "", "./tensorflow/lite/kernels/internal/optimized/im2col_utils.h", "DilatedIm2col3D");
