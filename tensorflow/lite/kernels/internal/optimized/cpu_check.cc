...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTcc() {
      // Check if tracing is enabled
...
bool DetectArmNeonDotprod() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSoptimizedPScpu_checkDTcc mht_0(mht_0_v, 211, "", "./tensorflow/lite/kernels/internal/optimized/cpu_check.cc", "DetectArmNeonDotprod");
