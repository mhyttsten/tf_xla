...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbatch_to_space_ndDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbatch_to_space_ndDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbatch_to_space_ndDTh() {
      // Check if tracing is enabled
...
inline RuntimeShape ExtendShapeBatchToSpace(const RuntimeShape& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbatch_to_space_ndDTh mht_0(mht_0_v, 196, "", "./tensorflow/lite/kernels/internal/reference/batch_to_space_nd.h", "ExtendShapeBatchToSpace");
...
inline void BatchToSpaceND(const RuntimeShape& unextended_input1_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbatch_to_space_ndDTh mht_1(mht_1_v, 218, "", "./tensorflow/lite/kernels/internal/reference/batch_to_space_nd.h", "BatchToSpaceND");
