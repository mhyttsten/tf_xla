...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh() {
      // Check if tracing is enabled
...
inline bool ResolveAxis(const int num_dims, const int* axis,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh mht_0(mht_0_v, 278, "", "./tensorflow/lite/kernels/internal/reference/reduce.h", "ResolveAxis");
...
inline bool InitTensorDataForReduce(const int* dims, const int num_dims,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh mht_1(mht_1_v, 330, "", "./tensorflow/lite/kernels/internal/reference/reduce.h", "InitTensorDataForReduce");
...
inline bool ReduceGeneric(const T* input_data, const int* input_dims,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh mht_2(mht_2_v, 359, "", "./tensorflow/lite/kernels/internal/reference/reduce.h", "ReduceGeneric");
...
inline void Mean(const tflite::MeanParams& op_params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh mht_3(mht_3_v, 451, "", "./tensorflow/lite/kernels/internal/reference/reduce.h", "Mean");
...
inline void Mean(const tflite::MeanParams& op_params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh mht_4(mht_4_v, 499, "", "./tensorflow/lite/kernels/internal/reference/reduce.h", "Mean");
...
inline bool QuantizedReduceProd(const T* input_data, int32_t input_zero_point,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSreduceDTh mht_5(mht_5_v, 662, "", "./tensorflow/lite/kernels/internal/reference/reduce.h", "QuantizedReduceProd");
