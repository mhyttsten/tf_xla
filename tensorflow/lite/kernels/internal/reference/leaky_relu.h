...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSleaky_reluDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSleaky_reluDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSleaky_reluDTh() {
      // Check if tracing is enabled
...
inline void LeakyRelu(const tflite::LeakyReluParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSleaky_reluDTh mht_0(mht_0_v, 197, "", "./tensorflow/lite/kernels/internal/reference/leaky_relu.h", "LeakyRelu");
...
inline void QuantizeLeakyRelu(const LeakyReluParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSleaky_reluDTh mht_1(mht_1_v, 214, "", "./tensorflow/lite/kernels/internal/reference/leaky_relu.h", "QuantizeLeakyRelu");
