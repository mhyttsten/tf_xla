...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSsparse_opsPSfully_connectedDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSsparse_opsPSfully_connectedDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSsparse_opsPSfully_connectedDTh() {
      // Check if tracing is enabled
...
inline void FullyConnectedSparseWeight(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSsparse_opsPSfully_connectedDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/internal/reference/sparse_ops/fully_connected.h", "FullyConnectedSparseWeight");
