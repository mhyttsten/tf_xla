...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh() {
      // Check if tracing is enabled
...
inline void Tanh(const RuntimeShape& input_shape, const float* input_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/internal/reference/tanh.h", "Tanh");
...
inline void Tanh(const TanhParams&, const RuntimeShape& input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh mht_1(mht_1_v, 216, "", "./tensorflow/lite/kernels/internal/reference/tanh.h", "Tanh");
...
inline void Tanh(const TanhParams& params, const RuntimeShape& input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh mht_2(mht_2_v, 226, "", "./tensorflow/lite/kernels/internal/reference/tanh.h", "Tanh");
...
inline void Tanh(const TanhParams& params, const RuntimeShape& input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStanhDTh mht_3(mht_3_v, 263, "", "./tensorflow/lite/kernels/internal/reference/tanh.h", "Tanh");
