...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStranspose_convDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStranspose_convDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStranspose_convDTh() {
      // Check if tracing is enabled
...
inline void TransposeConv(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStranspose_convDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/internal/reference/transpose_conv.h", "TransposeConv");
...
inline void TransposeConv(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePStranspose_convDTh mht_1(mht_1_v, 292, "", "./tensorflow/lite/kernels/internal/reference/transpose_conv.h", "TransposeConv");
