...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStranspose_convDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStranspose_convDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStranspose_convDTh() {
      // Check if tracing is enabled
...
inline void TransposeConv(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStranspose_convDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/internal/reference/integer_ops/transpose_conv.h", "TransposeConv");
...
inline void TransposeConv(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStranspose_convDTh mht_1(mht_1_v, 303, "", "./tensorflow/lite/kernels/internal/reference/integer_ops/transpose_conv.h", "TransposeConv");
