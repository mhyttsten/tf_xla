...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSl2normalizationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSl2normalizationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSl2normalizationDTh() {
      // Check if tracing is enabled
...
inline void L2Normalization(int32_t input_zero_point, int32_t outer_size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSl2normalizationDTh mht_0(mht_0_v, 194, "", "./tensorflow/lite/kernels/internal/reference/integer_ops/l2normalization.h", "L2Normalization");
