...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStanhDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStanhDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStanhDTh() {
      // Check if tracing is enabled
...
inline void Tanh(int32_t input_zero_point, int32_t input_range_radius,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStanhDTh mht_0(mht_0_v, 198, "", "./tensorflow/lite/kernels/internal/reference/integer_ops/tanh.h", "Tanh");
...
inline void Tanh(int32_t input_multiplier, int32_t input_left_shift,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPStanhDTh mht_1(mht_1_v, 236, "", "./tensorflow/lite/kernels/internal/reference/integer_ops/tanh.h", "Tanh");
