...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSmeanDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSmeanDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSmeanDTh() {
      // Check if tracing is enabled
...
inline void Mean(const tflite::MeanParams& op_params, int32_t multiplier,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSinteger_opsPSmeanDTh mht_0(mht_0_v, 197, "", "./tensorflow/lite/kernels/internal/reference/integer_ops/mean.h", "Mean");
