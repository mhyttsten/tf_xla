...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdequantizeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdequantizeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdequantizeDTh() {
      // Check if tracing is enabled
...
inline void PerChannelDequantize(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdequantizeDTh mht_0(mht_0_v, 220, "", "./tensorflow/lite/kernels/internal/reference/dequantize.h", "PerChannelDequantize");
