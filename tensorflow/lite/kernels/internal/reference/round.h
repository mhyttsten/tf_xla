...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSroundDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSroundDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSroundDTh() {
      // Check if tracing is enabled
...
inline float RoundToNearest(float value) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSroundDTh mht_0(mht_0_v, 195, "", "./tensorflow/lite/kernels/internal/reference/round.h", "RoundToNearest");
...
inline void Round(const RuntimeShape& input_shape, const float* input_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSroundDTh mht_1(mht_1_v, 210, "", "./tensorflow/lite/kernels/internal/reference/round.h", "Round");
