...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSlstm_cellDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSlstm_cellDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSlstm_cellDTh() {
      // Check if tracing is enabled
...
inline void LstmCell(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSlstm_cellDTh mht_0(mht_0_v, 209, "", "./tensorflow/lite/kernels/internal/reference/lstm_cell.h", "LstmCell");
...
inline void LstmCell(const LstmCellParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSlstm_cellDTh mht_1(mht_1_v, 418, "", "./tensorflow/lite/kernels/internal/reference/lstm_cell.h", "LstmCell");
