...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSpreluDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSpreluDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSpreluDTh() {
      // Check if tracing is enabled
...
inline void BroadcastPrelu4DSlow(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSpreluDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/internal/reference/prelu.h", "BroadcastPrelu4DSlow");
...
inline void Prelu(const PreluParams& params, const RuntimeShape& input_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSpreluDTh mht_1(mht_1_v, 251, "", "./tensorflow/lite/kernels/internal/reference/prelu.h", "Prelu");
