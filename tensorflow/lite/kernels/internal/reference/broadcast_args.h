...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbroadcast_argsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbroadcast_argsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbroadcast_argsDTh() {
      // Check if tracing is enabled
...
void BroadcastArgs(const RuntimeShape& input1_shape, const T* input1_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSbroadcast_argsDTh mht_0(mht_0_v, 196, "", "./tensorflow/lite/kernels/internal/reference/broadcast_args.h", "BroadcastArgs");
