...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSgeluDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSgeluDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSgeluDTh() {
      // Check if tracing is enabled
...
inline std::function<float(float)> GeluTransform(bool approximate) {
  if (approximate) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSgeluDTh mht_0(mht_0_v, 208, "", "./tensorflow/lite/kernels/internal/reference/gelu.h", "lambda");
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSgeluDTh mht_1(mht_1_v, 220, "", "./tensorflow/lite/kernels/internal/reference/gelu.h", "lambda");
...
inline void Gelu(const RuntimeShape& input_shape, const T* input_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSgeluDTh mht_2(mht_2_v, 233, "", "./tensorflow/lite/kernels/internal/reference/gelu.h", "Gelu");
