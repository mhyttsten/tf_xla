...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdensifyDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdensifyDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdensifyDTh() {
      // Check if tracing is enabled
...
inline void Densify(const TfLiteSparsity* sparsity,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdensifyDTh mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/internal/reference/densify.h", "Densify");
