...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSspace_to_depthDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSspace_to_depthDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSspace_to_depthDTh() {
      // Check if tracing is enabled
...
inline void SpaceToDepth(const tflite::SpaceToDepthParams& op_params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSspace_to_depthDTh mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/internal/reference/space_to_depth.h", "SpaceToDepth");
