...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSadd_nDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSadd_nDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSadd_nDTh() {
      // Check if tracing is enabled
...
inline void AddN(const RuntimeShape& input_shape, const size_t num_inputs,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSadd_nDTh mht_0(mht_0_v, 198, "", "./tensorflow/lite/kernels/internal/reference/add_n.h", "AddN");
...
inline void AddN(const ArithmeticParams& params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSadd_nDTh mht_1(mht_1_v, 216, "", "./tensorflow/lite/kernels/internal/reference/add_n.h", "AddN");
