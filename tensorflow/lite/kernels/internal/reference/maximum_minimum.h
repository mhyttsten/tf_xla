...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSmaximum_minimumDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSmaximum_minimumDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSmaximum_minimumDTh() {
      // Check if tracing is enabled
...
void MaximumMinimumBroadcastSlow(const RuntimeShape& unextended_input1_shape,
  ...
  if (unextended_input1_shape == unextended_input2_shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSmaximum_minimumDTh mht_0(mht_0_v, 221, "", "./tensorflow/lite/kernels/internal/reference/maximum_minimum.h", "lambda");
