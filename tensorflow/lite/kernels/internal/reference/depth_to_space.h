...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdepth_to_spaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdepth_to_spaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdepth_to_spaceDTh() {
      // Check if tracing is enabled
...
inline void DepthToSpace(const tflite::DepthToSpaceParams& op_params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSreferencePSdepth_to_spaceDTh mht_0(mht_0_v, 197, "", "./tensorflow/lite/kernels/internal/reference/depth_to_space.h", "DepthToSpace");
