...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh() {
      // Check if tracing is enabled
...
class Mfcc {
 public:
  ...
  void set_upper_frequency_limit(double upper_frequency_limit) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh mht_0(mht_0_v, 211, "", "./tensorflow/lite/kernels/internal/mfcc.h", "set_upper_frequency_limit");
  ...
  void set_lower_frequency_limit(double lower_frequency_limit) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh mht_1(mht_1_v, 220, "", "./tensorflow/lite/kernels/internal/mfcc.h", "set_lower_frequency_limit");
  ...
  void set_filterbank_channel_count(int filterbank_channel_count) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh mht_2(mht_2_v, 229, "", "./tensorflow/lite/kernels/internal/mfcc.h", "set_filterbank_channel_count");
  ...
  void set_dct_coefficient_count(int dct_coefficient_count) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSinternalPSmfccDTh mht_3(mht_3_v, 237, "", "./tensorflow/lite/kernels/internal/mfcc.h", "set_dct_coefficient_count");
