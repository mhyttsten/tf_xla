...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_0(mht_0_v, 218, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_1(mht_1_v, 228, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_2(mht_2_v, 235, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "Prepare");
...
TfLiteStatus EvalFloat(const TfLiteTensor* input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_3(mht_3_v, 391, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "EvalFloat");
...
TfLiteStatus EvalHybrid(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_4(mht_4_v, 457, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "EvalHybrid");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_5(mht_5_v, 541, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "Eval");
...
TfLiteRegistration* Register_UNIDIRECTIONAL_SEQUENCE_RNN() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_rnnDTcc mht_6(mht_6_v, 604, "", "./tensorflow/lite/kernels/unidirectional_sequence_rnn.cc", "Register_UNIDIRECTIONAL_SEQUENCE_RNN");
