...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc mht_0(mht_0_v, 214, "", "./tensorflow/lite/kernels/floor_mod.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc mht_1(mht_1_v, 223, "", "./tensorflow/lite/kernels/floor_mod.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc mht_2(mht_2_v, 230, "", "./tensorflow/lite/kernels/floor_mod.cc", "Prepare");
...
TfLiteStatus EvalImpl(TfLiteContext* context, bool requires_broadcast,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc mht_3(mht_3_v, 276, "", "./tensorflow/lite/kernels/floor_mod.cc", "EvalImpl");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc mht_4(mht_4_v, 308, "", "./tensorflow/lite/kernels/floor_mod.cc", "Eval");
...
TfLiteRegistration* Register_FLOOR_MOD() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_modDTcc mht_5(mht_5_v, 348, "", "./tensorflow/lite/kernels/floor_mod.cc", "Register_FLOOR_MOD");
