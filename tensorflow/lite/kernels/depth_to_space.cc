...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc mht_0(mht_0_v, 210, "", "./tensorflow/lite/kernels/depth_to_space.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc mht_1(mht_1_v, 259, "", "./tensorflow/lite/kernels/depth_to_space.cc", "Eval");
...
TfLiteRegistration* Register_DEPTH_TO_SPACE_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc mht_2(mht_2_v, 326, "", "./tensorflow/lite/kernels/depth_to_space.cc", "Register_DEPTH_TO_SPACE_REF");
...
TfLiteRegistration* Register_DEPTH_TO_SPACE_GENERIC_OPT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc mht_3(mht_3_v, 336, "", "./tensorflow/lite/kernels/depth_to_space.cc", "Register_DEPTH_TO_SPACE_GENERIC_OPT");
...
TfLiteRegistration* Register_DEPTH_TO_SPACE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdepth_to_spaceDTcc mht_4(mht_4_v, 346, "", "./tensorflow/lite/kernels/depth_to_space.cc", "Register_DEPTH_TO_SPACE");
