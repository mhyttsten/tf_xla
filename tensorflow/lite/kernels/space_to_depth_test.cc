...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depth_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depth_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depth_testDTcc() {
      // Check if tracing is enabled
...
class SpaceToDepthOpModel : public SingleOpModel {
 public:
  SpaceToDepthOpModel(const TensorData& tensor_data, int block_size) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depth_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/kernels/space_to_depth_test.cc", "SpaceToDepthOpModel");
  ...
  void SetInput(std::initializer_list<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depth_testDTcc mht_1(mht_1_v, 215, "", "./tensorflow/lite/kernels/space_to_depth_test.cc", "SetInput");
