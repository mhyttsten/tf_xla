...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh() {
      // Check if tracing is enabled
...
struct CustomGemvImpl {
  ...
  static bool IsSupportedGivenSufficientlyManyRows(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_0(mht_0_v, 252, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "IsSupportedGivenSufficientlyManyRows");
  ...
  static void Run(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_1(mht_1_v, 265, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Run");
}
};
...
class CustomGemvTask : public cpu_backend_threadpool::Task {
 public:
  CustomGemvTask(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_2(mht_2_v, 290, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "CustomGemvTask");
}

  void Run() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_3(mht_3_v, 295, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Run");
...
inline int16x8x2_t Load16AndSubtractZeroPoint(const std::int8_t* src,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_4(mht_4_v, 390, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Load16AndSubtractZeroPoint");
...
inline int16x8_t Load8AndSubtractZeroPoint(const std::uint8_t* src,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_5(mht_5_v, 405, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Load8AndSubtractZeroPoint");
...
inline int16x8_t Load8AndSubtractZeroPoint(const std::int8_t* src,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_6(mht_6_v, 416, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Load8AndSubtractZeroPoint");
...
inline void ClampAndStore(int32x4_t src, std::uint8_t clamp_min,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_7(mht_7_v, 427, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "ClampAndStore");
...
inline void ClampAndStore(int32x4_t src, std::int8_t clamp_min,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_8(mht_8_v, 446, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "ClampAndStore");
...
inline void ClampAndStore(int32x4_t src, std::int16_t clamp_min,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_9(mht_9_v, 465, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "ClampAndStore");
...
struct CustomGemvImpl<LhsScalar, RhsScalar, std::int32_t, DstScalar,
  ...
  static bool IsSupportedGivenSufficientlyManyRows(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_10(mht_10_v, 512, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "IsSupportedGivenSufficientlyManyRows");
  ...
  static void Run(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_11(mht_11_v, 529, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Run");
...
struct CustomGemvImpl<float, float, float, float,
  ...
  static bool IsSupportedGivenSufficientlyManyRows(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_12(mht_12_v, 832, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "IsSupportedGivenSufficientlyManyRows");
  ...
  static void Run(const MatrixParams<float>& lhs_params, const float* lhs_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_custom_gemvDTh mht_13(mht_13_v, 847, "", "./tensorflow/lite/kernels/cpu_backend_gemm_custom_gemv.h", "Run");
