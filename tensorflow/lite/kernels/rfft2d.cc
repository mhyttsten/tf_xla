...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc() {
      // Check if tracing is enabled
...
bool IsPowerOfTwo(uint32_t v) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_0(mht_0_v, 222, "", "./tensorflow/lite/kernels/rfft2d.cc", "IsPowerOfTwo");
 return v && !(v & (v - 1)); }

static TfLiteStatus InitTemporaryTensors(TfLiteContext* context,
                                         TfLiteNode* node) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_1(mht_1_v, 228, "", "./tensorflow/lite/kernels/rfft2d.cc", "InitTemporaryTensors");
...
TfLiteStatus ResizeOutputandTemporaryTensors(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_2(mht_2_v, 281, "", "./tensorflow/lite/kernels/rfft2d.cc", "ResizeOutputandTemporaryTensors");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_3(mht_3_v, 338, "", "./tensorflow/lite/kernels/rfft2d.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_4(mht_4_v, 346, "", "./tensorflow/lite/kernels/rfft2d.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_5(mht_5_v, 353, "", "./tensorflow/lite/kernels/rfft2d.cc", "Prepare");
...
void Rfft2dReorder(int fft_height, int fft_width, double** fft_input_output) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_6(mht_6_v, 435, "", "./tensorflow/lite/kernels/rfft2d.cc", "Rfft2dReorder");
...
void Rfft2dImpl(int fft_height, int fft_width, double** fft_input_output,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_7(mht_7_v, 493, "", "./tensorflow/lite/kernels/rfft2d.cc", "Rfft2dImpl");
...
void PrepareInputBuffer(const float* input_data, int input_height,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_8(mht_8_v, 510, "", "./tensorflow/lite/kernels/rfft2d.cc", "PrepareInputBuffer");
...
void PrepareOutputBuffer(complex<float>* output_data, int fft_height,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_9(mht_9_v, 536, "", "./tensorflow/lite/kernels/rfft2d.cc", "PrepareOutputBuffer");
...
TfLiteStatus Rfft2dHelper(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_10(mht_10_v, 549, "", "./tensorflow/lite/kernels/rfft2d.cc", "Rfft2dHelper");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_11(mht_11_v, 629, "", "./tensorflow/lite/kernels/rfft2d.cc", "Eval");
...
TfLiteRegistration* Register_RFFT2D() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2dDTcc mht_12(mht_12_v, 670, "", "./tensorflow/lite/kernels/rfft2d.cc", "Register_RFFT2D");
