...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc() {
      // Check if tracing is enabled
...
class QuantizedLSTMOpModel : public MultiOpModel {
 public:
  QuantizedLSTMOpModel(int numBatches, int inputSize, float weightsScale,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/kernels/quant_basic_lstm_test.cc", "QuantizedLSTMOpModel");
  ...
  int inputSize() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc mht_1(mht_1_v, 301, "", "./tensorflow/lite/kernels/quant_basic_lstm_test.cc", "inputSize");
 return input_size_; }

  int outputSize() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc mht_2(mht_2_v, 306, "", "./tensorflow/lite/kernels/quant_basic_lstm_test.cc", "outputSize");
 return output_size_; }

  void setInput(const std::vector<uint8_t>& input) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc mht_3(mht_3_v, 311, "", "./tensorflow/lite/kernels/quant_basic_lstm_test.cc", "setInput");
...
class QuantizedLstmTest : public ::testing::Test,
 ...
 protected:
  void VerifyGoldens(const std::vector<std::vector<uint8_t>>& input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSquant_basic_lstm_testDTcc mht_4(mht_4_v, 349, "", "./tensorflow/lite/kernels/quant_basic_lstm_test.cc", "VerifyGoldens");
