...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc() {
      // Check if tracing is enabled
...
class ArgBaseOpModel : public SingleOpModel {
 public:
  ArgBaseOpModel(TensorType input_type, int axis_value, TensorType axis_type,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "ArgBaseOpModel");
  ...
  int input() const {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_1(mht_1_v, 224, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "input");
 return input_; }
  int axis() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_2(mht_2_v, 228, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "axis");
 return axis_; }
 ...
 protected:
  void PopulateAxisIfNeeded() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_3(mht_3_v, 242, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "PopulateAxisIfNeeded");
...
class ArgMaxOpModel : public ArgBaseOpModel {
 public:
  ArgMaxOpModel(std::initializer_list<int> input_shape, TensorType input_type,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_4(mht_4_v, 269, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "ArgMaxOpModel");
...
class ArgMinOpModel : public ArgBaseOpModel {
 public:
  ArgMinOpModel(std::initializer_list<int> input_shape, TensorType input_type,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_5(mht_5_v, 287, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "ArgMinOpModel");
...
class ArgMinMaxOpTest : public ::testing::TestWithParam<
 ...
 public:
  bool ConstantAxis() const {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_6(mht_6_v, 307, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "ConstantAxis");
 return std::get<0>(GetParam()); }

  TensorType AxisType() const {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_7(mht_7_v, 312, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "AxisType");
 return std::get<1>(GetParam()); }

  TensorType OutputType() const {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_8(mht_8_v, 317, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "OutputType");
 return std::get<2>(GetParam()); }

  void ValidateOutput(const ArgBaseOpModel& model,
                      const std::vector<int>& expected_output) {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSarg_min_max_testDTcc mht_9(mht_9_v, 323, "", "./tensorflow/lite/kernels/arg_min_max_test.cc", "ValidateOutput");
