...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSrankDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrankDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSrankDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrankDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/rank.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrankDTcc mht_1(mht_1_v, 236, "", "./tensorflow/lite/kernels/rank.cc", "Eval");
...
TfLiteRegistration* Register_RANK() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrankDTcc mht_2(mht_2_v, 245, "", "./tensorflow/lite/kernels/rank.cc", "Register_RANK");
