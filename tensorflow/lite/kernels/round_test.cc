...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSround_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSround_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSround_testDTcc() {
      // Check if tracing is enabled
...
class RoundOpModel : public SingleOpModel {
 public:
  RoundOpModel(std::initializer_list<int> input_shape, TensorType input_type) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSround_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/round_test.cc", "RoundOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSround_testDTcc mht_1(mht_1_v, 211, "", "./tensorflow/lite/kernels/round_test.cc", "input");
 return input_; }
