...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc() {
      // Check if tracing is enabled
...
class RankOpModel : public SingleOpModel {
 public:
  RankOpModel(std::initializer_list<int> input_shape, TensorType input_type) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/kernels/rank_test.cc", "RankOpModel");
  ...
  TfLiteStatus InvokeWithResult() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc mht_1(mht_1_v, 216, "", "./tensorflow/lite/kernels/rank_test.cc", "InvokeWithResult");
 return interpreter_->Invoke(); }

  int input() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc mht_2(mht_2_v, 221, "", "./tensorflow/lite/kernels/rank_test.cc", "input");
 return input_; }
  ...
  TfLiteAllocationType GetOutputAllocationType() const {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrank_testDTcc mht_3(mht_3_v, 228, "", "./tensorflow/lite/kernels/rank_test.cc", "GetOutputAllocationType");
