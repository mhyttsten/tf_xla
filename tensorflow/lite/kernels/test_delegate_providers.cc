...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTcc() {
      // Check if tracing is enabled
...
/*static*/ KernelTestDelegateProviders* KernelTestDelegateProviders::Get() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/kernels/test_delegate_providers.cc", "KernelTestDelegateProviders::Get");
...
KernelTestDelegateProviders::KernelTestDelegateProviders()
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTcc mht_1(mht_1_v, 203, "", "./tensorflow/lite/kernels/test_delegate_providers.cc", "KernelTestDelegateProviders::KernelTestDelegateProviders");
...
bool KernelTestDelegateProviders::InitFromCmdlineArgs(int* argc,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTcc mht_2(mht_2_v, 212, "", "./tensorflow/lite/kernels/test_delegate_providers.cc", "KernelTestDelegateProviders::InitFromCmdlineArgs");
