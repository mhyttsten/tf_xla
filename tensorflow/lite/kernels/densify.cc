...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc() {
      // Check if tracing is enabled
...
struct OpContext {
  OpContext(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/densify.cc", "OpContext");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc mht_1(mht_1_v, 216, "", "./tensorflow/lite/kernels/densify.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc mht_2(mht_2_v, 225, "", "./tensorflow/lite/kernels/densify.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc mht_3(mht_3_v, 232, "", "./tensorflow/lite/kernels/densify.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc mht_4(mht_4_v, 252, "", "./tensorflow/lite/kernels/densify.cc", "Eval");
...
TfLiteRegistration* Register_DENSIFY() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSdensifyDTcc mht_5(mht_5_v, 297, "", "./tensorflow/lite/kernels/densify.cc", "Register_DENSIFY");
