...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSacceleration_test_util_internalDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSacceleration_test_util_internalDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSacceleration_test_util_internalDTcc() {
      // Check if tracing is enabled
...
void ReadAccelerationConfig(
   ...
   mht_0_v.push_back("config: \"" + (config == nullptr ? std::string("nullptr") : std::string((char*)config)) + "\"");
   MHTracer_DTPStensorflowPSlitePSkernelsPSacceleration_test_util_internalDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/acceleration_test_util_internal.cc", "ReadAccelerationConfig");
