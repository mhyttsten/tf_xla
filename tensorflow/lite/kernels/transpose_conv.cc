...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_0(mht_0_v, 265, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_1(mht_1_v, 272, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Free");
...
TfLiteStatus ResizeTensor(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_2(mht_2_v, 281, "", "./tensorflow/lite/kernels/transpose_conv.cc", "ResizeTensor");
...
static TfLiteStatus AllocateTemporaryTensorsIfRequired(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_3(mht_3_v, 305, "", "./tensorflow/lite/kernels/transpose_conv.cc", "AllocateTemporaryTensorsIfRequired");
...
TfLiteStatus ResizeCol2ImTensor(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_4(mht_4_v, 353, "", "./tensorflow/lite/kernels/transpose_conv.cc", "ResizeCol2ImTensor");
...
TfLiteStatus ResizeAndTransposeWeights(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_5(mht_5_v, 377, "", "./tensorflow/lite/kernels/transpose_conv.cc", "ResizeAndTransposeWeights");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_6(mht_6_v, 429, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Prepare");
...
void EvalFloat(TfLiteContext* context, const TfLiteTransposeConvParams* params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_7(mht_7_v, 591, "", "./tensorflow/lite/kernels/transpose_conv.cc", "EvalFloat");
...
void EvalQuantized(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_8(mht_8_v, 634, "", "./tensorflow/lite/kernels/transpose_conv.cc", "EvalQuantized");
...
void EvalQuantizedPerChannel(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_9(mht_9_v, 688, "", "./tensorflow/lite/kernels/transpose_conv.cc", "EvalQuantizedPerChannel");
...
void EvalQuantizedPerChannel16x8(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_10(mht_10_v, 739, "", "./tensorflow/lite/kernels/transpose_conv.cc", "EvalQuantizedPerChannel16x8");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_11(mht_11_v, 798, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Eval");
...
TfLiteRegistration* Register_TRANSPOSECONV_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_12(mht_12_v, 931, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Register_TRANSPOSECONV_REF");
...
TfLiteRegistration* Register_TRANSPOSECONV_GENERIC_OPT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_13(mht_13_v, 942, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Register_TRANSPOSECONV_GENERIC_OPT");
...
TfLiteRegistration* Register_TRANSPOSE_CONV() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStranspose_convDTcc mht_14(mht_14_v, 953, "", "./tensorflow/lite/kernels/transpose_conv.cc", "Register_TRANSPOSE_CONV");
