...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTh() {
      // Check if tracing is enabled
...
class BuiltinOpResolverWithoutDefaultDelegates : public BuiltinOpResolver {
 public:
  BuiltinOpResolverWithoutDefaultDelegates() : BuiltinOpResolver() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSregisterDTh mht_0(mht_0_v, 210, "", "./tensorflow/lite/kernels/register.h", "BuiltinOpResolverWithoutDefaultDelegates");
