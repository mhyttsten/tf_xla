...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus PopulateQuantizedLstmParams8x8_16(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_0(mht_0_v, 219, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "PopulateQuantizedLstmParams8x8_16");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_1(mht_1_v, 577, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_2(mht_2_v, 587, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "Free");
...
TfLiteStatus CheckInputTensorDimensions(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_3(mht_3_v, 598, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "CheckInputTensorDimensions");
...
TfLiteStatus PrecomputeZeroPointTimesWeightWithBias(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_4(mht_4_v, 870, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "PrecomputeZeroPointTimesWeightWithBias");
...
TfLiteStatus PopulatePrecomputedZPTimesWeightsWithBias(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_5(mht_5_v, 899, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "PopulatePrecomputedZPTimesWeightsWithBias");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_6(mht_6_v, 1045, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_7(mht_7_v, 1405, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "Eval");
...
TfLiteRegistration* Register_UNIDIRECTIONAL_SEQUENCE_LSTM() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSunidirectional_sequence_lstmDTcc mht_8(mht_8_v, 1643, "", "./tensorflow/lite/kernels/unidirectional_sequence_lstm.cc", "Register_UNIDIRECTIONAL_SEQUENCE_LSTM");
