...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTh() {
      // Check if tracing is enabled
...
class KernelTestDelegateProviders {
 public:
  ...
  tools::ToolParams* MutableParams() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTh mht_0(mht_0_v, 218, "", "./tensorflow/lite/kernels/test_delegate_providers.h", "MutableParams");
 return &params_; }
  const tools::ToolParams& ConstParams() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPStest_delegate_providersDTh mht_1(mht_1_v, 222, "", "./tensorflow/lite/kernels/test_delegate_providers.h", "ConstParams");
 return params_; }
