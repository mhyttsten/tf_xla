...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_threadpool_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_threadpool_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_threadpool_testDTcc() {
      // Check if tracing is enabled
...
class TestGenerateArrayOfIncrementingIntsTask
 ...
 public:
  TestGenerateArrayOfIncrementingIntsTask(int* buffer, int start, int end)
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_threadpool_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/cpu_backend_threadpool_test.cc", "TestGenerateArrayOfIncrementingIntsTask");
}

  void Run() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_threadpool_testDTcc mht_1(mht_1_v, 205, "", "./tensorflow/lite/kernels/cpu_backend_threadpool_test.cc", "Run");
...
void TestGenerateArrayOfIncrementingInts(int num_threads, int size) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_threadpool_testDTcc mht_2(mht_2_v, 220, "", "./tensorflow/lite/kernels/cpu_backend_threadpool_test.cc", "TestGenerateArrayOfIncrementingInts");
