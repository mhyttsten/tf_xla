...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc() {
      // Check if tracing is enabled
...
class BaseSqueezeOpModel : public SingleOpModel {
 public:
  BaseSqueezeOpModel(const TensorData& input, const TensorData& output,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/kernels/squeeze_test.cc", "BaseSqueezeOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc mht_1(mht_1_v, 217, "", "./tensorflow/lite/kernels/squeeze_test.cc", "input");
 return input_; }
...
class SqueezeOpModel : public BaseSqueezeOpModel {
 public:
  ...
  void SetInput(std::initializer_list<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc mht_2(mht_2_v, 232, "", "./tensorflow/lite/kernels/squeeze_test.cc", "SetInput");
 PopulateTensor(input_, data); }

  void SetStringInput(std::initializer_list<string> data) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueeze_testDTcc mht_3(mht_3_v, 237, "", "./tensorflow/lite/kernels/squeeze_test.cc", "SetStringInput");
