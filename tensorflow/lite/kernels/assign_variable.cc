...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSassign_variableDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSassign_variableDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSassign_variableDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSassign_variableDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/assign_variable.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSassign_variableDTcc mht_1(mht_1_v, 218, "", "./tensorflow/lite/kernels/assign_variable.cc", "Eval");
...
TfLiteRegistration* Register_ASSIGN_VARIABLE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSassign_variableDTcc mht_2(mht_2_v, 243, "", "./tensorflow/lite/kernels/assign_variable.cc", "Register_ASSIGN_VARIABLE");
