...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSshimPStflite_tensor_view_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshimPStflite_tensor_view_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSshimPStflite_tensor_view_testDTcc() {
      // Check if tracing is enabled
...
void IntTest() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshimPStflite_tensor_view_testDTcc mht_0(mht_0_v, 224, "", "./tensorflow/lite/kernels/shim/tflite_tensor_view_test.cc", "IntTest");
...
void FloatTest() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshimPStflite_tensor_view_testDTcc mht_1(mht_1_v, 255, "", "./tensorflow/lite/kernels/shim/tflite_tensor_view_test.cc", "FloatTest");
