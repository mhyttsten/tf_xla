...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_testDTcc() {
      // Check if tracing is enabled
...
class ReverseOpModel : public SingleOpModel {
 public:
  ReverseOpModel(const TensorData& input, const TensorData& axis) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/reverse_test.cc", "ReverseOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_testDTcc mht_1(mht_1_v, 215, "", "./tensorflow/lite/kernels/reverse_test.cc", "input");
 return input_; }
  int axis() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_testDTcc mht_2(mht_2_v, 219, "", "./tensorflow/lite/kernels/reverse_test.cc", "axis");
 return axis_; }
