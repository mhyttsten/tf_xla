...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc() {
      // Check if tracing is enabled
...
class MatrixSetDiagOpModel : public SingleOpModel {
 public:
  explicit MatrixSetDiagOpModel(const TensorData& input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/kernels/matrix_set_diag_test.cc", "MatrixSetDiagOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc mht_1(mht_1_v, 219, "", "./tensorflow/lite/kernels/matrix_set_diag_test.cc", "input");
 return input_; }
  int diag() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc mht_2(mht_2_v, 223, "", "./tensorflow/lite/kernels/matrix_set_diag_test.cc", "diag");
 return diag_; }
  ...
  TfLiteType GetOutputType() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmatrix_set_diag_testDTcc mht_3(mht_3_v, 230, "", "./tensorflow/lite/kernels/matrix_set_diag_test.cc", "GetOutputType");
