...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc() {
      // Check if tracing is enabled
...
std::string ToString(const std::vector<Scalar>& vector) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "ToString");
...
void MakeDeterministicPseudoRandomVector(int size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_1(mht_1_v, 237, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "MakeDeterministicPseudoRandomVector");
...
void MakeVectorFilledWithConsecutiveInts(int size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_2(mht_2_v, 276, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "MakeVectorFilledWithConsecutiveInts");
...
Scalar Median(const std::vector<Scalar>& vector) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_3(mht_3_v, 288, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "Median");
...
double MedianAbs(const std::vector<Scalar>& vector) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_4(mht_4_v, 299, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "MedianAbs");
...
void Clamp(const std::vector<Scalar>& src, Scalar clamp_min, Scalar clamp_max,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_5(mht_5_v, 315, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "Clamp");
...
void ComputeErrorStats(const std::vector<Scalar>& actual,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_6(mht_6_v, 346, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "ComputeErrorStats");
...
void TestSomeGemm(int rows, int depth, int cols,
  ...
  auto random_order = [&]() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_7(mht_7_v, 582, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "lambda");
...
void TestRandomGemms(const std::vector<std::tuple<int, int, int>>& shapes) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScpu_backend_gemm_testDTcc mht_8(mht_8_v, 838, "", "./tensorflow/lite/kernels/cpu_backend_gemm_test.cc", "TestRandomGemms");
