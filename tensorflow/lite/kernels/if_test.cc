...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSif_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSif_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSif_testDTcc() {
      // Check if tracing is enabled
...
class SimpleIfTest : public ControlFlowOpTest {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSif_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/lite/kernels/if_test.cc", "SetUp");
...
class DynamicSubgraphIfTest : public ControlFlowOpTest {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSif_testDTcc mht_1(mht_1_v, 244, "", "./tensorflow/lite/kernels/if_test.cc", "SetUp");
