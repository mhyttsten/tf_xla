...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc() {
      // Check if tracing is enabled
...
struct OpContext {
  OpContext(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_0(mht_0_v, 240, "", "./tensorflow/lite/kernels/batch_matmul.cc", "OpContext");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_1(mht_1_v, 256, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_2(mht_2_v, 271, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Free");
...
TfLiteStatus ResizeOutputTensor(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_3(mht_3_v, 282, "", "./tensorflow/lite/kernels/batch_matmul.cc", "ResizeOutputTensor");
...
TfLiteStatus InitializeTemporaries(TfLiteContext* context, TfLiteNode* node,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_4(mht_4_v, 309, "", "./tensorflow/lite/kernels/batch_matmul.cc", "InitializeTemporaries");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_5(mht_5_v, 476, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Prepare");
...
void TransposeRowsColumnsImpl(const TfLiteTensor* tensor_in,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_6(mht_6_v, 579, "", "./tensorflow/lite/kernels/batch_matmul.cc", "TransposeRowsColumnsImpl");
...
TfLiteStatus TransposeRowsColumns(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_7(mht_7_v, 601, "", "./tensorflow/lite/kernels/batch_matmul.cc", "TransposeRowsColumns");
...
RuntimeShape SwapRowColumnDims(const RuntimeShape& shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_8(mht_8_v, 627, "", "./tensorflow/lite/kernels/batch_matmul.cc", "SwapRowColumnDims");
...
TfLiteStatus EvalHybrid(TfLiteContext* context, TfLiteNode* node, OpData* data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_9(mht_9_v, 647, "", "./tensorflow/lite/kernels/batch_matmul.cc", "EvalHybrid");
...
TfLiteStatus EvalInt8Int8(TfLiteContext* context, const OpData* data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_10(mht_10_v, 717, "", "./tensorflow/lite/kernels/batch_matmul.cc", "EvalInt8Int8");
...
TfLiteStatus EvalInt8Int32(TfLiteContext* context, const OpData* data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_11(mht_11_v, 758, "", "./tensorflow/lite/kernels/batch_matmul.cc", "EvalInt8Int32");
...
TfLiteStatus EvalInt16(TfLiteContext* context, const OpData* data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_12(mht_12_v, 773, "", "./tensorflow/lite/kernels/batch_matmul.cc", "EvalInt16");
...
TfLiteStatus EvalQuantized(TfLiteContext* context, TfLiteNode* node,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_13(mht_13_v, 804, "", "./tensorflow/lite/kernels/batch_matmul.cc", "EvalQuantized");
...
TfLiteTensor* GetTempRhs(TfLiteContext* context, TfLiteNode* node,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_14(mht_14_v, 849, "", "./tensorflow/lite/kernels/batch_matmul.cc", "GetTempRhs");
...
TfLiteTensor* GetTempLhs(TfLiteContext* context, TfLiteNode* node,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_15(mht_15_v, 867, "", "./tensorflow/lite/kernels/batch_matmul.cc", "GetTempLhs");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_16(mht_16_v, 896, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Eval");
...
TfLiteRegistration* Register_BATCH_MATMUL_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_17(mht_17_v, 967, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Register_BATCH_MATMUL_REF");
...
TfLiteRegistration* Register_BATCH_MATMUL_GENERIC_OPTIMIZED() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_18(mht_18_v, 977, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Register_BATCH_MATMUL_GENERIC_OPTIMIZED");
...
TfLiteRegistration* Register_BATCH_MATMUL() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbatch_matmulDTcc mht_19(mht_19_v, 987, "", "./tensorflow/lite/kernels/batch_matmul.cc", "Register_BATCH_MATMUL");
