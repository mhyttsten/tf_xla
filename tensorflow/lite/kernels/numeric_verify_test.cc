...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSnumeric_verify_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSnumeric_verify_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSnumeric_verify_testDTcc() {
      // Check if tracing is enabled
...
class NumericVerifyOpModel : public SingleOpModel {
 public:
  NumericVerifyOpModel(TensorType type, std::initializer_list<int> shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSnumeric_verify_testDTcc mht_0(mht_0_v, 217, "", "./tensorflow/lite/kernels/numeric_verify_test.cc", "NumericVerifyOpModel");
  ...
  void SetInputs(std::initializer_list<T> data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSnumeric_verify_testDTcc mht_1(mht_1_v, 244, "", "./tensorflow/lite/kernels/numeric_verify_test.cc", "SetInputs");
