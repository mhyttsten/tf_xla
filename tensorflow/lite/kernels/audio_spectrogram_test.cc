...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSaudio_spectrogram_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaudio_spectrogram_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSaudio_spectrogram_testDTcc() {
      // Check if tracing is enabled
...
class BaseAudioSpectrogramOpModel : public SingleOpModel {
 public:
  BaseAudioSpectrogramOpModel(const TensorData& input1,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaudio_spectrogram_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/kernels/audio_spectrogram_test.cc", "BaseAudioSpectrogramOpModel");
  ...
  int input1() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaudio_spectrogram_testDTcc mht_1(mht_1_v, 227, "", "./tensorflow/lite/kernels/audio_spectrogram_test.cc", "input1");
 return input1_; }
