...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSread_variableDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSread_variableDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSread_variableDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSread_variableDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/kernels/read_variable.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSread_variableDTcc mht_1(mht_1_v, 230, "", "./tensorflow/lite/kernels/read_variable.cc", "Eval");
...
TfLiteRegistration* Register_READ_VARIABLE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSread_variableDTcc mht_2(mht_2_v, 263, "", "./tensorflow/lite/kernels/read_variable.cc", "Register_READ_VARIABLE");
