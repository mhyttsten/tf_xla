...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_0(mht_0_v, 248, "", "./tensorflow/lite/kernels/add.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_1(mht_1_v, 256, "", "./tensorflow/lite/kernels/add.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_2(mht_2_v, 263, "", "./tensorflow/lite/kernels/add.cc", "Prepare");
...
void EvalAdd(TfLiteContext* context, TfLiteNode* node, TfLiteAddParams* params,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_3(mht_3_v, 414, "", "./tensorflow/lite/kernels/add.cc", "EvalAdd");
...
TfLiteStatus EvalAddQuantized(TfLiteContext* context, TfLiteNode* node,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_4(mht_4_v, 482, "", "./tensorflow/lite/kernels/add.cc", "EvalAddQuantized");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_5(mht_5_v, 576, "", "./tensorflow/lite/kernels/add.cc", "Eval");
...
TfLiteRegistration* Register_ADD_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_6(mht_6_v, 610, "", "./tensorflow/lite/kernels/add.cc", "Register_ADD_REF");
...
TfLiteRegistration* Register_ADD_GENERIC_OPT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_7(mht_7_v, 619, "", "./tensorflow/lite/kernels/add.cc", "Register_ADD_GENERIC_OPT");
...
TfLiteRegistration* Register_ADD_NEON_OPT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_8(mht_8_v, 628, "", "./tensorflow/lite/kernels/add.cc", "Register_ADD_NEON_OPT");
...
TfLiteRegistration* Register_ADD() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSaddDTcc mht_9(mht_9_v, 637, "", "./tensorflow/lite/kernels/add.cc", "Register_ADD");
