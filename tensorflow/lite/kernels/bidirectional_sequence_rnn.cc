...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_0(mht_0_v, 250, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_1(mht_1_v, 260, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_2(mht_2_v, 267, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "Prepare");
...
TfLiteStatus EvalFloat(const TfLiteTensor* input, const TfLiteTensor* bw_input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_3(mht_3_v, 563, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "EvalFloat");
...
TfLiteStatus EvalHybrid(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_4(mht_4_v, 712, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "EvalHybrid");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_5(mht_5_v, 895, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "Eval");
...
TfLiteRegistration* Register_BIDIRECTIONAL_SEQUENCE_RNN() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_rnnDTcc mht_6(mht_6_v, 1028, "", "./tensorflow/lite/kernels/bidirectional_sequence_rnn.cc", "Register_BIDIRECTIONAL_SEQUENCE_RNN");
