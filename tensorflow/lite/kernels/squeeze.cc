...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc() {
      // Check if tracing is enabled
...
struct SqueezeContext {
  SqueezeContext(TfLiteContext* context, TfLiteNode* node)
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/squeeze.cc", "SqueezeContext");
}
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc mht_1(mht_1_v, 210, "", "./tensorflow/lite/kernels/squeeze.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc mht_2(mht_2_v, 255, "", "./tensorflow/lite/kernels/squeeze.cc", "Eval");
...
TfLiteRegistration* Register_SQUEEZE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSsqueezeDTcc mht_3(mht_3_v, 279, "", "./tensorflow/lite/kernels/squeeze.cc", "Register_SQUEEZE");
