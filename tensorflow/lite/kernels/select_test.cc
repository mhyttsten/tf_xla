...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc() {
      // Check if tracing is enabled
...
class BaseSelectOpModel : public SingleOpModel {
 public:
  BaseSelectOpModel(std::initializer_list<int> input1_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/kernels/select_test.cc", "BaseSelectOpModel");
  ...
  int input1() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/lite/kernels/select_test.cc", "input1");
 return input1_; }
  int input2() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc mht_2(mht_2_v, 218, "", "./tensorflow/lite/kernels/select_test.cc", "input2");
 return input2_; }
  int input3() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc mht_3(mht_3_v, 222, "", "./tensorflow/lite/kernels/select_test.cc", "input3");
 return input3_; }
...
class SelectOpModel : public BaseSelectOpModel {
 public:
  SelectOpModel(std::initializer_list<int> input1_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc mht_4(mht_4_v, 247, "", "./tensorflow/lite/kernels/select_test.cc", "SelectOpModel");
...
class SelectV2OpModel : public BaseSelectOpModel {
 public:
  SelectV2OpModel(std::initializer_list<int> input1_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSselect_testDTcc mht_5(mht_5_v, 264, "", "./tensorflow/lite/kernels/select_test.cc", "SelectV2OpModel");
