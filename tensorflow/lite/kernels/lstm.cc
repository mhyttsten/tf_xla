...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus make_ledger(const TfLiteSparsity* sparsity, TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_0(mht_0_v, 265, "", "./tensorflow/lite/kernels/lstm.cc", "make_ledger");
...
TfLiteStatus copy_ledger(const TfLiteSparsity* sparsity, TfLiteTensor* ledger) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_1(mht_1_v, 280, "", "./tensorflow/lite/kernels/lstm.cc", "copy_ledger");
...
TfLiteStatus PopulateQuantizedLstmParams8x8_16(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_2(mht_2_v, 318, "", "./tensorflow/lite/kernels/lstm.cc", "PopulateQuantizedLstmParams8x8_16");
...
TfLiteStatus PopulateQuantizedLstmParams8x8_8(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_3(mht_3_v, 643, "", "./tensorflow/lite/kernels/lstm.cc", "PopulateQuantizedLstmParams8x8_8");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_4(mht_4_v, 1020, "", "./tensorflow/lite/kernels/lstm.cc", "Init");
...
TfLiteStatus CheckInputTensorDimensions(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_5(mht_5_v, 1040, "", "./tensorflow/lite/kernels/lstm.cc", "CheckInputTensorDimensions");
...
TfLiteStatus PrecomputeZeroPointTimesWeightWithBias(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_6(mht_6_v, 1316, "", "./tensorflow/lite/kernels/lstm.cc", "PrecomputeZeroPointTimesWeightWithBias");
...
TfLiteStatus PopulatePrecomputedZPTimesWeightsWithBias(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_7(mht_7_v, 1345, "", "./tensorflow/lite/kernels/lstm.cc", "PopulatePrecomputedZPTimesWeightsWithBias");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_8(mht_8_v, 1478, "", "./tensorflow/lite/kernels/lstm.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_9(mht_9_v, 2022, "", "./tensorflow/lite/kernels/lstm.cc", "Eval");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_10(mht_10_v, 2352, "", "./tensorflow/lite/kernels/lstm.cc", "Init");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_11(mht_11_v, 2363, "", "./tensorflow/lite/kernels/lstm.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_12(mht_12_v, 2443, "", "./tensorflow/lite/kernels/lstm.cc", "Eval");
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_13(mht_13_v, 2561, "", "./tensorflow/lite/kernels/lstm.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_14(mht_14_v, 2575, "", "./tensorflow/lite/kernels/lstm.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_15(mht_15_v, 2582, "", "./tensorflow/lite/kernels/lstm.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_16(mht_16_v, 2597, "", "./tensorflow/lite/kernels/lstm.cc", "Eval");
...
TfLiteRegistration* Register_LSTM() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlstmDTcc mht_17(mht_17_v, 2614, "", "./tensorflow/lite/kernels/lstm.cc", "Register_LSTM");
