...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc() {
      // Check if tracing is enabled
...
class RealOpModel : public SingleOpModel {
 public:
  RealOpModel(const TensorData& input, const TensorData& output) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/complex_support_test.cc", "RealOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc mht_1(mht_1_v, 215, "", "./tensorflow/lite/kernels/complex_support_test.cc", "input");
 return input_; }
...
class ImagOpModel : public SingleOpModel {
 public:
  ImagOpModel(const TensorData& input, const TensorData& output) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc mht_2(mht_2_v, 268, "", "./tensorflow/lite/kernels/complex_support_test.cc", "ImagOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc mht_3(mht_3_v, 282, "", "./tensorflow/lite/kernels/complex_support_test.cc", "input");
 return input_; }
...
class ComplexAbsOpModel : public SingleOpModel {
 public:
  ComplexAbsOpModel(const TensorData& input, const TensorData& output) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc mht_4(mht_4_v, 335, "", "./tensorflow/lite/kernels/complex_support_test.cc", "ComplexAbsOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPScomplex_support_testDTcc mht_5(mht_5_v, 349, "", "./tensorflow/lite/kernels/complex_support_test.cc", "input");
 return input_; }
