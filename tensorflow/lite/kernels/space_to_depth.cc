...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc mht_0(mht_0_v, 210, "", "./tensorflow/lite/kernels/space_to_depth.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc mht_1(mht_1_v, 255, "", "./tensorflow/lite/kernels/space_to_depth.cc", "Eval");
...
TfLiteRegistration* Register_SPACE_TO_DEPTH_REF() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc mht_2(mht_2_v, 322, "", "./tensorflow/lite/kernels/space_to_depth.cc", "Register_SPACE_TO_DEPTH_REF");
...
TfLiteRegistration* Register_SPACE_TO_DEPTH_GENERIC_OPT() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc mht_3(mht_3_v, 332, "", "./tensorflow/lite/kernels/space_to_depth.cc", "Register_SPACE_TO_DEPTH_GENERIC_OPT");
...
TfLiteRegistration* Register_SPACE_TO_DEPTH() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSspace_to_depthDTcc mht_4(mht_4_v, 342, "", "./tensorflow/lite/kernels/space_to_depth.cc", "Register_SPACE_TO_DEPTH");
