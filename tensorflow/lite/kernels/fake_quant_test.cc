...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSfake_quant_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfake_quant_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSfake_quant_testDTcc() {
      // Check if tracing is enabled
...
class FakeQuantOpModel : public SingleOpModel {
 public:
  FakeQuantOpModel(const TensorData& input, const TensorType& output, float min,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfake_quant_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/fake_quant_test.cc", "FakeQuantOpModel");
  ...
  void SetInput(std::initializer_list<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfake_quant_testDTcc mht_1(mht_1_v, 213, "", "./tensorflow/lite/kernels/fake_quant_test.cc", "SetInput");
