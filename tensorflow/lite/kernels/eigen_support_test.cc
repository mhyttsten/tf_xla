...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSeigen_support_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSeigen_support_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSeigen_support_testDTcc() {
      // Check if tracing is enabled
...
struct TestTfLiteContext : public TfLiteContext {
  TestTfLiteContext() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSeigen_support_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/kernels/eigen_support_test.cc", "TestTfLiteContext");
  ...
  static void SetExternalContextImpl(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSeigen_support_testDTcc mht_1(mht_1_v, 209, "", "./tensorflow/lite/kernels/eigen_support_test.cc", "SetExternalContextImpl");
  ...
  static TfLiteExternalContext* GetExternalContextImpl(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSeigen_support_testDTcc mht_2(mht_2_v, 218, "", "./tensorflow/lite/kernels/eigen_support_test.cc", "GetExternalContextImpl");
