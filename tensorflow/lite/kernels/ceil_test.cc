...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSceil_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSceil_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSceil_testDTcc() {
      // Check if tracing is enabled
...
class CeilOpModel : public SingleOpModel {
 public:
  CeilOpModel(std::initializer_list<int> input_shape, TensorType input_type) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSceil_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/ceil_test.cc", "CeilOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSceil_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/kernels/ceil_test.cc", "input");
 return input_; }
