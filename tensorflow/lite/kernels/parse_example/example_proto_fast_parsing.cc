...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc() {
      // Check if tracing is enabled
...
string ExampleName(const gtl::ArraySlice<tstring> example_names, int n) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_0(mht_0_v, 189, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "ExampleName");
...
void CountSparseFeatures(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_1(mht_1_v, 198, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "CountSparseFeatures");
...
void CopySparseBufferToTensor(DataType dtype, size_t offset, SparseBuffer* src,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_2(mht_2_v, 215, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "CopySparseBufferToTensor");
...
uint8 PeekTag(protobuf::io::CodedInputStream* stream) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_3(mht_3_v, 240, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "PeekTag");
...
bool ParseString(protobuf::io::CodedInputStream* stream, StringPiece* result) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_4(mht_4_v, 251, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "ParseString");
...
bool ParseFeatureMapEntry(protobuf::io::CodedInputStream* stream,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_5(mht_5_v, 275, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "ParseFeatureMapEntry");
...
bool ParseFeatures(protobuf::io::CodedInputStream* stream,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_6(mht_6_v, 296, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "ParseFeatures");
...
bool ParseExample(protobuf::io::CodedInputStream* stream,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_7(mht_7_v, 316, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "ParseExample");
...
bool ParseExample(StringPiece serialized, parsed::Example* example) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_8(mht_8_v, 335, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "ParseExample");
...
void CopyOrMoveBlock(const tstring* b, const tstring* e, tstring* t) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_9(mht_9_v, 347, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "CopyOrMoveBlock");
...
const SmallVector<int64_t>& GetListFromBuffer<int64_t>(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_10(mht_10_v, 356, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "GetListFromBuffer<int64_t>");
...
const SmallVector<float>& GetListFromBuffer<float>(const SparseBuffer& buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_11(mht_11_v, 363, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "GetListFromBuffer<float>");
...
const SmallVector<tstring>& GetListFromBuffer<tstring>(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSparse_examplePSexample_proto_fast_parsingDTcc mht_12(mht_12_v, 371, "", "./tensorflow/lite/kernels/parse_example/example_proto_fast_parsing.cc", "GetListFromBuffer<tstring>");
