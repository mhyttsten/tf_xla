...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_sizeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_sizeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_sizeDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus PrepareHashtableSize(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_sizeDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/kernels/hashtable_size.cc", "PrepareHashtableSize");
...
TfLiteStatus EvalHashtableSize(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_sizeDTcc mht_1(mht_1_v, 222, "", "./tensorflow/lite/kernels/hashtable_size.cc", "EvalHashtableSize");
...
TfLiteRegistration* Register_HASHTABLE_SIZE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPShashtable_sizeDTcc mht_2(mht_2_v, 247, "", "./tensorflow/lite/kernels/hashtable_size.cc", "Register_HASHTABLE_SIZE");
