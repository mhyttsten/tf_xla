...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc() {
      // Check if tracing is enabled
...
class BasePoolingOpModel : public SingleOpModel {
 public:
  BasePoolingOpModel(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/lite/kernels/pooling_test.cc", "BasePoolingOpModel");
...
class FloatPoolingOpModel : public BasePoolingOpModel {
 public:
  ...
  void SetInput(std::initializer_list<float> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_1(mht_1_v, 230, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
...
class QuantizedPoolingOpModel : public BasePoolingOpModel {
 public:
  ...
  void SetInput(std::initializer_list<float> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_2(mht_2_v, 244, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
  ...
  void SetInput(const std::vector<float>& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_3(mht_3_v, 251, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
...
class SymmetricQuantizedPoolingOpModel : public BasePoolingOpModel {
 public:
  ...
  void SetInput(std::initializer_list<float> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_4(mht_4_v, 269, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
  ...
  void SetInput(const std::vector<float>& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_5(mht_5_v, 276, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
...
class SymmetricQuantizedPoolingOpModel16 : public BasePoolingOpModel {
 public:
  ...
  void SetInput(std::initializer_list<float> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_6(mht_6_v, 294, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
  ...
  void SetInput(const std::vector<float>& data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSpooling_testDTcc mht_7(mht_7_v, 301, "", "./tensorflow/lite/kernels/pooling_test.cc", "SetInput");
