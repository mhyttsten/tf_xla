...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc() {
      // Check if tracing is enabled
...
class LogicalOpModel : public SingleOpModel {
 public:
  LogicalOpModel(std::initializer_list<int> input1_shape,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/logical_test.cc", "LogicalOpModel");
  ...
  int input1() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/kernels/logical_test.cc", "input1");
 return input1_; }
  int input2() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc mht_2(mht_2_v, 216, "", "./tensorflow/lite/kernels/logical_test.cc", "input2");
 return input2_; }
 ...
 private:
  ...
  void ConfigureBuiltinOp(BuiltinOperator op) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSlogical_testDTcc mht_3(mht_3_v, 229, "", "./tensorflow/lite/kernels/logical_test.cc", "ConfigureBuiltinOp");
