...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc mht_0(mht_0_v, 223, "", "./tensorflow/lite/kernels/mfcc.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc mht_1(mht_1_v, 239, "", "./tensorflow/lite/kernels/mfcc.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc mht_2(mht_2_v, 246, "", "./tensorflow/lite/kernels/mfcc.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc mht_3(mht_3_v, 286, "", "./tensorflow/lite/kernels/mfcc.cc", "Eval");
...
TfLiteRegistration* Register_MFCC() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfccDTcc mht_4(mht_4_v, 347, "", "./tensorflow/lite/kernels/mfcc.cc", "Register_MFCC");
