...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh() {
      // Check if tracing is enabled
...
class CTCBeamSearchDecoder : public CTCDecoder {
 ...
 public:
  ...
  CTCBeamSearchDecoder(int num_classes, int beam_width,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh mht_0(mht_0_v, 262, "", "./tensorflow/lite/kernels/ctc/ctc_beam_search.h", "CTCBeamSearchDecoder");
  ...
  ~CTCBeamSearchDecoder() override {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh mht_1(mht_1_v, 269, "", "./tensorflow/lite/kernels/ctc/ctc_beam_search.h", "~CTCBeamSearchDecoder");
}
  ...
  BaseBeamScorer<CTCBeamState>* GetBeamScorer() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh mht_2(mht_2_v, 290, "", "./tensorflow/lite/kernels/ctc/ctc_beam_search.h", "GetBeamScorer");
 return beam_scorer_; }
  ...
  void SetLabelSelectionParameters(int label_selection_size,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh mht_3(mht_3_v, 298, "", "./tensorflow/lite/kernels/ctc/ctc_beam_search.h", "SetLabelSelectionParameters");
...
void CTCBeamSearchDecoder<CTCBeamState, CTCBeamComparer>::Step(
  ...
  for (BeamEntry* b : *branches) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSctcPSctc_beam_searchDTh mht_4(mht_4_v, 505, "", "./tensorflow/lite/kernels/ctc/ctc_beam_search.h", "lambda");
