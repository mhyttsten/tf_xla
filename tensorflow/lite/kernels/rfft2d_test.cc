...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2d_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2d_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2d_testDTcc() {
      // Check if tracing is enabled
...
class Rfft2dOpModel : public SingleOpModel {
 public:
  Rfft2dOpModel(const TensorData& input, const TensorData& fft_lengths) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2d_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/lite/kernels/rfft2d_test.cc", "Rfft2dOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2d_testDTcc mht_1(mht_1_v, 219, "", "./tensorflow/lite/kernels/rfft2d_test.cc", "input");
 return input_; }
  int fft_lengths() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSrfft2d_testDTcc mht_2(mht_2_v, 223, "", "./tensorflow/lite/kernels/rfft2d_test.cc", "fft_lengths");
 return fft_lengths_; }
