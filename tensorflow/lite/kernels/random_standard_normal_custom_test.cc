...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc() {
      // Check if tracing is enabled
...
TensorType GetTTEnum<float>() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/kernels/random_standard_normal_custom_test.cc", "GetTTEnum<float>");
...
TensorType GetTTEnum<double>() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc mht_1(mht_1_v, 209, "", "./tensorflow/lite/kernels/random_standard_normal_custom_test.cc", "GetTTEnum<double>");
...
class RandomStandardNormalOpModel : public SingleOpModel {
 public:
  RandomStandardNormalOpModel(const std::initializer_list<int>& input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc mht_2(mht_2_v, 219, "", "./tensorflow/lite/kernels/random_standard_normal_custom_test.cc", "RandomStandardNormalOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc mht_3(mht_3_v, 241, "", "./tensorflow/lite/kernels/random_standard_normal_custom_test.cc", "input");
 return input_; }
  int output() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSrandom_standard_normal_custom_testDTcc mht_4(mht_4_v, 245, "", "./tensorflow/lite/kernels/random_standard_normal_custom_test.cc", "output");
 return output_; }
