...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSembedding_lookup_sparse_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSembedding_lookup_sparse_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSembedding_lookup_sparse_testDTcc() {
      // Check if tracing is enabled
...
class EmbeddingLookupSparseOpModel : public SingleOpModel {
 public:
  EmbeddingLookupSparseOpModel(CombinerType type,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSembedding_lookup_sparse_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/lite/kernels/embedding_lookup_sparse_test.cc", "EmbeddingLookupSparseOpModel");
  ...
  void SetInput(std::initializer_list<int> lookup_data,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSembedding_lookup_sparse_testDTcc mht_1(mht_1_v, 231, "", "./tensorflow/lite/kernels/embedding_lookup_sparse_test.cc", "SetInput");
  ...
  void Set3DWeightMatrix(const std::function<float(int, int, int)>& function) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSembedding_lookup_sparse_testDTcc mht_2(mht_2_v, 241, "", "./tensorflow/lite/kernels/embedding_lookup_sparse_test.cc", "Set3DWeightMatrix");
