...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_0(mht_0_v, 333, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_1(mht_1_v, 343, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "Free");
...
TfLiteStatus CheckLstmTensorDimensionsAndTypes(
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_2(mht_2_v, 362, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "CheckLstmTensorDimensionsAndTypes");
...
TfLiteStatus CheckInputTensorDimensions(TfLiteContext* context,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_3(mht_3_v, 564, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "CheckInputTensorDimensions");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_4(mht_4_v, 602, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_5(mht_5_v, 1154, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "Eval");
...
TfLiteRegistration* Register_BIDIRECTIONAL_SEQUENCE_LSTM() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbidirectional_sequence_lstmDTcc mht_6(mht_6_v, 1542, "", "./tensorflow/lite/kernels/bidirectional_sequence_lstm.cc", "Register_BIDIRECTIONAL_SEQUENCE_LSTM");
