...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc() {
      // Check if tracing is enabled
...
void ExtractShape(const TfLiteTensor* input, OutType* output_data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/kernels/shape.cc", "ExtractShape");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc mht_1(mht_1_v, 211, "", "./tensorflow/lite/kernels/shape.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc mht_2(mht_2_v, 268, "", "./tensorflow/lite/kernels/shape.cc", "Eval");
...
TfLiteRegistration* Register_SHAPE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSshapeDTcc mht_3(mht_3_v, 277, "", "./tensorflow/lite/kernels/shape.cc", "Register_SHAPE");
