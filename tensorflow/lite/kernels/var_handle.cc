...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/kernels/var_handle.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/kernels/var_handle.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc mht_2(mht_2_v, 233, "", "./tensorflow/lite/kernels/var_handle.cc", "Prepare");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc mht_3(mht_3_v, 247, "", "./tensorflow/lite/kernels/var_handle.cc", "Eval");
...
TfLiteRegistration* Register_VAR_HANDLE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSvar_handleDTcc mht_4(mht_4_v, 264, "", "./tensorflow/lite/kernels/var_handle.cc", "Register_VAR_HANDLE");
