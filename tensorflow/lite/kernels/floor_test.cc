...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_testDTcc() {
      // Check if tracing is enabled
...
class FloorOpModel : public SingleOpModel {
 public:
  FloorOpModel(std::initializer_list<int> input_shape, TensorType input_type) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/kernels/floor_test.cc", "FloorOpModel");
  ...
  int input() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSfloor_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/lite/kernels/floor_test.cc", "input");
 return input_; }
