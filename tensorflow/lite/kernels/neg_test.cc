...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSneg_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSneg_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSneg_testDTcc() {
      // Check if tracing is enabled
...
class NegOpModel : public SingleOpModel {
 public:
  NegOpModel(const TensorData& input, const TensorData& output) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSneg_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/kernels/neg_test.cc", "NegOpModel");
  ...
  void SetInput(std::initializer_list<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSneg_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/lite/kernels/neg_test.cc", "SetInput");
