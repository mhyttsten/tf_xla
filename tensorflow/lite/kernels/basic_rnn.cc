...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc() {
      // Check if tracing is enabled
...
void* Init(TfLiteContext* context, const char* buffer, size_t length) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_0(mht_0_v, 217, "", "./tensorflow/lite/kernels/basic_rnn.cc", "Init");
...
void Free(TfLiteContext* context, void* buffer) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_1(mht_1_v, 227, "", "./tensorflow/lite/kernels/basic_rnn.cc", "Free");
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_2(mht_2_v, 234, "", "./tensorflow/lite/kernels/basic_rnn.cc", "Prepare");
...
TfLiteStatus EvalFloat(const TfLiteTensor* input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_3(mht_3_v, 383, "", "./tensorflow/lite/kernels/basic_rnn.cc", "EvalFloat");
...
TfLiteStatus EvalHybrid(const TfLiteTensor* input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_4(mht_4_v, 419, "", "./tensorflow/lite/kernels/basic_rnn.cc", "EvalHybrid");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_5(mht_5_v, 465, "", "./tensorflow/lite/kernels/basic_rnn.cc", "Eval");
...
TfLiteRegistration* Register_RNN() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSbasic_rnnDTcc mht_6(mht_6_v, 528, "", "./tensorflow/lite/kernels/basic_rnn.cc", "Register_RNN");
