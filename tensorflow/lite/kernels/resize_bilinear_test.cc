...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinear_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinear_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinear_testDTcc() {
      // Check if tracing is enabled
...
class ResizeBilinearOpModel : public SingleOpModel {
 public:
  explicit ResizeBilinearOpModel(const TensorData& input,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinear_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/lite/kernels/resize_bilinear_test.cc", "ResizeBilinearOpModel");
  ...
  void SetInput(std::initializer_list<T> data) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSresize_bilinear_testDTcc mht_1(mht_1_v, 239, "", "./tensorflow/lite/kernels/resize_bilinear_test.cc", "SetInput");
