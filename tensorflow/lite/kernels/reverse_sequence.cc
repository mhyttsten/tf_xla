...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus Prepare(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc mht_0(mht_0_v, 204, "", "./tensorflow/lite/kernels/reverse_sequence.cc", "Prepare");
...
TfLiteStatus ReverseSequenceHelper(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc mht_1(mht_1_v, 281, "", "./tensorflow/lite/kernels/reverse_sequence.cc", "ReverseSequenceHelper");
...
TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc mht_2(mht_2_v, 306, "", "./tensorflow/lite/kernels/reverse_sequence.cc", "Eval");
...
TfLiteRegistration* Register_REVERSE_SEQUENCE() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSreverse_sequenceDTcc mht_3(mht_3_v, 342, "", "./tensorflow/lite/kernels/reverse_sequence.cc", "Register_REVERSE_SEQUENCE");
