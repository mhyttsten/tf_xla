...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSkernelsPSmfcc_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfcc_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSkernelsPSmfcc_testDTcc() {
      // Check if tracing is enabled
...
class BaseMfccOpModel : public SingleOpModel {
 public:
  BaseMfccOpModel(const TensorData& input1, const TensorData& input2,
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfcc_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/lite/kernels/mfcc_test.cc", "BaseMfccOpModel");
  ...
  int input1() {
   ...
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfcc_testDTcc mht_1(mht_1_v, 229, "", "./tensorflow/lite/kernels/mfcc_test.cc", "input1");
 return input1_; }
  int input2() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSkernelsPSmfcc_testDTcc mht_2(mht_2_v, 233, "", "./tensorflow/lite/kernels/mfcc_test.cc", "input2");
 return input2_; }
