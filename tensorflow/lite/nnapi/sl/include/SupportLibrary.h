...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh() {
      // Check if tracing is enabled
...
struct NnApiSupportLibrary {
  NnApiSupportLibrary(const NnApiSLDriverImplFL5* impl, void* libHandle)
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh mht_0(mht_0_v, 222, "", "./tensorflow/lite/nnapi/sl/include/SupportLibrary.h", "NnApiSupportLibrary");
}
  ...
  ~NnApiSupportLibrary() {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh mht_1(mht_1_v, 230, "", "./tensorflow/lite/nnapi/sl/include/SupportLibrary.h", "~NnApiSupportLibrary");
  ...
  int64_t getFeatureLevel() const {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh mht_2(mht_2_v, 242, "", "./tensorflow/lite/nnapi/sl/include/SupportLibrary.h", "getFeatureLevel");
 return fl5->base.implFeatureLevel; }

  const NnApiSLDriverImplFL5* getFL5() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh mht_3(mht_3_v, 247, "", "./tensorflow/lite/nnapi/sl/include/SupportLibrary.h", "getFL5");
 return fl5; }
  const NnApiSLDriverImplFL6* getFL6() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh mht_4(mht_4_v, 251, "", "./tensorflow/lite/nnapi/sl/include/SupportLibrary.h", "getFL6");
  ...
  const NnApiSLDriverImplFL7* getFL7() const {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSslPSincludePSSupportLibraryDTh mht_5(mht_5_v, 258, "", "./tensorflow/lite/nnapi/sl/include/SupportLibrary.h", "getFL7");
