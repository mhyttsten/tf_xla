...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_utilDTcc() {
      // Check if tracing is enabled
...
std::string SimpleJoin(const std::vector<const char*>& elements,
   ...
   mht_0_v.push_back("separator: \"" + (separator == nullptr ? std::string("nullptr") : std::string((char*)separator)) + "\"");
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_utilDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/nnapi/nnapi_util.cc", "SimpleJoin");
...
std::string GetStringDeviceNamesList() {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_utilDTcc mht_1(mht_1_v, 244, "", "./tensorflow/lite/nnapi/nnapi_util.cc", "GetStringDeviceNamesList");
...
std::string GetStringDeviceNamesList(const NnApi* nnapi) {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_utilDTcc mht_2(mht_2_v, 251, "", "./tensorflow/lite/nnapi/nnapi_util.cc", "GetStringDeviceNamesList");
