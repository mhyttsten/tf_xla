...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_implementationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_implementationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_implementationDTcc() {
      // Check if tracing is enabled
...
uint32_t CalculateAndroidSdkVersion(NnApi const& nnapi) {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_implementationDTcc mht_0(mht_0_v, 260, "", "./tensorflow/lite/nnapi/nnapi_implementation.cc", "CalculateAndroidSdkVersion");
...
const NnApi LoadNnApi() {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_implementationDTcc mht_1(mht_1_v, 332, "", "./tensorflow/lite/nnapi/nnapi_implementation.cc", "LoadNnApi");
...
const NnApi* NnApiImplementation() {
   ...
   MHTracer_DTPStensorflowPSlitePSnnapiPSnnapi_implementationDTcc mht_2(mht_2_v, 750, "", "./tensorflow/lite/nnapi/nnapi_implementation.cc", "NnApiImplementation");
