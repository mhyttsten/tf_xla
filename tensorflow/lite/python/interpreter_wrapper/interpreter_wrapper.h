...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSpythonPSinterpreter_wrapperPSinterpreter_wrapperDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSpythonPSinterpreter_wrapperPSinterpreter_wrapperDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSpythonPSinterpreter_wrapperPSinterpreter_wrapperDTh() {
      // Check if tracing is enabled
...
class InterpreterWrapper {
 public:
  ...
  Interpreter* interpreter() {
   ...
   MHTracer_DTPStensorflowPSlitePSpythonPSinterpreter_wrapperPSinterpreter_wrapperDTh mht_0(mht_0_v, 279, "", "./tensorflow/lite/python/interpreter_wrapper/interpreter_wrapper.h", "interpreter");
