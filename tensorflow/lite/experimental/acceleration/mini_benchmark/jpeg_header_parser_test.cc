...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSjpeg_header_parser_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSjpeg_header_parser_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSjpeg_header_parser_testDTcc() {
      // Check if tracing is enabled
...
void PrintTo(const Status& status, std::ostream* os) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSjpeg_header_parser_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/jpeg_header_parser_test.cc", "PrintTo");
