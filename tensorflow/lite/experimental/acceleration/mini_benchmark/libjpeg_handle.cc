...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTcc() {
      // Check if tracing is enabled
...
std::unique_ptr<LibjpegHandle> LibjpegHandle::Create(Status &status) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTcc mht_0(mht_0_v, 202, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/libjpeg_handle.cc", "LibjpegHandle::Create");
...
LibjpegHandle::~LibjpegHandle() {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTcc mht_1(mht_1_v, 260, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/libjpeg_handle.cc", "LibjpegHandle::~LibjpegHandle");
