...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSfb_storageDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSfb_storageDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSfb_storageDTcc() {
      // Check if tracing is enabled
...
FileStorage::FileStorage(absl::string_view path, ErrorReporter* error_reporter)
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSfb_storageDTcc mht_0(mht_0_v, 214, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/fb_storage.cc", "FileStorage::FileStorage");
}

MinibenchmarkStatus FileStorage::ReadFileIntoBuffer() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSfb_storageDTcc mht_1(mht_1_v, 219, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/fb_storage.cc", "FileStorage::ReadFileIntoBuffer");
...
MinibenchmarkStatus FileStorage::AppendDataToFile(absl::string_view data) {
   ...
   mht_2_v.push_back("data: \"" + std::string(data.data(), data.size()) + "\"");
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSfb_storageDTcc mht_2(mht_2_v, 277, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/fb_storage.cc", "FileStorage::AppendDataToFile");
