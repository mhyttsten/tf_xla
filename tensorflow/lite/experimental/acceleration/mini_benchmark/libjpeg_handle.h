...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTh() {
      // Check if tracing is enabled
...
class LibjpegHandle {
 ...
 private:
  LibjpegHandle() {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSlibjpeg_handleDTh mht_0(mht_0_v, 235, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/libjpeg_handle.h", "LibjpegHandle");
}
