...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc() {
      // Check if tracing is enabled
...
class ValidationGraphBuilder {
 ...
 private:
  ...
  struct TensorInfo {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_0(mht_0_v, 331, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "~TensorInfo");
 free(jpeg_buffer_contents); }
  };
...
ValidationGraphBuilder::ValidationGraphBuilder(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_1(mht_1_v, 862, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "ValidationGraphBuilder::ValidationGraphBuilder");
}

absl::Status ValidationGraphBuilder::BuildIntermediateModel(
    fb::FlatBufferBuilder* fbb) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_2(mht_2_v, 868, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "ValidationGraphBuilder::BuildIntermediateModel");
...
absl::Status ValidationGraphBuilder::BuildFinalModel(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_3(mht_3_v, 886, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "ValidationGraphBuilder::BuildFinalModel");
...
std::string DescribeShape(const fb::Vector<int32_t>* shape) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_4(mht_4_v, 908, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "DescribeShape");
...
Embedder::Embedder(const Model* main_model,
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_5(mht_5_v, 936, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "Embedder::Embedder");
}

absl::Status Embedder::ValidateInputs() {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_6(mht_6_v, 941, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "Embedder::ValidateInputs");
...
absl::Status Embedder::CreateModelWithEmbeddedValidation(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSmini_benchmarkPSembedderDTcc mht_7(mht_7_v, 1057, "", "./tensorflow/lite/experimental/acceleration/mini_benchmark/embedder.cc", "Embedder::CreateModelWithEmbeddedValidation");
