...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSxnnpack_plugin_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSxnnpack_plugin_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSxnnpack_plugin_testDTcc() {
      // Check if tracing is enabled
...
class XnnpackPluginTest : public testing::Test {
 public:
  ...
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSxnnpack_plugin_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/lite/experimental/acceleration/configuration/xnnpack_plugin_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSxnnpack_plugin_testDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/experimental/acceleration/configuration/xnnpack_plugin_test.cc", "TearDown");
 delegate_plugin_.reset(); }
  ~XnnpackPluginTest() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSxnnpack_plugin_testDTcc mht_2(mht_2_v, 230, "", "./tensorflow/lite/experimental/acceleration/configuration/xnnpack_plugin_test.cc", "~XnnpackPluginTest");
}
