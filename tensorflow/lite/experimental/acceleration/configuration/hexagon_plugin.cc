...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPShexagon_pluginDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPShexagon_pluginDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPShexagon_pluginDTcc() {
      // Check if tracing is enabled
...
class HexagonPlugin : public DelegatePluginInterface {
 public:
  TfLiteDelegatePtr Create() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPShexagon_pluginDTcc mht_0(mht_0_v, 198, "", "./tensorflow/lite/experimental/acceleration/configuration/hexagon_plugin.cc", "Create");
  ...
  int GetDelegateErrno(TfLiteDelegate* /* from_delegate */) override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPShexagon_pluginDTcc mht_1(mht_1_v, 214, "", "./tensorflow/lite/experimental/acceleration/configuration/hexagon_plugin.cc", "GetDelegateErrno");
  ...
  explicit HexagonPlugin(const TFLiteSettings& tflite_settings) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPShexagon_pluginDTcc mht_2(mht_2_v, 224, "", "./tensorflow/lite/experimental/acceleration/configuration/hexagon_plugin.cc", "HexagonPlugin");
