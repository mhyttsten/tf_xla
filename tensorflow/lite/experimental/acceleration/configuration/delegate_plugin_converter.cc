...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSdelegate_plugin_converterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSdelegate_plugin_converterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSdelegate_plugin_converterDTcc() {
      // Check if tracing is enabled
...
class DelegatePluginViaCApi : public DelegatePluginInterface {
 public:
  explicit DelegatePluginViaCApi(const TfLiteOpaqueDelegatePlugin& plugin_c_api,
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSdelegate_plugin_converterDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/experimental/acceleration/configuration/delegate_plugin_converter.cc", "DelegatePluginViaCApi");
}
  TfLiteOpaqueDelegatePtr Create() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSdelegate_plugin_converterDTcc mht_1(mht_1_v, 207, "", "./tensorflow/lite/experimental/acceleration/configuration/delegate_plugin_converter.cc", "Create");
  ...
  int GetDelegateErrno(TfLiteOpaqueDelegate* from_delegate) override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSdelegate_plugin_converterDTcc mht_2(mht_2_v, 215, "", "./tensorflow/lite/experimental/acceleration/configuration/delegate_plugin_converter.cc", "GetDelegateErrno");
