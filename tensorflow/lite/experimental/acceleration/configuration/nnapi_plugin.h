...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh() {
      // Check if tracing is enabled
...
class NnapiPlugin : public DelegatePluginInterface {
 public:
  TfLiteDelegatePtr Create() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_0(mht_0_v, 206, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "Create");
  ...
  int GetDelegateErrno(TfLiteDelegate* from_delegate) override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_1(mht_1_v, 226, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "GetDelegateErrno");
  ...
  explicit NnapiPlugin(const TFLiteSettings& tflite_settings) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_2(mht_2_v, 238, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "NnapiPlugin");
  ...
  const tflite::StatefulNnApiDelegate::Options& Options() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_3(mht_3_v, 273, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "Options");
 return options_; }
  const int64_t GetSupportLibraryHandle() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_4(mht_4_v, 277, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "GetSupportLibraryHandle");
 ...
 private:
  ...
  ConvertExecutionPrefence(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_5(mht_5_v, 285, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "ConvertExecutionPrefence");
  ...
  static inline int ConvertExecutionPriority(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPSnnapi_pluginDTh mht_6(mht_6_v, 304, "", "./tensorflow/lite/experimental/acceleration/configuration/nnapi_plugin.h", "ConvertExecutionPriority");
