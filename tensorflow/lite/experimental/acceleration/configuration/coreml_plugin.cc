...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScoreml_pluginDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScoreml_pluginDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScoreml_pluginDTcc() {
      // Check if tracing is enabled
...
class CoreMLPlugin : public DelegatePluginInterface {
 public:
  TfLiteDelegatePtr Create() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScoreml_pluginDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/experimental/acceleration/configuration/coreml_plugin.cc", "Create");
  ...
  int GetDelegateErrno(TfLiteDelegate* /* from_delegate */) override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScoreml_pluginDTcc mht_1(mht_1_v, 209, "", "./tensorflow/lite/experimental/acceleration/configuration/coreml_plugin.cc", "GetDelegateErrno");
  ...
  explicit CoreMLPlugin(const TFLiteSettings& tflite_settings) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScoreml_pluginDTcc mht_2(mht_2_v, 219, "", "./tensorflow/lite/experimental/acceleration/configuration/coreml_plugin.cc", "CoreMLPlugin");
