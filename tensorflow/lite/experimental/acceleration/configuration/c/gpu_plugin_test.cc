...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScPSgpu_plugin_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScPSgpu_plugin_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScPSgpu_plugin_testDTcc() {
      // Check if tracing is enabled
...
class GpuTest : public testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScPSgpu_plugin_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/lite/experimental/acceleration/configuration/c/gpu_plugin_test.cc", "SetUp");
  ...
  ~GpuTest() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPSconfigurationPScPSgpu_plugin_testDTcc mht_1(mht_1_v, 218, "", "./tensorflow/lite/experimental/acceleration/configuration/c/gpu_plugin_test.cc", "~GpuTest");
}
