...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedb_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedb_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedb_testDTcc() {
      // Check if tracing is enabled
...
class DeviceDbTest : public ::testing::Test {
 protected:
  void LoadSample() {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedb_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/lite/experimental/acceleration/compatibility/devicedb_test.cc", "LoadSample");
