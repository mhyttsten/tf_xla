...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedbDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedbDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedbDTcc() {
      // Check if tracing is enabled
...
void UpdateVariablesFromDeviceDecisionTreeEdges(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedbDTcc mht_0(mht_0_v, 219, "", "./tensorflow/lite/experimental/acceleration/compatibility/devicedb.cc", "UpdateVariablesFromDeviceDecisionTreeEdges");
...
void Follow(const DeviceDecisionTreeNode* root,
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedbDTcc mht_1(mht_1_v, 231, "", "./tensorflow/lite/experimental/acceleration/compatibility/devicedb.cc", "Follow");
...
void UpdateVariablesFromDatabase(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSdevicedbDTcc mht_2(mht_2_v, 258, "", "./tensorflow/lite/experimental/acceleration/compatibility/devicedb.cc", "UpdateVariablesFromDatabase");
