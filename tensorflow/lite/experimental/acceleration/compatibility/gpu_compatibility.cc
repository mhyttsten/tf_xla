...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc() {
      // Check if tracing is enabled
...
void CanonicalizeValues(std::map<std::string, std::string>* variable_values) {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_0(mht_0_v, 203, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "CanonicalizeValues");
...
GPUCompatibilityList::GPUCompatibilityList(
   ...
   mht_1_v.push_back("compatibility_list_flatbuffer: \"" + (compatibility_list_flatbuffer == nullptr ? std::string("nullptr") : std::string((char*)compatibility_list_flatbuffer)) + "\"");
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_1(mht_1_v, 216, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::GPUCompatibilityList");
...
std::unique_ptr<GPUCompatibilityList> GPUCompatibilityList::Create() {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_2(mht_2_v, 225, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::Create");
...
std::unique_ptr<GPUCompatibilityList> GPUCompatibilityList::Create(
   ...
   mht_3_v.push_back("compatibility_list_flatbuffer: \"" + (compatibility_list_flatbuffer == nullptr ? std::string("nullptr") : std::string((char*)compatibility_list_flatbuffer)) + "\"");
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_3(mht_3_v, 235, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::Create");
...
std::map<std::string, std::string> GPUCompatibilityList::CalculateVariables(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_4(mht_4_v, 249, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::CalculateVariables");
...
bool GPUCompatibilityList::Includes(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_5(mht_5_v, 274, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::Includes");
...
TfLiteGpuDelegateOptionsV2 GPUCompatibilityList::GetBestOptionsFor(
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_6(mht_6_v, 284, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::GetBestOptionsFor");
...
bool GPUCompatibilityList::IsValidFlatbuffer(const unsigned char* data,
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSaccelerationPScompatibilityPSgpu_compatibilityDTcc mht_7(mht_7_v, 297, "", "./tensorflow/lite/experimental/acceleration/compatibility/gpu_compatibility.cc", "GPUCompatibilityList::IsValidFlatbuffer");
