...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSinitialization_statusDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSinitialization_statusDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSinitialization_statusDTh() {
      // Check if tracing is enabled
...
class InitializationStatus : public ResourceBase {
 public:
  InitializationStatus() {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSinitialization_statusDTh mht_0(mht_0_v, 201, "", "./tensorflow/lite/experimental/resource/initialization_status.h", "InitializationStatus");
}
  InitializationStatus(InitializationStatus&& other) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSinitialization_statusDTh mht_1(mht_1_v, 205, "", "./tensorflow/lite/experimental/resource/initialization_status.h", "InitializationStatus");
  ...
  ~InitializationStatus() override {
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSinitialization_statusDTh mht_2(mht_2_v, 215, "", "./tensorflow/lite/experimental/resource/initialization_status.h", "~InitializationStatus");
}
