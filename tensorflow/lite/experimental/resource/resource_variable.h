...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSresource_variableDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSresource_variableDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSresource_variableDTh() {
      // Check if tracing is enabled
...
class ResourceVariable : public ResourceBase {
 public:
  ...
  // `AssignFrom`.
  TfLiteTensor* GetTensor() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSresource_variableDTh mht_0(mht_0_v, 213, "", "./tensorflow/lite/experimental/resource/resource_variable.h", "GetTensor");
 return is_initialized_ ? &tensor_ : nullptr; }

  // Returns true if this resource variable is initialized.
  bool IsInitialized() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSlitePSexperimentalPSresourcePSresource_variableDTh mht_1(mht_1_v, 219, "", "./tensorflow/lite/experimental/resource/resource_variable.h", "IsInitialized");
