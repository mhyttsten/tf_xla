...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSschemaPSschema_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSschema_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSschemaPSschema_utilsDTcc() {
      // Check if tracing is enabled
...
BuiltinOperator GetBuiltinCode(const OperatorCode* op_code) {
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSschema_utilsDTcc mht_0(mht_0_v, 214, "", "./tensorflow/lite/schema/schema_utils.cc", "GetBuiltinCode");
...
BuiltinOperator GetBuiltinCode(const OperatorCodeT* op_code) {
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSschema_utilsDTcc mht_1(mht_1_v, 226, "", "./tensorflow/lite/schema/schema_utils.cc", "GetBuiltinCode");
