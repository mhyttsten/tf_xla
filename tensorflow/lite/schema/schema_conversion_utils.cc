...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSschemaPSschema_conversion_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSschema_conversion_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSschemaPSschema_conversion_utilsDTcc() {
      // Check if tracing is enabled
...
int8_t ConvertBuiltinCodeToDeprecatedBuiltinCode(
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSschema_conversion_utilsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/lite/schema/schema_conversion_utils.cc", "ConvertBuiltinCodeToDeprecatedBuiltinCode");
