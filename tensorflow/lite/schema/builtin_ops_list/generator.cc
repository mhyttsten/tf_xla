...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSschemaPSbuiltin_ops_listPSgeneratorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSbuiltin_ops_listPSgeneratorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSschemaPSbuiltin_ops_listPSgeneratorDTcc() {
      // Check if tracing is enabled
...
bool IsValidInputEnumName(const std::string& name) {
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSbuiltin_ops_listPSgeneratorDTcc mht_0(mht_0_v, 215, "", "./tensorflow/lite/schema/builtin_ops_list/generator.cc", "IsValidInputEnumName");
...
bool GenerateHeader(std::ostream& os) {
   ...
   MHTracer_DTPStensorflowPSlitePSschemaPSbuiltin_ops_listPSgeneratorDTcc mht_1(mht_1_v, 245, "", "./tensorflow/lite/schema/builtin_ops_list/generator.cc", "GenerateHeader");
