...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSlitePSjavaPSsrcPSmainPSnativePSop_resolver_lazy_delegate_proxyDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSlitePSjavaPSsrcPSmainPSnativePSop_resolver_lazy_delegate_proxyDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSlitePSjavaPSsrcPSmainPSnativePSop_resolver_lazy_delegate_proxyDTh() {
      // Check if tracing is enabled
...
class OpResolverLazyDelegateProxy : public OpResolver {
 public:
  OpResolverLazyDelegateProxy(std::unique_ptr<tflite::OpResolver>&& op_resolver,
   ...
   MHTracer_DTPStensorflowPSlitePSjavaPSsrcPSmainPSnativePSop_resolver_lazy_delegate_proxyDTh mht_0(mht_0_v, 200, "", "./tensorflow/lite/java/src/main/native/op_resolver_lazy_delegate_proxy.h", "OpResolverLazyDelegateProxy");
}
