...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTcc() {
      // Check if tracing is enabled
...
Status ShapeAnnotationsMatch(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/jit/test_util.cc", "ShapeAnnotationsMatch");
