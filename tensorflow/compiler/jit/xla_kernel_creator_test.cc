...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creator_testDTcc() {
      // Check if tracing is enabled
...
FunctionDef XTimesY() {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creator_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/jit/xla_kernel_creator_test.cc", "XTimesY");
...
class XlaKernelCreatorTest : public ::testing::Test {
 protected:
  void Init(const std::vector<FunctionDef>& flib) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creator_testDTcc mht_1(mht_1_v, 233, "", "./tensorflow/compiler/jit/xla_kernel_creator_test.cc", "Init");
...
AttrValue BoolAttr(bool b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creator_testDTcc mht_2(mht_2_v, 267, "", "./tensorflow/compiler/jit/xla_kernel_creator_test.cc", "BoolAttr");
