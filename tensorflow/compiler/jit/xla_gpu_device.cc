...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_gpu_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_gpu_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_gpu_deviceDTcc() {
      // Check if tracing is enabled
...
Status XlaGpuDeviceFactory::ListPhysicalDevices(std::vector<string>* devices) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_gpu_deviceDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/jit/xla_gpu_device.cc", "XlaGpuDeviceFactory::ListPhysicalDevices");
...
Status XlaGpuDeviceFactory::CreateDevices(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_gpu_deviceDTcc mht_1(mht_1_v, 249, "", "./tensorflow/compiler/jit/xla_gpu_device.cc", "XlaGpuDeviceFactory::CreateDevices");
