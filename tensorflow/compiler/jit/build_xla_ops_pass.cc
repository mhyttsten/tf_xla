...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc() {
      // Check if tracing is enabled
...
void MoveOutgoingEdges(Graph* g, Node* old_node, Node* new_node) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_0(mht_0_v, 234, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "MoveOutgoingEdges");
...
Output ControlToData(const Scope& scope, Node* control) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_1(mht_1_v, 250, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "ControlToData");
...
Operation DataToControl(const Scope& scope, Output data) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_2(mht_2_v, 284, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "DataToControl");
...
void MergeOutgoingDataEdges(const Scope& s, Node* old_node, Node* new_node,
   ...
   mht_3_v.push_back("cluster_name: \"" + std::string(cluster_name.data(), cluster_name.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_3(mht_3_v, 297, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "MergeOutgoingDataEdges");
...
void MergeOutgoingControlEdges(const Scope& s, Node* old_node, Node* new_node) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_4(mht_4_v, 358, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "MergeOutgoingControlEdges");
...
Output IncomingEdgeAsOutput(const Edge* e) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_5(mht_5_v, 409, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "IncomingEdgeAsOutput");
...
Status GetXlaClusterInfo(Node* n, XlaClusterInfo* result) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_6(mht_6_v, 416, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "GetXlaClusterInfo");
...
Status CopyIncomingControlEdges(Graph* g, Node* from, Node* to) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_7(mht_7_v, 457, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "CopyIncomingControlEdges");
...
void RemoveAllIncomingControlEdges(Graph* g, Node* n) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_8(mht_8_v, 470, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "RemoveAllIncomingControlEdges");
...
Status DeviceRequiresCompilation(const jit::DeviceInfoCache& device_info_cache,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_9(mht_9_v, 484, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "DeviceRequiresCompilation");
...
Status PredicateInt32Inputs(const Scope& root, Node* n,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_10(mht_10_v, 626, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "PredicateInt32Inputs");
...
Status ReplaceNodeWithXlaCompileAndXlaRun(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_11(mht_11_v, 673, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "ReplaceNodeWithXlaCompileAndXlaRun");
...
Status BuildXlaOpsPass::Run(const GraphOptimizationPassOptions& options) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSbuild_xla_ops_passDTcc mht_12(mht_12_v, 777, "", "./tensorflow/compiler/jit/build_xla_ops_pass.cc", "BuildXlaOpsPass::Run");
