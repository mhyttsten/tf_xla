...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_test_helperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_test_helperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_test_helperDTcc() {
      // Check if tracing is enabled
...
/*static*/ Status MarkForCompilationPassTestHelper::MarkForCompilation(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_test_helperDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test_helper.cc", "MarkForCompilationPassTestHelper::MarkForCompilation");
...
/*static*/ Status MarkForCompilationPassTestHelper::MarkForCompilation(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_test_helperDTcc mht_1(mht_1_v, 240, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test_helper.cc", "MarkForCompilationPassTestHelper::MarkForCompilation");
