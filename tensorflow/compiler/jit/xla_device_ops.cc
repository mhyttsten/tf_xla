...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc() {
      // Check if tracing is enabled
...
XlaDeviceDummyOp::XlaDeviceDummyOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/jit/xla_device_ops.cc", "XlaDeviceDummyOp::XlaDeviceDummyOp");
}

void XlaDeviceDummyOp::Compute(OpKernelContext* ctx) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc mht_1(mht_1_v, 199, "", "./tensorflow/compiler/jit/xla_device_ops.cc", "XlaDeviceDummyOp::Compute");
...
XlaAssignVariableOp::XlaAssignVariableOp(OpKernelConstruction* c)
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc mht_2(mht_2_v, 208, "", "./tensorflow/compiler/jit/xla_device_ops.cc", "XlaAssignVariableOp::XlaAssignVariableOp");
...
void XlaAssignVariableOp::Compute(OpKernelContext* context) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_device_opsDTcc mht_3(mht_3_v, 215, "", "./tensorflow/compiler/jit/xla_device_ops.cc", "XlaAssignVariableOp::Compute");
