...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh() {
      // Check if tracing is enabled
...
class RecursiveCompilabilityChecker {
 public:
  ...
  RecursiveCompilabilityChecker(OperationFilter op_filter,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_0(mht_0_v, 325, "", "./tensorflow/compiler/jit/compilability_check_util.h", "RecursiveCompilabilityChecker");
}
  ...
  bool IsCompilableNode(const Node& node,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_1(mht_1_v, 350, "", "./tensorflow/compiler/jit/compilability_check_util.h", "IsCompilableNode");
 ...
 private:
  ...
  bool IsStackOp(const Node& node) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_2(mht_2_v, 408, "", "./tensorflow/compiler/jit/compilability_check_util.h", "IsStackOp");
  ...
  bool IsTensorArrayOp(const Node& node) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_3(mht_3_v, 417, "", "./tensorflow/compiler/jit/compilability_check_util.h", "IsTensorArrayOp");
  ...
  bool IsAssertOrCheckNumerics(absl::string_view op_name) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_4(mht_4_v, 427, "", "./tensorflow/compiler/jit/compilability_check_util.h", "IsAssertOrCheckNumerics");
  ...
  bool IsStatefulRandomOp(absl::string_view op_name) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_5(mht_5_v, 435, "", "./tensorflow/compiler/jit/compilability_check_util.h", "IsStatefulRandomOp");
  ...
  bool OpProducesOrConsumesVariant(const Node& node) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_6(mht_6_v, 444, "", "./tensorflow/compiler/jit/compilability_check_util.h", "OpProducesOrConsumesVariant");

    auto is_variant = [](DataType dtype) {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPSjitPScompilability_check_utilDTh mht_7(mht_7_v, 448, "", "./tensorflow/compiler/jit/compilability_check_util.h", "lambda");
