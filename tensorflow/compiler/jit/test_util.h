...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTh() {
      // Check if tracing is enabled
...
struct GraphOptimizationPassWrapper {
  explicit GraphOptimizationPassWrapper() : library(OpRegistry::Global(), {}) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/jit/test_util.h", "GraphOptimizationPassWrapper");
  ...
  GraphOptimizationPassOptions CreateGraphOptimizationPassOptions(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStest_utilDTh mht_1(mht_1_v, 225, "", "./tensorflow/compiler/jit/test_util.h", "CreateGraphOptimizationPassOptions");
