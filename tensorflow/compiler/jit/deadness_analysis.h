...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSdeadness_analysisDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSdeadness_analysisDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSdeadness_analysisDTh() {
      // Check if tracing is enabled
...
class DeadnessAnalysis {
 public:
  ...
  struct DeadnessPredicate {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSdeadness_analysisDTh mht_0(mht_0_v, 236, "", "./tensorflow/compiler/jit/deadness_analysis.h", "DeadnessPredicate");
}
 ...
 protected:
  static DeadnessPredicate MakeDeadnessPredicate(void* pred) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSdeadness_analysisDTh mht_1(mht_1_v, 265, "", "./tensorflow/compiler/jit/deadness_analysis.h", "MakeDeadnessPredicate");
