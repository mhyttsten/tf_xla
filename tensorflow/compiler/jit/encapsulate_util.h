...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSencapsulate_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSencapsulate_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSencapsulate_utilDTh() {
      // Check if tracing is enabled
...
struct XlaClusterInfo {
  ...
  XlaClusterInfo() {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSencapsulate_utilDTh mht_0(mht_0_v, 267, "", "./tensorflow/compiler/jit/encapsulate_util.h", "XlaClusterInfo");
}
  XlaClusterInfo(const string& cluster_name,
   ...
   mht_1_v.push_back("cluster_name: \"" + cluster_name + "\"");
   MHTracer_DTPStensorflowPScompilerPSjitPSencapsulate_utilDTh mht_1(mht_1_v, 278, "", "./tensorflow/compiler/jit/encapsulate_util.h", "XlaClusterInfo");
}
