...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSintroduce_floating_point_jitter_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSintroduce_floating_point_jitter_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSintroduce_floating_point_jitter_passDTcc() {
      // Check if tracing is enabled
...
Status IntroduceJitterToTensor(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSintroduce_floating_point_jitter_passDTcc mht_0(mht_0_v, 233, "", "./tensorflow/compiler/jit/introduce_floating_point_jitter_pass.cc", "IntroduceJitterToTensor");
...
Status IntroduceFloatingPointJitter(Graph* graph,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSintroduce_floating_point_jitter_passDTcc mht_1(mht_1_v, 296, "", "./tensorflow/compiler/jit/introduce_floating_point_jitter_pass.cc", "IntroduceFloatingPointJitter");
...
Status IntroduceFloatingPointJitterPass::Run(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSintroduce_floating_point_jitter_passDTcc mht_2(mht_2_v, 321, "", "./tensorflow/compiler/jit/introduce_floating_point_jitter_pass.cc", "IntroduceFloatingPointJitterPass::Run");
