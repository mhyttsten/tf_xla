...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc() {
      // Check if tracing is enabled
...
Status ShapeHandleToTensorShape(shape_inference::InferenceContext* context,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/jit/shape_inference.cc", "ShapeHandleToTensorShape");
...
Status PropagateShapes(Graph* graph,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/jit/shape_inference.cc", "PropagateShapes");
...
Status StoreOutputShapes(const Graph& graph, const ShapeRefiner& shape_refiner,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc mht_2(mht_2_v, 382, "", "./tensorflow/compiler/jit/shape_inference.cc", "StoreOutputShapes");
...
Status InferShapes(Graph* graph, const std::map<int, InferredShape>& arg_shapes,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSshape_inferenceDTcc mht_3(mht_3_v, 423, "", "./tensorflow/compiler/jit/shape_inference.cc", "InferShapes");
