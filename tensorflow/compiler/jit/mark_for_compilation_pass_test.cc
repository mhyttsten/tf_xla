...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc() {
      // Check if tracing is enabled
...
static Status GradForUnaryCwise(FunctionDef* g,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_0(mht_0_v, 523, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "GradForUnaryCwise");
...
Status SupportedGrad(const AttrSlice& attrs, FunctionDef* g) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_1(mht_1_v, 545, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "SupportedGrad");
...
Status UnsupportedGrad(const AttrSlice& attrs, FunctionDef* g) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_2(mht_2_v, 562, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "UnsupportedGrad");
...
Node* MakeRead(const Scope& scope, const string& id,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_3(mht_3_v, 853, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "MakeRead");
...
Node* MakeWrite(const Scope& scope, const string& id) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_4(mht_4_v, 868, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "MakeWrite");
...
Node* MakeNeutral(const Scope& scope, const string& id) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_5(mht_5_v, 882, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "MakeNeutral");
...
TEST(XlaCompilationTest, IllegalCycle_UsefulErrorMessage) {
  ...
  Scope root = Scope::NewRootScope().ExitOnError();
  {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_6(mht_6_v, 964, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "lambda");
...
void AddCtrlEdge(const Scope& scope, Operation a, Operation b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_7(mht_7_v, 1811, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "AddCtrlEdge");
...
void AddCtrlEdge(const Scope& scope, Output a, Operation b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_8(mht_8_v, 1818, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "AddCtrlEdge");
...
void AddCtrlEdge(const Scope& scope, Operation a, Output b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_9(mht_9_v, 1825, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "AddCtrlEdge");
...
TEST(XlaCompilationTest, DeterministicClusterNames) {
  ...
  auto cluster_names_match = [](absl::string_view lhs_cluster_name,
   ...
   mht_10_v.push_back("lhs_cluster_name: \"" + std::string(lhs_cluster_name.data(), lhs_cluster_name.size()) + "\"");
   mht_10_v.push_back("rhs_cluster_name: \"" + std::string(rhs_cluster_name.data(), rhs_cluster_name.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_10(mht_10_v, 1971, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "lambda");
...
Node* MakeStageNode(GraphDefBuilder& builder, string name,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSmark_for_compilation_pass_testDTcc mht_11(mht_11_v, 2050, "", "./tensorflow/compiler/jit/mark_for_compilation_pass_test.cc", "MakeStageNode");
