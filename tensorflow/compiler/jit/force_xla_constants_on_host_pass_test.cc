...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSforce_xla_constants_on_host_pass_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSforce_xla_constants_on_host_pass_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSforce_xla_constants_on_host_pass_testDTcc() {
      // Check if tracing is enabled
...
Status ForceXlaConstantsOnHost(const Scope& s,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSforce_xla_constants_on_host_pass_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/jit/force_xla_constants_on_host_pass_test.cc", "ForceXlaConstantsOnHost");
