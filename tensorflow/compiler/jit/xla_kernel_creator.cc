...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc() {
      // Check if tracing is enabled
...
bool XlaKernelCreator::CanCreateKernel(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/jit/xla_kernel_creator.cc", "XlaKernelCreator::CanCreateKernel");
...
static Status CreateXlaKernel(FunctionLibraryRuntime* flr,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/jit/xla_kernel_creator.cc", "CreateXlaKernel");
...
Status XlaKernelCreator::CreateKernel(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc mht_2(mht_2_v, 262, "", "./tensorflow/compiler/jit/xla_kernel_creator.cc", "XlaKernelCreator::CreateKernel");
...
static bool RegisterLaunchOpCreator() {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_kernel_creatorDTcc mht_3(mht_3_v, 269, "", "./tensorflow/compiler/jit/xla_kernel_creator.cc", "RegisterLaunchOpCreator");
