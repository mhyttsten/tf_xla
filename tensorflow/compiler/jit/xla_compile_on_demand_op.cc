...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTcc() {
      // Check if tracing is enabled
...
Status XlaCompileOnDemandOp::Run(OpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTcc mht_0(mht_0_v, 218, "", "./tensorflow/compiler/jit/xla_compile_on_demand_op.cc", "XlaCompileOnDemandOp::Run");
...
Status XlaCompileOnDemandOp::Compile(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTcc mht_1(mht_1_v, 283, "", "./tensorflow/compiler/jit/xla_compile_on_demand_op.cc", "XlaCompileOnDemandOp::Compile");
...
void XlaCompileOnDemandOp::Compute(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTcc mht_2(mht_2_v, 344, "", "./tensorflow/compiler/jit/xla_compile_on_demand_op.cc", "XlaCompileOnDemandOp::Compute");
