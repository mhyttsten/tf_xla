...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc() {
      // Check if tracing is enabled
...
Status TpuPaddedShapeFn(const Tensor& tensor, xla::Shape* shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_0(mht_0_v, 245, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "TpuPaddedShapeFn");
...
Status CheckIfTPUInitialized() {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_1(mht_1_v, 279, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "CheckIfTPUInitialized");
...
void TpuDeviceToDeviceCopy(DeviceContext* src_dev_context,
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_2(mht_2_v, 304, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "TpuDeviceToDeviceCopy");
...
Status TpuNodeDeviceFactory::ListPhysicalDevices(std::vector<string>* devices) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_3(mht_3_v, 494, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "TpuNodeDeviceFactory::ListPhysicalDevices");
...
Status TpuNodeDeviceFactory::CreateDevices(
   ...
   mht_4_v.push_back("name_prefix: \"" + name_prefix + "\"");
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_4(mht_4_v, 518, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "TpuNodeDeviceFactory::CreateDevices");
...
Status TpuSystemDeviceFactory::ListPhysicalDevices(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_5(mht_5_v, 604, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "TpuSystemDeviceFactory::ListPhysicalDevices");
...
Status TpuSystemDeviceFactory::CreateDevices(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_6(mht_6_v, 623, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "TpuSystemDeviceFactory::CreateDevices");
...
void RegisterTpuDeviceToDeviceCopy() {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_7(mht_7_v, 651, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "RegisterTpuDeviceToDeviceCopy");
...
void RegisterTpuNodeDevice(
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_8(mht_8_v, 662, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "RegisterTpuNodeDevice");
...
void RegisterTpuSystemDevice() {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_tpu_deviceDTcc mht_9(mht_9_v, 679, "", "./tensorflow/compiler/jit/xla_tpu_device.cc", "RegisterTpuSystemDevice");
