...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSextract_outside_compilation_pass_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSextract_outside_compilation_pass_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSextract_outside_compilation_pass_testDTcc() {
      // Check if tracing is enabled
...
class ExtractOutsideCompilationForFunctionTest : public ::testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSextract_outside_compilation_pass_testDTcc mht_0(mht_0_v, 399, "", "./tensorflow/compiler/jit/extract_outside_compilation_pass_test.cc", "SetUp");
  ...
  Status ExtractOutsideCompilationTest(
   ...
   mht_1_v.push_back("xla_cluster_attr_name: \"" + xla_cluster_attr_name + "\"");
   mht_1_v.push_back("outside_compilation_attr_name: \"" + outside_compilation_attr_name + "\"");
   mht_1_v.push_back("xla_cluster_name: \"" + xla_cluster_name + "\"");
   mht_1_v.push_back("new_func_name: \"" + new_func_name + "\"");
   mht_1_v.push_back("host_graph_func_name: \"" + host_graph_func_name + "\"");
   MHTracer_DTPStensorflowPScompilerPSjitPSextract_outside_compilation_pass_testDTcc mht_1(mht_1_v, 423, "", "./tensorflow/compiler/jit/extract_outside_compilation_pass_test.cc", "ExtractOutsideCompilationTest");
