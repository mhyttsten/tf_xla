...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTh() {
      // Check if tracing is enabled
...
class XlaCompileOnDemandOp : public OpKernel {
 public:
  explicit XlaCompileOnDemandOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPSxla_compile_on_demand_opDTh mht_0(mht_0_v, 210, "", "./tensorflow/compiler/jit/xla_compile_on_demand_op.h", "XlaCompileOnDemandOp");
}
