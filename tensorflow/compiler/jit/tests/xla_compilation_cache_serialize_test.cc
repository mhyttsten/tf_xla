...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSjitPStestsPSxla_compilation_cache_serialize_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStestsPSxla_compilation_cache_serialize_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSjitPStestsPSxla_compilation_cache_serialize_testDTcc() {
      // Check if tracing is enabled
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSjitPStestsPSxla_compilation_cache_serialize_testDTcc mht_0(mht_0_v, 237, "", "./tensorflow/compiler/jit/tests/xla_compilation_cache_serialize_test.cc", "main");
