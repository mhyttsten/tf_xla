...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc() {
      // Check if tracing is enabled
...
/* static */ Literal LiteralUtil::CreateFromDimensions(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_0(mht_0_v, 254, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::CreateFromDimensions");
...
/* static */ Literal LiteralUtil::ConvertBF16ToF32(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_1(mht_1_v, 263, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ConvertBF16ToF32");
...
/* static */ Literal LiteralUtil::ConvertBF16ToF64(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_2(mht_2_v, 271, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ConvertBF16ToF64");
...
/* static */ Literal LiteralUtil::ConvertF32ToBF16(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_3(mht_3_v, 279, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ConvertF32ToBF16");
...
/* static */ Literal LiteralUtil::ConvertF32ToF64(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_4(mht_4_v, 287, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ConvertF32ToF64");
...
/* static */ Literal LiteralUtil::ConvertF64ToBF16(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_5(mht_5_v, 295, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ConvertF64ToBF16");
...
/* static */ Literal LiteralUtil::ConvertF64ToF32(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_6(mht_6_v, 303, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ConvertF64ToF32");
...
/* static */ Literal LiteralUtil::CreateToken() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_7(mht_7_v, 310, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::CreateToken");
...
/* static */ Literal LiteralUtil::Zero(PrimitiveType primitive_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_8(mht_8_v, 317, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::Zero");
...
/* static */ Literal LiteralUtil::One(PrimitiveType primitive_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_9(mht_9_v, 361, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::One");
...
/* static */ Literal LiteralUtil::MinValue(PrimitiveType primitive_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_10(mht_10_v, 405, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MinValue");
...
/* static */ Literal LiteralUtil::MaxValue(PrimitiveType primitive_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_11(mht_11_v, 460, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MaxValue");
...
/* static */ StatusOr<Literal> LiteralUtil::NanValue(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_12(mht_12_v, 512, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::NanValue");
...
/* static */ Literal LiteralUtil::CreateR1(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_13(mht_13_v, 544, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::CreateR1");
...
/* static */ Literal LiteralUtil::CreateR1U8(absl::string_view value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_14(mht_14_v, 555, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::CreateR1U8");
...
/* static */ Literal LiteralUtil::CreateR2F32Linspace(float from, float to,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_15(mht_15_v, 569, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::CreateR2F32Linspace");
...
/* static */ Literal LiteralUtil::ReshapeSlice(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_16(mht_16_v, 579, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::ReshapeSlice");
...
/* static */ Literal LiteralUtil::GetFirstScalarLiteral(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_17(mht_17_v, 656, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::GetFirstScalarLiteral");
...
/* static */ Literal LiteralUtil::MaxElement(const LiteralSlice& literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_18(mht_18_v, 710, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MaxElement");
...
/* static */ Literal LiteralUtil::MakeTuple(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_19(mht_19_v, 779, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MakeTuple");
...
/* static */ Literal LiteralUtil::MakeTupleFromSlices(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_20(mht_20_v, 796, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MakeTupleFromSlices");
...
/* static */ Literal LiteralUtil::MakeTupleOwned(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_21(mht_21_v, 813, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MakeTupleOwned");
...
/* static */ std::string LiteralUtil::MultiIndexAsString(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSliteral_utilDTcc mht_22(mht_22_v, 831, "", "./tensorflow/compiler/xla/literal_util.cc", "LiteralUtil::MultiIndexAsString");
