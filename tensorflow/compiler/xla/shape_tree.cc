...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSshape_treeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_treeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSshape_treeDTcc() {
      // Check if tracing is enabled
...
IndexTable::IndexTable(const Shape& shape) : entries_(1) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_treeDTcc mht_0(mht_0_v, 190, "", "./tensorflow/compiler/xla/shape_tree.cc", "IndexTable::IndexTable");
...
void IndexTable::CreateEntry(Entry& entry, const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_treeDTcc mht_1(mht_1_v, 200, "", "./tensorflow/compiler/xla/shape_tree.cc", "IndexTable::CreateEntry");
...
const IndexTable::Entry& IndexTable::operator[](ShapeIndexView index) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_treeDTcc mht_2(mht_2_v, 219, "", "./tensorflow/compiler/xla/shape_tree.cc", "lambda");
