...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_utilsDTh() {
      // Check if tracing is enabled
...
pybind11::object property_readonly(Func&& get) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_utilsDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/python/python_utils.h", "property_readonly");
...
pybind11::object property(GetFunc&& get, SetFunc&& set) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_utilsDTh mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/python/python_utils.h", "property");
...
pybind11::object def_static(Constructor&& constructor) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_utilsDTh mht_2(mht_2_v, 227, "", "./tensorflow/compiler/xla/python/python_utils.h", "def_static");
