...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPStracebackDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPStracebackDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPStracebackDTh() {
      // Check if tracing is enabled
...
class Traceback {
 public:
  ...
  static bool enabled() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPStracebackDTh mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/python/traceback.h", "enabled");
 return enabled_; }
  // Require GIL.
...
H AbslHashValue(H h, const Traceback& traceback) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPStracebackDTh mht_1(mht_1_v, 257, "", "./tensorflow/compiler/xla/python/traceback.h", "AbslHashValue");
