...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc() {
      // Check if tracing is enabled
...
Status CompileAndExecute(XlaBuilder* builder, XlaOp root, int device_id,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "CompileAndExecute");
...
class Accumulator {
 public:
  ...
  void Receive(uint32_t consumer_id, std::shared_ptr<Literal> data) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_1(mht_1_v, 235, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "Receive");
...
TEST(OutfeedReceiverTest, ReceiveOutfeedSimple) {
  ...
  OutfeedReceiver::Callback callback =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_2(mht_2_v, 291, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "lambda");
...
TEST(OutfeedReceiverTest, ReceiveOutfeedTwoComputations) {
  ...
  OutfeedReceiver::Callback callback =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_3(mht_3_v, 327, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "lambda");
...
TEST(OutfeedReceiverTest, ReceiveOutfeedTwoOutfeed) {
  ...
  OutfeedReceiver::Callback callback =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_4(mht_4_v, 375, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "lambda");
...
TEST(OutfeedReceiverTest, DifferentShapeForConsumerIdError) {
  ...
  OutfeedReceiver::Callback callback =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_5(mht_5_v, 421, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "lambda");
...
TEST(OutfeedReceiverTest, InvalidConsumerIdError) {
  ...
  OutfeedReceiver::Callback callback =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_6(mht_6_v, 458, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "lambda");
...
TEST(OutfeedReceiverTest, NonLocalDevicesIgnored) {
  ...
  OutfeedReceiver::Callback callback =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSoutfeed_receiver_testDTcc mht_7(mht_7_v, 487, "", "./tensorflow/compiler/xla/python/outfeed_receiver_test.cc", "lambda");
