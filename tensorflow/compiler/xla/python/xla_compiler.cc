...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc() {
      // Check if tracing is enabled
...
Uniquer* GetUniquer() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_0(mht_0_v, 237, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "GetUniquer");
...
static std::string UniquifyName(const std::string& name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_1(mht_1_v, 246, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "UniquifyName");
...
Status PyRegisterCustomCallTarget(const std::string& fn_name,
   ...
   mht_2_v.push_back("fn_name: \"" + fn_name + "\"");
   mht_2_v.push_back("platform: \"" + platform + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_2(mht_2_v, 359, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "PyRegisterCustomCallTarget");
...
void DefRepeatedProperty(py::class_<T>& cls, const char* name,
  ...
  cls.def_property(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_3(mht_3_v, 389, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "lambda");
...
void BuildXlaCompilerSubmodule(py::module& m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_4(mht_4_v, 404, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "BuildXlaCompilerSubmodule");
  ...
  compile_options
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_5(mht_5_v, 795, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_6(mht_6_v, 806, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSxla_compilerDTcc mht_7(mht_7_v, 823, "", "./tensorflow/compiler/xla/python/xla_compiler.cc", "lambda");
