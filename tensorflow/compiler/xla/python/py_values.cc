...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpy_valuesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpy_valuesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpy_valuesDTcc() {
      // Check if tracing is enabled
...
StatusOr<DevicePutResult> HandleNumpyArray(py::handle h, PjRtDevice* to_device,
  ...
  if (options.allow_zero_copy) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpy_valuesDTcc mht_0(mht_0_v, 352, "", "./tensorflow/compiler/xla/python/py_values.cc", "lambda");
...
bool IsFloat0(py::array arg) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpy_valuesDTcc mht_1(mht_1_v, 503, "", "./tensorflow/compiler/xla/python/py_values.cc", "IsFloat0");
...
std::string PyArgSignature::DebugString() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpy_valuesDTcc mht_2(mht_2_v, 514, "", "./tensorflow/compiler/xla/python/py_values.cc", "PyArgSignature::DebugString");
