...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_ref_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_ref_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_ref_managerDTh() {
      // Check if tracing is enabled
...
class PythonRefManager {
 public:
  ...
  void MaybeCollectGarbage() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpython_ref_managerDTh mht_0(mht_0_v, 251, "", "./tensorflow/compiler/xla/python/python_ref_manager.h", "MaybeCollectGarbage");
