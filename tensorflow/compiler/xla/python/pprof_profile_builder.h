...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTh() {
      // Check if tracing is enabled
...
class PprofProfileBuilder {
 public:
  ...
  tensorflow::tfprof::pprof::Profile& profile() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/python/pprof_profile_builder.h", "profile");
 return profile_; }
