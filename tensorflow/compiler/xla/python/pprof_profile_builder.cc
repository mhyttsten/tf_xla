...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc() {
      // Check if tracing is enabled
...
PprofProfileBuilder::PprofProfileBuilder() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/python/pprof_profile_builder.cc", "PprofProfileBuilder::PprofProfileBuilder");
 CHECK_EQ(0, StringId("")); }

int PprofProfileBuilder::StringId(const std::string& s) {
   std::vector<std::string> mht_1_v;
   mht_1_v.push_back("s: \"" + s + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc mht_1(mht_1_v, 203, "", "./tensorflow/compiler/xla/python/pprof_profile_builder.cc", "PprofProfileBuilder::StringId");
...
int PprofProfileBuilder::FunctionId(PyCodeObject* code) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc mht_2(mht_2_v, 214, "", "./tensorflow/compiler/xla/python/pprof_profile_builder.cc", "PprofProfileBuilder::FunctionId");
...
int PprofProfileBuilder::LocationId(PyCodeObject* code, int instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSpprof_profile_builderDTcc mht_3(mht_3_v, 232, "", "./tensorflow/compiler/xla/python/pprof_profile_builder.cc", "PprofProfileBuilder::LocationId");
