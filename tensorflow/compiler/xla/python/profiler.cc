...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSprofilerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSprofilerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSprofilerDTcc() {
      // Check if tracing is enabled
...
tensorflow::ProfileOptions DefaultPythonProfileOptions() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSprofilerDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/python/profiler.cc", "DefaultPythonProfileOptions");
...
void BuildProfilerSubmodule(py::module* m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSprofilerDTcc mht_1(mht_1_v, 221, "", "./tensorflow/compiler/xla/python/profiler.cc", "BuildProfilerSubmodule");
