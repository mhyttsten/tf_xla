...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSstatus_castersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSstatus_castersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSstatus_castersDTh() {
      // Check if tracing is enabled
...
T ValueOrThrow(StatusOr<T> v) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSstatus_castersDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/python/status_casters.h", "ValueOrThrow");
...
struct type_caster<xla::Status> {
 public:
  ...
  static handle cast(xla::Status src, return_value_policy /* policy */,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSstatus_castersDTh mht_1(mht_1_v, 224, "", "./tensorflow/compiler/xla/python/status_casters.h", "cast");
...
struct type_caster<xla::StatusOr<T>> {
 public:
  ...
  static handle cast(xla::StatusOr<T> src, return_value_policy policy,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpythonPSstatus_castersDTh mht_2(mht_2_v, 244, "", "./tensorflow/compiler/xla/python/status_casters.h", "cast");
