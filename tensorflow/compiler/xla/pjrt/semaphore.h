...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSsemaphoreDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSsemaphoreDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSsemaphoreDTh() {
      // Check if tracing is enabled
...
class Semaphore {
 public:
  ...
  class ScopedReservation {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSsemaphoreDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/pjrt/semaphore.h", "ScopedReservation");
}
    ~ScopedReservation();
