...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh() {
      // Check if tracing is enabled
...
class PjRtTpuDevice : public PjRtStreamExecutorDevice {
 public:
  PjRtTpuDevice(const tensorflow::tpu::TpuCoreLocationExternal core,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/pjrt/tpu_client.h", "PjRtTpuDevice");
}

  const std::array<int, 3>& coords() const { return coords_; }
  int core_on_chip() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/pjrt/tpu_client.h", "core_on_chip");
 return core_.index(); }
  const tensorflow::tpu::TpuCoreLocationExternal core() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh mht_2(mht_2_v, 218, "", "./tensorflow/compiler/xla/pjrt/tpu_client.h", "core");
 return core_; }

  std::string DebugString() const override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh mht_3(mht_3_v, 223, "", "./tensorflow/compiler/xla/pjrt/tpu_client.h", "DebugString");
...
class PjRtTpuClient : public PjRtStreamExecutorClient {
 public:
  ...
  absl::string_view platform_version() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh mht_4(mht_4_v, 244, "", "./tensorflow/compiler/xla/pjrt/tpu_client.h", "platform_version");
  ...
  bool EnqueueD2DTransfersOnSrcStream() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPStpu_clientDTh mht_5(mht_5_v, 254, "", "./tensorflow/compiler/xla/pjrt/tpu_client.h", "EnqueueD2DTransfersOnSrcStream");
 return false; }
