...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh() {
      // Check if tracing is enabled
...
inline const char* CpuName() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_0(mht_0_v, 227, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "CpuName");
...
inline const char* GpuName() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_1(mht_1_v, 234, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "GpuName");
...
inline const char* TpuName() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_2(mht_2_v, 241, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "TpuName");
...
inline PjRtPlatformId CpuId() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_3(mht_3_v, 248, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "CpuId");
...
inline PjRtPlatformId GpuId() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_4(mht_4_v, 255, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "GpuId");
...
inline PjRtPlatformId TpuId() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_5(mht_5_v, 262, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "TpuId");
...
inline constexpr absl::string_view PjRtRuntimeTypeString(PjRtRuntimeType type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_6(mht_6_v, 271, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "PjRtRuntimeTypeString");
...
class PjRtDevice {
 public:
  virtual ~PjRtDevice() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_7(mht_7_v, 287, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "~PjRtDevice");
}
...
class PjRtBuffer {
 public:
  ...
  class ExternalReference {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_8(mht_8_v, 808, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "OpaqueDeviceMemoryDataPointer");
 return data_ptr_; }
  ...
  Status ToLiteralSync(MutableLiteralBase* literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSpjrt_clientDTh mht_9(mht_9_v, 836, "", "./tensorflow/compiler/xla/pjrt/pjrt_client.h", "ToLiteralSync");
