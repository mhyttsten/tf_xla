...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSinterpreter_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSinterpreter_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSinterpreter_deviceDTcc() {
      // Check if tracing is enabled
...
InterpreterDevice::InterpreterDevice(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPSinterpreter_deviceDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/pjrt/interpreter_device.cc", "InterpreterDevice::InterpreterDevice");
}
