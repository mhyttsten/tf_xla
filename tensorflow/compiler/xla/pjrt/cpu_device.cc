...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPScpu_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPScpu_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPScpu_deviceDTcc() {
      // Check if tracing is enabled
...
CpuDevice::CpuDevice(int id,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpjrtPScpu_deviceDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/pjrt/cpu_device.cc", "CpuDevice::CpuDevice");
}
