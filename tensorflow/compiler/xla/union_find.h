...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh() {
      // Check if tracing is enabled
...
class UnionFind {
 public:
  UnionFind() : rank_(0), size_(1), parent_(nullptr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/union_find.h", "UnionFind");
}

  // Returns the number of elements in a cluster.
  int Size() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh mht_1(mht_1_v, 203, "", "./tensorflow/compiler/xla/union_find.h", "Size");
 return FindRoot()->size_; }
  ...
  T& Get() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh mht_2(mht_2_v, 214, "", "./tensorflow/compiler/xla/union_find.h", "Get");
...
void UnionFind<T>::Merge(UnionFind* other) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh mht_3(mht_3_v, 230, "", "./tensorflow/compiler/xla/union_find.h", "UnionFind<T>::Merge");
...
UnionFind<T>* UnionFind<T>::FindRoot() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSunion_findDTh mht_4(mht_4_v, 252, "", "./tensorflow/compiler/xla/union_find.h", "UnionFind<T>::FindRoot");
