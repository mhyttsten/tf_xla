...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSprotobuf_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSprotobuf_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSprotobuf_utilDTcc() {
      // Check if tracing is enabled
...
bool ProtobufEquals(const tensorflow::protobuf::Message& m1,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSprotobuf_utilDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/protobuf_util.cc", "ProtobufEquals");
...
size_t ProtobufHash(const tensorflow::protobuf::Message& m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSprotobuf_utilDTcc mht_1(mht_1_v, 215, "", "./tensorflow/compiler/xla/protobuf_util.cc", "ProtobufHash");
...
Status DumpProtoToDirectory(const tensorflow::protobuf::Message& message,
   ...
   mht_2_v.push_back("directory: \"" + directory + "\"");
   mht_2_v.push_back("file_name: \"" + file_name + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSprotobuf_utilDTcc mht_2(mht_2_v, 232, "", "./tensorflow/compiler/xla/protobuf_util.cc", "DumpProtoToDirectory");
