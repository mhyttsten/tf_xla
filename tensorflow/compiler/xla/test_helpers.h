...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStest_helpersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStest_helpersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStest_helpersDTh() {
      // Check if tracing is enabled
...
inline const Status& GetStatus(const Status& status) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStest_helpersDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/test_helpers.h", "GetStatus");
 return status; }

template <typename T>
inline const Status& GetStatus(const StatusOr<T>& status) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStest_helpersDTh mht_1(mht_1_v, 215, "", "./tensorflow/compiler/xla/test_helpers.h", "GetStatus");
