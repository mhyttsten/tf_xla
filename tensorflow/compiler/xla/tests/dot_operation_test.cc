...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc() {
      // Check if tracing is enabled
...
class SquareMatrixDot : public DotOperationTest {
 public:
  void TestImpl(bool lhs_row_major, bool rhs_row_major) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_0(mht_0_v, 395, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "TestImpl");
...
std::string PrintDotTestParam(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_1(mht_1_v, 441, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "PrintDotTestParam");
...
void ParametricDotTest::ComputeAndCompareR2WithError(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_2(mht_2_v, 473, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "ParametricDotTest::ComputeAndCompareR2WithError");
...
void ParametricDotTest::ComputeAndCompareR2WithError<Eigen::half>(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_3(mht_3_v, 484, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "ParametricDotTest::ComputeAndCompareR2WithError<Eigen::half>");
...
void ParametricDotTest::ComputeAndCompareR2WithError<int32_t>(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_4(mht_4_v, 495, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "ParametricDotTest::ComputeAndCompareR2WithError<int32_t>");
...
void ParametricDotTest::TestImpl() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_5(mht_5_v, 503, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "ParametricDotTest::TestImpl");
...
std::vector<DotTestParam> CreateDotTestParameters() {
  ...
  auto add_matrix_matrix_dot_test = [&](int m, int k, int n) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_6(mht_6_v, 582, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "lambda");
...
class ParametricDotTestWithoutLayoutAssignment : public ParametricDotTest {
 public:
  ParametricDotTestWithoutLayoutAssignment() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_7(mht_7_v, 625, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "ParametricDotTestWithoutLayoutAssignment");
...
std::vector<DotTestParam> CreateNoLayoutAssignmentDotTestParameters() {
  ...
  auto add_matrix_vector_dot_test = [&](int k, int n) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_8(mht_8_v, 643, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "lambda");
...
class NonsquareMatrixDot : public DotOperationTest {
 public:
  void TestImpl(bool lhs_row_major, bool rhs_row_major) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_9(mht_9_v, 707, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "TestImpl");
...
void DOT_ReorderContracting(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSdot_operation_testDTcc mht_10(mht_10_v, 2013, "", "./tensorflow/compiler/xla/tests/dot_operation_test.cc", "DOT_ReorderContracting");
