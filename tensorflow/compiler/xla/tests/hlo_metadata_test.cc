...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPShlo_metadata_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPShlo_metadata_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPShlo_metadata_testDTcc() {
      // Check if tracing is enabled
...
class HloMetadataTest : public LocalClientTestBase {
 protected:
  HloMetadataTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPShlo_metadata_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/tests/hlo_metadata_test.cc", "HloMetadataTest");
  ...
  void BuildAddComputation(XlaBuilder* builder) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPShlo_metadata_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/compiler/xla/tests/hlo_metadata_test.cc", "BuildAddComputation");
