...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscalar_computations_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscalar_computations_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscalar_computations_testDTcc() {
      // Check if tracing is enabled
...
class ScalarComputationsTest : public ClientLibraryTestBase {
 ...
 protected:
  ...
  void TestCompare(NativeT lhs, NativeT rhs, bool expected,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscalar_computations_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/compiler/xla/tests/scalar_computations_test.cc", "TestCompare");
  ...
  void TestMinMax(NativeT lhs, NativeT rhs, NativeT expected,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscalar_computations_testDTcc mht_1(mht_1_v, 232, "", "./tensorflow/compiler/xla/tests/scalar_computations_test.cc", "TestMinMax");
...
void PrintTo(const DivS32Params& p, std::ostream* os) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscalar_computations_testDTcc mht_2(mht_2_v, 454, "", "./tensorflow/compiler/xla/tests/scalar_computations_test.cc", "PrintTo");
