...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc() {
      // Check if tracing is enabled
...
class MapTest : public ClientLibraryTestBase {
 public:
  explicit MapTest(se::Platform* platform = nullptr)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/tests/map_test.cc", "MapTest");
  ...
  XlaComputation CreateAdderToOne() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_1(mht_1_v, 224, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateAdderToOne");
  ...
  XlaComputation CreateMax() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_2(mht_2_v, 237, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateMax");
  ...
  XlaComputation CreateScalarOne() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_3(mht_3_v, 253, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateScalarOne");
  ...
  XlaComputation CreateMulByTwo() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_4(mht_4_v, 270, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateMulByTwo");
  ...
  XlaComputation CreateAdderToOneTimesItself() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_5(mht_5_v, 291, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateAdderToOneTimesItself");
  ...
  XlaComputation CreateMapPlusN(const XlaComputation& embedded_computation,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_6(mht_6_v, 312, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateMapPlusN");
  ...
  XlaComputation CreateGt() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_7(mht_7_v, 328, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateGt");
  ...
  XlaComputation CreateTernaryAdder() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmap_testDTcc mht_8(mht_8_v, 348, "", "./tensorflow/compiler/xla/tests/map_test.cc", "CreateTernaryAdder");
