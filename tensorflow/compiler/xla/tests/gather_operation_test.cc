...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSgather_operation_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSgather_operation_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSgather_operation_testDTcc() {
      // Check if tracing is enabled
...
class GatherOperationTest : public HloTestBase {
 protected:
  void RunTest(const std::string& hlo_text, Literal* operand,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSgather_operation_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/tests/gather_operation_test.cc", "RunTest");
  ...
  void RunTest(const std::string& hlo_text, absl::Span<Literal* const> args) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSgather_operation_testDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/tests/gather_operation_test.cc", "RunTest");
