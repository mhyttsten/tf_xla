...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc() {
      // Check if tracing is enabled
...
void PopulateWithRandomFullRangeFloatingPointData(Literal* literal,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_0(mht_0_v, 217, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithRandomFullRangeFloatingPointData");
...
void PopulateWithIntNext<half>(Literal* literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_1(mht_1_v, 261, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithIntNext<half>");
...
void PopulateWithIntNext<bfloat16>(Literal* literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_2(mht_2_v, 278, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithIntNext<bfloat16>");
...
void PopulateWithNextAfter(Literal* literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_3(mht_3_v, 296, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithNextAfter");
...
void PopulateWithFloatingPointData(Literal* literal, std::minstd_rand0* engine,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_4(mht_4_v, 331, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithFloatingPointData");
...
void PopulateWithComplexData(Literal* result, std::minstd_rand0* engine,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_5(mht_5_v, 349, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithComplexData");
...
void PopulateWithFloatingPointData<half>(Literal* literal,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_6(mht_6_v, 380, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithFloatingPointData<half>");
...
void PopulateWithFloatingPointData<bfloat16>(Literal* literal,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_7(mht_7_v, 400, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithFloatingPointData<bfloat16>");
...
void PopulateWithRandomIntegralData(Literal* literal, std::minstd_rand0* engine,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_8(mht_8_v, 435, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithRandomIntegralData");
...
void PopulateWithRandomIntegralDataWithBounds(Literal* literal,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_9(mht_9_v, 554, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "PopulateWithRandomIntegralDataWithBounds");
...
ConstantType GetInitValue(const HloComputation& computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_10(mht_10_v, 676, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "GetInitValue");
...
bool NeedsInitValue(const HloUse& use) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_11(mht_11_v, 701, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "NeedsInitValue");
...
Literal MakeRandomIndex(int64_t index_bound, std::minstd_rand0* engine) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_12(mht_12_v, 716, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "MakeRandomIndex");
...
Status VerifyHloModule(HloModule* const module, bool layout_sensitive,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPStest_utilsDTcc mht_13(mht_13_v, 935, "", "./tensorflow/compiler/xla/tests/test_utils.cc", "VerifyHloModule");
