...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSverified_hlo_moduleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSverified_hlo_moduleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSverified_hlo_moduleDTh() {
      // Check if tracing is enabled
...
class VerifiedHloModule : public HloModule {
 public:
  VerifiedHloModule(const std::string& name, const HloModuleConfig& config,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSverified_hlo_moduleDTh mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/tests/verified_hlo_module.h", "VerifiedHloModule");
}

  ~VerifiedHloModule() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSverified_hlo_moduleDTh mht_1(mht_1_v, 217, "", "./tensorflow/compiler/xla/tests/verified_hlo_module.h", "~VerifiedHloModule");
 VerifyOrAddFailure("in destructor"); }
