...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_execute_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_execute_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_execute_testDTcc() {
      // Check if tracing is enabled
...
XLA_TEST_F(LocalClientExecuteTest, ShapeBufferToLiteralConversion) {
  ...
  auto test_to_device_and_back = [this](const Literal& literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_execute_testDTcc mht_0(mht_0_v, 1011, "", "./tensorflow/compiler/xla/tests/local_client_execute_test.cc", "lambda");
...
XLA_TEST_F(LocalClientExecuteTest, ShapeBufferToLiteralConversion64bit) {
  ...
  auto test_to_device_and_back = [this](const Literal& literal) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_execute_testDTcc mht_1(mht_1_v, 1054, "", "./tensorflow/compiler/xla/tests/local_client_execute_test.cc", "lambda");
...
void BM_LocalClientOverhead(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_execute_testDTcc mht_2(mht_2_v, 1131, "", "./tensorflow/compiler/xla/tests/local_client_execute_test.cc", "BM_LocalClientOverhead");
