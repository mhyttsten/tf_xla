...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_testDTcc() {
      // Check if tracing is enabled
...
extern "C" void SumStructElements(float* out, void** parameters) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/tests/local_client_aot_test.cc", "SumStructElements");
