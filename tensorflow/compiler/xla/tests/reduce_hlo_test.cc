...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSreduce_hlo_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSreduce_hlo_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSreduce_hlo_testDTcc() {
      // Check if tracing is enabled
...
struct ReduceLayout {
  ...
  std::string ToString() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSreduce_hlo_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/tests/reduce_hlo_test.cc", "ToString");
...
std::string PrintReduceLayout(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSreduce_hlo_testDTcc mht_1(mht_1_v, 213, "", "./tensorflow/compiler/xla/tests/reduce_hlo_test.cc", "PrintReduceLayout");
...
void PrintTo(const ReduceLayout& reduce_layout, ::std::ostream* os) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSreduce_hlo_testDTcc mht_2(mht_2_v, 220, "", "./tensorflow/compiler/xla/tests/reduce_hlo_test.cc", "PrintTo");
