...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSsample_file_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSsample_file_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSsample_file_testDTcc() {
      // Check if tracing is enabled
...
class SampleFileTest : public HloTestBase {
 protected:
  SampleFileTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSsample_file_testDTcc mht_0(mht_0_v, 210, "", "./tensorflow/compiler/xla/tests/sample_file_test.cc", "SampleFileTest");
}
};
