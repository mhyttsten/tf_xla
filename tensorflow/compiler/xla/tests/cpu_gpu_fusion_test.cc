...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc() {
      // Check if tracing is enabled
...
class CpuGpuFusionTest : public HloTestBase {
 ...
 private:
  ...
  DebugOptions GetDebugOptionsForTest() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc mht_0(mht_0_v, 311, "", "./tensorflow/compiler/xla/tests/cpu_gpu_fusion_test.cc", "GetDebugOptionsForTest");
...
float CpuGpuFusionTest::ComputeElementwiseAnswerFloat(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc mht_1(mht_1_v, 322, "", "./tensorflow/compiler/xla/tests/cpu_gpu_fusion_test.cc", "CpuGpuFusionTest::ComputeElementwiseAnswerFloat");
...
bool CpuGpuFusionTest::ComputeElementwiseAnswerCompare(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc mht_2(mht_2_v, 349, "", "./tensorflow/compiler/xla/tests/cpu_gpu_fusion_test.cc", "CpuGpuFusionTest::ComputeElementwiseAnswerCompare");
...
void BM_ParallelFusion(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScpu_gpu_fusion_testDTcc mht_3(mht_3_v, 1004, "", "./tensorflow/compiler/xla/tests/cpu_gpu_fusion_test.cc", "BM_ParallelFusion");
