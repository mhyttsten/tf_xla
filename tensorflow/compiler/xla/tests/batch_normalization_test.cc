...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc() {
      // Check if tracing is enabled
...
class BatchNormalizationTest : public ClientLibraryTestBase {
 protected:
  BatchNormalizationTest() : input_array_(kSamples, kZ, kY, kX) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc mht_0(mht_0_v, 223, "", "./tensorflow/compiler/xla/tests/batch_normalization_test.cc", "BatchNormalizationTest");
  ...
  XlaOp CheckShape(XlaBuilder* b, const XlaOp operand,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc mht_1(mht_1_v, 242, "", "./tensorflow/compiler/xla/tests/batch_normalization_test.cc", "CheckShape");
...
struct BatchNormTestParam {
  ...
  friend ::std::ostream& operator<<(::std::ostream& os,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc mht_2(mht_2_v, 635, "", "./tensorflow/compiler/xla/tests/batch_normalization_test.cc", "operator<<");
...
std::vector<BatchNormTestParam> BuildBatchNormTestParams() {
  ...
  auto add_testcase = [&](std::vector<int64_t> bounds, int64_t feature_index,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSbatch_normalization_testDTcc mht_3(mht_3_v, 656, "", "./tensorflow/compiler/xla/tests/batch_normalization_test.cc", "lambda");
