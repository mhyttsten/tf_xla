...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvector_ops_reduce_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvector_ops_reduce_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvector_ops_reduce_testDTcc() {
      // Check if tracing is enabled
...
class VecOpsReduceTest : public ClientLibraryTestBase {
 public:
  VecOpsReduceTest() : builder_(TestName()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvector_ops_reduce_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/tests/vector_ops_reduce_test.cc", "VecOpsReduceTest");
}

  XlaOp BuildSampleConstantCube() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvector_ops_reduce_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/tests/vector_ops_reduce_test.cc", "BuildSampleConstantCube");
