...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSarray_elementwise_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSarray_elementwise_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSarray_elementwise_ops_testDTcc() {
      // Check if tracing is enabled
...
class IntegerDivideOpTest : public ArrayElementwiseOpTest {
 protected:
  ...
  void TestDivRem(absl::Span<const T> dividends, absl::Span<const T> divisors,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSarray_elementwise_ops_testDTcc mht_0(mht_0_v, 702, "", "./tensorflow/compiler/xla/tests/array_elementwise_ops_test.cc", "TestDivRem");
