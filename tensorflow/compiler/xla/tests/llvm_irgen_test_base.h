...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSllvm_irgen_test_baseDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSllvm_irgen_test_baseDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSllvm_irgen_test_baseDTh() {
      // Check if tracing is enabled
...
class LlvmIrGenTestBase : public CodegenTestBase {
 protected:
  ...
  void MatchOptimizedHloWithShapes(absl::string_view hlo,
   ...
   mht_0_v.push_back("hlo: \"" + std::string(hlo.data(), hlo.size()) + "\"");
   mht_0_v.push_back("pattern: \"" + std::string(pattern.data(), pattern.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSllvm_irgen_test_baseDTh mht_0(mht_0_v, 239, "", "./tensorflow/compiler/xla/tests/llvm_irgen_test_base.h", "MatchOptimizedHloWithShapes");
