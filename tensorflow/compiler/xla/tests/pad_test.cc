...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSpad_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSpad_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSpad_testDTcc() {
      // Check if tracing is enabled
...
class PadTest : public ClientLibraryTestBase {
 protected:
  PadTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSpad_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/xla/tests/pad_test.cc", "PadTest");
...
class PadTestFloat : public PadTest,
 ...
 protected:
  PadTestFloat() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSpad_testDTcc mht_1(mht_1_v, 246, "", "./tensorflow/compiler/xla/tests/pad_test.cc", "PadTestFloat");
 set_use_bfloat16(GetParam()); }

  ErrorSpec DefaultErrorSpec() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSpad_testDTcc mht_2(mht_2_v, 251, "", "./tensorflow/compiler/xla/tests/pad_test.cc", "DefaultErrorSpec");
