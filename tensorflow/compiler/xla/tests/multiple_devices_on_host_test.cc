...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmultiple_devices_on_host_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmultiple_devices_on_host_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmultiple_devices_on_host_testDTcc() {
      // Check if tracing is enabled
...
void CompileAndExecute(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmultiple_devices_on_host_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/tests/multiple_devices_on_host_test.cc", "CompileAndExecute");
...
void TestWithDeviceCount(const int device_count) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSmultiple_devices_on_host_testDTcc mht_1(mht_1_v, 228, "", "./tensorflow/compiler/xla/tests/multiple_devices_on_host_test.cc", "TestWithDeviceCount");
