...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc() {
      // Check if tracing is enabled
...
class CollectiveOpsTest : public HloTestBase {
 public:
  static void SetUpTestSuite() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "SetUpTestSuite");
 ...
 protected:
  ...
  void TestTwoReplicasOneOperand(std::string op, Literal input_value,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_1(mht_1_v, 272, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "TestTwoReplicasOneOperand");
  ...
  void TestAllOpsForReduce() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_2(mht_2_v, 296, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "TestAllOpsForReduce");

    auto cast = [&](int value) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_3(mht_3_v, 300, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "lambda");
 return static_cast<LiteralType>(value); };
    auto to_literal = [&](absl::Span<const LiteralType> values) {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_4(mht_4_v, 304, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "lambda");
...
DeviceAssignment MakeDeviceAssn(std::vector<int64_t> devices) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_5(mht_5_v, 346, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "MakeDeviceAssn");
...
static Eigen::half ToHalf(T value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPScollective_ops_testDTcc mht_6(mht_6_v, 359, "", "./tensorflow/compiler/xla/tests/collective_ops_test.cc", "ToHalf");
