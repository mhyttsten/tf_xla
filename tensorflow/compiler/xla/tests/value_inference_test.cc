...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc() {
      // Check if tracing is enabled
...
class ValueInferenceTest : public ::testing::Test {
 public:
  std::string TestName() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/compiler/xla/tests/value_inference_test.cc", "TestName");
...
class DynamismInferenceTest : public ValueInferenceTest {
 public:
  explicit DynamismInferenceTest(se::Platform* platform = nullptr)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc mht_1(mht_1_v, 229, "", "./tensorflow/compiler/xla/tests/value_inference_test.cc", "DynamismInferenceTest");
}
...
class UpperBoundInferenceTest : public ValueInferenceTest {
 public:
  explicit UpperBoundInferenceTest(se::Platform* platform = nullptr)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc mht_2(mht_2_v, 738, "", "./tensorflow/compiler/xla/tests/value_inference_test.cc", "UpperBoundInferenceTest");
}
...
class ConstValueInferenceTest : public ValueInferenceTest {
 public:
  explicit ConstValueInferenceTest(se::Platform* platform = nullptr)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSvalue_inference_testDTcc mht_3(mht_3_v, 904, "", "./tensorflow/compiler/xla/tests/value_inference_test.cc", "ConstValueInferenceTest");
}
