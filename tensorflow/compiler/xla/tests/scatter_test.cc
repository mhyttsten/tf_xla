...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscatter_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscatter_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscatter_testDTcc() {
      // Check if tracing is enabled
...
class ScatterTest : public HloTestBase {
 protected:
  void RunTest(const std::string& hlo_text, Literal* operand,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscatter_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/tests/scatter_test.cc", "RunTest");
  ...
  void RunTest(const std::string& hlo_text, absl::Span<Literal* const> args) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSscatter_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/compiler/xla/tests/scatter_test.cc", "RunTest");
