...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSround_trip_packed_literal_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSround_trip_packed_literal_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSround_trip_packed_literal_testDTcc() {
      // Check if tracing is enabled
...
class RoundTripPackedLiteralTest : public ClientLibraryTestBase {
 protected:
  ...
  Literal RoundTripToServer(const Literal& original) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSround_trip_packed_literal_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/tests/round_trip_packed_literal_test.cc", "RoundTripToServer");
