...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_test_helperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_test_helperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_test_helperDTcc() {
      // Check if tracing is enabled
...
xla::XlaComputation Doubler() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_test_helperDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/tests/local_client_aot_test_helper.cc", "Doubler");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStestsPSlocal_client_aot_test_helperDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/xla/tests/local_client_aot_test_helper.cc", "main");
