...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsers_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsers_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsers_testDTcc() {
      // Check if tracing is enabled
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsers_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/debug_options_parsers_test.cc", "main");
