...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_module_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_module_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_module_mainDTcc() {
      // Check if tracing is enabled
...
std::string GetTestPlatformName(std::string name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_module_mainDTcc mht_0(mht_0_v, 229, "", "./tensorflow/compiler/xla/tools/run_hlo_module_main.cc", "GetTestPlatformName");
...
std::string GetReferencePlatformName(std::string reference_platform) {
   ...
   mht_1_v.push_back("reference_platform: \"" + reference_platform + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_module_mainDTcc mht_1(mht_1_v, 239, "", "./tensorflow/compiler/xla/tools/run_hlo_module_main.cc", "GetReferencePlatformName");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_module_mainDTcc mht_2(mht_2_v, 250, "", "./tensorflow/compiler/xla/tools/run_hlo_module_main.cc", "main");
