...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShlo_module_loaderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShlo_module_loaderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShlo_module_loaderDTh() {
      // Check if tracing is enabled
...
struct Config {
  Config() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShlo_module_loaderDTh mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/tools/hlo_module_loader.h", "Config");
}
