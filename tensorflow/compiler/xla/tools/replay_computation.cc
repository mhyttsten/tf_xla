...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc() {
      // Check if tracing is enabled
...
struct Options {
  Options() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc mht_0(mht_0_v, 257, "", "./tensorflow/compiler/xla/tools/replay_computation.cc", "Options");
}

  bool NeedsRealData() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc mht_1(mht_1_v, 262, "", "./tensorflow/compiler/xla/tools/replay_computation.cc", "NeedsRealData");
 return !use_fake_data && !compile_only; }
...
absl::optional<Shape> GetXfeedShape(bool is_infeed,
  ...
  auto find_instruction_from_id_or_die = [&](int64_t id) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc mht_2(mht_2_v, 341, "", "./tensorflow/compiler/xla/tools/replay_computation.cc", "lambda");
...
int RealMain(absl::Span<char* const> args, const Options& opts) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc mht_3(mht_3_v, 629, "", "./tensorflow/compiler/xla/tools/replay_computation.cc", "RealMain");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSreplay_computationDTcc mht_4(mht_4_v, 720, "", "./tensorflow/compiler/xla/tools/replay_computation.cc", "main");
