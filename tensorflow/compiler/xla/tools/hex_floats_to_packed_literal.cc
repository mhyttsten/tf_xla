...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShex_floats_to_packed_literalDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShex_floats_to_packed_literalDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShex_floats_to_packed_literalDTcc() {
      // Check if tracing is enabled
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPShex_floats_to_packed_literalDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/tools/hex_floats_to_packed_literal.cc", "main");
