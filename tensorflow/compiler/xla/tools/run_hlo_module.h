...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_moduleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_moduleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_moduleDTh() {
      // Check if tracing is enabled
...
struct RunHloModuleOptions {
  RunHloModuleOptions()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSrun_hlo_moduleDTh mht_0(mht_0_v, 218, "", "./tensorflow/compiler/xla/tools/run_hlo_module.h", "RunHloModuleOptions");
}
  std::string platform;
