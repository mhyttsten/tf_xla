...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSshow_signatureDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSshow_signatureDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSshow_signatureDTcc() {
      // Check if tracing is enabled
...
void RealMain(absl::Span<char* const> args) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSshow_signatureDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/xla/tools/show_signature.cc", "RealMain");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSshow_signatureDTcc mht_1(mht_1_v, 237, "", "./tensorflow/compiler/xla/tools/show_signature.cc", "main");
