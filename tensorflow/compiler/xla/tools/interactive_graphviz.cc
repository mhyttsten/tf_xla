...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc() {
      // Check if tracing is enabled
...
bool ReadLine(const char* prompt, std::string* line) {
   ...
   mht_0_v.push_back("prompt: \"" + (prompt == nullptr ? std::string("nullptr") : std::string((char*)prompt)) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_0(mht_0_v, 235, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "ReadLine");
...
HloInstruction* FindInstruction(const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_1(mht_1_v, 298, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "FindInstruction");
...
HloComputation* FindComputation(const HloModule& module,
   ...
   mht_2_v.push_back("comp_name: \"" + comp_name + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_2(mht_2_v, 321, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "FindComputation");
...
void DoHelpCommand() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_3(mht_3_v, 334, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoHelpCommand");
...
void DoBackendConfigCommand(const std::vector<std::string>& tokens) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_4(mht_4_v, 375, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoBackendConfigCommand");
...
void DoShowFusionSubcomputationsCommand(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_5(mht_5_v, 394, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoShowFusionSubcomputationsCommand");
...
void DoListComputationsCommand(const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_6(mht_6_v, 414, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoListComputationsCommand");
...
void DoListCommand(const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_7(mht_7_v, 439, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoListCommand");
...
void DoInfoCommand(const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_8(mht_8_v, 476, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoInfoCommand");
...
void DoExtractCommand(const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_9(mht_9_v, 576, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoExtractCommand");
...
bool ExistsPathFromTo(const HloInstruction* from, const HloInstruction* to) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_10(mht_10_v, 612, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "ExistsPathFromTo");
...
void OpenUrl(const Options& opts, absl::string_view url) {
   ...
   mht_11_v.push_back("url: \"" + std::string(url.data(), url.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_11(mht_11_v, 635, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "OpenUrl");
...
void RenderAndDisplayGraph(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_12(mht_12_v, 663, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "RenderAndDisplayGraph");
...
void DoAllPathsCommand(const Options& opts, const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_13(mht_13_v, 720, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoAllPathsCommand");
...
void DoPlotCommand(const Options& opts, const HloModule& module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_14(mht_14_v, 770, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "DoPlotCommand");
...
void InteractiveDumpGraphs(const Options& opts, const HloModule& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_15(mht_15_v, 844, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "InteractiveDumpGraphs");
...
void CheckFlags(const Options& opts) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_16(mht_16_v, 889, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "CheckFlags");
...
void RealMain(const Options& opts) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_17(mht_17_v, 913, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "RealMain");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStoolsPSinteractive_graphvizDTcc mht_18(mht_18_v, 979, "", "./tensorflow/compiler/xla/tools/interactive_graphviz.cc", "main");
