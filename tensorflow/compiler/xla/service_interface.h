...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservice_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservice_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservice_interfaceDTh() {
      // Check if tracing is enabled
...
class ServiceInterface {
 public:
  ServiceInterface() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservice_interfaceDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service_interface.h", "ServiceInterface");
}
