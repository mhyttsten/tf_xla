...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_readerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_readerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_readerDTcc() {
      // Check if tracing is enabled
...
StatusOr<Literal> TextLiteralReader::ReadPath(absl::string_view path) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_readerDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/text_literal_reader.cc", "TextLiteralReader::ReadPath");
...
TextLiteralReader::TextLiteralReader(tensorflow::RandomAccessFile* file)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_readerDTcc mht_1(mht_1_v, 230, "", "./tensorflow/compiler/xla/text_literal_reader.cc", "TextLiteralReader::TextLiteralReader");
}

StatusOr<Literal> TextLiteralReader::ReadAllLines() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_readerDTcc mht_2(mht_2_v, 235, "", "./tensorflow/compiler/xla/text_literal_reader.cc", "TextLiteralReader::ReadAllLines");
