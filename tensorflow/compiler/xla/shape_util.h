...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh() {
      // Check if tracing is enabled
...
struct ShapeIndex : public absl::InlinedVector<int64_t, 2> {
  ...
  explicit ShapeIndex(ShapeIndexView view)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_0(mht_0_v, 245, "", "./tensorflow/compiler/xla/shape_util.h", "ShapeIndex");
}

  // push_front is O(n), but shapes don't usually have a ton of dimensions.
  void push_front(int64_t value) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_1(mht_1_v, 251, "", "./tensorflow/compiler/xla/shape_util.h", "push_front");
 insert(begin(), value); }
  void pop_front() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_2(mht_2_v, 255, "", "./tensorflow/compiler/xla/shape_util.h", "pop_front");
 erase(begin()); }
...
class ShapeUtil {
 public:
  ...
  struct IndexedShape {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_3(mht_3_v, 276, "", "./tensorflow/compiler/xla/shape_util.h", "IndexedShape");
}
    ShapeIndex index;
    Shape shape;
  };
  ...
  static bool SameElementType(const Shape& lhs, const Shape& rhs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_4(mht_4_v, 345, "", "./tensorflow/compiler/xla/shape_util.h", "SameElementType");
  ...
  static bool SameElementTypeIgnoringFpPrecision(const Shape& a,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_5(mht_5_v, 355, "", "./tensorflow/compiler/xla/shape_util.h", "SameElementTypeIgnoringFpPrecision");
  ...
  static PrimitiveType HigherPrecisionElementType(const Shape& a,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_6(mht_6_v, 369, "", "./tensorflow/compiler/xla/shape_util.h", "HigherPrecisionElementType");
  ...
  static bool IsScalar(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_7(mht_7_v, 427, "", "./tensorflow/compiler/xla/shape_util.h", "IsScalar");

    return shape.IsArray() && shape.rank() == 0;
  }
  static bool IsEffectiveScalar(const Shape& shape) {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_8(mht_8_v, 433, "", "./tensorflow/compiler/xla/shape_util.h", "IsEffectiveScalar");
  ...
  static Shape MakeNil() {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_9(mht_9_v, 502, "", "./tensorflow/compiler/xla/shape_util.h", "MakeNil");
 return MakeTupleShape({}); }

  // Checks whether the shape is initialized.
  static bool IsInitialized(const Shape& shape) {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_10(mht_10_v, 508, "", "./tensorflow/compiler/xla/shape_util.h", "IsInitialized");
  ...
  static Shape MakeShapeWithType(absl::Span<const int64_t> dimensions) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_11(mht_11_v, 545, "", "./tensorflow/compiler/xla/shape_util.h", "MakeShapeWithType");
  ...
  static Status ForEachIndexWithStatus(const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_12(mht_12_v, 818, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndexWithStatus");
  ...
  static Status ForEachIndexWithStatus(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_13(mht_13_v, 835, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndexWithStatus");
  ...
  static void ForEachIndex(const Shape& shape, absl::Span<const int64_t> base,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_14(mht_14_v, 848, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndex");
  ...
  static Status ForEachIndexWithStatus(const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_15(mht_15_v, 864, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndexWithStatus");
  ...
  static void ForEachIndex(const Shape& shape, const FnType& visitor_function) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_16(mht_16_v, 876, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndex");
  ...
  static void ForEachIndexParallel(const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_17(mht_17_v, 896, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndexParallel");
 ...
 private:
  ...
  static Status ForEachIndexInternal(const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSshape_utilDTh mht_18(mht_18_v, 968, "", "./tensorflow/compiler/xla/shape_util.h", "ForEachIndexInternal");
