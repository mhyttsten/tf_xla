...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSpermutation_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpermutation_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSpermutation_utilDTcc() {
      // Check if tracing is enabled
...
bool IsPermutation(absl::Span<const int64_t> permutation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpermutation_utilDTcc mht_0(mht_0_v, 192, "", "./tensorflow/compiler/xla/permutation_util.cc", "IsPermutation");
...
bool IsIdentityPermutation(absl::Span<const int64_t> permutation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSpermutation_utilDTcc mht_1(mht_1_v, 227, "", "./tensorflow/compiler/xla/permutation_util.cc", "IsIdentityPermutation");
