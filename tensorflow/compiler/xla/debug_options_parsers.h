...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsersDTh() {
      // Check if tracing is enabled
...
void parse_xla_backend_extra_options(T* extra_options_map,
   ...
   mht_0_v.push_back("comma_separated_values: \"" + comma_separated_values + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSdebug_options_parsersDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/debug_options_parsers.h", "parse_xla_backend_extra_options");
