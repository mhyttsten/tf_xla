...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_writerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_writerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_writerDTcc() {
      // Check if tracing is enabled
...
/* static */ Status TextLiteralWriter::WriteToPath(const Literal& literal,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPStext_literal_writerDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/text_literal_writer.cc", "TextLiteralWriter::WriteToPath");
