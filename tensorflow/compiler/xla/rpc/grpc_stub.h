...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_stubDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_stubDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_stubDTh() {
      // Check if tracing is enabled
...
class GRPCStub : public ServiceInterface {
 public:
  explicit GRPCStub(grpc::XlaService::Stub* stub) : grpc_stub_(stub) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_stubDTh mht_0(mht_0_v, 196, "", "./tensorflow/compiler/xla/rpc/grpc_stub.h", "GRPCStub");
}
  ~GRPCStub() override;
  ...
  grpc::XlaService::Stub* service() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_stubDTh mht_1(mht_1_v, 251, "", "./tensorflow/compiler/xla/rpc/grpc_stub.h", "service");
 return grpc_stub_; }
