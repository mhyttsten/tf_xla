...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_client_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_client_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_client_testDTcc() {
      // Check if tracing is enabled
...
class GRPCClientTestBase : public ::testing::Test {
 protected:
  GRPCClientTestBase() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_client_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/xla/rpc/grpc_client_test.cc", "GRPCClientTestBase");
  ...
  ~GRPCClientTestBase() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_client_testDTcc mht_1(mht_1_v, 245, "", "./tensorflow/compiler/xla/rpc/grpc_client_test.cc", "~GRPCClientTestBase");
