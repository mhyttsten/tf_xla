...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_service_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_service_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_service_mainDTcc() {
      // Check if tracing is enabled
...
int RealMain(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_service_mainDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/rpc/grpc_service_main.cc", "RealMain");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSrpcPSgrpc_service_mainDTcc mht_1(mht_1_v, 247, "", "./tensorflow/compiler/xla/rpc/grpc_service_main.cc", "main");
