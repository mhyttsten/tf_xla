...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlogdetDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlogdetDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlogdetDTcc() {
      // Check if tracing is enabled
...
SignAndLogDet SLogDet(XlaOp a) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlogdetDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/client/lib/logdet.cc", "SLogDet");
...
XlaOp LogDet(XlaOp a) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlogdetDTcc mht_1(mht_1_v, 245, "", "./tensorflow/compiler/xla/client/lib/logdet.cc", "LogDet");
