...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSsvdDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSsvdDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSsvdDTcc() {
      // Check if tracing is enabled
...
SVDResult SVD(XlaOp a, int64_t max_iter, float epsilon,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSsvdDTcc mht_0(mht_0_v, 993, "", "./tensorflow/compiler/xla/client/lib/svd.cc", "SVD");

  XlaBuilder* builder = a.builder();
  auto return_error = [&](const Status& status) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSsvdDTcc mht_1(mht_1_v, 998, "", "./tensorflow/compiler/xla/client/lib/svd.cc", "lambda");
