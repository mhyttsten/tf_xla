...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh() {
      // Check if tracing is enabled
...
class TensorFormat {
 public:
  TensorFormat(int batch_dimension, int feature_dimension,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/client/lib/pooling.h", "TensorFormat");
}

  int batch_dimension() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh mht_1(mht_1_v, 206, "", "./tensorflow/compiler/xla/client/lib/pooling.h", "batch_dimension");
 return batch_dimension_; }

  int feature_dimension() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh mht_2(mht_2_v, 211, "", "./tensorflow/compiler/xla/client/lib/pooling.h", "feature_dimension");
 return feature_dimension_; }

  int spatial_dimension(int dim) const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh mht_3(mht_3_v, 216, "", "./tensorflow/compiler/xla/client/lib/pooling.h", "spatial_dimension");
 return spatial_dimensions_[dim]; }

  int num_spatial_dims() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTh mht_4(mht_4_v, 221, "", "./tensorflow/compiler/xla/client/lib/pooling.h", "num_spatial_dims");
