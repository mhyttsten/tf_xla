...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlu_decompositionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlu_decompositionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlu_decompositionDTcc() {
      // Check if tracing is enabled
...
LuDecompositionResult LuDecomposition(XlaOp a) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSlu_decompositionDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/xla/client/lib/lu_decomposition.cc", "LuDecomposition");
