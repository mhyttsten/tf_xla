...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc() {
      // Check if tracing is enabled
...
class ArithmeticTest : public ClientLibraryTestBase {
 public:
  ...
  void TestArgMin(std::initializer_list<std::initializer_list<NativeT>> input,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/client/lib/arithmetic_test.cc", "TestArgMin");
  ...
  void TestArgMax(std::initializer_list<std::initializer_list<NativeT>> input,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/client/lib/arithmetic_test.cc", "TestArgMax");
 ...
 private:
  ...
  void TestArgMinMax(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc mht_2(mht_2_v, 226, "", "./tensorflow/compiler/xla/client/lib/arithmetic_test.cc", "TestArgMinMax");
  ...
  void TestArgMinMaxImpl(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSarithmetic_testDTcc mht_3(mht_3_v, 241, "", "./tensorflow/compiler/xla/client/lib/arithmetic_test.cc", "TestArgMinMaxImpl");
}
};
