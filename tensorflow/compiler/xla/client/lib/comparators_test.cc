...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPScomparators_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPScomparators_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPScomparators_testDTcc() {
      // Check if tracing is enabled
...
class ComparatorsTest : public ClientLibraryTestBase {
 public:
  ComparatorsTest() : builder_(TestName()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPScomparators_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/client/lib/comparators_test.cc", "ComparatorsTest");
}
  XlaBuilder* builder() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPScomparators_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/client/lib/comparators_test.cc", "builder");
 return &builder_; }
...
void BuildComparatorAndComparisons(ComparatorsTest* test,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPScomparators_testDTcc mht_2(mht_2_v, 224, "", "./tensorflow/compiler/xla/client/lib/comparators_test.cc", "BuildComparatorAndComparisons");
