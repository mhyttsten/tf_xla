...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc() {
      // Check if tracing is enabled
...
XlaOp AvgPoolDivideByCountWithGeneralPadding(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "AvgPoolDivideByCountWithGeneralPadding");
...
XlaOp ComputeSums(XlaOp operand, XlaOp init_value,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_1(mht_1_v, 248, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "ComputeSums");
...
PaddingConfig MakeSpatialPaddingConfig(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_2(mht_2_v, 267, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "MakeSpatialPaddingConfig");
...
XlaOp AvgPoolDivideByCount(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_3(mht_3_v, 292, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "AvgPoolDivideByCount");
...
XlaOp MaxPool(XlaOp operand, absl::Span<const int64_t> kernel_size,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_4(mht_4_v, 317, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "MaxPool");
...
XlaOp AvgPool(XlaOp operand, absl::Span<const int64_t> kernel_size,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_5(mht_5_v, 336, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "AvgPool");
...
XlaOp AvgPoolGrad(XlaOp out_backprop, absl::Span<const int64_t> gradients_size,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSpoolingDTcc mht_6(mht_6_v, 385, "", "./tensorflow/compiler/xla/client/lib/pooling.cc", "AvgPoolGrad");
