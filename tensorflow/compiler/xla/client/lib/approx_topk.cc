...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc() {
      // Check if tracing is enabled
...
XlaComputation BuildReductionComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc mht_0(mht_0_v, 241, "", "./tensorflow/compiler/xla/client/lib/approx_topk.cc", "BuildReductionComputation");
...
XlaOp AggregateToTopKBuilder(XlaBuilder* builder,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc mht_1(mht_1_v, 285, "", "./tensorflow/compiler/xla/client/lib/approx_topk.cc", "AggregateToTopKBuilder");
...
XlaOp ApproxTopK(XlaBuilder* builder, absl::Span<const XlaOp> operands,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc mht_2(mht_2_v, 336, "", "./tensorflow/compiler/xla/client/lib/approx_topk.cc", "ApproxTopK");
...
XlaOp ApproxTopKFallback(XlaBuilder* builder, absl::Span<const XlaOp> operands,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topkDTcc mht_3(mht_3_v, 435, "", "./tensorflow/compiler/xla/client/lib/approx_topk.cc", "ApproxTopKFallback");
