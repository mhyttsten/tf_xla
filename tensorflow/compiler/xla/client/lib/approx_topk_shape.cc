...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topk_shapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topk_shapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topk_shapeDTcc() {
      // Check if tracing is enabled
...
inline uint32_t log2_floor(uint64_t value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topk_shapeDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/client/lib/approx_topk_shape.cc", "log2_floor");
...
inline uint32_t log2_ceil(uint64_t value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSlibPSapprox_topk_shapeDTcc mht_1(mht_1_v, 205, "", "./tensorflow/compiler/xla/client/lib/approx_topk_shape.cc", "log2_ceil");
