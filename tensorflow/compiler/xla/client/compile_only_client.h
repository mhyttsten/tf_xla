...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTh() {
      // Check if tracing is enabled
...
class CompileOnlyClient : public Client {
 public:
  explicit CompileOnlyClient(CompileOnlyService* service)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/client/compile_only_client.h", "CompileOnlyClient");
}
