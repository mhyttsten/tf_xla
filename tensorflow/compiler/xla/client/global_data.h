...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSglobal_dataDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSglobal_dataDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSglobal_dataDTh() {
      // Check if tracing is enabled
...
class GlobalData {
 public:
  ...
  const GlobalDataHandle& handle() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSglobal_dataDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/client/global_data.h", "handle");
 return handle_; }
 ...
 private:
  ...
  GlobalDataHandle Release() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSglobal_dataDTh mht_1(mht_1_v, 221, "", "./tensorflow/compiler/xla/client/global_data.h", "Release");
