...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc() {
      // Check if tracing is enabled
...
class XlaBuilderTest : public ::testing::Test {
 protected:
  ...
  std::string TestName() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc mht_0(mht_0_v, 237, "", "./tensorflow/compiler/xla/client/xla_builder_test.cc", "TestName");
...
TEST_F(XlaBuilderTest, UnaryOperatorsBuildExpectedHLO) {
  auto test_unary_operator =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc mht_1(mht_1_v, 256, "", "./tensorflow/compiler/xla/client/xla_builder_test.cc", "lambda");
...
TEST_F(XlaBuilderTest, BinaryOperatorsBuildExpectedHLO) {
  auto test_binary_operator =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc mht_2(mht_2_v, 273, "", "./tensorflow/compiler/xla/client/xla_builder_test.cc", "lambda");
  ...
  auto test_unsigned_binary_operator =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc mht_3(mht_3_v, 307, "", "./tensorflow/compiler/xla/client/xla_builder_test.cc", "lambda");
...
void ExpectAttributesMatch(const FrontendAttributes& attr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc mht_4(mht_4_v, 1397, "", "./tensorflow/compiler/xla/client/xla_builder_test.cc", "ExpectAttributesMatch");
...
void ExpectInstructionsAttributesMatch(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPSxla_builder_testDTcc mht_5(mht_5_v, 1410, "", "./tensorflow/compiler/xla/client/xla_builder_test.cc", "ExpectInstructionsAttributesMatch");
