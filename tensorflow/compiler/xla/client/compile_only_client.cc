...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTcc() {
      // Check if tracing is enabled
...
CompileOnlyClient::CreateModuleConfig(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/client/compile_only_client.cc", "CompileOnlyClient::CreateModuleConfig");
...
CompileOnlyClient::CompileAheadOfTime(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/client/compile_only_client.cc", "CompileOnlyClient::CompileAheadOfTime");
...
int64_t CompileOnlyClient::PointerSizeForTriple(absl::string_view triple) {
   ...
   mht_2_v.push_back("triple: \"" + std::string(triple.data(), triple.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSclientPScompile_only_clientDTcc mht_2(mht_2_v, 230, "", "./tensorflow/compiler/xla/client/compile_only_client.cc", "CompileOnlyClient::PointerSizeForTriple");
