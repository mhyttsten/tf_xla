...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_liveness_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_liveness_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_liveness_analysis_testDTcc() {
      // Check if tracing is enabled
...
class HloLivenessAnalysisTest : public HloTestBase {
 protected:
  HloLivenessAnalysisTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_liveness_analysis_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/hlo_liveness_analysis_test.cc", "HloLivenessAnalysisTest");
}
  ...
  const HloLivenessAnalysis& RunLiveness(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_liveness_analysis_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/service/hlo_liveness_analysis_test.cc", "RunLiveness");
  ...
  HloInstruction* GetInstruction(HloModule* module, const std::string& name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_liveness_analysis_testDTcc mht_2(mht_2_v, 219, "", "./tensorflow/compiler/xla/service/hlo_liveness_analysis_test.cc", "GetInstruction");
