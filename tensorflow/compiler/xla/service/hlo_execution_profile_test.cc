...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_execution_profile_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_execution_profile_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_execution_profile_testDTcc() {
      // Check if tracing is enabled
...
TEST_F(HloExecutionProfileTest, Basic) {
  ...
  auto shape_size_function = [&](const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_execution_profile_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/xla/service/hlo_execution_profile_test.cc", "lambda");
