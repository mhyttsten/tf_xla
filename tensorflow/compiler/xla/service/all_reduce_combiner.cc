...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combinerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combinerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combinerDTcc() {
      // Check if tracing is enabled
...
Status CombineAllReduces(absl::Span<HloInstruction* const> to_combine) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combinerDTcc mht_0(mht_0_v, 219, "", "./tensorflow/compiler/xla/service/all_reduce_combiner.cc", "CombineAllReduces");
...
AllReduceCombiner::AllReduceCombiner(int64_t combine_threshold_in_bytes,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combinerDTcc mht_1(mht_1_v, 284, "", "./tensorflow/compiler/xla/service/all_reduce_combiner.cc", "AllReduceCombiner::AllReduceCombiner");
}

StatusOr<bool> AllReduceCombiner::Run(HloModule* module) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combinerDTcc mht_2(mht_2_v, 289, "", "./tensorflow/compiler/xla/service/all_reduce_combiner.cc", "AllReduceCombiner::Run");
