...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_index_splitterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_index_splitterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_index_splitterDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> DynamicIndexSplitter::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_index_splitterDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/dynamic_index_splitter.cc", "DynamicIndexSplitter::Run");
