...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPSplatformDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPSplatformDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPSplatformDTh() {
      // Check if tracing is enabled
...
class XlaInterpreterPlatform : public Platform {
 public:
  XlaInterpreterPlatform()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPSplatformDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/interpreter/platform.h", "XlaInterpreterPlatform");
}
