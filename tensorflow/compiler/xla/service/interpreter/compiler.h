...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPScompilerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPScompilerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPScompilerDTh() {
      // Check if tracing is enabled
...
class InterpreterCompiler : public Compiler {
 public:
  InterpreterCompiler() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPScompilerDTh mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/interpreter/compiler.h", "InterpreterCompiler");
}
  ~InterpreterCompiler() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSinterpreterPScompilerDTh mht_1(mht_1_v, 215, "", "./tensorflow/compiler/xla/service/interpreter/compiler.h", "~InterpreterCompiler");
}
