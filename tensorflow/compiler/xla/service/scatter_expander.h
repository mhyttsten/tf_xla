...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSscatter_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSscatter_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSscatter_expanderDTh() {
      // Check if tracing is enabled
...
class ScatterExpander : public OpExpanderPass {
 public:
  ...
  explicit ScatterExpander(Mode m) : mode_(m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSscatter_expanderDTh mht_0(mht_0_v, 214, "", "./tensorflow/compiler/xla/service/scatter_expander.h", "ScatterExpander");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSscatter_expanderDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/scatter_expander.h", "name");
 return "scatter_expander"; }
