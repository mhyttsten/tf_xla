...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc() {
      // Check if tracing is enabled
...
void ClearMetadata(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "ClearMetadata");
...
struct MetadataTestParameter {
  explicit MetadataTestParameter(bool propagate_metadata, bool clear_metadata)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_1(mht_1_v, 224, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "MetadataTestParameter");
}
...
struct MetadataTestParameterWithOutput {
  explicit MetadataTestParameterWithOutput(bool propagate_metadata,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_2(mht_2_v, 239, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "MetadataTestParameterWithOutput");
}
...
std::string OpMetadataListToString(absl::Span<const OpMetadata> metadata) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_3(mht_3_v, 257, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "OpMetadataListToString");
...
class HloShardingMetadataMatcher
 ...
 public:
  explicit HloShardingMetadataMatcher(absl::Span<const OpMetadata> metadata)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_4(mht_4_v, 274, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "HloShardingMetadataMatcher");
}
  ...
  bool MatchAndExplain(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_5(mht_5_v, 281, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "MatchAndExplain");
  ...
  void DescribeTo(std::ostream* os) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_6(mht_6_v, 305, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "DescribeTo");
...
OpMetadata CreateMetadata(const std::string& op_name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_7(mht_7_v, 322, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "CreateMetadata");
...
ENTRY %entry {
  ...
  auto while_is_sharded =
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_8(mht_8_v, 2064, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "lambda");
...
ENTRY entry {
  ...
  auto check_metadata = [](const HloSharding& sharding,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_9(mht_9_v, 3164, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "lambda");
  ...
  auto check_empty_metadata = [](const HloSharding& sharding) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagation_testDTcc mht_10(mht_10_v, 3175, "", "./tensorflow/compiler/xla/service/sharding_propagation_test.cc", "lambda");
