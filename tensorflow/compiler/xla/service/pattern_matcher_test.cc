...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc() {
      // Check if tracing is enabled
...
std::string Description(const Pattern& pattern) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc mht_0(mht_0_v, 723, "", "./tensorflow/compiler/xla/service/pattern_matcher_test.cc", "Description");
...
std::string Explanation(Elem* elem, const Pattern& pattern) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc mht_1(mht_1_v, 733, "", "./tensorflow/compiler/xla/service/pattern_matcher_test.cc", "Explanation");
...
std::string Explanation(const std::unique_ptr<Elem>& elem,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc mht_2(mht_2_v, 744, "", "./tensorflow/compiler/xla/service/pattern_matcher_test.cc", "Explanation");
...
std::string Explanation(const Elem& elem, const Pattern& pattern) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_testDTcc mht_3(mht_3_v, 751, "", "./tensorflow/compiler/xla/service/pattern_matcher_test.cc", "Explanation");
