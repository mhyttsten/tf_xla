...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSalias_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSalias_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSalias_analysis_testDTcc() {
      // Check if tracing is enabled
...
void FakeCustomCallTarget(float* out, float** in, XlaCustomCallStatus*) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSalias_analysis_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/llvm_ir/alias_analysis_test.cc", "FakeCustomCallTarget");
}
