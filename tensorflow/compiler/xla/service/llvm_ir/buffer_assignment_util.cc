...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc() {
      // Check if tracing is enabled
...
static const HloInstruction& InstrForConstantBufferAllocation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "InstrForConstantBufferAllocation");
...
std::string SanitizeConstantName(const HloInstruction& instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "SanitizeConstantName");
...
std::string SanitizeConstantName(absl::string_view name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_2(mht_2_v, 228, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "SanitizeConstantName");
...
std::string ConstantHloToGlobalName(const HloInstruction& instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_3(mht_3_v, 241, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "ConstantHloToGlobalName");
...
std::string ConstantNameToGlobalName(absl::string_view name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_4(mht_4_v, 249, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "ConstantNameToGlobalName");
...
std::string ConstantBufferAllocationToGlobalName(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_5(mht_5_v, 260, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "ConstantBufferAllocationToGlobalName");
...
const Literal& LiteralForConstantAllocation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPSbuffer_assignment_utilDTcc mht_6(mht_6_v, 269, "", "./tensorflow/compiler/xla/service/llvm_ir/buffer_assignment_util.cc", "LiteralForConstantAllocation");
