...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc() {
      // Check if tracing is enabled
...
static llvm::Module* getModuleFromBuilder(llvm::IRBuilder<>* b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/llvm_ir/tuple_ops.cc", "getModuleFromBuilder");
...
void EmitTupleSelect(const IrArray& select, const IrArray& pred,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xla/service/llvm_ir/tuple_ops.cc", "EmitTupleSelect");
...
void EmitTuple(const IrArray& tuple, absl::Span<llvm::Value* const> operands,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc mht_2(mht_2_v, 238, "", "./tensorflow/compiler/xla/service/llvm_ir/tuple_ops.cc", "EmitTuple");
...
void EmitTuple(const IrArray& tuple, absl::Span<const IrArray> buffers,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc mht_3(mht_3_v, 255, "", "./tensorflow/compiler/xla/service/llvm_ir/tuple_ops.cc", "EmitTuple");
...
llvm::Value* EmitGetTupleElement(const Shape& target_shape, int64_t index,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_irPStuple_opsDTcc mht_4(mht_4_v, 295, "", "./tensorflow/compiler/xla/service/llvm_ir/tuple_ops.cc", "EmitGetTupleElement");
