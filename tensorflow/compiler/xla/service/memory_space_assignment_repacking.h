...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_repackingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_repackingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_repackingDTh() {
      // Check if tracing is enabled
...
class MemorySpaceAssignmentRepacker {
 public:
  MemorySpaceAssignmentRepacker(int64_t max_size, int64_t alignment)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_repackingDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/service/memory_space_assignment_repacking.h", "MemorySpaceAssignmentRepacker");
}
  ...
  struct AllocationBlock {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_repackingDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/memory_space_assignment_repacking.h", "ToString");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_repackingDTh mht_2(mht_2_v, 230, "", "./tensorflow/compiler/xla/service/memory_space_assignment_repacking.h", "operator<");
 return id < other.id; }
  };
