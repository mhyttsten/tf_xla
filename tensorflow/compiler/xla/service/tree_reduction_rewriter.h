...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStree_reduction_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStree_reduction_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStree_reduction_rewriterDTh() {
      // Check if tracing is enabled
...
class TreeReductionRewriter : public HloModulePass {
 public:
  explicit TreeReductionRewriter(int64_t reduce_window_size = 32)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStree_reduction_rewriterDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/tree_reduction_rewriter.h", "TreeReductionRewriter");
}
  ~TreeReductionRewriter() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStree_reduction_rewriterDTh mht_1(mht_1_v, 220, "", "./tensorflow/compiler/xla/service/tree_reduction_rewriter.h", "name");
 return "tree_reduction_rewriter"; }
