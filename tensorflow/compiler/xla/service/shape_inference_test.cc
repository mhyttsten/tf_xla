...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc() {
      // Check if tracing is enabled
...
class ReduceShapeInferenceTest : public ShapeInferenceTest {
 protected:
  ...
  void ExpectInferredReduceShape(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc mht_0(mht_0_v, 234, "", "./tensorflow/compiler/xla/service/shape_inference_test.cc", "ExpectInferredReduceShape");
...
class SelectAndScatterShapeInferenceTest : public ShapeInferenceTest {
 protected:
  SelectAndScatterShapeInferenceTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc mht_1(mht_1_v, 250, "", "./tensorflow/compiler/xla/service/shape_inference_test.cc", "SelectAndScatterShapeInferenceTest");
...
TEST_F(ShapeInferenceTest, Complex) {
  auto complex_shape = [&](const Shape& lhs, const Shape& rhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc mht_2(mht_2_v, 442, "", "./tensorflow/compiler/xla/service/shape_inference_test.cc", "lambda");
...
ConvolveArgs MakeConvolveArgs(PrimitiveType lhs_type, PrimitiveType rhs_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc mht_3(mht_3_v, 823, "", "./tensorflow/compiler/xla/service/shape_inference_test.cc", "MakeConvolveArgs");
...
static void Pass(const Shape& shape, FftType type,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc mht_4(mht_4_v, 1014, "", "./tensorflow/compiler/xla/service/shape_inference_test.cc", "Pass");
...
static void Fail(const Shape& shape, FftType type,
   ...
   mht_5_v.push_back("message: \"" + std::string(message.data(), message.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSshape_inference_testDTcc mht_5(mht_5_v, 1026, "", "./tensorflow/compiler/xla/service/shape_inference_test.cc", "Fail");
