...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScomparison_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScomparison_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScomparison_expanderDTh() {
      // Check if tracing is enabled
...
class ComparisonExpander : public OpExpanderPass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScomparison_expanderDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/comparison_expander.h", "name");
 return "comparison-expander"; }
