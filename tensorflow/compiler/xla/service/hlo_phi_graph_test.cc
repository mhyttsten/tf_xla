...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_phi_graph_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_phi_graph_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_phi_graph_testDTcc() {
      // Check if tracing is enabled
...
class PhiGraphTest : public ::testing::Test {
 protected:
  HloValue NewHloValue(bool is_phi) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_phi_graph_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/xla/service/hlo_phi_graph_test.cc", "NewHloValue");
  ...
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_phi_graph_testDTcc mht_1(mht_1_v, 202, "", "./tensorflow/compiler/xla/service/hlo_phi_graph_test.cc", "SetUp");
