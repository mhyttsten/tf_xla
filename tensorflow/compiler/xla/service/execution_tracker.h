...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSexecution_trackerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSexecution_trackerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSexecution_trackerDTh() {
      // Check if tracing is enabled
...
class AsyncExecution {
 public:
  ...
  const GlobalDataHandle& result() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSexecution_trackerDTh mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/execution_tracker.h", "result");
 return result_; }

  const ExecutionProfile& profile() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSexecution_trackerDTh mht_1(mht_1_v, 218, "", "./tensorflow/compiler/xla/service/execution_tracker.h", "profile");
 return profile_; }
