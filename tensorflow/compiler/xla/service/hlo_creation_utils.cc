...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc() {
      // Check if tracing is enabled
...
HloInstruction* MakeBroadcastHlo(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_0(mht_0_v, 375, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "MakeBroadcastHlo");
...
HloInstruction* MakeBroadcastHlo(HloInstruction* operand,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_1(mht_1_v, 389, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "MakeBroadcastHlo");
...
HloInstruction* MakeConvertToHlo(HloInstruction* hlo, PrimitiveType type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_2(mht_2_v, 426, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "MakeConvertToHlo");
...
HloInstruction* MakeBitcastConvertToHlo(HloInstruction* hlo,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_3(mht_3_v, 441, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "MakeBitcastConvertToHlo");
...
HloInstruction* MakeIotaHlo(HloComputation* computation, const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_4(mht_4_v, 461, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "MakeIotaHlo");
...
HloInstruction* BroadcastZeros(HloComputation* computation,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_5(mht_5_v, 744, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "BroadcastZeros");
...
HloInstruction* BroadcastOnes(HloComputation* computation,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_6(mht_6_v, 756, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "BroadcastOnes");
...
HloInstruction* CreateDummyOp(HloComputation::Builder* b, const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_creation_utilsDTcc mht_7(mht_7_v, 777, "", "./tensorflow/compiler/xla/service/hlo_creation_utils.cc", "CreateDummyOp");
