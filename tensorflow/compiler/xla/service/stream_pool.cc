...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTcc() {
      // Check if tracing is enabled
...
StreamPool::Ptr StreamPool::BorrowStream(se::StreamExecutor* executor) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTcc mht_0(mht_0_v, 192, "", "./tensorflow/compiler/xla/service/stream_pool.cc", "StreamPool::BorrowStream");
...
void StreamPool::ReturnStream(se::Stream* stream) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTcc mht_1(mht_1_v, 227, "", "./tensorflow/compiler/xla/service/stream_pool.cc", "StreamPool::ReturnStream");
