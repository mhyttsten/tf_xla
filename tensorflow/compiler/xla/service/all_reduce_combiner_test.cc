...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combiner_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combiner_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combiner_testDTcc() {
      // Check if tracing is enabled
...
int64_t AllReduceCount(const HloModule& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combiner_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/all_reduce_combiner_test.cc", "AllReduceCount");
...
HloInstruction* MakeCrossReplicaReductions(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combiner_testDTcc mht_1(mht_1_v, 235, "", "./tensorflow/compiler/xla/service/all_reduce_combiner_test.cc", "MakeCrossReplicaReductions");
...
HloComputation* MakeReduction(const HloOpcode type, HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_combiner_testDTcc mht_2(mht_2_v, 260, "", "./tensorflow/compiler/xla/service/all_reduce_combiner_test.cc", "MakeReduction");
