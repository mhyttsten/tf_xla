...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSrng_bit_generator_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSrng_bit_generator_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSrng_bit_generator_expanderDTh() {
      // Check if tracing is enabled
...
class RngBitGeneratorExpander : public OpExpanderPass {
 public:
  explicit RngBitGeneratorExpander(RandomAlgorithm default_algorithm)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSrng_bit_generator_expanderDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/rng_bit_generator_expander.h", "RngBitGeneratorExpander");
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSrng_bit_generator_expanderDTh mht_1(mht_1_v, 208, "", "./tensorflow/compiler/xla/service/rng_bit_generator_expander.h", "name");
 ...
 protected:
  struct RngGeneratorKey {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSrng_bit_generator_expanderDTh mht_2(mht_2_v, 223, "", "./tensorflow/compiler/xla/service/rng_bit_generator_expander.h", "AbslHashValue");
