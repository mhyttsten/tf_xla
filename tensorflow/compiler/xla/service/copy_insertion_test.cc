...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc() {
      // Check if tracing is enabled
...
int64_t CountCopies(const HloComputation& computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "CountCopies");
...
int64_t CountCopies(const HloModule& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_1(mht_1_v, 224, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "CountCopies");
...
int64_t CountControlEdges(const HloComputation& computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_2(mht_2_v, 235, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "CountControlEdges");
...
int64_t CountControlEdges(const HloModule& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_3(mht_3_v, 246, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "CountControlEdges");
...
class CopyInsertionTest : public HloTestBase {
 protected:
  void InsertCopies(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_4(mht_4_v, 259, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "InsertCopies");
...
class WhileCopyInsertionTest : public CopyInsertionTest {
 protected:
  WhileCopyInsertionTest() : module_(CreateNewVerifiedModule()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_5(mht_5_v, 590, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "WhileCopyInsertionTest");
}
  ...
  HloInstruction* BuildWhileInstruction(HloComputation* condition,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_6(mht_6_v, 829, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstruction");
  ...
  HloInstruction* BuildWhileInstruction_InitPointsToConstant() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_7(mht_7_v, 860, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstruction_InitPointsToConstant");
  ...
  HloInstruction* BuildWhileInstruction_InitPointsToParameter() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_8(mht_8_v, 872, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstruction_InitPointsToParameter");
  ...
  HloInstruction* BuildWhileInstruction_InitPointsToAmbiguous() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_9(mht_9_v, 883, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstruction_InitPointsToAmbiguous");
  ...
  HloInstruction* BuildWhileInstruction_InitPointsToNonDistinct() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_10(mht_10_v, 910, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstruction_InitPointsToNonDistinct");
  ...
  HloInstruction* BuildWhileInstruction_InitPointsToInterfering() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_11(mht_11_v, 927, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstruction_InitPointsToInterfering");
  ...
  HloInstruction* BuildWhileInstructionWithCustomInit(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_12(mht_12_v, 966, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BuildWhileInstructionWithCustomInit");
...
void BM_SequentialWhiles(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_13(mht_13_v, 2311, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BM_SequentialWhiles");
...
void BM_ParallelWhiles(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_14(mht_14_v, 2359, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BM_ParallelWhiles");
...
void BM_ManyElementTuple(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScopy_insertion_testDTcc mht_15(mht_15_v, 2433, "", "./tensorflow/compiler/xla/service/copy_insertion_test.cc", "BM_ManyElementTuple");
