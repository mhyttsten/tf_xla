...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgeneric_transfer_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgeneric_transfer_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgeneric_transfer_managerDTh() {
      // Check if tracing is enabled
...
class GenericTransferManager : public TransferManager {
 public:
  ...
  ~GenericTransferManager() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgeneric_transfer_managerDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/generic_transfer_manager.h", "~GenericTransferManager");
}
