...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_combinerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_combinerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_combinerDTh() {
      // Check if tracing is enabled
...
class AllGatherCombiner : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_combinerDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/all_gather_combiner.h", "name");
 return "all-gather-combiner"; }
