...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> AllReduceSimplifier::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/service/all_reduce_simplifier.cc", "AllReduceSimplifier::Run");
