...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc() {
      // Check if tracing is enabled
...
MovableAllReduceContext IsAllReduceMovable(HloInstruction* all_reduce,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc mht_0(mht_0_v, 237, "", "./tensorflow/compiler/xla/service/while_loop_all_reduce_code_motion.cc", "IsAllReduceMovable");
...
WhileInitContext CreateNewWhileInit(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc mht_1(mht_1_v, 531, "", "./tensorflow/compiler/xla/service/while_loop_all_reduce_code_motion.cc", "CreateNewWhileInit");
...
HloInstruction* CreateNewWhileResult(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc mht_2(mht_2_v, 637, "", "./tensorflow/compiler/xla/service/while_loop_all_reduce_code_motion.cc", "CreateNewWhileResult");
...
Status AddSinkedAllReducesAndReplaceWhile(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc mht_3(mht_3_v, 668, "", "./tensorflow/compiler/xla/service/while_loop_all_reduce_code_motion.cc", "AddSinkedAllReducesAndReplaceWhile");
...
StatusOr<bool> WhileLoopAllReduceCodeMotion::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_all_reduce_code_motionDTcc mht_4(mht_4_v, 701, "", "./tensorflow/compiler/xla/service/while_loop_all_reduce_code_motion.cc", "WhileLoopAllReduceCodeMotion::Run");
