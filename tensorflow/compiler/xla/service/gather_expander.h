...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgather_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgather_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgather_expanderDTh() {
      // Check if tracing is enabled
...
class GatherExpander : public OpExpanderPass {
 public:
  ...
  explicit GatherExpander(Mode m) : mode_(m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgather_expanderDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/gather_expander.h", "GatherExpander");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgather_expanderDTh mht_1(mht_1_v, 220, "", "./tensorflow/compiler/xla/service/gather_expander.h", "name");
