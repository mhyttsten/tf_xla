...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_broadcast_reorder_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_broadcast_reorder_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_broadcast_reorder_testDTcc() {
      // Check if tracing is enabled
...
class AllGatherBroadcastReorderTest : public HloTestBase {
 public:
  ...
  void RunPass(absl::string_view hlo_module, PassOutput expected_output) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_broadcast_reorder_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/all_gather_broadcast_reorder_test.cc", "RunPass");
