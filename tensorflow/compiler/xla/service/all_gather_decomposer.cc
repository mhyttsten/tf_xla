...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_decomposerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_decomposerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_decomposerDTcc() {
      // Check if tracing is enabled
...
HloComputation* MakeBinaryAdd(PrimitiveType type, HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_decomposerDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/all_gather_decomposer.cc", "MakeBinaryAdd");
...
Status DecomposeAllGather(HloAllGatherInstruction* ag, HloComputation* comp) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_decomposerDTcc mht_1(mht_1_v, 227, "", "./tensorflow/compiler/xla/service/all_gather_decomposer.cc", "DecomposeAllGather");
...
StatusOr<bool> AllGatherDecomposer::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_gather_decomposerDTcc mht_2(mht_2_v, 258, "", "./tensorflow/compiler/xla/service/all_gather_decomposer.cc", "AllGatherDecomposer::Run");
