...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_value_containersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_value_containersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_value_containersDTh() {
      // Check if tracing is enabled
...
BufferValueCompactPointerSet ToBufferValueCompactPointerSet(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_value_containersDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/buffer_value_containers.h", "ToBufferValueCompactPointerSet");
...
BufferValueFlatSet ToBufferValueFlatSet(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_value_containersDTh mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/service/buffer_value_containers.h", "ToBufferValueFlatSet");
