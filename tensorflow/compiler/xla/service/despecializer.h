...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdespecializerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdespecializerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdespecializerDTh() {
      // Check if tracing is enabled
...
class Despecializer : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdespecializerDTh mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/service/despecializer.h", "name");
...
class ControlDepRemover : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdespecializerDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/despecializer.h", "name");
