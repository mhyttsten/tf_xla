...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_isolatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_isolatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_isolatorDTh() {
      // Check if tracing is enabled
...
class HloDomainIsolator : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_isolatorDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/hlo_domain_isolator.h", "name");
 return "domain_isolator"; }
