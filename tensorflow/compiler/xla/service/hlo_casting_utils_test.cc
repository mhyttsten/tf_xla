...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_casting_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_casting_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_casting_utils_testDTcc() {
      // Check if tracing is enabled
...
class DummyInstruction : public HloInstruction {
 public:
  DummyInstruction()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_casting_utils_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/xla/service/hlo_casting_utils_test.cc", "DummyInstruction");
}
};
...
class AnotherDummyInstruction : public HloInstruction {
 public:
  AnotherDummyInstruction()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_casting_utils_testDTcc mht_1(mht_1_v, 205, "", "./tensorflow/compiler/xla/service/hlo_casting_utils_test.cc", "AnotherDummyInstruction");
}
};
