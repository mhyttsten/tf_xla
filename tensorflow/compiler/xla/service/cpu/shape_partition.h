...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSshape_partitionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSshape_partitionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSshape_partitionDTh() {
      // Check if tracing is enabled
...
class ShapePartitionAssigner {
 public:
  ShapePartitionAssigner(const Shape& shape) : shape_(shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSshape_partitionDTh mht_0(mht_0_v, 236, "", "./tensorflow/compiler/xla/service/cpu/shape_partition.h", "ShapePartitionAssigner");
}
