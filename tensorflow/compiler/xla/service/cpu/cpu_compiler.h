...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh() {
      // Check if tracing is enabled
...
class CpuAotCompilationOptions : public AotCompilationOptions {
 public:
  ...
  const std::string& triple() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_0(mht_0_v, 231, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "triple");
 return triple_; }
  // The CPU name used for compilation, similar to clang's -mcpu flag.
  const std::string& cpu_name() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_1(mht_1_v, 236, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "cpu_name");
 return cpu_name_; }
  // The target features used for compilation ("+avx2", "+neon", etc).
  const std::string& features() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_2(mht_2_v, 241, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "features");
 return features_; }
  // The name to be used for the compiled code's entry point.
  const std::string& entry_point_name() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_3(mht_3_v, 246, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "entry_point_name");
 return entry_point_name_; }
  // The relocation model used for compilation.
  RelocationModel relocation_model() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_4(mht_4_v, 251, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "relocation_model");
 return relocation_model_; }

  bool use_mlir_hlo_lowering() const {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_5(mht_5_v, 256, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "use_mlir_hlo_lowering");
 return use_mlir_hlo_lowering_; }
  void set_use_mlir_hlo_lowering(bool value) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_6(mht_6_v, 260, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "set_use_mlir_hlo_lowering");
 use_mlir_hlo_lowering_ = value; }
...
class CpuAotCompilationResult : public AotCompilationResult {
 public:
  ...
  HloProfilePrinterData* hlo_profile_printer_data() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_7(mht_7_v, 283, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "hlo_profile_printer_data");
  ...
  const ObjectFileData& object_file_data() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_8(mht_8_v, 290, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "object_file_data");
 return object_file_data_; }
  const std::vector<cpu_function_runtime::BufferInfo>& buffer_infos() const {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_9(mht_9_v, 294, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "buffer_infos");

    return buffer_infos_;
  }
  int64_t result_buffer_index() const {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_10(mht_10_v, 300, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "result_buffer_index");
...
class CpuCompiler : public LLVMCompiler {
 public:
  ...
  ~CpuCompiler() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_compilerDTh mht_11(mht_11_v, 331, "", "./tensorflow/compiler/xla/service/cpu/cpu_compiler.h", "~CpuCompiler");
}
