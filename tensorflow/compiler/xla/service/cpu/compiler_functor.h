...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScompiler_functorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScompiler_functorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScompiler_functorDTh() {
      // Check if tracing is enabled
...
class CompilerFunctor : public llvm::orc::IRCompileLayer::IRCompiler {
 public:
  explicit CompilerFunctor(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScompiler_functorDTh mht_0(mht_0_v, 220, "", "./tensorflow/compiler/xla/service/cpu/compiler_functor.h", "CompilerFunctor");
}
