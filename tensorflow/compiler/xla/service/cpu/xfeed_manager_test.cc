...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc() {
      // Check if tracing is enabled
...
class TestInfeedBuffer : public cpu::runtime::XfeedBuffer {
 public:
  explicit TestInfeedBuffer(int32_t length, bool expect_shape_match = true)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "TestInfeedBuffer");
}
  ~TestInfeedBuffer() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "~TestInfeedBuffer");
 EXPECT_TRUE(done_called_); }

  int32_t length() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_2(mht_2_v, 217, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "length");
 return length_; }
  void* data() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_3(mht_3_v, 221, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "data");
 return nullptr; }
  void Done(StatusOr<Shape> shape) override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_4(mht_4_v, 225, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "Done");
  ...
  const Shape& shape() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_5(mht_5_v, 238, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "shape");
 return shape_; }
...
void ProcessNextBuffer(int32_t length) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_6(mht_6_v, 252, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "ProcessNextBuffer");
...
void ProcessNextOutfeedBuffer(int32_t length, const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_manager_testDTcc mht_7(mht_7_v, 266, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager_test.cc", "ProcessNextOutfeedBuffer");
