...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emission_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emission_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emission_utilsDTcc() {
      // Check if tracing is enabled
...
int64_t GetMinimumAlignmentForArray(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emission_utilsDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/service/cpu/ir_emission_utils.cc", "GetMinimumAlignmentForArray");
...
bool PotentiallyImplementedAsEigenConvolution(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emission_utilsDTcc mht_1(mht_1_v, 217, "", "./tensorflow/compiler/xla/service/cpu/ir_emission_utils.cc", "PotentiallyImplementedAsEigenConvolution");
  ...
  auto is_aligned = [&](const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emission_utilsDTcc mht_2(mht_2_v, 232, "", "./tensorflow/compiler/xla/service/cpu/ir_emission_utils.cc", "lambda");
