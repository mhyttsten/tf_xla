...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_managerDTh() {
      // Check if tracing is enabled
...
class XfeedQueueManager {
 public:
  XfeedQueueManager(std::string queue_name) : queue_name_(queue_name) {
   ...
   mht_0_v.push_back("queue_name: \"" + queue_name + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_managerDTh mht_0(mht_0_v, 223, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager.h", "XfeedQueueManager");
}
...
class XfeedManager {
 public:
  ...
  XfeedQueueManager* infeed() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_managerDTh mht_1(mht_1_v, 285, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager.h", "infeed");
 return &infeed_; }
  XfeedQueueManager* outfeed() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSxfeed_managerDTh mht_2(mht_2_v, 289, "", "./tensorflow/compiler/xla/service/cpu/xfeed_manager.h", "outfeed");
 return &outfeed_; }
