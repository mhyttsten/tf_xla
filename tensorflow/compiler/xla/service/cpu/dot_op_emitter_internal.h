...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSdot_op_emitter_internalDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSdot_op_emitter_internalDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSdot_op_emitter_internalDTh() {
      // Check if tracing is enabled
...
struct DotInfo {
  ...
  explicit DotInfo(const HloInstruction& instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSdot_op_emitter_internalDTh mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/cpu/dot_op_emitter_internal.h", "DotInfo");
