...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc() {
      // Check if tracing is enabled
...
bool Is16BytesAligned(void* ptr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "Is16BytesAligned");
...
void MatMul(const void* run_options_ptr, T* out, T* lhs, T* rhs, int64_t m,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_1(mht_1_v, 206, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "MatMul");
...
void SingleThreadedMatMulDispatch(const void* run_options_ptr, T* out, T* lhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_2(mht_2_v, 244, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "SingleThreadedMatMulDispatch");
...
__xla_cpu_runtime_EigenSingleThreadedMatMulF16(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_3(mht_3_v, 266, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "__xla_cpu_runtime_EigenSingleThreadedMatMulF16");
...
__xla_cpu_runtime_EigenSingleThreadedMatMulF32(const void* run_options_ptr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_4(mht_4_v, 279, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "__xla_cpu_runtime_EigenSingleThreadedMatMulF32");
...
__xla_cpu_runtime_EigenSingleThreadedMatMulF64(const void* run_options_ptr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_5(mht_5_v, 293, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "__xla_cpu_runtime_EigenSingleThreadedMatMulF64");
...
__xla_cpu_runtime_EigenSingleThreadedMatMulC64(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_6(mht_6_v, 305, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "__xla_cpu_runtime_EigenSingleThreadedMatMulC64");
...
__xla_cpu_runtime_EigenSingleThreadedMatMulC128(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_7(mht_7_v, 317, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "__xla_cpu_runtime_EigenSingleThreadedMatMulC128");
...
__xla_cpu_runtime_EigenSingleThreadedMatMulS32(const void* run_options_ptr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_matmulDTcc mht_8(mht_8_v, 331, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_matmul.cc", "__xla_cpu_runtime_EigenSingleThreadedMatMulS32");
