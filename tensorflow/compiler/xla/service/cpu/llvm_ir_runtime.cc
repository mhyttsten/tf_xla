...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc() {
      // Check if tracing is enabled
...
void RemoveFunctionFromUsedList(llvm::Module* module, llvm::Function* fn) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "RemoveFunctionFromUsedList");
...
void RewriteCalls(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_1(mht_1_v, 261, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "RewriteCalls");
...
llvm::Value* GenerateVF32Tanh(llvm::IRBuilder<>* b, llvm::Value* input,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_2(mht_2_v, 334, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "GenerateVF32Tanh");
...
llvm::Value* GenerateVF32Exp(llvm::IRBuilder<>* b, llvm::Value* input,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_3(mht_3_v, 342, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "GenerateVF32Exp");
  ...
  auto splat_i32 = [&](int32_t v) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_4(mht_4_v, 453, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "lambda");
...
llvm::Value* GenerateVF32Log(llvm::IRBuilder<>* b, llvm::Value* input,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_5(mht_5_v, 473, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "GenerateVF32Log");
...
void RewriteIRRuntimeFunctions(llvm::Module* module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSllvm_ir_runtimeDTcc mht_6(mht_6_v, 584, "", "./tensorflow/compiler/xla/service/cpu/llvm_ir_runtime.cc", "RewriteIRRuntimeFunctions");
