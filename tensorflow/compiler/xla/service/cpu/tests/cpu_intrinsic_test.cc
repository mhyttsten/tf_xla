...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_intrinsic_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_intrinsic_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_intrinsic_testDTcc() {
      // Check if tracing is enabled
...
class CpuUnaryIntrinsicTest
 ...
 public:
  static std::string Name(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_intrinsic_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/xla/service/cpu/tests/cpu_intrinsic_test.cc", "Name");
 ...
 private:
  DebugOptions GetDebugOptionsForTest() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_intrinsic_testDTcc mht_1(mht_1_v, 248, "", "./tensorflow/compiler/xla/service/cpu/tests/cpu_intrinsic_test.cc", "GetDebugOptionsForTest");
