...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_external_constants_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_external_constants_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_external_constants_testDTcc() {
      // Check if tracing is enabled
...
class CpuExternalConstantsTest : public CpuCodegenTest {
 public:
  void TestWithArray(int64_t rows, int64_t cols,
   ...
   mht_0_v.push_back("filecheck_pattern: \"" + (filecheck_pattern == nullptr ? std::string("nullptr") : std::string((char*)filecheck_pattern)) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPStestsPScpu_external_constants_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/cpu/tests/cpu_external_constants_test.cc", "TestWithArray");
