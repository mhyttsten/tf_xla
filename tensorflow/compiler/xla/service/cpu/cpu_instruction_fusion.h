...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_instruction_fusionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_instruction_fusionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_instruction_fusionDTh() {
      // Check if tracing is enabled
...
class CpuInstructionFusion : public InstructionFusion {
 public:
  CpuInstructionFusion()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_instruction_fusionDTh mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/service/cpu/cpu_instruction_fusion.h", "CpuInstructionFusion");
}
