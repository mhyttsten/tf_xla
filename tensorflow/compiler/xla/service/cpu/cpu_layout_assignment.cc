...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc() {
      // Check if tracing is enabled
...
static bool ShouldMakeAllUsersColMajor(const HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/xla/service/cpu/cpu_layout_assignment.cc", "ShouldMakeAllUsersColMajor");
...
static Shape RowMajorShape(const Shape& old_shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc mht_1(mht_1_v, 253, "", "./tensorflow/compiler/xla/service/cpu/cpu_layout_assignment.cc", "RowMajorShape");
...
static Shape ColMajorShape(const Shape& old_shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc mht_2(mht_2_v, 264, "", "./tensorflow/compiler/xla/service/cpu/cpu_layout_assignment.cc", "ColMajorShape");
...
static bool OperandsAndResultMustHaveRowMajorLayout(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc mht_3(mht_3_v, 277, "", "./tensorflow/compiler/xla/service/cpu/cpu_layout_assignment.cc", "OperandsAndResultMustHaveRowMajorLayout");
...
Status CpuLayoutAssignment::AddBackendConstraints(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPScpu_layout_assignmentDTcc mht_4(mht_4_v, 292, "", "./tensorflow/compiler/xla/service/cpu/cpu_layout_assignment.cc", "CpuLayoutAssignment::AddBackendConstraints");
