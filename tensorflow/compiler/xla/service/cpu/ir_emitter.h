...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh() {
      // Check if tracing is enabled
...
class IrEmitter : public DfsHloVisitorWithDefault,
 ...
 public:
  ...
  llvm::IRBuilder<>* b() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_0(mht_0_v, 294, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "b");
 return &b_; }

  // builder() is for IrBuilderMixin.
  llvm::IRBuilder<>* builder() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_1(mht_1_v, 300, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "builder");
 return &b_; }
 ...
 private:
  ...
  void AddAliasingInformationToIrArray(const HloInstruction& hlo,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_2(mht_2_v, 422, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "AddAliasingInformationToIrArray");
  ...
  struct ComputationToEmit {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_3(mht_3_v, 654, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "AbslHashValue");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_4(mht_4_v, 661, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "operator<<");
  ...
  bool ComputationTransitivelyContainsCustomCall(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_5(mht_5_v, 712, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "ComputationTransitivelyContainsCustomCall");
  ...
  bool ShouldEmitParallelLoopFor(const HloInstruction& op) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_6(mht_6_v, 734, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "ShouldEmitParallelLoopFor");
  ...
  class ProfilingState {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_7(mht_7_v, 748, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "ProfilingState");
}
    explicit ProfilingState(bool use_rdtscp) : use_rdtscp_(use_rdtscp) {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_8(mht_8_v, 752, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "ProfilingState");
}
  ...
  class TracingState {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_9(mht_9_v, 795, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "TracingState");
}
    void set_enabled(bool value) {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSir_emitterDTh mht_10(mht_10_v, 799, "", "./tensorflow/compiler/xla/service/cpu/ir_emitter.h", "set_enabled");
 enabled_ = value; }
