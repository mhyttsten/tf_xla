...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv3dDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv3dDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv3dDTcc() {
      // Check if tracing is enabled
...
__xla_cpu_runtime_EigenSingleThreadedConv3DF16(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv3dDTcc mht_0(mht_0_v, 225, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_conv3d.cc", "__xla_cpu_runtime_EigenSingleThreadedConv3DF16");
