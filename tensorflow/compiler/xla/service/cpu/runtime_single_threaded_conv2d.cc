...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv2dDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv2dDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv2dDTcc() {
      // Check if tracing is enabled
...
__xla_cpu_runtime_EigenSingleThreadedConv2DF32(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSruntime_single_threaded_conv2dDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/xla/service/cpu/runtime_single_threaded_conv2d.cc", "__xla_cpu_runtime_EigenSingleThreadedConv2DF32");
