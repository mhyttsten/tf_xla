...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSelemental_ir_emitterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSelemental_ir_emitterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSelemental_ir_emitterDTh() {
      // Check if tracing is enabled
...
class CpuElementalIrEmitter : public ElementalIrEmitter {
 public:
  CpuElementalIrEmitter(const HloModuleConfig& module_config,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSelemental_ir_emitterDTh mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/service/cpu/elemental_ir_emitter.h", "CpuElementalIrEmitter");
}
 ...
 protected:
  ...
  bool fast_min_max() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScpuPSelemental_ir_emitterDTh mht_1(mht_1_v, 224, "", "./tensorflow/compiler/xla/service/cpu/elemental_ir_emitter.h", "fast_min_max");
