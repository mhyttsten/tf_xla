...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconvolution_group_converterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconvolution_group_converterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconvolution_group_converterDTh() {
      // Check if tracing is enabled
...
class ConvolutionGroupConverter : public HloModulePass {
 public:
  ConvolutionGroupConverter(std::function<bool(HloInstruction*)> should_expand,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconvolution_group_converterDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/convolution_group_converter.h", "ConvolutionGroupConverter");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconvolution_group_converterDTh mht_1(mht_1_v, 213, "", "./tensorflow/compiler/xla/service/convolution_group_converter.h", "name");
