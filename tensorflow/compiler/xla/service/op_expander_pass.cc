...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> OpExpanderPass::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/service/op_expander_pass.cc", "OpExpanderPass::Run");
