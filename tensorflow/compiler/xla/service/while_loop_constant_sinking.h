...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_constant_sinkingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_constant_sinkingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_constant_sinkingDTh() {
      // Check if tracing is enabled
...
class WhileLoopConstantSinking : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_constant_sinkingDTh mht_0(mht_0_v, 223, "", "./tensorflow/compiler/xla/service/while_loop_constant_sinking.h", "name");
