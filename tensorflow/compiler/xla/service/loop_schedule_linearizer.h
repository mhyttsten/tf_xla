...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSloop_schedule_linearizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSloop_schedule_linearizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSloop_schedule_linearizerDTh() {
      // Check if tracing is enabled
...
class LoopScheduleLinearizer : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSloop_schedule_linearizerDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/loop_schedule_linearizer.h", "name");
 return "loop-schedule-linearizer"; }

  explicit LoopScheduleLinearizer(
      const HloDataflowAnalysis::CanShareBuffer& can_share_buffer = nullptr)
      : can_share_buffer_(can_share_buffer) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSloop_schedule_linearizerDTh mht_1(mht_1_v, 213, "", "./tensorflow/compiler/xla/service/loop_schedule_linearizer.h", "LoopScheduleLinearizer");
}
