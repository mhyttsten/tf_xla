...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc() {
      // Check if tracing is enabled
...
XlaOp Norm(std::vector<XlaOp> xs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_0(mht_0_v, 230, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "Norm");
...
Status House(XlaOp x, XlaOp k, absl::Span<const int64_t> batch_dims,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_1(mht_1_v, 282, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "House");
...
StatusOr<QrDecomposition> QrExpander::QrBlock(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_2(mht_2_v, 375, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "QrExpander::QrBlock");
...
StatusOr<XlaOp> QrExpander::CompactWYRepresentation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_3(mht_3_v, 498, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "QrExpander::CompactWYRepresentation");
...
StatusOr<XlaOp> QrExpander::BuildQrDecomposition(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_4(mht_4_v, 555, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "QrExpander::BuildQrDecomposition");
...
StatusOr<XlaOp> QrExpander::ProductOfElementaryHouseholderReflectors(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_5(mht_5_v, 622, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "QrExpander::ProductOfElementaryHouseholderReflectors");
...
bool QrExpander::InstructionMatchesPattern(HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_6(mht_6_v, 692, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "QrExpander::InstructionMatchesPattern");
...
StatusOr<HloInstruction*> QrExpander::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTcc mht_7(mht_7_v, 703, "", "./tensorflow/compiler/xla/service/qr_expander.cc", "QrExpander::ExpandInstruction");
