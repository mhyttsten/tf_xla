...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combiner_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combiner_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combiner_testDTcc() {
      // Check if tracing is enabled
...
class ReduceScatterCombinerTest : public HloTestBase {
 public:
  ...
  size_t ReduceScatterCount(std::unique_ptr<HloModule>& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combiner_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/xla/service/reduce_scatter_combiner_test.cc", "ReduceScatterCount");
