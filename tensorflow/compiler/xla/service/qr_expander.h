...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTh() {
      // Check if tracing is enabled
...
class QrExpander : public OpExpanderPass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSqr_expanderDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/service/qr_expander.h", "name");
 return "qr_expander"; }
