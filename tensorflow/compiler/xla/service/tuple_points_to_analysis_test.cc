...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc() {
      // Check if tracing is enabled
...
class TuplePointsToAnalysisTest : public HloTestBase {
 protected:
  ...
  void BuildModuleAndRunAnalysis(std::unique_ptr<HloComputation> computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "BuildModuleAndRunAnalysis");
  ...
  void BuildModule(std::unique_ptr<HloComputation> computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_1(mht_1_v, 226, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "BuildModule");
  ...
  void RunAnalysis() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_2(mht_2_v, 234, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "RunAnalysis");
  ...
  const LogicalBuffer* const GetBuffer(const HloInstruction* instruction,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_3(mht_3_v, 246, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "GetBuffer");
  ...
  void ExpectHasBuffers(const PointsToSet::BufferList& points_to_set,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_4(mht_4_v, 261, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "ExpectHasBuffers");
  ...
  void ExpectHasTopLevelBuffers(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_5(mht_5_v, 273, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "ExpectHasTopLevelBuffers");
  ...
  void ExpectHasTopLevelBuffers(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_6(mht_6_v, 287, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "ExpectHasTopLevelBuffers");
  ...
  void ExpectHasBufferAliases(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_7(mht_7_v, 300, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "ExpectHasBufferAliases");
...
class FusionPointsToAnalysisTest : public TuplePointsToAnalysisTest {
 protected:
  ...
  void Run(const bool add_additional_gte0_user) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_8(mht_8_v, 910, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "Run");
  ...
  HloInstruction* GetFusionParameterForOperand(HloInstruction* fusion,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_9(mht_9_v, 1000, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "GetFusionParameterForOperand");
  ...
  HloInstruction* GetUniqueFusionParameterUserAt(HloInstruction* fusion_param,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_10(mht_10_v, 1029, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "GetUniqueFusionParameterUserAt");
  ...
  void ExpectNumUsersOfAliases(const HloInstruction* instruction,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_11(mht_11_v, 1043, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "ExpectNumUsersOfAliases");
...
class PointsToAnalysisTestBase : public HloTestBase {
 protected:
  void BuildModule(std::unique_ptr<HloComputation> computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_12(mht_12_v, 1112, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "BuildModule");
  ...
  void RunAnalysis() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_13(mht_13_v, 1120, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "RunAnalysis");
  ...
  void BuildModuleAndRunAnalysis(std::unique_ptr<HloComputation> computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_points_to_analysis_testDTcc mht_14(mht_14_v, 1129, "", "./tensorflow/compiler/xla/service/tuple_points_to_analysis_test.cc", "BuildModuleAndRunAnalysis");
