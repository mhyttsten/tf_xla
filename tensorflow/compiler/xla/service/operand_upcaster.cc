...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoperand_upcasterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoperand_upcasterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoperand_upcasterDTcc() {
      // Check if tracing is enabled
...
bool OperandUpcaster::InstructionMatchesPattern(HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoperand_upcasterDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/operand_upcaster.cc", "OperandUpcaster::InstructionMatchesPattern");
...
StatusOr<HloInstruction*> OperandUpcaster::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoperand_upcasterDTcc mht_1(mht_1_v, 235, "", "./tensorflow/compiler/xla/service/operand_upcaster.cc", "OperandUpcaster::ExpandInstruction");
