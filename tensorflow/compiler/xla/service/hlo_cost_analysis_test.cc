...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cost_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cost_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cost_analysis_testDTcc() {
      // Check if tracing is enabled
...
int64_t ShapeSize(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cost_analysis_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/hlo_cost_analysis_test.cc", "ShapeSize");
...
class HloCostAnalysisTest : public ::testing::Test {
 protected:
  HloCostAnalysisTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cost_analysis_testDTcc mht_1(mht_1_v, 230, "", "./tensorflow/compiler/xla/service/hlo_cost_analysis_test.cc", "HloCostAnalysisTest");
