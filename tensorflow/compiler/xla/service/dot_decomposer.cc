...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_decomposerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_decomposerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_decomposerDTcc() {
      // Check if tracing is enabled
...
Status CanonicalizeDot(HloInstruction* original_dot) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_decomposerDTcc mht_0(mht_0_v, 210, "", "./tensorflow/compiler/xla/service/dot_decomposer.cc", "CanonicalizeDot");
...
StatusOr<bool> DotDecomposer::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_decomposerDTcc mht_1(mht_1_v, 350, "", "./tensorflow/compiler/xla/service/dot_decomposer.cc", "DotDecomposer::Run");
