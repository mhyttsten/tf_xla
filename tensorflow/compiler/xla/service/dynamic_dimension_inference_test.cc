...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc() {
      // Check if tracing is enabled
...
class DynamicDimensionInferenceTest : public HloTestBase {
 protected:
  DynamicDimensionInferenceTest() : HloTestBase() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference_test.cc", "DynamicDimensionInferenceTest");
  ...
  Status RunInference(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference_test.cc", "RunInference");
  ...
  HloComputation* GetAdd() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc mht_2(mht_2_v, 231, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference_test.cc", "GetAdd");
  ...
  HloComputation* GetAddTuple() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc mht_3(mht_3_v, 245, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference_test.cc", "GetAddTuple");
  ...
  HloComputation* GetGe() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc mht_4(mht_4_v, 268, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference_test.cc", "GetGe");
...
TEST_F(DynamicDimensionInferenceTest, InfersCustomOp) {
  ...
  auto handler = [&](HloInstruction* hlo,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inference_testDTcc mht_5(mht_5_v, 1424, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference_test.cc", "lambda");
