...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_profile_printerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_profile_printerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_profile_printerDTcc() {
      // Check if tracing is enabled
...
std::string PrintHloProfile(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_profile_printerDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/xla/service/hlo_profile_printer.cc", "PrintHloProfile");
