...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc() {
      // Check if tracing is enabled
...
void CopyFrontendAttributes(HloInstruction* old_while_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "CopyFrontendAttributes");
...
static StatusOr<HloInstruction*> RemoveDeadTupleIndices(
  ...
  auto make_while_computation_replacements = [&](const HloComputation* comp) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_1(mht_1_v, 260, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
...
static StatusOr<bool> TryRemoveDeadWhileParams(HloInstruction* while_op) {
  ...
  struct InputIndicesSet {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_2(mht_2_v, 482, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "Merge");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_3(mht_3_v, 511, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "Add");
...
static StatusOr<bool> TryRemoveConstantParams(HloInstruction* while_op) {
  ...
  auto add_new_instr = [&](std::unique_ptr<HloInstruction> instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_4(mht_4_v, 854, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto remove_constant_elems = [&](HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_5(mht_5_v, 863, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto add_constant_elems = [&](HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_6(mht_6_v, 880, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
...
static StatusOr<bool> TryFlattenNestedTuples(HloInstruction* while_op) {
  ...
  auto add_new_instr = [&](std::unique_ptr<HloInstruction> instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_7(mht_7_v, 1218, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto nested = [&](HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_8(mht_8_v, 1226, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto flattened = [&](HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_9(mht_9_v, 1244, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
...
static StatusOr<HloInstruction*> TryMergeInductionVariables(
  ...
  auto add_new_instr = [&](std::unique_ptr<HloInstruction> instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_10(mht_10_v, 1381, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto add_binary_op = [&](const Shape& shape, HloOpcode opcode,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_11(mht_11_v, 1390, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto add_gte = [&](HloInstruction* src, int64_t idx) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_12(mht_12_v, 1406, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto convert_to_old_form = [&](HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_13(mht_13_v, 1429, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto convert_to_new_form = [&](HloInstruction* old_root,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_14(mht_14_v, 1454, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
  ...
  auto get_new_while_init = [&](HloInstruction* init) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_15(mht_15_v, 1483, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "lambda");
...
StatusOr<bool> WhileLoopSimplifier::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTcc mht_16(mht_16_v, 1552, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.cc", "WhileLoopSimplifier::Run");
