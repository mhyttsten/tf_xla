...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc() {
      // Check if tracing is enabled
...
class HloComputationTest : public HloTestBase {
 protected:
  HloComputationTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/xla/service/hlo_computation_test.cc", "HloComputationTest");
}
...
TEST_F(HloComputationTest, VisitWithMultipleRoots) {
  ...
  class TestVisitor : public DfsHloVisitorWithDefault {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc mht_1(mht_1_v, 404, "", "./tensorflow/compiler/xla/service/hlo_computation_test.cc", "TestVisitor");
}

    Status DefaultAction(HloInstruction* hlo_instruction) override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc mht_2(mht_2_v, 409, "", "./tensorflow/compiler/xla/service/hlo_computation_test.cc", "DefaultAction");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_computation_testDTcc mht_3(mht_3_v, 419, "", "./tensorflow/compiler/xla/service/hlo_computation_test.cc", "FinishVisit");
