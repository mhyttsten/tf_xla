...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_op_metadataDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_op_metadataDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_op_metadataDTcc() {
      // Check if tracing is enabled
...
std::string OpMetadataToString(const OpMetadata& metadata) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_op_metadataDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/xla/service/hlo_op_metadata.cc", "OpMetadataToString");
