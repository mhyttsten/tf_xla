...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSzero_sized_hlo_elimination_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSzero_sized_hlo_elimination_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSzero_sized_hlo_elimination_testDTcc() {
      // Check if tracing is enabled
...
class ZeroSizedHloEliminationTest : public HloTestBase {
 protected:
  ZeroSizedHloEliminationTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSzero_sized_hlo_elimination_testDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/zero_sized_hlo_elimination_test.cc", "ZeroSizedHloEliminationTest");
}
