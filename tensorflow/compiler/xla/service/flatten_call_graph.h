...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSflatten_call_graphDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSflatten_call_graphDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSflatten_call_graphDTh() {
      // Check if tracing is enabled
...
class FlattenCallGraph : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSflatten_call_graphDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/flatten_call_graph.h", "name");
