...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inferenceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inferenceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inferenceDTh() {
      // Check if tracing is enabled
...
class DynamicDimensionInference {
 ...
 private:
  ...
  struct DynamicDimension {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_dimension_inferenceDTh mht_0(mht_0_v, 286, "", "./tensorflow/compiler/xla/service/dynamic_dimension_inference.h", "AbslHashValue");
