...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_conversion_foldingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_conversion_foldingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_conversion_foldingDTh() {
      // Check if tracing is enabled
...
class BFloat16ConversionFolding : public HloModulePass {
 public:
  explicit BFloat16ConversionFolding(const BFloat16Support* bfloat16_support)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_conversion_foldingDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/bfloat16_conversion_folding.h", "BFloat16ConversionFolding");
}

  ~BFloat16ConversionFolding() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_conversion_foldingDTh mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xla/service/bfloat16_conversion_folding.h", "name");
 return "bfloat16-fold"; }
