...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_folderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_folderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_folderDTh() {
      // Check if tracing is enabled
...
class AllReduceFolder : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_folderDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/all_reduce_folder.h", "name");
 return "all-reduce-folder"; }
