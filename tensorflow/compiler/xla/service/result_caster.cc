...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSresult_casterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSresult_casterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSresult_casterDTcc() {
      // Check if tracing is enabled
...
bool ResultCaster::InstructionMatchesPattern(HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSresult_casterDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/result_caster.cc", "ResultCaster::InstructionMatchesPattern");
...
StatusOr<HloInstruction*> ResultCaster::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSresult_casterDTcc mht_1(mht_1_v, 227, "", "./tensorflow/compiler/xla/service/result_caster.cc", "ResultCaster::ExpandInstruction");
