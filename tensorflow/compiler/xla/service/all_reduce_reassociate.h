...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_reassociateDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_reassociateDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_reassociateDTh() {
      // Check if tracing is enabled
...
class AllReduceReassociate : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_reassociateDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/all_reduce_reassociate.h", "name");
 return "all-reduce-reassociate"; }
