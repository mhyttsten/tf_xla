...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc() {
      // Check if tracing is enabled
...
XlaOp Hypot(XlaOp x, XlaOp y) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_0(mht_0_v, 237, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "Hypot");
...
void ApplyJacobiRotationOverRows(Eigh2x2 rotation, XlaOp& tl, XlaOp& tr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_1(mht_1_v, 320, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "ApplyJacobiRotationOverRows");
...
void ApplyJacobiRotationOverCols(Eigh2x2 rotation, XlaOp& tl, XlaOp& tr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_2(mht_2_v, 343, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "ApplyJacobiRotationOverCols");
...
void PermuteRowsInColumn(XlaOp& top, XlaOp& bottom) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_3(mht_3_v, 369, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "PermuteRowsInColumn");
...
void PermuteColumnsInRow(XlaOp& left, XlaOp& right) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_4(mht_4_v, 392, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "PermuteColumnsInRow");
...
Status ApplyRotations(int64_t n, XlaOp& w_tl, XlaOp& w_tr, XlaOp& w_bl,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_5(mht_5_v, 424, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "ApplyRotations");
...
StatusOr<FrobeniusNorms> ComputeFrobeniusNorms(XlaOp w_tl, XlaOp w_tr,
  ...
  auto off_diag = [](XlaOp x) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_6(mht_6_v, 465, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "lambda");
...
Status EighExpander::SortByEigenvalues(XlaOp& v, XlaOp& w) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_7(mht_7_v, 544, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "EighExpander::SortByEigenvalues");
...
XlaOp EighExpander::BuildEigh(XlaOp a, bool lower, int64_t max_iter, float tol,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_8(mht_8_v, 623, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "EighExpander::BuildEigh");
...
bool EighExpander::InstructionMatchesPattern(HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_9(mht_9_v, 736, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "EighExpander::InstructionMatchesPattern");
...
StatusOr<HloInstruction*> EighExpander::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSeigh_expanderDTcc mht_10(mht_10_v, 745, "", "./tensorflow/compiler/xla/service/eigh_expander.cc", "EighExpander::ExpandInstruction");
