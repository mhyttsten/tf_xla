...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStranspose_foldingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStranspose_foldingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStranspose_foldingDTh() {
      // Check if tracing is enabled
...
class TransposeFolding : public HloModulePass {
 public:
  ...
  static OperandIndices NeverFoldTranspose(const HloInstruction&,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStranspose_foldingDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/transpose_folding.h", "NeverFoldTranspose");
  ...
  static OperandIndices AlwaysFoldTranspose(const HloInstruction&,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStranspose_foldingDTh mht_1(mht_1_v, 217, "", "./tensorflow/compiler/xla/service/transpose_folding.h", "AlwaysFoldTranspose");
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStranspose_foldingDTh mht_2(mht_2_v, 236, "", "./tensorflow/compiler/xla/service/transpose_folding.h", "name");
