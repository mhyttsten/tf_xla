...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh() {
      // Check if tracing is enabled
...
class LLVMCompiler : public Compiler {
 public:
  ~LLVMCompiler() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/llvm_compiler.h", "~LLVMCompiler");
}
  ...
  void SetPreOptimizationHook(ModuleHook hook) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/service/llvm_compiler.h", "SetPreOptimizationHook");
  ...
  void RemovePreOptimizationHook() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh mht_2(mht_2_v, 224, "", "./tensorflow/compiler/xla/service/llvm_compiler.h", "RemovePreOptimizationHook");
 user_pre_optimization_hook_ = nullptr; }

  void SetPostOptimizationHook(ModuleHook hook) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh mht_3(mht_3_v, 229, "", "./tensorflow/compiler/xla/service/llvm_compiler.h", "SetPostOptimizationHook");
  ...
  void RemovePostOptimizationHook() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTh mht_4(mht_4_v, 239, "", "./tensorflow/compiler/xla/service/llvm_compiler.h", "RemovePostOptimizationHook");
