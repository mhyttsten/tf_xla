...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnvptx_helperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnvptx_helperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnvptx_helperDTcc() {
      // Check if tracing is enabled
...
std::string CantFindCudaMessage(absl::string_view msg,
   ...
   mht_0_v.push_back("msg: \"" + std::string(msg.data(), msg.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnvptx_helperDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/gpu/nvptx_helper.cc", "CantFindCudaMessage");
...
std::string GetLibdeviceDir(const HloModuleConfig& hlo_module_config) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnvptx_helperDTcc mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/gpu/nvptx_helper.cc", "GetLibdeviceDir");
