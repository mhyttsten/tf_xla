...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_layout_normalizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_layout_normalizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_layout_normalizerDTh() {
      // Check if tracing is enabled
...
class ReductionLayoutNormalizer : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_layout_normalizerDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/service/gpu/reduction_layout_normalizer.h", "name");
