...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShlo_algorithm_denylist_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShlo_algorithm_denylist_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShlo_algorithm_denylist_testDTcc() {
      // Check if tracing is enabled
...
class DenylistTest : public testing::Test {
 protected:
  DenylistTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShlo_algorithm_denylist_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/gpu/hlo_algorithm_denylist_test.cc", "DenylistTest");
