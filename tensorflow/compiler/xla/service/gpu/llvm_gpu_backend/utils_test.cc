...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSllvm_gpu_backendPSutils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSllvm_gpu_backendPSutils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSllvm_gpu_backendPSutils_testDTcc() {
      // Check if tracing is enabled
...
std::string SaxpyIRFile() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSllvm_gpu_backendPSutils_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/gpu/llvm_gpu_backend/utils_test.cc", "SaxpyIRFile");
