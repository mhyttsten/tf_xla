...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScusolver_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScusolver_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScusolver_contextDTh() {
      // Check if tracing is enabled
...
class GpuSolverContext {
 public:
  ...
  bool SupportsPotrfBatched() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScusolver_contextDTh mht_0(mht_0_v, 236, "", "./tensorflow/compiler/xla/service/gpu/cusolver_context.h", "SupportsPotrfBatched");
 ...
 private:
  ...
  gpusolverHandle_t handle() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScusolver_contextDTh mht_1(mht_1_v, 300, "", "./tensorflow/compiler/xla/service/gpu/cusolver_context.h", "handle");
 return handle_; }
