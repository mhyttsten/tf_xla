...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTcc() {
      // Check if tracing is enabled
...
class ReduceDimensionGroupVisitor : public DfsHloRewriteVisitor {
 public:
  Status HandleReduce(HloInstruction *hlo) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/gpu/reduction_dimension_grouper.cc", "HandleReduce");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTcc mht_1(mht_1_v, 226, "", "./tensorflow/compiler/xla/service/gpu/reduction_dimension_grouper.cc", "lambda");
...
StatusOr<bool> ReductionDimensionGrouper::Run(HloModule *module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTcc mht_2(mht_2_v, 281, "", "./tensorflow/compiler/xla/service/gpu/reduction_dimension_grouper.cc", "ReductionDimensionGrouper::Run");
