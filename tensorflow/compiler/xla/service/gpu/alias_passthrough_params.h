...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTh() {
      // Check if tracing is enabled
...
class AliasPassthroughParams : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/gpu/alias_passthrough_params.h", "name");
 return "alias_passthrough_params"; }
