...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusion_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusion_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusion_testDTcc() {
      // Check if tracing is enabled
...
static int Count(const HloModule& module, HloOpcode op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusion_testDTcc mht_0(mht_0_v, 564, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion_test.cc", "Count");
