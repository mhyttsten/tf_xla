...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc() {
      // Check if tracing is enabled
...
GpuGemmConfig GetGpuGemmConfig(const HloInstruction *gemm) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "GetGpuGemmConfig");
...
GemmThunk::GemmThunk(ThunkInfo thunk_info, GpuGemmConfig config,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_1(mht_1_v, 226, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "GemmThunk::GemmThunk");
}

Status GemmThunk::ExecuteOnStream(const ExecuteParams &params) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_2(mht_2_v, 231, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "GemmThunk::ExecuteOnStream");

  auto get_device_address = [&](const BufferAllocation::Slice &slice) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_3(mht_3_v, 235, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "lambda");
...
struct MatrixDescriptor {
  ...
  int64_t reduced_dim() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_4(mht_4_v, 259, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "reduced_dim");
...
static Status DoGemm(int64_t batch_size, const MatrixDescriptor &lhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_5(mht_5_v, 338, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "DoGemm");
...
Status RunGemm(const GpuGemmConfig &gemm_config,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_6(mht_6_v, 378, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "RunGemm");
  ...
  auto validate_matrix = [&](const Shape &shape, auto batch_dimensions) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_thunkDTcc mht_7(mht_7_v, 407, "", "./tensorflow/compiler/xla/service/gpu/gemm_thunk.cc", "lambda");
