...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTh() {
      // Check if tracing is enabled
...
class GemmBroadcastFoldingRewriter : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/gpu/gemm_broadcast_folding_rewriter.h", "name");
