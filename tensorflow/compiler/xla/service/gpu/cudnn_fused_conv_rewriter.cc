...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc() {
      // Check if tracing is enabled
...
bool IsConvCustomCall(const HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_0(mht_0_v, 224, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "IsConvCustomCall");
...
bool IsLosslesslyConvertibleTo(const HloInstruction* instr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_1(mht_1_v, 243, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "IsLosslesslyConvertibleTo");
...
bool IsLosslesslyConvertibleToS8(const HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_2(mht_2_v, 290, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "IsLosslesslyConvertibleToS8");

  return IsLosslesslyConvertibleTo(instr, S8);
}
bool IsLosslesslyConvertibleToF16(const HloInstruction* instr) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_3(mht_3_v, 296, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "IsLosslesslyConvertibleToF16");
...
StatusOr<bool> FuseSideInputAlpha(HloComputation* comp) {
  ...
  for (HloInstruction* instr : comp->MakeInstructionPostOrder()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_4(mht_4_v, 614, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "lambda");
...
Status CheckNoIllegalIntegerConvs(HloComputation* comp) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_5(mht_5_v, 826, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "CheckNoIllegalIntegerConvs");

  auto is_integral_not_s8 = [](const Shape& s) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_6(mht_6_v, 830, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "lambda");
...
void VlogStats(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_7(mht_7_v, 888, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "VlogStats");
...
StatusOr<bool> CudnnFusedConvRewriter::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriterDTcc mht_8(mht_8_v, 969, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter.cc", "CudnnFusedConvRewriter::Run");
