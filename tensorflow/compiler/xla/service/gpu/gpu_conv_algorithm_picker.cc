...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc() {
      // Check if tracing is enabled
...
class ScratchAllocator : public se::ScratchAllocator {
 public:
  ScratchAllocator(int device_ordinal,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_0(mht_0_v, 234, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "ScratchAllocator");
}

  int64_t GetMemoryLimitInBytes() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_1(mht_1_v, 239, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GetMemoryLimitInBytes");

    return 1LL << 32;  // 4GB.  TODO(jlebar): Tune this?
  }
  int64_t TotalAllocatedBytes() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_2(mht_2_v, 245, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "TotalAllocatedBytes");
...
StatusOr<se::DeviceMemory<uint8_t>> ScratchAllocator::AllocateBytes(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_3(mht_3_v, 267, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "ScratchAllocator::AllocateBytes");
...
std::string NumBytesToString(int64_t bytes) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_4(mht_4_v, 394, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "NumBytesToString");
...
tensorflow::CudnnVersion GetCudnnVersion(se::StreamExecutor* stream_executor) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_5(mht_5_v, 402, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GetCudnnVersion");
...
tensorflow::ComputeCapability GetComputeCapability(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_6(mht_6_v, 420, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GetComputeCapability");
...
void PrintPlatformInfo(const se::Stream* stream) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_7(mht_7_v, 432, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "PrintPlatformInfo");
...
struct ConvCacheStats {
  ...
  void LogStats() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_8(mht_8_v, 508, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "LogStats");
...
ConvCacheKey AutotuneCacheKeyfromInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_9(mht_9_v, 518, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "AutotuneCacheKeyfromInstruction");
...
StatusOr<AutotuneResult> GpuConvAlgorithmPicker::PickBestAlgorithm(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_10(mht_10_v, 535, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::PickBestAlgorithm");
...
bool ShouldInitConvData(const HloCustomCallInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_11(mht_11_v, 608, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "ShouldInitConvData");
...
bool ShouldCheckConv(const HloCustomCallInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_12(mht_12_v, 618, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "ShouldCheckConv");
...
GpuConvAlgorithmPicker::AutotuneOneConvRunner(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_13(mht_13_v, 643, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::AutotuneOneConvRunner");
  ...
  auto make_failure = [&alg](AutotuneResult::FailureKind kind,
   ...
   mht_14_v.push_back("msg: \"" + std::string(msg.data(), msg.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_14(mht_14_v, 659, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "lambda");
...
GpuConvAlgorithmPicker::PickBestAlgorithmNoCacheCuda(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_15(mht_15_v, 858, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::PickBestAlgorithmNoCacheCuda");
  ...
  const auto initialize_buffer = [init_conv_data, &stream, &rng_state](
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_16(mht_16_v, 873, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "lambda");
...
GpuConvAlgorithmPicker::PickBestAlgorithmNoCacheRocm(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_17(mht_17_v, 1015, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::PickBestAlgorithmNoCacheRocm");
  ...
  const auto initialize_buffer = [stream](DeviceMemoryBase buffer) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_18(mht_18_v, 1026, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "lambda");
...
StatusOr<bool> GpuConvAlgorithmPicker::RunOnInstruction(HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_19(mht_19_v, 1132, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::RunOnInstruction");
...
StatusOr<bool> GpuConvAlgorithmPicker::RunOnComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_20(mht_20_v, 1212, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::RunOnComputation");
...
StatusOr<bool> GpuConvAlgorithmPicker::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTcc mht_21(mht_21_v, 1231, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.cc", "GpuConvAlgorithmPicker::Run");
