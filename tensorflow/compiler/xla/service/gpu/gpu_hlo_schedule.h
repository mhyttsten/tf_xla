...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_scheduleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_scheduleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_scheduleDTh() {
      // Check if tracing is enabled
...
class GpuHloSchedule {
 public:
  ...
  const std::vector<HloInstruction*>& ThunkLaunchOrder() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_scheduleDTh mht_0(mht_0_v, 218, "", "./tensorflow/compiler/xla/service/gpu/gpu_hlo_schedule.h", "ThunkLaunchOrder");
