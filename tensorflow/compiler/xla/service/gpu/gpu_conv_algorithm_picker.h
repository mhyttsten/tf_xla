...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTh() {
      // Check if tracing is enabled
...
class GpuConvAlgorithmPicker : public HloModulePass {
 public:
  ...
  GpuConvAlgorithmPicker(se::StreamExecutor* stream_exec,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.h", "GpuConvAlgorithmPicker");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_algorithm_pickerDTh mht_1(mht_1_v, 220, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_algorithm_picker.h", "name");
