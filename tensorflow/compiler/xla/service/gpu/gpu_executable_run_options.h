...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_executable_run_optionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_executable_run_optionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_executable_run_optionsDTh() {
      // Check if tracing is enabled
...
class NcclCliqueKey {
 public:
  ...
  friend H AbslHashValue(H h, const NcclCliqueKey& k) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_executable_run_optionsDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/gpu/gpu_executable_run_options.h", "AbslHashValue");
  ...
  const std::vector<GlobalDeviceId>& devices() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_executable_run_optionsDTh mht_1(mht_1_v, 217, "", "./tensorflow/compiler/xla/service/gpu/gpu_executable_run_options.h", "devices");
 return devices_; }
