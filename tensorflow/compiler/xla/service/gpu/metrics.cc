...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc() {
      // Check if tracing is enabled
...
void RecordHloPassesDuration(const uint64_t time_usecs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/gpu/metrics.cc", "RecordHloPassesDuration");
...
void RecordHloToLlvmDuration(const uint64_t time_usecs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/service/gpu/metrics.cc", "RecordHloToLlvmDuration");
...
void RecordLlvmPassesAndLlvmToPtxDuration(const uint64_t time_usecs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc mht_2(mht_2_v, 219, "", "./tensorflow/compiler/xla/service/gpu/metrics.cc", "RecordLlvmPassesAndLlvmToPtxDuration");
...
void RecordLlvmPassesDuration(const uint64_t time_usecs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc mht_3(mht_3_v, 230, "", "./tensorflow/compiler/xla/service/gpu/metrics.cc", "RecordLlvmPassesDuration");
...
void RecordLlvmToPtxDuration(const uint64_t time_usecs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc mht_4(mht_4_v, 238, "", "./tensorflow/compiler/xla/service/gpu/metrics.cc", "RecordLlvmToPtxDuration");
...
void RecordPtxToCubinDuration(const uint64_t time_usecs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmetricsDTcc mht_5(mht_5_v, 248, "", "./tensorflow/compiler/xla/service/gpu/metrics.cc", "RecordPtxToCubinDuration");
