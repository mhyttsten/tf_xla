...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSkernel_thunkDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSkernel_thunkDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSkernel_thunkDTh() {
      // Check if tracing is enabled
...
class KernelThunk : public Thunk {
 public:
  ...
  const std::vector<const BufferAllocation*>& arguments() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSkernel_thunkDTh mht_0(mht_0_v, 231, "", "./tensorflow/compiler/xla/service/gpu/kernel_thunk.h", "arguments");

    return args_;
  }
  const std::string& kernel_name() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSkernel_thunkDTh mht_1(mht_1_v, 237, "", "./tensorflow/compiler/xla/service/gpu/kernel_thunk.h", "kernel_name");
 return kernel_name_; }
  const LaunchDimensions& launch_dimensions() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSkernel_thunkDTh mht_2(mht_2_v, 241, "", "./tensorflow/compiler/xla/service/gpu/kernel_thunk.h", "launch_dimensions");
