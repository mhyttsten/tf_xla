...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSwhile_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSwhile_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSwhile_thunkDTcc() {
      // Check if tracing is enabled
...
WhileThunk::WhileThunk(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSwhile_thunkDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/gpu/while_thunk.cc", "WhileThunk::WhileThunk");
}

Status WhileThunk::Initialize(const GpuExecutable& executable,
                              se::StreamExecutor* executor) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSwhile_thunkDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/service/gpu/while_thunk.cc", "WhileThunk::Initialize");
...
Status WhileThunk::ExecuteOnStream(const ExecuteParams& params) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSwhile_thunkDTcc mht_2(mht_2_v, 220, "", "./tensorflow/compiler/xla/service/gpu/while_thunk.cc", "WhileThunk::ExecuteOnStream");
