...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc() {
      // Check if tracing is enabled
...
class CudnnFusedConvRewriterHloTest : public HloTestBase {
 public:
  CudnnFusedConvRewriterHloTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc mht_0(mht_0_v, 225, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter_test.cc", "CudnnFusedConvRewriterHloTest");
}
};
...
class CudnnFusedConvRewriterTest : public GpuCodegenTest {
 protected:
  std::string GetOptimizedHlo(absl::string_view hlo_string) {
   ...
   mht_1_v.push_back("hlo_string: \"" + std::string(hlo_string.data(), hlo_string.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc mht_1(mht_1_v, 234, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter_test.cc", "GetOptimizedHlo");
  ...
  void TestMatchWithAllTypes(absl::string_view hlo_string) {
   ...
   mht_2_v.push_back("hlo_string: \"" + std::string(hlo_string.data(), hlo_string.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc mht_2(mht_2_v, 262, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter_test.cc", "TestMatchWithAllTypes");
  ...
  void TestClamp(absl::string_view pre_hlo_string,
   ...
   mht_3_v.push_back("pre_hlo_string: \"" + std::string(pre_hlo_string.data(), pre_hlo_string.size()) + "\"");
   mht_3_v.push_back("post_hlo_string: \"" + std::string(post_hlo_string.data(), post_hlo_string.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc mht_3(mht_3_v, 283, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter_test.cc", "TestClamp");
  ...
  void TestNotMatchWithAllTypes(absl::string_view hlo_string) {
   ...
   mht_4_v.push_back("hlo_string: \"" + std::string(hlo_string.data(), hlo_string.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_fused_conv_rewriter_testDTcc mht_4(mht_4_v, 303, "", "./tensorflow/compiler/xla/service/gpu/cudnn_fused_conv_rewriter_test.cc", "TestNotMatchWithAllTypes");
