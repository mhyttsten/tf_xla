...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh() {
      // Check if tracing is enabled
...
class IrEmitterUnnested : public IrEmitter {
 public:
  ...
  struct ThreadIdInfo {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh mht_0(mht_0_v, 253, "", "./tensorflow/compiler/xla/service/gpu/ir_emitter_unnested.h", "ThreadIdInfo");
}
  ...
  absl::string_view platform_name() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh mht_1(mht_1_v, 286, "", "./tensorflow/compiler/xla/service/gpu/ir_emitter_unnested.h", "platform_name");
 ...
 private:
  ...
  void AddThunkToThunkSequence(std::unique_ptr<Thunk> thunk) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh mht_2(mht_2_v, 389, "", "./tensorflow/compiler/xla/service/gpu/ir_emitter_unnested.h", "AddThunkToThunkSequence");
  ...
  int64_t ByteSizeOf(const Shape& shape) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh mht_3(mht_3_v, 515, "", "./tensorflow/compiler/xla/service/gpu/ir_emitter_unnested.h", "ByteSizeOf");
  ...
  Thunk* LastThunk() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSir_emitter_unnestedDTh mht_4(mht_4_v, 893, "", "./tensorflow/compiler/xla/service/gpu/ir_emitter_unnested.h", "LastThunk");
 return thunk_sequence_.back().get(); }
