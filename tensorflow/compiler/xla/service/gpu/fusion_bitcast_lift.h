...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSfusion_bitcast_liftDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSfusion_bitcast_liftDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSfusion_bitcast_liftDTh() {
      // Check if tracing is enabled
...
class FusionBitcastLift : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSfusion_bitcast_liftDTh mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/gpu/fusion_bitcast_lift.h", "name");
 return "fusion_bitcast_lift"; }
