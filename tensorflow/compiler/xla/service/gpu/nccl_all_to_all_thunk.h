...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh() {
      // Check if tracing is enabled
...
class NcclAllToAllThunk : public NcclCollectiveThunk {
 public:
  ...
  static const char* GetName() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_to_all_thunk.h", "GetName");
 return "AllToAll"; }
  static bool IsDegenerate(mlir::lmhlo::AllToAllOp op, int64_t replica_count,
                           int64_t partition_count) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh mht_1(mht_1_v, 218, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_to_all_thunk.h", "IsDegenerate");
  ...
  static CollectiveOpGroupMode GetGroupMode(mlir::lmhlo::AllToAllOp op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh mht_2(mht_2_v, 226, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_to_all_thunk.h", "GetGroupMode");
 ...
 protected:
  ...
  const NcclCollectiveConfig& config() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_to_all_thunkDTh mht_3(mht_3_v, 237, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_to_all_thunk.h", "config");
