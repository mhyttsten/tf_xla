...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_input_fusionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_input_fusionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_input_fusionDTh() {
      // Check if tracing is enabled
...
class GpuHorizontalInputFusion : public HloModulePass {
 public:
  GpuHorizontalInputFusion() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_input_fusionDTh mht_0(mht_0_v, 210, "", "./tensorflow/compiler/xla/service/gpu/horizontal_input_fusion.h", "GpuHorizontalInputFusion");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_input_fusionDTh mht_1(mht_1_v, 215, "", "./tensorflow/compiler/xla/service/gpu/horizontal_input_fusion.h", "name");
