...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStree_reduction_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStree_reduction_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStree_reduction_rewriterDTh() {
      // Check if tracing is enabled
...
class GpuTreeReductionRewriter : public HloModulePass {
 public:
  explicit GpuTreeReductionRewriter(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStree_reduction_rewriterDTh mht_0(mht_0_v, 249, "", "./tensorflow/compiler/xla/service/gpu/tree_reduction_rewriter.h", "GpuTreeReductionRewriter");
}

  ~GpuTreeReductionRewriter() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStree_reduction_rewriterDTh mht_1(mht_1_v, 255, "", "./tensorflow/compiler/xla/service/gpu/tree_reduction_rewriter.h", "name");
