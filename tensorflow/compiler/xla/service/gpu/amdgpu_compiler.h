...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSamdgpu_compilerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSamdgpu_compilerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSamdgpu_compilerDTh() {
      // Check if tracing is enabled
...
class AMDGPUCompiler : public GpuCompiler {
 public:
  ...
  ~AMDGPUCompiler() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSamdgpu_compilerDTh mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/gpu/amdgpu_compiler.h", "~AMDGPUCompiler");
}
