...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc() {
      // Check if tracing is enabled
...
static HloInstruction* PadInstruction(HloInstruction* instr,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "PadInstruction");
...
static Status PadConv(HloCustomCallInstruction* conv,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_1(mht_1_v, 245, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "PadConv");
  ...
  auto add = [&](std::unique_ptr<HloInstruction> new_instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_2(mht_2_v, 266, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "lambda");
...
static StatusOr<bool> TryResolvePaddedShapesForTensorCore(
  ...
  if (input_features == 3 && (output_features == 32 || output_features == 64)) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_3(mht_3_v, 414, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_4(mht_4_v, 439, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "lambda");
...
StatusOr<bool> TryResolvePaddedShapesForIntegerConvolution(
  ...
  // Pad the features to multiples of pad_to.
  {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_5(mht_5_v, 542, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_6(mht_6_v, 615, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "lambda");
...
StatusOr<bool> CudnnPadForConvolutions::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_pad_for_convolutionsDTcc mht_7(mht_7_v, 656, "", "./tensorflow/compiler/xla/service/gpu/cudnn_pad_for_convolutions.cc", "CudnnPadForConvolutions::Run");
