...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinfeed_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinfeed_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinfeed_thunkDTcc() {
      // Check if tracing is enabled
...
InfeedThunk::InfeedThunk(ThunkInfo thunk_info,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinfeed_thunkDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/gpu/infeed_thunk.cc", "InfeedThunk::InfeedThunk");
}

Status InfeedThunk::ExecuteOnStream(const ExecuteParams& params) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinfeed_thunkDTcc mht_1(mht_1_v, 205, "", "./tensorflow/compiler/xla/service/gpu/infeed_thunk.cc", "InfeedThunk::ExecuteOnStream");
