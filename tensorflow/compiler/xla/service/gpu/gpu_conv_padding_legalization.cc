...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc() {
      // Check if tracing is enabled
...
bool IsForwardConvolutionCanonical(const HloInstruction& conv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "IsForwardConvolutionCanonical");
...
HloInstruction* MaybePaddedAndSlicedInput(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_1(mht_1_v, 222, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "MaybePaddedAndSlicedInput");
...
HloInstruction* MaybePaddedKernel(const Window& conv_window,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_2(mht_2_v, 300, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "MaybePaddedKernel");
...
bool GpuConvPaddingLegalization::CanonicalizeForwardConvolution(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_3(mht_3_v, 328, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "GpuConvPaddingLegalization::CanonicalizeForwardConvolution");
...
void IncreasePaddingLowBy(int64_t delta, WindowDimension* window_dim) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_4(mht_4_v, 374, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "IncreasePaddingLowBy");
...
void IncreasePaddingHighBy(int64_t delta, WindowDimension* window_dim) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_5(mht_5_v, 381, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "IncreasePaddingHighBy");
...
bool GpuConvPaddingLegalization::CanonicalizeBackwardFilterConvolution(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_6(mht_6_v, 390, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "GpuConvPaddingLegalization::CanonicalizeBackwardFilterConvolution");
...
bool GpuConvPaddingLegalization::CanonicalizeBackwardInputConvolution(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_7(mht_7_v, 466, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "GpuConvPaddingLegalization::CanonicalizeBackwardInputConvolution");
...
StatusOr<bool> GpuConvPaddingLegalization::RunOnComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_8(mht_8_v, 595, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "GpuConvPaddingLegalization::RunOnComputation");
...
StatusOr<bool> GpuConvPaddingLegalization::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTcc mht_9(mht_9_v, 623, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.cc", "GpuConvPaddingLegalization::Run");
