...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc() {
      // Check if tracing is enabled
...
int64_t FindMissingDnum(absl::Span<const int64_t> vals) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_0(mht_0_v, 229, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "FindMissingDnum");
...
absl::Mutex& GetGpuMutex(const se::StreamExecutor* stream_exec) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_1(mht_1_v, 490, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "GetGpuMutex");
...
Status ExecuteKernelOnStream(const se::KernelBase& kernel,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_2(mht_2_v, 539, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "ExecuteKernelOnStream");
...
typename std::enable_if<std::is_floating_point<T>::value,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_3(mht_3_v, 575, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "UniformDistribution");
...
static void InitializeTypedBuffer(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_4(mht_4_v, 585, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "InitializeTypedBuffer");
...
void InitializeBuffer(se::Stream* stream, PrimitiveType buffer_type,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_5(mht_5_v, 640, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "InitializeBuffer");
...
bool RequireDeterminism(const HloModuleConfig& config) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_executor_utilDTcc mht_6(mht_6_v, 705, "", "./tensorflow/compiler/xla/service/gpu/stream_executor_util.cc", "RequireDeterminism");
