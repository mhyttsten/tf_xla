...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStriangular_solve_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStriangular_solve_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStriangular_solve_rewriterDTh() {
      // Check if tracing is enabled
...
class TriangularSolveRewriter : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStriangular_solve_rewriterDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/gpu/triangular_solve_rewriter.h", "name");
