...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysisDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysisDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysisDTh() {
      // Check if tracing is enabled
...
class GpuHloCostAnalysis : public HloCostAnalysis {
 public:
  explicit GpuHloCostAnalysis(const Options& options)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysisDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/service/gpu/gpu_hlo_cost_analysis.h", "GpuHloCostAnalysis");
}
