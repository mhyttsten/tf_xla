...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScublas_cudnnDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScublas_cudnnDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScublas_cudnnDTcc() {
      // Check if tracing is enabled
...
bool IsCublasGemm(const HloInstruction& hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScublas_cudnnDTcc mht_0(mht_0_v, 190, "", "./tensorflow/compiler/xla/service/gpu/cublas_cudnn.cc", "IsCublasGemm");
...
bool IsCustomCallToDnnConvolution(const HloInstruction& hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScublas_cudnnDTcc mht_1(mht_1_v, 208, "", "./tensorflow/compiler/xla/service/gpu/cublas_cudnn.cc", "IsCustomCallToDnnConvolution");
...
std::string CudnnConvKindToString(CudnnConvKind kind) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScublas_cudnnDTcc mht_2(mht_2_v, 240, "", "./tensorflow/compiler/xla/service/gpu/cublas_cudnn.cc", "CudnnConvKindToString");
