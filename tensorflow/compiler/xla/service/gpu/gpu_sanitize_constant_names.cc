...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_sanitize_constant_namesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_sanitize_constant_namesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_sanitize_constant_namesDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> GpuSanitizeConstantNames::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_sanitize_constant_namesDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/gpu/gpu_sanitize_constant_names.cc", "GpuSanitizeConstantNames::Run");
