...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSconvolution_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSconvolution_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSconvolution_thunkDTcc() {
      // Check if tracing is enabled
...
ConvolutionThunk::ConvolutionThunk(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSconvolution_thunkDTcc mht_0(mht_0_v, 210, "", "./tensorflow/compiler/xla/service/gpu/convolution_thunk.cc", "ConvolutionThunk::ConvolutionThunk");
}

MaybeFusedConvRunner& ConvolutionThunk::GetOrCreateRunner(
    const stream_executor::Stream* stream) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSconvolution_thunkDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/service/gpu/convolution_thunk.cc", "ConvolutionThunk::GetOrCreateRunner");
...
Status ConvolutionThunk::ExecuteOnStream(const ExecuteParams& params) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSconvolution_thunkDTcc mht_2(mht_2_v, 230, "", "./tensorflow/compiler/xla/service/gpu/convolution_thunk.cc", "ConvolutionThunk::ExecuteOnStream");
