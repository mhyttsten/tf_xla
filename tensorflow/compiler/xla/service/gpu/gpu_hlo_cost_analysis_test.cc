...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysis_testDTcc() {
      // Check if tracing is enabled
...
int64_t ShapeSize(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_cost_analysis_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/xla/service/gpu/gpu_hlo_cost_analysis_test.cc", "ShapeSize");
