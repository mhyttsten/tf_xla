...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScustom_call_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScustom_call_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScustom_call_thunkDTcc() {
      // Check if tracing is enabled
...
CustomCallThunk::CustomCallThunk(ThunkInfo thunk_info,
   ...
   mht_0_v.push_back("opaque: \"" + opaque + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScustom_call_thunkDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/service/gpu/custom_call_thunk.cc", "CustomCallThunk::CustomCallThunk");
}

Status CustomCallThunk::ExecuteOnStream(const ExecuteParams& params) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScustom_call_thunkDTcc mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/service/gpu/custom_call_thunk.cc", "CustomCallThunk::ExecuteOnStream");
