...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_rewriterDTh() {
      // Check if tracing is enabled
...
class GemmRewriter : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_rewriterDTh mht_0(mht_0_v, 214, "", "./tensorflow/compiler/xla/service/gpu/gemm_rewriter.h", "name");
 return "cublas-gemm-rewriter"; }
