...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSpred_arithmetic_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSpred_arithmetic_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSpred_arithmetic_testDTcc() {
      // Check if tracing is enabled
...
class PredArithmeticTest : public GpuCodegenTest {
 protected:
  void RunAndCompareTruthTable(const char* const hlo_text) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSpred_arithmetic_testDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/xla/service/gpu/tests/pred_arithmetic_test.cc", "RunAndCompareTruthTable");
