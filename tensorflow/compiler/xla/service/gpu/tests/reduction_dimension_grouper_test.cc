...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSreduction_dimension_grouper_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSreduction_dimension_grouper_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSreduction_dimension_grouper_testDTcc() {
      // Check if tracing is enabled
...
class ReductionDimensionGrouperTest : public GpuCodegenTest {
  DebugOptions GetDebugOptionsForTest() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSreduction_dimension_grouper_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/gpu/tests/reduction_dimension_grouper_test.cc", "GetDebugOptionsForTest");
