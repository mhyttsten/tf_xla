...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_reduce_scatter_creator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_reduce_scatter_creator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_reduce_scatter_creator_testDTcc() {
      // Check if tracing is enabled
...
class GpuReduceScatterCreatorTest : public HloTestBase {
 public:
  ...
  size_t AllReduceCount(std::unique_ptr<HloModule> &module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_reduce_scatter_creator_testDTcc mht_0(mht_0_v, 226, "", "./tensorflow/compiler/xla/service/gpu/tests/gpu_reduce_scatter_creator_test.cc", "AllReduceCount");
