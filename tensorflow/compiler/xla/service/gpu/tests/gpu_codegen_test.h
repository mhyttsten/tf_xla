...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_codegen_testDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_codegen_testDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_codegen_testDTh() {
      // Check if tracing is enabled
...
class GpuCodegenTest : public LlvmIrGenTestBase {
 public:
  GpuCodegenTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_codegen_testDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/gpu/tests/gpu_codegen_test.h", "GpuCodegenTest");
}
