...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_copy_alone_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_copy_alone_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_copy_alone_testDTcc() {
      // Check if tracing is enabled
...
class CopyAloneNoOptTest : public GpuCodegenTest {
  DebugOptions GetDebugOptionsForTest() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPStestsPSgpu_copy_alone_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/gpu/tests/gpu_copy_alone_test.cc", "GetDebugOptionsForTest");
