...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmulti_output_fusion_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmulti_output_fusion_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmulti_output_fusion_testDTcc() {
      // Check if tracing is enabled
...
static int64_t CountMultiOutputFusions(const HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmulti_output_fusion_testDTcc mht_0(mht_0_v, 217, "", "./tensorflow/compiler/xla/service/gpu/multi_output_fusion_test.cc", "CountMultiOutputFusions");
...
TEST_F(MultiOutputFusionTest, AvoidsLargeFusion) {
  ...
  auto make_fusion = [&](HloInstruction* x, HloInstruction* y) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSmulti_output_fusion_testDTcc mht_1(mht_1_v, 911, "", "./tensorflow/compiler/xla/service/gpu/multi_output_fusion_test.cc", "lambda");
