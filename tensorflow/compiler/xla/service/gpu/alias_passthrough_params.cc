...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> AliasPassthroughParams::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSalias_passthrough_paramsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/compiler/xla/service/gpu/alias_passthrough_params.cc", "AliasPassthroughParams::Run");
