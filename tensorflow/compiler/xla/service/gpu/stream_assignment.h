...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_assignmentDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_assignmentDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_assignmentDTh() {
      // Check if tracing is enabled
...
class StreamAssignment {
 public:
  int StreamCount() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSstream_assignmentDTh mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/service/gpu/stream_assignment.h", "StreamCount");
