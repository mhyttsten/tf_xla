...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc() {
      // Check if tracing is enabled
...
bool ElementIsF32OrF16(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.cc", "ElementIsF32OrF16");
...
/*static*/ bool GpuInstructionFusion::IsExpensive(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.cc", "GpuInstructionFusion::IsExpensive");
...
FusionDecision GpuInstructionFusion::ShouldFuseInexpensiveChecks(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc mht_2(mht_2_v, 234, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.cc", "GpuInstructionFusion::ShouldFuseInexpensiveChecks");
...
FusionDecision GpuInstructionFusion::ShouldFuse(HloInstruction* consumer,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc mht_3(mht_3_v, 263, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.cc", "GpuInstructionFusion::ShouldFuse");
...
HloInstruction::FusionKind GpuInstructionFusion::ChooseKind(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc mht_4(mht_4_v, 304, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.cc", "GpuInstructionFusion::ChooseKind");
...
HloInstruction* GpuInstructionFusion::FuseInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTcc mht_5(mht_5_v, 312, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.cc", "GpuInstructionFusion::FuseInstruction");
