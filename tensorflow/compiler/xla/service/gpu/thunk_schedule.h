...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh() {
      // Check if tracing is enabled
...
class ThunkSchedule {
 public:
  ...
  const ThunkSequence& TotalOrder() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh mht_0(mht_0_v, 230, "", "./tensorflow/compiler/xla/service/gpu/thunk_schedule.h", "TotalOrder");
 return *thunks_; }
  ...
  bool Depended(const Thunk* thunk) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh mht_1(mht_1_v, 238, "", "./tensorflow/compiler/xla/service/gpu/thunk_schedule.h", "Depended");
  ...
  int StreamCount() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh mht_2(mht_2_v, 246, "", "./tensorflow/compiler/xla/service/gpu/thunk_schedule.h", "StreamCount");
  ...
  int StreamNumberForThunk(const Thunk* thunk) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSthunk_scheduleDTh mht_3(mht_3_v, 255, "", "./tensorflow/compiler/xla/service/gpu/thunk_schedule.h", "StreamNumberForThunk");
