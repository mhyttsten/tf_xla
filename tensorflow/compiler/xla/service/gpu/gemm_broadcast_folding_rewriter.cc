...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTcc() {
      // Check if tracing is enabled
...
class GemmBroadcastFoldingVisitor : public DfsHloRewriteVisitor {
 public:
  Status HandleCustomCall(HloInstruction *instr) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/gpu/gemm_broadcast_folding_rewriter.cc", "HandleCustomCall");
...
StatusOr<bool> GemmBroadcastFoldingRewriter::Run(HloModule *module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_broadcast_folding_rewriterDTcc mht_1(mht_1_v, 271, "", "./tensorflow/compiler/xla/service/gpu/gemm_broadcast_folding_rewriter.cc", "GemmBroadcastFoldingRewriter::Run");
