...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTh() {
      // Check if tracing is enabled
...
class GpuConvPaddingLegalization : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_conv_padding_legalizationDTh mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/service/gpu/gpu_conv_padding_legalization.h", "name");
