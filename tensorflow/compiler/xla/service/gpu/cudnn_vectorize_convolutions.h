...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_vectorize_convolutionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_vectorize_convolutionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_vectorize_convolutionsDTh() {
      // Check if tracing is enabled
...
class CudnnVectorizeConvolutions : public HloModulePass {
 public:
  explicit CudnnVectorizeConvolutions(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_vectorize_convolutionsDTh mht_0(mht_0_v, 219, "", "./tensorflow/compiler/xla/service/gpu/cudnn_vectorize_convolutions.h", "CudnnVectorizeConvolutions");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPScudnn_vectorize_convolutionsDTh mht_1(mht_1_v, 224, "", "./tensorflow/compiler/xla/service/gpu/cudnn_vectorize_convolutions.h", "name");
