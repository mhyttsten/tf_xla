...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc() {
      // Check if tracing is enabled
...
class BefThunk : public Thunk {
 public:
  BefThunk(Thunk::Kind kind, ThunkInfo thunk_info,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_0(mht_0_v, 252, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "BefThunk");
}
...
static Status RunLmhloGpuToTfrtConversionPipeline(mlir::ModuleOp module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_1(mht_1_v, 309, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "RunLmhloGpuToTfrtConversionPipeline");
...
static MlirAndTfrtHostCtx GetMlirAndTfrtHostCtx() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_2(mht_2_v, 390, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "GetMlirAndTfrtHostCtx");
...
static Status InsertKernelRequestContext(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_3(mht_3_v, 593, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "InsertKernelRequestContext");
...
Status BefThunk::Initialize(const GpuExecutable& executable,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_4(mht_4_v, 607, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "BefThunk::Initialize");
...
Status BefThunk::ExecuteOnStream(const ExecuteParams& params) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_5(mht_5_v, 630, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "BefThunk::ExecuteOnStream");
...
static Status GetXlirDisabledError() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_6(mht_6_v, 715, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "GetXlirDisabledError");
...
StatusOr<std::unique_ptr<gpu::Thunk>> gpu::CreateBefThunk(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_7(mht_7_v, 724, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "gpu::CreateBefThunk");
...
StatusOr<std::unique_ptr<gpu::Thunk>> gpu::CreateBefCollectiveThunk(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_8(mht_8_v, 733, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "gpu::CreateBefCollectiveThunk");
...
StatusOr<std::unique_ptr<gpu::Thunk>> gpu::CreateBefKernelThunk(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbef_thunkDTcc mht_9(mht_9_v, 742, "", "./tensorflow/compiler/xla/service/gpu/bef_thunk.cc", "gpu::CreateBefKernelThunk");
