...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc() {
      // Check if tracing is enabled
...
/*static*/ NcclAllGatherConfig NcclAllGatherThunk::GetNcclAllGatherConfig(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_gather_thunk.cc", "NcclAllGatherThunk::GetNcclAllGatherConfig");
...
/*static*/ bool NcclAllGatherThunk::CanImplement(mlir::lmhlo::AllGatherOp op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_gather_thunk.cc", "NcclAllGatherThunk::CanImplement");
...
NcclAllGatherThunk::NcclAllGatherThunk(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc mht_2(mht_2_v, 236, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_gather_thunk.cc", "NcclAllGatherThunk::NcclAllGatherThunk");
...
Status NcclAllGatherThunk::RunNcclCollective(const ExecuteParams& params,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_all_gather_thunkDTcc mht_3(mht_3_v, 244, "", "./tensorflow/compiler/xla/service/gpu/nccl_all_gather_thunk.cc", "NcclAllGatherThunk::RunNcclCollective");
