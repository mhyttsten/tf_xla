...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSall_reduce_blueconnectDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSall_reduce_blueconnectDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSall_reduce_blueconnectDTh() {
      // Check if tracing is enabled
...
class AllReduceBlueConnect : public HloModulePass {
 public:
  explicit AllReduceBlueConnect(size_t num_devices_per_host)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSall_reduce_blueconnectDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/gpu/all_reduce_blueconnect.h", "AllReduceBlueConnect");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSall_reduce_blueconnectDTh mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/service/gpu/all_reduce_blueconnect.h", "name");
 return "all-reduce-blueconnect"; }
