...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSoutfeed_managerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSoutfeed_managerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSoutfeed_managerDTcc() {
      // Check if tracing is enabled
...
OutfeedManager *GetOrCreateOutfeedManager(se::StreamExecutor *executor) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSoutfeed_managerDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/gpu/outfeed_manager.cc", "GetOrCreateOutfeedManager");
...
Status OutfeedManager::TransferLiteralFromOutfeed(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSoutfeed_managerDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/service/gpu/outfeed_manager.cc", "OutfeedManager::TransferLiteralFromOutfeed");
