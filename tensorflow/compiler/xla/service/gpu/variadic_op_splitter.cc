...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSvariadic_op_splitterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSvariadic_op_splitterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSvariadic_op_splitterDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> VariadicOpSplitter::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSvariadic_op_splitterDTcc mht_0(mht_0_v, 261, "", "./tensorflow/compiler/xla/service/gpu/variadic_op_splitter.cc", "VariadicOpSplitter::Run");
