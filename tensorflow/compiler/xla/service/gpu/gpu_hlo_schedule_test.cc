...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_schedule_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_schedule_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_schedule_testDTcc() {
      // Check if tracing is enabled
...
class GpuHloScheduleTest : public HloTestBase {
 protected:
  ...
  HloVec RemoveHlo(const HloVec& input,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_hlo_schedule_testDTcc mht_0(mht_0_v, 225, "", "./tensorflow/compiler/xla/service/gpu/gpu_hlo_schedule_test.cc", "RemoveHlo");
