...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTh() {
      // Check if tracing is enabled
...
class ReductionDimensionGrouper : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_dimension_grouperDTh mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/gpu/reduction_dimension_grouper.h", "name");
