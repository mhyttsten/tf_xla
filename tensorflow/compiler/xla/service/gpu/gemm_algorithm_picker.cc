...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_algorithm_pickerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_algorithm_pickerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_algorithm_pickerDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> GemmAlgorithmPicker::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgemm_algorithm_pickerDTcc mht_0(mht_0_v, 477, "", "./tensorflow/compiler/xla/service/gpu/gemm_algorithm_picker.cc", "GemmAlgorithmPicker::Run");
