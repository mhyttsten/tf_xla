...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_degenerate_dim_removerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_degenerate_dim_removerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_degenerate_dim_removerDTh() {
      // Check if tracing is enabled
...
class ReductionDegenerateDimRemover : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSreduction_degenerate_dim_removerDTh mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/gpu/reduction_degenerate_dim_remover.h", "name");
