...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc() {
      // Check if tracing is enabled
...
PrimitiveType GetUniqueOutputTypeOfFusible(const HloInstruction& fusible) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "GetUniqueOutputTypeOfFusible");
...
class HorizontalLoopFusionImpl {
 public:
  explicit HorizontalLoopFusionImpl(HloComputation* computation)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_1(mht_1_v, 223, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HorizontalLoopFusionImpl");
}

  ~HorizontalLoopFusionImpl() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_2(mht_2_v, 228, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "~HorizontalLoopFusionImpl");
}
 ...
 private:
  ...
  class FusionCandidates {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_3(mht_3_v, 257, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "FusionCandidates");
...
bool IsFusibleCandidate(const HloInstruction& instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_4(mht_4_v, 278, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "IsFusibleCandidate");
...
bool IsProfitableFusionCandidate(const HloInstruction& instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_5(mht_5_v, 318, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "IsProfitableFusionCandidate");
...
bool HasOnlyRowMajorLayout(const HloInstruction& instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_6(mht_6_v, 356, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HasOnlyRowMajorLayout");
...
bool AnyOpndIsParamSharedAmongFusions(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_7(mht_7_v, 380, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "AnyOpndIsParamSharedAmongFusions");
...
void HorizontalLoopFusionImpl::FusionCandidates::Initialize(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_8(mht_8_v, 393, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HorizontalLoopFusionImpl::FusionCandidates::Initialize");
...
HorizontalLoopFusionImpl::FusionCandidates::GetNextSpanOfFusions() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_9(mht_9_v, 461, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HorizontalLoopFusionImpl::FusionCandidates::GetNextSpanOfFusions");
...
Status HorizontalLoopFusionImpl::CreateFusedComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_10(mht_10_v, 525, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HorizontalLoopFusionImpl::CreateFusedComputation");
...
Status HorizontalLoopFusionImpl::Fuse(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_11(mht_11_v, 640, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HorizontalLoopFusionImpl::Fuse");
...
StatusOr<bool> HorizontalLoopFusionImpl::Run() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_12(mht_12_v, 685, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "HorizontalLoopFusionImpl::Run");
...
StatusOr<bool> GpuHorizontalLoopFusion::RunOnComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_13(mht_13_v, 735, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "GpuHorizontalLoopFusion::RunOnComputation");
...
StatusOr<bool> GpuHorizontalLoopFusion::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPShorizontal_loop_fusionDTcc mht_14(mht_14_v, 743, "", "./tensorflow/compiler/xla/service/gpu/horizontal_loop_fusion.cc", "GpuHorizontalLoopFusion::Run");
