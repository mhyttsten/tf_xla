...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_transfer_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_transfer_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_transfer_managerDTh() {
      // Check if tracing is enabled
...
class GpuTransferManager : public GenericTransferManager {
 public:
  ...
  ~GpuTransferManager() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_transfer_managerDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/gpu/gpu_transfer_manager.h", "~GpuTransferManager");
}
