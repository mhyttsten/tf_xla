...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTh() {
      // Check if tracing is enabled
...
class GpuInstructionFusion : public InstructionFusion {
 public:
  explicit GpuInstructionFusion(bool may_duplicate)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSinstruction_fusionDTh mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/service/gpu/instruction_fusion.h", "GpuInstructionFusion");
}
