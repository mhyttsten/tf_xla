...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbuffer_comparatorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbuffer_comparatorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbuffer_comparatorDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> BufferComparator::CompareEqual(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbuffer_comparatorDTcc mht_0(mht_0_v, 932, "", "./tensorflow/compiler/xla/service/gpu/buffer_comparator.cc", "BufferComparator::CompareEqual");
...
BufferComparator::BufferComparator(const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbuffer_comparatorDTcc mht_1(mht_1_v, 962, "", "./tensorflow/compiler/xla/service/gpu/buffer_comparator.cc", "BufferComparator::BufferComparator");
  ...
  auto double_dim_size = [&]() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSbuffer_comparatorDTcc mht_2(mht_2_v, 968, "", "./tensorflow/compiler/xla/service/gpu/buffer_comparator.cc", "lambda");
