...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh() {
      // Check if tracing is enabled
...
class Lockable {
 public:
  ...
  explicit Lockable(T value = T()) : value_(std::move(value)) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh mht_0(mht_0_v, 256, "", "./tensorflow/compiler/xla/service/gpu/nccl_utils.h", "Lockable");
}

  Lock Acquire() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh mht_1(mht_1_v, 261, "", "./tensorflow/compiler/xla/service/gpu/nccl_utils.h", "Acquire");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh mht_2(mht_2_v, 269, "", "./tensorflow/compiler/xla/service/gpu/nccl_utils.h", "lambda");
...
struct NcclComm : public Lockable<ncclComm_t> {
  NcclComm() : Lockable(nullptr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSnccl_utilsDTh mht_3(mht_3_v, 288, "", "./tensorflow/compiler/xla/service/gpu/nccl_utils.h", "NcclComm");
}
};
