...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_layout_assignmentDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_layout_assignmentDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_layout_assignmentDTcc() {
      // Check if tracing is enabled
...
Status GpuLayoutAssignment::AddBackendConstraintsToDnnConvCustomCall(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_layout_assignmentDTcc mht_0(mht_0_v, 310, "", "./tensorflow/compiler/xla/service/gpu/gpu_layout_assignment.cc", "GpuLayoutAssignment::AddBackendConstraintsToDnnConvCustomCall");
...
static void SetFortranLayout(Shape* shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_layout_assignmentDTcc mht_1(mht_1_v, 387, "", "./tensorflow/compiler/xla/service/gpu/gpu_layout_assignment.cc", "SetFortranLayout");
...
Status GpuLayoutAssignment::AddBackendConstraints(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSgpuPSgpu_layout_assignmentDTcc mht_2(mht_2_v, 399, "", "./tensorflow/compiler/xla/service/gpu/gpu_layout_assignment.cc", "GpuLayoutAssignment::AddBackendConstraints");
