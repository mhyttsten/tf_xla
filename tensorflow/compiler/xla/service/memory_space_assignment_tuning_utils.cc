...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_tuning_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_tuning_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_tuning_utilsDTcc() {
      // Check if tracing is enabled
...
void CustomizeSortedBufferInterval(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_tuning_utilsDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/xla/service/memory_space_assignment_tuning_utils.cc", "CustomizeSortedBufferInterval");
