...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_invariant_code_motionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_invariant_code_motionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_invariant_code_motionDTh() {
      // Check if tracing is enabled
...
class WhileLoopInvariantCodeMotion : public HloModulePass {
 public:
  ...
  explicit WhileLoopInvariantCodeMotion(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_invariant_code_motionDTh mht_0(mht_0_v, 232, "", "./tensorflow/compiler/xla/service/while_loop_invariant_code_motion.h", "WhileLoopInvariantCodeMotion");
}
  ~WhileLoopInvariantCodeMotion() override = default;

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_invariant_code_motionDTh mht_1(mht_1_v, 238, "", "./tensorflow/compiler/xla/service/while_loop_invariant_code_motion.h", "name");
