...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc() {
      // Check if tracing is enabled
...
class ListScheduler {
 public:
  ...
  static bool IgnoreInstruction(const HloInstruction& instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_0(mht_0_v, 262, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "IgnoreInstruction");
 ...
 private:
  ...
  ListScheduler(HloComputation* computation,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_1(mht_1_v, 286, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "ListScheduler");
  ...
  static bool IgnoreBuffer(const LogicalBuffer& buffer) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_2(mht_2_v, 333, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "IgnoreBuffer");
  ...
  ReadyListEntry MakeReadyListEntry(HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_3(mht_3_v, 358, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "MakeReadyListEntry");
  ...
  int64_t BytesFreedIfScheduled(const ReadyListEntry& entry) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_4(mht_4_v, 394, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "BytesFreedIfScheduled");
  ...
  Priority GetPriority(const ReadyListEntry& entry) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_5(mht_5_v, 445, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "GetPriority");
  ...
  HloInstructionSequence CreateSchedule() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_6(mht_6_v, 459, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "CreateSchedule");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_7(mht_7_v, 487, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_8(mht_8_v, 528, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "lambda");
...
int64_t SumLogicalBufferSizes(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_9(mht_9_v, 601, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "SumLogicalBufferSizes");
...
ModuleSchedulerAlgorithm ComputationSchedulerToModuleScheduler(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_10(mht_10_v, 727, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "ComputationSchedulerToModuleScheduler");
...
HloMemoryScheduler::HloMemoryScheduler(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_11(mht_11_v, 957, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "HloMemoryScheduler::HloMemoryScheduler");
}

StatusOr<bool> HloMemoryScheduler::Run(HloModule* module) {
   std::vector<std::string> mht_12_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_12(mht_12_v, 962, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "HloMemoryScheduler::Run");
...
StatusOr<bool> HloTrivialScheduler::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_13(mht_13_v, 972, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "HloTrivialScheduler::Run");
...
StatusOr<bool> HloDescheduler::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_memory_schedulerDTcc mht_14(mht_14_v, 994, "", "./tensorflow/compiler/xla/service/hlo_memory_scheduler.cc", "HloDescheduler::Run");
