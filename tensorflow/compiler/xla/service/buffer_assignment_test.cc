...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc() {
      // Check if tracing is enabled
...
class InstructionListVisitor : public DfsHloVisitorWithDefault {
 public:
  explicit InstructionListVisitor(const HloInstruction* root) : root_(root) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_0(mht_0_v, 227, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "InstructionListVisitor");
}

  Status DefaultAction(HloInstruction* hlo) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_1(mht_1_v, 232, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "DefaultAction");
...
class BufferAssignmentTest : public HloTestBase {
 protected:
  ~BufferAssignmentTest() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_2(mht_2_v, 264, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "~BufferAssignmentTest");
}
  ...
  std::unique_ptr<BufferAssignment> RunBufferAssignmentNoBuffersReuseForAdd(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_3(mht_3_v, 303, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "lambda");
  ...
  const BufferAllocation& GetAssignedInputAllocation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_4(mht_4_v, 449, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "GetAssignedInputAllocation");
  ...
  const BufferAllocation& GetAssignedOutputAllocation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_5(mht_5_v, 463, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "GetAssignedOutputAllocation");
  ...
  const BufferAllocation& GetAllocation(const BufferAssignment& buffers,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_6(mht_6_v, 475, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "GetAllocation");
  ...
  const BufferAllocation& GetTopLevelAllocation(const BufferAssignment& buffers,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_7(mht_7_v, 482, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "GetTopLevelAllocation");
  ...
  int64_t ValidateBuffers(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_8(mht_8_v, 497, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "ValidateBuffers");
...
static bool BuffersDistinct(const std::vector<const HloInstruction*>& a,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_9(mht_9_v, 535, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "BuffersDistinct");
...
TEST_F(BufferAssignmentTest, BasicUniquelyColored) {
  ...
  auto colorer = [](HloAliasAnalysis* alias_analysis, const HloOrdering&) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_10(mht_10_v, 803, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "lambda");
...
TEST_F(BufferAssignmentTest, BasicPartiallyColored) {
  ...
  auto colorer = [](HloAliasAnalysis* alias_analysis, const HloOrdering&) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_11(mht_11_v, 872, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "lambda");
...
class WhileBufferAssignmentTest : public HloTestBase {
 protected:
  ...
  static int64_t ByteSizeOf(const BufferValue& buffer) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_12(mht_12_v, 2374, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "ByteSizeOf");
...
static void RunCopyInsertion(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_13(mht_13_v, 2386, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "RunCopyInsertion");
...
TEST_F(WhileBufferAssignmentTest, ColocatedBuffers) {
  ...
  auto build_cond = [&]() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_14(mht_14_v, 2612, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "lambda");
  ...
  auto build_body = [&]() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbuffer_assignment_testDTcc mht_15(mht_15_v, 2628, "", "./tensorflow/compiler/xla/service/buffer_assignment_test.cc", "lambda");
