...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_mergerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_mergerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_mergerDTh() {
      // Check if tracing is enabled
...
class DotMerger : public HloModulePass {
 public:
  explicit DotMerger(int64_t max_size_to_merge)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_mergerDTh mht_0(mht_0_v, 226, "", "./tensorflow/compiler/xla/service/dot_merger.h", "DotMerger");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdot_mergerDTh mht_1(mht_1_v, 231, "", "./tensorflow/compiler/xla/service/dot_merger.h", "name");
 return "dot-merger"; }
