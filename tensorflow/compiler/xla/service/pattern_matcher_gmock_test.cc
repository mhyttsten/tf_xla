...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_gmock_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_gmock_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_gmock_testDTcc() {
      // Check if tracing is enabled
...
std::string Describe(const ::testing::Matcher<MatchedTy>& m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_gmock_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/xla/service/pattern_matcher_gmock_test.cc", "Describe");
...
std::string Explain(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSpattern_matcher_gmock_testDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/service/pattern_matcher_gmock_test.cc", "Explain");
