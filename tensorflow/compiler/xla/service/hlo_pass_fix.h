...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_pass_fixDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_pass_fixDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_pass_fixDTh() {
      // Check if tracing is enabled
...
class HloPassFix : public Pass {
 public:
  ...
  Status RunOnChangedComputations(HloModule* module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_pass_fixDTh mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/hlo_pass_fix.h", "RunOnChangedComputations");
 ...
 private:
  Status RunToFixPoint(HloModule* module, RunState* run_state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_pass_fixDTh mht_1(mht_1_v, 251, "", "./tensorflow/compiler/xla/service/hlo_pass_fix.h", "RunToFixPoint");
  ...
  Status RunOnChangedComputationsOnce(HloModule* module, RunState* run_state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_pass_fixDTh mht_2(mht_2_v, 274, "", "./tensorflow/compiler/xla/service/hlo_pass_fix.h", "RunOnChangedComputationsOnce");
