...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_verifierDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_verifierDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_verifierDTh() {
      // Check if tracing is enabled
...
class HloDomainVerifier : public HloModulePass {
 public:
  HloDomainVerifier(std::vector<std::string> kinds)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_verifierDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/hlo_domain_verifier.h", "HloDomainVerifier");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_verifierDTh mht_1(mht_1_v, 209, "", "./tensorflow/compiler/xla/service/hlo_domain_verifier.h", "name");
 return "domain_verifier"; }
