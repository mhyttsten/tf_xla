...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_testDTcc() {
      // Check if tracing is enabled
...
bool IsTrivialCollectivePermute(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_testDTcc mht_0(mht_0_v, 9651, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_test.cc", "IsTrivialCollectivePermute");
