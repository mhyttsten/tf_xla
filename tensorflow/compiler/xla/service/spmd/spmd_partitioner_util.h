...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh() {
      // Check if tracing is enabled
...
HloInstruction* CreateR0WithType(PrimitiveType type, NativeT value,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_0(mht_0_v, 223, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "CreateR0WithType");
...
inline HloInstruction* CreateFirstWithType(PrimitiveType type, SpmdBuilder* b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_1(mht_1_v, 233, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "CreateFirstWithType");
...
inline HloInstruction* CreateLastWithType(PrimitiveType type, SpmdBuilder* b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_2(mht_2_v, 245, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "CreateLastWithType");
...
class MultiplyAddDivideOffsetCalculation {
 public:
  MultiplyAddDivideOffsetCalculation()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_3(mht_3_v, 319, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "MultiplyAddDivideOffsetCalculation");
}
  ...
  bool IsConstant() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_4(mht_4_v, 334, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "IsConstant");
...
class OffsetCalculation {
 public:
  OffsetCalculation() : opcode_(HloOpcode::kCopy), copy_from_() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_5(mht_5_v, 358, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "OffsetCalculation");
}
  explicit OffsetCalculation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_6(mht_6_v, 364, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "OffsetCalculation");
}
  OffsetCalculation(const OffsetCalculation& copy_from) {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_7(mht_7_v, 368, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "OffsetCalculation");
 *this = copy_from; }
  OffsetCalculation(HloOpcode opcode,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_8(mht_8_v, 377, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "OffsetCalculation");
}
  OffsetCalculation(HloOpcode opcode, const OffsetCalculation& lhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSspmd_partitioner_utilDTh mht_9(mht_9_v, 385, "", "./tensorflow/compiler/xla/service/spmd/spmd_partitioner_util.h", "OffsetCalculation");
}
