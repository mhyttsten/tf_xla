...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSconvolution_handlerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSconvolution_handlerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSconvolution_handlerDTcc() {
      // Check if tracing is enabled
...
PartitionConvolutionWithSpatialDimensionHaloExchangeOnRHS(
  ...
  auto unsupported_sharding = [&](const HloSharding& lhs_sharding,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSconvolution_handlerDTcc mht_0(mht_0_v, 428, "", "./tensorflow/compiler/xla/service/spmd/convolution_handler.cc", "lambda");
...
PartitionConvolutionWithSpatialDimensionHaloExchangeOnLHS(
  ...
  auto unsupported_sharding = [&](const HloSharding& lhs_sharding,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSconvolution_handlerDTcc mht_1(mht_1_v, 744, "", "./tensorflow/compiler/xla/service/spmd/convolution_handler.cc", "lambda");
...
Status SpmdPartitioningVisitor::HandleConvolution(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSconvolution_handlerDTcc mht_2(mht_2_v, 1164, "", "./tensorflow/compiler/xla/service/spmd/convolution_handler.cc", "SpmdPartitioningVisitor::HandleConvolution");
