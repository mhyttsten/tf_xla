...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSgather_scatter_handlerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSgather_scatter_handlerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSgather_scatter_handlerDTcc() {
      // Check if tracing is enabled
...
bool IsSupportedScatterForIndexUpdatePartitioning(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSgather_scatter_handlerDTcc mht_0(mht_0_v, 251, "", "./tensorflow/compiler/xla/service/spmd/gather_scatter_handler.cc", "IsSupportedScatterForIndexUpdatePartitioning");
...
Status SpmdPartitioningVisitor::HandleScatter(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSgather_scatter_handlerDTcc mht_1(mht_1_v, 876, "", "./tensorflow/compiler/xla/service/spmd/gather_scatter_handler.cc", "SpmdPartitioningVisitor::HandleScatter");
...
Status SpmdPartitioningVisitor::HandleGather(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSgather_scatter_handlerDTcc mht_2(mht_2_v, 1069, "", "./tensorflow/compiler/xla/service/spmd/gather_scatter_handler.cc", "SpmdPartitioningVisitor::HandleGather");
