...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSschedule_aware_collective_ops_cseDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSschedule_aware_collective_ops_cseDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSschedule_aware_collective_ops_cseDTh() {
      // Check if tracing is enabled
...
class ScheduleAwareCollectiveOpsCSE : public HloModulePass {
 public:
  ...
  explicit ScheduleAwareCollectiveOpsCSE(int64_t distance_threshold,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSschedule_aware_collective_ops_cseDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/spmd/schedule_aware_collective_ops_cse.h", "ScheduleAwareCollectiveOpsCSE");
}

  ~ScheduleAwareCollectiveOpsCSE() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSschedule_aware_collective_ops_cseDTh mht_1(mht_1_v, 208, "", "./tensorflow/compiler/xla/service/spmd/schedule_aware_collective_ops_cse.h", "name");
