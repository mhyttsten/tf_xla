...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc() {
      // Check if tracing is enabled
...
HloInstruction* ShuffleWithinEachPartitionUsingOneHot(HloInstruction* hlo,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_0(mht_0_v, 282, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "ShuffleWithinEachPartitionUsingOneHot");
...
HloInstruction* ShuffleDataWithAllToAll(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_1(mht_1_v, 333, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "ShuffleDataWithAllToAll");
...
HloInstruction* GetCorrectionFactor(HloInstruction* hlo, int64_t num_partitions,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_2(mht_2_v, 348, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "GetCorrectionFactor");
  ...
  */
  auto add_hlo = [&](std::unique_ptr<HloInstruction> to_add) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_3(mht_3_v, 359, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "lambda");
...
HloInstruction* GetFinalFftUsingCollectivePermute(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_4(mht_4_v, 411, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "GetFinalFftUsingCollectivePermute");
...
HloInstruction* SliceValidData(HloInstruction* hlo, const Shape& target_shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_5(mht_5_v, 524, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "SliceValidData");
...
Status SpmdPartitioningVisitor::HandleFft(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSfft_handlerDTcc mht_6(mht_6_v, 537, "", "./tensorflow/compiler/xla/service/spmd/fft_handler.cc", "SpmdPartitioningVisitor::HandleFft");
