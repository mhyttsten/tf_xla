...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTh() {
      // Check if tracing is enabled
...
class StatefulRngSpmdPartitioningVisitor
 ...
 public:
  StatefulRngSpmdPartitioningVisitor(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.h", "StatefulRngSpmdPartitioningVisitor");
...
class StatefulRngSpmdPartitioner : public spmd::SpmdPartitioner {
 public:
  StatefulRngSpmdPartitioner(int64_t num_partitions, int64_t num_replicas)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.h", "StatefulRngSpmdPartitioner");
}
 ...
 private:
  static spmd::SpmdPartitionerOptions GetSpmdPartitionerOptions() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTh mht_2(mht_2_v, 236, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.h", "GetSpmdPartitionerOptions");
