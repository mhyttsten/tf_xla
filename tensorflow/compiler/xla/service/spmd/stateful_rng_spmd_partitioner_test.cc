...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitioner_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitioner_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitioner_testDTcc() {
      // Check if tracing is enabled
...
class StatefulRngSpmdPartitionerTest : public HloTestBase {
 public:
  ...
  void VerifyNoAllReduce(HloModule *module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitioner_testDTcc mht_0(mht_0_v, 231, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner_test.cc", "VerifyNoAllReduce");
...
ENTRY entry {
  ...
  auto add_passes = [](HloPassPipeline &pipeline) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitioner_testDTcc mht_1(mht_1_v, 256, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner_test.cc", "lambda");
...
ENTRY entry {
  ...
  auto add_passes = [](HloPassPipeline &pipeline) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitioner_testDTcc mht_2(mht_2_v, 283, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner_test.cc", "lambda");
