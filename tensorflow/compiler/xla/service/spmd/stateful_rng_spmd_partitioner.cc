...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc() {
      // Check if tracing is enabled
...
Status StatefulRngSpmdPartitioningVisitor::HandleRngGetAndUpdateState(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.cc", "StatefulRngSpmdPartitioningVisitor::HandleRngGetAndUpdateState");
...
StatefulRngSpmdPartitioner::CreateVisitor(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc mht_1(mht_1_v, 225, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.cc", "StatefulRngSpmdPartitioner::CreateVisitor");
...
Status StatefulRngSpmdPartitioner::PreprocessSharding(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc mht_2(mht_2_v, 234, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.cc", "StatefulRngSpmdPartitioner::PreprocessSharding");
...
bool StatefulRngSpmdPartitioner::CanSideEffectingHaveReplicatedSharding(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspmdPSstateful_rng_spmd_partitionerDTcc mht_3(mht_3_v, 252, "", "./tensorflow/compiler/xla/service/spmd/stateful_rng_spmd_partitioner.cc", "StatefulRngSpmdPartitioner::CanSideEffectingHaveReplicatedSharding");
