...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc() {
      // Check if tracing is enabled
...
bool IsTableLookup(const HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_0(mht_0_v, 192, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "IsTableLookup");
...
int64_t GetIndexForId(const HloInstruction* index, int64_t id,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_1(mht_1_v, 217, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "GetIndexForId");
...
bool IsPerIdOffsets(absl::Span<const HloInstruction*> offsets,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_2(mht_2_v, 251, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "IsPerIdOffsets");
...
bool IsPerIdOffset(const HloInstruction* offset, int64_t shard_size,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_3(mht_3_v, 308, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "IsPerIdOffset");
...
absl::optional<ReduceScatterSpec> MatchReduceScatter(
  ...
  if (!ar->IsCrossModuleAllReduce()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_4(mht_4_v, 492, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_5(mht_5_v, 521, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_6(mht_6_v, 534, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_utilsDTcc mht_7(mht_7_v, 569, "", "./tensorflow/compiler/xla/service/reduce_scatter_utils.cc", "lambda");
