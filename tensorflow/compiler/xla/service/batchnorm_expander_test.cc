...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expander_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expander_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expander_testDTcc() {
      // Check if tracing is enabled
...
class BatchNormExpanderTest : public HloTestBase {
 protected:
  ...
  int64_t CountGetDimensionSize(const HloModule& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expander_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/batchnorm_expander_test.cc", "CountGetDimensionSize");
