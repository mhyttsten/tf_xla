...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStopk_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStopk_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStopk_rewriterDTh() {
      // Check if tracing is enabled
...
class TopkRewriter : public HloModulePass {
 public:
  explicit TopkRewriter(std::function<bool(const HloSortInstruction*, int64_t)>
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStopk_rewriterDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/topk_rewriter.h", "TopkRewriter");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStopk_rewriterDTh mht_1(mht_1_v, 206, "", "./tensorflow/compiler/xla/service/topk_rewriter.h", "name");
 return "topk-rewriter"; }
