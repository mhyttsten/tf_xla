...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc() {
      // Check if tracing is enabled
...
class MapInlinerVisitor : public DfsHloVisitorWithDefault {
 public:
  explicit MapInlinerVisitor(HloComputation* computation)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/map_inliner.cc", "MapInlinerVisitor");
}

  // Default visitor action is to do nothing and return OK.
  Status DefaultAction(HloInstruction* /*hlo_instruction*/) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/service/map_inliner.cc", "DefaultAction");
...
StatusOr<bool> MapInlinerVisitor::Run(HloComputation* computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc mht_2(mht_2_v, 234, "", "./tensorflow/compiler/xla/service/map_inliner.cc", "MapInlinerVisitor::Run");
...
Status MapInlinerVisitor::HandleMap(HloInstruction* map) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc mht_3(mht_3_v, 244, "", "./tensorflow/compiler/xla/service/map_inliner.cc", "MapInlinerVisitor::HandleMap");
...
StatusOr<bool> MapInliner::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmap_inlinerDTcc mht_4(mht_4_v, 295, "", "./tensorflow/compiler/xla/service/map_inliner.cc", "MapInliner::Run");
