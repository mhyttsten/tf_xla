...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTh() {
      // Check if tracing is enabled
...
class OpExpanderPass : public HloModulePass {
 public:
  ...
  explicit OpExpanderPass(PatternExtraFilter extra_filter = nullptr)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSop_expander_passDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/op_expander_pass.h", "OpExpanderPass");
}
