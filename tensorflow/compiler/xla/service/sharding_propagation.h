...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagationDTh() {
      // Check if tracing is enabled
...
class ShardingPropagation : public HloModulePass {
 public:
  ...
  explicit ShardingPropagation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagationDTh mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/sharding_propagation.h", "ShardingPropagation");
}
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSsharding_propagationDTh mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/service/sharding_propagation.h", "name");
 return "sharding-propagation"; }
