...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc() {
      // Check if tracing is enabled
...
class LayoutAssignmentTest : public HloTestBase {
 protected:
  void AssignLayouts(HloModule* m, ComputationLayout* entry_computation_layout,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc mht_0(mht_0_v, 224, "", "./tensorflow/compiler/xla/service/layout_assignment_test.cc", "AssignLayouts");
  ...
  void ExpectLayoutIs(const Shape& shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc mht_1(mht_1_v, 242, "", "./tensorflow/compiler/xla/service/layout_assignment_test.cc", "ExpectLayoutIs");
  ...
  void ExpectTupleLayoutIs(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc mht_2(mht_2_v, 253, "", "./tensorflow/compiler/xla/service/layout_assignment_test.cc", "ExpectTupleLayoutIs");
...
class OperandsMustBeTheSameLayoutAssignment : public LayoutAssignment {
 public:
  explicit OperandsMustBeTheSameLayoutAssignment(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc mht_3(mht_3_v, 695, "", "./tensorflow/compiler/xla/service/layout_assignment_test.cc", "OperandsMustBeTheSameLayoutAssignment");
}
 ...
 protected:
  Status PropagateBufferConstraint(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc mht_4(mht_4_v, 703, "", "./tensorflow/compiler/xla/service/layout_assignment_test.cc", "PropagateBufferConstraint");
...
Status AssignLayoutsToComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlayout_assignment_testDTcc mht_5(mht_5_v, 1554, "", "./tensorflow/compiler/xla/service/layout_assignment_test.cc", "AssignLayoutsToComputation");
