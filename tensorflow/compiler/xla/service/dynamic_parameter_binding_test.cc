...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc() {
      // Check if tracing is enabled
...
class DynamicParameterBindingTest : public HloTestBase {
 protected:
  ...
  void SerializeAndDeserialize(DynamicParameterBinding* binding) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/dynamic_parameter_binding_test.cc", "SerializeAndDeserialize");
...
ENTRY main {
  ...
  auto test = [&](const DynamicParameterBinding& binding) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc mht_1(mht_1_v, 238, "", "./tensorflow/compiler/xla/service/dynamic_parameter_binding_test.cc", "lambda");
...
ENTRY main {
  ...
  auto test = [&](const DynamicParameterBinding& binding) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc mht_2(mht_2_v, 279, "", "./tensorflow/compiler/xla/service/dynamic_parameter_binding_test.cc", "lambda");
...
ENTRY main {
  ...
  auto test = [&](const DynamicParameterBinding& binding) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_parameter_binding_testDTcc mht_3(mht_3_v, 325, "", "./tensorflow/compiler/xla/service/dynamic_parameter_binding_test.cc", "lambda");
