...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTcc() {
      // Check if tracing is enabled
...
bool IsNonNestedTuple(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/optimize_input_output_buffer_alias.cc", "IsNonNestedTuple");
...
StatusOr<bool> OptimizeInputOutputBufferAlias::Build(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTcc mht_1(mht_1_v, 213, "", "./tensorflow/compiler/xla/service/optimize_input_output_buffer_alias.cc", "OptimizeInputOutputBufferAlias::Build");
...
StatusOr<bool> OptimizeInputOutputBufferAlias::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTcc mht_2(mht_2_v, 264, "", "./tensorflow/compiler/xla/service/optimize_input_output_buffer_alias.cc", "OptimizeInputOutputBufferAlias::Run");
