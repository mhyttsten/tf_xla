...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_input_output_alias_config_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_input_output_alias_config_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_input_output_alias_config_testDTcc() {
      // Check if tracing is enabled
...
class HloInputOutputAliasConfigTest : public HloTestBase {
 protected:
  void expect_aliased(const ShapeIndex& output_index, int64_t param_number,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_input_output_alias_config_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/hlo_input_output_alias_config_test.cc", "expect_aliased");
  ...
  void expect_not_aliased(const ShapeIndex& output_index, int64_t param_number,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_input_output_alias_config_testDTcc mht_1(mht_1_v, 228, "", "./tensorflow/compiler/xla/service/hlo_input_output_alias_config_test.cc", "expect_not_aliased");
