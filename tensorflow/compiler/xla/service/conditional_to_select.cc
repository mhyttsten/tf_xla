...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_to_selectDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_to_selectDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_to_selectDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> ConditionalToSelect::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_to_selectDTcc mht_0(mht_0_v, 234, "", "./tensorflow/compiler/xla/service/conditional_to_select.cc", "ConditionalToSelect::Run");
