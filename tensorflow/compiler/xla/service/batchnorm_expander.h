...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expanderDTh() {
      // Check if tracing is enabled
...
class BatchNormExpander : public HloModulePass {
 public:
  ...
  explicit BatchNormExpander(bool rewrite_training_op = false,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expanderDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/batchnorm_expander.h", "BatchNormExpander");
}
  ~BatchNormExpander() = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbatchnorm_expanderDTh mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/service/batchnorm_expander.h", "name");
