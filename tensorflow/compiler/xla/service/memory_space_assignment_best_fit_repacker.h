...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repackerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repackerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repackerDTh() {
      // Check if tracing is enabled
...
class MemorySpaceAssignmentBestFitRepacker
 ...
 public:
  ...
  explicit MemorySpaceAssignmentBestFitRepacker(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repackerDTh mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/memory_space_assignment_best_fit_repacker.h", "MemorySpaceAssignmentBestFitRepacker");
}
