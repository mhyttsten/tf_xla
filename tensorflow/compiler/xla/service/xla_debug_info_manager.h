...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh() {
      // Check if tracing is enabled
...
class XlaDebugInfoManager {
 public:
  static XlaDebugInfoManager* Get() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh mht_0(mht_0_v, 220, "", "./tensorflow/compiler/xla/service/xla_debug_info_manager.h", "Get");
  ...
  void OnModuleStart(ModuleIdentifier module_id) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh mht_1(mht_1_v, 245, "", "./tensorflow/compiler/xla/service/xla_debug_info_manager.h", "OnModuleStart");
}
  // Register when the module stop execution on certain device.
  void OnModuleStop(ModuleIdentifier module_id) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh mht_2(mht_2_v, 250, "", "./tensorflow/compiler/xla/service/xla_debug_info_manager.h", "OnModuleStop");
}
 ...
 private:
  XlaDebugInfoManager() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh mht_3(mht_3_v, 268, "", "./tensorflow/compiler/xla/service/xla_debug_info_manager.h", "XlaDebugInfoManager");
}
  ...
  struct XlaModuleInstance {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSxla_debug_info_managerDTh mht_4(mht_4_v, 289, "", "./tensorflow/compiler/xla/service/xla_debug_info_manager.h", "XlaModuleInstance");
}
