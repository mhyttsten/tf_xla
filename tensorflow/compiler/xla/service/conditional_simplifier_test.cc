...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_simplifier_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_simplifier_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_simplifier_testDTcc() {
      // Check if tracing is enabled
...
HloComputation* ConditionalSimplifierTest::MakeConditional(HloModule* module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_simplifier_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/xla/service/conditional_simplifier_test.cc", "ConditionalSimplifierTest::MakeConditional");
