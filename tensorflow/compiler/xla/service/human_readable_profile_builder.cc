...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShuman_readable_profile_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShuman_readable_profile_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShuman_readable_profile_builderDTcc() {
      // Check if tracing is enabled
...
std::string HumanReadableProfileBuilder::ToString() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShuman_readable_profile_builderDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/xla/service/human_readable_profile_builder.cc", "HumanReadableProfileBuilder::ToString");
  ...
  auto print_op = [&](const OpInfo& op, bool is_total = false) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShuman_readable_profile_builderDTcc mht_1(mht_1_v, 213, "", "./tensorflow/compiler/xla/service/human_readable_profile_builder.cc", "lambda");
