...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_contiguousDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_contiguousDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_contiguousDTcc() {
      // Check if tracing is enabled
...
Status ReplaceWithContiguousAllReduce(HloAllReduceInstruction* all_reduce) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_contiguousDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/all_reduce_contiguous.cc", "ReplaceWithContiguousAllReduce");
...
StatusOr<bool> AllReduceContiguous::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_contiguousDTcc mht_1(mht_1_v, 258, "", "./tensorflow/compiler/xla/service/all_reduce_contiguous.cc", "AllReduceContiguous::Run");
