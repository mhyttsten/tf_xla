...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_matchers_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_matchers_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_matchers_testDTcc() {
      // Check if tracing is enabled
...
std::string DescribeHloMatcher(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_matchers_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/hlo_matchers_test.cc", "DescribeHloMatcher");
...
std::string Explain(const T& t, const M& m) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_matchers_testDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/service/hlo_matchers_test.cc", "Explain");
