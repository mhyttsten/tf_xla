...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_removerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_removerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_removerDTh() {
      // Check if tracing is enabled
...
class HloDomainRemover : public HloModulePass {
 public:
  ...
  HloDomainRemover(absl::string_view kind,
   ...
   mht_0_v.push_back("kind: \"" + std::string(kind.data(), kind.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_removerDTh mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/hlo_domain_remover.h", "HloDomainRemover");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_removerDTh mht_1(mht_1_v, 218, "", "./tensorflow/compiler/xla/service/hlo_domain_remover.h", "name");
 return "domain_remover"; }
