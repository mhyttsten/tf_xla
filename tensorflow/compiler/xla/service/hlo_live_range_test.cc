...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc() {
      // Check if tracing is enabled
...
class HloLiveRangeTest : public HloTestBase {
 protected:
  HloLiveRangeTest() : module_(CreateNewVerifiedModule()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/hlo_live_range_test.cc", "HloLiveRangeTest");
}
  ~HloLiveRangeTest() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xla/service/hlo_live_range_test.cc", "~HloLiveRangeTest");
}

  void Analyze(const HloSchedule& schedule) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc mht_2(mht_2_v, 217, "", "./tensorflow/compiler/xla/service/hlo_live_range_test.cc", "Analyze");
  ...
  const HloValue* BufferAt(const HloInstruction* instruction,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc mht_3(mht_3_v, 236, "", "./tensorflow/compiler/xla/service/hlo_live_range_test.cc", "BufferAt");
  ...
  void CheckSchedule() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_range_testDTcc mht_4(mht_4_v, 252, "", "./tensorflow/compiler/xla/service/hlo_live_range_test.cc", "CheckSchedule");
