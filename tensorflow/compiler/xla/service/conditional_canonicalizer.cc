...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_canonicalizerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_canonicalizerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_canonicalizerDTcc() {
      // Check if tracing is enabled
...
Status CanonicalizeNonTupleConditional(HloInstruction* conditional) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_canonicalizerDTcc mht_0(mht_0_v, 193, "", "./tensorflow/compiler/xla/service/conditional_canonicalizer.cc", "CanonicalizeNonTupleConditional");
...
StatusOr<bool> ConditionalCanonicalizer::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSconditional_canonicalizerDTcc mht_1(mht_1_v, 218, "", "./tensorflow/compiler/xla/service/conditional_canonicalizer.cc", "ConditionalCanonicalizer::Run");
