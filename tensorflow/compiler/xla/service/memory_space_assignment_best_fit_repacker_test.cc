...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repacker_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repacker_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repacker_testDTcc() {
      // Check if tracing is enabled
...
class MemorySpaceAssignmentBestFitRepackerTest : public ::testing::Test {
 protected:
  ...
  MemorySpaceAssignmentBestFitRepackerTest() : repacker_(100, 1) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repacker_testDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/xla/service/memory_space_assignment_best_fit_repacker_test.cc", "MemorySpaceAssignmentBestFitRepackerTest");
}
  ...
  AllocationBlock* MakeAllocationBlock(int64_t start_time, int64_t end_time,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_best_fit_repacker_testDTcc mht_1(mht_1_v, 202, "", "./tensorflow/compiler/xla/service/memory_space_assignment_best_fit_repacker_test.cc", "MakeAllocationBlock");
