...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdefuserDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdefuserDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdefuserDTcc() {
      // Check if tracing is enabled
...
Status Defuse(HloInstruction* fusion_instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdefuserDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/defuser.cc", "Defuse");
...
StatusOr<bool> Defuser::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdefuserDTcc mht_1(mht_1_v, 263, "", "./tensorflow/compiler/xla/service/defuser.cc", "Defuser::Run");
