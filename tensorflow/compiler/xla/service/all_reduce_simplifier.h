...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTh() {
      // Check if tracing is enabled
...
class AllReduceSimplifier : public HloModulePass {
 public:
  explicit AllReduceSimplifier(int64_t replica_count)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/all_reduce_simplifier.h", "AllReduceSimplifier");
}
  ~AllReduceSimplifier() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSall_reduce_simplifierDTh mht_1(mht_1_v, 206, "", "./tensorflow/compiler/xla/service/all_reduce_simplifier.h", "name");
 return "all-reduce-simp"; }
