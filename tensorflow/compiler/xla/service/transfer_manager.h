...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh() {
      // Check if tracing is enabled
...
class TransferManager {
 public:
  virtual ~TransferManager() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "~TransferManager");
}
  ...
  virtual Shape HostShapeToDeviceShape(const Shape& host_shape) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_1(mht_1_v, 223, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "HostShapeToDeviceShape");
  ...
  Status TransferLiteralFromDevice(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_2(mht_2_v, 263, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "TransferLiteralFromDevice");
  ...
  void TransferLiteralFromDevice(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_3(mht_3_v, 289, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "TransferLiteralFromDevice");
  ...
  Status TransferLiteralToDevice(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_4(mht_4_v, 314, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "TransferLiteralToDevice");
  ...
  Status TransferLiteralToDeviceAsync(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_5(mht_5_v, 343, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "TransferLiteralToDeviceAsync");
  ...
  virtual bool CanShapedBufferBeAccessedNow(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_6(mht_6_v, 462, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "CanShapedBufferBeAccessedNow");
  ...
  virtual bool CanBufferBeAccessedNow(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStransfer_managerDTh mht_7(mht_7_v, 472, "", "./tensorflow/compiler/xla/service/transfer_manager.h", "CanBufferBeAccessedNow");
