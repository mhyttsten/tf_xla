...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposer_testDTcc() {
      // Check if tracing is enabled
...
class ReduceScatterDecomposerTest : public HloTestBase {
 public:
  ...
  void RunPass(
   ...
   mht_0_v.push_back("hlo_module: \"" + std::string(hlo_module.data(), hlo_module.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposer_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/xla/service/reduce_scatter_decomposer_test.cc", "RunPass");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposer_testDTcc mht_1(mht_1_v, 231, "", "./tensorflow/compiler/xla/service/reduce_scatter_decomposer_test.cc", "lambda");
