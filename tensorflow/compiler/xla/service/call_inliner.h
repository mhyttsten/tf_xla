...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScall_inlinerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScall_inlinerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScall_inlinerDTh() {
      // Check if tracing is enabled
...
class CallInliner : public HloModulePass {
 public:
  ...
  explicit CallInliner(bool single_call_site = false,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScall_inlinerDTh mht_0(mht_0_v, 213, "", "./tensorflow/compiler/xla/service/call_inliner.h", "CallInliner");
}
  ~CallInliner() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScall_inlinerDTh mht_1(mht_1_v, 218, "", "./tensorflow/compiler/xla/service/call_inliner.h", "name");
 return "CallInliner"; }
