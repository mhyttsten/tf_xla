...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreal_imag_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreal_imag_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreal_imag_expanderDTcc() {
      // Check if tracing is enabled
...
bool RealImagExpander::InstructionMatchesPattern(HloInstruction* inst) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreal_imag_expanderDTcc mht_0(mht_0_v, 191, "", "./tensorflow/compiler/xla/service/real_imag_expander.cc", "RealImagExpander::InstructionMatchesPattern");
...
StatusOr<HloInstruction*> RealImagExpander::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreal_imag_expanderDTcc mht_1(mht_1_v, 201, "", "./tensorflow/compiler/xla/service/real_imag_expander.cc", "RealImagExpander::ExpandInstruction");
