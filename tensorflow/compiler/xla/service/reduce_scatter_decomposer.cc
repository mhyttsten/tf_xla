...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposerDTcc() {
      // Check if tracing is enabled
...
StatusOr<bool> ReduceScatterDecomposer::Run(HloModule *module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_decomposerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/reduce_scatter_decomposer.cc", "ReduceScatterDecomposer::Run");
