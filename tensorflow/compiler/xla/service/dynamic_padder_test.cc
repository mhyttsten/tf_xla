...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc() {
      // Check if tracing is enabled
...
OpDynamismSupport OpHasDynamismSupport(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_0(mht_0_v, 222, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "OpHasDynamismSupport");
...
Status CustomCallDynamicDimensionInference(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_1(mht_1_v, 236, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "CustomCallDynamicDimensionInference");
...
class DynamicPadderTest : public HloTestBase {
 protected:
  DynamicPadderTest() : HloTestBase() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_2(mht_2_v, 259, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "DynamicPadderTest");
 module_ = CreateNewVerifiedModule(); }
  ...
  void ExpectPadded(const HloInstruction* inst) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_3(mht_3_v, 279, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "ExpectPadded");
  ...
  HloComputation* GetScalarAddComputation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_4(mht_4_v, 288, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "GetScalarAddComputation");
...
class ExecutionTest : public HloTestBase {
 protected:
  ...
  Literal PadAndExecute(std::unique_ptr<HloModule> module,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_5(mht_5_v, 698, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "PadAndExecute");
...
class HloDimensionSizeLegalizerTest : public HloTestBase {
 protected:
  HloDimensionSizeLegalizerTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_6(mht_6_v, 2035, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "HloDimensionSizeLegalizerTest");
}
};
...
class SizeCheckTest : public HloTestBase {
 protected:
  SizeCheckTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSdynamic_padder_testDTcc mht_7(mht_7_v, 2101, "", "./tensorflow/compiler/xla/service/dynamic_padder_test.cc", "SizeCheckTest");
}
};
