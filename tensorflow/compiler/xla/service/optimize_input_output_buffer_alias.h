...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTh() {
      // Check if tracing is enabled
...
class OptimizeInputOutputBufferAlias : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSoptimize_input_output_buffer_aliasDTh mht_0(mht_0_v, 220, "", "./tensorflow/compiler/xla/service/optimize_input_output_buffer_alias.h", "name");
