...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh() {
      // Check if tracing is enabled
...
struct RendezvousKey {
  ...
  explicit RendezvousKey(const RunId& run_id,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_0(mht_0_v, 335, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "RendezvousKey");
}

  template <typename H>
  friend H AbslHashValue(H h, const RendezvousKey& k) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_1(mht_1_v, 341, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "AbslHashValue");
  ...
  absl::string_view CollectiveOpKindString() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_2(mht_2_v, 358, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "CollectiveOpKindString");
  ...
  std::string ToString() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_3(mht_3_v, 370, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "ToString");
...
void WaitAndLogIfStuck(tensorflow::BlockingCounter* counter,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_4(mht_4_v, 390, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "WaitAndLogIfStuck");
...
struct ParticipantData {
  explicit ParticipantData(const RendezvousKey& rendezvous_key)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_5(mht_5_v, 412, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "ParticipantData");
}

  virtual ~ParticipantData() {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_6(mht_6_v, 417, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "~ParticipantData");
}
...
struct AllReduceParticipantData : ParticipantData {
  AllReduceParticipantData(const RendezvousKey& rendezvous_key_p,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_7(mht_7_v, 433, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "AllReduceParticipantData");
}
  ...
  std::string ToString() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_8(mht_8_v, 458, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "ToString");
...
class Rendezvous {
 public:
  virtual ~Rendezvous() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_9(mht_9_v, 490, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "~Rendezvous");
}
  explicit Rendezvous(const RendezvousKey& k) : key_(k) {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_10(mht_10_v, 494, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "Rendezvous");
}
 ...
 protected:
  ...
  bool InitializationBarrier() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollective_ops_utilsDTh mht_11(mht_11_v, 533, "", "./tensorflow/compiler/xla/service/collective_ops_utils.h", "InitializationBarrier");
