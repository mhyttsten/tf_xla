...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_replication_analysisDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_replication_analysisDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_replication_analysisDTh() {
      // Check if tracing is enabled
...
class HloReplicationAnalysis {
 ...
 private:
  HloReplicationAnalysis(const HloModule* module, bool cross_partition_spmd,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_replication_analysisDTh mht_0(mht_0_v, 226, "", "./tensorflow/compiler/xla/service/hlo_replication_analysis.h", "HloReplicationAnalysis");
}
