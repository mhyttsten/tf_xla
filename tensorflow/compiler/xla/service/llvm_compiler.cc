...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTcc() {
      // Check if tracing is enabled
...
StatusOr<std::vector<std::unique_ptr<Executable>>> LLVMCompiler::Compile(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSllvm_compilerDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/xla/service/llvm_compiler.cc", "LLVMCompiler::Compile");
