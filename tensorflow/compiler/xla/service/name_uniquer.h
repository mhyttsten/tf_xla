...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSname_uniquerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSname_uniquerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSname_uniquerDTh() {
      // Check if tracing is enabled
...
class NameUniquer {
 ...
 private:
  ...
  class SequentialIdGenerator {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSname_uniquerDTh mht_0(mht_0_v, 225, "", "./tensorflow/compiler/xla/service/name_uniquer.h", "RegisterId");
