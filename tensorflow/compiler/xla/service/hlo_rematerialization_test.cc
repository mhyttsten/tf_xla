...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc() {
      // Check if tracing is enabled
...
TEST_F(HloRematerializationTest, RngNotRematerialized) {
  ...
  auto count_rngs = [](const HloComputation* computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc mht_0(mht_0_v, 464, "", "./tensorflow/compiler/xla/service/hlo_rematerialization_test.cc", "lambda");
...
TEST_F(HloRematerializationTest, InstructionRematerializedMultipleTimes) {
  ...
  auto count_broadcasts = [](const HloComputation* computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc mht_1(mht_1_v, 555, "", "./tensorflow/compiler/xla/service/hlo_rematerialization_test.cc", "lambda");
...
TEST_F(HloRematerializationTest, CopyNotRematerialized) {
  ...
  auto count_copies = [](const HloComputation* computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc mht_2(mht_2_v, 631, "", "./tensorflow/compiler/xla/service/hlo_rematerialization_test.cc", "lambda");
...
class CompressingRematerializationTest : public RematerializationTestBase {
 protected:
  ...
  static int64_t ShapeSizePadMinorTo64(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_rematerialization_testDTcc mht_3(mht_3_v, 741, "", "./tensorflow/compiler/xla/service/hlo_rematerialization_test.cc", "ShapeSizePadMinorTo64");
