...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc() {
      // Check if tracing is enabled
...
class HloDomainTest : public HloTestBase {
 protected:
  bool FindUserViaDomainPath(HloInstruction* instruction,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "FindUserViaDomainPath");
  ...
  bool HasDomainEdge(HloModule* module, absl::string_view instruction_name,
   ...
   mht_1_v.push_back("instruction_name: \"" + std::string(instruction_name.data(), instruction_name.size()) + "\"");
   mht_1_v.push_back("operand_name: \"" + std::string(operand_name.data(), operand_name.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_1(mht_1_v, 227, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "HasDomainEdge");
...
class OpNameMetadata : public DomainMetadata {
 public:
  explicit OpNameMetadata(std::string opname) : opname_(std::move(opname)) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_2(mht_2_v, 254, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "OpNameMetadata");
}
  ...
  absl::string_view Kind() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_3(mht_3_v, 263, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "Kind");
 return KindName(); }

  bool Matches(const DomainMetadata& other) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_4(mht_4_v, 268, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "Matches");
  ...
  std::string ToString() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_5(mht_5_v, 281, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "ToString");
 return opname_; }

  static absl::string_view KindName() {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_6(mht_6_v, 286, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "KindName");
 return "opname"; }

  size_t Hash() const override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_7(mht_7_v, 291, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "Hash");
 return std::hash<std::string>()(opname_); }
...
Status OpNameDomainNormalizer(const DomainMetadata::Domain& domain,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_domain_testDTcc mht_8(mht_8_v, 319, "", "./tensorflow/compiler/xla/service/hlo_domain_test.cc", "OpNameDomainNormalizer");
