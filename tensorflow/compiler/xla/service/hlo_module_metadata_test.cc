...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_module_metadata_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_module_metadata_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_module_metadata_testDTcc() {
      // Check if tracing is enabled
...
class TestEnv : public tensorflow::EnvWrapper {
 public:
  TestEnv() : EnvWrapper(Env::Default()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_module_metadata_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/xla/service/hlo_module_metadata_test.cc", "TestEnv");
}

  uint64_t NowMicros() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_module_metadata_testDTcc mht_1(mht_1_v, 205, "", "./tensorflow/compiler/xla/service/hlo_module_metadata_test.cc", "NowMicros");
 return current_micros_; }

  void SetCurrentMicros(uint64_t micros) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_module_metadata_testDTcc mht_2(mht_2_v, 210, "", "./tensorflow/compiler/xla/service/hlo_module_metadata_test.cc", "SetCurrentMicros");
