...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc() {
      // Check if tracing is enabled
...
StatusOr<std::unique_ptr<HloLiveRange>> HloLiveRange::Run(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::Run");
...
void HloLiveRange::NormalizeAliasedBuffers() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::NormalizeAliasedBuffers");
...
void HloLiveRange::FlattenSchedule(const HloComputation& computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_2(mht_2_v, 272, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::FlattenSchedule");
...
HloLiveRange::TimeBound HloLiveRange::GetLastPosition(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_3(mht_3_v, 315, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::GetLastPosition");
...
HloLiveRange::LogicalTime HloLiveRange::GetLastUsageTime(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_4(mht_4_v, 345, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::GetLastUsageTime");
...
void HloLiveRange::CalculateBufferStartEndMap() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_5(mht_5_v, 375, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::CalculateBufferStartEndMap");
...
int64_t HloLiveRange::ComputePeakMemoryMoment() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_6(mht_6_v, 427, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::ComputePeakMemoryMoment");
...
std::string HloLiveRange::ToString() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_live_rangeDTcc mht_7(mht_7_v, 464, "", "./tensorflow/compiler/xla/service/hlo_live_range.cc", "HloLiveRange::ToString");
