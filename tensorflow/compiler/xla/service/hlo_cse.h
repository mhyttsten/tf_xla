...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cseDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cseDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cseDTh() {
      // Check if tracing is enabled
...
class HloCSE : public HloModulePass {
 public:
  ...
  explicit HloCSE(bool is_layout_sensitive,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cseDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/hlo_cse.h", "HloCSE");
}
  ~HloCSE() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_cseDTh mht_1(mht_1_v, 209, "", "./tensorflow/compiler/xla/service/hlo_cse.h", "name");
 return "cse"; }
