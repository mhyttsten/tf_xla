...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc() {
      // Check if tracing is enabled
...
bool MemorySpaceAssignmentUtils::IsValueAllowedInAlternateMemory(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/compiler/xla/service/memory_space_assignment_utils.cc", "MemorySpaceAssignmentUtils::IsValueAllowedInAlternateMemory");
...
bool MemorySpaceAssignmentUtils::IsIntervalAllowedInAlternateMemory(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc mht_1(mht_1_v, 264, "", "./tensorflow/compiler/xla/service/memory_space_assignment_utils.cc", "MemorySpaceAssignmentUtils::IsIntervalAllowedInAlternateMemory");
...
/*static*/ void MemorySpaceAssignmentUtils::HoistEntryParameters(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc mht_2(mht_2_v, 273, "", "./tensorflow/compiler/xla/service/memory_space_assignment_utils.cc", "MemorySpaceAssignmentUtils::HoistEntryParameters");
...
/*static*/ void MemorySpaceAssignmentUtils::HoistConstantOperations(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc mht_3(mht_3_v, 317, "", "./tensorflow/compiler/xla/service/memory_space_assignment_utils.cc", "MemorySpaceAssignmentUtils::HoistConstantOperations");
  ...
  for (const HloComputation* computation : module.MakeNonfusionComputations()) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmemory_space_assignment_utilsDTcc mht_4(mht_4_v, 337, "", "./tensorflow/compiler/xla/service/memory_space_assignment_utils.cc", "lambda");
