...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTh() {
      // Check if tracing is enabled
...
class RootInstructionSinker : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/root_instruction_sinker.h", "name");
