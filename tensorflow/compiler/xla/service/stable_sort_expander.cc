...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstable_sort_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstable_sort_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstable_sort_expanderDTcc() {
      // Check if tracing is enabled
...
StatusOr<HloInstruction*> StableSortExpander::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstable_sort_expanderDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/stable_sort_expander.cc", "StableSortExpander::ExpandInstruction");
  ...
  auto replace = [&](HloInstruction* instr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstable_sort_expanderDTcc mht_1(mht_1_v, 308, "", "./tensorflow/compiler/xla/service/stable_sort_expander.cc", "lambda");
...
bool StableSortExpander::InstructionMatchesPattern(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstable_sort_expanderDTcc mht_2(mht_2_v, 375, "", "./tensorflow/compiler/xla/service/stable_sort_expander.cc", "StableSortExpander::InstructionMatchesPattern");
