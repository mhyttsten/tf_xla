...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc() {
      // Check if tracing is enabled
...
class HloAliasAnalysisTest : public HloTestBase {
 protected:
  HloAliasAnalysisTest() : HloTestBase() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/xla/service/hlo_alias_analysis_test.cc", "HloAliasAnalysisTest");
  ...
  HloAliasAnalysis& RunAnalysis() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc mht_1(mht_1_v, 221, "", "./tensorflow/compiler/xla/service/hlo_alias_analysis_test.cc", "RunAnalysis");
  ...
  bool AnyValuesInSameBufferInterfere() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc mht_2(mht_2_v, 260, "", "./tensorflow/compiler/xla/service/hlo_alias_analysis_test.cc", "AnyValuesInSameBufferInterfere");
  ...
  bool InstructionBuffersAreAmbiguous(const HloInstruction* instruction) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc mht_3(mht_3_v, 284, "", "./tensorflow/compiler/xla/service/hlo_alias_analysis_test.cc", "InstructionBuffersAreAmbiguous");
  ...
  bool InstructionBuffersAreDistinct(const HloInstruction* instruction) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc mht_4(mht_4_v, 305, "", "./tensorflow/compiler/xla/service/hlo_alias_analysis_test.cc", "InstructionBuffersAreDistinct");
...
TEST_F(HloAliasAnalysisTest, NestedWhiles) {
  ...
  auto build_cond_computation = [&tuple_shape]() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_alias_analysis_testDTcc mht_5(mht_5_v, 900, "", "./tensorflow/compiler/xla/service/hlo_alias_analysis_test.cc", "lambda");
