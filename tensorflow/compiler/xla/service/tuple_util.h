...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_utilDTh() {
      // Check if tracing is enabled
...
class TupleUtil {
 public:
  ...
  static HloInstruction* Duplicate(HloInstruction* input_tuple) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStuple_utilDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/tuple_util.h", "Duplicate");
