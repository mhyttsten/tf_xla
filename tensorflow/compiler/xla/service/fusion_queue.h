...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSfusion_queueDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSfusion_queueDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSfusion_queueDTh() {
      // Check if tracing is enabled
...
class FusionQueue {
 public:
  ...
  virtual void PreFusion(HloInstruction* producer, HloInstruction* consumer) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSfusion_queueDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/service/fusion_queue.h", "PreFusion");
}
  ...
  virtual void OnFusingInstruction(HloInstruction* fusion,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSfusion_queueDTh mht_1(mht_1_v, 218, "", "./tensorflow/compiler/xla/service/fusion_queue.h", "OnFusingInstruction");
}
  ...
  virtual void NotFusingInstruction(HloInstruction* producer,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSfusion_queueDTh mht_2(mht_2_v, 226, "", "./tensorflow/compiler/xla/service/fusion_queue.h", "NotFusingInstruction");
}
