...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc() {
      // Check if tracing is enabled
...
std::string HloOpcodeString(HloOpcode opcode) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc mht_0(mht_0_v, 193, "", "./tensorflow/compiler/xla/service/hlo_opcode.cc", "HloOpcodeString");
...
bool HloOpcodeIsComparison(HloOpcode opcode) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/xla/service/hlo_opcode.cc", "HloOpcodeIsComparison");
...
bool HloOpcodeIsVariadic(HloOpcode opcode) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc mht_2(mht_2_v, 227, "", "./tensorflow/compiler/xla/service/hlo_opcode.cc", "HloOpcodeIsVariadic");
...
bool HloOpcodeIsAsync(HloOpcode opcode) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_opcodeDTcc mht_3(mht_3_v, 251, "", "./tensorflow/compiler/xla/service/hlo_opcode.cc", "HloOpcodeIsAsync");
