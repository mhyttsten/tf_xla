...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTh() {
      // Check if tracing is enabled
...
class StreamPool {
 public:
  ...
  StreamPool() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSstream_poolDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/service/stream_pool.h", "StreamPool");
}
