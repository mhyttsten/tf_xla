...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTh() {
      // Check if tracing is enabled
...
class LogisticExpander : public OpExpanderPass {
 public:
  explicit LogisticExpander(LogisticExpansionType expansion_type)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTh mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/service/logistic_expander.h", "LogisticExpander");
}
  ~LogisticExpander() override = default;
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTh mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/service/logistic_expander.h", "name");
 return "logistic-expander"; }
