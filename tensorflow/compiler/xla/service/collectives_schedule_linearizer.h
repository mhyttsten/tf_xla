...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollectives_schedule_linearizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollectives_schedule_linearizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollectives_schedule_linearizerDTh() {
      // Check if tracing is enabled
...
class CollectivesScheduleLinearizer : public HloModulePass {
 public:
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScollectives_schedule_linearizerDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/xla/service/collectives_schedule_linearizer.h", "name");
