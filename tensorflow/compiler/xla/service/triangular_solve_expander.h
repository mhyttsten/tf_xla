...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStriangular_solve_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStriangular_solve_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStriangular_solve_expanderDTh() {
      // Check if tracing is enabled
...
class TriangularSolveExpander : public OpExpanderPass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStriangular_solve_expanderDTh mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/service/triangular_solve_expander.h", "name");
 ...
 protected:
  ...
  virtual bool UseDirectSolves() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePStriangular_solve_expanderDTh mht_1(mht_1_v, 207, "", "./tensorflow/compiler/xla/service/triangular_solve_expander.h", "UseDirectSolves");
 return true; }
