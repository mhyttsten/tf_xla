...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTh() {
      // Check if tracing is enabled
...
class WhileLoopSimplifier : public HloModulePass {
 public:
  ~WhileLoopSimplifier() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.h", "~WhileLoopSimplifier");
}
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_simplifierDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xla/service/while_loop_simplifier.h", "name");
