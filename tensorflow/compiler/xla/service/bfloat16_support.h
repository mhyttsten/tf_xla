...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_supportDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_supportDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_supportDTh() {
      // Check if tracing is enabled
...
class BFloat16Support {
 public:
  BFloat16Support() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_supportDTh mht_0(mht_0_v, 195, "", "./tensorflow/compiler/xla/service/bfloat16_support.h", "BFloat16Support");
}
  virtual ~BFloat16Support() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_supportDTh mht_1(mht_1_v, 199, "", "./tensorflow/compiler/xla/service/bfloat16_support.h", "~BFloat16Support");
}
