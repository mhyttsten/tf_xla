...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh() {
      // Check if tracing is enabled
...
class HloDCE : public HloModulePass {
 public:
  HloDCE() : remove_cross_partition_collective_ops_(false) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/hlo_dce.h", "HloDCE");
}
  explicit HloDCE(bool remove_cross_partition_collective_ops)
      : remove_cross_partition_collective_ops_(
            remove_cross_partition_collective_ops) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/service/hlo_dce.h", "HloDCE");
}
  ~HloDCE() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh mht_2(mht_2_v, 218, "", "./tensorflow/compiler/xla/service/hlo_dce.h", "~HloDCE");
}
  absl::string_view name() const override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_dceDTh mht_3(mht_3_v, 222, "", "./tensorflow/compiler/xla/service/hlo_dce.h", "name");
 return "dce"; }
