...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc() {
      // Check if tracing is enabled
...
std::string TestDataToString(const ::testing::TestParamInfo<TestData>& data) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc mht_0(mht_0_v, 224, "", "./tensorflow/compiler/xla/service/hlo_parser_test.cc", "TestDataToString");
...
std::string NonRoundtripTestDataToString(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc mht_1(mht_1_v, 243, "", "./tensorflow/compiler/xla/service/hlo_parser_test.cc", "NonRoundtripTestDataToString");
...
class HloParameterizedParserTest
 ...
 protected:
  ...
  void ExpectEqual() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc mht_2(mht_2_v, 2377, "", "./tensorflow/compiler/xla/service/hlo_parser_test.cc", "ExpectEqual");
...
class HloParserTest : public ::testing::Test {
 protected:
  static void ExpectHasSubstr(string_view s, string_view expected) {
   ...
   mht_3_v.push_back("expected: \"" + std::string(expected.data(), expected.size()) + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_parser_testDTcc mht_3(mht_3_v, 2462, "", "./tensorflow/compiler/xla/service/hlo_parser_test.cc", "ExpectHasSubstr");
