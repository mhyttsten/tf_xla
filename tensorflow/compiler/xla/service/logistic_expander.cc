...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc() {
      // Check if tracing is enabled
...
HloInstruction* ExpandLogisticWithTanh(HloInstruction* logistic) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/xla/service/logistic_expander.cc", "ExpandLogisticWithTanh");
...
HloInstruction* ExpandLogisticWithExp(HloInstruction* logistic) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc mht_1(mht_1_v, 228, "", "./tensorflow/compiler/xla/service/logistic_expander.cc", "ExpandLogisticWithExp");
...
bool LogisticExpander::InstructionMatchesPattern(HloInstruction* instruction) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc mht_2(mht_2_v, 248, "", "./tensorflow/compiler/xla/service/logistic_expander.cc", "LogisticExpander::InstructionMatchesPattern");
...
StatusOr<HloInstruction*> LogisticExpander::ExpandInstruction(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogistic_expanderDTcc mht_3(mht_3_v, 256, "", "./tensorflow/compiler/xla/service/logistic_expander.cc", "LogisticExpander::ExpandInstruction");
