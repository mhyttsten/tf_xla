...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScompilation_cacheDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScompilation_cacheDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScompilation_cacheDTh() {
      // Check if tracing is enabled
...
class CompilationCache {
 public:
  CompilationCache() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePScompilation_cacheDTh mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xla/service/compilation_cache.h", "CompilationCache");
}
