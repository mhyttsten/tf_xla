...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc() {
      // Check if tracing is enabled
...
class TestBFloat16Support : public BFloat16Support {
 public:
  TestBFloat16Support() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "TestBFloat16Support");
}
  ~TestBFloat16Support() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "~TestBFloat16Support");
}

  bool SupportsBF16Operand(const HloInstruction& hlo,
                           int64_t operand_index) const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_2(mht_2_v, 216, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "SupportsBF16Operand");
  ...
  bool SupportsBF16Output(const HloInstruction& hlo) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_3(mht_3_v, 223, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "SupportsBF16Output");
  ...
  bool SupportsMixedPrecisions(const HloInstruction& hlo) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_4(mht_4_v, 230, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "SupportsMixedPrecisions");
  ...
  bool EffectiveOperandPrecisionIsBF16(const HloInstruction& hlo,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_5(mht_5_v, 238, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "EffectiveOperandPrecisionIsBF16");
...
class BFloat16PropagationTest : public HloTestBase {
 protected:
  BFloat16PropagationTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_6(mht_6_v, 250, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "BFloat16PropagationTest");
}
  ...
  bool PropagatePrecision(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_7(mht_7_v, 257, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "PropagatePrecision");
  ...
  bool OutputsBF16(const HloInstruction* inst) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_propagation_testDTcc mht_8(mht_8_v, 270, "", "./tensorflow/compiler/xla/service/bfloat16_propagation_test.cc", "OutputsBF16");
