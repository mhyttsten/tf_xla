...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combinerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combinerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combinerDTh() {
      // Check if tracing is enabled
...
class ReduceScatterCombiner : public HloModulePass {
 public:
  ...
  absl::string_view name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSreduce_scatter_combinerDTh mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xla/service/reduce_scatter_combiner.h", "name");
 return "reduce-scatter-combiner"; }
