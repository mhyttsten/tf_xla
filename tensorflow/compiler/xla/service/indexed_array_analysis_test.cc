...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc() {
      // Check if tracing is enabled
...
class IndexedArrayAnalysisTest : public HloTestBase {
 protected:
  void AssertArrayForRootExpressionIs(const std::string& hlo_text,
   ...
   mht_0_v.push_back("root_expression: \"" + root_expression + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/xla/service/indexed_array_analysis_test.cc", "AssertArrayForRootExpressionIs");
  ...
  void AssertArrayWithConstantsForRootExpressionIs(
   ...
   mht_1_v.push_back("hlo_text: \"" + hlo_text + "\"");
   mht_1_v.push_back("root_expression: \"" + root_expression + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc mht_1(mht_1_v, 209, "", "./tensorflow/compiler/xla/service/indexed_array_analysis_test.cc", "AssertArrayWithConstantsForRootExpressionIs");
 ...
 private:
  ...
  std::string CanonicalizeWhitespace(const std::string& text) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc mht_2(mht_2_v, 222, "", "./tensorflow/compiler/xla/service/indexed_array_analysis_test.cc", "CanonicalizeWhitespace");
  ...
  void AssertArrayForRootExpressionIsImpl(const std::string& hlo_text,
   ...
   mht_3_v.push_back("root_expression: \"" + root_expression + "\"");
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSindexed_array_analysis_testDTcc mht_3(mht_3_v, 247, "", "./tensorflow/compiler/xla/service/indexed_array_analysis_test.cc", "AssertArrayForRootExpressionIsImpl");
