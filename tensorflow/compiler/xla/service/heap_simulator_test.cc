...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc() {
      // Check if tracing is enabled
...
TEST_F(MinimumMemoryForSequenceTest, MultiComputation) {
  ...
  auto size_fn = [](const BufferValue& buffer) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_0(mht_0_v, 255, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "lambda");
...
TEST_F(MinimumMemoryForSequenceTest, SubcomputationAccounting) {
  ...
  auto size_fn = [](const BufferValue& buffer) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_1(mht_1_v, 376, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "lambda");
...
class HeapCallRecorder : public HeapAlgorithm<HloValue> {
 public:
  explicit HeapCallRecorder(CallSequence* calls) : calls_(calls) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_2(mht_2_v, 408, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "HeapCallRecorder");
}
  ~HeapCallRecorder() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_3(mht_3_v, 412, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "~HeapCallRecorder");
}

  void Alloc(const HloValue* buffer, int64_t size) override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_4(mht_4_v, 417, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "Alloc");
  ...
  void ShareWith(const HloValue* buffer, const HloValue* shared,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_5(mht_5_v, 430, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "ShareWith");
  ...
  void Free(const HloValue* buffer, int64_t size) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_6(mht_6_v, 441, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "Free");

    calls_->emplace_back(kFree, buffer);
  }
  Result Finish() override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_7(mht_7_v, 447, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "Finish");
...
class HeapSimulatorTracker {
 public:
  ...
  explicit HeapSimulatorTracker(const std::string& name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_8(mht_8_v, 491, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "HeapSimulatorTracker");
  ...
  void RunWholeModule(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_9(mht_9_v, 502, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "RunWholeModule");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_10(mht_10_v, 522, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "lambda");
  ...
  HloModule* module() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_11(mht_11_v, 534, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "module");
 return module_.get(); }
  ...
  const HloValue* BufferAt(const HloInstruction* instruction,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_12(mht_12_v, 541, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "BufferAt");
  ...
  int64_t OffsetAt(const HloInstruction* instruction, const ShapeIndex& index) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_13(mht_13_v, 549, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "OffsetAt");
  ...
  void ExpectCallSequence(const CallSequence& expected) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_14(mht_14_v, 559, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "ExpectCallSequence");

    auto to_string = [](const CallSequence& sequence) {
   std::vector<std::string> mht_15_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_15(mht_15_v, 563, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "lambda");
  ...
  void ExpectSharedBuffers(const HloInstruction* instruction_a,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_16(mht_16_v, 591, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "ExpectSharedBuffers");
 ...
 private:
  void Init(const std::vector<HloInstruction*>& instruction_sequence,
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_17(mht_17_v, 602, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "Init");
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_18(mht_18_v, 610, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "lambda");
 return 0; };
    auto algorithm = absl::make_unique<HeapCallRecorder>(&actual_calls_);
...
class HeapSimulatorTest : public HloTestBase {
 protected:
  HeapSimulatorTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_19(mht_19_v, 636, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "HeapSimulatorTest");
}
  ~HeapSimulatorTest() override {
   std::vector<std::string> mht_20_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_20(mht_20_v, 640, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "~HeapSimulatorTest");
}
...
class HeapAlgorithmTestBase : public ::testing::Test {
 protected:
  HeapAlgorithmTestBase() : builder_("heap_simulator_test") {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_21(mht_21_v, 1176, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "HeapAlgorithmTestBase");
  ...
  ~HeapAlgorithmTestBase() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_22(mht_22_v, 1190, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "~HeapAlgorithmTestBase");
}
 ...
 private:
  ...
  const HloValue* DummyBufferValue() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_23(mht_23_v, 1207, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "DummyBufferValue");
...
class GlobalDecreasingSizeBestFitHeapTest : public HeapAlgorithmTestBase {
 protected:
  class InheritedGlobalDecreasingSizeBestFitHeap
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_24(mht_24_v, 1266, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "InheritedGlobalDecreasingSizeBestFitHeap");
}
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSheap_simulator_testDTcc mht_25(mht_25_v, 1287, "", "./tensorflow/compiler/xla/service/heap_simulator_test.cc", "CommitChunk");
