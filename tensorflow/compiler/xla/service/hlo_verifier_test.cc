...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc() {
      // Check if tracing is enabled
...
class HloVerifierTest : public HloTestBase {
 public:
  HloVerifierTest()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/xla/service/hlo_verifier_test.cc", "HloVerifierTest");
}
};
...
class HloVerifierTestAllowMixedPrecision : public HloTestBase {
 public:
  HloVerifierTestAllowMixedPrecision()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc mht_1(mht_1_v, 230, "", "./tensorflow/compiler/xla/service/hlo_verifier_test.cc", "HloVerifierTestAllowMixedPrecision");
}
};
...
class HloVerifierTestLayoutSensitive : public HloTestBase {
 public:
  HloVerifierTestLayoutSensitive()
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc mht_2(mht_2_v, 241, "", "./tensorflow/compiler/xla/service/hlo_verifier_test.cc", "HloVerifierTestLayoutSensitive");
}
};
...
std::string ReplicaGroupsStr(std::vector<std::vector<int64_t>> replica_groups) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc mht_3(mht_3_v, 1230, "", "./tensorflow/compiler/xla/service/hlo_verifier_test.cc", "ReplicaGroupsStr");
...
int64_t ReplicaCount(const std::vector<std::vector<int64_t>>& replica_groups) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePShlo_verifier_testDTcc mht_4(mht_4_v, 1243, "", "./tensorflow/compiler/xla/service/hlo_verifier_test.cc", "ReplicaCount");
