...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspace_to_batch_converterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspace_to_batch_converterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspace_to_batch_converterDTh() {
      // Check if tracing is enabled
...
class SpaceToBatchConverter : public HloModulePass {
 public:
  explicit SpaceToBatchConverter(SpaceToBatchController ctrl) : ctrl_(ctrl) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspace_to_batch_converterDTh mht_0(mht_0_v, 222, "", "./tensorflow/compiler/xla/service/space_to_batch_converter.h", "SpaceToBatchConverter");
}

  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSspace_to_batch_converterDTh mht_1(mht_1_v, 227, "", "./tensorflow/compiler/xla/service/space_to_batch_converter.h", "name");
 return "space-to-batch-converter"; }
