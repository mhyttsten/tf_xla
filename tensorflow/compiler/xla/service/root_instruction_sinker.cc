...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTcc() {
      // Check if tracing is enabled
...
void SinkTupleRoot(HloComputation* computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTcc mht_0(mht_0_v, 193, "", "./tensorflow/compiler/xla/service/root_instruction_sinker.cc", "SinkTupleRoot");
...
void SinkNontupleRoot(HloComputation* computation) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/xla/service/root_instruction_sinker.cc", "SinkNontupleRoot");
...
StatusOr<bool> RootInstructionSinker::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSroot_instruction_sinkerDTcc mht_2(mht_2_v, 227, "", "./tensorflow/compiler/xla/service/root_instruction_sinker.cc", "RootInstructionSinker::Run");
