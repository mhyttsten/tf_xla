...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogical_bufferDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogical_bufferDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogical_bufferDTh() {
      // Check if tracing is enabled
...
class LogicalBuffer : public BufferValue {
 public:
  ...
  HloInstruction* instruction() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogical_bufferDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/xla/service/logical_buffer.h", "instruction");
 return instruction_; }
  ...
  const ShapeIndex& index() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogical_bufferDTh mht_1(mht_1_v, 214, "", "./tensorflow/compiler/xla/service/logical_buffer.h", "index");
 return index_; }
  ...
  const Shape& shape() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSlogical_bufferDTh mht_2(mht_2_v, 222, "", "./tensorflow/compiler/xla/service/logical_buffer.h", "shape");
