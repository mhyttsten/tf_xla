...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh() {
      // Check if tracing is enabled
...
class MaybeOwningDeviceMemory {
 public:
  ...
  explicit MaybeOwningDeviceMemory(tensorflow::se::OwningDeviceMemory owned)
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/xla/service/maybe_owning_device_memory.h", "MaybeOwningDeviceMemory");
}
  explicit MaybeOwningDeviceMemory(tensorflow::se::DeviceMemoryBase unowned)
      : mem_(unowned) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh mht_1(mht_1_v, 206, "", "./tensorflow/compiler/xla/service/maybe_owning_device_memory.h", "MaybeOwningDeviceMemory");
}
  ...
  MaybeOwningDeviceMemory& operator=(tensorflow::se::DeviceMemoryBase unowned) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh mht_2(mht_2_v, 213, "", "./tensorflow/compiler/xla/service/maybe_owning_device_memory.h", "=");
  ...
  MaybeOwningDeviceMemory& operator=(tensorflow::se::OwningDeviceMemory owned) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSmaybe_owning_device_memoryDTh mht_3(mht_3_v, 221, "", "./tensorflow/compiler/xla/service/maybe_owning_device_memory.h", "=");
