...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_trip_count_annotatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_trip_count_annotatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_trip_count_annotatorDTh() {
      // Check if tracing is enabled
...
class WhileLoopTripCountAnnotator : public HloModulePass {
 public:
  ~WhileLoopTripCountAnnotator() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_trip_count_annotatorDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/xla/service/while_loop_trip_count_annotator.h", "~WhileLoopTripCountAnnotator");
}
  absl::string_view name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSwhile_loop_trip_count_annotatorDTh mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xla/service/while_loop_trip_count_annotator.h", "name");
