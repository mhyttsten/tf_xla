...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc() {
      // Check if tracing is enabled
...
class BFloat16NormalizationVisitor : public DfsHloVisitorWithDefault {
 public:
  explicit BFloat16NormalizationVisitor(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor");
}

  bool changed() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "changed");
 return changed_; }
...
int64_t CountSubshapesWithMatchingType(const Shape& shape, PrimitiveType type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_2(mht_2_v, 269, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "CountSubshapesWithMatchingType");
...
int64_t ShapeLeafCount(const Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_3(mht_3_v, 283, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "ShapeLeafCount");
...
StatusOr<HloInstruction*> BFloat16NormalizationVisitor::ConvertType(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_4(mht_4_v, 299, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::ConvertType");
...
Status BFloat16NormalizationVisitor::InsertConvertAfterOutput(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_5(mht_5_v, 334, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::InsertConvertAfterOutput");
...
Status BFloat16NormalizationVisitor::ChangeOutputTypeThenInsertConvertBack(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_6(mht_6_v, 358, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::ChangeOutputTypeThenInsertConvertBack");
...
Status BFloat16NormalizationVisitor::InsertConvertBeforeOperand(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_7(mht_7_v, 409, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::InsertConvertBeforeOperand");
...
Status BFloat16NormalizationVisitor::ConvertCalledComputations(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_8(mht_8_v, 426, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::ConvertCalledComputations");
...
Status BFloat16NormalizationVisitor::HandleMultipleOutputs(
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_9(mht_9_v, 457, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::HandleMultipleOutputs");
  ...
  auto should_convert_operand = [&](int64_t i) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_10(mht_10_v, 494, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "lambda");
...
Status BFloat16NormalizationVisitor::HandleInstruction(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_11(mht_11_v, 584, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::HandleInstruction");
...
Status BFloat16NormalizationVisitor::DefaultAction(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_12(mht_12_v, 693, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::DefaultAction");
...
Status BFloat16NormalizationVisitor::Preprocess(HloInstruction* hlo) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_13(mht_13_v, 725, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16NormalizationVisitor::Preprocess");
...
StatusOr<bool> BFloat16Normalization::Run(HloModule* module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxlaPSservicePSbfloat16_normalizationDTcc mht_14(mht_14_v, 735, "", "./tensorflow/compiler/xla/service/bfloat16_normalization.cc", "BFloat16Normalization::Run");
