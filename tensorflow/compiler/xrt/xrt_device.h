...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh() {
      // Check if tracing is enabled
...
class XRTGenericDeviceAccessor {
 public:
  ...
  class ScopedRef {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/xrt/xrt_device.h", "ScopedRef");
}
    ~ScopedRef() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/xrt/xrt_device.h", "~ScopedRef");
}
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh mht_2(mht_2_v, 228, "", "./tensorflow/compiler/xrt/xrt_device.h", "client");
 return client_; }
    xla::Backend* backend() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh mht_3(mht_3_v, 232, "", "./tensorflow/compiler/xrt/xrt_device.h", "backend");
 return client_->mutable_backend(); }
    int device_ordinal() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh mht_4(mht_4_v, 236, "", "./tensorflow/compiler/xrt/xrt_device.h", "device_ordinal");
 return ordinal_; }
    se::DeviceMemoryAllocator* allocator() {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTh mht_5(mht_5_v, 240, "", "./tensorflow/compiler/xrt/xrt_device.h", "allocator");
 return allocator_; }
