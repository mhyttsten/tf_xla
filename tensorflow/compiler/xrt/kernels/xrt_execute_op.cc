...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc() {
      // Check if tracing is enabled
...
uint32 InitialRandomSeed() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_0(mht_0_v, 223, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "InitialRandomSeed");
...
uint32 GetXLARandomSeed() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_1(mht_1_v, 240, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "GetXLARandomSeed");
...
Status UpdateMetadata(se::Stream* stream, se::DeviceMemory<uint8>* buffer,
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_2(mht_2_v, 332, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "UpdateMetadata");
...
Status UpdateDynamicInputs(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_3(mht_3_v, 382, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "UpdateDynamicInputs");
...
xla::StatusOr<RefPtr<XRTTupleAllocation>> ExecuteComputation(
  ...
  auto runfn = [&]() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_4(mht_4_v, 566, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "lambda");
...
XRTExecuteOp::XRTExecuteOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_5(mht_5_v, 613, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "XRTExecuteOp::XRTExecuteOp");
}

void XRTExecuteOp::ComputeAsync(OpKernelContext* context, DoneCallback done) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_6(mht_6_v, 618, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "XRTExecuteOp::ComputeAsync");
...
Status XRTExecuteOp::DoWork(OpKernelContext* context) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_7(mht_7_v, 629, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "XRTExecuteOp::DoWork");
...
XRTExecuteChainedOp::XRTExecuteChainedOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_8(mht_8_v, 709, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "XRTExecuteChainedOp::XRTExecuteChainedOp");
}

void XRTExecuteChainedOp::ComputeAsync(OpKernelContext* context,
                                       DoneCallback done) {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_9(mht_9_v, 715, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "XRTExecuteChainedOp::ComputeAsync");
...
Status XRTExecuteChainedOp::DoWork(OpKernelContext* context) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_execute_opDTcc mht_10(mht_10_v, 726, "", "./tensorflow/compiler/xrt/kernels/xrt_execute_op.cc", "XRTExecuteChainedOp::DoWork");
