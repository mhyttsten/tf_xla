...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh() {
      // Check if tracing is enabled
...
class XRTStateHelpers {
 public:
  ...
  static Status MakeLiteral(const xla::LiteralProto& proto,
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_0(mht_0_v, 232, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "MakeLiteral");
  ...
  static Status ParseTupleNode(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_1(mht_1_v, 248, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "ParseTupleNode");
  ...
  static Status ParseTupleTree(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_2(mht_2_v, 304, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "ParseTupleTree");
...
class XRTAllocateOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_3(mht_3_v, 352, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTAllocateUninitializedOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_4(mht_4_v, 410, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTAllocateFromTensorOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_5(mht_5_v, 486, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTSubTupleOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_6(mht_6_v, 560, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTMakeTupleOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_7(mht_7_v, 614, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTReadLiteralOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_8(mht_8_v, 689, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTReadToTensorOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_9(mht_9_v, 743, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTWriteLiteralOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_10(mht_10_v, 830, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTReleaseAllocationOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_11(mht_11_v, 884, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTReleaseAllAllocationsOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_12(mht_12_v, 916, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTCompactAllocationsOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_13(mht_13_v, 938, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
...
class XRTMemoryInfoOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSkernelsPSxrt_state_opsDTh mht_14(mht_14_v, 965, "", "./tensorflow/compiler/xrt/kernels/xrt_state_ops.h", "Compute");
