...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc() {
      // Check if tracing is enabled
...
class ResourceMgrArena {
 public:
  static ResourceMgrArena* Get() {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/xrt/xrt_device.cc", "Get");
  ...
  ResourceMgr* GetResourceMgr(const std::string& platform_name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/xrt/xrt_device.cc", "GetResourceMgr");
...
/*static*/ Status XRTGenericDeviceAccessor::GetResourceManager(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_2(mht_2_v, 232, "", "./tensorflow/compiler/xrt/xrt_device.cc", "XRTGenericDeviceAccessor::GetResourceManager");
...
XRTGenericDeviceAccessor::GetOrCreateCompilationCache(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_3(mht_3_v, 244, "", "./tensorflow/compiler/xrt/xrt_device.cc", "XRTGenericDeviceAccessor::GetOrCreateCompilationCache");
...
/*static*/ Status XRTGenericDeviceAccessor::InitScopedRef(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_4(mht_4_v, 254, "", "./tensorflow/compiler/xrt/xrt_device.cc", "XRTGenericDeviceAccessor::InitScopedRef");
...
/*static*/ Status XRTGenericDeviceAccessor::InitScopedRef(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_5(mht_5_v, 271, "", "./tensorflow/compiler/xrt/xrt_device.cc", "XRTGenericDeviceAccessor::InitScopedRef");
...
void XRTGenericDeviceAccessor::ScopedRef::Acquire(
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_deviceDTcc mht_6(mht_6_v, 294, "", "./tensorflow/compiler/xrt/xrt_device.cc", "XRTGenericDeviceAccessor::ScopedRef::Acquire");
