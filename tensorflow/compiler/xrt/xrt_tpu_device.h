...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh() {
      // Check if tracing is enabled
...
class XRTTpuDeviceAccessor {
 public:
  ...
  class ScopedRef {
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh mht_0(mht_0_v, 205, "", "./tensorflow/compiler/xrt/xrt_tpu_device.h", "ScopedRef");
}
    ~ScopedRef() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh mht_1(mht_1_v, 209, "", "./tensorflow/compiler/xrt/xrt_tpu_device.h", "~ScopedRef");
}
   ...
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh mht_2(mht_2_v, 219, "", "./tensorflow/compiler/xrt/xrt_tpu_device.h", "backend");
 return node_context_->backend(); }
    int device_ordinal() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh mht_3(mht_3_v, 223, "", "./tensorflow/compiler/xrt/xrt_tpu_device.h", "device_ordinal");
 return ordinal_; }
    se::DeviceMemoryAllocator* allocator() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSxrtPSxrt_tpu_deviceDTh mht_4(mht_4_v, 227, "", "./tensorflow/compiler/xrt/xrt_tpu_device.h", "allocator");
