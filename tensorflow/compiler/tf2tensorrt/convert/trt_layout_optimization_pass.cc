...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_layout_optimization_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_layout_optimization_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_layout_optimization_passDTcc() {
      // Check if tracing is enabled
...
TRTLayoutOptimizationPass::TRTLayoutOptimizationPass(const string& name)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_layout_optimization_passDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_layout_optimization_pass.cc", "TRTLayoutOptimizationPass::TRTLayoutOptimizationPass");
...
Status TRTLayoutOptimizationPass::Optimize(grappler::Cluster* cluster,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_layout_optimization_passDTcc mht_1(mht_1_v, 229, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_layout_optimization_pass.cc", "TRTLayoutOptimizationPass::Optimize");
...
Status TRTLayoutOptimizationPass::Init(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_layout_optimization_passDTcc mht_2(mht_2_v, 265, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_layout_optimization_pass.cc", "TRTLayoutOptimizationPass::Init");
