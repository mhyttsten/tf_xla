...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc() {
      // Check if tracing is enabled
...
Status TrtPrecisionModeToName(const TrtPrecisionMode mode, string* name) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_parameters.cc", "TrtPrecisionModeToName");
...
Status TrtPrecisionModeFromName(const string& name, TrtPrecisionMode* mode) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc mht_1(mht_1_v, 223, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_parameters.cc", "TrtPrecisionModeFromName");
...
string DebugString(const TrtPrecisionMode mode) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc mht_2(mht_2_v, 239, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_parameters.cc", "DebugString");
...
string ProfileStrategyToName(const ProfileStrategy strategy) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc mht_3(mht_3_v, 248, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_parameters.cc", "ProfileStrategyToName");
...
Status ProfileStrategyFromName(const string& name, ProfileStrategy* strategy) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_parametersDTcc mht_4(mht_4_v, 266, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_parameters.cc", "ProfileStrategyFromName");
