...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_opsDTh() {
      // Check if tracing is enabled
...
std::ostream& operator<<(std::ostream& os,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_opsDTh mht_0(mht_0_v, 229, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops.h", "operator<<");
