...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc() {
      // Check if tracing is enabled
...
std::ostream& operator<<(std::ostream& os, ConvEpilogueType epilogue) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_0(mht_0_v, 232, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "operator<<");
...
std::string DebugString(ConvEpilogueType epilogue) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_1(mht_1_v, 250, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "DebugString");
...
Output AddQDQV2(Scope scope, Input input) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_2(mht_2_v, 282, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "AddQDQV2");
...
Output AddOutput(Scope scope, Output input, int idx, bool add_qdq) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_3(mht_3_v, 295, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "AddOutput");
...
ops::BatchMatMulV2 AddMatMul(Scope scope, const std::string& name,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_4(mht_4_v, 397, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "AddMatMul");
...
std::ostream& operator<<(std::ostream& os, const QDQTestOptions opts) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_5(mht_5_v, 437, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "operator<<");
...
class QDQExplicitTest : public ::testing::Test,
 ...
 public:
  ...
  static Status CheckTrtNode(const GraphDef& converted_graph_def) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_6(mht_6_v, 535, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "CheckTrtNode");
  ...
  Status ConvertAndRun(Scope* scope) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSopsPSquantization_ops_testDTcc mht_7(mht_7_v, 555, "", "./tensorflow/compiler/tf2tensorrt/convert/ops/quantization_ops_test.cc", "ConvertAndRun");
