...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_optimization_passDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_optimization_passDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_optimization_passDTh() {
      // Check if tracing is enabled
...
class TRTOptimizationPass : public grappler::CustomGraphOptimizer {
 public:
  ...
  TRTOptimizationPass(const string& name = "TRTOptimizationPass")
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_optimization_passDTh mht_0(mht_0_v, 230, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_optimization_pass.h", "TRTOptimizationPass");
}

  string name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_optimization_passDTh mht_1(mht_1_v, 235, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_optimization_pass.h", "name");
 return name_; };

  bool UsesFunctionLibrary() const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPStrt_optimization_passDTh mht_2(mht_2_v, 240, "", "./tensorflow/compiler/tf2tensorrt/convert/trt_optimization_pass.h", "UsesFunctionLibrary");
 return true; }
