...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSlogger_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSlogger_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSlogger_registryDTh() {
      // Check if tracing is enabled
...
class LoggerRegistry {
 public:
  ...
  virtual ~LoggerRegistry() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSlogger_registryDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/tf2tensorrt/convert/logger_registry.h", "~LoggerRegistry");
}
};
...
class RegisterLogger {
 public:
  RegisterLogger(const string& name, nvinfer1::ILogger* logger) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSconvertPSlogger_registryDTh mht_1(mht_1_v, 213, "", "./tensorflow/compiler/tf2tensorrt/convert/logger_registry.h", "RegisterLogger");
