...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_testutilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_testutilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_testutilsDTcc() {
      // Check if tracing is enabled
...
nvinfer1::Dims CreateDims(const std::vector<int>& d) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_testutilsDTcc mht_0(mht_0_v, 217, "", "./tensorflow/compiler/tf2tensorrt/utils/trt_testutils.cc", "CreateDims");
...
NodeDef MakeNodeDef(const std::string& name, const std::string& op,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_testutilsDTcc mht_1(mht_1_v, 233, "", "./tensorflow/compiler/tf2tensorrt/utils/trt_testutils.cc", "MakeNodeDef");
