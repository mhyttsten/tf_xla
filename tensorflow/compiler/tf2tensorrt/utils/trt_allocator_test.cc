...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocator_testDTcc() {
      // Check if tracing is enabled
...
bool RunTest(const uint64_t alignment, const uint64_t size,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocator_testDTcc mht_0(mht_0_v, 193, "", "./tensorflow/compiler/tf2tensorrt/utils/trt_allocator_test.cc", "RunTest");
