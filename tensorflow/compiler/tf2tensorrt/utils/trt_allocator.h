...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocatorDTh() {
      // Check if tracing is enabled
...
class TRTDeviceAllocator : public TRTBaseAllocator {
 ...
 public:
  ...
  virtual ~TRTDeviceAllocator() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSutilsPStrt_allocatorDTh mht_0(mht_0_v, 223, "", "./tensorflow/compiler/tf2tensorrt/utils/trt_allocator.h", "~TRTDeviceAllocator");
