...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSstubPSnvinfer_plugin_stubDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSstubPSnvinfer_plugin_stubDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSstubPSnvinfer_plugin_stubDTcc() {
      // Check if tracing is enabled
...
void* GetDsoHandle() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSstubPSnvinfer_plugin_stubDTcc mht_0(mht_0_v, 192, "", "./tensorflow/compiler/tf2tensorrt/stub/nvinfer_plugin_stub.cc", "GetDsoHandle");
...
T LoadSymbol(const char* symbol_name) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSstubPSnvinfer_plugin_stubDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/tf2tensorrt/stub/nvinfer_plugin_stub.cc", "LoadSymbol");
...
void LogFatalSymbolNotFound(const char* symbol_name) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2tensorrtPSstubPSnvinfer_plugin_stubDTcc mht_2(mht_2_v, 225, "", "./tensorflow/compiler/tf2tensorrt/stub/nvinfer_plugin_stub.cc", "LogFatalSymbolNotFound");
