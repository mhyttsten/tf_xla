...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSutilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSutilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSutilDTcc() {
      // Check if tracing is enabled
...
xla::XlaOp Zeros(xla::XlaBuilder* builder, const xla::Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSutilDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/tf2xla/lib/util.cc", "Zeros");
...
xla::XlaOp FloatLiteral(xla::XlaBuilder* builder, xla::PrimitiveType type,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSutilDTcc mht_1(mht_1_v, 209, "", "./tensorflow/compiler/tf2xla/lib/util.cc", "FloatLiteral");
...
xla::XlaOp IntegerLiteral(xla::XlaBuilder* builder, xla::PrimitiveType type,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSutilDTcc mht_2(mht_2_v, 238, "", "./tensorflow/compiler/tf2xla/lib/util.cc", "IntegerLiteral");
