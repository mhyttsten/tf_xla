...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSbroadcastDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSbroadcastDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSbroadcastDTcc() {
      // Check if tracing is enabled
...
Status BroadcastOpsToSame(xla::XlaOp* lhs, xla::XlaOp* rhs) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSbroadcastDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/tf2xla/lib/broadcast.cc", "BroadcastOpsToSame");
