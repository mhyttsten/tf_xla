...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSrandomDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSrandomDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSrandomDTcc() {
      // Check if tracing is enabled
...
xla::XlaOp TruncatedNormal(xla::XlaOp uniform) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSrandomDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/tf2xla/lib/random.cc", "TruncatedNormal");
...
xla::XlaOp ParameterizedTruncatedNormal(xla::XlaOp uniform, xla::XlaOp mu,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSrandomDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/tf2xla/lib/random.cc", "ParameterizedTruncatedNormal");
  ...
  auto normal_cdf = [&](xla::XlaOp x) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSlibPSrandomDTcc mht_2(mht_2_v, 224, "", "./tensorflow/compiler/tf2xla/lib/random.cc", "lambda");
