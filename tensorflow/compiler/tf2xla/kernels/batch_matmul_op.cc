...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbatch_matmul_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbatch_matmul_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbatch_matmul_opDTcc() {
      // Check if tracing is enabled
...
class BatchMatMulOp : public XlaOpKernel {
 public:
  explicit BatchMatMulOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbatch_matmul_opDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/tf2xla/kernels/batch_matmul_op.cc", "BatchMatMulOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbatch_matmul_opDTcc mht_1(mht_1_v, 215, "", "./tensorflow/compiler/tf2xla/kernels/batch_matmul_op.cc", "Compile");
