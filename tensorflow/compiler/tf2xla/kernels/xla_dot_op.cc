...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_dot_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_dot_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_dot_opDTcc() {
      // Check if tracing is enabled
...
class XlaDotOp : public XlaOpKernel {
 public:
  explicit XlaDotOp(OpKernelConstruction* context) : XlaOpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_dot_opDTcc mht_0(mht_0_v, 201, "", "./tensorflow/compiler/tf2xla/kernels/xla_dot_op.cc", "XlaDotOp");
  ...
  void Compile(XlaOpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_dot_opDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/tf2xla/kernels/xla_dot_op.cc", "Compile");
...
class XlaDotV2Op : public XlaDotOp {
 public:
  explicit XlaDotV2Op(OpKernelConstruction* context) : XlaDotOp(context) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_dot_opDTcc mht_2(mht_2_v, 248, "", "./tensorflow/compiler/tf2xla/kernels/xla_dot_op.cc", "XlaDotV2Op");
