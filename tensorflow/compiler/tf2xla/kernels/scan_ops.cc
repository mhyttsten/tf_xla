...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc() {
      // Check if tracing is enabled
...
class ScanOp : public XlaOpKernel {
 public:
  ScanOp(OpKernelConstruction* ctx, bool sum) : XlaOpKernel(ctx), sum_(sum) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/tf2xla/kernels/scan_ops.cc", "ScanOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc mht_1(mht_1_v, 221, "", "./tensorflow/compiler/tf2xla/kernels/scan_ops.cc", "Compile");
...
class CumsumOp : public ScanOp {
 public:
  explicit CumsumOp(OpKernelConstruction* ctx) : ScanOp(ctx, /*sum=*/true) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc mht_2(mht_2_v, 307, "", "./tensorflow/compiler/tf2xla/kernels/scan_ops.cc", "CumsumOp");
}
};
...
class CumprodOp : public ScanOp {
 public:
  explicit CumprodOp(OpKernelConstruction* ctx) : ScanOp(ctx, /*sum=*/false) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSscan_opsDTcc mht_3(mht_3_v, 319, "", "./tensorflow/compiler/tf2xla/kernels/scan_ops.cc", "CumprodOp");
}
};
