...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSspacetodepth_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSspacetodepth_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSspacetodepth_opDTcc() {
      // Check if tracing is enabled
...
class SpaceToDepthOp : public XlaOpKernel {
 public:
  explicit SpaceToDepthOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSspacetodepth_opDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/tf2xla/kernels/spacetodepth_op.cc", "SpaceToDepthOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSspacetodepth_opDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/tf2xla/kernels/spacetodepth_op.cc", "Compile");
