...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc() {
      // Check if tracing is enabled
...
ResizeConvolutionDims ComputeResizeConvolutionParameters(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_0(mht_0_v, 262, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ComputeResizeConvolutionParameters");
...
int64_t CalculateUpperPadding(int64_t in_size, int64_t out_size,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_1(mht_1_v, 303, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "CalculateUpperPadding");
...
xla::XlaOp MakeBilinear1DKernel(xla::XlaBuilder* builder,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_2(mht_2_v, 325, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "MakeBilinear1DKernel");
...
xla::XlaOp MakeNearestNeighbor1DKernel(xla::XlaBuilder* builder,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_3(mht_3_v, 348, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "MakeNearestNeighbor1DKernel");
...
xla::XlaOp MakeGeneralResizeKernel(xla::XlaBuilder* builder,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_4(mht_4_v, 365, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "MakeGeneralResizeKernel");
...
xla::XlaOp MakeGeneralResizeKernelInDim(xla::XlaBuilder* builder,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_5(mht_5_v, 387, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "MakeGeneralResizeKernelInDim");
...
xla::XlaOp BroadcastSpatialDimensions(xla::XlaBuilder* builder,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_6(mht_6_v, 406, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "BroadcastSpatialDimensions");
...
xla::XlaOp ResizeUsingDilationAndConvolution(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_7(mht_7_v, 431, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeUsingDilationAndConvolution");
...
xla::XlaOp ResizeUsingDilationAndConvolutionGradOp(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_8(mht_8_v, 580, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeUsingDilationAndConvolutionGradOp");
...
void GeneralCompile(XlaOpKernelContext* ctx, bool align_corners_,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_9(mht_9_v, 674, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "GeneralCompile");
...
ResizeNearestNeighborOp::ResizeNearestNeighborOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_10(mht_10_v, 875, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeNearestNeighborOp::ResizeNearestNeighborOp");
...
void ResizeNearestNeighborOp::Compile(XlaOpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_11(mht_11_v, 886, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeNearestNeighborOp::Compile");
...
ResizeBilinearOp::ResizeBilinearOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_12(mht_12_v, 897, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeBilinearOp::ResizeBilinearOp");
...
void ResizeBilinearOp::Compile(XlaOpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_13(mht_13_v, 908, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeBilinearOp::Compile");
...
ResizeBilinearGradOp::ResizeBilinearGradOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_14(mht_14_v, 919, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeBilinearGradOp::ResizeBilinearGradOp");
...
void ResizeBilinearGradOp::Compile(XlaOpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSimage_resize_opsDTcc mht_15(mht_15_v, 939, "", "./tensorflow/compiler/tf2xla/kernels/image_resize_ops.cc", "ResizeBilinearGradOp::Compile");
