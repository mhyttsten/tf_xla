...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc() {
      // Check if tracing is enabled
...
class CollectiveReduceV2Op : public XlaOpKernel {
 public:
  explicit CollectiveReduceV2Op(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/tf2xla/kernels/all_reduce_op.cc", "CollectiveReduceV2Op");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/tf2xla/kernels/all_reduce_op.cc", "Compile");
...
class CollectiveAssignGroupV2Op : public XlaOpKernel {
 public:
  explicit CollectiveAssignGroupV2Op(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc mht_2(mht_2_v, 269, "", "./tensorflow/compiler/tf2xla/kernels/all_reduce_op.cc", "CollectiveAssignGroupV2Op");
}

  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSall_reduce_opDTcc mht_3(mht_3_v, 274, "", "./tensorflow/compiler/tf2xla/kernels/all_reduce_op.cc", "Compile");
