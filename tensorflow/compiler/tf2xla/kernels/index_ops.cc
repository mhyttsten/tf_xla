...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc() {
      // Check if tracing is enabled
...
XlaArgMinMaxOp::XlaArgMinMaxOp(OpKernelConstruction* ctx, bool is_min)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/tf2xla/kernels/index_ops.cc", "XlaArgMinMaxOp::XlaArgMinMaxOp");
}

void XlaArgMinMaxOp::Compile(XlaOpKernelContext* ctx) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc mht_1(mht_1_v, 208, "", "./tensorflow/compiler/tf2xla/kernels/index_ops.cc", "XlaArgMinMaxOp::Compile");
...
XlaArgMaxOp::XlaArgMaxOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc mht_2(mht_2_v, 248, "", "./tensorflow/compiler/tf2xla/kernels/index_ops.cc", "XlaArgMaxOp::XlaArgMaxOp");
}
...
XlaArgMinOp::XlaArgMinOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSindex_opsDTcc mht_3(mht_3_v, 262, "", "./tensorflow/compiler/tf2xla/kernels/index_ops.cc", "XlaArgMinOp::XlaArgMinOp");
}
