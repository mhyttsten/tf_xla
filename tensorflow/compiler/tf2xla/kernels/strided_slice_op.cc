...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc() {
      // Check if tracing is enabled
...
class StridedSliceOp : public XlaOpKernel {
 public:
  explicit StridedSliceOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_0(mht_0_v, 218, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "StridedSliceOp");
  ...
  void EmitDynamicSlice(XlaOpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_1(mht_1_v, 237, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "EmitDynamicSlice");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_2(mht_2_v, 409, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "Compile");
...
class StridedSliceGradOp : public XlaOpKernel {
 public:
  explicit StridedSliceGradOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_3(mht_3_v, 585, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "StridedSliceGradOp");
  ...
  void CompileAsDynamicUpdateSlice(XlaOpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_4(mht_4_v, 608, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "CompileAsDynamicUpdateSlice");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_5(mht_5_v, 699, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "Compile");
...
class StridedSliceAssignOp : public XlaOpKernel {
 public:
  explicit StridedSliceAssignOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_6(mht_6_v, 832, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "StridedSliceAssignOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSstrided_slice_opDTcc mht_7(mht_7_v, 845, "", "./tensorflow/compiler/tf2xla/kernels/strided_slice_op.cc", "Compile");
