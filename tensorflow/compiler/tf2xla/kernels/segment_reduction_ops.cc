...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc() {
      // Check if tracing is enabled
...
class UnsortedSegmentReduce : public XlaOpKernel {
 public:
  explicit UnsortedSegmentReduce(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "UnsortedSegmentReduce");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_1(mht_1_v, 214, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "Compile");
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_2(mht_2_v, 293, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "lambda");
 return Combine(a, b); };
...
class UnsortedSegmentSum : public UnsortedSegmentReduce {
 public:
  explicit UnsortedSegmentSum(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_3(mht_3_v, 311, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "UnsortedSegmentSum");
}

  xla::XlaOp InitialValue(xla::XlaBuilder* builder) override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_4(mht_4_v, 316, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "InitialValue");

    return xla::Zero(builder, type_);
  };
  xla::XlaOp Combine(xla::XlaOp a, xla::XlaOp b) override {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_5(mht_5_v, 322, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "Combine");
 return a + b; };
};
...
class UnsortedSegmentProd : public UnsortedSegmentReduce {
 public:
  explicit UnsortedSegmentProd(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_6(mht_6_v, 335, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "UnsortedSegmentProd");
}

  xla::XlaOp InitialValue(xla::XlaBuilder* builder) override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_7(mht_7_v, 340, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "InitialValue");

    return xla::One(builder, type_);
  };
  xla::XlaOp Combine(xla::XlaOp a, xla::XlaOp b) override {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_8(mht_8_v, 346, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "Combine");
 return a * b; };
};
...
class UnsortedSegmentMin : public UnsortedSegmentReduce {
 public:
  explicit UnsortedSegmentMin(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_9(mht_9_v, 359, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "UnsortedSegmentMin");
}

  xla::XlaOp InitialValue(xla::XlaBuilder* builder) override {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_10(mht_10_v, 364, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "InitialValue");

    return xla::MaxFiniteValue(builder, type_);
  };
  xla::XlaOp Combine(xla::XlaOp a, xla::XlaOp b) override {
   std::vector<std::string> mht_11_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_11(mht_11_v, 370, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "Combine");
...
class UnsortedSegmentMax : public UnsortedSegmentReduce {
 public:
  explicit UnsortedSegmentMax(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_12(mht_12_v, 385, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "UnsortedSegmentMax");
}

  xla::XlaOp InitialValue(xla::XlaBuilder* builder) override {
   std::vector<std::string> mht_13_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_13(mht_13_v, 390, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "InitialValue");

    return xla::MinFiniteValue(builder, type_);
  };
  xla::XlaOp Combine(xla::XlaOp a, xla::XlaOp b) override {
   std::vector<std::string> mht_14_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSsegment_reduction_opsDTcc mht_14(mht_14_v, 396, "", "./tensorflow/compiler/tf2xla/kernels/segment_reduction_ops.cc", "Combine");
