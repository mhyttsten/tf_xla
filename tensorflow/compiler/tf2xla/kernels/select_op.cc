...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc() {
      // Check if tracing is enabled
...
class SelectOp : public XlaOpKernel {
 public:
  explicit SelectOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/tf2xla/kernels/select_op.cc", "SelectOp");
}

  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc mht_1(mht_1_v, 208, "", "./tensorflow/compiler/tf2xla/kernels/select_op.cc", "Compile");
...
class SelectOpV2 : public XlaOpKernel {
 public:
  explicit SelectOpV2(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc mht_2(mht_2_v, 260, "", "./tensorflow/compiler/tf2xla/kernels/select_op.cc", "SelectOpV2");
}

  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSselect_opDTcc mht_3(mht_3_v, 265, "", "./tensorflow/compiler/tf2xla/kernels/select_op.cc", "Compile");
