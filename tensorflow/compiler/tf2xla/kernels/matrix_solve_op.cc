...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_solve_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_solve_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_solve_opDTcc() {
      // Check if tracing is enabled
...
class MatrixSolveOp : public XlaOpKernel {
 public:
  explicit MatrixSolveOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_solve_opDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/tf2xla/kernels/matrix_solve_op.cc", "MatrixSolveOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_solve_opDTcc mht_1(mht_1_v, 203, "", "./tensorflow/compiler/tf2xla/kernels/matrix_solve_op.cc", "Compile");
