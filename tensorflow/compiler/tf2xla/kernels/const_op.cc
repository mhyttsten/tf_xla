...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSconst_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSconst_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSconst_opDTcc() {
      // Check if tracing is enabled
...
xla::XlaOp GetScalarConst(const TensorProto& proto, xla::XlaBuilder* b) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSconst_opDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/tf2xla/kernels/const_op.cc", "GetScalarConst");
...
class ConstOp : public XlaOpKernel {
 public:
  explicit ConstOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSconst_opDTcc mht_1(mht_1_v, 274, "", "./tensorflow/compiler/tf2xla/kernels/const_op.cc", "ConstOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSconst_opDTcc mht_2(mht_2_v, 289, "", "./tensorflow/compiler/tf2xla/kernels/const_op.cc", "Compile");
