...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSempty_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSempty_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSempty_opDTcc() {
      // Check if tracing is enabled
...
class EmptyOp : public XlaOpKernel {
 public:
  explicit EmptyOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSempty_opDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/tf2xla/kernels/empty_op.cc", "EmptyOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSempty_opDTcc mht_1(mht_1_v, 211, "", "./tensorflow/compiler/tf2xla/kernels/empty_op.cc", "Compile");
