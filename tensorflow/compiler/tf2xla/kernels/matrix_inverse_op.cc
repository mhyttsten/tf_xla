...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_inverse_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_inverse_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_inverse_opDTcc() {
      // Check if tracing is enabled
...
class MatrixInverseOp : public XlaOpKernel {
 public:
  explicit MatrixInverseOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_inverse_opDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/tf2xla/kernels/matrix_inverse_op.cc", "MatrixInverseOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSmatrix_inverse_opDTcc mht_1(mht_1_v, 202, "", "./tensorflow/compiler/tf2xla/kernels/matrix_inverse_op.cc", "Compile");
