...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbucketize_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbucketize_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbucketize_opDTcc() {
      // Check if tracing is enabled
...
class BucketizeOp : public XlaOpKernel {
 public:
  explicit BucketizeOp(OpKernelConstruction* context) : XlaOpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbucketize_opDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/tf2xla/kernels/bucketize_op.cc", "BucketizeOp");
  ...
  void Compile(XlaOpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbucketize_opDTcc mht_1(mht_1_v, 207, "", "./tensorflow/compiler/tf2xla/kernels/bucketize_op.cc", "Compile");
