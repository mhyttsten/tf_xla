...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc() {
      // Check if tracing is enabled
...
class GatherOp : public XlaOpKernel {
 public:
  explicit GatherOp(OpKernelConstruction* context) : XlaOpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/tf2xla/kernels/gather_scatter_ops.cc", "GatherOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc mht_1(mht_1_v, 209, "", "./tensorflow/compiler/tf2xla/kernels/gather_scatter_ops.cc", "Compile");
...
class ScatterOp : public XlaOpKernel {
 public:
  explicit ScatterOp(OpKernelConstruction* context) : XlaOpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc mht_2(mht_2_v, 232, "", "./tensorflow/compiler/tf2xla/kernels/gather_scatter_ops.cc", "ScatterOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSgather_scatter_opsDTcc mht_3(mht_3_v, 247, "", "./tensorflow/compiler/tf2xla/kernels/gather_scatter_ops.cc", "Compile");
