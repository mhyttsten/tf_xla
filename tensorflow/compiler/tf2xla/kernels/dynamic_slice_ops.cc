...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSdynamic_slice_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSdynamic_slice_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSdynamic_slice_opsDTcc() {
      // Check if tracing is enabled
...
class DynamicUpdateSliceOp : public XlaOpKernel {
 public:
  explicit DynamicUpdateSliceOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSdynamic_slice_opsDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/tf2xla/kernels/dynamic_slice_ops.cc", "DynamicUpdateSliceOp");
}

  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSdynamic_slice_opsDTcc mht_1(mht_1_v, 217, "", "./tensorflow/compiler/tf2xla/kernels/dynamic_slice_ops.cc", "Compile");
