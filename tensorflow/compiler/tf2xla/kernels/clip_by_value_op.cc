...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSclip_by_value_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSclip_by_value_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSclip_by_value_opDTcc() {
      // Check if tracing is enabled
...
class ClipByValueOp : public XlaOpKernel {
 public:
  explicit ClipByValueOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSclip_by_value_opDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/tf2xla/kernels/clip_by_value_op.cc", "ClipByValueOp");
}

  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSclip_by_value_opDTcc mht_1(mht_1_v, 200, "", "./tensorflow/compiler/tf2xla/kernels/clip_by_value_op.cc", "Compile");
