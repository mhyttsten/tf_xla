...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc() {
      // Check if tracing is enabled
...
class PassOn : public XlaOpKernel {
 public:
  explicit PassOn(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/tf2xla/kernels/function_ops.cc", "PassOn");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/tf2xla/kernels/function_ops.cc", "Compile");
...
class AlwaysFailOp : public OpKernel {
 public:
  explicit AlwaysFailOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc mht_2(mht_2_v, 231, "", "./tensorflow/compiler/tf2xla/kernels/function_ops.cc", "AlwaysFailOp");
}

  ~AlwaysFailOp() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc mht_3(mht_3_v, 236, "", "./tensorflow/compiler/tf2xla/kernels/function_ops.cc", "~AlwaysFailOp");
}

  void Compute(OpKernelContext* ctx) override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSfunction_opsDTcc mht_4(mht_4_v, 241, "", "./tensorflow/compiler/tf2xla/kernels/function_ops.cc", "Compute");
