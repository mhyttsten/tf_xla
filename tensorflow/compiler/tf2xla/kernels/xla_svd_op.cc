...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc() {
      // Check if tracing is enabled
...
class XlaSvdOp : public XlaOpKernel {
 public:
  explicit XlaSvdOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/tf2xla/kernels/xla_svd_op.cc", "XlaSvdOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc mht_1(mht_1_v, 214, "", "./tensorflow/compiler/tf2xla/kernels/xla_svd_op.cc", "Compile");
...
class SvdOp : public XlaOpKernel {
 public:
  explicit SvdOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc mht_2(mht_2_v, 233, "", "./tensorflow/compiler/tf2xla/kernels/xla_svd_op.cc", "SvdOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSxla_svd_opDTcc mht_3(mht_3_v, 240, "", "./tensorflow/compiler/tf2xla/kernels/xla_svd_op.cc", "Compile");
