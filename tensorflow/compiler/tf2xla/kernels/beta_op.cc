...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbeta_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbeta_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbeta_opDTcc() {
      // Check if tracing is enabled
...
class BetaincOp : public XlaOpKernel {
 public:
  explicit BetaincOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbeta_opDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/tf2xla/kernels/beta_op.cc", "BetaincOp");
}

  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSkernelsPSbeta_opDTcc mht_1(mht_1_v, 208, "", "./tensorflow/compiler/tf2xla/kernels/beta_op.cc", "Compile");
