...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_argumentDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_argumentDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_argumentDTcc() {
      // Check if tracing is enabled
...
bool AnyUninitializedResourceArg(absl::Span<const XlaArgument> args) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_argumentDTcc mht_0(mht_0_v, 224, "", "./tensorflow/compiler/tf2xla/xla_argument.cc", "AnyUninitializedResourceArg");
