...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc() {
      // Check if tracing is enabled
...
Status InputTypesNeedsRearrange(const std::vector<DataType>& in_types,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_0(mht_0_v, 226, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "InputTypesNeedsRearrange");
...
Status ReorderInputEdges(Graph* g, Node* n,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_1(mht_1_v, 281, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "ReorderInputEdges");
...
Status ReorderOutputEdges(Graph* g, Node* n, int input_count,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_2(mht_2_v, 309, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "ReorderOutputEdges");
...
void RearrangeArgNodes(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_3(mht_3_v, 342, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "RearrangeArgNodes");
...
Status CalculateRetvalRearrange(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_4(mht_4_v, 363, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "CalculateRetvalRearrange");
...
Status RearrangeOutputEdges(Node* n, Graph* g,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_5(mht_5_v, 414, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "RearrangeOutputEdges");
...
void RearrangeRetvalNodes(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_6(mht_6_v, 450, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "RearrangeRetvalNodes");
...
Status MaybeRewriteWhileNode(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_7(mht_7_v, 469, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "MaybeRewriteWhileNode");
...
Status MaybeRewriteIfNode(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_8(mht_8_v, 577, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "MaybeRewriteIfNode");
...
Status RearrangeFunctionArguments(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSrearrange_function_argumentDTcc mht_9(mht_9_v, 710, "", "./tensorflow/compiler/tf2xla/rearrange_function_argument.cc", "RearrangeFunctionArguments");
