...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_jit_compiled_cpu_functionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_jit_compiled_cpu_functionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_jit_compiled_cpu_functionDTh() {
      // Check if tracing is enabled
...
class XlaJitCompiledCpuFunction {
 public:
  ...
  const XlaCompiledCpuFunction::StaticData& StaticData() const {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_jit_compiled_cpu_functionDTh mht_0(mht_0_v, 226, "", "./tensorflow/compiler/tf2xla/xla_jit_compiled_cpu_function.h", "StaticData");
 ...
 private:
  XlaJitCompiledCpuFunction() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_jit_compiled_cpu_functionDTh mht_1(mht_1_v, 234, "", "./tensorflow/compiler/tf2xla/xla_jit_compiled_cpu_function.h", "XlaJitCompiledCpuFunction");
}
