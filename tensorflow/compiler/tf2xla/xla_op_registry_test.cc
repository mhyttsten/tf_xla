...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc() {
      // Check if tracing is enabled
...
class DummyCPUOp : public XlaOpKernel {
 public:
  explicit DummyCPUOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/tf2xla/xla_op_registry_test.cc", "DummyCPUOp");
}
  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc mht_1(mht_1_v, 202, "", "./tensorflow/compiler/tf2xla/xla_op_registry_test.cc", "Compile");
...
class DummyGenericOp : public XlaOpKernel {
 public:
  explicit DummyGenericOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc mht_2(mht_2_v, 213, "", "./tensorflow/compiler/tf2xla/xla_op_registry_test.cc", "DummyGenericOp");
}
  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc mht_3(mht_3_v, 217, "", "./tensorflow/compiler/tf2xla/xla_op_registry_test.cc", "Compile");
...
class DummyInfeasibleTypeConstraintOp : public XlaOpKernel {
 public:
  explicit DummyInfeasibleTypeConstraintOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc mht_4(mht_4_v, 270, "", "./tensorflow/compiler/tf2xla/xla_op_registry_test.cc", "DummyInfeasibleTypeConstraintOp");
}
  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registry_testDTcc mht_5(mht_5_v, 274, "", "./tensorflow/compiler/tf2xla/xla_op_registry_test.cc", "Compile");
