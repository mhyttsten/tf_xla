...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_table_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_table_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_table_testDTcc() {
      // Check if tracing is enabled
...
bool IsResourceArgDef(const OpDef::ArgDef& arg_def) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_table_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/tf2xla/resource_operation_table_test.cc", "IsResourceArgDef");
...
bool HasResourceInputOrOutput(const OpDef& op_def) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_table_testDTcc mht_1(mht_1_v, 203, "", "./tensorflow/compiler/tf2xla/resource_operation_table_test.cc", "HasResourceInputOrOutput");
