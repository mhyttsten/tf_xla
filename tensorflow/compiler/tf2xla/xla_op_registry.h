...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registryDTh() {
      // Check if tracing is enabled
...
class XlaOpRegistry {
 public:
  ...
  static Status CompileTimeConstantInputs(const NodeDef& node_def,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registryDTh mht_0(mht_0_v, 359, "", "./tensorflow/compiler/tf2xla/xla_op_registry.h", "CompileTimeConstantInputs");
  ...
  static Status CompileTimeConstantInputs(const OpKernel& op_kernel,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_op_registryDTh mht_1(mht_1_v, 372, "", "./tensorflow/compiler/tf2xla/xla_op_registry.h", "CompileTimeConstantInputs");
