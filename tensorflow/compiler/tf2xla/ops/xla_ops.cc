...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc() {
      // Check if tracing is enabled
...
Status UnchangedRank(shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/tf2xla/ops/xla_ops.cc", "UnchangedRank");
...
static Status XlaDotShapeFunction(shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc mht_1(mht_1_v, 376, "", "./tensorflow/compiler/tf2xla/ops/xla_ops.cc", "XlaDotShapeFunction");
...
REGISTER_OP("XlaReduce")
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc mht_2(mht_2_v, 792, "", "./tensorflow/compiler/tf2xla/ops/xla_ops.cc", "lambda");
...
REGISTER_OP("XlaVariadicReduce")
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc mht_3(mht_3_v, 845, "", "./tensorflow/compiler/tf2xla/ops/xla_ops.cc", "lambda");
...
REGISTER_OP("XlaVariadicReduceV2")
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc mht_4(mht_4_v, 929, "", "./tensorflow/compiler/tf2xla/ops/xla_ops.cc", "lambda");
...
Status OptimizationBarrierShape(shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSopsPSxla_opsDTcc mht_5(mht_5_v, 1394, "", "./tensorflow/compiler/tf2xla/ops/xla_ops.cc", "OptimizationBarrierShape");
