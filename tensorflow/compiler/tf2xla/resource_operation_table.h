...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_tableDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_tableDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_tableDTh() {
      // Check if tracing is enabled
...
class XlaResourceOpInfo {
 public:
  explicit XlaResourceOpInfo(XlaResourceOpKind op_kind,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_tableDTh mht_0(mht_0_v, 214, "", "./tensorflow/compiler/tf2xla/resource_operation_table.h", "XlaResourceOpInfo");
}

  XlaResourceOpKind kind() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_tableDTh mht_1(mht_1_v, 219, "", "./tensorflow/compiler/tf2xla/resource_operation_table.h", "kind");
 return op_kind_; }
  XlaResourceKind resource_kind() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSresource_operation_tableDTh mht_2(mht_2_v, 223, "", "./tensorflow/compiler/tf2xla/resource_operation_table.h", "resource_kind");
