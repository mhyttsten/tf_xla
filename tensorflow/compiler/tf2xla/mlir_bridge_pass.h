...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSmlir_bridge_passDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSmlir_bridge_passDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSmlir_bridge_passDTh() {
      // Check if tracing is enabled
...
class MlirBridgePass : public MlirOptimizationPass {
 public:
  llvm::StringRef name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSmlir_bridge_passDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/tf2xla/mlir_bridge_pass.h", "name");
 return "bridge"; }
...
class MlirBridgeV1CompatPass : public MlirV1CompatOptimizationPass {
 public:
  llvm::StringRef name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSmlir_bridge_passDTh mht_1(mht_1_v, 222, "", "./tensorflow/compiler/tf2xla/mlir_bridge_pass.h", "name");
 return "bridge"; }
