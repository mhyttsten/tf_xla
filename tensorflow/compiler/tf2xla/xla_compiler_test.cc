...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc() {
      // Check if tracing is enabled
...
class XlaCompilerTest : public ::testing::Test {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_0(mht_0_v, 232, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "SetUp");
  ...
  XlaCompiler::Options DefaultOptions() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_1(mht_1_v, 244, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "DefaultOptions");
  ...
  FunctionLibraryDefinition* LocalFlibDef(XlaCompiler* compiler) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_2(mht_2_v, 255, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "LocalFlibDef");
...
class DummyResourceForTest : public ResourceBase {
 public:
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_3(mht_3_v, 272, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "DebugString");
 return "dummy"; }
  void Increment() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_4(mht_4_v, 276, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "Increment");
 ++value_; }
  int Get() {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_5(mht_5_v, 280, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "Get");
 return value_; }
...
class DummyReadResourceOp : public XlaOpKernel {
 public:
  explicit DummyReadResourceOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_6(mht_6_v, 291, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "DummyReadResourceOp");
}
  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_7(mht_7_v, 295, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "Compile");
...
class DummyReadResourceCC {
 public:
  DummyReadResourceCC(const Scope& scope, const Input& value) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_8(mht_8_v, 314, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "DummyReadResourceCC");
...
class DummyDuplicateOp : public XlaOpKernel {
 public:
  explicit DummyDuplicateOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_9(mht_9_v, 356, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "DummyDuplicateOp");
}
  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_10(mht_10_v, 360, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "Compile");
...
TEST_F(XlaCompilerTest, ResourceManager) {
  ...
  std::function<Status(ResourceMgr*)> populate_function =
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_11(mht_11_v, 926, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "lambda");
...
FunctionDef FillFn() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_12(mht_12_v, 1154, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "FillFn");
...
FunctionDef SliceFn() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_13(mht_13_v, 1239, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "SliceFn");
...
void RunAndCheckVariablesComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_14(mht_14_v, 1309, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "RunAndCheckVariablesComputation");
...
class DummySideEffectingOp : public XlaOpKernel {
 public:
  explicit DummySideEffectingOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_15(mht_15_v, 1793, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "DummySideEffectingOp");
}
  void Compile(XlaOpKernelContext* ctx) override {
   std::vector<std::string> mht_16_v;
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_compiler_testDTcc mht_16(mht_16_v, 1797, "", "./tensorflow/compiler/tf2xla/xla_compiler_test.cc", "Compile");
