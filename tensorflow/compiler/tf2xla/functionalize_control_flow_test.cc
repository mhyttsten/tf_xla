...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc() {
      // Check if tracing is enabled
...
Status FindIfThenAndElse(const GraphDef& graph, string* op_name,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "FindIfThenAndElse");
...
class ConditionalTestFixture
 ...
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_1(mht_1_v, 245, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "SetUp");
...
void ConditionalTestFixture::BuildCondGraph(Graph* cond_graph) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_2(mht_2_v, 278, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "ConditionalTestFixture::BuildCondGraph");
...
void ConditionalTestFixture::CheckGraphDef(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_3(mht_3_v, 319, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "ConditionalTestFixture::CheckGraphDef");
...
void ConditionalTestFixture::RunTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_4(mht_4_v, 394, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "ConditionalTestFixture::RunTest");
  ...
  NodeFilter node_filter =
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_5(mht_5_v, 430, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "lambda");
 return n->attrs().Find("_tpu_replicate"); }
          : NodeFilter{};
...
Status FindWhileCondAndBody(const GraphDef& graph, NameAttrList* cond,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_6(mht_6_v, 480, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "FindWhileCondAndBody");
...
FunctionDef GetNoinlineFunctionDef() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_7(mht_7_v, 620, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "GetNoinlineFunctionDef");
...
Status AddNoinlineFunctionToGraph(const string& node_name, Graph* graph) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_8(mht_8_v, 641, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "AddNoinlineFunctionToGraph");
...
class ComplexTestFixture
 ...
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_9(mht_9_v, 1070, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "SetUp");
...
void ComplexTestFixture::RunTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_10(mht_10_v, 1118, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "ComplexTestFixture::RunTest");
  ...
  NodeFilter node_filter =
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_11(mht_11_v, 1289, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "lambda");
 return n->attrs().Find("_tpu_replicate"); }
          : NodeFilter{};
...
void ComplexTestFixture::CheckOuterNodesFunctionalized(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_12(mht_12_v, 1339, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "ComplexTestFixture::CheckOuterNodesFunctionalized");
...
void ComplexTestFixture::CheckInnerNodesFunctionalized(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_control_flow_testDTcc mht_13(mht_13_v, 1444, "", "./tensorflow/compiler/tf2xla/functionalize_control_flow_test.cc", "ComplexTestFixture::CheckInnerNodesFunctionalized");
