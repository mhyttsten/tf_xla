...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPStf2xla_util_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPStf2xla_util_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPStf2xla_util_testDTcc() {
      // Check if tracing is enabled
...
void ExpectErrorContains(const Status& status, absl::string_view str) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPStf2xla_util_testDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/tf2xla/tf2xla_util_test.cc", "ExpectErrorContains");
...
static tf2xla::Config FetchesConfig(std::vector<string> fetches) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPStf2xla_util_testDTcc mht_1(mht_1_v, 333, "", "./tensorflow/compiler/tf2xla/tf2xla_util_test.cc", "FetchesConfig");
