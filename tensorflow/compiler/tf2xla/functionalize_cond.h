...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_condDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_condDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_condDTh() {
      // Check if tracing is enabled
...
class FunctionalizeCond {
 ...
 private:
  ...
  Status DetermineCondState(Node* dst) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSfunctionalize_condDTh mht_0(mht_0_v, 398, "", "./tensorflow/compiler/tf2xla/functionalize_cond.h", "DetermineCondState");
