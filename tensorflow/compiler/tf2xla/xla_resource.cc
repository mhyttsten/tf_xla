...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc() {
      // Check if tracing is enabled
...
/*static*/ absl::string_view XlaResource::KindToString(XlaResource::Kind kind) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::KindToString");
...
/*static*/ std::unique_ptr<XlaResource> XlaResource::CreateStack(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::CreateStack");
...
/*static*/ std::unique_ptr<XlaResource> XlaResource::CreateTensorArray(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_2(mht_2_v, 231, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::CreateTensorArray");
...
XlaResource::XlaResource(
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_3(mht_3_v, 259, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::XlaResource");
...
Status XlaResource::SetTypeAndShape(DataType type, const TensorShape& shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_4(mht_4_v, 274, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::SetTypeAndShape");
...
Status XlaResource::SetValue(const xla::XlaOp& value) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_5(mht_5_v, 302, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::SetValue");
...
Status XlaResource::SetZeroValue(xla::XlaBuilder* builder) {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_6(mht_6_v, 316, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::SetZeroValue");
...
Status XlaResource::GetOrCreateTensorArrayGradient(const string& source,
   ...
   mht_7_v.push_back("source: \"" + source + "\"");
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_7(mht_7_v, 361, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::GetOrCreateTensorArrayGradient");
...
Status XlaResource::Pack(xla::XlaOp* pack, xla::XlaBuilder* builder) const {
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_8(mht_8_v, 386, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::Pack");
...
Status XlaResource::SetFromPack(const std::set<string>& gradient_sources,
   ...
   MHTracer_DTPStensorflowPScompilerPStf2xlaPSxla_resourceDTcc mht_9(mht_9_v, 406, "", "./tensorflow/compiler/tf2xla/xla_resource.cc", "XlaResource::SetFromPack");
