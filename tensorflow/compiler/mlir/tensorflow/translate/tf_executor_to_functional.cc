...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_executor_to_functionalDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_executor_to_functionalDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_executor_to_functionalDTcc() {
      // Check if tracing is enabled
...
LogicalResult LiftIslandOpInnerOpsFromGraph(tf_executor::GraphOp graph) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_executor_to_functionalDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/tensorflow/translate/tf_executor_to_functional.cc", "LiftIslandOpInnerOpsFromGraph");
...
void ExecutorDialectToFunctionalConversion::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_executor_to_functionalDTcc mht_1(mht_1_v, 244, "", "./tensorflow/compiler/mlir/tensorflow/translate/tf_executor_to_functional.cc", "ExecutorDialectToFunctionalConversion::runOnOperation");
