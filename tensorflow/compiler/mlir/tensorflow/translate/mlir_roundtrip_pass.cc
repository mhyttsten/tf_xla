...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSmlir_roundtrip_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSmlir_roundtrip_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSmlir_roundtrip_passDTcc() {
      // Check if tracing is enabled
...
static Status Export(mlir::OwningOpRef<mlir::ModuleOp> module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSmlir_roundtrip_passDTcc mht_0(mht_0_v, 225, "", "./tensorflow/compiler/mlir/tensorflow/translate/mlir_roundtrip_pass.cc", "Export");
...
static Status Roundtrip(const GraphOptimizationPassOptions& options,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSmlir_roundtrip_passDTcc mht_1(mht_1_v, 234, "", "./tensorflow/compiler/mlir/tensorflow/translate/mlir_roundtrip_pass.cc", "Roundtrip");
...
Status MlirRoundtripPass::Run(const GraphOptimizationPassOptions& options) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSmlir_roundtrip_passDTcc mht_2(mht_2_v, 242, "", "./tensorflow/compiler/mlir/tensorflow/translate/mlir_roundtrip_pass.cc", "MlirRoundtripPass::Run");
