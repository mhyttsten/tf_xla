...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_functional_to_executorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_functional_to_executorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_functional_to_executorDTcc() {
      // Check if tracing is enabled
...
void FunctionalToExecutorDialectConversion::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStf_functional_to_executorDTcc mht_0(mht_0_v, 219, "", "./tensorflow/compiler/mlir/tensorflow/translate/tf_functional_to_executor.cc", "FunctionalToExecutorDialectConversion::runOnOperation");
