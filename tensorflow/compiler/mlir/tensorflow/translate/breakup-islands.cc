...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc() {
      // Check if tracing is enabled
...
class BreakUpIslands : public TF::PerFunctionAggregateAnalysisConsumerPass<
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_0(mht_0_v, 215, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "getDependentDialects");
 ...
 public:
  StringRef getArgument() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_1(mht_1_v, 223, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "getArgument");
 return "tf-executor-break-up-islands"; }

  StringRef getDescription() const final {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_2(mht_2_v, 228, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "getDescription");
...
void BreakUpIslands::runOnFunction(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_3(mht_3_v, 245, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "BreakUpIslands::runOnFunction");
...
void PopulateEmptyIsland(tf_executor::IslandOp island) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_4(mht_4_v, 316, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "PopulateEmptyIsland");
...
tf_executor::IslandOp CreateIsland(TypeRange result_types,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_5(mht_5_v, 343, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "CreateIsland");
...
bool IsStatefulFunctionalControlFlowOp(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_6(mht_6_v, 384, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "IsStatefulFunctionalControlFlowOp");
...
IslandSourcesAndSinks FindSourcesAndSinksInIsland(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_7(mht_7_v, 401, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "FindSourcesAndSinksInIsland");
...
void BreakUpIslands::BreakUpIsland(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePSbreakupSLislandsDTcc mht_8(mht_8_v, 441, "", "./tensorflow/compiler/mlir/tensorflow/translate/breakup-islands.cc", "BreakUpIslands::BreakUpIsland");
