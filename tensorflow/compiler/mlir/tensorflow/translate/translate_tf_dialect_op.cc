...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStranslate_tf_dialect_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStranslate_tf_dialect_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStranslate_tf_dialect_opDTcc() {
      // Check if tracing is enabled
...
static mlir::Operation* ExtractOnlyOp(mlir::ModuleOp module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStranslate_tf_dialect_opDTcc mht_0(mht_0_v, 196, "", "./tensorflow/compiler/mlir/tensorflow/translate/translate_tf_dialect_op.cc", "ExtractOnlyOp");
...
static LogicalResult MlirToTfNodeDef(ModuleOp module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStranslatePStranslate_tf_dialect_opDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/tensorflow/translate/translate_tf_dialect_op.cc", "MlirToTfNodeDef");
