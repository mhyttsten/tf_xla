...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSinitialize_variables_in_session_init_test_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSinitialize_variables_in_session_init_test_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSinitialize_variables_in_session_init_test_passDTcc() {
      // Check if tracing is enabled
...
class InitializeVariablesInSessionInitializerPass
 ...
 public:
  void runOnOperation() final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSinitialize_variables_in_session_init_test_passDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/tensorflow/transforms/initialize_variables_in_session_init_test_pass.cc", "runOnOperation");
