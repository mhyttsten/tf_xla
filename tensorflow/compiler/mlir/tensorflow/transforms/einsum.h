...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTh() {
      // Check if tracing is enabled
...
struct ConvertTFEinsumOp : public OpRewritePattern<TF::EinsumOp> {
 public:
  explicit ConvertTFEinsumOp(MLIRContext* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTh mht_0(mht_0_v, 215, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.h", "ConvertTFEinsumOp");
}
