...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc() {
      // Check if tracing is enabled
...
void UnrollBatchMatMulPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc mht_0(mht_0_v, 239, "", "./tensorflow/compiler/mlir/tensorflow/transforms/unroll_batch_matmul.cc", "UnrollBatchMatMulPass::runOnOperation");
...
TF::ReshapeOp ConvertTFBatchMatMulOp<BatchMatMulOpType>::createReshapeOp(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc mht_1(mht_1_v, 254, "", "./tensorflow/compiler/mlir/tensorflow/transforms/unroll_batch_matmul.cc", "ConvertTFBatchMatMulOp<BatchMatMulOpType>::createReshapeOp");
...
std::vector<Value> ConvertTFBatchMatMulOp<BatchMatMulOpType>::sliceInput(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc mht_2(mht_2_v, 271, "", "./tensorflow/compiler/mlir/tensorflow/transforms/unroll_batch_matmul.cc", "ConvertTFBatchMatMulOp<BatchMatMulOpType>::sliceInput");
...
LogicalResult ConvertTFBatchMatMulOp<BatchMatMulOpType>::matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc mht_3(mht_3_v, 324, "", "./tensorflow/compiler/mlir/tensorflow/transforms/unroll_batch_matmul.cc", "ConvertTFBatchMatMulOp<BatchMatMulOpType>::matchAndRewrite");
...
void mlir::TF::PopulateUnrollTfBatchMatMul(MLIRContext* context,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSunroll_batch_matmulDTcc mht_4(mht_4_v, 475, "", "./tensorflow/compiler/mlir/tensorflow/transforms/unroll_batch_matmul.cc", "mlir::TF::PopulateUnrollTfBatchMatMul");
