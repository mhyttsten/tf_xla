...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSguarantee_all_funcs_one_useDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSguarantee_all_funcs_one_useDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSguarantee_all_funcs_one_useDTcc() {
      // Check if tracing is enabled
...
class GuaranteeAllFuncsOneUse
 ...
 public:
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSguarantee_all_funcs_one_useDTcc mht_0(mht_0_v, 224, "", "./tensorflow/compiler/mlir/tensorflow/transforms/guarantee_all_funcs_one_use.cc", "runOnOperation");
  ...
  LogicalResult Run() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSguarantee_all_funcs_one_useDTcc mht_1(mht_1_v, 233, "", "./tensorflow/compiler/mlir/tensorflow/transforms/guarantee_all_funcs_one_use.cc", "Run");
