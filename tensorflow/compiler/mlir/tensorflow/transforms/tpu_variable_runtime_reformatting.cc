...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc() {
      // Check if tracing is enabled
...
std::string GetRandomStateVariableName() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc mht_0(mht_0_v, 235, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_variable_runtime_reformatting.cc", "GetRandomStateVariableName");
...
Value SkipIdentity(Value v, bool allow_other_use,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc mht_1(mht_1_v, 251, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_variable_runtime_reformatting.cc", "SkipIdentity");
...
tf_device::ReplicateOp AddInputsToReplicateOp(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc mht_2(mht_2_v, 402, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_variable_runtime_reformatting.cc", "AddInputsToReplicateOp");
...
void WrapOpInLaunch(OpBuilder* builder, Location loc, Operation* op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc mht_3(mht_3_v, 496, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_variable_runtime_reformatting.cc", "WrapOpInLaunch");
...
void HandleReplicateOp(TF::WhileRegionOp while_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc mht_4(mht_4_v, 517, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_variable_runtime_reformatting.cc", "HandleReplicateOp");
...
void TPUVariableRuntimeReformattingPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_variable_runtime_reformattingDTcc mht_5(mht_5_v, 659, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_variable_runtime_reformatting.cc", "TPUVariableRuntimeReformattingPass::runOnOperation");
