...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_cluster_formationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_cluster_formationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_cluster_formationDTcc() {
      // Check if tracing is enabled
...
void EncapsulateStatefulpartitionedCall(TF::StatefulPartitionedCallOp call_op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_cluster_formationDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/tensorflow/transforms/xla_cluster_formation.cc", "EncapsulateStatefulpartitionedCall");
...
void XlaClusterFormationPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_cluster_formationDTcc mht_1(mht_1_v, 225, "", "./tensorflow/compiler/mlir/tensorflow/transforms/xla_cluster_formation.cc", "XlaClusterFormationPass::runOnOperation");
