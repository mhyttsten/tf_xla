...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdeduplicate_bound_input_bindingsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdeduplicate_bound_input_bindingsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdeduplicate_bound_input_bindingsDTcc() {
      // Check if tracing is enabled
...
void DedupBoundInputBindingPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdeduplicate_bound_input_bindingsDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/mlir/tensorflow/transforms/deduplicate_bound_input_bindings.cc", "DedupBoundInputBindingPass::runOnOperation");
