...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSset_tpu_infeed_layoutDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSset_tpu_infeed_layoutDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSset_tpu_infeed_layoutDTcc() {
      // Check if tracing is enabled
...
bool SetTPUInfeedLayout(mlir::OwningOpRef<mlir::ModuleOp> &mlir_module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSset_tpu_infeed_layoutDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tensorflow/transforms/set_tpu_infeed_layout.cc", "SetTPUInfeedLayout");
