...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconvert_to_legacy_compile_and_replicate_attributesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconvert_to_legacy_compile_and_replicate_attributesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconvert_to_legacy_compile_and_replicate_attributesDTcc() {
      // Check if tracing is enabled
...
LogicalResult ConvertToLegacyAttributes(FuncOp func_op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconvert_to_legacy_compile_and_replicate_attributesDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/mlir/tensorflow/transforms/convert_to_legacy_compile_and_replicate_attributes.cc", "ConvertToLegacyAttributes");
...
void ConvertToLegacyCompileAndReplicateAttributesPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconvert_to_legacy_compile_and_replicate_attributesDTcc mht_1(mht_1_v, 229, "", "./tensorflow/compiler/mlir/tensorflow/transforms/convert_to_legacy_compile_and_replicate_attributes.cc", "ConvertToLegacyCompileAndReplicateAttributesPass::runOnOperation");
