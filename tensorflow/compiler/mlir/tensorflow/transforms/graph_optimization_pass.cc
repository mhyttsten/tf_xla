...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTcc() {
      // Check if tracing is enabled
...
Status MlirGraphOptimizationPass::Run(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/mlir/tensorflow/transforms/graph_optimization_pass.cc", "MlirGraphOptimizationPass::Run");
