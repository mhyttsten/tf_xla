...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSannotate_parameter_replicationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSannotate_parameter_replicationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSannotate_parameter_replicationDTcc() {
      // Check if tracing is enabled
...
Value SkipIdentityAndReadVariable(Value v) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSannotate_parameter_replicationDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/mlir/tensorflow/transforms/annotate_parameter_replication.cc", "SkipIdentityAndReadVariable");
...
void AnnotateParameterReplicationPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSannotate_parameter_replicationDTcc mht_1(mht_1_v, 231, "", "./tensorflow/compiler/mlir/tensorflow/transforms/annotate_parameter_replication.cc", "AnnotateParameterReplicationPass::runOnOperation");
