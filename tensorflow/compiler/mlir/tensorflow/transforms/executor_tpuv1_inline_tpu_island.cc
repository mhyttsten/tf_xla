...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSexecutor_tpuv1_inline_tpu_islandDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSexecutor_tpuv1_inline_tpu_islandDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSexecutor_tpuv1_inline_tpu_islandDTcc() {
      // Check if tracing is enabled
...
void ExecutorTPUV1IslandInliningPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSexecutor_tpuv1_inline_tpu_islandDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/mlir/tensorflow/transforms/executor_tpuv1_inline_tpu_island.cc", "ExecutorTPUV1IslandInliningPass::runOnOperation");
