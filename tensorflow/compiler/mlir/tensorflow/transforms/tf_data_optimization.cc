...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStf_data_optimizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStf_data_optimizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStf_data_optimizationDTcc() {
      // Check if tracing is enabled
...
struct FuseParallelMapAndBatch : public OpRewritePattern<BatchDatasetV2Op> {
  ...
  LogicalResult matchAndRewrite(BatchDatasetV2Op op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStf_data_optimizationDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tf_data_optimization.cc", "matchAndRewrite");
...
void PopulateTFDataOptimizationPatterns(MLIRContext *context,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStf_data_optimizationDTcc mht_1(mht_1_v, 235, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tf_data_optimization.cc", "PopulateTFDataOptimizationPatterns");
