...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc() {
      // Check if tracing is enabled
...
class PerFunctionResult {
 public:
  explicit PerFunctionResult(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_0(mht_0_v, 242, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "PerFunctionResult");
}
  ...
  LogicalResult AddResourceDevice(Value resource, StringRef device,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_1(mht_1_v, 269, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "AddResourceDevice");
...
LogicalResult AddResourceDeviceAndEmitError(Value resource, StringRef device,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_2(mht_2_v, 295, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "AddResourceDeviceAndEmitError");
...
inline StringRef GetDeviceAttr(FuncOp func, int arg_no) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_3(mht_3_v, 308, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "GetDeviceAttr");
...
inline StringRef GetDeviceAttr(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_4(mht_4_v, 318, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "GetDeviceAttr");
...
void dump(StringRef message, Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_5(mht_5_v, 327, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "dump");
...
LogicalResult ComputeResourceDevicesInComputation(FuncOp func_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_6(mht_6_v, 338, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "ComputeResourceDevicesInComputation");
...
void ResourceDeviceInference::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_7(mht_7_v, 418, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "ResourceDeviceInference::runOnOperation");
  ...
  auto propagate_operands_to_callee_arguments =
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSresource_device_inferenceDTcc mht_8(mht_8_v, 437, "", "./tensorflow/compiler/mlir/tensorflow/transforms/resource_device_inference.cc", "lambda");
