...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSsink_constantDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSsink_constantDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSsink_constantDTcc() {
      // Check if tracing is enabled
...
class ClusterConstantSinkingPass
 ...
 public:
  explicit ClusterConstantSinkingPass(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSsink_constantDTcc mht_0(mht_0_v, 215, "", "./tensorflow/compiler/mlir/tensorflow/transforms/sink_constant.cc", "ClusterConstantSinkingPass");
}

  void runOnOperation() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSsink_constantDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/mlir/tensorflow/transforms/sink_constant.cc", "runOnOperation");
