...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSrewrite_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSrewrite_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSrewrite_utilDTh() {
      // Check if tracing is enabled
...
DenseElementsAttr GetScalarOfType(Type ty, T raw_value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSrewrite_utilDTh mht_0(mht_0_v, 196, "", "./tensorflow/compiler/mlir/tensorflow/transforms/rewrite_util.h", "GetScalarOfType");
