...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc() {
      // Check if tracing is enabled
...
static Type GetResourceSubtypeOrDefault(Value resource, Type element_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops.cc", "GetResourceSubtypeOrDefault");
...
static bool HasResourceSubtype(Value resource) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc mht_1(mht_1_v, 214, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops.cc", "HasResourceSubtype");
...
static Type GetResourceSubtype(Value resource) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc mht_2(mht_2_v, 226, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops.cc", "GetResourceSubtype");
...
class DecomposeRngReadAndSkipOp : public RewritePattern {
 public:
  explicit DecomposeRngReadAndSkipOp(MLIRContext *context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc mht_3(mht_3_v, 267, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops.cc", "DecomposeRngReadAndSkipOp");
}

  LogicalResult matchAndRewrite(Operation *op,
                                PatternRewriter &rewriter) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc mht_4(mht_4_v, 273, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops.cc", "matchAndRewrite");
...
void PopulateDecomposeResourceOpsPatterns(MLIRContext *context,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_opsDTcc mht_5(mht_5_v, 382, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops.cc", "PopulateDecomposeResourceOpsPatterns");
