...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_index_selectorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_index_selectorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_index_selectorDTcc() {
      // Check if tracing is enabled
...
void DeviceIndexSelector::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_index_selectorDTcc mht_0(mht_0_v, 223, "", "./tensorflow/compiler/mlir/tensorflow/transforms/device_index_selector.cc", "DeviceIndexSelector::runOnOperation");
