...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStest_cluster_ops_by_policyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStest_cluster_ops_by_policyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStest_cluster_ops_by_policyDTcc() {
      // Check if tracing is enabled
...
class TestOpsClusteringPolicy : public ClusteringPolicy {
  LogicalResult MatchAndUpdateConstraints(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStest_cluster_ops_by_policyDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/tensorflow/transforms/test_cluster_ops_by_policy.cc", "MatchAndUpdateConstraints");
...
void TestClusteringPolicyPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStest_cluster_ops_by_policyDTcc mht_1(mht_1_v, 230, "", "./tensorflow/compiler/mlir/tensorflow/transforms/test_cluster_ops_by_policy.cc", "TestClusteringPolicyPass::runOnOperation");
