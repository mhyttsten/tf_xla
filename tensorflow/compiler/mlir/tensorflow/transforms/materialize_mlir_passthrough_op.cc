...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSmaterialize_mlir_passthrough_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSmaterialize_mlir_passthrough_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSmaterialize_mlir_passthrough_opDTcc() {
      // Check if tracing is enabled
...
void MaterializePassthroughOpPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSmaterialize_mlir_passthrough_opDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/mlir/tensorflow/transforms/materialize_mlir_passthrough_op.cc", "MaterializePassthroughOpPass::runOnOperation");
