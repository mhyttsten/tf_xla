...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSoutside_compiled_to_host_launchDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSoutside_compiled_to_host_launchDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSoutside_compiled_to_host_launchDTcc() {
      // Check if tracing is enabled
...
void WrapOpInLaunch(Operation* host_op, llvm::StringRef host_device) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSoutside_compiled_to_host_launchDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/tensorflow/transforms/outside_compiled_to_host_launch.cc", "WrapOpInLaunch");
...
void OutsideCompiledToHostLaunchPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSoutside_compiled_to_host_launchDTcc mht_1(mht_1_v, 231, "", "./tensorflow/compiler/mlir/tensorflow/transforms/outside_compiled_to_host_launch.cc", "OutsideCompiledToHostLaunchPass::runOnOperation");
  ...
  auto traverse_op = [&](Operation* op, tf_device::ClusterOp tpu_cluster,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSoutside_compiled_to_host_launchDTcc mht_2(mht_2_v, 238, "", "./tensorflow/compiler/mlir/tensorflow/transforms/outside_compiled_to_host_launch.cc", "lambda");
