...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc() {
      // Check if tracing is enabled
...
void PopulateClusterReachableFunctions(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc mht_0(mht_0_v, 213, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops_pass.cc", "PopulateClusterReachableFunctions");
...
LogicalResult ApplyPatternsLocallyUntilConverged(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc mht_1(mht_1_v, 262, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops_pass.cc", "ApplyPatternsLocallyUntilConverged");
...
LogicalResult ApplyPatternsInClusterAndReachableFunctions(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc mht_2(mht_2_v, 289, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops_pass.cc", "ApplyPatternsInClusterAndReachableFunctions");
...
struct DecomposeResourceOpsPass
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc mht_3(mht_3_v, 333, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops_pass.cc", "runOnOperation");
...
struct DecomposeResourceOpsInClusterPass
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdecompose_resource_ops_passDTcc mht_4(mht_4_v, 352, "", "./tensorflow/compiler/mlir/tensorflow/transforms/decompose_resource_ops_pass.cc", "runOnOperation");
