...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSfreeze_saved_model_assetsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSfreeze_saved_model_assetsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSfreeze_saved_model_assetsDTcc() {
      // Check if tracing is enabled
...
struct FreezeAssetsPass : public FreezeAssetsPassBase<FreezeAssetsPass> {
  ...
  FreezeAssetsPass(const FreezeAssetsPass& pass) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSfreeze_saved_model_assetsDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/tensorflow/transforms/freeze_saved_model_assets.cc", "FreezeAssetsPass");
}
  explicit FreezeAssetsPass(std::string saved_model_dir) {
   std::vector<std::string> mht_1_v;
   mht_1_v.push_back("saved_model_dir: \"" + saved_model_dir + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSfreeze_saved_model_assetsDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/tensorflow/transforms/freeze_saved_model_assets.cc", "FreezeAssetsPass");
...
void FreezeAssetsPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSfreeze_saved_model_assetsDTcc mht_2(mht_2_v, 229, "", "./tensorflow/compiler/mlir/tensorflow/transforms/freeze_saved_model_assets.cc", "FreezeAssetsPass::runOnOperation");
