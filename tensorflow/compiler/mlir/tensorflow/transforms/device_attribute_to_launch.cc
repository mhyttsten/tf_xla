...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_attribute_to_launchDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_attribute_to_launchDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_attribute_to_launchDTcc() {
      // Check if tracing is enabled
...
void WrapOpInLaunch(Operation* op, llvm::StringRef device) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_attribute_to_launchDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/tensorflow/transforms/device_attribute_to_launch.cc", "WrapOpInLaunch");
...
void DeviceAttributeToLaunch::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSdevice_attribute_to_launchDTcc mht_1(mht_1_v, 228, "", "./tensorflow/compiler/mlir/tensorflow/transforms/device_attribute_to_launch.cc", "DeviceAttributeToLaunch::runOnOperation");
