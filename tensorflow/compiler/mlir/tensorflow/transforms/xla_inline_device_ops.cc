...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_inline_device_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_inline_device_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_inline_device_opsDTcc() {
      // Check if tracing is enabled
...
void InlineDeviceOp(tf_device::ClusterOp cluster_op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_inline_device_opsDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/mlir/tensorflow/transforms/xla_inline_device_ops.cc", "InlineDeviceOp");
...
void XlaInlineDeviceOpsPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSxla_inline_device_opsDTcc mht_1(mht_1_v, 230, "", "./tensorflow/compiler/mlir/tensorflow/transforms/xla_inline_device_ops.cc", "XlaInlineDeviceOpsPass::runOnOperation");
