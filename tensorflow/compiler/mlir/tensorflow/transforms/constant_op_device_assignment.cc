...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconstant_op_device_assignmentDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconstant_op_device_assignmentDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconstant_op_device_assignmentDTcc() {
      // Check if tracing is enabled
...
void ConstantOpDeviceAssignmentPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSconstant_op_device_assignmentDTcc mht_0(mht_0_v, 210, "", "./tensorflow/compiler/mlir/tensorflow/transforms/constant_op_device_assignment.cc", "ConstantOpDeviceAssignmentPass::runOnOperation");
