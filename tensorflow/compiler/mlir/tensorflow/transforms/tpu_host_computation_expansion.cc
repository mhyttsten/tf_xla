...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc() {
      // Check if tracing is enabled
...
bool HasOutsideCompilationAttribute(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_host_computation_expansion.cc", "HasOutsideCompilationAttribute");
...
Operation* GetOpOfValue(Value value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_host_computation_expansion.cc", "GetOpOfValue");
...
bool IsTrivialUnaryOperation(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc mht_2(mht_2_v, 227, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_host_computation_expansion.cc", "IsTrivialUnaryOperation");
...
void ExpandHeadOutsideCompiledOps(tf_device::ClusterOp cluster,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc mht_3(mht_3_v, 242, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_host_computation_expansion.cc", "ExpandHeadOutsideCompiledOps");
...
void TPUHostComputationExpansionPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_host_computation_expansionDTcc mht_4(mht_4_v, 300, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_host_computation_expansion.cc", "TPUHostComputationExpansionPass::runOnOperation");
