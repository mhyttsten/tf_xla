...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTh() {
      // Check if tracing is enabled
...
class MlirGraphOptimizationPass : public ::tensorflow::MlirOptimizationPass {
 public:
  llvm::StringRef name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/tensorflow/transforms/graph_optimization_pass.h", "name");
 return "graph_optimization"; }
  ...
  ::tensorflow::MlirOptimizationPassState GetPassState(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSgraph_optimization_passDTh mht_1(mht_1_v, 207, "", "./tensorflow/compiler/mlir/tensorflow/transforms/graph_optimization_pass.h", "GetPassState");
