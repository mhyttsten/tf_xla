...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc() {
      // Check if tracing is enabled
...
TF::TransposeOp createTransposeOp(Value value, Location loc,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_0(mht_0_v, 229, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "createTransposeOp");
...
TF::ReshapeOp createReshapeOp(Value value, ArrayRef<int64_t> shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_1(mht_1_v, 251, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "createReshapeOp");
...
llvm::Optional<llvm::SetVector<char>> GetAvailableLabels(
  ...
  auto is_start_of_ellipsis = [](StringRef equation, int start_index) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_2(mht_2_v, 305, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "lambda");
...
std::string GenerateLabels(int count,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_3(mht_3_v, 357, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "GenerateLabels");
...
LogicalResult transposeForBatchMatmul(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_4(mht_4_v, 512, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "transposeForBatchMatmul");
...
inline int64_t ProdShapeWithIndexInTuple(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_5(mht_5_v, 564, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "ProdShapeWithIndexInTuple");
...
LogicalResult reshapeForBatchMatmul(const Location& loc,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_6(mht_6_v, 584, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "reshapeForBatchMatmul");
...
LogicalResult rewriteToBatchMatmul(TF::EinsumOp op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_7(mht_7_v, 661, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "rewriteToBatchMatmul");
...
void TransformEinsumPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_8(mht_8_v, 710, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "TransformEinsumPass::runOnOperation");
...
LogicalResult ConvertTFEinsumOp::matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSeinsumDTcc mht_9(mht_9_v, 724, "", "./tensorflow/compiler/mlir/tensorflow/transforms/einsum.cc", "ConvertTFEinsumOp::matchAndRewrite");
