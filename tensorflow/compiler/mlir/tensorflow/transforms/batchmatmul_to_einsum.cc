...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSbatchmatmul_to_einsumDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSbatchmatmul_to_einsumDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSbatchmatmul_to_einsumDTcc() {
      // Check if tracing is enabled
...
class ConvertTFBatchMatMulToEinsumOp
  ...
  LogicalResult matchAndRewrite(BatchMatMulOpType op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSbatchmatmul_to_einsumDTcc mht_0(mht_0_v, 221, "", "./tensorflow/compiler/mlir/tensorflow/transforms/batchmatmul_to_einsum.cc", "matchAndRewrite");
...
void BatchMatMulToEinsumPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPSbatchmatmul_to_einsumDTcc mht_1(mht_1_v, 263, "", "./tensorflow/compiler/mlir/tensorflow/transforms/batchmatmul_to_einsum.cc", "BatchMatMulToEinsumPass::runOnOperation");
