...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_cluster_cleanup_attributesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_cluster_cleanup_attributesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_cluster_cleanup_attributesDTcc() {
      // Check if tracing is enabled
...
class TPUCleanupClusterAttributesPass
 ...
 public:
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_cluster_cleanup_attributesDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_cluster_cleanup_attributes.cc", "runOnOperation");

    auto traverse_op = [&](Operation* op, tf_device::ClusterOp tpu_cluster) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPStransformsPStpu_cluster_cleanup_attributesDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/mlir/tensorflow/transforms/tpu_cluster_cleanup_attributes.cc", "lambda");
