...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTcc() {
      // Check if tracing is enabled
...
LogicalResult HasValidCompilationAndReplicationAttributes(Operation& op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTcc mht_0(mht_0_v, 194, "", "./tensorflow/compiler/mlir/tensorflow/utils/attribute_utils.cc", "HasValidCompilationAndReplicationAttributes");
