...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSsession_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSsession_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSsession_utilsDTcc() {
      // Check if tracing is enabled
...
std::string GetVariableName(TF::VarHandleOp var_handle_op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSsession_utilsDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/tensorflow/utils/session_utils.cc", "GetVariableName");
...
tensorflow::Var* GetVariableFromSession(mlir::TF::VarHandleOp var_handle_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSsession_utilsDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/mlir/tensorflow/utils/session_utils.cc", "GetVariableFromSession");
