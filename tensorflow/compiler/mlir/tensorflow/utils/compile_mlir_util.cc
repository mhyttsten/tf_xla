...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc() {
      // Check if tracing is enabled
...
Status MaybeRewriteLayoutWithShardedShape(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_0(mht_0_v, 262, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "MaybeRewriteLayoutWithShardedShape");
...
Status GetXlaInputShapes(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_1(mht_1_v, 284, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "GetXlaInputShapes");
...
Status GetOutputInfo(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_2(mht_2_v, 333, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "GetOutputInfo");

  auto shape_representation_fn_no_fast_memory =
      [shape_representation_fn](const TensorShape& shape, DataType dtype) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_3(mht_3_v, 338, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "lambda");
...
void GetInputMappingForMlir(int num_inputs, std::vector<int>* input_mapping) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_4(mht_4_v, 417, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "GetInputMappingForMlir");
...
static void RegisterDialects(mlir::DialectRegistry& registry) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_5(mht_5_v, 425, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "RegisterDialects");
...
bool CanInlineFunctionsPostLegalization(llvm::StringRef device_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_6(mht_6_v, 436, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CanInlineFunctionsPostLegalization");
...
Status RefineShapes(llvm::ArrayRef<TensorOrResourceShape> arg_shapes,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_7(mht_7_v, 446, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "RefineShapes");
...
void CreateConvertMlirToXlaHloPipeline(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_8(mht_8_v, 501, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CreateConvertMlirToXlaHloPipeline");
...
Status LegalizeToHlo(mlir::ModuleOp module_op, llvm::StringRef device_type,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_9(mht_9_v, 584, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "LegalizeToHlo");
...
Status BuildHloFromTfInner(mlir::ModuleOp module_op, xla::XlaBuilder& builder,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_10(mht_10_v, 624, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "BuildHloFromTfInner");
...
Status ConvertMLIRToXlaComputation(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_11(mht_11_v, 643, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "ConvertMLIRToXlaComputation");
...
Status CompileMlirSetup(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_12(mht_12_v, 660, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CompileMlirSetup");
...
Status BuildHloFromTf(mlir::ModuleOp module_op, xla::XlaBuilder& builder,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_13(mht_13_v, 682, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "BuildHloFromTf");
...
Status PopulateCollectiveInfo(mlir::ModuleOp module_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_14(mht_14_v, 705, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "PopulateCollectiveInfo");
...
Status PopulateResultIOInfo(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_15(mht_15_v, 738, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "PopulateResultIOInfo");
...
Status CompileMlirToXlaHlo(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_16(mht_16_v, 765, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CompileMlirToXlaHlo");
...
Status CompileSerializedMlirToXlaHlo(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_17(mht_17_v, 798, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CompileSerializedMlirToXlaHlo");
...
Status CompileGraphSetup(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_18(mht_18_v, 897, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CompileGraphSetup");
...
Status BuildHloFromModule(mlir::ModuleOp module_op, xla::XlaBuilder& builder,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_19(mht_19_v, 940, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "BuildHloFromModule");
...
Status CompileGraphToXlaHlo(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_20(mht_20_v, 962, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CompileGraphToXlaHlo");
...
Status BuildHloFromGraph(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_21(mht_21_v, 1006, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "BuildHloFromGraph");
...
Status CompileGraphToXlaHlo(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_22(mht_22_v, 1025, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "CompileGraphToXlaHlo");
...
void RegisterConvertMlirToXlaHloPipelineWithDefaults() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPScompile_mlir_utilDTcc mht_23(mht_23_v, 1039, "", "./tensorflow/compiler/mlir/tensorflow/utils/compile_mlir_util.cc", "RegisterConvertMlirToXlaHloPipelineWithDefaults");
