...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSshape_inference_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSshape_inference_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSshape_inference_utilsDTcc() {
      // Check if tracing is enabled
...
LogicalResult InferReturnTypeComponentsForTFOp(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSshape_inference_utilsDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tensorflow/utils/shape_inference_utils.cc", "InferReturnTypeComponentsForTFOp");
