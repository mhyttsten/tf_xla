...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc() {
      // Check if tracing is enabled
...
BridgeLoggerConfig::BridgeLoggerConfig(bool print_module_scope,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_0(mht_0_v, 206, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "BridgeLoggerConfig::BridgeLoggerConfig");
}
...
inline static void Log(BridgeLoggerConfig::PrintCallbackFn print_callback,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_1(mht_1_v, 215, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "Log");
...
void BridgeLoggerConfig::printBeforeIfEnabled(mlir::Pass* pass,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_2(mht_2_v, 235, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "BridgeLoggerConfig::printBeforeIfEnabled");
...
void BridgeLoggerConfig::printAfterIfEnabled(mlir::Pass* pass,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_3(mht_3_v, 244, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "BridgeLoggerConfig::printAfterIfEnabled");
...
std::vector<std::string> BridgeLoggerConfig::GetFilter(
   ...
   mht_4_v.push_back("env_var: \"" + env_var + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_4(mht_4_v, 253, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "BridgeLoggerConfig::GetFilter");
...
bool BridgeLoggerConfig::MatchesFilter(const std::string& str,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_5(mht_5_v, 268, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "BridgeLoggerConfig::MatchesFilter");
...
bool BridgeLoggerConfig::ShouldPrint(mlir::Pass* pass, mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSbridge_loggerDTcc mht_6(mht_6_v, 280, "", "./tensorflow/compiler/mlir/tensorflow/utils/bridge_logger.cc", "BridgeLoggerConfig::ShouldPrint");
