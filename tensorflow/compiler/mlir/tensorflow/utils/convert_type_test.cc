...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSconvert_type_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSconvert_type_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSconvert_type_testDTcc() {
      // Check if tracing is enabled
...
std::string ConvertToMlirString(const std::vector<int64_t>& dims,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSconvert_type_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tensorflow/utils/convert_type_test.cc", "ConvertToMlirString");
