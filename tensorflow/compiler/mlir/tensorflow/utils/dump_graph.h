...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSdump_graphDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSdump_graphDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSdump_graphDTh() {
      // Check if tracing is enabled
...
struct MlirDumpConfig {
  ...
  MlirDumpConfig& elide_large_attributes(int large_element_limit = 16) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSdump_graphDTh mht_0(mht_0_v, 213, "", "./tensorflow/compiler/mlir/tensorflow/utils/dump_graph.h", "elide_large_attributes");
  ...
  MlirDumpConfig& emit_location_information(bool pretty_form = false) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSdump_graphDTh mht_1(mht_1_v, 224, "", "./tensorflow/compiler/mlir/tensorflow/utils/dump_graph.h", "emit_location_information");
  ...
  MlirDumpConfig& emit_dialect(Dialect dialect) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSdump_graphDTh mht_2(mht_2_v, 232, "", "./tensorflow/compiler/mlir/tensorflow/utils/dump_graph.h", "emit_dialect");
