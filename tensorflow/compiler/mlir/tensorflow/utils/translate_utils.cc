...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPStranslate_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPStranslate_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPStranslate_utilsDTcc() {
      // Check if tracing is enabled
...
void PopulateTfVersions(mlir::ModuleOp module, const VersionDef& versions) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPStranslate_utilsDTcc mht_0(mht_0_v, 192, "", "./tensorflow/compiler/mlir/tensorflow/utils/translate_utils.cc", "PopulateTfVersions");
...
mlir::LogicalResult ExtractTfVersions(mlir::ModuleOp module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPStranslate_utilsDTcc mht_1(mht_1_v, 212, "", "./tensorflow/compiler/mlir/tensorflow/utils/translate_utils.cc", "ExtractTfVersions");
