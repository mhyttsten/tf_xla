...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSverify_suitable_for_graph_exportDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSverify_suitable_for_graph_exportDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSverify_suitable_for_graph_exportDTcc() {
      // Check if tracing is enabled
...
mlir::LogicalResult VerifyExportSuitable(mlir::ModuleOp module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSverify_suitable_for_graph_exportDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/mlir/tensorflow/utils/verify_suitable_for_graph_export.cc", "VerifyExportSuitable");
