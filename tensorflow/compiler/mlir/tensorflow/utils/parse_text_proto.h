...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSparse_text_protoDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSparse_text_protoDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSparse_text_protoDTh() {
      // Check if tracing is enabled
...
inline Status ParseTextProto(absl::string_view /* text_proto */,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSparse_text_protoDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/tensorflow/utils/parse_text_proto.h", "ParseTextProto");
