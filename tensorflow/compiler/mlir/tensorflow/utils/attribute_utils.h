...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh() {
      // Check if tracing is enabled
...
void CopyAttributes(Operation *from, Operation *to, Predicate P) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tensorflow/utils/attribute_utils.h", "CopyAttributes");
...
inline void CopyUnderscoredAttributes(Operation *from, Operation *to) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh mht_1(mht_1_v, 209, "", "./tensorflow/compiler/mlir/tensorflow/utils/attribute_utils.h", "CopyUnderscoredAttributes");
...
inline void CopyDeviceAndUnderscoredAttributes(Operation *from, Operation *to) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh mht_2(mht_2_v, 222, "", "./tensorflow/compiler/mlir/tensorflow/utils/attribute_utils.h", "CopyDeviceAndUnderscoredAttributes");
...
bool GetValueAsConstant(Value val, AttrT &attr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSutilsPSattribute_utilsDTh mht_3(mht_3_v, 240, "", "./tensorflow/compiler/mlir/tensorflow/utils/attribute_utils.h", "GetValueAsConstant");
