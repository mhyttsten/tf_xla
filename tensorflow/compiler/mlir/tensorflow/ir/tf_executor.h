...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_executorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_executorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_executorDTh() {
      // Check if tracing is enabled
...
class TensorFlowExecutorDialect : public Dialect {
 public:
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_executorDTh mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_executor.h", "getDialectNamespace");
 return "tf_executor"; }
