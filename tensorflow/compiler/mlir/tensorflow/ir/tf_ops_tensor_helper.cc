...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc() {
      // Check if tracing is enabled
...
RankedTensorType GetRankedTensorTypeForOperand(Value operand) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.cc", "GetRankedTensorTypeForOperand");
...
Type DeduceEqualCmpOpType(Builder *builder, Location loc, Value x, Value y,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc mht_1(mht_1_v, 217, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.cc", "DeduceEqualCmpOpType");
...
Type InferReductionOpType(Value input, Value reduction_indices,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc mht_2(mht_2_v, 238, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.cc", "InferReductionOpType");
...
LogicalResult VerifyTypesCompatibility(Operation::operand_type_range types,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTcc mht_3(mht_3_v, 291, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.cc", "VerifyTypesCompatibility");
