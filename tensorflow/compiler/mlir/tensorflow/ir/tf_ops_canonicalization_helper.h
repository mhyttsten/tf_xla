...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_canonicalization_helperDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_canonicalization_helperDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_canonicalization_helperDTh() {
      // Check if tracing is enabled
...
struct DropAttributes : public OpRewritePattern<Op> {
  ...
  LogicalResult matchAndRewrite(Op op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_canonicalization_helperDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_canonicalization_helper.h", "matchAndRewrite");
