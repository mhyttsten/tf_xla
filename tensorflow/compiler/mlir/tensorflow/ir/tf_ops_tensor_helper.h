...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh() {
      // Check if tracing is enabled
...
inline bool IsOfRankedFloatTensorType(RankedTensorType type, int rank) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.h", "IsOfRankedFloatTensorType");
...
inline bool IsOfRankOrUnranked(Value value, int64_t rank) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.h", "IsOfRankOrUnranked");
...
inline bool HasRankAtLeast(Value value, int64_t rank) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh mht_2(mht_2_v, 226, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.h", "HasRankAtLeast");
...
inline bool HasRankAtMost(Value value, int64_t rank) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh mht_3(mht_3_v, 236, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.h", "HasRankAtMost");
...
inline bool IsUnknownDimOrRank(int64_t dim_or_rank) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh mht_4(mht_4_v, 244, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.h", "IsUnknownDimOrRank");
...
inline int64_t GetDimForAxis(int64_t axis, int64_t rank) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_ops_tensor_helperDTh mht_5(mht_5_v, 253, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_ops_tensor_helper.h", "GetDimForAxis");
