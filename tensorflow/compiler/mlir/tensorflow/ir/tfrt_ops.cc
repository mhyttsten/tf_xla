...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStfrt_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStfrt_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStfrt_opsDTcc() {
      // Check if tracing is enabled
...
LogicalResult _TfrtGetResourceOp::verify() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStfrt_opsDTcc mht_0(mht_0_v, 222, "", "./tensorflow/compiler/mlir/tensorflow/ir/tfrt_ops.cc", "_TfrtGetResourceOp::verify");
