...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_saved_modelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_saved_modelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_saved_modelDTh() {
      // Check if tracing is enabled
...
class TensorFlowSavedModelDialect : public Dialect {
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_saved_modelDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_saved_model.h", "getDialectNamespace");
...
T LookupBoundInputOfType(func::FuncOp func, int arg_index,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_saved_modelDTh mht_1(mht_1_v, 242, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_saved_model.h", "LookupBoundInputOfType");
