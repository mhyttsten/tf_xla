...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh() {
      // Check if tracing is enabled
...
inline bool IsResourceHandleAnonymous(StringRef name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_0(mht_0_v, 232, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "IsResourceHandleAnonymous");
...
struct ResourceHandle {
  ResourceHandle(StringRef container, StringRef name, StringRef device,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_1(mht_1_v, 247, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "ResourceHandle");
}
...
inline ::llvm::hash_code hash_value(const ResourceHandle& resource_handle) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_2(mht_2_v, 267, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "hash_value");
...
struct ResourceHandleValueAndId {
  ResourceHandleValueAndId(Value value, int64_t id) : value(value), id(id) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_3(mht_3_v, 278, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "ResourceHandleValueAndId");
}
...
struct DenseMapInfo<mlir::TF::ResourceHandle> {
  static mlir::TF::ResourceHandle getEmptyKey() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_4(mht_4_v, 310, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "getEmptyKey");
  ...
  static mlir::TF::ResourceHandle getTombstoneKey() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_5(mht_5_v, 318, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "getTombstoneKey");
  ...
  static unsigned getHashValue(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_6(mht_6_v, 327, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "getHashValue");
  ...
  static bool isEqual(const mlir::TF::ResourceHandle& lhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTh mht_7(mht_7_v, 335, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.h", "isEqual");
