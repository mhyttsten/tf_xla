...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTcc() {
      // Check if tracing is enabled
...
llvm::StringRef GetDeviceOrEmpty(Operation *op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTcc mht_0(mht_0_v, 190, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.cc", "GetDeviceOrEmpty");
...
ResourceHandleValueAndId GetResourceHandleValueAndIdBase(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_op_interfacesDTcc mht_1(mht_1_v, 205, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_op_interfaces.cc", "GetResourceHandleValueAndIdBase");
