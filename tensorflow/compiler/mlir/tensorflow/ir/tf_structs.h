...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_structsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_structsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_structsDTh() {
      // Check if tracing is enabled
...
class RuntimeDevices {
 ...
 public:
  ...
  size_t NumDevices() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_structsDTh mht_0(mht_0_v, 218, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_structs.h", "NumDevices");
