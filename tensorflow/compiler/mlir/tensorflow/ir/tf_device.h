...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_deviceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_deviceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_deviceDTh() {
      // Check if tracing is enabled
...
class TensorFlowDeviceDialect : public Dialect {
 public:
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSirPStf_deviceDTh mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/tensorflow/ir/tf_device.h", "getDialectNamespace");
 return "tf_device"; }
