...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSanalysisPSper_function_aggregate_analysisDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSanalysisPSper_function_aggregate_analysisDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSanalysisPSper_function_aggregate_analysisDTh() {
      // Check if tracing is enabled
...
class PerFunctionAggregateAnalysis {
 public:
  ...
  const Info& GetAnalysisForFunc(FuncOp func) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSanalysisPSper_function_aggregate_analysisDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/mlir/tensorflow/analysis/per_function_aggregate_analysis.h", "GetAnalysisForFunc");
...
class PerFunctionAggregateAnalysisConsumerPass
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStensorflowPSanalysisPSper_function_aggregate_analysisDTh mht_1(mht_1_v, 236, "", "./tensorflow/compiler/mlir/tensorflow/analysis/per_function_aggregate_analysis.h", "runOnOperation");
