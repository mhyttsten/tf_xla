...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTh() {
      // Check if tracing is enabled
...
static inline MlirBridgeRolloutPolicy GetMlirBridge2ndPhaseRolloutPolicy(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTh mht_0(mht_0_v, 231, "", "./tensorflow/compiler/mlir/mlir_bridge_rollout_policy.h", "GetMlirBridge2ndPhaseRolloutPolicy");
