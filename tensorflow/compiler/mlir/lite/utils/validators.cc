...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc() {
      // Check if tracing is enabled
...
bool TFIntListIs1XY1(Operation *op, StringRef name, IntegerAttr *x,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "TFIntListIs1XY1");
...
bool TFIntListIs1XY1(const Attribute attr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_1(mht_1_v, 223, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "TFIntListIs1XY1");
...
bool TFIntListIs1XYZ1(Operation *op, StringRef name, IntegerAttr *x,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_2(mht_2_v, 244, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "TFIntListIs1XYZ1");
...
bool TFIntListIsAllOnes(const Attribute attr) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_3(mht_3_v, 271, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "TFIntListIsAllOnes");
...
bool IsBroadcastableElementsAttrs(mlir::Attribute a, mlir::Attribute b) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_4(mht_4_v, 282, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "IsBroadcastableElementsAttrs");
...
bool IsDimensionsDegenerateExceptLastOne(ArrayRef<int64_t> elements_shape) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_5(mht_5_v, 292, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "IsDimensionsDegenerateExceptLastOne");
...
bool IsDimensionsDegenerateExceptLastOne(Attribute val) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTcc mht_6(mht_6_v, 304, "", "./tensorflow/compiler/mlir/lite/utils/validators.cc", "IsDimensionsDegenerateExceptLastOne");
