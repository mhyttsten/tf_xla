...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvariables_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvariables_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvariables_utilsDTcc() {
      // Check if tracing is enabled
...
bool IsSupportedVariableType(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvariables_utilsDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/mlir/lite/utils/variables_utils.cc", "IsSupportedVariableType");
...
bool IsSupportedVariableType(ShapedType type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvariables_utilsDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/lite/utils/variables_utils.cc", "IsSupportedVariableType");
