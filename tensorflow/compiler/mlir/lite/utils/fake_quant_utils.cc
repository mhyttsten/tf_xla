...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSfake_quant_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSfake_quant_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSfake_quant_utilsDTcc() {
      // Check if tracing is enabled
...
LogicalResult UnwrapTFCustomOps(FuncOp fn, OpBuilder& builder) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSfake_quant_utilsDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/lite/utils/fake_quant_utils.cc", "UnwrapTFCustomOps");
...
LogicalResult ConvertFakeQuantOps(FuncOp func, MLIRContext* ctx,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSfake_quant_utilsDTcc mht_1(mht_1_v, 243, "", "./tensorflow/compiler/mlir/lite/utils/fake_quant_utils.cc", "ConvertFakeQuantOps");
