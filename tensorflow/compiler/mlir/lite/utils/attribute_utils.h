...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSattribute_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSattribute_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSattribute_utilsDTh() {
      // Check if tracing is enabled
...
inline bool HasAll3Attrs(Attribute a, Attribute b, Attribute c) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSattribute_utilsDTh mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/lite/utils/attribute_utils.h", "HasAll3Attrs");
