...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPStftext_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPStftext_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPStftext_utils_testDTcc() {
      // Check if tracing is enabled
...
void Register(const std::string& op_name, OpRegistry* registry) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPStftext_utils_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/lite/utils/tftext_utils_test.cc", "Register");
