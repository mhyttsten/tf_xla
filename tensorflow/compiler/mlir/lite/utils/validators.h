...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh() {
      // Check if tracing is enabled
...
inline bool TFDataFormatIsNHWC(Operation *op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFDataFormatIsNHWC");
...
inline bool TFDataFormatIsNDHWC(Operation *op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_1(mht_1_v, 213, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFDataFormatIsNDHWC");
...
inline bool TFTypeIsFloat32Tensor(Value value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_2(mht_2_v, 244, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFTypeIsFloat32Tensor");
...
inline bool TFTypeIsBFloat16Tensor(Value value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_3(mht_3_v, 254, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFTypeIsBFloat16Tensor");
...
inline bool TFTypeIsHalfTensor(Value value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_4(mht_4_v, 264, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFTypeIsHalfTensor");
...
inline bool TFTypeIsBFloat16OrHalfTensor(Value value) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_5(mht_5_v, 274, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFTypeIsBFloat16OrHalfTensor");
...
inline bool TFPaddingIsSameOrValid(Operation *op, StringAttr *padding) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSvalidatorsDTh mht_6(mht_6_v, 283, "", "./tensorflow/compiler/mlir/lite/utils/validators.h", "TFPaddingIsSameOrValid");
