...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSnms_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSnms_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSnms_utilsDTh() {
      // Check if tracing is enabled
...
class ConvertNMSPaddedFunc {
 public:
  explicit ConvertNMSPaddedFunc(FuncOp func) : func_(func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSnms_utilsDTh mht_0(mht_0_v, 206, "", "./tensorflow/compiler/mlir/lite/utils/nms_utils.h", "ConvertNMSPaddedFunc");
}
...
class ConvertSSDPostProcessFunc {
 public:
  explicit ConvertSSDPostProcessFunc(FuncOp func, mlir::TF::FuncAttr attr)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSnms_utilsDTh mht_1(mht_1_v, 224, "", "./tensorflow/compiler/mlir/lite/utils/nms_utils.h", "ConvertSSDPostProcessFunc");
}
