...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSarithmetic_count_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSarithmetic_count_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSarithmetic_count_utilDTh() {
      // Check if tracing is enabled
...
class ArithmeticCountUtilHelper {
 public:
  static bool GetFirstOutputCount(mlir::Operation* op, int64_t* count) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSarithmetic_count_utilDTh mht_0(mht_0_v, 196, "", "./tensorflow/compiler/mlir/lite/utils/arithmetic_count_util.h", "GetFirstOutputCount");
  ...
  static bool GetInputTensorTotalSize(mlir::Operation* op, int64_t* count) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSarithmetic_count_utilDTh mht_1(mht_1_v, 209, "", "./tensorflow/compiler/mlir/lite/utils/arithmetic_count_util.h", "GetInputTensorTotalSize");
  ...
  static bool GetArithmeticCountForConvAndFullyconnectedOp(mlir::Operation* op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSutilsPSarithmetic_count_utilDTh mht_2(mht_2_v, 229, "", "./tensorflow/compiler/mlir/lite/utils/arithmetic_count_util.h", "GetArithmeticCountForConvAndFullyconnectedOp");
