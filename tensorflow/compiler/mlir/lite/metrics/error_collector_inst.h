...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSmetricsPSerror_collector_instDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSmetricsPSerror_collector_instDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSmetricsPSerror_collector_instDTh() {
      // Check if tracing is enabled
...
inline InFlightDiagnostic AttachErrorCode(InFlightDiagnostic &&diag,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSmetricsPSerror_collector_instDTh mht_0(mht_0_v, 230, "", "./tensorflow/compiler/mlir/lite/metrics/error_collector_inst.h", "AttachErrorCode");
