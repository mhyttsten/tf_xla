...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSsparsityPSsparsify_modelDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSsparsityPSsparsify_modelDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSsparsityPSsparsify_modelDTcc() {
      // Check if tracing is enabled
...
TfLiteStatus SparsifyModel(const tflite::ModelT& input_model,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSsparsityPSsparsify_modelDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/lite/sparsity/sparsify_model.cc", "SparsifyModel");
