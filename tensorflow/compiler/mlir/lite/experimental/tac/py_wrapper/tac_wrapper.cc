...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSpy_wrapperPStac_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSpy_wrapperPStac_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSpy_wrapperPStac_wrapperDTcc() {
      // Check if tracing is enabled
...
bool run_tac(const std::string& model_file_path,
   ...
   mht_0_v.push_back("model_file_path: \"" + model_file_path + "\"");
   mht_0_v.push_back("model_output_path: \"" + model_output_path + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSpy_wrapperPStac_wrapperDTcc mht_0(mht_0_v, 226, "", "./tensorflow/compiler/mlir/lite/experimental/tac/py_wrapper/tac_wrapper.cc", "run_tac");
