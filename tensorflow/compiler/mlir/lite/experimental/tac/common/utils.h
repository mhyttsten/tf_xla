...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh() {
      // Check if tracing is enabled
...
inline bool IsNonConstOp(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/mlir/lite/experimental/tac/common/utils.h", "IsNonConstOp");
...
inline bool IsF32ShapedType(Type t) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh mht_1(mht_1_v, 220, "", "./tensorflow/compiler/mlir/lite/experimental/tac/common/utils.h", "IsF32ShapedType");
...
inline bool IsQI8Type(Type t) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh mht_2(mht_2_v, 231, "", "./tensorflow/compiler/mlir/lite/experimental/tac/common/utils.h", "IsQI8Type");
...
inline bool IsQUI8Type(Type t) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh mht_3(mht_3_v, 242, "", "./tensorflow/compiler/mlir/lite/experimental/tac/common/utils.h", "IsQUI8Type");
...
inline bool IsQI32Type(Type t) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPScommonPSutilsDTh mht_4(mht_4_v, 253, "", "./tensorflow/compiler/mlir/lite/experimental/tac/common/utils.h", "IsQI32Type");
