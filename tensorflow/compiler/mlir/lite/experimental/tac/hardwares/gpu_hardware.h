...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPShardwaresPSgpu_hardwareDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPShardwaresPSgpu_hardwareDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPShardwaresPSgpu_hardwareDTh() {
      // Check if tracing is enabled
...
class GpuHardware : public TargetHardware {
 public:
  ...
  mlir::TypeID GetTypeId() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPShardwaresPSgpu_hardwareDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/lite/experimental/tac/hardwares/gpu_hardware.h", "GetTypeId");
