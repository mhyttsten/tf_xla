...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStflite_import_exportDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStflite_import_exportDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStflite_import_exportDTh() {
      // Check if tracing is enabled
...
class TfLiteImporter : public mlir::TFL::tac::TacImporter {
 public:
  ...
  explicit TfLiteImporter(const Options& options) : options_(options) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStflite_import_exportDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tflite_import_export.h", "TfLiteImporter");
}
...
class TfLiteExporter : public mlir::TFL::tac::TacExporter {
 public:
  ...
  explicit TfLiteExporter(const Options& options) : options_(options) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStflite_import_exportDTh mht_1(mht_1_v, 233, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tflite_import_export.h", "TfLiteExporter");
}
