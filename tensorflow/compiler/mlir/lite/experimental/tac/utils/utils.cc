...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSutilsPSutilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSutilsPSutilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSutilsPSutilsDTcc() {
      // Check if tracing is enabled
...
absl::Status ExportFlatbufferOrMlir(const std::string& output_filename,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPSutilsPSutilsDTcc mht_0(mht_0_v, 244, "", "./tensorflow/compiler/mlir/lite/experimental/tac/utils/utils.cc", "ExportFlatbufferOrMlir");
