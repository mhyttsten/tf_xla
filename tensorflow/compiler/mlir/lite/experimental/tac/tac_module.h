...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh() {
      // Check if tracing is enabled
...
class TacModule {
 public:
  ...
  virtual ~TacModule() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh mht_0(mht_0_v, 227, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tac_module.h", "~TacModule");
}

  explicit TacModule(const Options& options) : options_(options) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh mht_1(mht_1_v, 232, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tac_module.h", "TacModule");
}

  void SetImporter(std::unique_ptr<TacImporter> importer) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh mht_2(mht_2_v, 237, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tac_module.h", "SetImporter");
  ...
  void SetExporter(std::unique_ptr<TacExporter> exporter) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh mht_3(mht_3_v, 244, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tac_module.h", "SetExporter");
  ...
  const std::vector<const tac::TargetHardware*>& GetAvailableHardwares() const {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStac_moduleDTh mht_4(mht_4_v, 264, "", "./tensorflow/compiler/mlir/lite/experimental/tac/tac_module.h", "GetAvailableHardwares");
