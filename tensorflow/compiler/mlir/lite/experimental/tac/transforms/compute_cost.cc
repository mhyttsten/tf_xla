...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStransformsPScompute_costDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStransformsPScompute_costDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStransformsPScompute_costDTcc() {
      // Check if tracing is enabled
...
class ComputeCostPass
 ...
 private:
  llvm::StringRef getArgument() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStransformsPScompute_costDTcc mht_0(mht_0_v, 244, "", "./tensorflow/compiler/mlir/lite/experimental/tac/transforms/compute_cost.cc", "getArgument");
 return "tfl-compute-cost"; }
  llvm::StringRef getDescription() const final {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStransformsPScompute_costDTcc mht_1(mht_1_v, 248, "", "./tensorflow/compiler/mlir/lite/experimental/tac/transforms/compute_cost.cc", "getDescription");
...
void ComputeCostPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSexperimentalPStacPStransformsPScompute_costDTcc mht_2(mht_2_v, 257, "", "./tensorflow/compiler/mlir/lite/experimental/tac/transforms/compute_cost.cc", "ComputeCostPass::runOnOperation");
