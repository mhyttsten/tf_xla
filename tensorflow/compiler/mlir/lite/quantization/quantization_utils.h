...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh() {
      // Check if tracing is enabled
...
struct OpQuantScaleSpec {
  ...
  RequiredSameOperandsAndResultsScaleFunc required_same_scale_func =
      [](bool sign, int bit_width) {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_0(mht_0_v, 298, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "lambda");
 return true; };
  ...
  RequiredSameQuantizedAxesFunc required_same_quantized_axes_func = []() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_1(mht_1_v, 303, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "lambda");
...
inline std::string GetTensorNameFromLoc(Location loc) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_2(mht_2_v, 356, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "GetTensorNameFromLoc");
...
struct ConvertStatsToQDQs : public OpRewritePattern<quant::StatisticsOp> {
  ConvertStatsToQDQs(int num_bits, bool narrow_range, bool is_signed,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_3(mht_3_v, 374, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "ConvertStatsToQDQs");
}

  LogicalResult matchAndRewrite(quant::StatisticsOp op,
                                PatternRewriter& rewriter) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_4(mht_4_v, 380, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "matchAndRewrite");
 ...
 private:
  ...
  void TensorRangeSanityCheck(quant::StatisticsOp op, double& min,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_5(mht_5_v, 454, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "TensorRangeSanityCheck");
...
bool UsedBy(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_6(mht_6_v, 477, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "UsedBy");
...
void CreateVerifier(Operation* quantizing_op, Operation* quantized_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_7(mht_7_v, 490, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "CreateVerifier");
...
inline bool UsedBy<void>(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_8(mht_8_v, 507, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "UsedBy<void>");
...
inline void CreateVerifier<void>(Operation* quantizing_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_9(mht_9_v, 519, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "CreateVerifier<void>");
}
...
class QuantizationPattern : public RewritePattern {
 public:
  ...
  explicit QuantizationPattern(MLIRContext* context,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_10(mht_10_v, 552, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "QuantizationPattern");
}

  LogicalResult matchAndRewrite(Operation* op,
                                PatternRewriter& rewriter) const override {
   std::vector<std::string> mht_11_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_11(mht_11_v, 558, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "matchAndRewrite");
 ...
 private:
  ...
  void RewireFloatModelBackbone(Operation* quantized_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_12(mht_12_v, 807, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "RewireFloatModelBackbone");
...
class RemoveDebugAttrPattern : public RewritePattern {
 public:
  explicit RemoveDebugAttrPattern(MLIRContext* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_13(mht_13_v, 868, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "RemoveDebugAttrPattern");
}
  LogicalResult matchAndRewrite(Operation* op,
                                PatternRewriter& rewriter) const override;
};
...
struct ConvertUnsignedToSigned : public OpRewritePattern<Q> {
  ...
  explicit ConvertUnsignedToSigned(MLIRContext* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_14(mht_14_v, 888, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "ConvertUnsignedToSigned");
}

  LogicalResult matchAndRewrite(Q op,
                                PatternRewriter& rewriter) const override {
   std::vector<std::string> mht_15_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_15(mht_15_v, 894, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "matchAndRewrite");
...
struct FoldTrivalRequantizeOp : public OpRewritePattern<RQ> {
  explicit FoldTrivalRequantizeOp(MLIRContext* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_16(mht_16_v, 951, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "FoldTrivalRequantizeOp");
}

  LogicalResult matchAndRewrite(RQ op,
                                PatternRewriter& rewriter) const override {
   std::vector<std::string> mht_17_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTh mht_17(mht_17_v, 957, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.h", "matchAndRewrite");
