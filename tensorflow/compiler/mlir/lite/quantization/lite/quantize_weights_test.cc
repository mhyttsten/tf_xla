...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc() {
      // Check if tracing is enabled
...
class QuantizeWeightsTest : public testing::Test {
 protected:
  QuantizeWeightsTest() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_0(mht_0_v, 250, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "QuantizeWeightsTest");
}

  void LoadBasicModel() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_1(mht_1_v, 255, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "LoadBasicModel");
  ...
  void LoadSharedWeightsModel() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_2(mht_2_v, 263, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "LoadSharedWeightsModel");
  ...
  void LoadGatherTestModel() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_3(mht_3_v, 271, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "LoadGatherTestModel");
  ...
  void LoadCustomOpTestModel() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_4(mht_4_v, 279, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "LoadCustomOpTestModel");
  ...
  bool IsModelInputOrOutput(const Model* model, uint32_t tensor_idx) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_5(mht_5_v, 290, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "IsModelInputOrOutput");
  ...
  bool GetProducerOpCode(const Model* model, uint32_t subgraph_idx,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_6(mht_6_v, 313, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "GetProducerOpCode");
...
bool ExpectEqualTensor(const Tensor* tensor, const Tensor* expected_tensor) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_7(mht_7_v, 332, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "ExpectEqualTensor");
...
const Tensor* FindMatchingExpectedTensor(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_8(mht_8_v, 352, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "FindMatchingExpectedTensor");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePSquantize_weights_testDTcc mht_9(mht_9_v, 942, "", "./tensorflow/compiler/mlir/lite/quantization/lite/quantize_weights_test.cc", "main");
