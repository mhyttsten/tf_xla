...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePStfl_to_stdDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePStfl_to_stdDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePStfl_to_stdDTh() {
      // Check if tracing is enabled
...
class ScopedOpsConverter {
 public:
  explicit ScopedOpsConverter(FuncOp func) : func_(func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePStfl_to_stdDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/lite/quantization/lite/tfl_to_std.h", "ScopedOpsConverter");
  ...
  ~ScopedOpsConverter() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSlitePStfl_to_stdDTh mht_1(mht_1_v, 220, "", "./tensorflow/compiler/mlir/lite/quantization/lite/tfl_to_std.h", "~ScopedOpsConverter");
 ConvertBackward(func_); }
