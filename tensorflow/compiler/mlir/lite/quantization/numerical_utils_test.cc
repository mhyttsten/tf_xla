...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSnumerical_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSnumerical_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSnumerical_utils_testDTcc() {
      // Check if tracing is enabled
...
double ComposeScale(const QuantizedMultiplier& input) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSnumerical_utils_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/mlir/lite/quantization/numerical_utils_test.cc", "ComposeScale");
