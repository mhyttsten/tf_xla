...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc() {
      // Check if tracing is enabled
...
void ExpandVerySmallRange(ArrayRef<double> mins, ArrayRef<double> maxs,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_0(mht_0_v, 232, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "ExpandVerySmallRange");
...
QuantizedType ResetMinMaxFromNumBits(QuantizedType type, int num_bits,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_1(mht_1_v, 256, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "ResetMinMaxFromNumBits");
...
bool BroadcastVector(int target_size, SmallVectorImpl<T>& data) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_2(mht_2_v, 304, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "BroadcastVector");
...
quant::UniformQuantizedPerAxisType ResetAxisAndBroadcast(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_3(mht_3_v, 323, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "ResetAxisAndBroadcast");
...
bool IsOpNotQuantizable(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_4(mht_4_v, 372, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "IsOpNotQuantizable");
...
Type GetQuantizedType(Builder builder, Type input_type, ArrayRef<double> min,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_5(mht_5_v, 403, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "GetQuantizedType");
...
TypeAttr RescaleQuantizedType(Type input, Attribute factor) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_6(mht_6_v, 456, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "RescaleQuantizedType");
...
TypeAttr GetQuantizedTypeAttr(Builder builder, Type input_type, Attribute min,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_7(mht_7_v, 494, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "GetQuantizedTypeAttr");
...
TypeAttr CastQuantizedTypeAttrFromExpressedType(Builder builder,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_8(mht_8_v, 530, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "CastQuantizedTypeAttrFromExpressedType");
...
void ExtractMinMaxFromAttr(DenseFPElementsAttr values, int dim_size,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_9(mht_9_v, 554, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "ExtractMinMaxFromAttr");
...
Type GetUniformQuantizedTypeForWeight(ElementsAttr attr, bool symmetric,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_10(mht_10_v, 607, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "GetUniformQuantizedTypeForWeight");
...
Type GetUniformQuantizedPerAxisTypeForWeight(ElementsAttr attr, int quant_dim,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_11(mht_11_v, 638, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "GetUniformQuantizedPerAxisTypeForWeight");
...
quant::QuantizedType GetUniformQuantizedTypeForBias(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_12(mht_12_v, 670, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "GetUniformQuantizedTypeForBias");
...
ElementsAttr QuantizeLegacy(Attribute real_value, Type tensor_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_13(mht_13_v, 745, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "QuantizeLegacy");
...
ElementsAttr Quantize(Attribute real_value, Type tensor_type) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_14(mht_14_v, 845, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "Quantize");
...
QuantizedType DownCastScale(QuantizedType type, double min, double max,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_15(mht_15_v, 859, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "DownCastScale");
...
QuantizedType DownCastScale(QuantizedType type,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_16(mht_16_v, 870, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "DownCastScale");
...
static bool PreferResultScale(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_17(mht_17_v, 918, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "PreferResultScale");
...
std::unique_ptr<OpQuantScaleSpec> GetDefaultQuantScaleSpec(Operation* op) {
  ...
  if (llvm::isa<SameScalesOpInterface>(op)) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_18(mht_18_v, 937, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_19(mht_19_v, 944, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "lambda");
  ...
  if (llvm::isa<FixedOutputRangeInterface>(op)) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_20(mht_20_v, 953, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "lambda");
...
static bool IsStatsRedundant(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_21(mht_21_v, 968, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "IsStatsRedundant");
...
static bool IsSameScaleOp(Operation* op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_22(mht_22_v, 978, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "IsSameScaleOp");
...
bool RemoveRedundantStatsOps(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_23(mht_23_v, 989, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "RemoveRedundantStatsOps");
...
LogicalResult VerifySameScales(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_24(mht_24_v, 1085, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "VerifySameScales");
...
quant::UniformQuantizedType GetFixedOutputRange(bool is_signed, int bit_width,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_25(mht_25_v, 1163, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "GetFixedOutputRange");
...
Type ConvertSignedQuantizedToUnsigned(Type signed_tensor_type, Location loc) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_26(mht_26_v, 1185, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "ConvertSignedQuantizedToUnsigned");
...
LogicalResult RemoveDebugAttrPattern::matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSquantizationPSquantization_utilsDTcc mht_27(mht_27_v, 1226, "", "./tensorflow/compiler/mlir/lite/quantization/quantization_utils.cc", "RemoveDebugAttrPattern::matchAndRewrite");
