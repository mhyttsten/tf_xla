...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPSflatbuffer_to_mlirDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPSflatbuffer_to_mlirDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPSflatbuffer_to_mlirDTcc() {
      // Check if tracing is enabled
...
std::string FlatBufferFileToMlir(const std::string& model_file_or_buffer,
   ...
   mht_0_v.push_back("model_file_or_buffer: \"" + model_file_or_buffer + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPSflatbuffer_to_mlirDTcc mht_0(mht_0_v, 227, "", "./tensorflow/compiler/mlir/lite/python/flatbuffer_to_mlir.cc", "FlatBufferFileToMlir");
