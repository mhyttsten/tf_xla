...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc() {
      // Check if tracing is enabled
...
DataType ConvertIODataTypeToDataType(toco::IODataType dtype) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_0(mht_0_v, 280, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "ConvertIODataTypeToDataType");
...
Status RegisterCustomBuiltinOps(const std::vector<string> extra_tf_opdefs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_1(mht_1_v, 346, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "RegisterCustomBuiltinOps");
...
Status RegisterAllCustomOps(const toco::TocoFlags& toco_flags) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_2(mht_2_v, 372, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "RegisterAllCustomOps");
...
Status PopulateQuantizationSpecs(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_3(mht_3_v, 391, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "PopulateQuantizationSpecs");
...
Status DumpOpGraphToFile(mlir::ModuleOp module, const std::string& filename) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_4(mht_4_v, 498, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "DumpOpGraphToFile");
...
Status ConvertMLIRToTFLiteFlatBuffer(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_5(mht_5_v, 521, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "ConvertMLIRToTFLiteFlatBuffer");
...
void WarningUnusedFlags(const toco::ModelFlags& model_flags,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSlitePSpythonPStf_tfl_flatbuffer_helpersDTcc mht_6(mht_6_v, 548, "", "./tensorflow/compiler/mlir/lite/python/tf_tfl_flatbuffer_helpers.cc", "WarningUnusedFlags");
