...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPStransformsPSmap_chlo_to_hlo_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPStransformsPSmap_chlo_to_hlo_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPStransformsPSmap_chlo_to_hlo_opDTh() {
      // Check if tracing is enabled
...
struct HloNaryElementwiseAdaptor {
  static ToOpTy CreateOp(FromOpTy from_op, Type result_type,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPStransformsPSmap_chlo_to_hlo_opDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/mhlo/transforms/map_chlo_to_hlo_op.h", "CreateOp");
...
struct HloCompareAdaptor {
  static mhlo::CompareOp CreateOp(BroadcastCompareOp from_op, Type result_type,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPStransformsPSmap_chlo_to_hlo_opDTh mht_1(mht_1_v, 211, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/mhlo/transforms/map_chlo_to_hlo_op.h", "CreateOp");
