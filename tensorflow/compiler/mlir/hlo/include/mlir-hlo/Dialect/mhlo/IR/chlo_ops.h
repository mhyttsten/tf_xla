...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPSIRPSchlo_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPSIRPSchlo_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPSIRPSchlo_opsDTh() {
      // Check if tracing is enabled
...
class HloClientDialect : public Dialect {
 ...
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPSIRPSchlo_opsDTh mht_0(mht_0_v, 217, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/mhlo/IR/chlo_ops.h", "getDialectNamespace");
 return "chlo"; }
};
...
static Value getConstantLike(OpBuilder& b, Location loc, T constant,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSmhloPSIRPSchlo_opsDTh mht_1(mht_1_v, 246, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/mhlo/IR/chlo_ops.h", "getConstantLike");
