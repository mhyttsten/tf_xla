...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSlhloPStransformsPSmap_lmhlo_to_scalar_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSlhloPStransformsPSmap_lmhlo_to_scalar_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSlhloPStransformsPSmap_lmhlo_to_scalar_opDTh() {
      // Check if tracing is enabled
...
struct LhloOpToStdScalarOp {
  ...
  static Value map(LhloOpTy op, ArrayRef<Type> result_types, ValueRange args,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSlhloPStransformsPSmap_lmhlo_to_scalar_opDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/lhlo/transforms/map_lmhlo_to_scalar_op.h", "map");
  ...
  static Value map(lmhlo::CompareOp op, ArrayRef<Type> result_types,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSlhloPStransformsPSmap_lmhlo_to_scalar_opDTh mht_1(mht_1_v, 214, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/lhlo/transforms/map_lmhlo_to_scalar_op.h", "map");
  ...
  static Value map(Location loc, ArrayRef<Type> result_types,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSDialectPSlhloPStransformsPSmap_lmhlo_to_scalar_opDTh mht_2(mht_2_v, 231, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/Dialect/lhlo/transforms/map_lmhlo_to_scalar_op.h", "map");
