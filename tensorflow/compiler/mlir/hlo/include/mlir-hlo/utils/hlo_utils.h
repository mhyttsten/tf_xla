...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPShlo_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPShlo_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPShlo_utilsDTh() {
      // Check if tracing is enabled
...
static ElementsAttr getSplat(Builder* b, RankedTensorType ty, T constant) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPShlo_utilsDTh mht_0(mht_0_v, 209, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/utils/hlo_utils.h", "getSplat");
...
static ElementsAttr getSplat(Builder* b, Value val, T constant) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPShlo_utilsDTh mht_1(mht_1_v, 234, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/utils/hlo_utils.h", "getSplat");
