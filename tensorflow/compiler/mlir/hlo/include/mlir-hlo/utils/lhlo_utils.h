...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPSlhlo_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPSlhlo_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPSlhlo_utilsDTh() {
      // Check if tracing is enabled
...
LogicalResult VerifyReplicaGroups(OpT op, bool is_uniform_sized) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPSlhlo_utilsDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/utils/lhlo_utils.h", "VerifyReplicaGroups");
...
static LogicalResult VerifyAllReduce(OpT op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSincludePSmlirSLhloPSutilsPSlhlo_utilsDTh mht_1(mht_1_v, 250, "", "./tensorflow/compiler/mlir/hlo/include/mlir-hlo/utils/lhlo_utils.h", "VerifyAllReduce");
