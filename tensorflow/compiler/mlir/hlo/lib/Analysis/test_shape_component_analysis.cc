...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSAnalysisPStest_shape_component_analysisDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSAnalysisPStest_shape_component_analysisDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSAnalysisPStest_shape_component_analysisDTcc() {
      // Check if tracing is enabled
...
struct TestShapeComponentAnalysisPass
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSAnalysisPStest_shape_component_analysisDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/mlir/hlo/lib/Analysis/test_shape_component_analysis.cc", "getDependentDialects");
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSAnalysisPStest_shape_component_analysisDTcc mht_1(mht_1_v, 206, "", "./tensorflow/compiler/mlir/hlo/lib/Analysis/test_shape_component_analysis.cc", "runOnOperation");
