...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPScycle_detector_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPScycle_detector_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPScycle_detector_testDTcc() {
      // Check if tracing is enabled
...
class GraphCyclesTest : public ::testing::Test {
 public:
  GraphCyclesTest() : g_(100) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPScycle_detector_testDTcc mht_0(mht_0_v, 191, "", "./tensorflow/compiler/mlir/hlo/lib/utils/cycle_detector_test.cc", "GraphCyclesTest");
}

  bool AddEdge(int x, int y) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPScycle_detector_testDTcc mht_1(mht_1_v, 196, "", "./tensorflow/compiler/mlir/hlo/lib/utils/cycle_detector_test.cc", "AddEdge");
 return g_.InsertEdge(x, y); }

  void AddMultiples() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPScycle_detector_testDTcc mht_2(mht_2_v, 201, "", "./tensorflow/compiler/mlir/hlo/lib/utils/cycle_detector_test.cc", "AddMultiples");
