...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSconvert_op_folderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSconvert_op_folderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSconvert_op_folderDTcc() {
      // Check if tracing is enabled
...
mlir::ElementsAttr ConvertElementsAttr(const mlir::ElementsAttr& elements,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSconvert_op_folderDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/hlo/lib/utils/convert_op_folder.cc", "ConvertElementsAttr");
