...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSbroadcast_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSbroadcast_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSbroadcast_utilsDTcc() {
      // Check if tracing is enabled
...
bool IsLegalNumpyRankedBroadcast(Value lhs, Value rhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSbroadcast_utilsDTcc mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/hlo/lib/utils/broadcast_utils.cc", "IsLegalNumpyRankedBroadcast");
...
Value ComputeBinaryElementwiseBroadcastingResultExtents(Location loc, Value lhs,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSbroadcast_utilsDTcc mht_1(mht_1_v, 224, "", "./tensorflow/compiler/mlir/hlo/lib/utils/broadcast_utils.cc", "ComputeBinaryElementwiseBroadcastingResultExtents");
...
Value ComputeNaryElementwiseBroadcastingResultExtents(Location loc,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSutilsPSbroadcast_utilsDTcc mht_2(mht_2_v, 234, "", "./tensorflow/compiler/mlir/hlo/lib/utils/broadcast_utils.cc", "ComputeNaryElementwiseBroadcastingResultExtents");
