...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc() {
      // Check if tracing is enabled
...
void GmlStDialect::initialize() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "GmlStDialect::initialize");
...
LogicalResult MaterializeOp::inferReturnTypes(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_1(mht_1_v, 228, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "MaterializeOp::inferReturnTypes");
...
void LoopOp::build(OpBuilder &builder, OperationState &result,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_2(mht_2_v, 265, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::build");
...
void LoopOp::build(OpBuilder &builder, OperationState &result,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_3(mht_3_v, 280, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::build");
...
void LoopOp::print(OpAsmPrinter &p) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_4(mht_4_v, 333, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::print");
...
ParseResult LoopOp::parse(OpAsmParser &parser, OperationState &result) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_5(mht_5_v, 377, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::parse");
  ...
  auto parseAttr = [&](StringRef keyword, SmallVector<Attribute, 4> *attrs) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_6(mht_6_v, 445, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "lambda");
...
Region &LoopOp::getLoopBody() {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_7(mht_7_v, 506, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::getLoopBody");
 return region(); }

LogicalResult LoopOp::verify() {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_8(mht_8_v, 511, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::verify");
...
struct LoopInputsFolder : public OpRewritePattern<LoopOp> {
  ...
  LogicalResult matchAndRewrite(LoopOp loop,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_9(mht_9_v, 567, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "matchAndRewrite");
...
static bool isShapePreserving(LoopOp loopOp, int64_t arg) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_10(mht_10_v, 613, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "isShapePreserving");
...
struct DimOfLoopInsOutsFolder : public OpRewritePattern<OpTy> {
  ...
  LogicalResult matchAndRewrite(OpTy dimOp,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_11(mht_11_v, 668, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "matchAndRewrite");
...
struct DimOfLoopResultFolder : public OpRewritePattern<OpTy> {
  ...
  LogicalResult matchAndRewrite(OpTy dimOp,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_12(mht_12_v, 730, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "matchAndRewrite");
...
struct LoopResultsFolder : public OpRewritePattern<LoopOp> {
  ...
  LogicalResult matchAndRewrite(LoopOp loop,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_13(mht_13_v, 768, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "matchAndRewrite");
...
struct TensorCastOfLoopInsOutsFolder : public OpRewritePattern<LoopOp> {
  ...
  LogicalResult matchAndRewrite(LoopOp loop,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_14(mht_14_v, 881, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "matchAndRewrite");
 ...
 private:
  ...
  CastOpsOfArgs FindTensorCastOps(ValueRange args) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_15(mht_15_v, 908, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "FindTensorCastOps");
...
void LoopOp::getCanonicalizationPatterns(RewritePatternSet &results,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_16(mht_16_v, 998, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::getCanonicalizationPatterns");
...
LogicalResult LoopOp::fold(ArrayRef<Attribute>,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_17(mht_17_v, 1017, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "LoopOp::fold");
...
LogicalResult YieldOp::verify() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPSIRPSgml_st_opsDTcc mht_18(mht_18_v, 1058, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/IR/gml_st_ops.cc", "YieldOp::verify");
