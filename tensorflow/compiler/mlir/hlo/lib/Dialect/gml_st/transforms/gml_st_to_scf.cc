...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPStransformsPSgml_st_to_scfDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPStransformsPSgml_st_to_scfDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPStransformsPSgml_st_to_scfDTcc() {
      // Check if tracing is enabled
...
struct LoopToSCFPattern : public OpRewritePattern<LoopOp> {
  ...
  LogicalResult matchAndRewrite(LoopOp loop,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPStransformsPSgml_st_to_scfDTcc mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/transforms/gml_st_to_scf.cc", "matchAndRewrite");
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPStransformsPSgml_st_to_scfDTcc mht_1(mht_1_v, 238, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/transforms/gml_st_to_scf.cc", "lambda");
...
struct GmlStToScfPass : public GmlStToScfBase<GmlStToScfPass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSgml_stPStransformsPSgml_st_to_scfDTcc mht_2(mht_2_v, 272, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/gml_st/transforms/gml_st_to_scf.cc", "runOnOperation");
