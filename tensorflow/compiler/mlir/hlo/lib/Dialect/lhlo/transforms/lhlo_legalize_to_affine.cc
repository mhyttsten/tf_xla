...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc() {
      // Check if tracing is enabled
...
static void BuildBoundedAffineLoopNest(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "BuildBoundedAffineLoopNest");
...
struct DotOpConverter : public OpRewritePattern<DotOp> {
  ...
  LogicalResult matchAndRewrite(DotOp op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_1(mht_1_v, 222, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "matchAndRewrite");
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_2(mht_2_v, 253, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "lambda");
...
struct ConcatOpConverter : public OpRewritePattern<ConcatenateOp> {
  ...
  LogicalResult matchAndRewrite(ConcatenateOp op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_3(mht_3_v, 303, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "matchAndRewrite");
...
static Value getZeroValue(Type type, Location loc, PatternRewriter& rewriter) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_4(mht_4_v, 365, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "getZeroValue");
...
static void fillBuffer(Location loc, Value buffer, Value fillValue,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_5(mht_5_v, 382, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "fillBuffer");
...
class GatherOpConverter : public OpRewritePattern<GatherOp> {
 public:
  ...
  LogicalResult matchAndRewrite(GatherOp op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_6(mht_6_v, 432, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "matchAndRewrite");
...
struct PadOpConverter : public OpRewritePattern<PadOp> {
  ...
  LogicalResult matchAndRewrite(PadOp op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_7(mht_7_v, 675, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "matchAndRewrite");
...
struct BinaryOpConverter : public OpRewritePattern<LhloOpTy> {
  ...
  LogicalResult matchAndRewrite(LhloOpTy op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_8(mht_8_v, 766, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "matchAndRewrite");
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_9(mht_9_v, 782, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "lambda");
...
struct UnaryOpConverter : public OpRewritePattern<LhloOpTy> {
  ...
  LogicalResult matchAndRewrite(LhloOpTy op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_10(mht_10_v, 809, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "matchAndRewrite");
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_11(mht_11_v, 822, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "lambda");
...
void populateLHLOToAffineConversionPattern(MLIRContext* context,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_12(mht_12_v, 843, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "populateLHLOToAffineConversionPattern");
...
struct LhloLegalizeToAffinePass
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_13(mht_13_v, 866, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "getDependentDialects");

    registry.insert<AffineDialect, math::MathDialect>();
  }
  void runOnOperation() override {
   std::vector<std::string> mht_14_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSlhloPStransformsPSlhlo_legalize_to_affineDTcc mht_14(mht_14_v, 872, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/lhlo/transforms/lhlo_legalize_to_affine.cc", "runOnOperation");
