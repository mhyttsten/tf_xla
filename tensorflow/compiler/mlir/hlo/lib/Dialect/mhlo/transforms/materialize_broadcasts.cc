...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc() {
      // Check if tracing is enabled
...
struct ClampWithBroadcastConvert : public OpRewritePattern<ClampOp> {
  explicit ClampWithBroadcastConvert(MLIRContext *context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/mhlo/transforms/materialize_broadcasts.cc", "ClampWithBroadcastConvert");
}

  LogicalResult matchAndRewrite(ClampOp op,
                                PatternRewriter &rewriter) const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/mhlo/transforms/materialize_broadcasts.cc", "matchAndRewrite");
...
void SetupMaterializeBroadcastsLegality(MLIRContext * /*context*/,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc mht_2(mht_2_v, 249, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/mhlo/transforms/materialize_broadcasts.cc", "SetupMaterializeBroadcastsLegality");
...
void PopulateMaterializeBroadcastsPatterns(MLIRContext *context,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSmhloPStransformsPSmaterialize_broadcastsDTcc mht_3(mht_3_v, 260, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/mhlo/transforms/materialize_broadcasts.cc", "PopulateMaterializeBroadcastsPatterns");
