...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSdiscSLralPStransformsPSral_inject_execution_contextDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSdiscSLralPStransformsPSral_inject_execution_contextDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSdiscSLralPStransformsPSral_inject_execution_contextDTcc() {
      // Check if tracing is enabled
...
struct RalInjectExecutionContextPass
  ...
  explicit RalInjectExecutionContextPass(const std::string& entry_func_name)
   ...
   mht_0_v.push_back("entry_func_name: \"" + entry_func_name + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSdiscSLralPStransformsPSral_inject_execution_contextDTcc mht_0(mht_0_v, 241, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/disc-ral/transforms/ral_inject_execution_context.cc", "RalInjectExecutionContextPass");
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSdiscSLralPStransformsPSral_inject_execution_contextDTcc mht_1(mht_1_v, 248, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/disc-ral/transforms/ral_inject_execution_context.cc", "getDependentDialects");
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPShloPSlibPSDialectPSdiscSLralPStransformsPSral_inject_execution_contextDTcc mht_2(mht_2_v, 255, "", "./tensorflow/compiler/mlir/hlo/lib/Dialect/disc-ral/transforms/ral_inject_execution_context.cc", "runOnOperation");
