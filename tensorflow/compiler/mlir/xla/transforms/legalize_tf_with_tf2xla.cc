...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc() {
      // Check if tracing is enabled
...
bool IsOpAllowedTf2XlaFallback(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_0(mht_0_v, 251, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "IsOpAllowedTf2XlaFallback");
...
bool IsOpAllowedTf2XlaPreferred(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_1(mht_1_v, 460, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "IsOpAllowedTf2XlaPreferred");
...
bool IsOpAllowedForTesting(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_2(mht_2_v, 574, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "IsOpAllowedForTesting");
...
class Tf2XlaRewriter {
 public:
  static LogicalResult RewriteOp(Operation* op, PatternRewriter& rewriter,
   ...
   mht_3_v.push_back("device_type: \"" + device_type + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_3(mht_3_v, 609, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "RewriteOp");
 ...
 private:
  Tf2XlaRewriter(Operation* op, PatternRewriter& rewriter,
   ...
   mht_4_v.push_back("device_type: \"" + device_type + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_4(mht_4_v, 626, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "Tf2XlaRewriter");
}

  ~Tf2XlaRewriter() {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_5(mht_5_v, 631, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "~Tf2XlaRewriter");
...
LogicalResult Tf2XlaRewriter::PrepareParams() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_6(mht_6_v, 670, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "Tf2XlaRewriter::PrepareParams");
  ...
  auto cleanup = [](const std::string& name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_7(mht_7_v, 693, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "lambda");
};
...
LogicalResult Tf2XlaRewriter::LegalizeOp() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_8(mht_8_v, 726, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "Tf2XlaRewriter::LegalizeOp");
...
tensorflow::XlaExpression Tf2XlaRewriter::GetExprForOperand(Value operand,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_9(mht_9_v, 873, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "Tf2XlaRewriter::GetExprForOperand");
...
class Tf2XlaRewritePattern : public RewritePattern {
 public:
  explicit Tf2XlaRewritePattern(MLIRContext* ctx,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_10(mht_10_v, 917, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "Tf2XlaRewritePattern");
}

  LogicalResult matchAndRewrite(Operation* op,
                                PatternRewriter& rewriter) const override {
   std::vector<std::string> mht_11_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_11(mht_11_v, 923, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "matchAndRewrite");
...
class LegalizeTF : public LegalizeTFPassBase<LegalizeTF> {
 public:
  ...
  explicit LegalizeTF(llvm::StringRef device_type, bool prefer_tf2xla) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_12(mht_12_v, 943, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "LegalizeTF");
  ...
  LegalizeTF(const LegalizeTF&) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_13(mht_13_v, 951, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "LegalizeTF");
}

  void runOnOperation() override {
   std::vector<std::string> mht_14_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_14(mht_14_v, 956, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "runOnOperation");
...
void PopulateLegalizeTfWithTf2XlaPatterns(llvm::StringRef device_type,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSlegalize_tf_with_tf2xlaDTcc mht_15(mht_15_v, 976, "", "./tensorflow/compiler/mlir/xla/transforms/legalize_tf_with_tf2xla.cc", "PopulateLegalizeTfWithTf2XlaPatterns");
