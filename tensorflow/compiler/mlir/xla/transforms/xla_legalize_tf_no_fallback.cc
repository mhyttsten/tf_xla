...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSxla_legalize_tf_no_fallbackDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSxla_legalize_tf_no_fallbackDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSxla_legalize_tf_no_fallbackDTcc() {
      // Check if tracing is enabled
...
class LegalizeTFNoFallback
 ...
 public:
  explicit LegalizeTFNoFallback(bool allow_partial_conversion) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSxla_legalize_tf_no_fallbackDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/xla/transforms/xla_legalize_tf_no_fallback.cc", "LegalizeTFNoFallback");
...
void LegalizeTFNoFallback::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSxla_legalize_tf_no_fallbackDTcc mht_1(mht_1_v, 221, "", "./tensorflow/compiler/mlir/xla/transforms/xla_legalize_tf_no_fallback.cc", "LegalizeTFNoFallback::runOnOperation");
