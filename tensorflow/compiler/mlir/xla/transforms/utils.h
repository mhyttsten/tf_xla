...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSutilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSutilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSutilsDTh() {
      // Check if tracing is enabled
...
void BuildReduceBody(Type element_type, Region* body, OpBuilder* builder) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPStransformsPSutilsDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/xla/transforms/utils.h", "BuildReduceBody");
