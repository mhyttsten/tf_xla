...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPShlo_module_importerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPShlo_module_importerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPShlo_module_importerDTcc() {
      // Check if tracing is enabled
...
HloModuleImporter::HloModuleImporter(mlir::ModuleOp module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPShlo_module_importerDTcc mht_0(mht_0_v, 207, "", "./tensorflow/compiler/mlir/xla/hlo_module_importer.cc", "HloModuleImporter::HloModuleImporter");
...
Status HloModuleImporter::Import(const xla::HloModule& module) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPShlo_module_importerDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/xla/hlo_module_importer.cc", "HloModuleImporter::Import");
...
Status HloModuleImporter::Import(const xla::HloModuleProto& module_proto) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSxlaPShlo_module_importerDTcc mht_2(mht_2_v, 234, "", "./tensorflow/compiler/mlir/xla/hlo_module_importer.cc", "HloModuleImporter::Import");
