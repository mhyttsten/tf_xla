...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTcc() {
      // Check if tracing is enabled
...
MlirBridgeRolloutPolicy GetMlirBridgeRolloutPolicy(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSmlir_bridge_rollout_policyDTcc mht_0(mht_0_v, 195, "", "./tensorflow/compiler/mlir/mlir_bridge_rollout_policy.cc", "GetMlirBridgeRolloutPolicy");
