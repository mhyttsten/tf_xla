...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_passesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_passesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_passesDTcc() {
      // Check if tracing is enabled
...
void createTFtoTOSALegalizationPipeline(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_passesDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/tosa/tf_passes.cc", "createTFtoTOSALegalizationPipeline");
...
void registerTFtoTOSALegalizationPipeline() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_passesDTcc mht_1(mht_1_v, 232, "", "./tensorflow/compiler/mlir/tosa/tf_passes.cc", "registerTFtoTOSALegalizationPipeline");
