...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTh() {
      // Check if tracing is enabled
...
struct TOSATFLLegalizationPipelineOptions
  ...
  TOSATFLLegalizationPipelineOptions() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTh mht_0(mht_0_v, 200, "", "./tensorflow/compiler/mlir/tosa/tfl_passes.h", "TOSATFLLegalizationPipelineOptions");
