...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTcc() {
      // Check if tracing is enabled
...
void createTFLtoTOSALegalizationPipeline(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTcc mht_0(mht_0_v, 197, "", "./tensorflow/compiler/mlir/tosa/tfl_passes.cc", "createTFLtoTOSALegalizationPipeline");
...
void registerTFLtoTOSALegalizationPipeline() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStfl_passesDTcc mht_1(mht_1_v, 235, "", "./tensorflow/compiler/mlir/tosa/tfl_passes.cc", "registerTFLtoTOSALegalizationPipeline");
