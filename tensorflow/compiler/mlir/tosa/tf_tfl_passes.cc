...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_tfl_passesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_tfl_passesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_tfl_passesDTcc() {
      // Check if tracing is enabled
...
void createTFTFLtoTOSALegalizationPipeline(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_tfl_passesDTcc mht_0(mht_0_v, 198, "", "./tensorflow/compiler/mlir/tosa/tf_tfl_passes.cc", "createTFTFLtoTOSALegalizationPipeline");
...
void registerTFTFLtoTOSALegalizationPipeline() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStf_tfl_passesDTcc mht_1(mht_1_v, 237, "", "./tensorflow/compiler/mlir/tosa/tf_tfl_passes.cc", "registerTFTFLtoTOSALegalizationPipeline");
