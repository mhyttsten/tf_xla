...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStransformsPSlegalize_commonDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStransformsPSlegalize_commonDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStransformsPSlegalize_commonDTcc() {
      // Check if tracing is enabled
...
void tensorflow_nudge(const float min, const float max, const int quant_min,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStransformsPSlegalize_commonDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/mlir/tosa/transforms/legalize_common.cc", "tensorflow_nudge");
...
static Value reverseNegativeStride(PatternRewriter& rewriter, Operation* op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStransformsPSlegalize_commonDTcc mht_1(mht_1_v, 2269, "", "./tensorflow/compiler/mlir/tosa/transforms/legalize_common.cc", "reverseNegativeStride");
...
static Value convertGenericReduceOp(PatternRewriter& rewriter, Operation* op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStosaPStransformsPSlegalize_commonDTcc mht_2(mht_2_v, 2680, "", "./tensorflow/compiler/mlir/tosa/transforms/legalize_common.cc", "convertGenericReduceOp");
