...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc() {
      // Check if tracing is enabled
...
class PostQuantizePass
 ...
 public:
  ...
  explicit PostQuantizePass() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/post_quantize.cc", "PostQuantizePass");
}

  StringRef getArgument() const final {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc mht_1(mht_1_v, 217, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/post_quantize.cc", "getArgument");
  ...
  StringRef getDescription() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc mht_2(mht_2_v, 225, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/post_quantize.cc", "getDescription");
...
struct RemoveVolatileOps : public OpRewritePattern<DequantizeCastOp> {
  explicit RemoveVolatileOps(MLIRContext* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc mht_3(mht_3_v, 247, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/post_quantize.cc", "RemoveVolatileOps");
}

  LogicalResult matchAndRewrite(DequantizeCastOp op,
                                PatternRewriter& rewriter) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc mht_4(mht_4_v, 253, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/post_quantize.cc", "matchAndRewrite");
...
void PostQuantizePass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSpost_quantizeDTcc mht_5(mht_5_v, 287, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/post_quantize.cc", "PostQuantizePass::runOnOperation");
