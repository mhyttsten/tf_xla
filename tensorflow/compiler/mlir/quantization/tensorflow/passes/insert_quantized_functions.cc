...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc() {
      // Check if tracing is enabled
...
class InsertQuantizedFunctionsPass
 ...
 public:
  StringRef getArgument() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_quantized_functions.cc", "getArgument");
  ...
  StringRef getDescription() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc mht_1(mht_1_v, 218, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_quantized_functions.cc", "getDescription");
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc mht_2(mht_2_v, 226, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_quantized_functions.cc", "getDependentDialects");
...
void InsertQuantizedFunctionsPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_quantized_functionsDTcc mht_3(mht_3_v, 239, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_quantized_functions.cc", "InsertQuantizedFunctionsPass::runOnOperation");
