...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc() {
      // Check if tracing is enabled
...
class PrepareQuantizePass
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_0(mht_0_v, 242, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "getDependentDialects");
 ...
 public:
  ...
  explicit PrepareQuantizePass() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_1(mht_1_v, 253, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass");
  ...
  explicit PrepareQuantizePass(QuantizationMethod quantization_method) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_2(mht_2_v, 261, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass");
  ...
  explicit PrepareQuantizePass(const QuantizationSpecs& quant_specs)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_3(mht_3_v, 272, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass");
}

  StringRef getArgument() const final {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_4(mht_4_v, 277, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "getArgument");
  ...
  StringRef getDescription() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_5(mht_5_v, 285, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "getDescription");
 ...
 private:
  ...
  bool IsLegalQuantSpecs(FuncOp func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_6(mht_6_v, 310, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "IsLegalQuantSpecs");
...
bool PrepareQuantizePass::SetInputNodesQuantizationParams(FuncOp func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_7(mht_7_v, 343, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass::SetInputNodesQuantizationParams");

  StringRef func_name = func.getName();
  auto has_quantize_op = [&](const Value arg) {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_8(mht_8_v, 348, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "lambda");
  ...
  auto add_quantize_op = [&](Location loc, Type input_type, Block* block,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_9(mht_9_v, 383, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "lambda");
...
bool PrepareQuantizePass::RemoveRedundantStats(FuncOp func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_10(mht_10_v, 449, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass::RemoveRedundantStats");
...
static Value Quantized(Operation* user) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_11(mht_11_v, 456, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "Quantized");
...
void PrepareQuantizePass::SanityCheckAndAdjustment(FuncOp func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_12(mht_12_v, 469, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass::SanityCheckAndAdjustment");
...
bool PrepareQuantizePass::ContainsQuantizeOps(FuncOp func) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSprepare_quantizeDTcc mht_13(mht_13_v, 540, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/prepare_quantize.cc", "PrepareQuantizePass::ContainsQuantizeOps");
