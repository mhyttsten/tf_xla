...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc() {
      // Check if tracing is enabled
...
class InsertCustomAggregationOpsPass
 ...
 public:
  StringRef getArgument() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_custom_aggregation_ops.cc", "getArgument");
  ...
  StringRef getDescription() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc mht_1(mht_1_v, 220, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_custom_aggregation_ops.cc", "getDescription");
  ...
  void getDependentDialects(DialectRegistry &registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc mht_2(mht_2_v, 228, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_custom_aggregation_ops.cc", "getDependentDialects");
...
class AddCustomAggregationOp : public RewritePattern {
 public:
  ...
  explicit AddCustomAggregationOp(MLIRContext *context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc mht_3(mht_3_v, 245, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_custom_aggregation_ops.cc", "AddCustomAggregationOp");
}

  LogicalResult matchAndRewrite(Operation *op,
                                PatternRewriter &rewriter) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc mht_4(mht_4_v, 251, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_custom_aggregation_ops.cc", "matchAndRewrite");
...
void InsertCustomAggregationOpsPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSpassesPSinsert_custom_aggregation_opsDTcc mht_5(mht_5_v, 302, "", "./tensorflow/compiler/mlir/quantization/tensorflow/passes/insert_custom_aggregation_ops.cc", "InsertCustomAggregationOpsPass::runOnOperation");
