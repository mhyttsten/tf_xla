...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSutilsPSfake_quant_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSutilsPSfake_quant_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSutilsPSfake_quant_utilsDTh() {
      // Check if tracing is enabled
...
class ConvertFakeQuantOpToQuantOps {
 public:
  explicit ConvertFakeQuantOpToQuantOps(bool use_fake_quant_num_bits)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSutilsPSfake_quant_utilsDTh mht_0(mht_0_v, 256, "", "./tensorflow/compiler/mlir/quantization/tensorflow/utils/fake_quant_utils.h", "ConvertFakeQuantOpToQuantOps");
}
  ...
  LogicalResult matchAndRewrite(TFFakeQuantOp tf_op,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPSquantizationPStensorflowPSutilsPSfake_quant_utilsDTh mht_1(mht_1_v, 265, "", "./tensorflow/compiler/mlir/quantization/tensorflow/utils/fake_quant_utils.h", "matchAndRewrite");
