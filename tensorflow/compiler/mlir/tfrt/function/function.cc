...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSfunctionPSfunctionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSfunctionPSfunctionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSfunctionPSfunctionDTcc() {
      // Check if tracing is enabled
...
Status CompileTFMLIRToBEF(const TfrtFunctionCompileOptions& options,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSfunctionPSfunctionDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/mlir/tfrt/function/function.cc", "CompileTFMLIRToBEF");
