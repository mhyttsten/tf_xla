...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSruntime_fallbackPSruntime_fallback_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSruntime_fallbackPSruntime_fallback_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSruntime_fallbackPSruntime_fallback_opsDTh() {
      // Check if tracing is enabled
...
class RuntimeFallbackDialect : public Dialect {
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSruntime_fallbackPSruntime_fallback_opsDTh mht_0(mht_0_v, 203, "", "./tensorflow/compiler/mlir/tfrt/runtime_fallback/runtime_fallback_ops.h", "getDialectNamespace");
 return "tfd"; }
};
