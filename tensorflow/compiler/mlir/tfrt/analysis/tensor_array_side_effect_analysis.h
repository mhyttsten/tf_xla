...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSanalysisPStensor_array_side_effect_analysisDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSanalysisPStensor_array_side_effect_analysisDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSanalysisPStensor_array_side_effect_analysisDTh() {
      // Check if tracing is enabled
...
class TensorArraySideEffectAnalysis {
 public:
  ...
  bool HasAtMostTensorArrayEffect(mlir::func::FuncOp func_op) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSanalysisPStensor_array_side_effect_analysisDTh mht_0(mht_0_v, 208, "", "./tensorflow/compiler/mlir/tfrt/analysis/tensor_array_side_effect_analysis.h", "HasAtMostTensorArrayEffect");
