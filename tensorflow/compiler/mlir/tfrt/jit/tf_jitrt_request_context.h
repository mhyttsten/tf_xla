...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTh() {
      // Check if tracing is enabled
...
struct TfJitRtRequestState {
  explicit TfJitRtRequestState(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTh mht_0(mht_0_v, 196, "", "./tensorflow/compiler/mlir/tfrt/jit/tf_jitrt_request_context.h", "TfJitRtRequestState");
}
