...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPSopdefsPStf_jitrt_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPSopdefsPStf_jitrt_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPSopdefsPStf_jitrt_opsDTh() {
      // Check if tracing is enabled
...
class JitRuntimeDialect : public mlir::Dialect {
 public:
  ...
  static mlir::StringRef getDialectNamespace() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPSopdefsPStf_jitrt_opsDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/tfrt/jit/opdefs/tf_jitrt_ops.h", "getDialectNamespace");
 return "tf_jitrt"; }
};
