...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTcc() {
      // Check if tracing is enabled
...
Status SetUpTfJitRtRequestContext(tfrt::RequestContextBuilder* builder) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_request_contextDTcc mht_0(mht_0_v, 191, "", "./tensorflow/compiler/mlir/tfrt/jit/tf_jitrt_request_context.cc", "SetUpTfJitRtRequestContext");
