...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc() {
      // Check if tracing is enabled
...
bool IsTransposeGenericOp(Operation *op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc mht_0(mht_0_v, 222, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_tile_transpose.cc", "IsTransposeGenericOp");
...
struct TileTransposePattern : public mlir::OpRewritePattern<GenericOp> {
  ...
  TileTransposePattern(LinalgTilingOptions options,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc mht_1(mht_1_v, 268, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_tile_transpose.cc", "TileTransposePattern");
}

  mlir::LogicalResult matchAndRewrite(
      GenericOp linalg_op, PatternRewriter &rewriter) const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc mht_2(mht_2_v, 274, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_tile_transpose.cc", "matchAndRewrite");
...
struct TileTransposePass : public TileTransposeBase<TileTransposePass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc mht_3(mht_3_v, 306, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_tile_transpose.cc", "runOnOperation");

    auto get_tile_size = [&](mlir::OpBuilder b, Operation *op) {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_tile_transposeDTcc mht_4(mht_4_v, 310, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_tile_transpose.cc", "lambda");
