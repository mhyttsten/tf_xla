...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_copy_removalDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_copy_removalDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_copy_removalDTcc() {
      // Check if tracing is enabled
...
struct LinalgTrivialCopyRemovalPass
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_copy_removalDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_copy_removal.cc", "runOnOperation");
