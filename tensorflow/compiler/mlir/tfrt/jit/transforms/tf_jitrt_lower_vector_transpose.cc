...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_lower_vector_transposeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_lower_vector_transposeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_lower_vector_transposeDTcc() {
      // Check if tracing is enabled
...
struct LowerTransposePass : public LowerTransposeBase<LowerTransposePass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_lower_vector_transposeDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_lower_vector_transpose.cc", "runOnOperation");
