...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_test_passesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_test_passesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_test_passesDTcc() {
      // Check if tracing is enabled
...
struct TestClusteringPass : public TestClusteringBase<TestClusteringPass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_test_passesDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_test_passes.cc", "runOnOperation");
...
struct TestClusteringPolicyPass
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_test_passesDTcc mht_1(mht_1_v, 240, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_test_passes.cc", "runOnOperation");
