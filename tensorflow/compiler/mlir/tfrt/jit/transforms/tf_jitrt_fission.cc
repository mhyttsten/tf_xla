...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_fissionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_fissionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_fissionDTcc() {
      // Check if tracing is enabled
...
struct FusedMatMulFission
  ...
  mlir::LogicalResult matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_fissionDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_fission.cc", "matchAndRewrite");
...
struct FissionPass : public FissionBase<FissionPass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_fissionDTcc mht_1(mht_1_v, 256, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_fission.cc", "runOnOperation");
