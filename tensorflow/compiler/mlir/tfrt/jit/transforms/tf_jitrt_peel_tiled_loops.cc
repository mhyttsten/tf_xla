...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_peel_tiled_loopsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_peel_tiled_loopsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_peel_tiled_loopsDTcc() {
      // Check if tracing is enabled
...
struct PeelGmlStLoop : public mlir::OpRewritePattern<LoopOp> {
  ...
  mlir::LogicalResult matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_peel_tiled_loopsDTcc mht_0(mht_0_v, 212, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_peel_tiled_loops.cc", "matchAndRewrite");
...
struct PeelTiledLoopsPass : public PeelTiledLoopsBase<PeelTiledLoopsPass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStransformsPStf_jitrt_peel_tiled_loopsDTcc mht_1(mht_1_v, 233, "", "./tensorflow/compiler/mlir/tfrt/jit/transforms/tf_jitrt_peel_tiled_loops.cc", "runOnOperation");
