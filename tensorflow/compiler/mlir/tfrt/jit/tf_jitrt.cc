...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrtDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrtDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrtDTcc() {
      // Check if tracing is enabled
...
void RecordCompileTime(const std::string& model_name, const std::string& kernel,
   ...
   mht_0_v.push_back("kernel: \"" + kernel + "\"");
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrtDTcc mht_0(mht_0_v, 218, "", "./tensorflow/compiler/mlir/tfrt/jit/tf_jitrt.cc", "RecordCompileTime");
