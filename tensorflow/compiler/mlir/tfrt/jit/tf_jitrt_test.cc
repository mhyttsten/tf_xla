...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_testDTcc() {
      // Check if tracing is enabled
...
static void BM_ReturnTensor(benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_testDTcc mht_0(mht_0_v, 215, "", "./tensorflow/compiler/mlir/tfrt/jit/tf_jitrt_test.cc", "BM_ReturnTensor");
