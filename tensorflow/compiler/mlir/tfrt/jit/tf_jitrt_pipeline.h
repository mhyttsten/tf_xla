...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_pipelineDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_pipelineDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_pipelineDTh() {
      // Check if tracing is enabled
...
inline ::llvm::hash_code hash_value(const TfJitRtPipelineOptions& opts) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSjitPStf_jitrt_pipelineDTh mht_0(mht_0_v, 234, "", "./tensorflow/compiler/mlir/tfrt/jit/tf_jitrt_pipeline.h", "hash_value");
