...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSbenchmarksPSreduction_benchmarkDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSbenchmarksPSreduction_benchmarkDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSbenchmarksPSreduction_benchmarkDTcc() {
      // Check if tracing is enabled
...
std::string GetReductionIR(StringRef op_name, ArrayRef<int32_t> input_shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSbenchmarksPSreduction_benchmarkDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/mlir/tfrt/benchmarks/reduction_benchmark.cc", "GetReductionIR");
...
std::string GetSumF32IR(llvm::ArrayRef<int32_t> input_shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSbenchmarksPSreduction_benchmarkDTcc mht_1(mht_1_v, 236, "", "./tensorflow/compiler/mlir/tfrt/benchmarks/reduction_benchmark.cc", "GetSumF32IR");
...
std::string GetMeanF32IR(llvm::ArrayRef<int32_t> input_shape,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSbenchmarksPSreduction_benchmarkDTcc mht_2(mht_2_v, 246, "", "./tensorflow/compiler/mlir/tfrt/benchmarks/reduction_benchmark.cc", "GetMeanF32IR");
