...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPStpu_passesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPStpu_passesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPStpu_passesDTh() {
      // Check if tracing is enabled
...
inline void RegisterTPUDialects(mlir::DialectRegistry *registry) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPStpu_passesDTh mht_0(mht_0_v, 229, "", "./tensorflow/compiler/mlir/tfrt/transforms/tpu_passes.h", "RegisterTPUDialects");
}
...
inline void AddTPUTargetDialectAndPatterns(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPStpu_passesDTh mht_1(mht_1_v, 240, "", "./tensorflow/compiler/mlir/tfrt/transforms/tpu_passes.h", "AddTPUTargetDialectAndPatterns");
}
...
inline mlir::LogicalResult RunTPUBackwardCompatConversion(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPStpu_passesDTh mht_2(mht_2_v, 247, "", "./tensorflow/compiler/mlir/tfrt/transforms/tpu_passes.h", "RunTPUBackwardCompatConversion");
