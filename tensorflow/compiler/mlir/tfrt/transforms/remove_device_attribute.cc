...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSremove_device_attributeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSremove_device_attributeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSremove_device_attributeDTcc() {
      // Check if tracing is enabled
...
struct RemoveDeviceAttributePass
  ...
  llvm::StringRef getArgument() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSremove_device_attributeDTcc mht_0(mht_0_v, 203, "", "./tensorflow/compiler/mlir/tfrt/transforms/remove_device_attribute.cc", "getArgument");

    return "tfrt-remove-device-attribute";
  }
  llvm::StringRef getDescription() const final {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSremove_device_attributeDTcc mht_1(mht_1_v, 209, "", "./tensorflow/compiler/mlir/tfrt/transforms/remove_device_attribute.cc", "getDescription");
...
void RemoveDeviceAttributePass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSremove_device_attributeDTcc mht_2(mht_2_v, 219, "", "./tensorflow/compiler/mlir/tfrt/transforms/remove_device_attribute.cc", "RemoveDeviceAttributePass::runOnOperation");
