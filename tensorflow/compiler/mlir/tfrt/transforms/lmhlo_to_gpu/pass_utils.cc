...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSpass_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSpass_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSpass_utilsDTcc() {
      // Check if tracing is enabled
...
Status ConvertLmhloToTfrtGpuWithBinary(mlir::ModuleOp module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSpass_utilsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/mlir/tfrt/transforms/lmhlo_to_gpu/pass_utils.cc", "ConvertLmhloToTfrtGpuWithBinary");
