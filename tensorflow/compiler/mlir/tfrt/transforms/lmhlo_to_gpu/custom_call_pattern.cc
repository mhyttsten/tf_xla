...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPScustom_call_patternDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPScustom_call_patternDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPScustom_call_patternDTcc() {
      // Check if tracing is enabled
...
void populateCustomCallConversionPattern(RewritePatternSet& patterns,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPScustom_call_patternDTcc mht_0(mht_0_v, 242, "", "./tensorflow/compiler/mlir/tfrt/transforms/lmhlo_to_gpu/custom_call_pattern.cc", "populateCustomCallConversionPattern");
