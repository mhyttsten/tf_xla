...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPStriangular_solve_patternDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPStriangular_solve_patternDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPStriangular_solve_patternDTcc() {
      // Check if tracing is enabled
...
struct TriangularSolveRewritePattern
  ...
  FailureOr<Value> matchAndRewriteOp(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPStriangular_solve_patternDTcc mht_0(mht_0_v, 204, "", "./tensorflow/compiler/mlir/tfrt/transforms/lmhlo_to_gpu/triangular_solve_pattern.cc", "lambda");
...
void populateTriangularSolveConversionPattern(RewritePatternSet& patterns,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPStriangular_solve_patternDTcc mht_1(mht_1_v, 289, "", "./tensorflow/compiler/mlir/tfrt/transforms/lmhlo_to_gpu/triangular_solve_pattern.cc", "populateTriangularSolveConversionPattern");
