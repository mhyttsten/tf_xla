...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSreplica_and_partition_patternDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSreplica_and_partition_patternDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSreplica_and_partition_patternDTcc() {
      // Check if tracing is enabled
...
void populateReplicaAndPartitionConversionPattern(RewritePatternSet& patterns,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSreplica_and_partition_patternDTcc mht_0(mht_0_v, 229, "", "./tensorflow/compiler/mlir/tfrt/transforms/lmhlo_to_gpu/replica_and_partition_pattern.cc", "populateReplicaAndPartitionConversionPattern");
