...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSinfeed_and_outfeed_patternDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSinfeed_and_outfeed_patternDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSinfeed_and_outfeed_patternDTcc() {
      // Check if tracing is enabled
...
void populateInfeedAndOutfeedConversionPattern(RewritePatternSet& patterns,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSlmhlo_to_gpuPSinfeed_and_outfeed_patternDTcc mht_0(mht_0_v, 230, "", "./tensorflow/compiler/mlir/tfrt/transforms/lmhlo_to_gpu/infeed_and_outfeed_pattern.cc", "populateInfeedAndOutfeedConversionPattern");
