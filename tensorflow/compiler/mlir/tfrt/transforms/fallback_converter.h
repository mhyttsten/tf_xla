...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh() {
      // Check if tracing is enabled
...
inline llvm::StringRef GetDefaultCpuDeviceName() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh mht_0(mht_0_v, 194, "", "./tensorflow/compiler/mlir/tfrt/transforms/fallback_converter.h", "GetDefaultCpuDeviceName");
...
class FallbackConverter : public mlir::TypeConverter {
 public:
  ...
  int64_t GetNextFallbackKey() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh mht_1(mht_1_v, 209, "", "./tensorflow/compiler/mlir/tfrt/transforms/fallback_converter.h", "GetNextFallbackKey");
 return fallback_ops_.size(); }

  void RegisterFallbackOp(mlir::Operation *op) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh mht_2(mht_2_v, 214, "", "./tensorflow/compiler/mlir/tfrt/transforms/fallback_converter.h", "RegisterFallbackOp");
 fallback_ops_.push_back(op); }

  void ReplaceFallbackOp(int64_t key, mlir::Operation *op) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPStransformsPSfallback_converterDTh mht_3(mht_3_v, 219, "", "./tensorflow/compiler/mlir/tfrt/transforms/fallback_converter.h", "ReplaceFallbackOp");
