...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSsaved_modelPSsaved_modelDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSsaved_modelPSsaved_modelDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSsaved_modelPSsaved_modelDTcc() {
      // Check if tracing is enabled
...
llvm::StringRef ProcessIndexPath(mlir::ArrayAttr index_path) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSsaved_modelPSsaved_modelDTcc mht_0(mht_0_v, 209, "", "./tensorflow/compiler/mlir/tfrt/saved_model/saved_model.cc", "ProcessIndexPath");
...
Status MapFunctionSignaturesFromTFSavedModelMLIR(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSsaved_modelPSsaved_modelDTcc mht_1(mht_1_v, 239, "", "./tensorflow/compiler/mlir/tfrt/saved_model/saved_model.cc", "MapFunctionSignaturesFromTFSavedModelMLIR");
