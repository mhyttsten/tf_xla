...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_asyncDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_asyncDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_asyncDTh() {
      // Check if tracing is enabled
...
class FallbackAsyncDialect : public Dialect {
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_asyncDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/mlir/tfrt/ir/tfrt_fallback_async.h", "getDialectNamespace");
 return "tfrt_fallback_async"; }
};
