...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_syncDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_syncDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_syncDTh() {
      // Check if tracing is enabled
...
class FallbackSyncDialect : public Dialect {
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_syncDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/mlir/tfrt/ir/tfrt_fallback_sync.h", "getDialectNamespace");
 return "tfrt_fallback_sync"; }
};
