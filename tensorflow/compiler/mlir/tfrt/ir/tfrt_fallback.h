...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallbackDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallbackDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallbackDTh() {
      // Check if tracing is enabled
...
class FallbackDialect : public Dialect {
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallbackDTh mht_0(mht_0_v, 202, "", "./tensorflow/compiler/mlir/tfrt/ir/tfrt_fallback.h", "getDialectNamespace");
 return "tfrt_fallback"; }
