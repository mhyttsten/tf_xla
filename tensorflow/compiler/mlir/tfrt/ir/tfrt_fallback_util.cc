...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_utilDTcc() {
      // Check if tracing is enabled
...
bool IsArgConsumedByFallback(mlir::func::FuncOp func, int arg_index) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_utilDTcc mht_0(mht_0_v, 191, "", "./tensorflow/compiler/mlir/tfrt/ir/tfrt_fallback_util.cc", "IsArgConsumedByFallback");
...
void ForEachArgConsumedByFallback(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_utilDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/mlir/tfrt/ir/tfrt_fallback_util.cc", "ForEachArgConsumedByFallback");
...
void ForEachArgConsumedByFallback(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrtPSirPStfrt_fallback_utilDTcc mht_2(mht_2_v, 221, "", "./tensorflow/compiler/mlir/tfrt/ir/tfrt_fallback_util.cc", "ForEachArgConsumedByFallback");
