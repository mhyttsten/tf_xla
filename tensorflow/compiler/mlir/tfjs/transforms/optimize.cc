...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStransformsPSoptimizeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStransformsPSoptimizeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStransformsPSoptimizeDTcc() {
      // Check if tracing is enabled
...
struct Optimize : public tfjs::OptimizePassBase<Optimize> {
  void getDependentDialects(DialectRegistry &registry) const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStransformsPSoptimizeDTcc mht_0(mht_0_v, 211, "", "./tensorflow/compiler/mlir/tfjs/transforms/optimize.cc", "getDependentDialects");
