...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStranslatePSjson_translateDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStranslatePSjson_translateDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStranslatePSjson_translateDTcc() {
      // Check if tracing is enabled
...
bool tfjs::MlirToJSONTranslateFunction(ModuleOp module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStranslatePSjson_translateDTcc mht_0(mht_0_v, 220, "", "./tensorflow/compiler/mlir/tfjs/translate/json_translate.cc", "tfjs::MlirToJSONTranslateFunction");
...
static mlir::LogicalResult MlirToJSONFileTranslateFunction(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfjsPStranslatePSjson_translateDTcc mht_1(mht_1_v, 267, "", "./tensorflow/compiler/mlir/tfjs/translate/json_translate.cc", "MlirToJSONFileTranslateFunction");
