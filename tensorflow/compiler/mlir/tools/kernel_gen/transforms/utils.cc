...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSutilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSutilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSutilsDTcc() {
      // Check if tracing is enabled
...
FlatSymbolRefAttr GetOrInsertLLVMFunction(StringRef func_name, Type func_type,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSutilsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/utils.cc", "GetOrInsertLLVMFunction");
...
std::string GetGlobalName(StringRef base, StringRef content) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSutilsDTcc mht_1(mht_1_v, 213, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/utils.cc", "GetGlobalName");
...
Value CreateOrFindGlobalStringConstant(Location loc, StringRef global_name,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSutilsDTcc mht_2(mht_2_v, 221, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/utils.cc", "CreateOrFindGlobalStringConstant");
