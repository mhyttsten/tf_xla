...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSgpu_kernel_to_blob_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSgpu_kernel_to_blob_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSgpu_kernel_to_blob_passDTcc() {
      // Check if tracing is enabled
...
class GpuKernelToBlobPass
 ...
 public:
  GpuKernelToBlobPass(StringRef blob_annotation,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSgpu_kernel_to_blob_passDTcc mht_0(mht_0_v, 222, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/gpu_kernel_to_blob_pass.cc", "GpuKernelToBlobPass");
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSgpu_kernel_to_blob_passDTcc mht_1(mht_1_v, 233, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/gpu_kernel_to_blob_pass.cc", "runOnOperation");
  ...
  tensorflow::StatusOr<std::vector<uint8_t>> GetGpuBinaryBlob(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSgpu_kernel_to_blob_passDTcc mht_2(mht_2_v, 333, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/gpu_kernel_to_blob_pass.cc", "lambda");
