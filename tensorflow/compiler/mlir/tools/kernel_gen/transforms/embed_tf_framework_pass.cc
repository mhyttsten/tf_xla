...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSembed_tf_framework_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSembed_tf_framework_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSembed_tf_framework_passDTcc() {
      // Check if tracing is enabled
...
bool HasInitializedOpKernelContextOperand(OpTy op) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSembed_tf_framework_passDTcc mht_0(mht_0_v, 210, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/embed_tf_framework_pass.cc", "HasInitializedOpKernelContextOperand");
...
class EmbedTFFrameworkPass
  ...
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSembed_tf_framework_passDTcc mht_1(mht_1_v, 223, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/embed_tf_framework_pass.cc", "getDependentDialects");
 ...
 public:
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSembed_tf_framework_passDTcc mht_2(mht_2_v, 231, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/embed_tf_framework_pass.cc", "runOnOperation");
