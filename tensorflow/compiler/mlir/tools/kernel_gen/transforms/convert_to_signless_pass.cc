...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSconvert_to_signless_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSconvert_to_signless_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSconvert_to_signless_passDTcc() {
      // Check if tracing is enabled
...
class ConvertToSignless : public ConversionPattern {
 public:
  ConvertToSignless(TypeConverter& type_converter, MLIRContext* context)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSconvert_to_signless_passDTcc mht_0(mht_0_v, 214, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/convert_to_signless_pass.cc", "ConvertToSignless");
}
  ...
  LogicalResult matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSconvert_to_signless_passDTcc mht_1(mht_1_v, 221, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/convert_to_signless_pass.cc", "matchAndRewrite");
...
struct ConvertToSignlessPass
 ...
 public:
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSconvert_to_signless_passDTcc mht_2(mht_2_v, 251, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/convert_to_signless_pass.cc", "runOnOperation");
