...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSrewrite_tf_framework_assertDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSrewrite_tf_framework_assertDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSrewrite_tf_framework_assertDTcc() {
      // Check if tracing is enabled
...
class TFAssertOpConverter : public OpConversionPattern<TFAssertOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSrewrite_tf_framework_assertDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/rewrite_tf_framework_assert.cc", "matchAndRewrite");
...
class RewriteTFFrameworkAssertPass
  ...
  void getDependentDialects(DialectRegistry &registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSrewrite_tf_framework_assertDTcc mht_1(mht_1_v, 248, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/rewrite_tf_framework_assert.cc", "getDependentDialects");
 ...
 public:
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStoolsPSkernel_genPStransformsPSrewrite_tf_framework_assertDTcc mht_2(mht_2_v, 256, "", "./tensorflow/compiler/mlir/tools/kernel_gen/transforms/rewrite_tf_framework_assert.cc", "runOnOperation");
