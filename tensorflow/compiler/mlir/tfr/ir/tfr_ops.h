...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSirPStfr_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSirPStfr_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSirPStfr_opsDTh() {
      // Check if tracing is enabled
...
class TFRDialect : public Dialect {
 public:
  ...
  static StringRef getDialectNamespace() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSirPStfr_opsDTh mht_0(mht_0_v, 213, "", "./tensorflow/compiler/mlir/tfr/ir/tfr_ops.h", "getDialectNamespace");
 return "tfr"; }
