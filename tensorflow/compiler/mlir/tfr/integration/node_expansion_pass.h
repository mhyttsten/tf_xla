...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSnode_expansion_passDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSnode_expansion_passDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSnode_expansion_passDTh() {
      // Check if tracing is enabled
...
class CompositeOpExpansion : public EagerOpRewrite {
 public:
  CompositeOpExpansion(string name, string file, string line)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSnode_expansion_passDTh mht_0(mht_0_v, 204, "", "./tensorflow/compiler/mlir/tfr/integration/node_expansion_pass.h", "CompositeOpExpansion");
}
 ...
 private:
  ...
  bool IsEnabled() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSnode_expansion_passDTh mht_1(mht_1_v, 215, "", "./tensorflow/compiler/mlir/tfr/integration/node_expansion_pass.h", "IsEnabled");
