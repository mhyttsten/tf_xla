...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTh() {
      // Check if tracing is enabled
...
class GraphDecomposePass : public MlirOptimizationPass {
 public:
  llvm::StringRef name() const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTh mht_0(mht_0_v, 201, "", "./tensorflow/compiler/mlir/tfr/integration/graph_decompose_pass.h", "name");
 return "tfr"; }
