...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTcc() {
      // Check if tracing is enabled
...
MlirOptimizationPassState GraphDecomposePass::GetPassState(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/mlir/tfr/integration/graph_decompose_pass.cc", "GraphDecomposePass::GetPassState");
...
Status GraphDecomposePass::Run(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSintegrationPSgraph_decompose_passDTcc mht_1(mht_1_v, 216, "", "./tensorflow/compiler/mlir/tfr/integration/graph_decompose_pass.cc", "GraphDecomposePass::Run");
