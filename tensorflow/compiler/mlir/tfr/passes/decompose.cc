...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc() {
      // Check if tracing is enabled
...
void IncreaseOpExpansionExecuteCounterByOne(const std::string& op_name) {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_0(mht_0_v, 238, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "IncreaseOpExpansionExecuteCounterByOne");
...
Attribute Quantize(float value, Attribute scale_attr, Attribute zp_attr,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_1(mht_1_v, 257, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "Quantize");
...
class DecomposeTFOpsPass
 ...
 public:
  explicit DecomposeTFOpsPass(llvm::Optional<ModuleOp> external_tfr_module)
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_2(mht_2_v, 277, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "DecomposeTFOpsPass");
}

  StringRef getArgument() const final {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_3(mht_3_v, 282, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "getArgument");
 return "tfr-decompose"; }

  StringRef getDescription() const final {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_4(mht_4_v, 287, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "getDescription");
...
LogicalResult DecomposeTFOpsPass::RewriteUnregisteredTFOps() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_5(mht_5_v, 323, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "DecomposeTFOpsPass::RewriteUnregisteredTFOps");
...
LogicalResult DecomposeTFOpsPass::InlineTFRFuncCalls() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_6(mht_6_v, 466, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "DecomposeTFOpsPass::InlineTFRFuncCalls");
...
void DecomposeTFOpsPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSdecomposeDTcc mht_7(mht_7_v, 522, "", "./tensorflow/compiler/mlir/tfr/passes/decompose.cc", "DecomposeTFOpsPass::runOnOperation");
