...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc() {
      // Check if tracing is enabled
...
class RewriteTFRCallOp : public OpRewritePattern<CallOp> {
 ...
 public:
  explicit RewriteTFRCallOp(MLIRContext* context, const SymbolTable& table,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_0(mht_0_v, 252, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp");
}
 ...
 private:
  ...
  Type GetFixedElementType(StringRef element_type, Builder& builder) const {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_1(mht_1_v, 296, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "GetFixedElementType");
  ...
  Value CastToNonDerivedType(PatternRewriter& rewriter, Location loc,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_2(mht_2_v, 312, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "CastToNonDerivedType");
  ...
  void CastValuesToSameType(PatternRewriter& rewriter, Location loc,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_3(mht_3_v, 343, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "CastValuesToSameType");
...
LogicalResult RewriteTFRCallOp::AddDerivedAttrs(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_4(mht_4_v, 369, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp::AddDerivedAttrs");
...
LogicalResult RewriteTFRCallOp::CollectInputsAndAttributes(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_5(mht_5_v, 415, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp::CollectInputsAndAttributes");
...
Attribute RewriteTFRCallOp::ProcessAttributeValue(Attribute attr,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_6(mht_6_v, 499, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp::ProcessAttributeValue");
...
LogicalResult RewriteTFRCallOp::DeriveOutputTypes(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_7(mht_7_v, 522, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp::DeriveOutputTypes");
...
LogicalResult RewriteTFRCallOp::CreateAndReplaceOp(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_8(mht_8_v, 571, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp::CreateAndReplaceOp");
...
LogicalResult RewriteTFRCallOp::matchAndRewrite(
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_9(mht_9_v, 621, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RewriteTFRCallOp::matchAndRewrite");
...
class RaiseToTFOpsPass
 ...
 public:
  void getDependentDialects(DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_10(mht_10_v, 669, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "getDependentDialects");
  ...
  explicit RaiseToTFOpsPass(llvm::Optional<ModuleOp> tfr_module,
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_11(mht_11_v, 680, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RaiseToTFOpsPass");
}

  StringRef getArgument() const final {
   std::vector<std::string> mht_12_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_12(mht_12_v, 685, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "getArgument");
 return "tfr-raise-to-tf"; }

  StringRef getDescription() const final {
   std::vector<std::string> mht_13_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_13(mht_13_v, 690, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "getDescription");
...
void RaiseToTFOpsPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSraise_to_tfDTcc mht_14(mht_14_v, 704, "", "./tensorflow/compiler/mlir/tfr/passes/raise_to_tf.cc", "RaiseToTFOpsPass::runOnOperation");
