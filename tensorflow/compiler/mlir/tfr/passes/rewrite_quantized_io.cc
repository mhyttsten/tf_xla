...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSrewrite_quantized_ioDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSrewrite_quantized_ioDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSrewrite_quantized_ioDTcc() {
      // Check if tracing is enabled
...
class RewriteQuantizedIOPass
 ...
 public:
  StringRef getArgument() const final {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSrewrite_quantized_ioDTcc mht_0(mht_0_v, 205, "", "./tensorflow/compiler/mlir/tfr/passes/rewrite_quantized_io.cc", "getArgument");
 return "tfr-rewrite-quantized-io"; }

  StringRef getDescription() const final {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSrewrite_quantized_ioDTcc mht_1(mht_1_v, 210, "", "./tensorflow/compiler/mlir/tfr/passes/rewrite_quantized_io.cc", "getDescription");
...
void RewriteQuantizedIOPass::runOnOperation() {
   ...
   MHTracer_DTPStensorflowPScompilerPSmlirPStfrPSpassesPSrewrite_quantized_ioDTcc mht_2(mht_2_v, 220, "", "./tensorflow/compiler/mlir/tfr/passes/rewrite_quantized_io.cc", "RewriteQuantizedIOPass::runOnOperation");
