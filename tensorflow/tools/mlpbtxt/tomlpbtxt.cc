...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSmlpbtxtPStomlpbtxtDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSmlpbtxtPStomlpbtxtDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSmlpbtxtPStomlpbtxtDTcc() {
      // Check if tracing is enabled
...
int Run(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPStoolsPSmlpbtxtPStomlpbtxtDTcc mht_0(mht_0_v, 197, "", "./tensorflow/tools/mlpbtxt/tomlpbtxt.cc", "Run");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPStoolsPSmlpbtxtPStomlpbtxtDTcc mht_1(mht_1_v, 253, "", "./tensorflow/tools/mlpbtxt/tomlpbtxt.cc", "main");
