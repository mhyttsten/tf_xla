...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSbenchmarkPSbenchmark_model_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSbenchmarkPSbenchmark_model_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSbenchmarkPSbenchmark_model_testDTcc() {
      // Check if tracing is enabled
...
void CreateTestGraph(const ::tensorflow::Scope& root,
   ...
   MHTracer_DTPStensorflowPStoolsPSbenchmarkPSbenchmark_model_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/tools/benchmark/benchmark_model_test.cc", "CreateTestGraph");
