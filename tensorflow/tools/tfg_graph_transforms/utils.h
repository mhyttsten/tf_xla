...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPStfg_graph_transformsPSutilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPStfg_graph_transformsPSutilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPStfg_graph_transformsPSutilsDTh() {
      // Check if tracing is enabled
...
tensorflow::Status ReadModelProto(const std::string& input_file,
   ...
   MHTracer_DTPStensorflowPStoolsPStfg_graph_transformsPSutilsDTh mht_0(mht_0_v, 206, "", "./tensorflow/tools/tfg_graph_transforms/utils.h", "ReadModelProto");
...
tensorflow::Status SerializeProto(T model_proto,
   ...
   mht_1_v.push_back("output_file: \"" + output_file + "\"");
   MHTracer_DTPStensorflowPStoolsPStfg_graph_transformsPSutilsDTh mht_1(mht_1_v, 250, "", "./tensorflow/tools/tfg_graph_transforms/utils.h", "SerializeProto");
