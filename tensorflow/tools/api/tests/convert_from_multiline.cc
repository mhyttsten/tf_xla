...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSapiPStestsPSconvert_from_multilineDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSapiPStestsPSconvert_from_multilineDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSapiPStestsPSconvert_from_multilineDTcc() {
      // Check if tracing is enabled
...
Status ConvertFilesFromMultiline(const string& input_dir,
   ...
   mht_0_v.push_back("input_dir: \"" + input_dir + "\"");
   mht_0_v.push_back("output_dir: \"" + output_dir + "\"");
   MHTracer_DTPStensorflowPStoolsPSapiPStestsPSconvert_from_multilineDTcc mht_0(mht_0_v, 198, "", "./tensorflow/tools/api/tests/convert_from_multiline.cc", "ConvertFilesFromMultiline");
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPStoolsPSapiPStestsPSconvert_from_multilineDTcc mht_1(mht_1_v, 226, "", "./tensorflow/tools/api/tests/convert_from_multiline.cc", "main");
