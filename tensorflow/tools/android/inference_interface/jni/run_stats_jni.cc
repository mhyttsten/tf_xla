...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPSinference_interfacePSjniPSrun_stats_jniDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPSinference_interfacePSjniPSrun_stats_jniDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPSinference_interfacePSjniPSrun_stats_jniDTcc() {
      // Check if tracing is enabled
...
StatSummarizer* requireHandle(JNIEnv* env, jlong handle) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPSinference_interfacePSjniPSrun_stats_jniDTcc mht_0(mht_0_v, 198, "", "./tensorflow/tools/android/inference_interface/jni/run_stats_jni.cc", "requireHandle");
