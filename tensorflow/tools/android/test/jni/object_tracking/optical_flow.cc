...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc() {
      // Check if tracing is enabled
...
OpticalFlow::OpticalFlow(const OpticalFlowConfig* const config)
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::OpticalFlow");
}


void OpticalFlow::NextFrame(const ImageData* const image_data) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_1(mht_1_v, 213, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::NextFrame");
...
bool OpticalFlow::FindFlowAtPoint_LK(const Image<uint8_t>& img_I,
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_2(mht_2_v, 231, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::FindFlowAtPoint_LK");
...
bool OpticalFlow::FindFlowAtPoint_ESM(
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_3(mht_3_v, 398, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::FindFlowAtPoint_ESM");
...
bool OpticalFlow::FindFlowAtPointReversible(
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_4(mht_4_v, 563, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::FindFlowAtPointReversible");
...
bool OpticalFlow::FindFlowAtPointSingleLevel(
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_5(mht_5_v, 612, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::FindFlowAtPointSingleLevel");
...
bool OpticalFlow::FindFlowAtPointPyramidal(const float u_x, const float u_y,
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSoptical_flowDTcc mht_6(mht_6_v, 654, "", "./tensorflow/tools/android/test/jni/object_tracking/optical_flow.cc", "OpticalFlow::FindFlowAtPointPyramidal");
