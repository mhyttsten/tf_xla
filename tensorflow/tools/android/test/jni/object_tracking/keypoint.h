...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSkeypointDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSkeypointDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSkeypointDTh() {
      // Check if tracing is enabled
...
struct Keypoint {
  Keypoint() : pos_(0.0f, 0.0f), score_(0.0f), type_(0) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSkeypointDTh mht_0(mht_0_v, 200, "", "./tensorflow/tools/android/test/jni/object_tracking/keypoint.h", "Keypoint");
}
  Keypoint(const float x, const float y)
      : pos_(x, y), score_(0.0f), type_(0) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSkeypointDTh mht_1(mht_1_v, 205, "", "./tensorflow/tools/android/test/jni/object_tracking/keypoint.h", "Keypoint");
}
...
inline std::ostream& operator<<(std::ostream& stream, const Keypoint keypoint) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSkeypointDTh mht_2(mht_2_v, 215, "", "./tensorflow/tools/android/test/jni/object_tracking/keypoint.h", "operator<<");
