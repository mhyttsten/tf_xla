...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh() {
      // Check if tracing is enabled
...
class ObjectModelBase {
 public:
  ObjectModelBase(const std::string& name) : name_(name) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh mht_0(mht_0_v, 222, "", "./tensorflow/tools/android/test/jni/object_tracking/object_model.h", "ObjectModelBase");
}

  virtual ~ObjectModelBase() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh mht_1(mht_1_v, 227, "", "./tensorflow/tools/android/test/jni/object_tracking/object_model.h", "~ObjectModelBase");
}
  ...
  virtual void TrackStep(const BoundingBox& position,
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh mht_2(mht_2_v, 236, "", "./tensorflow/tools/android/test/jni/object_tracking/object_model.h", "TrackStep");
}

  // Called when an object track is lost.
  virtual void TrackLost() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh mht_3(mht_3_v, 242, "", "./tensorflow/tools/android/test/jni/object_tracking/object_model.h", "TrackLost");
}

  // Called when an object track is confirmed as legitimate.
  virtual void TrackConfirmed() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh mht_4(mht_4_v, 248, "", "./tensorflow/tools/android/test/jni/object_tracking/object_model.h", "TrackConfirmed");
}
  ...
  inline const std::string& GetName() const {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSobject_modelDTh mht_5(mht_5_v, 260, "", "./tensorflow/tools/android/test/jni/object_tracking/object_model.h", "GetName");
