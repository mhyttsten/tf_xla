...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSframe_pairDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSframe_pairDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSframe_pairDTh() {
      // Check if tracing is enabled
...
class FramePair {
 public:
  FramePair()
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSframe_pairDTh mht_0(mht_0_v, 199, "", "./tensorflow/tools/android/test/jni/object_tracking/frame_pair.h", "FramePair");
}
