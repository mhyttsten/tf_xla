...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSjni_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSjni_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSjni_utilsDTh() {
      // Check if tracing is enabled
...
class JniLongField {
 public:
  JniLongField(const char* field_name)
   ...
   mht_0_v.push_back("field_name: \"" + (field_name == nullptr ? std::string("nullptr") : std::string((char*)field_name)) + "\"");
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSjni_utilsDTh mht_0(mht_0_v, 201, "", "./tensorflow/tools/android/test/jni/object_tracking/jni_utils.h", "JniLongField");
}

  int64_t get(JNIEnv* env, jobject thiz) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSjni_utilsDTh mht_1(mht_1_v, 206, "", "./tensorflow/tools/android/test/jni/object_tracking/jni_utils.h", "get");
  ...
  void set(JNIEnv* env, jobject thiz, int64_t value) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSjni_utilsDTh mht_2(mht_2_v, 221, "", "./tensorflow/tools/android/test/jni/object_tracking/jni_utils.h", "set");
