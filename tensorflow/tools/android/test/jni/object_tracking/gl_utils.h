...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSgl_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSgl_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSgl_utilsDTh() {
      // Check if tracing is enabled
...
inline static void DrawBox(const BoundingBox& bounding_box) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSgl_utilsDTh mht_0(mht_0_v, 196, "", "./tensorflow/tools/android/test/jni/object_tracking/gl_utils.h", "DrawBox");
...
inline static void MapWorldSquareToUnitSquare(const BoundingSquare& square) {
   ...
   MHTracer_DTPStensorflowPStoolsPSandroidPStestPSjniPSobject_trackingPSgl_utilsDTh mht_1(mht_1_v, 220, "", "./tensorflow/tools/android/test/jni/object_tracking/gl_utils.h", "MapWorldSquareToUnitSquare");
