...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_op_testDTcc() {
      // Check if tracing is enabled
...
class RenameOpTest : public ::testing::Test {
 protected:
  void TestRenameOp() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_op_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/graph_transforms/rename_op_test.cc", "TestRenameOp");
