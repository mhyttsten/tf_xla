...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attributeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attributeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attributeDTcc() {
      // Check if tracing is enabled
...
Status RenameAttribute(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attributeDTcc mht_0(mht_0_v, 199, "", "./tensorflow/tools/graph_transforms/rename_attribute.cc", "RenameAttribute");
