...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfile_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfile_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfile_utils_testDTcc() {
      // Check if tracing is enabled
...
class FileUtilsTest : public ::testing::Test {
 protected:
  void TestLoadTextOrBinaryGraphFile() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfile_utils_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/tools/graph_transforms/file_utils_test.cc", "TestLoadTextOrBinaryGraphFile");
