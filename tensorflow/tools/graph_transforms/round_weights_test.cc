...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSround_weights_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSround_weights_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSround_weights_testDTcc() {
      // Check if tracing is enabled
...
class RoundWeightsTest : public ::testing::Test {
 protected:
  void TestRoundWeights() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSround_weights_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/graph_transforms/round_weights_test.cc", "TestRoundWeights");
