...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attribute_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attribute_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attribute_testDTcc() {
      // Check if tracing is enabled
...
class RenameAttributeTest : public ::testing::Test {
 protected:
  void TestRenameAttribute() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSrename_attribute_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/graph_transforms/rename_attribute_test.cc", "TestRenameAttribute");
