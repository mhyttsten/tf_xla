...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc() {
      // Check if tracing is enabled
...
const std::vector<QuantizedOpInfo>& GetQuantizedOpList() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_0(mht_0_v, 225, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "GetQuantizedOpList");
...
string UniqueNodeNameFromInput(const string& input_name) {
   ...
   mht_1_v.push_back("input_name: \"" + input_name + "\"");
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_1(mht_1_v, 321, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "UniqueNodeNameFromInput");
...
Status ExtractRangeFromParams(const TransformFuncContext& context,
   ...
   mht_2_v.push_back("min_name: \"" + min_name + "\"");
   mht_2_v.push_back("max_name: \"" + max_name + "\"");
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_2(mht_2_v, 346, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "ExtractRangeFromParams");
...
Status MergeDuplicateNodes(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_3(mht_3_v, 375, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "MergeDuplicateNodes");
...
Status RemoveRedundantQuantizations(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_4(mht_4_v, 447, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "RemoveRedundantQuantizations");
  ...
  TF_RETURN_IF_ERROR(ReplaceMatchingOpTypes(
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_5(mht_5_v, 469, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "lambda");
...
Status QuantizePlaceholders(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_6(mht_6_v, 503, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "QuantizePlaceholders");
...
Status ConvertFakeQuantsToRequantize(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_7(mht_7_v, 586, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "ConvertFakeQuantsToRequantize");
  ...
  TF_RETURN_IF_ERROR(ReplaceMatchingOpTypes(
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_8(mht_8_v, 601, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "lambda");
...
Status MergeAdjacentRequantizes(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_9(mht_9_v, 664, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "MergeAdjacentRequantizes");
  ...
  TF_RETURN_IF_ERROR(ReplaceMatchingOpTypes(
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_10(mht_10_v, 701, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "lambda");
...
Status HoistFakeQuants(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_11(mht_11_v, 740, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "HoistFakeQuants");
...
Status QuantizeNodes(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_12(mht_12_v, 799, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "QuantizeNodes");
  ...
  TF_RETURN_IF_ERROR(ReplaceMatchingOpTypes(
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSquantize_nodesDTcc mht_13(mht_13_v, 909, "", "./tensorflow/tools/graph_transforms/quantize_nodes.cc", "lambda");
