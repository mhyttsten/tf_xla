...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc() {
      // Check if tracing is enabled
...
class FoldBatchNormsTest : public ::testing::Test {
 protected:
  void TestFoldBatchNormsConv2D() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/tools/graph_transforms/fold_batch_norms_test.cc", "TestFoldBatchNormsConv2D");
  ...
  void TestFoldBatchNormsDepthwiseConv2dNative() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc mht_1(mht_1_v, 262, "", "./tensorflow/tools/graph_transforms/fold_batch_norms_test.cc", "TestFoldBatchNormsDepthwiseConv2dNative");
  ...
  void TestFoldBatchNormsConv2DShared() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc mht_2(mht_2_v, 316, "", "./tensorflow/tools/graph_transforms/fold_batch_norms_test.cc", "TestFoldBatchNormsConv2DShared");
  ...
  void TestFoldBatchNormsMatMul() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSfold_batch_norms_testDTcc mht_3(mht_3_v, 377, "", "./tensorflow/tools/graph_transforms/fold_batch_norms_test.cc", "TestFoldBatchNormsMatMul");
