...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_device_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_device_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_device_testDTcc() {
      // Check if tracing is enabled
...
class RemoveDeviceTest : public ::testing::Test {
 protected:
  void TestRemoveDevice() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_device_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/graph_transforms/remove_device_test.cc", "TestRemoveDevice");
