...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSadd_default_attributes_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSadd_default_attributes_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSadd_default_attributes_testDTcc() {
      // Check if tracing is enabled
...
class AddDefaultAttributesTest : public ::testing::Test {
 protected:
  void TestAddDefaultAttributes() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSadd_default_attributes_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/graph_transforms/add_default_attributes_test.cc", "TestAddDefaultAttributes");
