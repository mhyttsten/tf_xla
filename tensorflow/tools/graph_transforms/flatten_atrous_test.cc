...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSflatten_atrous_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSflatten_atrous_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSflatten_atrous_testDTcc() {
      // Check if tracing is enabled
...
class FlattenAtrousConvTest : public ::testing::Test {
 protected:
  ...
  void TestFlattenAtrousConv() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSflatten_atrous_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/tools/graph_transforms/flatten_atrous_test.cc", "TestFlattenAtrousConv");
