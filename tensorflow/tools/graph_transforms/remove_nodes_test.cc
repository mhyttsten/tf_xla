...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc() {
      // Check if tracing is enabled
...
class RemoveNodesTest : public ::testing::Test {
 protected:
  void TestRemoveNodes() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/tools/graph_transforms/remove_nodes_test.cc", "TestRemoveNodes");
  ...
  void TestRemoveOutputNodes() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc mht_1(mht_1_v, 297, "", "./tensorflow/tools/graph_transforms/remove_nodes_test.cc", "TestRemoveOutputNodes");
  ...
  void TestRemoveChainedNodes() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc mht_2(mht_2_v, 339, "", "./tensorflow/tools/graph_transforms/remove_nodes_test.cc", "TestRemoveChainedNodes");
  ...
  void TestRemoveMultipleInputs() {
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_nodes_testDTcc mht_3(mht_3_v, 392, "", "./tensorflow/tools/graph_transforms/remove_nodes_test.cc", "TestRemoveMultipleInputs");
