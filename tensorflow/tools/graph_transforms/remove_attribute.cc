...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_attributeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_attributeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_attributeDTcc() {
      // Check if tracing is enabled
...
Status RemoveAttribute(const GraphDef& input_graph_def,
   ...
   MHTracer_DTPStensorflowPStoolsPSgraph_transformsPSremove_attributeDTcc mht_0(mht_0_v, 200, "", "./tensorflow/tools/graph_transforms/remove_attribute.cc", "RemoveAttribute");
