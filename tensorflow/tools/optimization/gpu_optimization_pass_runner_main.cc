...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSoptimizationPSgpu_optimization_pass_runner_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSgpu_optimization_pass_runner_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSoptimizationPSgpu_optimization_pass_runner_mainDTcc() {
      // Check if tracing is enabled
...
Status RealMain(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSgpu_optimization_pass_runner_mainDTcc mht_0(mht_0_v, 200, "", "./tensorflow/tools/optimization/gpu_optimization_pass_runner_main.cc", "RealMain");
...
int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSgpu_optimization_pass_runner_mainDTcc mht_1(mht_1_v, 253, "", "./tensorflow/tools/optimization/gpu_optimization_pass_runner_main.cc", "main");
