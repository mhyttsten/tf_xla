...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPStoolsPSoptimizationPSoptimization_pass_runnerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSoptimization_pass_runnerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPStoolsPSoptimizationPSoptimization_pass_runnerDTh() {
      // Check if tracing is enabled
...
class OptimizationPassRunner {
 public:
  explicit OptimizationPassRunner() : jit_level_(OptimizerOptions::DEFAULT) {
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSoptimization_pass_runnerDTh mht_0(mht_0_v, 202, "", "./tensorflow/tools/optimization/optimization_pass_runner.h", "OptimizationPassRunner");
}
  ...
  Status AddCpus(int count) {
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSoptimization_pass_runnerDTh mht_1(mht_1_v, 213, "", "./tensorflow/tools/optimization/optimization_pass_runner.h", "AddCpus");
  ...
  Status AddGpus(int count) {
   ...
   MHTracer_DTPStensorflowPStoolsPSoptimizationPSoptimization_pass_runnerDTh mht_2(mht_2_v, 220, "", "./tensorflow/tools/optimization/optimization_pass_runner.h", "AddGpus");
