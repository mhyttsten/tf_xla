...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPStrainingPSquantize_training_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPStrainingPSquantize_training_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPStrainingPSquantize_training_wrapperDTcc() {
      // Check if tracing is enabled
...
static PyObject* DoQuantizeTrainingOnGraphDefHelper(const string& input_graph,
   ...
   mht_0_v.push_back("input_graph: \"" + input_graph + "\"");
   MHTracer_DTPStensorflowPSpythonPStrainingPSquantize_training_wrapperDTcc mht_0(mht_0_v, 195, "", "./tensorflow/python/training/quantize_training_wrapper.cc", "DoQuantizeTrainingOnGraphDefHelper");
