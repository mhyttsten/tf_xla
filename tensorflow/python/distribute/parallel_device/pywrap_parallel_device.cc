...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSdistributePSparallel_devicePSpywrap_parallel_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSdistributePSparallel_devicePSpywrap_parallel_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSdistributePSparallel_devicePSpywrap_parallel_deviceDTcc() {
      // Check if tracing is enabled
...
void CallDelete_Device(PyObject* capsule) {
   ...
   MHTracer_DTPStensorflowPSpythonPSdistributePSparallel_devicePSpywrap_parallel_deviceDTcc mht_0(mht_0_v, 200, "", "./tensorflow/python/distribute/parallel_device/pywrap_parallel_device.cc", "CallDelete_Device");
...
void CallDelete_DeviceInfo(PyObject* capsule) {
   ...
   MHTracer_DTPStensorflowPSpythonPSdistributePSparallel_devicePSpywrap_parallel_deviceDTcc mht_1(mht_1_v, 208, "", "./tensorflow/python/distribute/parallel_device/pywrap_parallel_device.cc", "CallDelete_DeviceInfo");
