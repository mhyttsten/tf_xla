...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSsaved_modelPSpywrap_saved_model_constantsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSsaved_modelPSpywrap_saved_model_constantsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSsaved_modelPSpywrap_saved_model_constantsDTcc() {
      // Check if tracing is enabled
...
void DefineConstantsModule(py::module main_module) {
   ...
   MHTracer_DTPStensorflowPSpythonPSsaved_modelPSpywrap_saved_model_constantsDTcc mht_0(mht_0_v, 194, "", "./tensorflow/python/saved_model/pywrap_saved_model_constants.cc", "DefineConstantsModule");
