...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSclientPStf_session_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSclientPStf_session_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSclientPStf_session_wrapperDTcc() {
      // Check if tracing is enabled
...
TF_Buffer* ProtoStringToTFBuffer(PyObject* input) {
   ...
   MHTracer_DTPStensorflowPSpythonPSclientPStf_session_wrapperDTcc mht_0(mht_0_v, 231, "", "./tensorflow/python/client/tf_session_wrapper.cc", "ProtoStringToTFBuffer");
...
tensorflow::NameVector ConvertPyListToNameVector(
   ...
   MHTracer_DTPStensorflowPSpythonPSclientPStf_session_wrapperDTcc mht_1(mht_1_v, 251, "", "./tensorflow/python/client/tf_session_wrapper.cc", "ConvertPyListToNameVector");
