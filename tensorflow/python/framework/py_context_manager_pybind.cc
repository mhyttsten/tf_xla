...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_manager_pybindDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_manager_pybindDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_manager_pybindDTcc() {
      // Check if tracing is enabled
...
py::handle TestPyContextManager(py::handle context_manager,
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_manager_pybindDTcc mht_0(mht_0_v, 196, "", "./tensorflow/python/framework/py_context_manager_pybind.cc", "TestPyContextManager");
