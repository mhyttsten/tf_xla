...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTcc() {
      // Check if tracing is enabled
...
bool PyContextManager::Enter(PyObject* py_context_manager) {
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTcc mht_0(mht_0_v, 192, "", "./tensorflow/python/framework/py_context_manager.cc", "PyContextManager::Enter");
...
PyContextManager::~PyContextManager() {
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTcc mht_1(mht_1_v, 208, "", "./tensorflow/python/framework/py_context_manager.cc", "PyContextManager::~PyContextManager");
