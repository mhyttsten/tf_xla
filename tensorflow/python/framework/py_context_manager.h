...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTh() {
      // Check if tracing is enabled
...
class PyContextManager {
 public:
  ...
  PyObject* var() {
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpy_context_managerDTh mht_0(mht_0_v, 238, "", "./tensorflow/python/framework/py_context_manager.h", "var");
 return var_.get(); }
