...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_tensor_converterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_tensor_converterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_tensor_converterDTh() {
      // Check if tracing is enabled
...
class PythonTensorConverter {
 public:
  ...
  PythonTensorConverter(PyObject* py_eager_context, TFE_Context* ctx,
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_tensor_converterDTh mht_0(mht_0_v, 219, "", "./tensorflow/python/framework/python_tensor_converter.h", "PythonTensorConverter");
}
