...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSproto_comparatorsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSproto_comparatorsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSproto_comparatorsDTcc() {
      // Check if tracing is enabled
...
bool EqualsGraphDef(string graphdef_string1, string graphdef_string2,
   ...
   mht_0_v.push_back("graphdef_string1: \"" + graphdef_string1 + "\"");
   mht_0_v.push_back("graphdef_string2: \"" + graphdef_string2 + "\"");
   MHTracer_DTPStensorflowPSpythonPSframeworkPSproto_comparatorsDTcc mht_0(mht_0_v, 214, "", "./tensorflow/python/framework/proto_comparators.cc", "EqualsGraphDef");
