...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_api_parameter_converter_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_api_parameter_converter_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_api_parameter_converter_wrapperDTcc() {
      // Check if tracing is enabled
...
PythonAPIInfo::InferredAttributes Convert(
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSpython_api_parameter_converter_wrapperDTcc mht_0(mht_0_v, 199, "", "./tensorflow/python/framework/python_api_parameter_converter_wrapper.cc", "Convert");
