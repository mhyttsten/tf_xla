...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSdtypesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSdtypesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSdtypesDTcc() {
      // Check if tracing is enabled
...
inline int DataTypeId(tensorflow::DataType dt) {
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSdtypesDTcc mht_0(mht_0_v, 192, "", "./tensorflow/python/framework/dtypes.cc", "DataTypeId");
...
const std::string DataTypeStringCompat(tensorflow::DataType dt) {
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSdtypesDTcc mht_1(mht_1_v, 200, "", "./tensorflow/python/framework/dtypes.cc", "DataTypeStringCompat");
...
inline bool DataTypeIsNumPyCompatible(DataType dt) {
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSdtypesDTcc mht_2(mht_2_v, 229, "", "./tensorflow/python/framework/dtypes.cc", "DataTypeIsNumPyCompatible");
