...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSframeworkPSop_def_util_pybindDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSframeworkPSop_def_util_pybindDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSframeworkPSop_def_util_pybindDTcc() {
      // Check if tracing is enabled
...
py::handle ConvertAttr(py::handle value, std::string attr_type) {
   ...
   mht_0_v.push_back("attr_type: \"" + attr_type + "\"");
   MHTracer_DTPStensorflowPSpythonPSframeworkPSop_def_util_pybindDTcc mht_0(mht_0_v, 192, "", "./tensorflow/python/framework/op_def_util_pybind.cc", "ConvertAttr");
...
py::handle SerializedAttrValueToPyObject(std::string attr_value_string) {
   ...
   mht_1_v.push_back("attr_value_string: \"" + attr_value_string + "\"");
   MHTracer_DTPStensorflowPSpythonPSframeworkPSop_def_util_pybindDTcc mht_1(mht_1_v, 207, "", "./tensorflow/python/framework/op_def_util_pybind.cc", "SerializedAttrValueToPyObject");
