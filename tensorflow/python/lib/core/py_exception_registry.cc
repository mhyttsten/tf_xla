...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSlibPScorePSpy_exception_registryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSlibPScorePSpy_exception_registryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSlibPScorePSpy_exception_registryDTcc() {
      // Check if tracing is enabled
...
void PyExceptionRegistry::Init(PyObject* code_to_exc_type_map) {
   ...
   MHTracer_DTPStensorflowPSpythonPSlibPScorePSpy_exception_registryDTcc mht_0(mht_0_v, 196, "", "./tensorflow/python/lib/core/py_exception_registry.cc", "PyExceptionRegistry::Init");
...
PyObject* PyExceptionRegistry::Lookup(TF_Code code) {
   ...
   MHTracer_DTPStensorflowPSpythonPSlibPScorePSpy_exception_registryDTcc mht_1(mht_1_v, 238, "", "./tensorflow/python/lib/core/py_exception_registry.cc", "PyExceptionRegistry::Lookup");
