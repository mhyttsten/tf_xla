...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizer_binding_for_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizer_binding_for_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizer_binding_for_testDTcc() {
      // Check if tracing is enabled
...
class FunctionParameterCanonicalizerWrapper {
 public:
  FunctionParameterCanonicalizerWrapper(absl::Span<const char*> arg_names,
   ...
   MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizer_binding_for_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/python/util/function_parameter_canonicalizer_binding_for_test.cc", "FunctionParameterCanonicalizerWrapper");
}
