...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSutilPStransform_graph_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSutilPStransform_graph_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSutilPStransform_graph_wrapperDTcc() {
      // Check if tracing is enabled
...
string TransformGraphWithStringInputs(string graph_def_string,
   ...
   mht_0_v.push_back("graph_def_string: \"" + graph_def_string + "\"");
   mht_0_v.push_back("inputs_string: \"" + inputs_string + "\"");
   mht_0_v.push_back("outputs_string: \"" + outputs_string + "\"");
   mht_0_v.push_back("transforms_string: \"" + transforms_string + "\"");
   MHTracer_DTPStensorflowPSpythonPSutilPStransform_graph_wrapperDTcc mht_0(mht_0_v, 205, "", "./tensorflow/python/util/transform_graph_wrapper.cc", "TransformGraphWithStringInputs");
