...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizerDTh() {
      // Check if tracing is enabled
...
class FunctionParameterCanonicalizer {
 public:
  ...
  int GetArgSize() const {
   ...
   MHTracer_DTPStensorflowPSpythonPSutilPSfunction_parameter_canonicalizerDTh mht_0(mht_0_v, 207, "", "./tensorflow/python/util/function_parameter_canonicalizer.h", "GetArgSize");
