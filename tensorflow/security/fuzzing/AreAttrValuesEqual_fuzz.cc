...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSsecurityPSfuzzingPSAreAttrValuesEqual_fuzzDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSAreAttrValuesEqual_fuzzDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSsecurityPSfuzzingPSAreAttrValuesEqual_fuzzDTcc() {
      // Check if tracing is enabled
...
tensorflow::AttrValue createAttrValue(T value) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSAreAttrValuesEqual_fuzzDTcc mht_0(mht_0_v, 199, "", "./tensorflow/security/fuzzing/AreAttrValuesEqual_fuzz.cc", "createAttrValue");
...
void compareValues(T value, T value_2) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSAreAttrValuesEqual_fuzzDTcc mht_1(mht_1_v, 210, "", "./tensorflow/security/fuzzing/AreAttrValuesEqual_fuzz.cc", "compareValues");
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSAreAttrValuesEqual_fuzzDTcc mht_2(mht_2_v, 232, "", "./tensorflow/security/fuzzing/AreAttrValuesEqual_fuzz.cc", "LLVMFuzzerTestOneInput");
