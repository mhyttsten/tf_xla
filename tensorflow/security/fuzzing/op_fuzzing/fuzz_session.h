...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh() {
      // Check if tracing is enabled
...
class FuzzSession {
 public:
  FuzzSession() : initialized_(false) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_0(mht_0_v, 236, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "FuzzSession");
}
  virtual ~FuzzSession() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_1(mht_1_v, 240, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "~FuzzSession");
}
  ...
  Status InitIfNeeded() {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_2(mht_2_v, 258, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "InitIfNeeded");
  ...
  void RunInputs(const std::vector<std::pair<string, Tensor> >& inputs) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_3(mht_3_v, 291, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "RunInputs");
  ...
  Status RunInputsWithStatus(
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_4(mht_4_v, 300, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "RunInputsWithStatus");
  ...
  int Fuzz(const uint8_t* data, size_t size) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_5(mht_5_v, 309, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "Fuzz");
...
class FuzzStringInputOp : public FuzzSession {
  void FuzzImpl(const uint8_t* data, size_t size) final {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSfuzz_sessionDTh mht_6(mht_6_v, 332, "", "./tensorflow/security/fuzzing/op_fuzzing/fuzz_session.h", "FuzzImpl");
