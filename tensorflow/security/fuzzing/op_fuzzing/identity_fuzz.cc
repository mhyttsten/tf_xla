...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSidentity_fuzzDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSidentity_fuzzDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSidentity_fuzzDTcc() {
      // Check if tracing is enabled
...
class FuzzIdentity : public FuzzSession {
  ...
  void FuzzImpl(const uint8_t* data, size_t size) final {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSop_fuzzingPSidentity_fuzzDTcc mht_0(mht_0_v, 194, "", "./tensorflow/security/fuzzing/op_fuzzing/identity_fuzz.cc", "FuzzImpl");
