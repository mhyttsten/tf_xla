...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSsecurityPSfuzzingPSstringprintf_fuzzDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSstringprintf_fuzzDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSsecurityPSfuzzingPSstringprintf_fuzzDTcc() {
      // Check if tracing is enabled
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
   ...
   MHTracer_DTPStensorflowPSsecurityPSfuzzingPSstringprintf_fuzzDTcc mht_0(mht_0_v, 195, "", "./tensorflow/security/fuzzing/stringprintf_fuzz.cc", "LLVMFuzzerTestOneInput");
