...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc() {
      // Check if tracing is enabled
...
Output ConstHelper(const Scope& scope, const T& value, DataType dtype) {
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc mht_0(mht_0_v, 193, "", "./tensorflow/cc/ops/const_op.cc", "ConstHelper");
...
Output Const(const Scope& scope, const Input::Initializer& val) {
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc mht_1(mht_1_v, 216, "", "./tensorflow/cc/ops/const_op.cc", "Const");
...
Output ConstFromProto(const Scope& scope, const TensorProto& proto) {
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc mht_2(mht_2_v, 227, "", "./tensorflow/cc/ops/const_op.cc", "ConstFromProto");
...
NodeBuilder::NodeOut AsNodeOut(const Scope& scope, const Input& inp) {
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTcc mht_3(mht_3_v, 234, "", "./tensorflow/cc/ops/const_op.cc", "AsNodeOut");
