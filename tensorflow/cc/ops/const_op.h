...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSopsPSconst_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSopsPSconst_opDTh() {
      // Check if tracing is enabled
...
Output Const(const Scope& scope, const Input::Initializer& val) {
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTh mht_0(mht_0_v, 207, "", "./tensorflow/cc/ops/const_op.h", "Const");
...
Output Const(const Scope& scope, const T& v, const TensorShape shape) {
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTh mht_1(mht_1_v, 241, "", "./tensorflow/cc/ops/const_op.h", "Const");
...
Output Const(const Scope& scope, const std::initializer_list<T>& v,
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_opDTh mht_2(mht_2_v, 250, "", "./tensorflow/cc/ops/const_op.h", "Const");
