...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSopsPSconst_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSopsPSconst_op_testDTcc() {
      // Check if tracing is enabled
...
void ExpectNodeEqual(const Node* n, gtl::ArraySlice<T> values,
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_op_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/cc/ops/const_op_test.cc", "ExpectNodeEqual");
...
void ExpectTypeAndShape(const Node* n, DataType expected_dtype,
   ...
   MHTracer_DTPStensorflowPSccPSopsPSconst_op_testDTcc mht_1(mht_1_v, 211, "", "./tensorflow/cc/ops/const_op_test.cc", "ExpectTypeAndShape");
