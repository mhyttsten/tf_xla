...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh() {
      // Check if tracing is enabled
...
class TensorHandle {
 ...
 private:
  ...
  explicit TensorHandle(TFE_TensorHandle* handle) : handle_(handle) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh mht_0(mht_0_v, 223, "", "./tensorflow/cc/experimental/base/public/tensorhandle.h", "TensorHandle");
}
  ...
  TFE_TensorHandle* GetTFETensorHandle() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh mht_1(mht_1_v, 234, "", "./tensorflow/cc/experimental/base/public/tensorhandle.h", "GetTFETensorHandle");
 return handle_.get(); }

  // Deletes the currently wrapped TFE_TensorHandle, and swaps it with handle,
  // and takes ownership of handle.
  void Reset(TFE_TensorHandle* handle) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh mht_2(mht_2_v, 241, "", "./tensorflow/cc/experimental/base/public/tensorhandle.h", "Reset");
...
inline Tensor TensorHandle::Resolve(Status* status) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh mht_3(mht_3_v, 252, "", "./tensorflow/cc/experimental/base/public/tensorhandle.h", "TensorHandle::Resolve");
...
inline TensorHandle TensorHandle::FromTensor(const Tensor& tensor,
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPStensorhandleDTh mht_4(mht_4_v, 266, "", "./tensorflow/cc/experimental/base/public/tensorhandle.h", "TensorHandle::FromTensor");
