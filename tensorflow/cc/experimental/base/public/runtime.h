...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPSruntimeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPSruntimeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPSruntimeDTh() {
      // Check if tracing is enabled
...
class Runtime {
 ...
 private:
  ...
  explicit Runtime(TFE_Context* ctx) : ctx_(ctx) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPSruntimeDTh mht_0(mht_0_v, 216, "", "./tensorflow/cc/experimental/base/public/runtime.h", "Runtime");
}
  ...
  void Reset(TFE_Context* ctx) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPSruntimeDTh mht_1(mht_1_v, 223, "", "./tensorflow/cc/experimental/base/public/runtime.h", "Reset");
 ctx_.reset(ctx); }
  ...
  TFE_Context* GetTFEContext() const {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSbasePSpublicPSruntimeDTh mht_2(mht_2_v, 230, "", "./tensorflow/cc/experimental/base/public/runtime.h", "GetTFEContext");
 return ctx_.get(); }
