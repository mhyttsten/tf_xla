...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPStestsPStensor_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPStestsPStensor_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPStestsPStensor_testDTcc() {
      // Check if tracing is enabled
...
class UnifiedCAPI
 ...
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPStestsPStensor_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/cc/experimental/libtf/tests/tensor_test.cc", "SetUp");
...
TaggedValue MakeContext(T runtime) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPStestsPStensor_testDTcc mht_1(mht_1_v, 224, "", "./tensorflow/cc/experimental/libtf/tests/tensor_test.cc", "MakeContext");
...
TaggedValue MakeScalarTensor(TaggedValue self, TaggedValue val) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPStestsPStensor_testDTcc mht_2(mht_2_v, 275, "", "./tensorflow/cc/experimental/libtf/tests/tensor_test.cc", "MakeScalarTensor");
