...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh() {
      // Check if tracing is enabled
...
class String final {
 public:
  ...
  String() : String("") {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh mht_0(mht_0_v, 206, "", "./tensorflow/cc/experimental/libtf/impl/string.h", "String");
}
  String(const String& s) : value_(s.value_) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh mht_1(mht_1_v, 210, "", "./tensorflow/cc/experimental/libtf/impl/string.h", "String");
}
  ...
  const std::string& str() const {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh mht_2(mht_2_v, 220, "", "./tensorflow/cc/experimental/libtf/impl/string.h", "str");
 return *value_; }
  ...
  friend H AbslHashValue(H h, const String& s) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSimplPSstringDTh mht_3(mht_3_v, 227, "", "./tensorflow/cc/experimental/libtf/impl/string.h", "AbslHashValue");
