...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc() {
      // Check if tracing is enabled
...
Handle LoadModule(Object self, String saved_model) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc mht_0(mht_0_v, 198, "", "./tensorflow/cc/experimental/libtf/mlir/mlir_transform.cc", "LoadModule");
  ...
  auto get_string = [](Object self) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc mht_1(mht_1_v, 231, "", "./tensorflow/cc/experimental/libtf/mlir/mlir_transform.cc", "lambda");
...
None SaveModule(Object self, Object module, String directory) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc mht_2(mht_2_v, 244, "", "./tensorflow/cc/experimental/libtf/mlir/mlir_transform.cc", "SaveModule");
...
None Transform(Object self, Object module, List passes) {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc mht_3(mht_3_v, 252, "", "./tensorflow/cc/experimental/libtf/mlir/mlir_transform.cc", "Transform");
...
Object MLIR() {
   ...
   MHTracer_DTPStensorflowPSccPSexperimentalPSlibtfPSmlirPSmlir_transformDTcc mht_4(mht_4_v, 260, "", "./tensorflow/cc/experimental/libtf/mlir/mlir_transform.cc", "MLIR");
