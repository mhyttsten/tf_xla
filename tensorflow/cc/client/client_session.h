...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSclientPSclient_sessionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSclientPSclient_sessionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSclientPSclient_sessionDTh() {
      // Check if tracing is enabled
...
class ClientSession {
 ...
 private:
  ...
  Impl* impl() {
   ...
   MHTracer_DTPStensorflowPSccPSclientPSclient_sessionDTh mht_0(mht_0_v, 318, "", "./tensorflow/cc/client/client_session.h", "impl");
 return impl_.get(); }
  const Impl* impl() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSclientPSclient_sessionDTh mht_1(mht_1_v, 322, "", "./tensorflow/cc/client/client_session.h", "impl");
 return impl_.get(); }
};
