...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc() {
      // Check if tracing is enabled
...
class ImageGradTest : public ::testing::Test {
 protected:
  ImageGradTest() : scope_(Scope::NewRootScope()) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/cc/gradients/image_grad_test.cc", "ImageGradTest");
}
  ...
  Tensor MakeData(const TensorShape& data_shape) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_1(mht_1_v, 215, "", "./tensorflow/cc/gradients/image_grad_test.cc", "MakeData");
  ...
  void MakeOp(const OpType op_type, const Tensor& x_data, const Input& y_shape,
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_2(mht_2_v, 231, "", "./tensorflow/cc/gradients/image_grad_test.cc", "MakeOp");
  ...
  void TestResizedShapeForType(const OpType op_type, const bool align_corners,
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_3(mht_3_v, 258, "", "./tensorflow/cc/gradients/image_grad_test.cc", "TestResizedShapeForType");
  ...
  void TestResizedShape(OpType op_type) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_4(mht_4_v, 275, "", "./tensorflow/cc/gradients/image_grad_test.cc", "TestResizedShape");
...
class ScaleAndTranslateGradTest : public ::testing::Test {
 protected:
  ScaleAndTranslateGradTest() : scope_(Scope::NewRootScope()) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_5(mht_5_v, 369, "", "./tensorflow/cc/gradients/image_grad_test.cc", "ScaleAndTranslateGradTest");
}

  template <typename T>
  Tensor MakeData(const TensorShape& data_shape) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_6(mht_6_v, 375, "", "./tensorflow/cc/gradients/image_grad_test.cc", "MakeData");
  ...
  void MakeOp(const Tensor& x_data, const Input& y_shape, Input scale,
   ...
   mht_7_v.push_back("kernel_type: \"" + kernel_type + "\"");
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_7(mht_7_v, 392, "", "./tensorflow/cc/gradients/image_grad_test.cc", "MakeOp");
...
class CropAndResizeGradTest : public ::testing::Test {
 protected:
  CropAndResizeGradTest() : scope_(Scope::NewRootScope()) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_8(mht_8_v, 496, "", "./tensorflow/cc/gradients/image_grad_test.cc", "CropAndResizeGradTest");
}

  template <typename T>
  Tensor MakeData(const TensorShape& data_shape) {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_9(mht_9_v, 502, "", "./tensorflow/cc/gradients/image_grad_test.cc", "MakeData");
  ...
  void MakeOp(const Tensor& x_data, const Input& boxes, const Input& box_ind,
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSimage_grad_testDTcc mht_10(mht_10_v, 517, "", "./tensorflow/cc/gradients/image_grad_test.cc", "MakeOp");
