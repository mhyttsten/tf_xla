...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSgradientsPSfunctional_grad_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSfunctional_grad_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSgradientsPSfunctional_grad_testDTcc() {
      // Check if tracing is enabled
...
class FunctionGradTest : public ::testing::Test {
 protected:
  FunctionGradTest() : scope_(Scope::NewRootScope()) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSfunctional_grad_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/cc/gradients/functional_grad_test.cc", "FunctionGradTest");
}

  void RunTest(const Output& x, const TensorShape& x_shape, const Output& y,
               const TensorShape& y_shape) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSgradientsPSfunctional_grad_testDTcc mht_1(mht_1_v, 209, "", "./tensorflow/cc/gradients/functional_grad_test.cc", "RunTest");
  ...
  void RunTest(const OutputList& xs, const std::vector<TensorShape>& x_shapes,
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSfunctional_grad_testDTcc mht_2(mht_2_v, 223, "", "./tensorflow/cc/gradients/functional_grad_test.cc", "RunTest");
