...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_gradDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_gradDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_gradDTcc() {
      // Check if tracing is enabled
...
Status DynamicPartitionGrad(const Scope& scope, const Operation& op,
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_gradDTcc mht_0(mht_0_v, 215, "", "./tensorflow/cc/gradients/data_flow_grad.cc", "DynamicPartitionGrad");
...
Status DynamicStitchGrad(const Scope& scope, const Operation& op,
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_gradDTcc mht_1(mht_1_v, 283, "", "./tensorflow/cc/gradients/data_flow_grad.cc", "DynamicStitchGrad");
