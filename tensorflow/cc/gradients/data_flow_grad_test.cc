...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_grad_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_grad_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_grad_testDTcc() {
      // Check if tracing is enabled
...
class DataFlowGradTest : public ::testing::Test {
 protected:
  DataFlowGradTest() : scope_(Scope::NewRootScope()) {
   ...
   MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_grad_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/cc/gradients/data_flow_grad_test.cc", "DataFlowGradTest");
}

  void RunTest(const OutputList& xs, const std::vector<TensorShape>& x_shapes,
               const OutputList& ys, const std::vector<TensorShape>& y_shapes) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSgradientsPSdata_flow_grad_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/cc/gradients/data_flow_grad_test.cc", "RunTest");
