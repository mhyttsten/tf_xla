...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc() {
      // Check if tracing is enabled
...
class LoaderTest : public ::testing::Test {
 protected:
  LoaderTest() {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/cc/saved_model/saved_model_bundle_lite_test.cc", "LoaderTest");
}

  string MakeSerializedExample(float x) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc mht_1(mht_1_v, 219, "", "./tensorflow/cc/saved_model/saved_model_bundle_lite_test.cc", "MakeSerializedExample");
  ...
  void ValidateAssets(const string& export_dir,
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc mht_2(mht_2_v, 231, "", "./tensorflow/cc/saved_model/saved_model_bundle_lite_test.cc", "ValidateAssets");
  ...
  void CheckSavedModelBundle(const string& export_dir,
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSsaved_model_bundle_lite_testDTcc mht_3(mht_3_v, 252, "", "./tensorflow/cc/saved_model/saved_model_bundle_lite_test.cc", "CheckSavedModelBundle");
