...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSsignature_def_function_metadataDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSsignature_def_function_metadataDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSsignature_def_function_metadataDTh() {
      // Check if tracing is enabled
...
class SignatureDefFunctionMetadata final {
 ...
 private:
  ...
  static SignatureDefFunctionMetadata* wrap(
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSsignature_def_function_metadataDTh mht_0(mht_0_v, 203, "", "./tensorflow/cc/saved_model/experimental/public/signature_def_function_metadata.h", "wrap");
  ...
  static TF_SignatureDefFunctionMetadata* unwrap(
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSsignature_def_function_metadataDTh mht_1(mht_1_v, 210, "", "./tensorflow/cc/saved_model/experimental/public/signature_def_function_metadata.h", "unwrap");
