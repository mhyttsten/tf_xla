...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_function_listDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_function_listDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_function_listDTh() {
      // Check if tracing is enabled
...
class ConcreteFunctionList {
 ...
 private:
  ...
  explicit ConcreteFunctionList(TF_ConcreteFunctionList* list) : list_(list) {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_function_listDTh mht_0(mht_0_v, 207, "", "./tensorflow/cc/saved_model/experimental/public/concrete_function_list.h", "ConcreteFunctionList");
}
...
inline std::vector<ConcreteFunction*> ConcreteFunctionList::ToVector() {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_function_listDTh mht_1(mht_1_v, 220, "", "./tensorflow/cc/saved_model/experimental/public/concrete_function_list.h", "ConcreteFunctionList::ToVector");
