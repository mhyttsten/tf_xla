...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSfunction_metadataDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSfunction_metadataDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSfunction_metadataDTh() {
      // Check if tracing is enabled
...
class FunctionMetadata final {
 ...
 private:
  ...
  static FunctionMetadata* wrap(TF_FunctionMetadata* p) {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSfunction_metadataDTh mht_0(mht_0_v, 204, "", "./tensorflow/cc/saved_model/experimental/public/function_metadata.h", "wrap");

    return reinterpret_cast<FunctionMetadata*>(p);
  }
  static TF_FunctionMetadata* unwrap(FunctionMetadata* p) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSfunction_metadataDTh mht_1(mht_1_v, 210, "", "./tensorflow/cc/saved_model/experimental/public/function_metadata.h", "unwrap");
