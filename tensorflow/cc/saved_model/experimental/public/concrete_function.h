...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_functionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_functionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_functionDTh() {
      // Check if tracing is enabled
...
class ConcreteFunction final {
 ...
 private:
  ...
  static ConcreteFunction* wrap(TF_ConcreteFunction* p) {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_functionDTh mht_0(mht_0_v, 214, "", "./tensorflow/cc/saved_model/experimental/public/concrete_function.h", "wrap");

    return reinterpret_cast<ConcreteFunction*>(p);
  }
  static TF_ConcreteFunction* unwrap(ConcreteFunction* p) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_functionDTh mht_1(mht_1_v, 220, "", "./tensorflow/cc/saved_model/experimental/public/concrete_function.h", "unwrap");
...
inline const FunctionMetadata* ConcreteFunction::GetFunctionMetadata() {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPSpublicPSconcrete_functionDTh mht_2(mht_2_v, 228, "", "./tensorflow/cc/saved_model/experimental/public/concrete_function.h", "ConcreteFunction::GetFunctionMetadata");
