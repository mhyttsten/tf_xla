...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPStestsPSsaved_model_api_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPStestsPSsaved_model_api_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPStestsPSsaved_model_api_testDTcc() {
      // Check if tracing is enabled
...
std::string SavedModelPath(tensorflow::StringPiece saved_model_dir) {
   ...
   MHTracer_DTPStensorflowPSccPSsaved_modelPSexperimentalPStestsPSsaved_model_api_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/cc/saved_model/experimental/tests/saved_model_api_test.cc", "SavedModelPath");
