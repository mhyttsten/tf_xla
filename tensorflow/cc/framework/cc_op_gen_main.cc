...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSccPSframeworkPScc_op_gen_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSccPSframeworkPScc_op_gen_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSccPSframeworkPScc_op_gen_mainDTcc() {
      // Check if tracing is enabled
...
void PrintAllCCOps(const std::string& dot_h, const std::string& dot_cc,
   ...
   mht_0_v.push_back("dot_h: \"" + dot_h + "\"");
   mht_0_v.push_back("dot_cc: \"" + dot_cc + "\"");
   MHTracer_DTPStensorflowPSccPSframeworkPScc_op_gen_mainDTcc mht_0(mht_0_v, 203, "", "./tensorflow/cc/framework/cc_op_gen_main.cc", "PrintAllCCOps");
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPSccPSframeworkPScc_op_gen_mainDTcc mht_1(mht_1_v, 232, "", "./tensorflow/cc/framework/cc_op_gen_main.cc", "main");
