...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSsleepPSsleep_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSsleepPSsleep_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSsleepPSsleep_opDTcc() {
      // Check if tracing is enabled
...
::tensorflow::Status ScalarOutput(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSsleepPSsleep_opDTcc mht_0(mht_0_v, 198, "", "./tensorflow/examples/custom_ops_doc/sleep/sleep_op.cc", "ScalarOutput");
