...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSmultiplex_4PSmultiplex_4_kernelDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSmultiplex_4PSmultiplex_4_kernelDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSmultiplex_4PSmultiplex_4_kernelDTcc() {
      // Check if tracing is enabled
...
class MultiplexDenseOp : public OpKernel {
 public:
  explicit MultiplexDenseOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSmultiplex_4PSmultiplex_4_kernelDTcc mht_0(mht_0_v, 206, "", "./tensorflow/examples/custom_ops_doc/multiplex_4/multiplex_4_kernel.cc", "MultiplexDenseOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPSexamplesPScustom_ops_docPSmultiplex_4PSmultiplex_4_kernelDTcc mht_1(mht_1_v, 217, "", "./tensorflow/examples/custom_ops_doc/multiplex_4/multiplex_4_kernel.cc", "Compute");
