...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSrecognize_commandsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSrecognize_commandsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSrecognize_commandsDTcc() {
      // Check if tracing is enabled
...
RecognizeCommands::RecognizeCommands(const std::vector<string>& labels,
   ...
   MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSrecognize_commandsDTcc mht_0(mht_0_v, 198, "", "./tensorflow/examples/speech_commands/recognize_commands.cc", "RecognizeCommands::RecognizeCommands");
...
Status RecognizeCommands::ProcessLatestResults(const Tensor& latest_results,
   ...
   MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSrecognize_commandsDTcc mht_1(mht_1_v, 211, "", "./tensorflow/examples/speech_commands/recognize_commands.cc", "RecognizeCommands::ProcessLatestResults");
