...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSaccuracy_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSaccuracy_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSaccuracy_utilsDTh() {
      // Check if tracing is enabled
...
struct StreamingAccuracyStats {
  StreamingAccuracyStats()
   ...
   MHTracer_DTPStensorflowPSexamplesPSspeech_commandsPSaccuracy_utilsDTh mht_0(mht_0_v, 201, "", "./tensorflow/examples/speech_commands/accuracy_utils.h", "StreamingAccuracyStats");
}
