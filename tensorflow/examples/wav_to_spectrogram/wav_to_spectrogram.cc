...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSexamplesPSwav_to_spectrogramPSwav_to_spectrogramDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSexamplesPSwav_to_spectrogramPSwav_to_spectrogramDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSexamplesPSwav_to_spectrogramPSwav_to_spectrogramDTcc() {
      // Check if tracing is enabled
...
tensorflow::Status WavToSpectrogram(const tensorflow::string& input_wav,
   ...
   MHTracer_DTPStensorflowPSexamplesPSwav_to_spectrogramPSwav_to_spectrogramDTcc mht_0(mht_0_v, 215, "", "./tensorflow/examples/wav_to_spectrogram/wav_to_spectrogram.cc", "WavToSpectrogram");
