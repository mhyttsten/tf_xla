...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSeventDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSeventDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSeventDTh() {
      // Check if tracing is enabled
...
class Event {
 public:
  ...
  internal::EventInterface* implementation() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPSstream_executorPSeventDTh mht_0(mht_0_v, 231, "", "./tensorflow/stream_executor/event.h", "implementation");
