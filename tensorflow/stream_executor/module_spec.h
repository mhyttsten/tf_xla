...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh() {
      // Check if tracing is enabled
...
class MultiModuleLoaderSpec {
 public:
  bool has_cuda_cubin_in_memory() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh mht_0(mht_0_v, 201, "", "./tensorflow/stream_executor/module_spec.h", "has_cuda_cubin_in_memory");
 return has_cuda_cubin_in_memory_; }
  ...
  bool has_cuda_ptx_in_memory() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh mht_1(mht_1_v, 210, "", "./tensorflow/stream_executor/module_spec.h", "has_cuda_ptx_in_memory");
 return has_cuda_ptx_in_memory_; }
  const char* cuda_ptx_in_memory() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh mht_2(mht_2_v, 214, "", "./tensorflow/stream_executor/module_spec.h", "cuda_ptx_in_memory");
  ...
  void AddCudaCubinInMemory(port::ArraySlice<const uint8> cubin_bytes) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh mht_3(mht_3_v, 222, "", "./tensorflow/stream_executor/module_spec.h", "AddCudaCubinInMemory");
  ...
  void AddCudaPtxInMemory(const char* ptx) {
   ...
   mht_4_v.push_back("ptx: \"" + (ptx == nullptr ? std::string("nullptr") : std::string((char*)ptx)) + "\"");
   MHTracer_DTPStensorflowPSstream_executorPSmodule_specDTh mht_4(mht_4_v, 232, "", "./tensorflow/stream_executor/module_spec.h", "AddCudaPtxInMemory");
