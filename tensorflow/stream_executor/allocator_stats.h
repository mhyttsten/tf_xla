...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSallocator_statsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSallocator_statsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSallocator_statsDTh() {
      // Check if tracing is enabled
...
struct AllocatorStats {
  ...
  AllocatorStats()
   ...
   MHTracer_DTPStensorflowPSstream_executorPSallocator_statsDTh mht_0(mht_0_v, 225, "", "./tensorflow/stream_executor/allocator_stats.h", "AllocatorStats");
}
