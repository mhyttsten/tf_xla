...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc() {
      // Check if tracing is enabled
...
hipfftType ROCMFftType(fft::Type type) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_0(mht_0_v, 293, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFftType");
...
bool SetStream(GpuExecutor *parent, hipfftHandle plan, Stream *stream) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_1(mht_1_v, 318, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "SetStream");
...
port::Status ROCMFftPlan::Initialize(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_2(mht_2_v, 336, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFftPlan::Initialize");
...
port::Status ROCMFftPlan::Initialize(GpuExecutor *parent, Stream *stream,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_3(mht_3_v, 500, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFftPlan::Initialize");
...
port::Status ROCMFftPlan::UpdateScratchAllocator(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_4(mht_4_v, 512, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFftPlan::UpdateScratchAllocator");
...
ROCMFftPlan::~ROCMFftPlan() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_5(mht_5_v, 534, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFftPlan::~ROCMFftPlan");
 wrap::hipfftDestroy(parent_, plan_); }

int ROCMFftPlan::GetFftDirection() const {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_6(mht_6_v, 539, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFftPlan::GetFftDirection");
...
std::unique_ptr<fft::Plan> ROCMFft::Create1dPlan(Stream *stream, uint64_t num_x,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_7(mht_7_v, 565, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::Create1dPlan");
...
std::unique_ptr<fft::Plan> ROCMFft::Create1dPlanWithScratchAllocator(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_8(mht_8_v, 584, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::Create1dPlanWithScratchAllocator");
...
std::unique_ptr<fft::Plan> ROCMFft::Create2dPlan(Stream *stream, uint64_t num_x,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_9(mht_9_v, 602, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::Create2dPlan");
...
std::unique_ptr<fft::Plan> ROCMFft::Create2dPlanWithScratchAllocator(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_10(mht_10_v, 619, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::Create2dPlanWithScratchAllocator");
...
std::unique_ptr<fft::Plan> ROCMFft::Create3dPlan(Stream *stream, uint64_t num_x,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_11(mht_11_v, 638, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::Create3dPlan");
...
std::unique_ptr<fft::Plan> ROCMFft::Create3dPlanWithScratchAllocator(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_12(mht_12_v, 655, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::Create3dPlanWithScratchAllocator");
...
std::unique_ptr<fft::Plan> ROCMFft::CreateBatchedPlan(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_13(mht_13_v, 675, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::CreateBatchedPlan");
...
std::unique_ptr<fft::Plan> ROCMFft::CreateBatchedPlanWithScratchAllocator(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_14(mht_14_v, 696, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::CreateBatchedPlanWithScratchAllocator");
...
void ROCMFft::UpdatePlanWithScratchAllocator(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_15(mht_15_v, 714, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "ROCMFft::UpdatePlanWithScratchAllocator");
...
void initialize_rocfft() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_fftDTcc mht_16(mht_16_v, 834, "", "./tensorflow/stream_executor/rocm/rocm_fft.cc", "initialize_rocfft");
