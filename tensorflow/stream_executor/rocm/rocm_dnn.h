...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh() {
      // Check if tracing is enabled
...
class MIOpenSupport : public dnn::DnnSupport {
 public:
  ...
  bool DoConvolveQuantized(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh mht_0(mht_0_v, 544, "", "./tensorflow/stream_executor/rocm/rocm_dnn.h", "DoConvolveQuantized");
  ...
  bool DoConvolveQuantized(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh mht_1(mht_1_v, 560, "", "./tensorflow/stream_executor/rocm/rocm_dnn.h", "DoConvolveQuantized");
  ...
  bool DoSeparableConvolve(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh mht_2(mht_2_v, 576, "", "./tensorflow/stream_executor/rocm/rocm_dnn.h", "DoSeparableConvolve");
  ...
  bool DoMatMulQuantized(Stream* stream, const DeviceMemory<float>& input_data,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh mht_3(mht_3_v, 595, "", "./tensorflow/stream_executor/rocm/rocm_dnn.h", "DoMatMulQuantized");
  ...
  bool DoMatMulQuantized(Stream* stream, const DeviceMemory<float>& input_data,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh mht_4(mht_4_v, 608, "", "./tensorflow/stream_executor/rocm/rocm_dnn.h", "DoMatMulQuantized");
  ...
  GpuExecutor* GetParentExecutor() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSrocmPSrocm_dnnDTh mht_5(mht_5_v, 829, "", "./tensorflow/stream_executor/rocm/rocm_dnn.h", "GetParentExecutor");
 return parent_; }
