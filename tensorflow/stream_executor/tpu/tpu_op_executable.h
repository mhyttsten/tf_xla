...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_op_executableDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_op_executableDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_op_executableDTh() {
      // Check if tracing is enabled
...
class TpuOpExecutable : public xla::TpuExecutableInterface {
 public:
  ...
  const XLA_TpuProgram* core_program() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_op_executableDTh mht_0(mht_0_v, 216, "", "./tensorflow/stream_executor/tpu/tpu_op_executable.h", "core_program");
 return core_program_; }
