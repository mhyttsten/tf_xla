...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_node_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_node_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_node_contextDTh() {
      // Check if tracing is enabled
...
class TpuNodeContext final {
 public:
  ...
  explicit TpuNodeContext(int device_ordinal, XLA_TpuNodeContext* node_context)
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_node_contextDTh mht_0(mht_0_v, 220, "", "./tensorflow/stream_executor/tpu/tpu_node_context.h", "TpuNodeContext");
