...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPSproto_helperDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSproto_helperDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPSproto_helperDTh() {
      // Check if tracing is enabled
...
inline SerializedProto SerializeProto(const ProtoType& proto) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSproto_helperDTh mht_0(mht_0_v, 222, "", "./tensorflow/stream_executor/tpu/proto_helper.h", "SerializeProto");
...
inline void SerializedProto_Free(const SerializedProtoType& serialized_proto) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSproto_helperDTh mht_1(mht_1_v, 246, "", "./tensorflow/stream_executor/tpu/proto_helper.h", "SerializedProto_Free");
