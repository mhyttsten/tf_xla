...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPSc_api_defnDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSc_api_defnDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPSc_api_defnDTh() {
      // Check if tracing is enabled
...
struct SE_Stream {
  explicit SE_Stream(stream_executor::StreamExecutor* parent)
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSc_api_defnDTh mht_0(mht_0_v, 213, "", "./tensorflow/stream_executor/tpu/c_api_defn.h", "SE_Stream");
}
...
struct SE_Event {
  explicit SE_Event(stream_executor::StreamExecutor* parent) : event(parent) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSc_api_defnDTh mht_1(mht_1_v, 221, "", "./tensorflow/stream_executor/tpu/c_api_defn.h", "SE_Event");
}
...
struct SE_Timer {
  explicit SE_Timer(stream_executor::StreamExecutor* parent) : timer(parent) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPSc_api_defnDTh mht_2(mht_2_v, 229, "", "./tensorflow/stream_executor/tpu/c_api_defn.h", "SE_Timer");
}
