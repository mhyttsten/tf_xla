...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_platform_interfaceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_platform_interfaceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_platform_interfaceDTcc() {
      // Check if tracing is enabled
...
TpuPlatformInterface* GetRegisteredPlatformStatic(bool initialize_platform,
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_platform_interfaceDTcc mht_0(mht_0_v, 198, "", "./tensorflow/stream_executor/tpu/tpu_platform_interface.cc", "GetRegisteredPlatformStatic");
...
TpuPlatformInterface* TpuPlatformInterface::GetRegisteredPlatform(
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_platform_interfaceDTcc mht_1(mht_1_v, 259, "", "./tensorflow/stream_executor/tpu/tpu_platform_interface.cc", "TpuPlatformInterface::GetRegisteredPlatform");
