...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executable_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executable_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executable_interfaceDTh() {
      // Check if tracing is enabled
...
class TpuExecutableInterface : public Executable {
 public:
  explicit TpuExecutableInterface(std::shared_ptr<HloModule> hlo_module)
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executable_interfaceDTh mht_0(mht_0_v, 213, "", "./tensorflow/stream_executor/tpu/tpu_executable_interface.h", "TpuExecutableInterface");
}
