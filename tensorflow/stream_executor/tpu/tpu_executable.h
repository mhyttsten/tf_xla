...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh() {
      // Check if tracing is enabled
...
class TpuExecutable : public xla::TpuExecutableInterface {
 public:
  TpuExecutable(SE_Executable* se_executable,
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh mht_0(mht_0_v, 198, "", "./tensorflow/stream_executor/tpu/tpu_executable.h", "TpuExecutable");
}
 ...
 private:
  Status LoadProgramAndEnqueueToStream(
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh mht_1(mht_1_v, 225, "", "./tensorflow/stream_executor/tpu/tpu_executable.h", "LoadProgramAndEnqueueToStream");
  ...
  Shape HostShapeToDeviceShape(const Shape& host_shape) override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh mht_2(mht_2_v, 232, "", "./tensorflow/stream_executor/tpu/tpu_executable.h", "HostShapeToDeviceShape");
  ...
  int64_t ShapeSize(const Shape& shape) override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPStpuPStpu_executableDTh mht_3(mht_3_v, 239, "", "./tensorflow/stream_executor/tpu/tpu_executable.h", "ShapeSize");
