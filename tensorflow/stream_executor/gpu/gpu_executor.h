...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh() {
      // Check if tracing is enabled
...
class XLAInterface {
 public:
  ...
  explicit XLAInterface() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_0(mht_0_v, 223, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "XLAInterface");
}

  // Default destructor for the abstract interface.
  virtual ~XLAInterface() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_1(mht_1_v, 229, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "~XLAInterface");
}
};
...
class GpuExecutor : public internal::StreamExecutorInterface {
  ...
  class Object {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_2(mht_2_v, 242, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "~Concept");
}
    };
    template <typename T>
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_3(mht_3_v, 249, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "Model");
}
      T object;
    };
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_4(mht_4_v, 258, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "getOrCreate");
 ...
 public:
  ...
  explicit GpuExecutor(const PluginConfig& plugin_config)
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_5(mht_5_v, 284, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "GpuExecutor");
}
  ...
  void* UnifiedMemoryAllocate(uint64_t size) override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_6(mht_6_v, 334, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "UnifiedMemoryAllocate");
  ...
  void UnifiedMemoryDeallocate(void* location) override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_7(mht_7_v, 341, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "UnifiedMemoryDeallocate");
  ...
  void* HostMemoryAllocate(uint64_t size) override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_8(mht_8_v, 352, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "HostMemoryAllocate");
  ...
  void HostMemoryDeallocate(void* location) override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_9(mht_9_v, 359, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "HostMemoryDeallocate");
  ...
  int PlatformDeviceCount() override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_10(mht_10_v, 435, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "PlatformDeviceCount");
 return GpuDriver::GetDeviceCount(); }
  ...
  T* getOrCreateXLAState(StreamExecutor* se) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_11(mht_11_v, 500, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "getOrCreateXLAState");
...
inline GpuExecutor* ExtractGpuExecutor(StreamExecutor* stream_exec) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_executorDTh mht_12(mht_12_v, 624, "", "./tensorflow/stream_executor/gpu/gpu_executor.h", "ExtractGpuExecutor");
