...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh() {
      // Check if tracing is enabled
...
class GpuTimer : public internal::TimerInterface {
 public:
  explicit GpuTimer(GpuExecutor* parent)
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh mht_0(mht_0_v, 207, "", "./tensorflow/stream_executor/gpu/gpu_timer.h", "GpuTimer");
}
  ...
  ~GpuTimer() override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh mht_1(mht_1_v, 215, "", "./tensorflow/stream_executor/gpu/gpu_timer.h", "~GpuTimer");
}
  ...
  uint64_t Microseconds() const override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh mht_2(mht_2_v, 240, "", "./tensorflow/stream_executor/gpu/gpu_timer.h", "Microseconds");
  ...
  uint64_t Nanoseconds() const override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_timerDTh mht_3(mht_3_v, 248, "", "./tensorflow/stream_executor/gpu/gpu_timer.h", "Nanoseconds");
