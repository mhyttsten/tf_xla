...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh() {
      // Check if tracing is enabled
...
const T* GpuMemory(const DeviceMemory<T>& mem) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh mht_0(mht_0_v, 210, "", "./tensorflow/stream_executor/gpu/gpu_helpers.h", "GpuMemory");
...
T* GpuMemoryMutable(DeviceMemory<T>* mem) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh mht_1(mht_1_v, 220, "", "./tensorflow/stream_executor/gpu/gpu_helpers.h", "GpuMemoryMutable");
...
inline const typename GpuComplexT<T>::type* GpuComplex(const T* p) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh mht_2(mht_2_v, 261, "", "./tensorflow/stream_executor/gpu/gpu_helpers.h", "GpuComplex");
...
inline typename GpuComplexT<T>::type* GpuComplex(T* p) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh mht_3(mht_3_v, 272, "", "./tensorflow/stream_executor/gpu/gpu_helpers.h", "GpuComplex");
...
inline GpuComplexType GpuComplexValue(std::complex<float> val) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh mht_4(mht_4_v, 284, "", "./tensorflow/stream_executor/gpu/gpu_helpers.h", "GpuComplexValue");
...
inline GpuDoubleComplexType GpuComplexValue(std::complex<double> val) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSgpu_helpersDTh mht_5(mht_5_v, 291, "", "./tensorflow/stream_executor/gpu/gpu_helpers.h", "GpuComplexValue");
