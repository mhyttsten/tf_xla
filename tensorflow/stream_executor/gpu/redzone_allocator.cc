...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc() {
      // Check if tracing is enabled
...
static T RoundUpToNearest(T value, T divisor) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_0(mht_0_v, 207, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "RoundUpToNearest");
...
RedzoneAllocator::RedzoneAllocator(Stream* stream,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_1(mht_1_v, 233, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "RedzoneAllocator::RedzoneAllocator");
}

port::StatusOr<DeviceMemory<uint8>> RedzoneAllocator::AllocateBytes(
    int64_t byte_size) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_2(mht_2_v, 239, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "RedzoneAllocator::AllocateBytes");
...
static void RunRedzoneChecker(Stream* stream,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_3(mht_3_v, 397, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "RunRedzoneChecker");
...
static port::Status ReinitializeRedzone(Stream* stream,
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_4(mht_4_v, 420, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "ReinitializeRedzone");
...
port::StatusOr<RedzoneCheckStatus> RedzoneAllocator::CheckRedzones() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_5(mht_5_v, 486, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "RedzoneAllocator::CheckRedzones");
...
std::string RedzoneCheckStatus::RedzoneFailureMsg() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSgpuPSredzone_allocatorDTcc mht_6(mht_6_v, 540, "", "./tensorflow/stream_executor/gpu/redzone_allocator.cc", "RedzoneCheckStatus::RedzoneFailureMsg");
