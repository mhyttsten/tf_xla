...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_versionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_versionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_versionDTcc() {
      // Check if tracing is enabled
...
bool IsSourceCompatibleWithCudnnLibrary(CudnnVersion source_version,
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_versionDTcc mht_0(mht_0_v, 191, "", "./tensorflow/stream_executor/cuda/cudnn_version.cc", "IsSourceCompatibleWithCudnnLibrary");
