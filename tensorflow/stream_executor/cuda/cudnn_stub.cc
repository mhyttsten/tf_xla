...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_stubDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_stubDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_stubDTcc() {
      // Check if tracing is enabled
...
void* GetDsoHandle() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_stubDTcc mht_0(mht_0_v, 192, "", "./tensorflow/stream_executor/cuda/cudnn_stub.cc", "GetDsoHandle");
...
T LoadSymbol(const char* symbol_name) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_stubDTcc mht_1(mht_1_v, 210, "", "./tensorflow/stream_executor/cuda/cudnn_stub.cc", "LoadSymbol");
...
cudnnStatus_t GetSymbolNotFoundError() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSstream_executorPScudaPScudnn_stubDTcc mht_2(mht_2_v, 223, "", "./tensorflow/stream_executor/cuda/cudnn_stub.cc", "GetSymbolNotFoundError");
