...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc() {
      // Check if tracing is enabled
...
const DeviceOptions GetDeviceOptionsFromEnv() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_0(mht_0_v, 210, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "GetDeviceOptionsFromEnv");
...
CudaPlatform::CudaPlatform()
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_1(mht_1_v, 242, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::CudaPlatform");
}

CudaPlatform::~CudaPlatform() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_2(mht_2_v, 247, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::~CudaPlatform");
}
...
void CudaPlatform::InspectNumaNodes() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_3(mht_3_v, 255, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::InspectNumaNodes");
...
int CudaPlatform::BusCount() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_4(mht_4_v, 280, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::BusCount");
...
int CudaPlatform::DeviceToBus(int device_ordinal) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_5(mht_5_v, 288, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::DeviceToBus");
...
port::StatusOr<StreamExecutor*> CudaPlatform::FirstExecutorForBus(
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_6(mht_6_v, 297, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::FirstExecutorForBus");
...
Platform::Id CudaPlatform::id() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_7(mht_7_v, 314, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::id");
 return cuda::kCudaPlatformId; }

int CudaPlatform::VisibleDeviceCount() const {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_8(mht_8_v, 319, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::VisibleDeviceCount");
...
const std::string& CudaPlatform::Name() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_9(mht_9_v, 332, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::Name");
 return name_; }

port::StatusOr<std::unique_ptr<DeviceDescription>>
CudaPlatform::DescriptionForDevice(int ordinal) const {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_10(mht_10_v, 338, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::DescriptionForDevice");
...
port::StatusOr<StreamExecutor*> CudaPlatform::ExecutorForDevice(int ordinal) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_11(mht_11_v, 345, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::ExecutorForDevice");
...
port::StatusOr<StreamExecutor*> CudaPlatform::ExecutorForDeviceWithPluginConfig(
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_12(mht_12_v, 357, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::ExecutorForDeviceWithPluginConfig");
...
port::StatusOr<StreamExecutor*> CudaPlatform::GetExecutor(
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_13(mht_13_v, 369, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::GetExecutor");
...
CudaPlatform::GetUncachedExecutor(const StreamExecutorConfig& config) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_14(mht_14_v, 378, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::GetUncachedExecutor");
...
void CudaPlatform::RegisterTraceListener(
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_15(mht_15_v, 398, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::RegisterTraceListener");
...
void CudaPlatform::UnregisterTraceListener(TraceListener* listener) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_16(mht_16_v, 405, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "CudaPlatform::UnregisterTraceListener");
...
static void InitializeCudaPlatform() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPScudaPScuda_platformDTcc mht_17(mht_17_v, 414, "", "./tensorflow/stream_executor/cuda/cuda_platform.cc", "InitializeCudaPlatform");
