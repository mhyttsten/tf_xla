...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSpluginDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSpluginDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSpluginDTh() {
      // Check if tracing is enabled
...
class PluginConfig {
 public:
  ...
  PluginId blas() const {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSpluginDTh mht_0(mht_0_v, 245, "", "./tensorflow/stream_executor/plugin.h", "blas");
 return blas_; }
  PluginId dnn() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSstream_executorPSpluginDTh mht_1(mht_1_v, 249, "", "./tensorflow/stream_executor/plugin.h", "dnn");
 return dnn_; }
  PluginId fft() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPSstream_executorPSpluginDTh mht_2(mht_2_v, 253, "", "./tensorflow/stream_executor/plugin.h", "fft");
 return fft_; }
  PluginId rng() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPSstream_executorPSpluginDTh mht_3(mht_3_v, 257, "", "./tensorflow/stream_executor/plugin.h", "rng");
 return rng_; }
