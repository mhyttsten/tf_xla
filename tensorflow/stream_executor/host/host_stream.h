...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPShostPShost_streamDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPShostPShost_streamDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPShostPShost_streamDTh() {
      // Check if tracing is enabled
...
class HostStream : public internal::StreamInterface {
 public:
  ...
  void* GpuStreamHack() override {
   ...
   MHTracer_DTPStensorflowPSstream_executorPShostPShost_streamDTh mht_0(mht_0_v, 217, "", "./tensorflow/stream_executor/host/host_stream.h", "GpuStreamHack");
 return nullptr; }
  void** GpuStreamMemberHack() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSstream_executorPShostPShost_streamDTh mht_1(mht_1_v, 221, "", "./tensorflow/stream_executor/host/host_stream.h", "GpuStreamMemberHack");
 return nullptr; }
