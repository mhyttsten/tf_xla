...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPShostPShost_timerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPShostPShost_timerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPShostPShost_timerDTh() {
      // Check if tracing is enabled
...
class HostTimer : public internal::TimerInterface {
 public:
  HostTimer() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPShostPShost_timerDTh mht_0(mht_0_v, 197, "", "./tensorflow/stream_executor/host/host_timer.h", "HostTimer");
}
  ~HostTimer() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSstream_executorPShostPShost_timerDTh mht_1(mht_1_v, 201, "", "./tensorflow/stream_executor/host/host_timer.h", "~HostTimer");
}
