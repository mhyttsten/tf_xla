...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc() {
      // Check if tracing is enabled
...
port::StatusOr<StreamExecutor*> ExecutorCache::GetOrCreate(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc mht_0(mht_0_v, 194, "", "./tensorflow/stream_executor/executor_cache.cc", "ExecutorCache::GetOrCreate");
...
port::StatusOr<StreamExecutor*> ExecutorCache::Get(
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc mht_1(mht_1_v, 239, "", "./tensorflow/stream_executor/executor_cache.cc", "ExecutorCache::Get");
...
void ExecutorCache::DestroyAllExecutors() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc mht_2(mht_2_v, 274, "", "./tensorflow/stream_executor/executor_cache.cc", "ExecutorCache::DestroyAllExecutors");
...
ExecutorCache::Entry::~Entry() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTcc mht_3(mht_3_v, 282, "", "./tensorflow/stream_executor/executor_cache.cc", "ExecutorCache::Entry::~Entry");
