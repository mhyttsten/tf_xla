...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTh() {
      // Check if tracing is enabled
...
class ExecutorCache {
 public:
  ExecutorCache() {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSexecutor_cacheDTh mht_0(mht_0_v, 202, "", "./tensorflow/stream_executor/executor_cache.h", "ExecutorCache");
}
