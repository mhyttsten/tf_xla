...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSlibPShuman_readableDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSlibPShuman_readableDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSlibPShuman_readableDTh() {
      // Check if tracing is enabled
...
class HumanReadableNumBytes {
 public:
  static std::string ToString(int64_t num_bytes) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSlibPShuman_readableDTh mht_0(mht_0_v, 200, "", "./tensorflow/stream_executor/lib/human_readable.h", "ToString");
 ...
 private:
  ...
  static const char* GetNegStr(T* value) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSlibPShuman_readableDTh mht_1(mht_1_v, 233, "", "./tensorflow/stream_executor/lib/human_readable.h", "GetNegStr");
