...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPSlibPSpathDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPSlibPSpathDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPSlibPSpathDTh() {
      // Check if tracing is enabled
...
inline std::string JoinPath(const T&... args) {
   ...
   MHTracer_DTPStensorflowPSstream_executorPSlibPSpathDTh mht_0(mht_0_v, 219, "", "./tensorflow/stream_executor/lib/path.h", "JoinPath");
