...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSstream_executorPStimerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSstream_executorPStimerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSstream_executorPStimerDTh() {
      // Check if tracing is enabled
...
class Timer {
 public:
  ...
  internal::TimerInterface *implementation() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPSstream_executorPStimerDTh mht_0(mht_0_v, 226, "", "./tensorflow/stream_executor/timer.h", "implementation");
