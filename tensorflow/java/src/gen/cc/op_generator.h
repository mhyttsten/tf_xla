...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_generatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_generatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_generatorDTh() {
      // Check if tracing is enabled
...
class OpGenerator {
 public:
  explicit OpGenerator(const std::vector<string>& api_dirs,
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_generatorDTh mht_0(mht_0_v, 210, "", "./tensorflow/java/src/gen/cc/op_generator.h", "OpGenerator");
}
