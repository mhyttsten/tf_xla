...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_gen_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_gen_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_gen_mainDTcc() {
      // Check if tracing is enabled
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSgenPSccPSop_gen_mainDTcc mht_0(mht_0_v, 221, "", "./tensorflow/java/src/gen/cc/op_gen_main.cc", "main");
