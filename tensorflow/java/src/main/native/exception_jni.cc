...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSexception_jniDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSexception_jniDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSexception_jniDTcc() {
      // Check if tracing is enabled
...
void throwException(JNIEnv* env, const char* clazz, const char* fmt, ...) {
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSexception_jniDTcc mht_0(mht_0_v, 201, "", "./tensorflow/java/src/main/native/exception_jni.cc", "throwException");
...
const char* exceptionClassName(TF_Code code) {
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSexception_jniDTcc mht_1(mht_1_v, 222, "", "./tensorflow/java/src/main/native/exception_jni.cc", "exceptionClassName");
...
bool throwExceptionIfNotOK(JNIEnv* env, const TF_Status* status) {
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSexception_jniDTcc mht_2(mht_2_v, 247, "", "./tensorflow/java/src/main/native/exception_jni.cc", "throwExceptionIfNotOK");
