...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSeager_session_jniDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSeager_session_jniDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSeager_session_jniDTcc() {
      // Check if tracing is enabled
...
JNIEXPORT void JNICALL Java_org_tensorflow_EagerSession_delete(JNIEnv* env,
   ...
   MHTracer_DTPStensorflowPSjavaPSsrcPSmainPSnativePSeager_session_jniDTcc mht_0(mht_0_v, 230, "", "./tensorflow/java/src/main/native/eager_session_jni.cc", "Java_org_tensorflow_EagerSession_delete");
