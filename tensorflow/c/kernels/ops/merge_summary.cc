...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSkernelsPSopsPSmerge_summaryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPSmerge_summaryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSkernelsPSopsPSmerge_summaryDTcc() {
      // Check if tracing is enabled
...
void Register_MergeSummaryOp() {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPSmerge_summaryDTcc mht_0(mht_0_v, 198, "", "./tensorflow/c/kernels/ops/merge_summary.cc", "Register_MergeSummaryOp");
...
TF_ATTRIBUTE_UNUSED static bool MergeSummaryOpRegistered = []() {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPSmerge_summaryDTcc mht_1(mht_1_v, 218, "", "./tensorflow/c/kernels/ops/merge_summary.cc", "lambda");
