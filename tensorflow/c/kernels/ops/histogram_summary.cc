...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSkernelsPSopsPShistogram_summaryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPShistogram_summaryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSkernelsPSopsPShistogram_summaryDTcc() {
      // Check if tracing is enabled
...
void Register_HistogramSummaryOp() {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPShistogram_summaryDTcc mht_0(mht_0_v, 196, "", "./tensorflow/c/kernels/ops/histogram_summary.cc", "Register_HistogramSummaryOp");
...
TF_ATTRIBUTE_UNUSED static bool HistogramSummaryOpRegistered = []() {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPShistogram_summaryDTcc mht_1(mht_1_v, 217, "", "./tensorflow/c/kernels/ops/histogram_summary.cc", "lambda");
