...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSkernelsPSopsPSsummaryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPSsummaryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSkernelsPSopsPSsummaryDTcc() {
      // Check if tracing is enabled
...
void Register_ScalarSummaryOp() {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPSsummaryDTcc mht_0(mht_0_v, 199, "", "./tensorflow/c/kernels/ops/summary.cc", "Register_ScalarSummaryOp");
...
TF_ATTRIBUTE_UNUSED static bool SummaryScalarOpRegistered = []() {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSopsPSsummaryDTcc mht_1(mht_1_v, 220, "", "./tensorflow/c/kernels/ops/summary.cc", "lambda");
