...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSkernelsPSsummary_op_benchmark_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSsummary_op_benchmark_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSkernelsPSsummary_op_benchmark_testDTcc() {
      // Check if tracing is enabled
...
Graph* BM_ScalarSummaryOp(TensorShape shape, std::string tag, float value) {
   ...
   MHTracer_DTPStensorflowPScPSkernelsPSsummary_op_benchmark_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/c/kernels/summary_op_benchmark_test.cc", "BM_ScalarSummaryOp");
