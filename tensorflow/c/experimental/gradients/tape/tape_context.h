...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSgradientsPStapePStape_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSgradientsPStapePStape_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSgradientsPStapePStape_contextDTh() {
      // Check if tracing is enabled
...
class TapeContext : public AbstractContext {
 public:
  ...
  static bool classof(const AbstractContext* ptr) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSgradientsPStapePStape_contextDTh mht_0(mht_0_v, 200, "", "./tensorflow/c/experimental/gradients/tape/tape_context.h", "classof");
