...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScommonPSpath_configDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScommonPSpath_configDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScommonPSpath_configDTcc() {
      // Check if tracing is enabled
...
PathConfig::PathConfig(const string& output_dir, const string& source_dir,
   ...
   mht_0_v.push_back("source_dir: \"" + source_dir + "\"");
   mht_0_v.push_back("api_dir_list: \"" + api_dir_list + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScommonPSpath_configDTcc mht_0(mht_0_v, 199, "", "./tensorflow/c/experimental/ops/gen/common/path_config.cc", "PathConfig::PathConfig");
