...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScppPSrenderersPSop_rendererDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScppPSrenderersPSop_rendererDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScppPSrenderersPSop_rendererDTcc() {
      // Check if tracing is enabled
...
string OpRenderer::Signature() const {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScppPSrenderersPSop_rendererDTcc mht_0(mht_0_v, 194, "", "./tensorflow/c/experimental/ops/gen/cpp/renderers/op_renderer.cc", "OpRenderer::Signature");
...
OpRenderer::OpRenderer(RendererContext context, OpView op)
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScppPSrenderersPSop_rendererDTcc mht_1(mht_1_v, 225, "", "./tensorflow/c/experimental/ops/gen/cpp/renderers/op_renderer.cc", "OpRenderer::OpRenderer");
}

void OpRenderer::Render() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPScppPSrenderersPSop_rendererDTcc mht_2(mht_2_v, 230, "", "./tensorflow/c/experimental/ops/gen/cpp/renderers/op_renderer.cc", "OpRenderer::Render");
