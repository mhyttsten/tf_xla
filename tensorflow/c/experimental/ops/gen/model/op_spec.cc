...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPSmodelPSop_specDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPSmodelPSop_specDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPSmodelPSop_specDTcc() {
      // Check if tracing is enabled
...
OpSpec OpSpec::Create(const OpDef& op_def, const ApiDef& api_def) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPSmodelPSop_specDTcc mht_0(mht_0_v, 193, "", "./tensorflow/c/experimental/ops/gen/model/op_spec.cc", "OpSpec::Create");
...
OpSpec::OpSpec(const OpDef& op_def, const ApiDef& api_def)
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSopsPSgenPSmodelPSop_specDTcc mht_1(mht_1_v, 203, "", "./tensorflow/c/experimental/ops/gen/model/op_spec.cc", "OpSpec::OpSpec");
