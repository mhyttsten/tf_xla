...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsaved_model_api_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsaved_model_api_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsaved_model_api_testDTcc() {
      // Check if tracing is enabled
...
std::string SavedModelPath(tensorflow::StringPiece saved_model_dir) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsaved_model_api_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/c/experimental/saved_model/internal/saved_model_api_test.cc", "SavedModelPath");
