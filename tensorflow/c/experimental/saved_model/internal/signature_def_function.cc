...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsignature_def_functionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsignature_def_functionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsignature_def_functionDTcc() {
      // Check if tracing is enabled
...
TF_SignatureDefFunctionMetadata* TF_SignatureDefFunctionGetMetadata(
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsignature_def_functionDTcc mht_0(mht_0_v, 202, "", "./tensorflow/c/experimental/saved_model/internal/signature_def_function.cc", "TF_SignatureDefFunctionGetMetadata");
...
TFE_Op* TF_SignatureDefFunctionMakeCallOp(TF_SignatureDefFunction* func,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPSinternalPSsignature_def_functionDTcc mht_1(mht_1_v, 212, "", "./tensorflow/c/experimental/saved_model/internal/signature_def_function.cc", "TF_SignatureDefFunctionMakeCallOp");
