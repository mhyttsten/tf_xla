...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc() {
      // Check if tracing is enabled
...
Variable::Variable(ImmediateExecutionContext* ctx, DataType dtype,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_0(mht_0_v, 208, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::Variable");
}

Variable::~Variable() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_1(mht_1_v, 213, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::~Variable");
...
DataType Variable::dtype() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_2(mht_2_v, 230, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::dtype");
 return dtype_; }

TensorShape Variable::shape() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_3(mht_3_v, 235, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::shape");
 return shape_; }

Status Variable::Assign(ImmediateExecutionTensorHandle* handle) {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_4(mht_4_v, 240, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::Assign");
...
Status Variable::ReadValue(ImmediateTensorHandlePtr* out) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_5(mht_5_v, 247, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::ReadValue");
...
Status Variable::CreateUninitialized(
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSvariableDTcc mht_6(mht_6_v, 259, "", "./tensorflow/c/experimental/saved_model/core/revived_types/variable.cc", "Variable::CreateUninitialized");
