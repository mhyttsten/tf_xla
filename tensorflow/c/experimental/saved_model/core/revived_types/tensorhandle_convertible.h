...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPStensorhandle_convertibleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPStensorhandle_convertibleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPStensorhandle_convertibleDTh() {
      // Check if tracing is enabled
...
class TensorHandleConvertible {
 public:
  explicit TensorHandleConvertible(ImmediateTensorHandlePtr handle)
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPStensorhandle_convertibleDTh mht_0(mht_0_v, 200, "", "./tensorflow/c/experimental/saved_model/core/revived_types/tensorhandle_convertible.h", "TensorHandleConvertible");
}

  ImmediateExecutionTensorHandle* handle() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPStensorhandle_convertibleDTh mht_1(mht_1_v, 205, "", "./tensorflow/c/experimental/saved_model/core/revived_types/tensorhandle_convertible.h", "handle");
 return handle_.get(); }
