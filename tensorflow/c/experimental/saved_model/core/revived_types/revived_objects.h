...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSrevived_objectsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSrevived_objectsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSrevived_objectsDTh() {
      // Check if tracing is enabled
...
class RevivedObjectContainer {
 public:
  ...
  void Insert(std::unique_ptr<T> object) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSrevived_objectsDTh mht_0(mht_0_v, 217, "", "./tensorflow/c/experimental/saved_model/core/revived_types/revived_objects.h", "Insert");
  ...
  void Insert(std::unique_ptr<T> object, int node_id) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSrevived_objectsDTh mht_1(mht_1_v, 225, "", "./tensorflow/c/experimental/saved_model/core/revived_types/revived_objects.h", "Insert");
  ...
  T* Find(int node_id) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSrevived_typesPSrevived_objectsDTh mht_2(mht_2_v, 235, "", "./tensorflow/c/experimental/saved_model/core/revived_types/revived_objects.h", "Find");
