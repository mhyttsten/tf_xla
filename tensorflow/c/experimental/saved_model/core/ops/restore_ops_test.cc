...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_ops_testDTcc() {
      // Check if tracing is enabled
...
std::string CheckpointPrefix(StringPiece saved_model_dir) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_ops_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/c/experimental/saved_model/core/ops/restore_ops_test.cc", "CheckpointPrefix");
...
class RestoreOpsTest : public ::testing::Test {
 public:
  RestoreOpsTest()
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_ops_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/c/experimental/saved_model/core/ops/restore_ops_test.cc", "RestoreOpsTest");
}

  EagerContext* context() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_ops_testDTcc mht_2(mht_2_v, 219, "", "./tensorflow/c/experimental/saved_model/core/ops/restore_ops_test.cc", "context");
 return ctx_.get(); }
