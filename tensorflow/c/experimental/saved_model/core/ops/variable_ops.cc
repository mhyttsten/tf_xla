...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc() {
      // Check if tracing is enabled
...
Status CreateUninitializedResourceVariable(ImmediateExecutionContext* ctx,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc mht_0(mht_0_v, 209, "", "./tensorflow/c/experimental/saved_model/core/ops/variable_ops.cc", "CreateUninitializedResourceVariable");
...
Status AssignVariable(ImmediateExecutionContext* ctx,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc mht_1(mht_1_v, 245, "", "./tensorflow/c/experimental/saved_model/core/ops/variable_ops.cc", "AssignVariable");
...
Status ReadVariable(ImmediateExecutionContext* ctx,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc mht_2(mht_2_v, 262, "", "./tensorflow/c/experimental/saved_model/core/ops/variable_ops.cc", "ReadVariable");
...
Status DestroyResource(ImmediateExecutionContext* ctx,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSvariable_opsDTcc mht_3(mht_3_v, 285, "", "./tensorflow/c/experimental/saved_model/core/ops/variable_ops.cc", "DestroyResource");
