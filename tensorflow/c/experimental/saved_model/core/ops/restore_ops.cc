...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_opsDTcc() {
      // Check if tracing is enabled
...
Status CreateStringScalarTensorHandle(ImmediateExecutionContext* ctx,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_opsDTcc mht_0(mht_0_v, 207, "", "./tensorflow/c/experimental/saved_model/core/ops/restore_ops.cc", "CreateStringScalarTensorHandle");
...
Status CreateStringVectorTensorHandle(ImmediateExecutionContext* ctx,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_opsDTcc mht_1(mht_1_v, 225, "", "./tensorflow/c/experimental/saved_model/core/ops/restore_ops.cc", "CreateStringVectorTensorHandle");
...
Status SingleRestore(ImmediateExecutionContext* ctx, const std::string& prefix,
   ...
   mht_2_v.push_back("checkpoint_key: \"" + checkpoint_key + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSopsPSrestore_opsDTcc mht_2(mht_2_v, 250, "", "./tensorflow/c/experimental/saved_model/core/ops/restore_ops.cc", "SingleRestore");
