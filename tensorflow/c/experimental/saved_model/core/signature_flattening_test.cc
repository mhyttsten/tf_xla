...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSsignature_flattening_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSsignature_flattening_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSsignature_flattening_testDTcc() {
      // Check if tracing is enabled
...
bool TensorSpecsAreEqual(const TensorSpecProto& spec,
   ...
   mht_0_v.push_back("expected_name: \"" + expected_name + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSsaved_modelPScorePSsignature_flattening_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/c/experimental/saved_model/core/signature_flattening_test.cc", "TensorSpecsAreEqual");
