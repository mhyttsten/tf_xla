...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc() {
      // Check if tracing is enabled
...
class ModularFileSystemTest : public ::testing::TestWithParam<std::string> {
 public:
  ...
  ModularFileSystemTest() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_0(mht_0_v, 251, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "ModularFileSystemTest");
  ...
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_1(mht_1_v, 279, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "SetUp");
  ...
  std::string GetURIForPath(StringPiece path) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_2(mht_2_v, 307, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "GetURIForPath");
  ...
  StringPiece GetRelativePath(StringPiece absolute_path) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_3(mht_3_v, 320, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "GetRelativePath");
  ...
  static void InitializeTestRNG() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_4(mht_4_v, 328, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "InitializeTestRNG");
  ...
  static void SetCloudPath(const std::string& cloud_path) {
   ...
   mht_5_v.push_back("cloud_path: \"" + cloud_path + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_5(mht_5_v, 339, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "SetCloudPath");
  ...
  static void SetTmpDir(const std::string& tmp_dir) {
   ...
   mht_6_v.push_back("tmp_dir: \"" + tmp_dir + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_6(mht_6_v, 348, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "SetTmpDir");
...
bool UnimplementedOrReturnsCode(Status actual_status, Code expected_code) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_7(mht_7_v, 371, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "UnimplementedOrReturnsCode");
...
static std::vector<std::string>* SchemeVector() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_8(mht_8_v, 1895, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "SchemeVector");
...
static std::vector<std::string>* GetSchemesFromUserOrEnv() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_9(mht_9_v, 1913, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "GetSchemesFromUserOrEnv");
  ...
  if (status.ok()) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_10(mht_10_v, 1924, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "lambda");
...
static bool LoadDSO(const std::string& dso) {
   ...
   mht_11_v.push_back("dso: \"" + dso + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_11(mht_11_v, 1950, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "LoadDSO");
...
static bool GetURIScheme(const std::string& scheme) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_12(mht_12_v, 1967, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "GetURIScheme");
...
static bool SetCloudPath(const std::string& cloud_path_) {
   ...
   mht_13_v.push_back("cloud_path_: \"" + cloud_path_ + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_13(mht_13_v, 1980, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "SetCloudPath");
...
static bool SetTmpDir(const std::string& tmp_dir_) {
   ...
   mht_14_v.push_back("tmp_dir_: \"" + tmp_dir_ + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_14(mht_14_v, 1989, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "SetTmpDir");
...
GTEST_API_ int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSmodular_filesystem_testDTcc mht_15(mht_15_v, 2004, "", "./tensorflow/c/experimental/filesystem/modular_filesystem_test.cc", "main");
