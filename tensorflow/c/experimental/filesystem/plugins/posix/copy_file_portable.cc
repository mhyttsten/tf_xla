...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSposixPScopy_file_portableDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSposixPScopy_file_portableDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSposixPScopy_file_portableDTcc() {
      // Check if tracing is enabled
...
int CopyFileContents(int dst_fd, int src_fd, off_t size) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSposixPScopy_file_portableDTcc mht_0(mht_0_v, 196, "", "./tensorflow/c/experimental/filesystem/plugins/posix/copy_file_portable.cc", "CopyFileContents");
