...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSram_file_block_cache_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSram_file_block_cache_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSram_file_block_cache_testDTcc() {
      // Check if tracing is enabled
...
Status ReadCache(tf_gcs_filesystem::RamFileBlockCache* cache,
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSram_file_block_cache_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/ram_file_block_cache_test.cc", "ReadCache");
...
TEST(RamFileBlockCacheTest, ParallelReads) {
  ...
  for (int i = 0; i < callers; i++) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSram_file_block_cache_testDTcc mht_1(mht_1_v, 699, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/ram_file_block_cache_test.cc", "lambda");
