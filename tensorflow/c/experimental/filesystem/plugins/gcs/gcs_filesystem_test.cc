...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc() {
      // Check if tracing is enabled
...
static std::string InitializeTmpDir() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "InitializeTmpDir");
...
static std::string* GetTmpDir() {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_1(mht_1_v, 231, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "GetTmpDir");
...
class GCSFilesystemTest : public ::testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_2(mht_2_v, 250, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_3(mht_3_v, 263, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "TearDown");
  ...
  std::string GetURIForPath(absl::string_view path) {
   ...
   mht_4_v.push_back("path: \"" + std::string(path.data(), path.size()) + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_4(mht_4_v, 274, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "GetURIForPath");
  ...
  void WriteString(const std::string& path, const std::string& content) {
   ...
   mht_5_v.push_back("content: \"" + content + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_5(mht_5_v, 312, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "WriteString");
  ...
  std::string ReadAll(const std::string& path) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_6(mht_6_v, 328, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "ReadAll");
...
::testing::AssertionResult WriteToServer(const std::string& path, size_t offset,
   ...
   mht_7_v.push_back("path: \"" + path + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_7(mht_7_v, 367, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "WriteToServer");
...
::testing::AssertionResult InsertObject(const std::string& path,
   ...
   mht_8_v.push_back("path: \"" + path + "\"");
   mht_8_v.push_back("content: \"" + content + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_8(mht_8_v, 392, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "InsertObject");
...
::testing::AssertionResult CompareSubString(int64_t offset, size_t length,
   ...
   mht_9_v.push_back("result: \"" + std::string(result.data(), result.size()) + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_9(mht_9_v, 410, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "CompareSubString");
...
::testing::AssertionResult CompareWithServer(const std::string& path,
   ...
   mht_10_v.push_back("path: \"" + path + "\"");
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_10(mht_10_v, 429, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "CompareWithServer");
...
GTEST_API_ int main(int argc, char** argv) {
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSpluginsPSgcsPSgcs_filesystem_testDTcc mht_11(mht_11_v, 872, "", "./tensorflow/c/experimental/filesystem/plugins/gcs/gcs_filesystem_test.cc", "main");
