...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSfilesystem_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSfilesystem_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSfilesystem_interfaceDTh() {
      // Check if tracing is enabled
...
static inline void TF_SetFilesystemVersionMetadata(
   ...
   MHTracer_DTPStensorflowPScPSexperimentalPSfilesystemPSfilesystem_interfaceDTh mht_0(mht_0_v, 1254, "", "./tensorflow/c/experimental/filesystem/filesystem_interface.h", "TF_SetFilesystemVersionMetadata");
