...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_operationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_operationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_operationDTh() {
      // Check if tracing is enabled
...
class ImmediateExecutionOperation : public AbstractOperation {
 public:
  ...
  static bool classof(const AbstractOperation* ptr) {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_operationDTh mht_0(mht_0_v, 247, "", "./tensorflow/c/eager/immediate_execution_operation.h", "classof");
 ...
 protected:
  explicit ImmediateExecutionOperation(AbstractOperationKind kind)
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_operationDTh mht_1(mht_1_v, 256, "", "./tensorflow/c/eager/immediate_execution_operation.h", "ImmediateExecutionOperation");
}
  ~ImmediateExecutionOperation() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_operationDTh mht_2(mht_2_v, 260, "", "./tensorflow/c/eager/immediate_execution_operation.h", "~ImmediateExecutionOperation");
}
};
