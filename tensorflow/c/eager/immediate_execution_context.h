...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_contextDTh() {
      // Check if tracing is enabled
...
class ImmediateExecutionContext : public AbstractContext {
 public:
  ...
  static bool classof(const AbstractContext* ptr) {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_contextDTh mht_0(mht_0_v, 330, "", "./tensorflow/c/eager/immediate_execution_context.h", "classof");
 ...
 protected:
  explicit ImmediateExecutionContext(AbstractContextKind kind)
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_contextDTh mht_1(mht_1_v, 431, "", "./tensorflow/c/eager/immediate_execution_context.h", "ImmediateExecutionContext");
}
  ~ImmediateExecutionContext() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_contextDTh mht_2(mht_2_v, 435, "", "./tensorflow/c/eager/immediate_execution_context.h", "~ImmediateExecutionContext");
}
};
