...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSabstract_tensor_handleDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_tensor_handleDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSabstract_tensor_handleDTh() {
      // Check if tracing is enabled
...
class AbstractTensorHandle : public core::RefCounted {
 protected:
  ...
  explicit AbstractTensorHandle(AbstractTensorHandleKind kind) : kind_(kind) {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_tensor_handleDTh mht_0(mht_0_v, 201, "", "./tensorflow/c/eager/abstract_tensor_handle.h", "AbstractTensorHandle");
}
  ~AbstractTensorHandle() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScPSeagerPSabstract_tensor_handleDTh mht_1(mht_1_v, 205, "", "./tensorflow/c/eager/abstract_tensor_handle.h", "~AbstractTensorHandle");
}
 ...
 public:
  ...
  AbstractTensorHandleKind getKind() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScPSeagerPSabstract_tensor_handleDTh mht_2(mht_2_v, 226, "", "./tensorflow/c/eager/abstract_tensor_handle.h", "getKind");
 return kind_; }
