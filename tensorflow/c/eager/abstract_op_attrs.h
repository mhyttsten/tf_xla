...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSabstract_op_attrsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_op_attrsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSabstract_op_attrsDTh() {
      // Check if tracing is enabled
...
class AbstractOpAttrs {
 protected:
  ...
  explicit AbstractOpAttrs(AbstractOpAttrsKind kind) : kind_(kind) {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_op_attrsDTh mht_0(mht_0_v, 198, "", "./tensorflow/c/eager/abstract_op_attrs.h", "AbstractOpAttrs");
}

 public:
  // Returns which subclass is this instance of.
  AbstractOpAttrsKind getKind() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScPSeagerPSabstract_op_attrsDTh mht_1(mht_1_v, 205, "", "./tensorflow/c/eager/abstract_op_attrs.h", "getKind");
 return kind_; }
