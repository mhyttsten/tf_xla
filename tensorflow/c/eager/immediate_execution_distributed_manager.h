...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_distributed_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_distributed_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_distributed_managerDTh() {
      // Check if tracing is enabled
...
class ImmediateExecutionDistributedManager {
 public:
  virtual ~ImmediateExecutionDistributedManager() {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_distributed_managerDTh mht_0(mht_0_v, 201, "", "./tensorflow/c/eager/immediate_execution_distributed_manager.h", "~ImmediateExecutionDistributedManager");
}
