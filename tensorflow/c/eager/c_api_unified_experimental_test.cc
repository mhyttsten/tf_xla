...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSc_api_unified_experimental_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSc_api_unified_experimental_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSc_api_unified_experimental_testDTcc() {
      // Check if tracing is enabled
...
class UnifiedCAPI
 ...
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSc_api_unified_experimental_testDTcc mht_0(mht_0_v, 213, "", "./tensorflow/c/eager/c_api_unified_experimental_test.cc", "SetUp");
