...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSabstract_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSabstract_contextDTh() {
      // Check if tracing is enabled
...
class AbstractContext {
 protected:
  ...
  explicit AbstractContext(AbstractContextKind kind) : kind_(kind) {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_contextDTh mht_0(mht_0_v, 205, "", "./tensorflow/c/eager/abstract_context.h", "AbstractContext");
}
  virtual ~AbstractContext() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScPSeagerPSabstract_contextDTh mht_1(mht_1_v, 209, "", "./tensorflow/c/eager/abstract_context.h", "~AbstractContext");
}

 public:
  AbstractContextKind getKind() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScPSeagerPSabstract_contextDTh mht_2(mht_2_v, 215, "", "./tensorflow/c/eager/abstract_context.h", "getKind");
 return kind_; }
