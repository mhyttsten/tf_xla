...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_test_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_test_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_test_utilDTcc() {
      // Check if tracing is enabled
...
string MatMulFunction(const string& matmul_device) {
   ...
   mht_0_v.push_back("matmul_device: \"" + matmul_device + "\"");
   MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_test_utilDTcc mht_0(mht_0_v, 199, "", "./tensorflow/c/eager/c_api_remote_test_util.cc", "MatMulFunction");
...
void TestRemoteExecuteSilentCopies(bool async, bool remote, bool func,
   ...
   MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_test_utilDTcc mht_1(mht_1_v, 245, "", "./tensorflow/c/eager/c_api_remote_test_util.cc", "TestRemoteExecuteSilentCopies");
