...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_tensor_handleDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_tensor_handleDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_tensor_handleDTcc() {
      // Check if tracing is enabled
...
std::string ImmediateExecutionTensorHandle::DebugString() const {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_tensor_handleDTcc mht_0(mht_0_v, 189, "", "./tensorflow/c/eager/immediate_execution_tensor_handle.cc", "ImmediateExecutionTensorHandle::DebugString");
...
Status ImmediateExecutionTensorHandle::SummarizeValue(
   ...
   MHTracer_DTPStensorflowPScPSeagerPSimmediate_execution_tensor_handleDTcc mht_1(mht_1_v, 220, "", "./tensorflow/c/eager/immediate_execution_tensor_handle.cc", "ImmediateExecutionTensorHandle::SummarizeValue");
