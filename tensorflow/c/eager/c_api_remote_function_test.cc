...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_function_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_function_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_function_testDTcc() {
      // Check if tracing is enabled
...
void TestRemoteExecuteSilentCopiesFunc(bool async, bool remote,
   ...
   MHTracer_DTPStensorflowPScPSeagerPSc_api_remote_function_testDTcc mht_0(mht_0_v, 193, "", "./tensorflow/c/eager/c_api_remote_function_test.cc", "TestRemoteExecuteSilentCopiesFunc");
