...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPSeagerPSabstract_functionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_functionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPSeagerPSabstract_functionDTh() {
      // Check if tracing is enabled
...
class AbstractFunction : public core::RefCounted {
 protected:
  ...
  explicit AbstractFunction(AbstractFunctionKind kind) : kind_(kind) {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_functionDTh mht_0(mht_0_v, 200, "", "./tensorflow/c/eager/abstract_function.h", "AbstractFunction");
}
 ...
 public:
  ...
  AbstractFunctionKind getKind() const {
   ...
   MHTracer_DTPStensorflowPScPSeagerPSabstract_functionDTh mht_1(mht_1_v, 207, "", "./tensorflow/c/eager/abstract_function.h", "getKind");
 return kind_; }
