...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScPStf_status_helperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScPStf_status_helperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScPStf_status_helperDTcc() {
      // Check if tracing is enabled
...
void Set_TF_Status_from_Status(TF_Status* tf_status, const Status& status) {
   ...
   MHTracer_DTPStensorflowPScPStf_status_helperDTcc mht_0(mht_0_v, 192, "", "./tensorflow/c/tf_status_helper.cc", "Set_TF_Status_from_Status");
...
Status StatusFromTF_Status(const TF_Status* tf_status) {
   ...
   MHTracer_DTPStensorflowPScPStf_status_helperDTcc mht_1(mht_1_v, 259, "", "./tensorflow/c/tf_status_helper.cc", "StatusFromTF_Status");
