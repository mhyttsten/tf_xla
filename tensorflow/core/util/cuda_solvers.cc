...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc() {
      // Check if tracing is enabled
...
inline bool CopyHostToDevice(OpKernelContext* context, void* dst,
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_0(mht_0_v, 273, "", "./tensorflow/core/util/cuda_solvers.cc", "CopyHostToDevice");
...
struct GpuSolverHandles {
  explicit GpuSolverHandles(cudaStream_t stream) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_1(mht_1_v, 285, "", "./tensorflow/core/util/cuda_solvers.cc", "GpuSolverHandles");
  ...
  ~GpuSolverHandles() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_2(mht_2_v, 300, "", "./tensorflow/core/util/cuda_solvers.cc", "~GpuSolverHandles");
...
HandleMap* GetHandleMapSingleton() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_3(mht_3_v, 320, "", "./tensorflow/core/util/cuda_solvers.cc", "GetHandleMapSingleton");
...
GpuSolver::~GpuSolver() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_4(mht_4_v, 373, "", "./tensorflow/core/util/cuda_solvers.cc", "GpuSolver::~GpuSolver");
...
void GpuSolver::CheckLapackInfoAndDeleteSolverAsync(
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_5(mht_5_v, 387, "", "./tensorflow/core/util/cuda_solvers.cc", "GpuSolver::CheckLapackInfoAndDeleteSolverAsync");
  ...
  auto wrapped_info_checker_callback =
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_6(mht_6_v, 418, "", "./tensorflow/core/util/cuda_solvers.cc", "lambda");
...
void GpuSolver::CheckLapackInfoAndDeleteSolverAsync(
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_7(mht_7_v, 464, "", "./tensorflow/core/util/cuda_solvers.cc", "GpuSolver::CheckLapackInfoAndDeleteSolverAsync");
  ...
  auto wrapped_done = [context, done](
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_8(mht_8_v, 471, "", "./tensorflow/core/util/cuda_solvers.cc", "lambda");
...
Status GpuSolver::allocate_scoped_tensor(DataType type,
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_9(mht_9_v, 491, "", "./tensorflow/core/util/cuda_solvers.cc", "GpuSolver::allocate_scoped_tensor");
...
Status GpuSolver::forward_input_or_allocate_scoped_tensor(
   ...
   MHTracer_DTPStensorflowPScorePSutilPScuda_solversDTcc mht_10(mht_10_v, 504, "", "./tensorflow/core/util/cuda_solvers.cc", "GpuSolver::forward_input_or_allocate_scoped_tensor");
