...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc() {
      // Check if tracing is enabled
...
TensorSliceReaderCacheWrapper::TensorSliceReaderCacheWrapper() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/util/tensor_slice_reader_cache.cc", "TensorSliceReaderCacheWrapper::TensorSliceReaderCacheWrapper");
}
TensorSliceReaderCacheWrapper::~TensorSliceReaderCacheWrapper() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc mht_1(mht_1_v, 199, "", "./tensorflow/core/util/tensor_slice_reader_cache.cc", "TensorSliceReaderCacheWrapper::~TensorSliceReaderCacheWrapper");
...
const TensorSliceReader* TensorSliceReaderCacheWrapper::GetReader(
   ...
   mht_2_v.push_back("filepattern: \"" + filepattern + "\"");
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc mht_2(mht_2_v, 211, "", "./tensorflow/core/util/tensor_slice_reader_cache.cc", "TensorSliceReaderCacheWrapper::GetReader");
...
TensorSliceReaderCache::TensorSliceReaderCache() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc mht_3(mht_3_v, 223, "", "./tensorflow/core/util/tensor_slice_reader_cache.cc", "TensorSliceReaderCache::TensorSliceReaderCache");
}

TensorSliceReaderCache::~TensorSliceReaderCache() {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc mht_4(mht_4_v, 228, "", "./tensorflow/core/util/tensor_slice_reader_cache.cc", "TensorSliceReaderCache::~TensorSliceReaderCache");
...
const TensorSliceReader* TensorSliceReaderCache::GetReader(
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_reader_cacheDTcc mht_5(mht_5_v, 240, "", "./tensorflow/core/util/tensor_slice_reader_cache.cc", "TensorSliceReaderCache::GetReader");
