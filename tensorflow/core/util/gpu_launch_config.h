...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh() {
      // Check if tracing is enabled
...
inline int DivUp(int a, int b) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh mht_0(mht_0_v, 278, "", "./tensorflow/core/util/gpu_launch_config.h", "DivUp");
 return (a + b - 1) / b; }
...
inline GpuLaunchConfig GetGpuLaunchConfig(int work_element_count,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh mht_1(mht_1_v, 300, "", "./tensorflow/core/util/gpu_launch_config.h", "GetGpuLaunchConfig");
...
GpuLaunchConfig GetGpuLaunchConfigFixedBlockSize(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh mht_2(mht_2_v, 369, "", "./tensorflow/core/util/gpu_launch_config.h", "GetGpuLaunchConfigFixedBlockSize");
...
inline Gpu2DLaunchConfig GetGpu2DLaunchConfig(int xdim, int ydim,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh mht_3(mht_3_v, 405, "", "./tensorflow/core/util/gpu_launch_config.h", "GetGpu2DLaunchConfig");
...
Gpu3DLaunchConfig GetGpu3DLaunchConfig(int xdim, int ydim, int zdim,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh mht_4(mht_4_v, 452, "", "./tensorflow/core/util/gpu_launch_config.h", "GetGpu3DLaunchConfig");
...
Gpu2DLaunchConfig GetGpu2DLaunchConfig(int xdim, int ydim,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSgpu_launch_configDTh mht_5(mht_5_v, 531, "", "./tensorflow/core/util/gpu_launch_config.h", "GetGpu2DLaunchConfig");
