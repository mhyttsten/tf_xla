...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSconv_autotune_mapsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSconv_autotune_mapsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSconv_autotune_mapsDTh() {
      // Check if tracing is enabled
...
struct ConvAutotuneGroup {
  static string name() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSconv_autotune_mapsDTh mht_0(mht_0_v, 211, "", "./tensorflow/core/util/autotune_maps/conv_autotune_maps.h", "name");
 return "Conv"; }
};
...
struct ConvFusedAutotuneGroup {
  static string name() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSconv_autotune_mapsDTh mht_1(mht_1_v, 222, "", "./tensorflow/core/util/autotune_maps/conv_autotune_maps.h", "name");
 return "FusedConv"; }
};
