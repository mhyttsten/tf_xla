...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSautotune_maps_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSautotune_maps_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSautotune_maps_utilsDTcc() {
      // Check if tracing is enabled
...
std::string DeviceIdToIdentifier(int device_id) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSautotune_maps_utilsDTcc mht_0(mht_0_v, 245, "", "./tensorflow/core/util/autotune_maps/autotune_maps_utils.cc", "DeviceIdToIdentifier");
...
std::string SerializeProtoDeterministic(const protobuf::Message& proto) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSautotune_maps_utilsDTcc mht_1(mht_1_v, 257, "", "./tensorflow/core/util/autotune_maps/autotune_maps_utils.cc", "SerializeProtoDeterministic");
...
uint64 HashProto(const protobuf::Message& proto) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSautotune_mapsPSautotune_maps_utilsDTcc mht_2(mht_2_v, 271, "", "./tensorflow/core/util/autotune_maps/autotune_maps_utils.cc", "HashProto");
