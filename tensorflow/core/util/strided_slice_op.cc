...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc() {
      // Check if tracing is enabled
...
static Status TF_MUST_USE_RESULT BuildDenseSpec(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc mht_0(mht_0_v, 250, "", "./tensorflow/core/util/strided_slice_op.cc", "BuildDenseSpec");
...
Status ValidateStridedSliceOp(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc mht_1(mht_1_v, 350, "", "./tensorflow/core/util/strided_slice_op.cc", "ValidateStridedSliceOp");
  ...
  *is_simple_slice = true;
  ...
  for (int i = 0; i < input_shape.dims(); ++i) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc mht_2(mht_2_v, 470, "", "./tensorflow/core/util/strided_slice_op.cc", "lambda");
...
Status ValidateStridedSliceOp(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSstrided_slice_opDTcc mht_3(mht_3_v, 608, "", "./tensorflow/core/util/strided_slice_op.cc", "ValidateStridedSliceOp");
