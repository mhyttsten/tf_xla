...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSguarded_philox_randomDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSguarded_philox_randomDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSguarded_philox_randomDTh() {
      // Check if tracing is enabled
...
class GuardedPhiloxRandom {
 public:
  ...
  GuardedPhiloxRandom() : initialized_(false) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSguarded_philox_randomDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/util/guarded_philox_random.h", "GuardedPhiloxRandom");
}
  ...
  random::PhiloxRandom ReserveSamples32(int64_t samples) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSguarded_philox_randomDTh mht_1(mht_1_v, 233, "", "./tensorflow/core/util/guarded_philox_random.h", "ReserveSamples32");
  ...
  random::PhiloxRandom ReserveRandomOutputs(int64_t output_count,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSguarded_philox_randomDTh mht_2(mht_2_v, 242, "", "./tensorflow/core/util/guarded_philox_random.h", "ReserveRandomOutputs");
