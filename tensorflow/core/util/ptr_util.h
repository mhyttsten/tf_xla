...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSptr_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSptr_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSptr_utilDTh() {
      // Check if tracing is enabled
...
typename helper::MakeUniqueResult<T>::scalar MakeUnique(Args&&... args) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSptr_utilDTh mht_0(mht_0_v, 235, "", "./tensorflow/core/util/ptr_util.h", "MakeUnique");
...
typename helper::MakeUniqueResult<T>::array MakeUnique(size_t n) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSptr_utilDTh mht_1(mht_1_v, 246, "", "./tensorflow/core/util/ptr_util.h", "MakeUnique");
