...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc() {
      // Check if tracing is enabled
...
inline bool CopyHostToDevice(OpKernelContext* context, void* dst,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_0(mht_0_v, 235, "", "./tensorflow/core/util/rocm_solvers.cc", "CopyHostToDevice");
...
struct GpuSolverHandles {
  explicit GpuSolverHandles(GpuExecutor* parent, hipStream_t stream) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_1(mht_1_v, 245, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolverHandles");
  ...
  ~GpuSolverHandles() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_2(mht_2_v, 263, "", "./tensorflow/core/util/rocm_solvers.cc", "~GpuSolverHandles");
...
HandleMap* GetHandleMapSingleton() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_3(mht_3_v, 288, "", "./tensorflow/core/util/rocm_solvers.cc", "GetHandleMapSingleton");
...
GpuSolver::GpuSolver(OpKernelContext* context) : context_(context) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_4(mht_4_v, 300, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolver::GpuSolver");
...
GpuSolver::~GpuSolver() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_5(mht_5_v, 331, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolver::~GpuSolver");
...
void GpuSolver::CheckLapackInfoAndDeleteSolverAsync(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_6(mht_6_v, 345, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolver::CheckLapackInfoAndDeleteSolverAsync");
  ...
  auto wrapped_info_checker_callback =
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_7(mht_7_v, 376, "", "./tensorflow/core/util/rocm_solvers.cc", "lambda");
...
void GpuSolver::CheckLapackInfoAndDeleteSolverAsync(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_8(mht_8_v, 422, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolver::CheckLapackInfoAndDeleteSolverAsync");
  ...
  auto wrapped_done = [context, done](
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_9(mht_9_v, 429, "", "./tensorflow/core/util/rocm_solvers.cc", "lambda");
...
Status GpuSolver::allocate_scoped_tensor(DataType type,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_10(mht_10_v, 911, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolver::allocate_scoped_tensor");
...
Status GpuSolver::forward_input_or_allocate_scoped_tensor(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSrocm_solversDTcc mht_11(mht_11_v, 924, "", "./tensorflow/core/util/rocm_solvers.cc", "GpuSolver::forward_input_or_allocate_scoped_tensor");
