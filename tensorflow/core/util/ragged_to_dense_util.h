...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSragged_to_dense_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSragged_to_dense_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSragged_to_dense_utilDTh() {
      // Check if tracing is enabled
...
Status GetRowPartitionTypes(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSragged_to_dense_utilDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/util/ragged_to_dense_util.h", "GetRowPartitionTypes");
