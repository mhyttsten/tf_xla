...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPStensor_slice_setDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_setDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPStensor_slice_setDTh() {
      // Check if tracing is enabled
...
class TensorSliceSet {
 public:
  ...
  const TensorShape& shape() const {
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_setDTh mht_0(mht_0_v, 211, "", "./tensorflow/core/util/tensor_slice_set.h", "shape");
 return shape_; }
  const DataType type() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_setDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/util/tensor_slice_set.h", "type");
 return type_; }
