...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc() {
      // Check if tracing is enabled
...
TEST(TestReffedStatusCallback, CallsBackOK) {
  ...
  auto done = [&called, &status](const Status& s) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/util/reffed_status_callback_test.cc", "lambda");
...
TEST(TestReffedStatusCallback, CallsBackFail) {
  ...
  auto done = [&called, &status](const Status& s) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc mht_1(mht_1_v, 220, "", "./tensorflow/core/util/reffed_status_callback_test.cc", "lambda");
...
TEST(TestReffedStatusCallback, RefMulti) {
  ...
  auto done = [&called, &status](const Status& s) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc mht_2(mht_2_v, 244, "", "./tensorflow/core/util/reffed_status_callback_test.cc", "lambda");
...
TEST(TestReffedStatusCallback, MultiThreaded) {
  ...
  auto done = [&num_called, &status, &n](const Status& s) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSreffed_status_callback_testDTcc mht_3(mht_3_v, 271, "", "./tensorflow/core/util/reffed_status_callback_test.cc", "lambda");
