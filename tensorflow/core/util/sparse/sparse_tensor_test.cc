...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSsparsePSsparse_tensor_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSsparsePSsparse_tensor_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSsparsePSsparse_tensor_testDTcc() {
      // Check if tracing is enabled
...
static void BM_SparseReorderFloat(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSsparsePSsparse_tensor_testDTcc mht_0(mht_0_v, 919, "", "./tensorflow/core/util/sparse/sparse_tensor_test.cc", "BM_SparseReorderFloat");
...
static void BM_SparseReorderString(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSsparsePSsparse_tensor_testDTcc mht_1(mht_1_v, 960, "", "./tensorflow/core/util/sparse/sparse_tensor_test.cc", "BM_SparseReorderString");
