...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_loss_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_loss_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_loss_utilDTh() {
      // Check if tracing is enabled
...
inline T LogSumExp(T log_prob_1, T log_prob_2) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_loss_utilDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/util/ctc/ctc_loss_util.h", "LogSumExp");
