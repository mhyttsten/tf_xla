...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh() {
      // Check if tracing is enabled
...
class BaseBeamScorer {
 public:
  virtual ~BaseBeamScorer() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/util/ctc/ctc_beam_scorer.h", "~BaseBeamScorer");
}
  // State initialization.
  virtual void InitializeState(CTCBeamState* root) const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh mht_1(mht_1_v, 214, "", "./tensorflow/core/util/ctc/ctc_beam_scorer.h", "InitializeState");
}
  ...
  virtual void ExpandState(const CTCBeamState& from_state, int from_label,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh mht_2(mht_2_v, 222, "", "./tensorflow/core/util/ctc/ctc_beam_scorer.h", "ExpandState");
}
  ...
  virtual void ExpandStateEnd(CTCBeamState* state) const {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh mht_3(mht_3_v, 229, "", "./tensorflow/core/util/ctc/ctc_beam_scorer.h", "ExpandStateEnd");
}
  ...
  virtual T GetStateExpansionScore(const CTCBeamState& state,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh mht_4(mht_4_v, 241, "", "./tensorflow/core/util/ctc/ctc_beam_scorer.h", "GetStateExpansionScore");
  ...
  virtual T GetStateEndExpansionScore(const CTCBeamState& state) const {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_scorerDTh mht_5(mht_5_v, 252, "", "./tensorflow/core/util/ctc/ctc_beam_scorer.h", "GetStateEndExpansionScore");
