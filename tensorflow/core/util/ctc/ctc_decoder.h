...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh() {
      // Check if tracing is enabled
...
class CTCDecoder {
 public:
  ...
  CTCDecoder(int num_classes, int batch_size, bool merge_repeated)
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh mht_0(mht_0_v, 219, "", "./tensorflow/core/util/ctc/ctc_decoder.h", "CTCDecoder");
}

  virtual ~CTCDecoder() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh mht_1(mht_1_v, 224, "", "./tensorflow/core/util/ctc/ctc_decoder.h", "~CTCDecoder");
}
  ...
  int batch_size() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh mht_2(mht_2_v, 238, "", "./tensorflow/core/util/ctc/ctc_decoder.h", "batch_size");
 return batch_size_; }
  int num_classes() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh mht_3(mht_3_v, 242, "", "./tensorflow/core/util/ctc/ctc_decoder.h", "num_classes");
 return num_classes_; }
...
class CTCGreedyDecoder : public CTCDecoder<T> {
 public:
  ...
  CTCGreedyDecoder(int num_classes, int batch_size, bool merge_repeated)
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh mht_4(mht_4_v, 261, "", "./tensorflow/core/util/ctc/ctc_decoder.h", "CTCGreedyDecoder");
}
  ...
  Status Decode(const typename CTCDecoder<T>::SequenceLength& seq_len,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_decoderDTh mht_5(mht_5_v, 269, "", "./tensorflow/core/util/ctc/ctc_decoder.h", "Decode");
