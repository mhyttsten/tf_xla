...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh() {
      // Check if tracing is enabled
...
class CTCBeamSearchDecoder : public CTCDecoder<T> {
 ...
 public:
  ...
  CTCBeamSearchDecoder(int num_classes, int beam_width,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh mht_0(mht_0_v, 264, "", "./tensorflow/core/util/ctc/ctc_beam_search.h", "CTCBeamSearchDecoder");
  ...
  ~CTCBeamSearchDecoder() override {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh mht_1(mht_1_v, 271, "", "./tensorflow/core/util/ctc/ctc_beam_search.h", "~CTCBeamSearchDecoder");
}
  ...
  void SetLabelSelectionParameters(int label_selection_size,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh mht_2(mht_2_v, 298, "", "./tensorflow/core/util/ctc/ctc_beam_search.h", "SetLabelSelectionParameters");
...
void CTCBeamSearchDecoder<T, CTCBeamState, CTCBeamComparer>::Step(
  ...
  for (BeamEntry* b : *branches) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSctcPSctc_beam_searchDTh mht_3(mht_3_v, 507, "", "./tensorflow/core/util/ctc/ctc_beam_search.h", "lambda");
