...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSsemver_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSsemver_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSsemver_testDTcc() {
      // Check if tracing is enabled
...
bool IsDotOrIdentifierChar(char c) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSsemver_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/util/semver_test.cc", "IsDotOrIdentifierChar");
...
bool ConsumeDotSeparatedIdentifiers(StringPiece* s, const string& prefix,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSsemver_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/util/semver_test.cc", "ConsumeDotSeparatedIdentifiers");
