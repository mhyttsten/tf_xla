...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSoverflow_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSoverflow_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSoverflow_testDTcc() {
      // Check if tracing is enabled
...
bool HasOverflow(int64_t x, int64_t y) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSoverflow_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/util/overflow_test.cc", "HasOverflow");
