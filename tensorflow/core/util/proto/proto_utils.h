...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTh() {
      // Check if tracing is enabled
...
inline google::protobuf::Duration ToDurationProto(absl::Duration duration) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTh mht_0(mht_0_v, 233, "", "./tensorflow/core/util/proto/proto_utils.h", "ToDurationProto");
...
inline absl::Duration FromDurationProto(google::protobuf::Duration proto) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTh mht_1(mht_1_v, 245, "", "./tensorflow/core/util/proto/proto_utils.h", "FromDurationProto");
