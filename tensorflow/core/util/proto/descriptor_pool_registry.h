...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registryDTh() {
      // Check if tracing is enabled
...
class DescriptorPoolRegistration {
 public:
  DescriptorPoolRegistration(
   ...
   mht_0_v.push_back("source: \"" + source + "\"");
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registryDTh mht_0(mht_0_v, 227, "", "./tensorflow/core/util/proto/descriptor_pool_registry.h", "DescriptorPoolRegistration");
