...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc() {
      // Check if tracing is enabled
...
bool IsCompatibleType(FieldDescriptor::Type field_type, DataType dtype) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/util/proto/proto_utils.cc", "IsCompatibleType");
...
Status ParseTextFormatFromString(absl::string_view input,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc mht_1(mht_1_v, 246, "", "./tensorflow/core/util/proto/proto_utils.cc", "ParseTextFormatFromString");
...
StringErrorCollector::StringErrorCollector(string* error_text)
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc mht_2(mht_2_v, 267, "", "./tensorflow/core/util/proto/proto_utils.cc", "StringErrorCollector::StringErrorCollector");
}
...
StringErrorCollector::StringErrorCollector(string* error_text,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc mht_3(mht_3_v, 274, "", "./tensorflow/core/util/proto/proto_utils.cc", "StringErrorCollector::StringErrorCollector");
...
void StringErrorCollector::AddError(int line, int column,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc mht_4(mht_4_v, 287, "", "./tensorflow/core/util/proto/proto_utils.cc", "StringErrorCollector::AddError");
...
void StringErrorCollector::AddWarning(int line, int column,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSproto_utilsDTcc mht_5(mht_5_v, 299, "", "./tensorflow/core/util/proto/proto_utils.cc", "StringErrorCollector::AddWarning");
