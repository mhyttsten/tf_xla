...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registry_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registry_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registry_testDTcc() {
      // Check if tracing is enabled
...
struct Value {
  static Status Function(
   ...
   MHTracer_DTPStensorflowPScorePSutilPSprotoPSdescriptor_pool_registry_testDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/util/proto/descriptor_pool_registry_test.cc", "Function");
