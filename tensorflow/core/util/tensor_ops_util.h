...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPStensor_ops_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_ops_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPStensor_ops_utilDTh() {
      // Check if tracing is enabled
...
Status ZerosLikeTensor(OpKernelContext* ctx, const Tensor& x, Tensor* out) {
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_ops_utilDTh mht_0(mht_0_v, 203, "", "./tensorflow/core/util/tensor_ops_util.h", "ZerosLikeTensor");
...
Status BinaryAddTensors(OpKernelContext* ctx, const Tensor& a, const Tensor& b,
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_ops_utilDTh mht_1(mht_1_v, 245, "", "./tensorflow/core/util/tensor_ops_util.h", "BinaryAddTensors");
