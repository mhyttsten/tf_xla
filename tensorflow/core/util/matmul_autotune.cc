...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSmatmul_autotuneDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSmatmul_autotuneDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSmatmul_autotuneDTcc() {
      // Check if tracing is enabled
...
bool MatmulAutotuneEnable() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSmatmul_autotuneDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/util/matmul_autotune.cc", "MatmulAutotuneEnable");
...
bool MatmulDoFP32ComputationFP16Input() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSmatmul_autotuneDTcc mht_1(mht_1_v, 205, "", "./tensorflow/core/util/matmul_autotune.cc", "MatmulDoFP32ComputationFP16Input");
