...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh() {
      // Check if tracing is enabled
...
class TensorSliceReader {
 public:
  ...
  const string& filepattern() const {
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh mht_0(mht_0_v, 241, "", "./tensorflow/core/util/tensor_slice_reader.h", "filepattern");
 return filepattern_; }

  // Get the number of files matched.
  int num_files() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh mht_1(mht_1_v, 247, "", "./tensorflow/core/util/tensor_slice_reader.h", "num_files");
 return sss_.size(); }

  // Get the status of the reader.
  const Status status() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh mht_2(mht_2_v, 253, "", "./tensorflow/core/util/tensor_slice_reader.h", "status");
 return status_; }
...
bool TensorSliceReader::CopySliceData(const string& name,
   ...
   MHTracer_DTPStensorflowPScorePSutilPStensor_slice_readerDTh mht_3(mht_3_v, 325, "", "./tensorflow/core/util/tensor_slice_reader.h", "TensorSliceReader::CopySliceData");
