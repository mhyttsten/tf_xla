...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSutilPSexec_on_stallDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSutilPSexec_on_stallDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSutilPSexec_on_stallDTh() {
      // Check if tracing is enabled
...
class ExecuteOnStall {
 public:
  ...
  ExecuteOnStall(int delay_secs, std::function<void()> f,
   ...
   MHTracer_DTPStensorflowPScorePSutilPSexec_on_stallDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/util/exec_on_stall.h", "ExecuteOnStall");
  ...
  ~ExecuteOnStall() {
   ...
   MHTracer_DTPStensorflowPScorePSutilPSexec_on_stallDTh mht_1(mht_1_v, 240, "", "./tensorflow/core/util/exec_on_stall.h", "~ExecuteOnStall");
