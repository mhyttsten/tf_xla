...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_localDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_localDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_localDTh() {
      // Check if tracing is enabled
...
class DeviceResolverLocal : public DeviceResolverInterface {
 public:
  explicit DeviceResolverLocal(const DeviceMgr* dev_mgr) : dev_mgr_(dev_mgr) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_localDTh mht_0(mht_0_v, 200, "", "./tensorflow/core/common_runtime/device_resolver_local.h", "DeviceResolverLocal");
}
