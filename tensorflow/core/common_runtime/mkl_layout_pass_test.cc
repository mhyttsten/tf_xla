...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc() {
      // Check if tracing is enabled
...
static void InitGraph(const string& s, Graph* graph,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_0(mht_0_v, 223, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "InitGraph");
...
class MklLayoutPassTest : public ::testing::Test {
 public:
  MklLayoutPassTest() : graph_(OpRegistry::Global()) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_1(mht_1_v, 241, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "MklLayoutPassTest");
}
  Node* FindNode(const string& name) {
   std::vector<std::string> mht_2_v;
   mht_2_v.push_back("name: \"" + name + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_2(mht_2_v, 246, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "FindNode");
  ...
  void InitGraph(const string& s, const string& device = kCPUDevice) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_3(mht_3_v, 257, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "InitGraph");
  ...
  static bool IncludeNode(const Node* n) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_4(mht_4_v, 265, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "IncludeNode");
 return n->IsOp(); }

  static string EdgeId(const Node* n, int index) {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_5(mht_5_v, 270, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "EdgeId");
  ...
  string CanonicalGraphString(Graph* g) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_6(mht_6_v, 283, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "CanonicalGraphString");
  ...
  string DoMklLayoutOptimizationPass() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_7(mht_7_v, 307, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "DoMklLayoutOptimizationPass");
  ...
  T DoMklLayoutOptimizationPassGetAttrVal(const string& attr,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_8(mht_8_v, 327, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "DoMklLayoutOptimizationPassGetAttrVal");
  ...
  const string& OriginalGraph() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_9(mht_9_v, 342, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "OriginalGraph");
 return original_; }
...
static void BM_MklLayoutRewritePass(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_layout_pass_testDTcc mht_10(mht_10_v, 5376, "", "./tensorflow/core/common_runtime/mkl_layout_pass_test.cc", "BM_MklLayoutRewritePass");
