...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_mgrDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_mgrDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_mgrDTh() {
      // Check if tracing is enabled
...
class DynamicDeviceMgr : public DeviceMgr {
 ...
 private:
  ...
  class DeviceCircularBuffer {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_mgrDTh mht_0(mht_0_v, 339, "", "./tensorflow/core/common_runtime/device_mgr.h", "DeviceCircularBuffer");

      devices_.resize(kStaleDeviceBufferSize);
    }
    void add(std::unique_ptr<Device> device) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_mgrDTh mht_1(mht_1_v, 345, "", "./tensorflow/core/common_runtime/device_mgr.h", "add");
