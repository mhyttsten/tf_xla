...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh() {
      // Check if tracing is enabled
...
class InlinedFunctionBodyPlacer {
 public:
  ...
  static Config Default() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh mht_0(mht_0_v, 248, "", "./tensorflow/core/common_runtime/inline_function_utils.h", "Default");
 return {"default", DefaultPlacer}; }
  static Config SingleDevice() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh mht_1(mht_1_v, 252, "", "./tensorflow/core/common_runtime/inline_function_utils.h", "SingleDevice");
 return {"single_device", SingleDevicePlacer}; }
  static Config MultiDevice() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh mht_2(mht_2_v, 256, "", "./tensorflow/core/common_runtime/inline_function_utils.h", "MultiDevice");
...
struct ExpandInlineFunctionsOptions {
  ExpandInlineFunctionsOptions() : native_options(), multi_device_options() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh mht_3(mht_3_v, 382, "", "./tensorflow/core/common_runtime/inline_function_utils.h", "ExpandInlineFunctionsOptions");
...
inline bool ExpandInlineFunctions(FunctionLibraryRuntime* lib, Graph* graph) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTh mht_4(mht_4_v, 415, "", "./tensorflow/core/common_runtime/inline_function_utils.h", "ExpandInlineFunctions");
