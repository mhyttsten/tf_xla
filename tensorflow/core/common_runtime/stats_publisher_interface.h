...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSstats_publisher_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSstats_publisher_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSstats_publisher_interfaceDTh() {
      // Check if tracing is enabled
...
class StatsPublisherInterface {
 public:
  ...
  virtual ~StatsPublisherInterface() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSstats_publisher_interfaceDTh mht_0(mht_0_v, 220, "", "./tensorflow/core/common_runtime/stats_publisher_interface.h", "~StatsPublisherInterface");
}
};
