...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registryDTh() {
      // Check if tracing is enabled
...
class CostMeasurementRegistrar {
 public:
  explicit CostMeasurementRegistrar(absl::string_view name,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registryDTh mht_0(mht_0_v, 226, "", "./tensorflow/core/common_runtime/cost_measurement_registry.h", "CostMeasurementRegistrar");
