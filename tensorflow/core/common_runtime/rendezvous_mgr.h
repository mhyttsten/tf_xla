...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_mgrDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_mgrDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_mgrDTh() {
      // Check if tracing is enabled
...
class RefCountedIntraProcessRendezvous : public Rendezvous {
 public:
  ...
  inline void UpdateDeviceManager(DeviceMgr* device_mgr) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_mgrDTh mht_0(mht_0_v, 226, "", "./tensorflow/core/common_runtime/rendezvous_mgr.h", "UpdateDeviceManager");
