...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgr_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgr_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgr_testDTcc() {
      // Check if tracing is enabled
...
class CollectiveExecutorMgrTest : public ::testing::Test {
 protected:
  CollectiveExecutorMgrTest() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgr_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/core/common_runtime/collective_executor_mgr_test.cc", "CollectiveExecutorMgrTest");
