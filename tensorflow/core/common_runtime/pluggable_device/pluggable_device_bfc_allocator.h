...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSpluggable_devicePSpluggable_device_bfc_allocatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpluggable_devicePSpluggable_device_bfc_allocatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSpluggable_devicePSpluggable_device_bfc_allocatorDTh() {
      // Check if tracing is enabled
...
class PluggableDeviceBFCAllocator : public BFCAllocator {
 public:
  ...
  ~PluggableDeviceBFCAllocator() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpluggable_devicePSpluggable_device_bfc_allocatorDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/common_runtime/pluggable_device/pluggable_device_bfc_allocator.h", "~PluggableDeviceBFCAllocator");
}
