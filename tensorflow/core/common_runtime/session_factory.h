...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSsession_factoryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSsession_factoryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSsession_factoryDTh() {
      // Check if tracing is enabled
...
class SessionFactory {
 public:
  ...
  virtual Status Reset(const SessionOptions& options,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSsession_factoryDTh mht_0(mht_0_v, 233, "", "./tensorflow/core/common_runtime/session_factory.h", "Reset");
  ...
  virtual ~SessionFactory() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSsession_factoryDTh mht_1(mht_1_v, 240, "", "./tensorflow/core/common_runtime/session_factory.h", "~SessionFactory");
}
