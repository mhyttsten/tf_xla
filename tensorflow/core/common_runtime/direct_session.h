...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh() {
      // Check if tracing is enabled
...
class DirectSession : public Session {
 public:
  ...
  ::tensorflow::Status LocalDeviceManager(const DeviceMgr** output) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_0(mht_0_v, 281, "", "./tensorflow/core/common_runtime/direct_session.h", "LocalDeviceManager");
  ...
  void ExportCostModels(CostModelManager::CostModelMap* cost_models) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_1(mht_1_v, 289, "", "./tensorflow/core/common_runtime/direct_session.h", "ExportCostModels");
  ...
  const SessionOptions& options() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_2(mht_2_v, 313, "", "./tensorflow/core/common_runtime/direct_session.h", "options");
 return options_; }
 ...
 private:
  ...
  struct ExecutorsAndKeys {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_3(mht_3_v, 340, "", "./tensorflow/core/common_runtime/direct_session.h", "ExecutorsAndKeys");
}
  ...
  struct RunStateArgs {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_4(mht_4_v, 413, "", "./tensorflow/core/common_runtime/direct_session.h", "RunStateArgs");
}
  ...
  ::tensorflow::Status CheckNotClosed() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_5(mht_5_v, 497, "", "./tensorflow/core/common_runtime/direct_session.h", "CheckNotClosed");
  ...
  ::tensorflow::Status CheckGraphCreated(const char* method) {
   ...
   mht_6_v.push_back("method: \"" + (method == nullptr ? std::string("nullptr") : std::string((char*)method)) + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdirect_sessionDTh mht_6(mht_6_v, 507, "", "./tensorflow/core/common_runtime/direct_session.h", "CheckGraphCreated");
