...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSplacer_inspection_required_ops_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSplacer_inspection_required_ops_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSplacer_inspection_required_ops_utils_testDTcc() {
      // Check if tracing is enabled
...
void VerifyPlacerInspectionRequiredOps(const GraphDef& graph_def,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSplacer_inspection_required_ops_utils_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/common_runtime/placer_inspection_required_ops_utils_test.cc", "VerifyPlacerInspectionRequiredOps");
