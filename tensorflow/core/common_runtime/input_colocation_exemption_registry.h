...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSinput_colocation_exemption_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinput_colocation_exemption_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSinput_colocation_exemption_registryDTh() {
      // Check if tracing is enabled
...
class InputColocationExemptionRegistry {
 public:
  ...
  const gtl::FlatSet<string>& Get() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinput_colocation_exemption_registryDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/common_runtime/input_colocation_exemption_registry.h", "Get");
 return ops_; }
...
class InputColocationExemptionRegistration {
 public:
  explicit InputColocationExemptionRegistration(const string& op) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinput_colocation_exemption_registryDTh mht_1(mht_1_v, 229, "", "./tensorflow/core/common_runtime/input_colocation_exemption_registry.h", "InputColocationExemptionRegistration");
