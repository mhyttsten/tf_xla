...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc() {
      // Check if tracing is enabled
...
AllToAll::AllToAll()
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/common_runtime/all_to_all.cc", "AllToAll::AllToAll");
}

StatusCallback AllToAll::CheckCounterAndCallDone() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_1(mht_1_v, 217, "", "./tensorflow/core/common_runtime/all_to_all.cc", "AllToAll::CheckCounterAndCallDone");

  return [this](const Status& s) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_2(mht_2_v, 221, "", "./tensorflow/core/common_runtime/all_to_all.cc", "lambda");
...
Status AllToAll::InitializeCollectiveContext(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_3(mht_3_v, 257, "", "./tensorflow/core/common_runtime/all_to_all.cc", "AllToAll::InitializeCollectiveContext");
...
void AllToAll::Run(StatusCallback done) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_4(mht_4_v, 275, "", "./tensorflow/core/common_runtime/all_to_all.cc", "AllToAll::Run");
...
void AllToAll::DispatchSend(int src_rank, int target_rank, const Tensor* tensor,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_5(mht_5_v, 308, "", "./tensorflow/core/common_runtime/all_to_all.cc", "AllToAll::DispatchSend");
...
void AllToAll::DispatchRecv(int src_rank, int target_rank, Tensor* tensor,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSall_to_allDTcc mht_6(mht_6_v, 323, "", "./tensorflow/core/common_runtime/all_to_all.cc", "AllToAll::DispatchRecv");
