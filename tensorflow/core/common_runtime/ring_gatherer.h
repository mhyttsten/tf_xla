...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSring_gathererDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSring_gathererDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSring_gathererDTh() {
      // Check if tracing is enabled
...
class RingGatherer : public RingAlg {
 public:
  RingGatherer() : RingAlg(GATHER_COLLECTIVE, "Gather") {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSring_gathererDTh mht_0(mht_0_v, 202, "", "./tensorflow/core/common_runtime/ring_gatherer.h", "RingGatherer");
}
  ~RingGatherer() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSring_gathererDTh mht_1(mht_1_v, 206, "", "./tensorflow/core/common_runtime/ring_gatherer.h", "~RingGatherer");
}
