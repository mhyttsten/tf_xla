...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_def_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_def_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_def_utilsDTcc() {
      // Check if tracing is enabled
...
Status FunctionDefToBodyHelper(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_def_utilsDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/common_runtime/function_def_utils.cc", "FunctionDefToBodyHelper");
...
Status FunctionDefToBodyHelper(const FunctionDef& fdef, const AttrSlice& attrs,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_def_utilsDTcc mht_1(mht_1_v, 250, "", "./tensorflow/core/common_runtime/function_def_utils.cc", "FunctionDefToBodyHelper");

  const auto get_func_sig = [&lib_def](const string& op, const OpDef** sig) {
   std::vector<std::string> mht_2_v;
   mht_2_v.push_back("op: \"" + op + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_def_utilsDTcc mht_2(mht_2_v, 255, "", "./tensorflow/core/common_runtime/function_def_utils.cc", "lambda");
