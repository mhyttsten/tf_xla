...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc() {
      // Check if tracing is enabled
...
ExecutorFactories* executor_factories() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/common_runtime/executor_factory.cc", "executor_factories");
...
void ExecutorFactory::Register(const string& executor_type,
   ...
   mht_1_v.push_back("executor_type: \"" + executor_type + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/common_runtime/executor_factory.cc", "ExecutorFactory::Register");
...
Status ExecutorFactory::GetFactory(const string& executor_type,
   ...
   mht_2_v.push_back("executor_type: \"" + executor_type + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc mht_2(mht_2_v, 239, "", "./tensorflow/core/common_runtime/executor_factory.cc", "ExecutorFactory::GetFactory");
...
Status NewExecutor(const string& executor_type,
   ...
   mht_3_v.push_back("executor_type: \"" + executor_type + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTcc mht_3(mht_3_v, 259, "", "./tensorflow/core/common_runtime/executor_factory.cc", "NewExecutor");
