...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh() {
      // Check if tracing is enabled
...
class CompositeDevice : public Device {
 public:
  Status Sync() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh mht_0(mht_0_v, 203, "", "./tensorflow/core/common_runtime/composite_device.h", "Sync");
  ...
  Allocator* GetAllocator(AllocatorAttributes) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh mht_1(mht_1_v, 211, "", "./tensorflow/core/common_runtime/composite_device.h", "GetAllocator");
 return nullptr; }

  const std::vector<string>* underlying_devices() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh mht_2(mht_2_v, 216, "", "./tensorflow/core/common_runtime/composite_device.h", "underlying_devices");
  ...
  bool IsRemoteCallAllowed() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh mht_3(mht_3_v, 234, "", "./tensorflow/core/common_runtime/composite_device.h", "IsRemoteCallAllowed");
 return false; }
 ...
 private:
  CompositeDevice(const DeviceAttributes& device_attributes,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTh mht_4(mht_4_v, 243, "", "./tensorflow/core/common_runtime/composite_device.h", "CompositeDevice");
}
