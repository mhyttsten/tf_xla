...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSprofile_handlerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSprofile_handlerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSprofile_handlerDTh() {
      // Check if tracing is enabled
...
class ProfileHandler {
 public:
  ProfileHandler() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSprofile_handlerDTh mht_0(mht_0_v, 198, "", "./tensorflow/core/common_runtime/profile_handler.h", "ProfileHandler");
}
  virtual ~ProfileHandler() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSprofile_handlerDTh mht_1(mht_1_v, 202, "", "./tensorflow/core/common_runtime/profile_handler.h", "~ProfileHandler");
}
