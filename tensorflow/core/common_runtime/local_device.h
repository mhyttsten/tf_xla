...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSlocal_deviceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlocal_deviceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSlocal_deviceDTh() {
      // Check if tracing is enabled
...
class LocalDevice : public Device {
 ...
 private:
  ...
  static void set_use_global_threadpool(bool use_global_threadpool) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlocal_deviceDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/common_runtime/local_device.h", "set_use_global_threadpool");
