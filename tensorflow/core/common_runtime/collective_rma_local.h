...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_localDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_localDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_localDTh() {
      // Check if tracing is enabled
...
class CollectiveRemoteAccessLocal : public CollectiveRemoteAccess {
 public:
  CollectiveRemoteAccessLocal(const DeviceMgr* dev_mgr,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_localDTh mht_0(mht_0_v, 203, "", "./tensorflow/core/common_runtime/collective_rma_local.h", "CollectiveRemoteAccessLocal");
}
  ...
  BufRendezvous* buf_rendezvous() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_localDTh mht_1(mht_1_v, 233, "", "./tensorflow/core/common_runtime/collective_rma_local.h", "buf_rendezvous");
