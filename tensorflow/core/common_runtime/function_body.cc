...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTcc() {
      // Check if tracing is enabled
...
FunctionBody::FunctionBody(const FunctionDef& f, DataTypeSlice arg_t,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/common_runtime/function_body.cc", "FunctionBody::FunctionBody");
...
FunctionBody::~FunctionBody() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTcc mht_1(mht_1_v, 234, "", "./tensorflow/core/common_runtime/function_body.cc", "FunctionBody::~FunctionBody");
 delete this->graph; }
