...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSpropagator_debug_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpropagator_debug_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSpropagator_debug_utilsDTcc() {
      // Check if tracing is enabled
...
const Tensor* GetTensorValueForDump(const Entry& input) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpropagator_debug_utilsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/common_runtime/propagator_debug_utils.cc", "GetTensorValueForDump");
...
void DumpPendingNodeState(const NodeItem& node_item, const Entry* input_vector,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpropagator_debug_utilsDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/common_runtime/propagator_debug_utils.cc", "DumpPendingNodeState");
...
void DumpActiveNodeState(const NodeItem& node_item, const Entry* input_vector) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpropagator_debug_utilsDTcc mht_2(mht_2_v, 250, "", "./tensorflow/core/common_runtime/propagator_debug_utils.cc", "DumpActiveNodeState");
