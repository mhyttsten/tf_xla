...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registry_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registry_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registry_testDTcc() {
      // Check if tracing is enabled
...
class TestRequestCostAccessor : public RequestCostAccessor {
 public:
  RequestCost* GetRequestCost() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registry_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/common_runtime/request_cost_accessor_registry_test.cc", "GetRequestCost");
 return nullptr; }
};
...
TEST(RequestCostAccessorRegistryDeathTest, CrashWhenRegisterTwice) {
  const auto creator = []() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registry_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/common_runtime/request_cost_accessor_registry_test.cc", "lambda");
