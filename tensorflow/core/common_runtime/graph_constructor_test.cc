...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc() {
      // Check if tracing is enabled
...
class GraphConstructorTest : public ::testing::Test {
 protected:
  GraphConstructorTest() : graph_(OpRegistry::Global()) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_0(mht_0_v, 217, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "GraphConstructorTest");
}

  void Convert(const string& gdef_ascii) {
   std::vector<std::string> mht_1_v;
   mht_1_v.push_back("gdef_ascii: \"" + gdef_ascii + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_1(mht_1_v, 223, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "Convert");
  ...
  void ExpectError(const string& gdef_ascii,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_2(mht_2_v, 233, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "ExpectError");
  ...
  void ExpectError(const string& gdef_ascii, const ImportGraphDefOptions& opts,
   ...
   mht_3_v.push_back("gdef_ascii: \"" + gdef_ascii + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_3(mht_3_v, 264, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "ExpectError");
  ...
  void ExpectOK(const string& gdef_ascii) {
   ...
   mht_4_v.push_back("gdef_ascii: \"" + gdef_ascii + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_4(mht_4_v, 284, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "ExpectOK");
  ...
  void ExpectOK(const string& gdef_ascii, const ImportGraphDefOptions& opts,
   ...
   mht_5_v.push_back("gdef_ascii: \"" + gdef_ascii + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_5(mht_5_v, 296, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "ExpectOK");
  ...
  void ExpectVersions(int min_consumer, int producer) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_6(mht_6_v, 305, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "ExpectVersions");
  ...
  Node* FindNode(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_7(mht_7_v, 318, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "FindNode");
  ...
  bool HasNode(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_8(mht_8_v, 329, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "HasNode");
 return FindNode(name) != nullptr; }
  ...
  bool HasEdge(const string& src, int src_out, const string& dst, int dst_in) {
   ...
   mht_9_v.push_back("dst: \"" + dst + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_9(mht_9_v, 336, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "HasEdge");
  ...
  bool HasControlEdge(const string& src, const string& dst) {
   ...
   mht_10_v.push_back("src: \"" + src + "\"");
   mht_10_v.push_back("dst: \"" + dst + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_10(mht_10_v, 351, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "HasControlEdge");
  ...
  string ColocationGroup(const string& node) {
   ...
   mht_11_v.push_back("node: \"" + node + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_11(mht_11_v, 359, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "ColocationGroup");
  ...
  string GraphDebugString() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_12(mht_12_v, 388, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "GraphDebugString");
...
Status Scalars(shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_13(mht_13_v, 401, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "Scalars");
...
TEST_F(GraphConstructorTest, InvalidNodeName) {
  auto expect_invalid_name = [this](const char* name) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructor_testDTcc mht_14(mht_14_v, 452, "", "./tensorflow/core/common_runtime/graph_constructor_test.cc", "lambda");
