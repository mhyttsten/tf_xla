...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc() {
      // Check if tracing is enabled
...
class ThreadLabel {
 public:
  static const char* GetValue() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "GetValue");
 return value_; }
  ...
  static void SetValue(const char* v) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "SetValue");
 value_ = v; }
...
void WarnIfInCallback(std::function<void()> f) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_2(mht_2_v, 223, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "WarnIfInCallback");
...
void InitThreadpoolLabels(thread::ThreadPool* threadpool) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_3(mht_3_v, 238, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "InitThreadpoolLabels");
...
EventMgr::EventMgr(se::StreamExecutor* se, const GPUOptions& gpu_options)
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_4(mht_4_v, 280, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::EventMgr");
...
EventMgr::~EventMgr() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_5(mht_5_v, 288, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::~EventMgr");
...
void EventMgr::StartPollingLoop() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_6(mht_6_v, 306, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::StartPollingLoop");
...
void EventMgr::StopPollingLoop() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_7(mht_7_v, 319, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::StopPollingLoop");
...
void EventMgr::PollLoop() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_8(mht_8_v, 338, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::PollLoop");
...
void EventMgr::QueueInUse(se::Stream* stream, InUse in_use) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_9(mht_9_v, 366, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::QueueInUse");
...
void EventMgr::PollEvents(bool is_dedicated_poller,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_10(mht_10_v, 407, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgr::PollEvents");
...
EventMgrFactory* EventMgrFactory::Singleton() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_11(mht_11_v, 449, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgrFactory::Singleton");
...
EventMgr* EventMgrFactory::GetEventMgr(se::StreamExecutor* se,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevicePSdevice_event_mgrDTcc mht_12(mht_12_v, 458, "", "./tensorflow/core/common_runtime/device/device_event_mgr.cc", "EventMgrFactory::GetEventMgr");
