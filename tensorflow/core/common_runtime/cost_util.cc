...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScost_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScost_utilDTcc() {
      // Check if tracing is enabled
...
const char* GetRequestCostAccessorType() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_utilDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/common_runtime/cost_util.cc", "GetRequestCostAccessorType");
