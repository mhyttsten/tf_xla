...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScustom_device_op_handlerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScustom_device_op_handlerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScustom_device_op_handlerDTh() {
      // Check if tracing is enabled
...
class CustomDeviceOpHandler {
 public:
  ~CustomDeviceOpHandler() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScustom_device_op_handlerDTh mht_0(mht_0_v, 196, "", "./tensorflow/core/common_runtime/eager/custom_device_op_handler.h", "~CustomDeviceOpHandler");
}
