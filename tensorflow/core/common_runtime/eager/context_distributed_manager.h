...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScontext_distributed_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScontext_distributed_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScontext_distributed_managerDTh() {
      // Check if tracing is enabled
...
class EagerContextDistributedManager
 ...
 public:
  explicit EagerContextDistributedManager(EagerContext* context)
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScontext_distributed_managerDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/common_runtime/eager/context_distributed_manager.h", "EagerContextDistributedManager");
}
  ...
  CoordinationServiceAgent* GetCoordinationServiceAgent() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScontext_distributed_managerDTh mht_1(mht_1_v, 221, "", "./tensorflow/core/common_runtime/eager/context_distributed_manager.h", "GetCoordinationServiceAgent");

    return coordination_service_agent_;
  }
  void SetCoordinationServiceAgent(CoordinationServiceAgent* agent) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPScontext_distributed_managerDTh mht_2(mht_2_v, 227, "", "./tensorflow/core/common_runtime/eager/context_distributed_manager.h", "SetCoordinationServiceAgent");
