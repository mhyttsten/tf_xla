...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSattr_builder_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSattr_builder_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSattr_builder_testDTcc() {
      // Check if tracing is enabled
...
string ToString(const AttrValueMap& m) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSattr_builder_testDTcc mht_0(mht_0_v, 257, "", "./tensorflow/core/common_runtime/eager/attr_builder_test.cc", "ToString");
