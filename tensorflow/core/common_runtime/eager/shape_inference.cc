...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSshape_inferenceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSshape_inferenceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSshape_inferenceDTcc() {
      // Check if tracing is enabled
...
Status RunShapeInference(const NodeDef& ndef,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSshape_inferenceDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/common_runtime/eager/shape_inference.cc", "RunShapeInference");
