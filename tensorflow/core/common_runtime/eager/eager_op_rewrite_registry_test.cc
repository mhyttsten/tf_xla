...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSeager_op_rewrite_registry_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSeager_op_rewrite_registry_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSeager_op_rewrite_registry_testDTcc() {
      // Check if tracing is enabled
...
class TestEagerOpRewrite : public EagerOpRewrite {
 public:
  TestEagerOpRewrite(string name, string file, string line)
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSeager_op_rewrite_registry_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/common_runtime/eager/eager_op_rewrite_registry_test.cc", "TestEagerOpRewrite");
}
  static int count_;
  ...
  Status Run(EagerOperation* orig_op,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSeagerPSeager_op_rewrite_registry_testDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/common_runtime/eager/eager_op_rewrite_registry_test.cc", "Run");
