...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registration_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registration_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registration_testDTcc() {
      // Check if tracing is enabled
...
class TestFunctionPass : public FunctionOptimizationPass {
 public:
  ...
  Status Run(const DeviceSet& device_set, const ConfigProto& config_proto,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registration_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/common_runtime/function_optimization_registration_test.cc", "Run");
