...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_local_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_local_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_local_testDTcc() {
      // Check if tracing is enabled
...
class DeviceResolverLocalTest : public ::testing::Test {
 protected:
  DeviceResolverLocalTest() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSdevice_resolver_local_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/common_runtime/device_resolver_local_test.cc", "DeviceResolverLocalTest");
