...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTh() {
      // Check if tracing is enabled
...
class ExecutorFactory {
 public:
  ...
  virtual ~ExecutorFactory() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSexecutor_factoryDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/common_runtime/executor_factory.h", "~ExecutorFactory");
}
