...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSallocator_retryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSallocator_retryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSallocator_retryDTh() {
      // Check if tracing is enabled
...
inline void AllocatorRetry::NotifyDealloc() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSallocator_retryDTh mht_0(mht_0_v, 222, "", "./tensorflow/core/common_runtime/allocator_retry.h", "AllocatorRetry::NotifyDealloc");
