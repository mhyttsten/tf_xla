...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTh() {
      // Check if tracing is enabled
...
class Permuter : public CollectiveImplementationInterface {
 public:
  ...
  Status InitializeCollectiveParams(CollectiveParams* col_params) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTh mht_0(mht_0_v, 221, "", "./tensorflow/core/common_runtime/permuter.h", "InitializeCollectiveParams");
