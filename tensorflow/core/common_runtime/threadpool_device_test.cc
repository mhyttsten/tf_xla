...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_testDTcc() {
      // Check if tracing is enabled
...
void InitTensor(Tensor* tensor, float value) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/common_runtime/threadpool_device_test.cc", "InitTensor");
...
bool Equal(const Tensor& tensor1, const Tensor& tensor2) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/common_runtime/threadpool_device_test.cc", "Equal");
