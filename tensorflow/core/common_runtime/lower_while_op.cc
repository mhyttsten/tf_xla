...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc() {
      // Check if tracing is enabled
...
class LowerWhileHelper {
 public:
  static Status Run(Node* while_op, const NameAttrList& cond_fn,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_0(mht_0_v, 237, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "Run");
...
LowerWhileHelper::LowerWhileHelper(Node* while_op, const NameAttrList& cond_fn,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_1(mht_1_v, 368, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::LowerWhileHelper");
...
Status LowerWhileHelper::RunInternal() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_2(mht_2_v, 390, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::RunInternal");
...
void LowerWhileHelper::InitializeInputOutputToLoweredNodeMap() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_3(mht_3_v, 407, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::InitializeInputOutputToLoweredNodeMap");
...
Status LowerWhileHelper::CreateEnterNodes() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_4(mht_4_v, 419, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateEnterNodes");
...
Status LowerWhileHelper::CreateMergeNodes() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_5(mht_5_v, 465, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateMergeNodes");
...
Status LowerWhileHelper::CreateCondFuncCallNode() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_6(mht_6_v, 485, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateCondFuncCallNode");
...
Status LowerWhileHelper::CreateSwitchNodes() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_7(mht_7_v, 511, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateSwitchNodes");
...
Status LowerWhileHelper::CreateBodyFuncCallNode() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_8(mht_8_v, 543, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateBodyFuncCallNode");
...
Status LowerWhileHelper::CreateExitNodes() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_9(mht_9_v, 578, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateExitNodes");
...
Status LowerWhileHelper::CreateNextIterationNodes() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_10(mht_10_v, 642, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::CreateNextIterationNodes");
...
Status LowerWhileHelper::UpdateMergeNodes() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_11(mht_11_v, 664, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::UpdateMergeNodes");
...
Status LowerWhileHelper::UpdateConsumers() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_12(mht_12_v, 675, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::UpdateConsumers");
...
string LowerWhileHelper::NewName(const string& infix) {
   ...
   mht_13_v.push_back("infix: \"" + infix + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_13(mht_13_v, 706, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::NewName");
...
bool LowerWhileHelper::IsResource(int index) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_14(mht_14_v, 713, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "LowerWhileHelper::IsResource");
...
Status RewriteWhileNode(Node* n, Graph* g,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSlower_while_opDTcc mht_15(mht_15_v, 724, "", "./tensorflow/core/common_runtime/lower_while_op.cc", "RewriteWhileNode");
