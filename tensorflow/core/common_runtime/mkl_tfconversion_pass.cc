...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc() {
      // Check if tracing is enabled
...
class MklToTfConversionPass : public GraphOptimizationPass {
 public:
  MklToTfConversionPass() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_0(mht_0_v, 247, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "MklToTfConversionPass");
}
 ...
 private:
  ...
  inline bool IsMklSupportedOp(const string& op_name, DataType T) const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_1(mht_1_v, 268, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "IsMklSupportedOp");
  ...
  inline bool IsMklElementWiseOp(const string& op_name, DataType T) const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_2(mht_2_v, 282, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "IsMklElementWiseOp");
...
Status MklToTfConversionPass::InsertInputConversionNode(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_3(mht_3_v, 390, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "MklToTfConversionPass::InsertInputConversionNode");
...
bool MklToTfConversionPass::RunPass(std::unique_ptr<Graph>* g) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_4(mht_4_v, 483, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "MklToTfConversionPass::RunPass");
...
bool InsertMklToTfConversionNodes(std::unique_ptr<Graph>* g) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_5(mht_5_v, 606, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "InsertMklToTfConversionNodes");
...
Status MklToTfConversionPass::Run(const GraphOptimizationPassOptions& options) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_6(mht_6_v, 613, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "MklToTfConversionPass::Run");
  ...
  auto process_graph = [&](std::unique_ptr<Graph>* g) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSmkl_tfconversion_passDTcc mht_7(mht_7_v, 630, "", "./tensorflow/core/common_runtime/mkl_tfconversion_pass.cc", "lambda");
