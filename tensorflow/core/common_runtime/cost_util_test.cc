...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc() {
      // Check if tracing is enabled
...
class TestGcuCostMeasurement : public CostMeasurement {
 public:
  ...
  absl::Duration GetTotalCost() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/common_runtime/cost_util_test.cc", "GetTotalCost");
 return absl::ZeroDuration(); }
  absl::string_view GetCostType() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/common_runtime/cost_util_test.cc", "GetCostType");
 return "test_gcu"; }
};
...
class TestTpuCostMeasurement : public CostMeasurement {
 public:
  ...
  absl::Duration GetTotalCost() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc mht_2(mht_2_v, 215, "", "./tensorflow/core/common_runtime/cost_util_test.cc", "GetTotalCost");
 return absl::ZeroDuration(); }
  absl::string_view GetCostType() const override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc mht_3(mht_3_v, 219, "", "./tensorflow/core/common_runtime/cost_util_test.cc", "GetCostType");
 return "test_tpu"; }
};
...
class TestRequestCostAccessor : public RequestCostAccessor {
 public:
  RequestCost* GetRequestCost() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_util_testDTcc mht_4(mht_4_v, 228, "", "./tensorflow/core/common_runtime/cost_util_test.cc", "GetRequestCost");
 return nullptr; }
};
