...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh() {
      // Check if tracing is enabled
...
class CollectiveExecutorMgr : public CollectiveExecutorMgrInterface {
 public:
  ...
  ParamResolverInterface* GetParamResolver() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/common_runtime/collective_executor_mgr.h", "GetParamResolver");
  ...
  DeviceResolverInterface* GetDeviceResolver() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh mht_1(mht_1_v, 216, "", "./tensorflow/core/common_runtime/collective_executor_mgr.h", "GetDeviceResolver");
  ...
  NcclCommunicatorInterface* GetNcclCommunicator() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh mht_2(mht_2_v, 223, "", "./tensorflow/core/common_runtime/collective_executor_mgr.h", "GetNcclCommunicator");
  ...
  int64_t NextStepId(int64_t graph_key) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh mht_3(mht_3_v, 237, "", "./tensorflow/core/common_runtime/collective_executor_mgr.h", "NextStepId");
  ...
  void RetireStepId(int64_t graph_key, int64_t step_id) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_executor_mgrDTh mht_4(mht_4_v, 244, "", "./tensorflow/core/common_runtime/collective_executor_mgr.h", "RetireStepId");
}
