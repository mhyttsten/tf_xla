...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSparallel_concat_optimizerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSparallel_concat_optimizerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSparallel_concat_optimizerDTcc() {
      // Check if tracing is enabled
...
class ParallelConcatRemovePass : public GraphOptimizationPass {
 public:
  Status Run(const GraphOptimizationPassOptions& options) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSparallel_concat_optimizerDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/common_runtime/parallel_concat_optimizer.cc", "Run");
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSparallel_concat_optimizerDTcc mht_1(mht_1_v, 224, "", "./tensorflow/core/common_runtime/parallel_concat_optimizer.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSparallel_concat_optimizerDTcc mht_2(mht_2_v, 238, "", "./tensorflow/core/common_runtime/parallel_concat_optimizer.cc", "lambda");
