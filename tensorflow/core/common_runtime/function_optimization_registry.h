...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registryDTh() {
      // Check if tracing is enabled
...
class FunctionOptimizationPass {
 public:
  virtual ~FunctionOptimizationPass() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registryDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/common_runtime/function_optimization_registry.h", "~FunctionOptimizationPass");
}
...
class FunctionOptimizationPassRegistration {
 public:
  explicit FunctionOptimizationPassRegistration(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_optimization_registryDTh mht_1(mht_1_v, 252, "", "./tensorflow/core/common_runtime/function_optimization_registry.h", "FunctionOptimizationPassRegistration");
