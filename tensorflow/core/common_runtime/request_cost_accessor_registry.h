...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registryDTh() {
      // Check if tracing is enabled
...
class RequestCostAccessorRegistrar {
 public:
  explicit RequestCostAccessorRegistrar(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrequest_cost_accessor_registryDTh mht_0(mht_0_v, 225, "", "./tensorflow/core/common_runtime/request_cost_accessor_registry.h", "RequestCostAccessorRegistrar");
