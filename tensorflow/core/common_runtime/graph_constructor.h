...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructorDTh() {
      // Check if tracing is enabled
...
struct GraphConstructorOptions {
  GraphConstructorOptions() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructorDTh mht_0(mht_0_v, 203, "", "./tensorflow/core/common_runtime/graph_constructor.h", "GraphConstructorOptions");
}
...
struct ImportGraphDefOptions {
  ImportGraphDefOptions()
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_constructorDTh mht_1(mht_1_v, 245, "", "./tensorflow/core/common_runtime/graph_constructor.h", "ImportGraphDefOptions");
}
