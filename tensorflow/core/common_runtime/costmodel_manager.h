...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScostmodel_managerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScostmodel_managerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScostmodel_managerDTh() {
      // Check if tracing is enabled
...
class CostModelManager {
 public:
  ...
  void ExportCostModels(CostModelMap* cost_models) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScostmodel_managerDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/common_runtime/costmodel_manager.h", "ExportCostModels");
