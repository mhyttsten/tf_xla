...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_utilDTcc() {
      // Check if tracing is enabled
...
Status SendTensorsToRendezvous(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_utilDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/common_runtime/rendezvous_util.cc", "SendTensorsToRendezvous");
...
void RecvOutputsFromRendezvousAsync(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_utilDTcc mht_1(mht_1_v, 232, "", "./tensorflow/core/common_runtime/rendezvous_util.cc", "RecvOutputsFromRendezvousAsync");
...
Status RecvOutputsFromRendezvous(RendezvousInterface* rendezvous,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSrendezvous_utilDTcc mht_2(mht_2_v, 298, "", "./tensorflow/core/common_runtime/rendezvous_util.cc", "RecvOutputsFromRendezvous");
