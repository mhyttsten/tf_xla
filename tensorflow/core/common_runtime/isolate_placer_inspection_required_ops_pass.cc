...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSisolate_placer_inspection_required_ops_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSisolate_placer_inspection_required_ops_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSisolate_placer_inspection_required_ops_passDTcc() {
      // Check if tracing is enabled
...
Status IsolatePlacerInspectionRequiredOpsPass::Run(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSisolate_placer_inspection_required_ops_passDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/common_runtime/isolate_placer_inspection_required_ops_pass.cc", "IsolatePlacerInspectionRequiredOpsPass::Run");
