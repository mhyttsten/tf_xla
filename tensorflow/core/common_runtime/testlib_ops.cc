...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc() {
      // Check if tracing is enabled
...
class ErrorOp : public OpKernel {
 public:
  explicit ErrorOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/common_runtime/testlib_ops.cc", "ErrorOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/common_runtime/testlib_ops.cc", "Compute");
...
class InvalidRefType : public OpKernel {
 public:
  explicit InvalidRefType(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc mht_2(mht_2_v, 236, "", "./tensorflow/core/common_runtime/testlib_ops.cc", "InvalidRefType");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc mht_3(mht_3_v, 244, "", "./tensorflow/core/common_runtime/testlib_ops.cc", "Compute");
...
class DelayOp : public AsyncOpKernel {
 public:
  explicit DelayOp(OpKernelConstruction* ctx) : AsyncOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc mht_4(mht_4_v, 269, "", "./tensorflow/core/common_runtime/testlib_ops.cc", "DelayOp");
  ...
  void ComputeAsync(OpKernelContext* ctx, DoneCallback done) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePStestlib_opsDTcc mht_5(mht_5_v, 276, "", "./tensorflow/core/common_runtime/testlib_ops.cc", "ComputeAsync");
