...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTh() {
      // Check if tracing is enabled
...
struct FunctionBody {
  ...
  FunctionBody() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSfunction_bodyDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/common_runtime/function_body.h", "FunctionBody");
}
