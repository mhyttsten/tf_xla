...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc() {
      // Check if tracing is enabled
...
struct Endpoint {
  ...
  string name() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_0(mht_0_v, 242, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "name");
  ...
  DataType dtype() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_1(mht_1_v, 253, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "dtype");
...
static Node* AddNoOp(StringPiece name, Graph* g) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_2(mht_2_v, 274, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "AddNoOp");
...
static Node* AddIdentity(StringPiece name, Graph* g, Endpoint input) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_3(mht_3_v, 287, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "AddIdentity");
...
class DefaultFunctionBodyPlacer : public InlinedFunctionBodyPlacer {
 public:
  explicit DefaultFunctionBodyPlacer(const Node& caller)
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_4(mht_4_v, 336, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "DefaultFunctionBodyPlacer");
}
  ...
  bool ColocateInputOutputIdentities() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_5(mht_5_v, 347, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "ColocateInputOutputIdentities");
 return false; }
...
class SingleDeviceFunctionBodyPlacer : public InlinedFunctionBodyPlacer {
 public:
  explicit SingleDeviceFunctionBodyPlacer(const Node& caller)
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_6(mht_6_v, 366, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "SingleDeviceFunctionBodyPlacer");
}
  ...
  bool ColocateInputOutputIdentities() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_7(mht_7_v, 377, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "ColocateInputOutputIdentities");
 return false; }
  absl::optional<string> ControlNodeDevice() const override {
    return caller_device_;
  }
...
class MultiDeviceFunctionBodyPlacer : public InlinedFunctionBodyPlacer {
 public:
  explicit MultiDeviceFunctionBodyPlacer(const Node& caller)
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_8(mht_8_v, 400, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "MultiDeviceFunctionBodyPlacer");
  ...
  bool ColocateInputOutputIdentities() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_9(mht_9_v, 414, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "ColocateInputOutputIdentities");
 return true; }
  absl::optional<string> ControlNodeDevice() const override {
    return caller_device_;
  }
...
InlinedFunctionBodyPlacer::DefaultPlacer(const Graph& graph,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_10(mht_10_v, 452, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "InlinedFunctionBodyPlacer::DefaultPlacer");
...
InlinedFunctionBodyPlacer::SingleDevicePlacer(const Graph& graph,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_11(mht_11_v, 462, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "InlinedFunctionBodyPlacer::SingleDevicePlacer");
...
InlinedFunctionBodyPlacer::MultiDevicePlacer(const Graph& graph,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_12(mht_12_v, 472, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "InlinedFunctionBodyPlacer::MultiDevicePlacer");
...
Status ValidateNoInline(const FunctionBody* fbody) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_13(mht_13_v, 482, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "ValidateNoInline");
...
void PropagateDebugInfoToNode(const string& func,
   ...
   mht_14_v.push_back("func: \"" + func + "\"");
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_14(mht_14_v, 503, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "PropagateDebugInfoToNode");
...
string InlineFunctionBodyOptions::DebugString() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_15(mht_15_v, 524, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "InlineFunctionBodyOptions::DebugString");

  const auto true_false = [](bool b) {
   std::vector<std::string> mht_16_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_16(mht_16_v, 528, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "lambda");
 return b ? "true" : "false"; };
...
Status ValidateInlining(const Node* node, const FunctionBody* fbody,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_17(mht_17_v, 557, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "ValidateInlining");
...
Status InlineFunctionBody(const FunctionLibraryDefinition& flib_def, Graph* g,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_18(mht_18_v, 704, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "InlineFunctionBody");
...
bool ExpandInlineFunctions(FunctionLibraryRuntime* lib, Graph* graph,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSinline_function_utilsDTcc mht_19(mht_19_v, 1084, "", "./tensorflow/core/common_runtime/inline_function_utils.cc", "ExpandInlineFunctions");
