...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_factoryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_factoryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_factoryDTcc() {
      // Check if tracing is enabled
...
class ThreadPoolDeviceFactory : public DeviceFactory {
 public:
  Status ListPhysicalDevices(std::vector<string>* devices) override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_factoryDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/common_runtime/threadpool_device_factory.cc", "ListPhysicalDevices");
  ...
  Status CreateDevices(const SessionOptions& options, const string& name_prefix,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_device_factoryDTcc mht_1(mht_1_v, 212, "", "./tensorflow/core/common_runtime/threadpool_device_factory.cc", "CreateDevices");
