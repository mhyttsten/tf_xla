...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTcc() {
      // Check if tracing is enabled
...
std::unique_ptr<CompositeDevice> CompositeDevice::MakeDevice(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/common_runtime/composite_device.cc", "CompositeDevice::MakeDevice");
...
std::unique_ptr<CompositeDevice> CompositeDevice::MakeDevice(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScomposite_deviceDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/common_runtime/composite_device.cc", "CompositeDevice::MakeDevice");
