...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registry_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registry_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registry_testDTcc() {
      // Check if tracing is enabled
...
class TestCostMeasurement : public CostMeasurement {
 public:
  ...
  absl::Duration GetTotalCost() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registry_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/common_runtime/cost_measurement_registry_test.cc", "GetTotalCost");
 return absl::ZeroDuration(); }
  absl::string_view GetCostType() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registry_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/common_runtime/cost_measurement_registry_test.cc", "GetCostType");
 return kTestCostName; }
};
...
TEST(CostMeasurementRegistryDeathTest, CrashWhenRegisterTwice) {
  const auto creator = [](const CostMeasurement::Context& context) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScost_measurement_registry_testDTcc mht_2(mht_2_v, 226, "", "./tensorflow/core/common_runtime/cost_measurement_registry_test.cc", "lambda");
