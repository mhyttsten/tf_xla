...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_local_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_local_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_local_testDTcc() {
      // Check if tracing is enabled
...
class CollectiveRemoteAccessLocalTest : public ::testing::Test {
 protected:
  ...
  CollectiveRemoteAccessLocalTest() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScollective_rma_local_testDTcc mht_0(mht_0_v, 210, "", "./tensorflow/core/common_runtime/collective_rma_local_test.cc", "CollectiveRemoteAccessLocalTest");
