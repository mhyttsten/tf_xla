...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSbuild_graph_optionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSbuild_graph_optionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSbuild_graph_optionsDTcc() {
      // Check if tracing is enabled
...
string BuildGraphOptions::DebugString() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSbuild_graph_optionsDTcc mht_0(mht_0_v, 191, "", "./tensorflow/core/common_runtime/build_graph_options.cc", "BuildGraphOptions::DebugString");
