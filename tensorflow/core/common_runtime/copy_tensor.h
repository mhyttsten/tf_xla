...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePScopy_tensorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScopy_tensorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePScopy_tensorDTh() {
      // Check if tracing is enabled
...
class CopyTensor {
 public:
  ...
  class Registration {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePScopy_tensorDTh mht_0(mht_0_v, 226, "", "./tensorflow/core/common_runtime/copy_tensor.h", "Registration");
