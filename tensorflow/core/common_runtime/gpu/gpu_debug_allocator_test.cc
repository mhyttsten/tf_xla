...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocator_testDTcc() {
      // Check if tracing is enabled
...
se::StreamExecutor* ExecutorForPlatformDeviceId(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocator_testDTcc mht_0(mht_0_v, 210, "", "./tensorflow/core/common_runtime/gpu/gpu_debug_allocator_test.cc", "ExecutorForPlatformDeviceId");
