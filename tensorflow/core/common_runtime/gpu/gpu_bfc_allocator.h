...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTh() {
      // Check if tracing is enabled
...
class GPUBFCAllocator : public BFCAllocator {
 public:
  ...
  ~GPUBFCAllocator() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTh mht_0(mht_0_v, 227, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator.h", "~GPUBFCAllocator");
}
