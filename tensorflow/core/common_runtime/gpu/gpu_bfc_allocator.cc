...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTcc() {
      // Check if tracing is enabled
...
bool GetAllowGrowthValue(bool orig_value) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator.cc", "GetAllowGrowthValue");
...
bool GetGarbageCollectionValue() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTcc mht_1(mht_1_v, 230, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator.cc", "GetGarbageCollectionValue");
...
GPUBFCAllocator::GPUBFCAllocator(std::unique_ptr<SubAllocator> sub_allocator,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocatorDTcc mht_2(mht_2_v, 270, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator.cc", "GPUBFCAllocator::GPUBFCAllocator");
}
