...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc() {
      // Check if tracing is enabled
...
int64_t GetTotalGPUMemory(PlatformDeviceId gpu_id) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "GetTotalGPUMemory");
...
se::CudaComputeCapability GetComputeCapability() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_1(mht_1_v, 217, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "GetComputeCapability");
...
void ExpectErrorMessageSubstr(const Status& s, StringPiece substr) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_2(mht_2_v, 228, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "ExpectErrorMessageSubstr");
...
class GPUDeviceTest : public ::testing::Test {
 public:
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_3(mht_3_v, 239, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "TearDown");
 ...
 protected:
  ...
  void InitCPUTensor(Tensor* cpu_tensor, int num_elements, float value) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_4(mht_4_v, 278, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "InitCPUTensor");
  ...
  void CopyCPUToGPU(Tensor* cpu_tensor, Tensor* gpu_tensor, Device* device,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_5(mht_5_v, 289, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "CopyCPUToGPU");
  ...
  void CopyGPUToCPU(Tensor* gpu_tensor, Tensor* cpu_tensor, Device* device,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_6(mht_6_v, 298, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "CopyGPUToCPU");
...
class GPUKernelTrackerTest : public ::testing::Test {
 protected:
  void Init(const GPUKernelTracker::Params& params) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_7(mht_7_v, 729, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "Init");
  ...
  void RecordQueued(uint64 v) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_device_testDTcc mht_8(mht_8_v, 739, "", "./tensorflow/core/common_runtime/gpu/gpu_device_test.cc", "RecordQueued");
