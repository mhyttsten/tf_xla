...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocatorDTh() {
      // Check if tracing is enabled
...
class GPUDebugAllocator : public Allocator {
 public:
  ...
  string Name() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocatorDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/common_runtime/gpu/gpu_debug_allocator.h", "Name");
 return "gpu_debug"; }
...
class GPUNanResetAllocator : public Allocator {
 public:
  ...
  string Name() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocatorDTh mht_1(mht_1_v, 241, "", "./tensorflow/core/common_runtime/gpu/gpu_debug_allocator.h", "Name");
 return "gpu_nan_reset"; }
  void* AllocateRaw(size_t alignment, size_t num_bytes) override;
  void DeallocateRaw(void* ptr) override;
  size_t RequestedSize(const void* ptr) const override;
  size_t AllocatedSize(const void* ptr) const override;
  ...
  AllocatorMemoryType GetMemoryType() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_debug_allocatorDTh mht_2(mht_2_v, 252, "", "./tensorflow/core/common_runtime/gpu/gpu_debug_allocator.h", "GetMemoryType");
