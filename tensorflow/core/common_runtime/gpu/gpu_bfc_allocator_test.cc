...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc() {
      // Check if tracing is enabled
...
void CheckStats(Allocator* a, int64_t num_allocs, int64_t bytes_in_use,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_0(mht_0_v, 215, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "CheckStats");
...
auto TestSuiteValues() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_1(mht_1_v, 267, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "TestSuiteValues");
...
static void BM_Allocation(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_2(mht_2_v, 510, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "BM_Allocation");
...
static void BM_AllocationThreaded(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_3(mht_3_v, 529, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "BM_AllocationThreaded");
...
static void BM_AllocationDelayed(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_4(mht_4_v, 578, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "BM_AllocationDelayed");
...
class GPUBFCAllocatorPrivateMethodsTest
 ...
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_5(mht_5_v, 618, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "SetUp");
 CHECK_EQ(unsetenv("TF_FORCE_GPU_ALLOW_GROWTH"), 0); }
  ...
  void TestBinDebugInfo() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_6(mht_6_v, 627, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "TestBinDebugInfo");
  ...
  void TestLog2FloorNonZeroSlow() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_7(mht_7_v, 726, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "TestLog2FloorNonZeroSlow");
  ...
  void TestForceAllowGrowth() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_8(mht_8_v, 741, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "TestForceAllowGrowth");
...
class GPUBFCAllocatorPrivateMethodsTest_SubAllocatorSpecific
 ...
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_9(mht_9_v, 856, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "SetUp");
 CHECK_EQ(unsetenv("TF_FORCE_GPU_ALLOW_GROWTH"), 0); }

  void TestRegionDeallocation() {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgpuPSgpu_bfc_allocator_testDTcc mht_10(mht_10_v, 861, "", "./tensorflow/core/common_runtime/gpu/gpu_bfc_allocator_test.cc", "TestRegionDeallocation");
