...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh() {
      // Check if tracing is enabled
...
struct ClientGraph {
  explicit ClientGraph(std::unique_ptr<FunctionLibraryDefinition> flib,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh mht_0(mht_0_v, 231, "", "./tensorflow/core/common_runtime/graph_execution_state.h", "ClientGraph");
}
...
class GraphExecutionState {
 public:
  ...
  const Graph* full_graph() {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh mht_1(mht_1_v, 321, "", "./tensorflow/core/common_runtime/graph_execution_state.h", "full_graph");
 return graph_; }

  // The original graph.
  GraphDef* original_graph_def() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh mht_2(mht_2_v, 327, "", "./tensorflow/core/common_runtime/graph_execution_state.h", "original_graph_def");
 return original_graph_def_.get(); }
  ...
  const FunctionLibraryDefinition& flib_def() const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh mht_3(mht_3_v, 333, "", "./tensorflow/core/common_runtime/graph_execution_state.h", "flib_def");
 return *flib_def_; }
  ...
  const Node* get_node_by_name(const string& name) const {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSgraph_execution_stateDTh mht_4(mht_4_v, 340, "", "./tensorflow/core/common_runtime/graph_execution_state.h", "get_node_by_name");
