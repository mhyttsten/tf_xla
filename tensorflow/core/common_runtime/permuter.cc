...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc() {
      // Check if tracing is enabled
...
Permuter::Permuter()
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/common_runtime/permuter.cc", "Permuter::Permuter");
}

StatusCallback Permuter::CheckCounterAndCallDone() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/common_runtime/permuter.cc", "Permuter::CheckCounterAndCallDone");

  return [this](const Status& s) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_2(mht_2_v, 218, "", "./tensorflow/core/common_runtime/permuter.cc", "lambda");
...
Status Permuter::InitializeCollectiveContext(
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_3(mht_3_v, 232, "", "./tensorflow/core/common_runtime/permuter.cc", "Permuter::InitializeCollectiveContext");
...
void Permuter::Run(StatusCallback done) {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_4(mht_4_v, 244, "", "./tensorflow/core/common_runtime/permuter.cc", "Permuter::Run");
...
void Permuter::DispatchSend(int src_rank, int target_rank, const Tensor* tensor,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_5(mht_5_v, 265, "", "./tensorflow/core/common_runtime/permuter.cc", "Permuter::DispatchSend");
...
void Permuter::DispatchRecv(int src_rank, int target_rank, Tensor* tensor,
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSpermuterDTcc mht_6(mht_6_v, 284, "", "./tensorflow/core/common_runtime/permuter.cc", "Permuter::DispatchRecv");
