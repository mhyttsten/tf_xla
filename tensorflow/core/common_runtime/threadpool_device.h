...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_deviceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_deviceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_deviceDTh() {
      // Check if tracing is enabled
...
class ThreadPoolDevice : public LocalDevice {
 public:
  ...
  ScopedAllocatorMgr* GetScopedAllocatorMgr() const override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_deviceDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/common_runtime/threadpool_device.h", "GetScopedAllocatorMgr");
  ...
  Status Sync() override {
   ...
   MHTracer_DTPStensorflowPScorePScommon_runtimePSthreadpool_deviceDTh mht_1(mht_1_v, 218, "", "./tensorflow/core/common_runtime/threadpool_device.h", "Sync");
 return Status::OK(); }
