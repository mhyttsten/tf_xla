...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSparse_annotationDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSparse_annotationDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSparse_annotationDTh() {
      // Check if tracing is enabled
...
inline bool HasMetadata(absl::string_view annotation) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSparse_annotationDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/profiler/utils/parse_annotation.h", "HasMetadata");
