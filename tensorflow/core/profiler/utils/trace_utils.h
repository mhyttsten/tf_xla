...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSutilsPStrace_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPStrace_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSutilsPStrace_utilsDTh() {
      // Check if tracing is enabled
...
static inline bool IsDerivedThreadId(int thread_id) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPStrace_utilsDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/profiler/utils/trace_utils.h", "IsDerivedThreadId");
