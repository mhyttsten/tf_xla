...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSstep_intersectionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSstep_intersectionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSstep_intersectionDTh() {
      // Check if tracing is enabled
...
class StepIntersection {
 public:
  ...
  uint32 NumSteps() const {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSstep_intersectionDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/profiler/utils/step_intersection.h", "NumSteps");
 return end_chief_idx_ - begin_chief_idx_; }

  // Returns the value of empty_intersect_ (see the explanation of
  // empty_intersect_ below).
  bool EmptyIntersect() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSstep_intersectionDTh mht_1(mht_1_v, 220, "", "./tensorflow/core/profiler/utils/step_intersection.h", "EmptyIntersect");
 return empty_intersect_; }
  ...
  uint32 StepsDropped() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSstep_intersectionDTh mht_2(mht_2_v, 235, "", "./tensorflow/core/profiler/utils/step_intersection.h", "StepsDropped");
 return steps_dropped_; }
