...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSdevice_caps_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSdevice_caps_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSdevice_caps_utilsDTcc() {
      // Check if tracing is enabled
...
void SetDeviceCaps(const DeviceCapabilities& caps, XPlane* plane) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSdevice_caps_utilsDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/profiler/utils/device_caps_utils.cc", "SetDeviceCaps");
...
DeviceCapabilities GetDeviceCaps(const XPlane& plane) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSdevice_caps_utilsDTcc mht_1(mht_1_v, 227, "", "./tensorflow/core/profiler/utils/device_caps_utils.cc", "GetDeviceCaps");
