...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSop_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSop_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSop_utilsDTh() {
      // Check if tracing is enabled
...
class HostOpMetricsDbBuilder : public OpMetricsDbBuilder {
 public:
  explicit HostOpMetricsDbBuilder(OpMetricsDb* db) : OpMetricsDbBuilder(db) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSop_utilsDTh mht_0(mht_0_v, 200, "", "./tensorflow/core/profiler/utils/op_utils.h", "HostOpMetricsDbBuilder");
}
...
class DeviceOpMetricsDbBuilder : public OpMetricsDbBuilder {
 public:
  explicit DeviceOpMetricsDbBuilder(OpMetricsDb* db) : OpMetricsDbBuilder(db) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSutilsPSop_utilsDTh mht_1(mht_1_v, 228, "", "./tensorflow/core/profiler/utils/op_utils.h", "DeviceOpMetricsDbBuilder");
}
