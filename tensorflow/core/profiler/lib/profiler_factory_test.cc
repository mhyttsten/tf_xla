...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc() {
      // Check if tracing is enabled
...
class TestProfiler : public ProfilerInterface {
 public:
  Status Start() override {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/profiler/lib/profiler_factory_test.cc", "Start");
 return Status::OK(); }
  Status Stop() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/profiler/lib/profiler_factory_test.cc", "Stop");
 return Status::OK(); }
  Status CollectData(XSpace*) override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc mht_2(mht_2_v, 210, "", "./tensorflow/core/profiler/lib/profiler_factory_test.cc", "CollectData");
 return Status::OK(); }
};
...
class FactoryClass {
 public:
  explicit FactoryClass(void* ptr) : ptr_(ptr) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_factory_testDTcc mht_3(mht_3_v, 251, "", "./tensorflow/core/profiler/lib/profiler_factory_test.cc", "FactoryClass");
}
