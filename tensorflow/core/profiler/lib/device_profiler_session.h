...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSlibPSdevice_profiler_sessionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSdevice_profiler_sessionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSlibPSdevice_profiler_sessionDTh() {
      // Check if tracing is enabled
...
class DeviceProfilerSession {
 public:
  ...
  Status CollectData(StepStats* step_stats) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSdevice_profiler_sessionDTh mht_0(mht_0_v, 221, "", "./tensorflow/core/profiler/lib/device_profiler_session.h", "CollectData");
