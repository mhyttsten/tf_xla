...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSlibPSannotated_tracemeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSannotated_tracemeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSlibPSannotated_tracemeDTh() {
      // Check if tracing is enabled
...
class AnnotatedTraceMe {
 public:
  ...
  explicit AnnotatedTraceMe(NameGeneratorT&& name_generator, int level = 1) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSannotated_tracemeDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/profiler/lib/annotated_traceme.h", "AnnotatedTraceMe");
