...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_lockDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_lockDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_lockDTcc() {
      // Check if tracing is enabled
...
/*static*/ StatusOr<ProfilerLock> ProfilerLock::Acquire() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_lockDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/profiler/lib/profiler_lock.cc", "ProfilerLock::Acquire");
...
void ProfilerLock::ReleaseIfActive() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_lockDTcc mht_1(mht_1_v, 231, "", "./tensorflow/core/profiler/lib/profiler_lock.cc", "ProfilerLock::ReleaseIfActive");
