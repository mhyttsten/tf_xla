...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSlibPScontext_typesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPScontext_typesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSlibPScontext_typesDTh() {
      // Check if tracing is enabled
...
inline ContextType GetSafeContextType(uint32_t context_type) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPScontext_typesDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/profiler/lib/context_types.h", "GetSafeContextType");
