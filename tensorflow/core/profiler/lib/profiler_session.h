...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_sessionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_sessionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_sessionDTh() {
      // Check if tracing is enabled
...
class ProfilerSession {
 public:
  ...
  static ProfileOptions DefaultOptions() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSlibPSprofiler_sessionDTh mht_0(mht_0_v, 216, "", "./tensorflow/core/profiler/lib/profiler_session.h", "DefaultOptions");
