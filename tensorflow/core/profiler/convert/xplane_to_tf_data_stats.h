...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSxplane_to_tf_data_statsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSxplane_to_tf_data_statsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSxplane_to_tf_data_statsDTh() {
      // Check if tracing is enabled
...
class CombinedTfDataStatsBuilder {
 public:
  explicit CombinedTfDataStatsBuilder(
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSxplane_to_tf_data_statsDTh mht_0(mht_0_v, 216, "", "./tensorflow/core/profiler/convert/xplane_to_tf_data_stats.h", "CombinedTfDataStatsBuilder");
}
