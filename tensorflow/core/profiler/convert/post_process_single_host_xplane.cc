...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSpost_process_single_host_xplaneDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSpost_process_single_host_xplaneDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSpost_process_single_host_xplaneDTcc() {
      // Check if tracing is enabled
...
void MergeHostPlanesAndSortLines(XSpace* space) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSpost_process_single_host_xplaneDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/profiler/convert/post_process_single_host_xplane.cc", "MergeHostPlanesAndSortLines");
...
void PostProcessSingleHostXSpace(XSpace* space, uint64 start_time_ns) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSpost_process_single_host_xplaneDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/profiler/convert/post_process_single_host_xplane.cc", "PostProcessSingleHostXSpace");
