...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewer_testDTcc() {
      // Check if tracing is enabled
...
void CreateOpStats(OpStats* op_stats) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewer_testDTcc mht_0(mht_0_v, 224, "", "./tensorflow/core/profiler/convert/op_stats_to_pod_viewer_test.cc", "CreateOpStats");
