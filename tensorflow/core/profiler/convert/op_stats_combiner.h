...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_combinerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_combinerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_combinerDTh() {
      // Check if tracing is enabled
...
void CombineCoreIdMap(int src_host_id, const CoreIdMap& src, CoreIdMap* dst) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_combinerDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/profiler/convert/op_stats_combiner.h", "CombineCoreIdMap");
...
struct OpStatsInfo {
  OpStatsInfo(const OpStats* op_stats, HardwareType hardware_type,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_combinerDTh mht_1(mht_1_v, 232, "", "./tensorflow/core/profiler/convert/op_stats_combiner.h", "OpStatsInfo");
}
