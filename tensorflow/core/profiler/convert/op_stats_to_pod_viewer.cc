...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewerDTcc() {
      // Check if tracing is enabled
...
PodStatsSequence ConvertOpStatsToPodStatsSequence(const OpStats& op_stats,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewerDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/profiler/convert/op_stats_to_pod_viewer.cc", "ConvertOpStatsToPodStatsSequence");
...
PodViewerDatabase ConvertOpStatsToPodViewer(const OpStats& op_stats) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_pod_viewerDTcc mht_1(mht_1_v, 221, "", "./tensorflow/core/profiler/convert/op_stats_to_pod_viewer.cc", "ConvertOpStatsToPodViewer");
