...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_tf_stats_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_tf_stats_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_tf_stats_testDTcc() {
      // Check if tracing is enabled
...
XEventBuilder AddTensorFlowOpEvent(std::string&& tf_op_fullname,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_tf_stats_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/profiler/convert/op_stats_to_tf_stats_test.cc", "AddTensorFlowOpEvent");
...
void AddTensorFlowOpEventWithKernelDetails(std::string&& tf_op_fullname,
   ...
   mht_1_v.push_back("kernel_details: \"" + std::string(kernel_details.data(), kernel_details.size()) + "\"");
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_stats_to_tf_stats_testDTcc mht_1(mht_1_v, 232, "", "./tensorflow/core/profiler/convert/op_stats_to_tf_stats_test.cc", "AddTensorFlowOpEventWithKernelDetails");
