...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_metrics_db_combinerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_metrics_db_combinerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_metrics_db_combinerDTh() {
      // Check if tracing is enabled
...
class OpMetricsDbCombiner : public OpMetricsDbBuilder {
 public:
  explicit OpMetricsDbCombiner(OpMetricsDb* dst) : OpMetricsDbBuilder(dst) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSconvertPSop_metrics_db_combinerDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/profiler/convert/op_metrics_db_combiner.h", "OpMetricsDbCombiner");
}
