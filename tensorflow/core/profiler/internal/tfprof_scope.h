...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_scopeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_scopeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_scopeDTh() {
      // Check if tracing is enabled
...
class TFScope : public TFShow {
 public:
  explicit TFScope(checkpoint::CheckpointReader* ckpt_reader)
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_scopeDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/profiler/internal/tfprof_scope.h", "TFScope");
}
  ~TFScope() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_scopeDTh mht_1(mht_1_v, 216, "", "./tensorflow/core/profiler/internal/tfprof_scope.h", "~TFScope");
}
