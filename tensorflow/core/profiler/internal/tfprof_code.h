...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_codeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_codeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_codeDTh() {
      // Check if tracing is enabled
...
class PprofProfile {
 public:
  virtual ~PprofProfile() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_codeDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/profiler/internal/tfprof_code.h", "~PprofProfile");
}
...
class TFCode : public TFMultiShow {
 public:
  TFCode() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_codeDTh mht_1(mht_1_v, 229, "", "./tensorflow/core/profiler/internal/tfprof_code.h", "TFCode");
}
  ~TFCode() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_codeDTh mht_2(mht_2_v, 233, "", "./tensorflow/core/profiler/internal/tfprof_code.h", "~TFCode");
}
