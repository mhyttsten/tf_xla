...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_opDTh() {
      // Check if tracing is enabled
...
class TFOp : public TFMultiShow {
 public:
  explicit TFOp() : TFMultiShow() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_opDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/profiler/internal/tfprof_op.h", "TFOp");
}
  ~TFOp() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_opDTh mht_1(mht_1_v, 217, "", "./tensorflow/core/profiler/internal/tfprof_op.h", "~TFOp");
}
 ...
 private:
  ...
  bool ShouldShowIfExtra(const ShowMultiNode* node, const Options& opts,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_opDTh mht_2(mht_2_v, 234, "", "./tensorflow/core/profiler/internal/tfprof_op.h", "ShouldShowIfExtra");
