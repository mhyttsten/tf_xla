...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPStfprof_advisorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPStfprof_advisorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPStfprof_advisorDTh() {
      // Check if tracing is enabled
...
class Advisor {
 public:
  Advisor(const TFStats* stats) : stats_(stats) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPStfprof_advisorDTh mht_0(mht_0_v, 202, "", "./tensorflow/core/profiler/internal/advisor/tfprof_advisor.h", "Advisor");
}

  static AdvisorOptionsProto DefaultOptions() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPStfprof_advisorDTh mht_1(mht_1_v, 207, "", "./tensorflow/core/profiler/internal/advisor/tfprof_advisor.h", "DefaultOptions");
  ...
  AdviceProto Advise(const AdvisorOptionsProto& options) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPStfprof_advisorDTh mht_2(mht_2_v, 220, "", "./tensorflow/core/profiler/internal/advisor/tfprof_advisor.h", "Advise");
