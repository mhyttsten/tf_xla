...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPSoperation_checkerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPSoperation_checkerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPSoperation_checkerDTh() {
      // Check if tracing is enabled
...
class OperationChecker : public Checker {
 public:
  string name() const override {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPSoperation_checkerDTh mht_0(mht_0_v, 197, "", "./tensorflow/core/profiler/internal/advisor/operation_checker.h", "name");
 return kCheckers[1]; }
 ...
 private:
  AdviceProto::Checker Check(const AdvisorOptionsProto::CheckerOption& options,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSadvisorPSoperation_checkerDTh mht_1(mht_1_v, 204, "", "./tensorflow/core/profiler/internal/advisor/operation_checker.h", "Check");
