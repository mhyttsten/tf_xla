...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh() {
      // Check if tracing is enabled
...
class TFShow {
 public:
  explicit TFShow(checkpoint::CheckpointReader* ckpt_reader)
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh mht_0(mht_0_v, 211, "", "./tensorflow/core/profiler/internal/tfprof_show.h", "TFShow");
}
  virtual ~TFShow() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/profiler/internal/tfprof_show.h", "~TFShow");
}
 ...
 protected:
  ...
  virtual bool ShouldShowIfExtra(const ShowNode* node, const Options& opts,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh mht_2(mht_2_v, 233, "", "./tensorflow/core/profiler/internal/tfprof_show.h", "ShouldShowIfExtra");
...
string FormatTotalExecTime(const T* node, const Options& opts) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh mht_3(mht_3_v, 303, "", "./tensorflow/core/profiler/internal/tfprof_show.h", "FormatTotalExecTime");
...
string FormatCPUExecTime(const T* node, const Options& opts) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh mht_4(mht_4_v, 316, "", "./tensorflow/core/profiler/internal/tfprof_show.h", "FormatCPUExecTime");
...
string FormatAcceleratorExecTime(const T* node, const Options& opts) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_showDTh mht_5(mht_5_v, 329, "", "./tensorflow/core/profiler/internal/tfprof_show.h", "FormatAcceleratorExecTime");
