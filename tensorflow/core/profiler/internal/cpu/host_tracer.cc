...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc() {
      // Check if tracing is enabled
...
HostTracer::HostTracer(int host_trace_level)
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc mht_0(mht_0_v, 235, "", "./tensorflow/core/profiler/internal/cpu/host_tracer.cc", "HostTracer::HostTracer");
}

HostTracer::~HostTracer() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc mht_1(mht_1_v, 240, "", "./tensorflow/core/profiler/internal/cpu/host_tracer.cc", "HostTracer::~HostTracer");
 Stop().IgnoreError(); }

Status HostTracer::Start() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc mht_2(mht_2_v, 245, "", "./tensorflow/core/profiler/internal/cpu/host_tracer.cc", "HostTracer::Start");
...
Status HostTracer::Stop() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc mht_3(mht_3_v, 264, "", "./tensorflow/core/profiler/internal/cpu/host_tracer.cc", "HostTracer::Stop");
...
Status HostTracer::CollectData(XSpace* space) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracerDTcc mht_4(mht_4_v, 276, "", "./tensorflow/core/profiler/internal/cpu/host_tracer.cc", "HostTracer::CollectData");
