...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracer_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracer_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracer_utilsDTcc() {
      // Check if tracing is enabled
...
void MayAddDisplayName(XEventMetadata* xevent_metadata) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracer_utilsDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/profiler/internal/cpu/host_tracer_utils.cc", "MayAddDisplayName");
...
void ConvertCompleteEventsToXPlane(uint64 start_timestamp_ns,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPShost_tracer_utilsDTcc mht_1(mht_1_v, 217, "", "./tensorflow/core/profiler/internal/cpu/host_tracer_utils.cc", "ConvertCompleteEventsToXPlane");
