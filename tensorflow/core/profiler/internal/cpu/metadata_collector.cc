...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSmetadata_collectorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSmetadata_collectorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSmetadata_collectorDTcc() {
      // Check if tracing is enabled
...
class MetadataCollector : public ProfilerInterface {
 public:
  ...
  Status Start() override {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSmetadata_collectorDTcc mht_0(mht_0_v, 226, "", "./tensorflow/core/profiler/internal/cpu/metadata_collector.cc", "Start");
  ...
  Status Stop() override {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSmetadata_collectorDTcc mht_1(mht_1_v, 237, "", "./tensorflow/core/profiler/internal/cpu/metadata_collector.cc", "Stop");
  ...
  Status CollectData(XSpace* space) override {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSmetadata_collectorDTcc mht_2(mht_2_v, 248, "", "./tensorflow/core/profiler/internal/cpu/metadata_collector.cc", "CollectData");
