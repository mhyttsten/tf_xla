...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh() {
      // Check if tracing is enabled
...
class AnnotationStack {
 public:
  ...
  static size_t PushAnnotation(absl::string_view name) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh mht_0(mht_0_v, 216, "", "./tensorflow/core/profiler/internal/cpu/annotation_stack.h", "PushAnnotation");
  ...
  static size_t PushAnnotation(string&& name) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh mht_1(mht_1_v, 230, "", "./tensorflow/core/profiler/internal/cpu/annotation_stack.h", "PushAnnotation");
  ...
  static const string& Get() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh mht_2(mht_2_v, 245, "", "./tensorflow/core/profiler/internal/cpu/annotation_stack.h", "Get");
 return *ThreadAnnotationStack(); }

  // Resizes the annotation stack for the current thread to its old length.
  static void PopAnnotation(size_t old_length) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh mht_3(mht_3_v, 251, "", "./tensorflow/core/profiler/internal/cpu/annotation_stack.h", "PopAnnotation");
  ...
  static void Enable(bool enable) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh mht_4(mht_4_v, 258, "", "./tensorflow/core/profiler/internal/cpu/annotation_stack.h", "Enable");
  ...
  static bool IsEnabled() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPScpuPSannotation_stackDTh mht_5(mht_5_v, 265, "", "./tensorflow/core/profiler/internal/cpu/annotation_stack.h", "IsEnabled");
