...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_graphDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_graphDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_graphDTh() {
      // Check if tracing is enabled
...
class TFGraph : public TFShow {
 public:
  explicit TFGraph(checkpoint::CheckpointReader* ckpt_reader)
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_graphDTh mht_0(mht_0_v, 215, "", "./tensorflow/core/profiler/internal/tfprof_graph.h", "TFGraph");
}
  ~TFGraph() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_graphDTh mht_1(mht_1_v, 219, "", "./tensorflow/core/profiler/internal/tfprof_graph.h", "~TFGraph");
}
 ...
 private:
  ...
  bool ShouldShowIfExtra(const ShowNode* node, const Options& opts,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_graphDTh mht_2(mht_2_v, 233, "", "./tensorflow/core/profiler/internal/tfprof_graph.h", "ShouldShowIfExtra");
