...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensorDTcc() {
      // Check if tracing is enabled
...
void TFProfTensor::Display(string* formatted_str,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensorDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/profiler/internal/tfprof_tensor.cc", "TFProfTensor::Display");
...
void TFProfTensor::Build() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensorDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/profiler/internal/tfprof_tensor.cc", "TFProfTensor::Build");
