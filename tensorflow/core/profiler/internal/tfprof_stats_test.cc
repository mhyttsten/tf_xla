...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_stats_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_stats_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_stats_testDTcc() {
      // Check if tracing is enabled
...
class TFProfStatsTest : public ::testing::Test {
 protected:
  TFProfStatsTest() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_stats_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/profiler/internal/tfprof_stats_test.cc", "TFProfStatsTest");
  ...
  string TestToFromProto(const string& cmd, const Options& opts) {
   ...
   mht_1_v.push_back("cmd: \"" + cmd + "\"");
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_stats_testDTcc mht_1(mht_1_v, 245, "", "./tensorflow/core/profiler/internal/tfprof_stats_test.cc", "TestToFromProto");
