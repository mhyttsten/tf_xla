...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_utilsDTh() {
      // Check if tracing is enabled
...
Status ReadProtoFile(Env* env, const string& fname, T* proto,
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_utilsDTh mht_0(mht_0_v, 216, "", "./tensorflow/core/profiler/internal/tfprof_utils.h", "ReadProtoFile");
