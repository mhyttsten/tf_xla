...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc() {
      // Check if tracing is enabled
...
class DeviceTracerTest : public ::testing::Test {
 public:
  void Initialize(std::initializer_list<float> a_values) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc mht_0(mht_0_v, 253, "", "./tensorflow/core/profiler/internal/gpu/device_tracer_test.cc", "Initialize");
 ...
 protected:
  void ExpectFailure(const Status& status, error::Code code) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc mht_1(mht_1_v, 285, "", "./tensorflow/core/profiler/internal/gpu/device_tracer_test.cc", "ExpectFailure");
...
void BM_CuptiTracer_ActivityBufferOverhead(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc mht_2(mht_2_v, 665, "", "./tensorflow/core/profiler/internal/gpu/device_tracer_test.cc", "BM_CuptiTracer_ActivityBufferOverhead");
...
void BM_CudaFree(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSdevice_tracer_testDTcc mht_3(mht_3_v, 681, "", "./tensorflow/core/profiler/internal/gpu/device_tracer_test.cc", "BM_CudaFree");
