...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSnvtx_utilsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSnvtx_utilsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSnvtx_utilsDTh() {
      // Check if tracing is enabled
...
class NVTXRangeTracker {
 public:
  static void EnterRange(const std::string& range) {
   ...
   mht_0_v.push_back("range: \"" + range + "\"");
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSnvtx_utilsDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/profiler/internal/gpu/nvtx_utils.h", "EnterRange");
  ...
  static void ExitRange() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSnvtx_utilsDTh mht_1(mht_1_v, 212, "", "./tensorflow/core/profiler/internal/gpu/nvtx_utils.h", "ExitRange");
  ...
  static const absl::string_view CurrentRange() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPSgpuPSnvtx_utilsDTh mht_2(mht_2_v, 219, "", "./tensorflow/core/profiler/internal/gpu/nvtx_utils.h", "CurrentRange");
