...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensor_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensor_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensor_testDTcc() {
      // Check if tracing is enabled
...
class TFProfTensorTest : public ::testing::Test {
 protected:
  TFProfTensorTest() {
   ...
   MHTracer_DTPStensorflowPScorePSprofilerPSinternalPStfprof_tensor_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/profiler/internal/tfprof_tensor_test.cc", "TFProfTensorTest");
