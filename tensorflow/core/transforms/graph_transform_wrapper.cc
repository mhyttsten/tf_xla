...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStransformsPSgraph_transform_wrapperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStransformsPSgraph_transform_wrapperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStransformsPSgraph_transform_wrapperDTcc() {
      // Check if tracing is enabled
...
tensorflow::Status RunTransformOnGraph(
   ...
   MHTracer_DTPStensorflowPScorePStransformsPSgraph_transform_wrapperDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/transforms/graph_transform_wrapper.cc", "RunTransformOnGraph");
