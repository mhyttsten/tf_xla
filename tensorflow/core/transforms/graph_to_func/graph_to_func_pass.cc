...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStransformsPSgraph_to_funcPSgraph_to_func_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStransformsPSgraph_to_funcPSgraph_to_func_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStransformsPSgraph_to_funcPSgraph_to_func_passDTcc() {
      // Check if tracing is enabled
...
struct GraphToFuncPass : GraphToFuncBase<GraphToFuncPass> {
  GraphToFuncPass(ArrayRef<std::string> feeds, ArrayRef<std::string> fetches) {
   ...
   MHTracer_DTPStensorflowPScorePStransformsPSgraph_to_funcPSgraph_to_func_passDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/transforms/graph_to_func/graph_to_func_pass.cc", "GraphToFuncPass");
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScorePStransformsPSgraph_to_funcPSgraph_to_func_passDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/transforms/graph_to_func/graph_to_func_pass.cc", "runOnOperation");
