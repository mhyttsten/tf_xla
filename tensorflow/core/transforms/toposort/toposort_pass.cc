...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStransformsPStoposortPStoposort_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStransformsPStoposortPStoposort_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStransformsPStoposortPStoposort_passDTcc() {
      // Check if tracing is enabled
...
void SortTopologically(Block *block) {
   ...
   MHTracer_DTPStensorflowPScorePStransformsPStoposortPStoposort_passDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/transforms/toposort/toposort_pass.cc", "SortTopologically");
...
struct TopoSortPass : TopoSortBase<TopoSortPass> {
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPScorePStransformsPStoposortPStoposort_passDTcc mht_1(mht_1_v, 254, "", "./tensorflow/core/transforms/toposort/toposort_pass.cc", "runOnOperation");
