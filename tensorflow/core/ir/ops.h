...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSopsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSopsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSopsDTh() {
      // Check if tracing is enabled
...
struct FunctionTable {
  ...
  bool empty() const {
   ...
   MHTracer_DTPStensorflowPScorePSirPSopsDTh mht_0(mht_0_v, 219, "", "./tensorflow/core/ir/ops.h", "empty");
