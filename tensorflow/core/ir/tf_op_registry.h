...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTh() {
      // Check if tracing is enabled
...
class TensorFlowOpRegistryInterface : public TensorFlowRegistryInterfaceBase {
 public:
  ...
  TensorFlowOpRegistryInterface(Dialect *dialect,
   ...
   MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTh mht_0(mht_0_v, 202, "", "./tensorflow/core/ir/tf_op_registry.h", "TensorFlowOpRegistryInterface");
}
