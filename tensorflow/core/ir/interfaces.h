...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSinterfacesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSinterfacesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSinterfacesDTh() {
      // Check if tracing is enabled
...
class TensorFlowRegistryInterfaceBase
 ...
 public:
  explicit TensorFlowRegistryInterfaceBase(Dialect *dialect)
   ...
   MHTracer_DTPStensorflowPScorePSirPSinterfacesDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/ir/interfaces.h", "TensorFlowRegistryInterfaceBase");
}
