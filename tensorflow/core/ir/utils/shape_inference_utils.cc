...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc() {
      // Check if tracing is enabled
...
llvm::StringRef GetTensorFlowOpName(Operation* inst) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_0(mht_0_v, 238, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "GetTensorFlowOpName");
...
NamedAttrList GetAllAttributesFromOperation(Operation* op) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_1(mht_1_v, 251, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "GetAllAttributesFromOperation");
...
LogicalResult EmitErrorFromShapeFunction(Optional<Location> location,
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_2(mht_2_v, 315, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "EmitErrorFromShapeFunction");
...
TensorType CreateTensorType(InferenceContext& context, const ShapeHandle& sh,
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_3(mht_3_v, 341, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "CreateTensorType");
...
ShapedTypeComponents CreateShapedTypeComponents(InferenceContext& context,
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_4(mht_4_v, 354, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "CreateShapedTypeComponents");
...
LogicalResult InferReturnTypeComponentsForTFOp(
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_5(mht_5_v, 372, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "InferReturnTypeComponentsForTFOp");
  ...
  auto requires_inputs = [&]() {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_6(mht_6_v, 450, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "lambda");
...
LogicalResult InferReturnTypeComponentsForTFOp(
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utilsDTcc mht_7(mht_7_v, 559, "", "./tensorflow/core/ir/utils/shape_inference_utils.cc", "InferReturnTypeComponentsForTFOp");
