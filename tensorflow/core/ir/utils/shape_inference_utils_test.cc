...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc() {
      // Check if tracing is enabled
...
class ShapeInferenceTest : public ::testing::Test {
 protected:
  ...
  ShapeInferenceTest() {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc mht_0(mht_0_v, 235, "", "./tensorflow/core/ir/utils/shape_inference_utils_test.cc", "ShapeInferenceTest");
  ...
  void VerifyInferredShapes(OpRange &&ops,
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc mht_1(mht_1_v, 249, "", "./tensorflow/core/ir/utils/shape_inference_utils_test.cc", "VerifyInferredShapes");
  ...
  ModuleOp GetModule() {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc mht_2(mht_2_v, 268, "", "./tensorflow/core/ir/utils/shape_inference_utils_test.cc", "GetModule");
 return module_.get(); }
  MLIRContext *GetContext() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc mht_3(mht_3_v, 272, "", "./tensorflow/core/ir/utils/shape_inference_utils_test.cc", "GetContext");
 return &context_; }
...
TEST_F(ShapeInferenceTest, TestInferenceFailure) {
  ...
  auto get_empty_attr_values_fn =
      [](Operation *, llvm::StringRef, const tensorflow::OpRegistrationData *,
         bool, tensorflow::AttrValueMap *) {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc mht_4(mht_4_v, 401, "", "./tensorflow/core/ir/utils/shape_inference_utils_test.cc", "lambda");
 return tensorflow::Status::OK(); };
  ...
  auto error_attr_values_fn = [](Operation *, llvm::StringRef,
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilsPSshape_inference_utils_testDTcc mht_5(mht_5_v, 424, "", "./tensorflow/core/ir/utils/shape_inference_utils_test.cc", "lambda");
