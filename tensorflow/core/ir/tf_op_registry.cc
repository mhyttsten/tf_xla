...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTcc() {
      // Check if tracing is enabled
...
TensorFlowOpRegistryInterface::TensorFlowOpRegistryInterface(Dialect *dialect)
   ...
   MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/ir/tf_op_registry.cc", "TensorFlowOpRegistryInterface::TensorFlowOpRegistryInterface");
...
static bool IsStatefulImpl(tensorflow::OpRegistry *registry,
   ...
   MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTcc mht_1(mht_1_v, 202, "", "./tensorflow/core/ir/tf_op_registry.cc", "IsStatefulImpl");
...
bool TensorFlowOpRegistryInterface::isStateful(Operation *op) const {
   ...
   MHTracer_DTPStensorflowPScorePSirPStf_op_registryDTcc mht_2(mht_2_v, 213, "", "./tensorflow/core/ir/tf_op_registry.cc", "TensorFlowOpRegistryInterface::isStateful");
