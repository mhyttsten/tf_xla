...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSimportexportPStfgSLtranslateDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPStfgSLtranslateDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSimportexportPStfgSLtranslateDTcc() {
      // Check if tracing is enabled
...
TranslateFromMLIRRegistration mlir_to_graphdef(
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPStfgSLtranslateDTcc mht_0(mht_0_v, 230, "", "./tensorflow/core/ir/importexport/tfg-translate.cc", "lambda");
 registry.insert<tfg::TFGraphDialect>(); });
}  //  namespace mlir

int main(int argc, char **argv) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSirPSimportexportPStfgSLtranslateDTcc mht_1(mht_1_v, 236, "", "./tensorflow/core/ir/importexport/tfg-translate.cc", "main");
