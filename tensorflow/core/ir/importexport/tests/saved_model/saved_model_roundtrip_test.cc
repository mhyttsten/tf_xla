...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSimportexportPStestsPSsaved_modelPSsaved_model_roundtrip_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPStestsPSsaved_modelPSsaved_model_roundtrip_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSimportexportPStestsPSsaved_modelPSsaved_model_roundtrip_testDTcc() {
      // Check if tracing is enabled
...
tensorflow::Status ReadModelProto(const std::string& input_file,
   ...
   mht_0_v.push_back("input_file: \"" + input_file + "\"");
   MHTracer_DTPStensorflowPScorePSirPSimportexportPStestsPSsaved_modelPSsaved_model_roundtrip_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/ir/importexport/tests/saved_model/saved_model_roundtrip_test.cc", "ReadModelProto");
...
void RunRoundTrip(const std::string& input_file) {
   ...
   mht_1_v.push_back("input_file: \"" + input_file + "\"");
   MHTracer_DTPStensorflowPScorePSirPSimportexportPStestsPSsaved_modelPSsaved_model_roundtrip_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/core/ir/importexport/tests/saved_model/saved_model_roundtrip_test.cc", "RunRoundTrip");
