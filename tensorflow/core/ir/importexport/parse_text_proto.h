...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTh() {
      // Check if tracing is enabled
...
inline tensorflow::Status ParseTextProto(
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/ir/importexport/parse_text_proto.h", "ParseTextProto");
