...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTcc() {
      // Check if tracing is enabled
...
class NoOpErrorCollector : public tensorflow::protobuf::io::ErrorCollector {
 public:
  void AddError(int line, int column, const std::string& message) override {
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/ir/importexport/parse_text_proto.cc", "AddError");
}
};
}  // namespace
...
Status ConsumePrefix(absl::string_view str, absl::string_view prefix,
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/ir/importexport/parse_text_proto.cc", "ConsumePrefix");
...
Status ParseTextProto(absl::string_view text_proto,
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSparse_text_protoDTcc mht_2(mht_2_v, 231, "", "./tensorflow/core/ir/importexport/parse_text_proto.cc", "ParseTextProto");
