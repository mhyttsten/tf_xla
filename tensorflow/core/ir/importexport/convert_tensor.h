...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSimportexportPSconvert_tensorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSconvert_tensorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSimportexportPSconvert_tensorDTh() {
      // Check if tracing is enabled
...
void SetTensorShapeProto(ShapeContainerT shape,
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSconvert_tensorDTh mht_0(mht_0_v, 230, "", "./tensorflow/core/ir/importexport/convert_tensor.h", "SetTensorShapeProto");
