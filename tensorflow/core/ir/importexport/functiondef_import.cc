...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc() {
      // Check if tracing is enabled
...
class ValueMapManager {
 public:
  ValueMapManager(
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc mht_0(mht_0_v, 237, "", "./tensorflow/core/ir/importexport/functiondef_import.cc", "ValueMapManager");
}

  Status DefineOperation(Operation* op, StringRef node_name) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc mht_1(mht_1_v, 242, "", "./tensorflow/core/ir/importexport/functiondef_import.cc", "DefineOperation");
  ...
  Value GetValueOrCreatePlaceholder(StringRef full_name) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc mht_2(mht_2_v, 267, "", "./tensorflow/core/ir/importexport/functiondef_import.cc", "GetValueOrCreatePlaceholder");
...
Status ImportNodes(ValueMapManager value_manager,
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc mht_3(mht_3_v, 335, "", "./tensorflow/core/ir/importexport/functiondef_import.cc", "ImportNodes");
...
Status ImportGenericFunction(
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc mht_4(mht_4_v, 444, "", "./tensorflow/core/ir/importexport/functiondef_import.cc", "ImportGenericFunction");
...
Status ConvertGenericFunction(const FunctionDef& func, OpBuilder& builder) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSimportexportPSfunctiondef_importDTcc mht_5(mht_5_v, 702, "", "./tensorflow/core/ir/importexport/functiondef_import.cc", "ConvertGenericFunction");
