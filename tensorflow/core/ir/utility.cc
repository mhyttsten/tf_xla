...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSirPSutilityDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilityDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSirPSutilityDTcc() {
      // Check if tracing is enabled
...
Block::BlockArgListType GetLoopRegionDataArgs(Region &region) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilityDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/ir/utility.cc", "GetLoopRegionDataArgs");
...
Block::BlockArgListType GetLoopRegionControlTokens(Region &region) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilityDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/ir/utility.cc", "GetLoopRegionControlTokens");
...
BlockArgument GetLoopRegionControlOf(BlockArgument data) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilityDTcc mht_2(mht_2_v, 213, "", "./tensorflow/core/ir/utility.cc", "GetLoopRegionControlOf");
...
BlockArgument GetLoopRegionDataOf(BlockArgument ctl) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilityDTcc mht_3(mht_3_v, 220, "", "./tensorflow/core/ir/utility.cc", "GetLoopRegionDataOf");
...
Value LookupControlDependency(Value data) {
   ...
   MHTracer_DTPStensorflowPScorePSirPSutilityDTcc mht_4(mht_4_v, 228, "", "./tensorflow/core/ir/utility.cc", "LookupControlDependency");
