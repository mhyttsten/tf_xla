...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTh() {
      // Check if tracing is enabled
...
struct GraphExecutionOptions {
  explicit GraphExecutionOptions(const tensorflow::tfrt_stub::Runtime* rt)
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTh mht_0(mht_0_v, 199, "", "./tensorflow/core/tfrt/graph_executor/graph_execution_options.h", "GraphExecutionOptions");
