...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTcc() {
      // Check if tracing is enabled
...
tensorflow::SessionOptions CreateDefaultSessionOptions(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/tfrt/graph_executor/graph_execution_options.cc", "CreateDefaultSessionOptions");
...
void UpdateTpuTargetByBridgeCompatibility(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSgraph_executorPSgraph_execution_optionsDTcc mht_1(mht_1_v, 229, "", "./tensorflow/core/tfrt/graph_executor/graph_execution_options.cc", "UpdateTpuTargetByBridgeCompatibility");
