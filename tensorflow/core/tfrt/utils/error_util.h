...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTh() {
      // Check if tracing is enabled
...
inline std::string MakeStatusString(tensorflow::Status status) {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTh mht_0(mht_0_v, 201, "", "./tensorflow/core/tfrt/utils/error_util.h", "MakeStatusString");
...
inline llvm::Error MakeStatusError(tensorflow::Status status) {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTh mht_1(mht_1_v, 245, "", "./tensorflow/core/tfrt/utils/error_util.h", "MakeStatusError");
