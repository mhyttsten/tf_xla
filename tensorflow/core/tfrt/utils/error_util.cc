...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTcc() {
      // Check if tracing is enabled
...
tfrt::ErrorCode ConvertTfErrorCodeToTfrtErrorCode(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/tfrt/utils/error_util.cc", "ConvertTfErrorCodeToTfrtErrorCode");
...
tensorflow::Status CreateTfErrorStatus(const DecodedDiagnostic& error) {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/tfrt/utils/error_util.cc", "CreateTfErrorStatus");
...
tensorflow::Status ToTfStatus(const tfrt::AsyncValue* av) {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSutilsPSerror_utilDTcc mht_2(mht_2_v, 228, "", "./tensorflow/core/tfrt/utils/error_util.cc", "ToTfStatus");
