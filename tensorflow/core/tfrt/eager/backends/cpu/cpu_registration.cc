...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSeagerPSbackendsPScpuPScpu_registrationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSeagerPSbackendsPScpuPScpu_registrationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSeagerPSbackendsPScpuPScpu_registrationDTcc() {
      // Check if tracing is enabled
...
static void RegisterCpuOpHandler(CoreRuntime* core_runtime,
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSeagerPSbackendsPScpuPScpu_registrationDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/tfrt/eager/backends/cpu/cpu_registration.cc", "RegisterCpuOpHandler");
