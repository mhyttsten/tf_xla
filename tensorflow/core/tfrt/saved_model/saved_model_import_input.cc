...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTcc() {
      // Check if tracing is enabled
...
StatusOr<TfrtSavedModelMLIRImportInput> TfrtSavedModelMLIRImportInput::Create(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/tfrt/saved_model/saved_model_import_input.cc", "TfrtSavedModelMLIRImportInput::Create");
...
TfrtSavedModelMLIRImportInput::TfrtSavedModelMLIRImportInput(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTcc mht_1(mht_1_v, 215, "", "./tensorflow/core/tfrt/saved_model/saved_model_import_input.cc", "TfrtSavedModelMLIRImportInput::TfrtSavedModelMLIRImportInput");
}
...
StatusOr<const tensorflow::Graph*> TfrtSavedModelMLIRImportInput::GetSubGraph(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTcc mht_2(mht_2_v, 222, "", "./tensorflow/core/tfrt/saved_model/saved_model_import_input.cc", "TfrtSavedModelMLIRImportInput::GetSubGraph");
