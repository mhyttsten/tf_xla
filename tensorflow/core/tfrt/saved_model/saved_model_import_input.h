...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTh() {
      // Check if tracing is enabled
...
class TfrtSavedModelMLIRImportInput : public SavedModelMLIRImportInput {
 public:
  ...
  absl::Duration GetGrapplerDuration() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/tfrt/saved_model/saved_model_import_input.h", "GetGrapplerDuration");
 return grappler_duration_; }

  // Return the time used by functionalization.
  absl::Duration GetFunctionalizationDuration() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePStfrtPSsaved_modelPSsaved_model_import_inputDTh mht_1(mht_1_v, 218, "", "./tensorflow/core/tfrt/saved_model/saved_model_import_input.h", "GetFunctionalizationDuration");
