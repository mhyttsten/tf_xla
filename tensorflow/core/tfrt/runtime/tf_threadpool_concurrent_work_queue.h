...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queueDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queueDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queueDTh() {
      // Check if tracing is enabled
...
class TfThreadPoolWorkQueue : public WorkQueueInterface {
 public:
  TfThreadPoolWorkQueue(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queueDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/tfrt/runtime/tf_threadpool_concurrent_work_queue.h", "TfThreadPoolWorkQueue");
}
  ...
  int GetParallelismLevel() const override {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queueDTh mht_1(mht_1_v, 220, "", "./tensorflow/core/tfrt/runtime/tf_threadpool_concurrent_work_queue.h", "GetParallelismLevel");

    return tensorflow::port::MaxParallelism();
  }
  std::string name() const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queueDTh mht_2(mht_2_v, 226, "", "./tensorflow/core/tfrt/runtime/tf_threadpool_concurrent_work_queue.h", "name");
 return "TfThreadPoolWorkQueue"; }
