...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queue_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queue_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queue_testDTcc() {
      // Check if tracing is enabled
...
class TfThreadpoolWorkQueueTest : public ::testing::Test {
 protected:
  TfThreadpoolWorkQueueTest()
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSruntimePStf_threadpool_concurrent_work_queue_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/tfrt/runtime/tf_threadpool_concurrent_work_queue_test.cc", "TfThreadpoolWorkQueueTest");
}
