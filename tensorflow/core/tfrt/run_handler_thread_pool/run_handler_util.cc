...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSrun_handler_thread_poolPSrun_handler_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSrun_handler_thread_poolPSrun_handler_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSrun_handler_thread_poolPSrun_handler_utilDTcc() {
      // Check if tracing is enabled
...
double ParamFromEnvWithDefault(const char* var_name, double default_value) {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSrun_handler_thread_poolPSrun_handler_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/tfrt/run_handler_thread_pool/run_handler_util.cc", "ParamFromEnvWithDefault");
...
bool ParamFromEnvBoolWithDefault(const char* var_name, bool default_value) {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSrun_handler_thread_poolPSrun_handler_utilDTcc mht_1(mht_1_v, 250, "", "./tensorflow/core/tfrt/run_handler_thread_pool/run_handler_util.cc", "ParamFromEnvBoolWithDefault");
