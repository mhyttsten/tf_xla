...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStfrtPSfallbackPSfallback_stateDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSfallbackPSfallback_stateDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStfrtPSfallbackPSfallback_stateDTcc() {
      // Check if tracing is enabled
...
StatusOr<std::unique_ptr<FallbackState>> FallbackState::Create(
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSfallbackPSfallback_stateDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/tfrt/fallback/fallback_state.cc", "FallbackState::Create");
...
FallbackState::FallbackState(const SessionOptions &session_options,
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSfallbackPSfallback_stateDTcc mht_1(mht_1_v, 224, "", "./tensorflow/core/tfrt/fallback/fallback_state.cc", "FallbackState::FallbackState");
...
FallbackState::CreateGraphExecutionState(GraphDef graph_def) const {
   ...
   MHTracer_DTPStensorflowPScorePStfrtPSfallbackPSfallback_stateDTcc mht_2(mht_2_v, 237, "", "./tensorflow/core/tfrt/fallback/fallback_state.cc", "FallbackState::CreateGraphExecutionState");
