...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc() {
      // Check if tracing is enabled
...
std::string CoreDevice(int core) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/tpu/tpu_compile.cc", "CoreDevice");
...
Status SetPerCoreArgShapes(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_1(mht_1_v, 224, "", "./tensorflow/core/tpu/tpu_compile.cc", "SetPerCoreArgShapes");
...
Status AssignDevicesToArgsAndRetvals(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_2(mht_2_v, 277, "", "./tensorflow/core/tpu/tpu_compile.cc", "AssignDevicesToArgsAndRetvals");
...
void ConvertGraphShapeInfoToShapeMap(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_3(mht_3_v, 315, "", "./tensorflow/core/tpu/tpu_compile.cc", "ConvertGraphShapeInfoToShapeMap");
...
Status OptimizeGraph(const tpu::TPUCompileMetadataProto& metadata,
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_4(mht_4_v, 348, "", "./tensorflow/core/tpu/tpu_compile.cc", "OptimizeGraph");
...
Status AssignReturnValueToCore(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_5(mht_5_v, 404, "", "./tensorflow/core/tpu/tpu_compile.cc", "AssignReturnValueToCore");
...
Status BuildComputationArgumentDescriptions(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_6(mht_6_v, 445, "", "./tensorflow/core/tpu/tpu_compile.cc", "BuildComputationArgumentDescriptions");
...
Status RunShapeInferenceOnComputation(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_7(mht_7_v, 531, "", "./tensorflow/core/tpu/tpu_compile.cc", "RunShapeInferenceOnComputation");
...
Status CompileTFFunctionToHlo(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_8(mht_8_v, 574, "", "./tensorflow/core/tpu/tpu_compile.cc", "CompileTFFunctionToHlo");
...
Status GetShardingInfo(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compileDTcc mht_9(mht_9_v, 654, "", "./tensorflow/core/tpu/tpu_compile.cc", "GetShardingInfo");
