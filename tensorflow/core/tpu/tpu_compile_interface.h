...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_compile_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compile_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_compile_interfaceDTh() {
      // Check if tracing is enabled
...
class TpuCompileInterface {
 public:
  virtual ~TpuCompileInterface() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_compile_interfaceDTh mht_0(mht_0_v, 195, "", "./tensorflow/core/tpu/tpu_compile_interface.h", "~TpuCompileInterface");
}
