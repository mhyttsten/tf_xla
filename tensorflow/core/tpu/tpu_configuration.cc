...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_configurationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_configurationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_configurationDTcc() {
      // Check if tracing is enabled
...
ResourceMgr* GetGlobalResourceMgr() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_configurationDTcc mht_0(mht_0_v, 191, "", "./tensorflow/core/tpu/tpu_configuration.cc", "GetGlobalResourceMgr");
