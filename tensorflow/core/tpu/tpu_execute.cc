...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc() {
      // Check if tracing is enabled
...
class HostTransferManager {
 public:
  explicit HostTransferManager(TpuNodeContext*, xla::Backend*) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_0(mht_0_v, 238, "", "./tensorflow/core/tpu/tpu_execute.cc", "HostTransferManager");
}
...
HostTransferManager::Initialize(const TPUHostTransferInfoProto& program,
   ...
   mht_1_v.push_back("rendezvous_key_base: \"" + rendezvous_key_base + "\"");
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_1(mht_1_v, 259, "", "./tensorflow/core/tpu/tpu_execute.cc", "HostTransferManager::Initialize");
...
void ExitCountdown(Env* env) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_2(mht_2_v, 269, "", "./tensorflow/core/tpu/tpu_execute.cc", "ExitCountdown");
...
xla::Shape HostShapeToDeviceShape(const xla::Shape& host_shape) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_3(mht_3_v, 287, "", "./tensorflow/core/tpu/tpu_execute.cc", "HostShapeToDeviceShape");
...
int64_t ShapeSizeCompact(const xla::Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_4(mht_4_v, 302, "", "./tensorflow/core/tpu/tpu_execute.cc", "ShapeSizeCompact");
...
int64_t ShapeSizeCompactRaw(const xla::Shape& shape) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_5(mht_5_v, 314, "", "./tensorflow/core/tpu/tpu_execute.cc", "ShapeSizeCompactRaw");
...
xla::Status FixTupleTableAsync(se::Stream* stream,
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_6(mht_6_v, 332, "", "./tensorflow/core/tpu/tpu_execute.cc", "FixTupleTableAsync");
...
bool DynamicShapeIsCompatible(const xla::Shape& dynamic_shape,
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_7(mht_7_v, 361, "", "./tensorflow/core/tpu/tpu_execute.cc", "DynamicShapeIsCompatible");
...
xla::Status UpdateDynamicInputs(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_8(mht_8_v, 393, "", "./tensorflow/core/tpu/tpu_execute.cc", "UpdateDynamicInputs");
...
void TPUCancelExecution(Env* env, int device_ordinal) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_9(mht_9_v, 495, "", "./tensorflow/core/tpu/tpu_execute.cc", "TPUCancelExecution");
...
void UnregisterCancellation(
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executeDTcc mht_10(mht_10_v, 565, "", "./tensorflow/core/tpu/tpu_execute.cc", "UnregisterCancellation");
