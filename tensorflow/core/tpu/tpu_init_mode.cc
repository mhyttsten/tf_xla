...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_init_modeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_init_modeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_init_modeDTcc() {
      // Check if tracing is enabled
...
void ForceSetTPUInitMode(const TPUInitMode mode) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_init_modeDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/tpu/tpu_init_mode.cc", "ForceSetTPUInitMode");
...
Status SetTPUInitMode(const TPUInitMode mode) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_init_modeDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/tpu/tpu_init_mode.cc", "SetTPUInitMode");
...
TPUInitMode GetTPUInitMode() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_init_modeDTcc mht_2(mht_2_v, 236, "", "./tensorflow/core/tpu/tpu_init_mode.cc", "GetTPUInitMode");
