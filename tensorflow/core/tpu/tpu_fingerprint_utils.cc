...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_fingerprint_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_fingerprint_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_fingerprint_utilsDTcc() {
      // Check if tracing is enabled
...
Status FingerprintFunctionLibrary(const FunctionLibraryDefinition& library,
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_fingerprint_utilsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/tpu/tpu_fingerprint_utils.cc", "FingerprintFunctionLibrary");
