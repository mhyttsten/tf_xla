...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_executor_dlsym_initializerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executor_dlsym_initializerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_executor_dlsym_initializerDTcc() {
      // Check if tracing is enabled
...
bool FindAndLoadTpuLibrary() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_executor_dlsym_initializerDTcc mht_0(mht_0_v, 233, "", "./tensorflow/core/tpu/tpu_executor_dlsym_initializer.cc", "FindAndLoadTpuLibrary");
