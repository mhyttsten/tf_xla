...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPStpu_model_server_initializerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_model_server_initializerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPStpu_model_server_initializerDTcc() {
      // Check if tracing is enabled
...
bool FindAndLoadTpuModelServer() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPStpu_model_server_initializerDTcc mht_0(mht_0_v, 224, "", "./tensorflow/core/tpu/tpu_model_server_initializer.cc", "FindAndLoadTpuModelServer");
