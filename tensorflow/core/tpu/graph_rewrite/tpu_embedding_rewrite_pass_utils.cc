...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePStpu_embedding_rewrite_pass_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePStpu_embedding_rewrite_pass_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePStpu_embedding_rewrite_pass_utilsDTcc() {
      // Check if tracing is enabled
...
Status AddNode(const NodeDef& n_def, Node** n, Graph* graph) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePStpu_embedding_rewrite_pass_utilsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/tpu/graph_rewrite/tpu_embedding_rewrite_pass_utils.cc", "AddNode");
...
Status ReplaceNode(const NodeDef& to_def, Node* from, Node** to, Graph* graph) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePStpu_embedding_rewrite_pass_utilsDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/tpu/graph_rewrite/tpu_embedding_rewrite_pass_utils.cc", "ReplaceNode");
