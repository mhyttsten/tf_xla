...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc() {
      // Check if tracing is enabled
...
Status GetTPUEmbeddingConfiguration(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_0(mht_0_v, 235, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "GetTPUEmbeddingConfiguration");
...
Status ValidateEmbeddingTableNames(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_1(mht_1_v, 278, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "ValidateEmbeddingTableNames");
...
absl::flat_hash_set<Node*> GetLoadNodes(Graph* graph) {
  ...
  auto is_load_op = [&load_op_names](Node* n) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_2(mht_2_v, 306, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "lambda");
...
absl::flat_hash_set<Node*> GetRetrieveNodes(Graph* graph) {
  ...
  auto is_retrieve_op = [&retrieve_op_names](Node* n) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_3(mht_3_v, 326, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "lambda");
...
Status GetLoadOrRetrieveNodesByTable(
   ...
   mht_4_v.push_back("operation_str: \"" + operation_str + "\"");
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_4(mht_4_v, 371, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "GetLoadOrRetrieveNodesByTable");
...
Status CombinePerTableParametersForLoad(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_5(mht_5_v, 467, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "CombinePerTableParametersForLoad");
...
void RemoveEdgesBetweenIndividualNodes(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_6(mht_6_v, 541, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "RemoveEdgesBetweenIndividualNodes");
...
Status CombineTPUEmbeddingLoadRetrievePass::Run(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_7(mht_7_v, 566, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "CombineTPUEmbeddingLoadRetrievePass::Run");
  ...
  for (const auto& shard_and_device : load_devices) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSgraph_rewritePScombine_tpu_embedding_load_retrieve_passDTcc mht_8(mht_8_v, 696, "", "./tensorflow/core/tpu/graph_rewrite/combine_tpu_embedding_load_retrieve_pass.cc", "lambda");
