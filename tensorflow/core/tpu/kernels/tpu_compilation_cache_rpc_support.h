...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh() {
      // Check if tracing is enabled
...
struct CacheEntry {
  CacheEntry() : size(0), last_use(-1) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_rpc_support.h", "CacheEntry");
}
  virtual ~CacheEntry() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh mht_1(mht_1_v, 210, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_rpc_support.h", "~CacheEntry");
...
class CacheWrapper : public CompilationCacheEntryRef {
 public:
  explicit CacheWrapper(std::shared_ptr<CacheEntry> entry)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh mht_2(mht_2_v, 234, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_rpc_support.h", "CacheWrapper");
}
  ~CacheWrapper() override = default;

  TpuCompilationCacheEntry get() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh mht_3(mht_3_v, 240, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_rpc_support.h", "get");
  ...
  Status ToSubEntryRef(CompilationCacheFetchTarget fetch_target) override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_rpc_supportDTh mht_4(mht_4_v, 253, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_rpc_support.h", "ToSubEntryRef");
