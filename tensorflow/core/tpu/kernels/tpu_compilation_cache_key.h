...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_keyDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_keyDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_keyDTh() {
      // Check if tracing is enabled
...
struct TpuCompilationCacheKey {
  ...
  std::string ToString() const {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_keyDTh mht_0(mht_0_v, 224, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_key.h", "ToString");
  ...
  explicit TpuCompilationCacheKey() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_keyDTh mht_1(mht_1_v, 235, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_key.h", "TpuCompilationCacheKey");
}
  explicit TpuCompilationCacheKey(const std::string& p) : prefix(p) {
   std::vector<std::string> mht_2_v;
   mht_2_v.push_back("p: \"" + p + "\"");
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_keyDTh mht_2(mht_2_v, 240, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_key.h", "TpuCompilationCacheKey");
}
};
