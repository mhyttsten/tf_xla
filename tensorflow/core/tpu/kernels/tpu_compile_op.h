...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_opDTh() {
      // Check if tracing is enabled
...
class TpuCompileSucceededAssertOp : public OpKernel {
 public:
  explicit TpuCompileSucceededAssertOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_opDTh mht_0(mht_0_v, 229, "", "./tensorflow/core/tpu/kernels/tpu_compile_op.h", "TpuCompileSucceededAssertOp");
}
