...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTcc() {
      // Check if tracing is enabled
...
Status TpuCompileOpKernelImpl::Compile(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_impl.cc", "TpuCompileOpKernelImpl::Compile");
