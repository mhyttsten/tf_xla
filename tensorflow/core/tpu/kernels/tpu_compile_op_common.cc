...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc() {
      // Check if tracing is enabled
...
std::string TruncateMessage(const std::string& msg, size_t max_len) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_0(mht_0_v, 223, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TruncateMessage");
...
/* static */
CompileOpImplFactory* CompileOpImplFactory::Get() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_1(mht_1_v, 242, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "CompileOpImplFactory::Get");
 return factory_; }

/* static */
void CompileOpImplFactory::Register(CompileOpImplFactory* factory) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_2(mht_2_v, 248, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "CompileOpImplFactory::Register");
...
/* static */ void TpuCompileOpKernelCommon::ExitCountdown(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_3(mht_3_v, 259, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TpuCompileOpKernelCommon::ExitCountdown");
...
/* static */ Status TpuCompileOpKernelCommon::GetDynamicShapes(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_4(mht_4_v, 278, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TpuCompileOpKernelCommon::GetDynamicShapes");
...
void TpuCompileOpKernelCommon::Compute(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_5(mht_5_v, 293, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TpuCompileOpKernelCommon::Compute");
...
Status TpuCompileOpKernelCommon::CompileLocallyAndFillHostCache(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_6(mht_6_v, 354, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TpuCompileOpKernelCommon::CompileLocallyAndFillHostCache");
...
Status TpuCompileOpKernelCommon::ComputeInternal(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_7(mht_7_v, 396, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TpuCompileOpKernelCommon::ComputeInternal");
...
Status TpuCompileOpKernelCommon::RegisterXLAFingerprints(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_commonDTcc mht_8(mht_8_v, 646, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_common.cc", "TpuCompileOpKernelCommon::RegisterXLAFingerprints");
