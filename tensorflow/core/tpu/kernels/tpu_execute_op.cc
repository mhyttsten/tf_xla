...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc() {
      // Check if tracing is enabled
...
Status GetComputationCacheEntry(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_0(mht_0_v, 239, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "GetComputationCacheEntry");
...
struct InputBuffers {
  explicit InputBuffers(xla::Shape device_shape)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_1(mht_1_v, 335, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "InputBuffers");
}
  ...
  xla::ShapedBuffer ToShapedBuffer(xla::Shape host_shape,
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_2(mht_2_v, 347, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "ToShapedBuffer");
...
xla::StatusOr<std::unique_ptr<InputBuffers>> BuildComputationInputs(
  ...
  auto validate_shape = [&](int i, const Tensor& tensor) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_3(mht_3_v, 388, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "lambda");
  ...
  auto set_input_buffers_helper = [&](int arg_index, bool donate_buffers,
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_4(mht_4_v, 474, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "lambda");
...
struct OutputBuffers {
  OutputBuffers(xla::ScopedShapedBuffer b, se::DeviceMemoryAllocator* allocator)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_5(mht_5_v, 548, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "OutputBuffers");
}

  ~OutputBuffers() {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_6(mht_6_v, 553, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "~OutputBuffers");
...
xla::StatusOr<std::unique_ptr<OutputBuffers>> AllocateOutputTensors(
  ...
  auto transfer_buffers = [&](int i, Tensor* output_tensor) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_7(mht_7_v, 647, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "lambda");
  ...
  auto process_non_updated_variable = [&](int input_index) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_8(mht_8_v, 703, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "lambda");
...
TPUExecuteOp::TPUExecuteOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_9(mht_9_v, 785, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "TPUExecuteOp::TPUExecuteOp");
}

AsyncOpKernel* TPUExecuteOp::AsAsync() {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_10(mht_10_v, 790, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "TPUExecuteOp::AsAsync");
...
void TPUExecuteOp::Compute(OpKernelContext* context) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_11(mht_11_v, 800, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "TPUExecuteOp::Compute");
...
void TPUExecuteOp::ComputeAsync(OpKernelContext* context, DoneCallback done) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_12(mht_12_v, 812, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "TPUExecuteOp::ComputeAsync");
...
Status TPUExecuteOp::DoWork(OpKernelContext* context) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_13(mht_13_v, 822, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "TPUExecuteOp::DoWork");
...
TPUExecuteAndUpdateVariablesOp::TPUExecuteAndUpdateVariablesOp(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_execute_opDTcc mht_14(mht_14_v, 1002, "", "./tensorflow/core/tpu/kernels/tpu_execute_op.cc", "TPUExecuteAndUpdateVariablesOp::TPUExecuteAndUpdateVariablesOp");
