...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_interfaceDTh() {
      // Check if tracing is enabled
...
class TpuCompilationCacheInterface : public ResourceBase {
 public:
  ...
  std::string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_interfaceDTh mht_0(mht_0_v, 331, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_interface.h", "DebugString");
 return "TpuCompilationCacheBase"; }

 protected:
  std::string ConstructCompilationCacheKey(const TpuCompilationCacheKey& key) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_interfaceDTh mht_1(mht_1_v, 337, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_interface.h", "ConstructCompilationCacheKey");
