...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_externalDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_externalDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_externalDTh() {
      // Check if tracing is enabled
...
class TpuCompilationCacheExternal : public TpuCompilationCacheInterface {
 public:
  explicit TpuCompilationCacheExternal(int64_t max_cache_size)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_externalDTh mht_0(mht_0_v, 218, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_external.h", "TpuCompilationCacheExternal");
}

  string DebugString() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_externalDTh mht_1(mht_1_v, 223, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_external.h", "DebugString");
