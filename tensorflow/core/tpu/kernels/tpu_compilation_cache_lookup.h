...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_lookupDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_lookupDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_lookupDTh() {
      // Check if tracing is enabled
...
class TpuCompilationCacheLookup : public ResourceBase {
 public:
  ...
  virtual Status Lookup(const string& proto_key,
   ...
   mht_0_v.push_back("proto_key: \"" + proto_key + "\"");
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_lookupDTh mht_0(mht_0_v, 221, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_lookup.h", "Lookup");
  ...
  virtual Status Lookup(int64_t uid, int proto_index,
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_lookupDTh mht_1(mht_1_v, 238, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_lookup.h", "Lookup");
