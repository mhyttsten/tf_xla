...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc() {
      // Check if tracing is enabled
...
class OutfeedEnqueueOp : public XlaOpKernel {
 public:
  explicit OutfeedEnqueueOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/tpu/kernels/xla/outfeed_ops.cc", "OutfeedEnqueueOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/tpu/kernels/xla/outfeed_ops.cc", "Compile");
...
class OutfeedEnqueueTupleOp : public XlaOpKernel {
 public:
  explicit OutfeedEnqueueTupleOp(OpKernelConstruction* ctx) : XlaOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc mht_2(mht_2_v, 231, "", "./tensorflow/core/tpu/kernels/xla/outfeed_ops.cc", "OutfeedEnqueueTupleOp");
  ...
  void Compile(XlaOpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSxlaPSoutfeed_opsDTcc mht_3(mht_3_v, 238, "", "./tensorflow/core/tpu/kernels/xla/outfeed_ops.cc", "Compile");
