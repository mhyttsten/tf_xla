...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_factoryDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_factoryDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_factoryDTcc() {
      // Check if tracing is enabled
...
TpuCompilationCacheInterface* CreateCompilationCacheExternal() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_factoryDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_factory.cc", "CreateCompilationCacheExternal");
...
void SetCompilationCacheCreateFn(
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compilation_cache_factoryDTcc mht_1(mht_1_v, 220, "", "./tensorflow/core/tpu/kernels/tpu_compilation_cache_factory.cc", "SetCompilationCacheCreateFn");
