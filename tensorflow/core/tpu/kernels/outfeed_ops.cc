...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPSoutfeed_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSoutfeed_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPSoutfeed_opsDTcc() {
      // Check if tracing is enabled
...
class StreamExecutorOutfeedDequeueOp : public TpuOutfeedDequeueOp<T> {
 public:
  explicit StreamExecutorOutfeedDequeueOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSoutfeed_opsDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/tpu/kernels/outfeed_ops.cc", "StreamExecutorOutfeedDequeueOp");
}
...
class StreamExecutorOutfeedDequeueTupleOp : public TpuOutfeedDequeueTupleOp<T> {
 public:
  explicit StreamExecutorOutfeedDequeueTupleOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPSoutfeed_opsDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/tpu/kernels/outfeed_ops.cc", "StreamExecutorOutfeedDequeueTupleOp");
}
