...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_fingerprint_lookupDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_fingerprint_lookupDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_fingerprint_lookupDTh() {
      // Check if tracing is enabled
...
class TpuFingerprintLookup : public ResourceBase {
 public:
  ...
  size_t num_valid() {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_fingerprint_lookupDTh mht_0(mht_0_v, 238, "", "./tensorflow/core/tpu/kernels/tpu_fingerprint_lookup.h", "num_valid");
  ...
  std::string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_fingerprint_lookupDTh mht_1(mht_1_v, 246, "", "./tensorflow/core/tpu/kernels/tpu_fingerprint_lookup.h", "DebugString");
 return "TpuFingerprintLookup"; }

 private:
  explicit TpuFingerprintLookup() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_fingerprint_lookupDTh mht_2(mht_2_v, 252, "", "./tensorflow/core/tpu/kernels/tpu_fingerprint_lookup.h", "TpuFingerprintLookup");
}
