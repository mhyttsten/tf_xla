...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTh() {
      // Check if tracing is enabled
...
class TpuCompileOpKernelImpl : public TpuCompileOpKernelCommon {
 public:
  TpuCompileOpKernelImpl(const std::string& mlir_module,
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_impl.h", "TpuCompileOpKernelImpl");
}
  ...
  TpuCompileOpKernelImpl(const NameAttrList& function,
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_compile_op_implDTh mht_1(mht_1_v, 225, "", "./tensorflow/core/tpu/kernels/tpu_compile_op_impl.h", "TpuCompileOpKernelImpl");
}
