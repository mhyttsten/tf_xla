...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh() {
      // Check if tracing is enabled
...
class TPUOrdinalSelector : TPUOrdinalSelectorInterface {
 public:
  explicit TPUOrdinalSelector(int num_cores_per_replica = 1) {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh mht_0(mht_0_v, 201, "", "./tensorflow/core/tpu/kernels/tpu_ordinal_selector.h", "TPUOrdinalSelector");
  ...
  ~TPUOrdinalSelector() override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh mht_1(mht_1_v, 208, "", "./tensorflow/core/tpu/kernels/tpu_ordinal_selector.h", "~TPUOrdinalSelector");
  ...
  int64_t GetOrdinal(absl::optional<uint64> key, int64_t* req_id) override {
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh mht_2(mht_2_v, 214, "", "./tensorflow/core/tpu/kernels/tpu_ordinal_selector.h", "GetOrdinal");
  ...
  void DequeueFromCoreSelector(int32_t device_ordinal,
   ...
   MHTracer_DTPStensorflowPScorePStpuPSkernelsPStpu_ordinal_selectorDTh mht_3(mht_3_v, 224, "", "./tensorflow/core/tpu/kernels/tpu_ordinal_selector.h", "DequeueFromCoreSelector");
