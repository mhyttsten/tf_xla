...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh() {
      // Check if tracing is enabled
...
class SpatialConvolutionBenchmarksSuite {
 public:
  ...
  SpatialConvolutionBenchmarksSuite(::testing::benchmark::State& state,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/kernels/eigen_benchmark.h", "SpatialConvolutionBenchmarksSuite");
}

  Eigen::Index BufferSize(const Dimensions& dims) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_1(mht_1_v, 214, "", "./tensorflow/core/kernels/eigen_benchmark.h", "BufferSize");
  ...
  void SpatialConvolution(Dimensions input_dims, Dimensions filter_dims) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_2(mht_2_v, 221, "", "./tensorflow/core/kernels/eigen_benchmark.h", "SpatialConvolution");
  ...
  void SpatialConvolutionBackwardInput(Dimensions input_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_3(mht_3_v, 255, "", "./tensorflow/core/kernels/eigen_benchmark.h", "SpatialConvolutionBackwardInput");
  ...
  void SpatialConvolutionBackwardKernel(Dimensions input_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_4(mht_4_v, 297, "", "./tensorflow/core/kernels/eigen_benchmark.h", "SpatialConvolutionBackwardKernel");
...
class CuboidConvolutionBenchmarksSuite {
 public:
  ...
  CuboidConvolutionBenchmarksSuite(::testing::benchmark::State& state,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_5(mht_5_v, 355, "", "./tensorflow/core/kernels/eigen_benchmark.h", "CuboidConvolutionBenchmarksSuite");
}

  Eigen::Index BufferSize(const Dimensions& dims) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_6(mht_6_v, 360, "", "./tensorflow/core/kernels/eigen_benchmark.h", "BufferSize");
  ...
  void CuboidConvolution(Dimensions input_dims, Dimensions filter_dims) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_7(mht_7_v, 367, "", "./tensorflow/core/kernels/eigen_benchmark.h", "CuboidConvolution");
  ...
  void CuboidConvolutionBackwardInput(Dimensions input_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_8(mht_8_v, 402, "", "./tensorflow/core/kernels/eigen_benchmark.h", "CuboidConvolutionBackwardInput");
  ...
  void CuboidConvolutionBackwardKernel(Dimensions input_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_benchmarkDTh mht_9(mht_9_v, 446, "", "./tensorflow/core/kernels/eigen_benchmark.h", "CuboidConvolutionBackwardKernel");
