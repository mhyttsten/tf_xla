...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSencode_wav_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSencode_wav_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSencode_wav_opDTcc() {
      // Check if tracing is enabled
...
class EncodeWavOp : public OpKernel {
 public:
  explicit EncodeWavOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSencode_wav_opDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/kernels/encode_wav_op.cc", "EncodeWavOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSencode_wav_opDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/kernels/encode_wav_op.cc", "Compute");
