...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reorder_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reorder_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reorder_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__global__ void IndicesFlattenKernel(const int64* __restrict__ indices,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reorder_op_gpuDTcuDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/sparse_reorder_op_gpu.cu.cc", "IndicesFlattenKernel");
...
__global__ void PermuteIndicesAndValuesKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reorder_op_gpuDTcuDTcc mht_1(mht_1_v, 224, "", "./tensorflow/core/kernels/sparse_reorder_op_gpu.cu.cc", "PermuteIndicesAndValuesKernel");
