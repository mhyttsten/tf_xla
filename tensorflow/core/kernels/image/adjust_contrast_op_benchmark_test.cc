...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_contrast_op_benchmark_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_contrast_op_benchmark_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_contrast_op_benchmark_testDTcc() {
      // Check if tracing is enabled
...
static Graph* AdjustContrast(int batches, int width, int height) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_contrast_op_benchmark_testDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/kernels/image/adjust_contrast_op_benchmark_test.cc", "AdjustContrast");
