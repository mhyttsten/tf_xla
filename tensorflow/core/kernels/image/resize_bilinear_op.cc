...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc() {
      // Check if tracing is enabled
...
class ResizeBilinearOp : public OpKernel {
 public:
  explicit ResizeBilinearOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_0(mht_0_v, 219, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "ResizeBilinearOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_1(mht_1_v, 228, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "Compute");
...
inline void compute_interpolation_weights(const Scaler scaler,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_2(mht_2_v, 269, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "compute_interpolation_weights");
...
inline float compute_lerp(const float top_left, const float top_right,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_3(mht_3_v, 292, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "compute_lerp");
...
inline __m128 load_3xfloat_v(float* values) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_4(mht_4_v, 350, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "load_3xfloat_v");
...
void ResizeLine3ChannelsVector(const T* const ys_input_lower_ptr,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_5(mht_5_v, 362, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "ResizeLine3ChannelsVector");
...
void resize_image(typename TTypes<T, 4>::ConstTensor images,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_6(mht_6_v, 406, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "resize_image");
...
class ResizeBilinearOpGrad : public OpKernel {
 public:
  explicit ResizeBilinearOpGrad(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_7(mht_7_v, 527, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "ResizeBilinearOpGrad");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_8(mht_8_v, 536, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "Compute");
...
struct ResizeBilinearGrad<CPUDevice, T> {
  ...
  void ResizeGradCore(const Scaler& scaler,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bilinear_opDTcc mht_9(mht_9_v, 589, "", "./tensorflow/core/kernels/image/resize_bilinear_op.cc", "ResizeGradCore");
