...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_op_testDTcc() {
      // Check if tracing is enabled
...
class MirrorPadOpTest : public OpsTestBase {
 protected:
  ...
  void MakeOp(const string& mode) {
   ...
   mht_0_v.push_back("mode: \"" + mode + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_op_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/kernels/image/mirror_pad_op_test.cc", "MakeOp");
...
class MirrorPadGradOpTest : public OpsTestBase {
 protected:
  ...
  void MakeOp(const string& mode) {
   ...
   mht_1_v.push_back("mode: \"" + mode + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_op_testDTcc mht_1(mht_1_v, 336, "", "./tensorflow/core/kernels/image/mirror_pad_op_test.cc", "MakeOp");
