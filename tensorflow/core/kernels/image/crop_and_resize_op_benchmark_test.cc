...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_benchmark_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_benchmark_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_benchmark_testDTcc() {
      // Check if tracing is enabled
...
static Graph* CropAndResize(int batches, int width, int height, int depth,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_benchmark_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/kernels/image/crop_and_resize_op_benchmark_test.cc", "CropAndResize");
