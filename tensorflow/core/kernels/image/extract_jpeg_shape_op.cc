...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSextract_jpeg_shape_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSextract_jpeg_shape_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSextract_jpeg_shape_opDTcc() {
      // Check if tracing is enabled
...
class ExtractJpegShapeOp : public OpKernel {
 public:
  explicit ExtractJpegShapeOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSextract_jpeg_shape_opDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/kernels/image/extract_jpeg_shape_op.cc", "ExtractJpegShapeOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSextract_jpeg_shape_opDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/kernels/image/extract_jpeg_shape_op.cc", "Compute");
