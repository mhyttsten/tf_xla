...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_hsv_gpuDTcuDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_hsv_gpuDTcuDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_hsv_gpuDTcuDTh() {
      // Check if tracing is enabled
...
inline __device__ HsvTuple rgb2hsv_cuda(const float r, const float g,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_hsv_gpuDTcuDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/kernels/image/adjust_hsv_gpu.cu.h", "rgb2hsv_cuda");
...
inline __device__ RgbTuple hsv2rgb_cuda(const float h, const float s,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSadjust_hsv_gpuDTcuDTh mht_1(mht_1_v, 245, "", "./tensorflow/core/kernels/image/adjust_hsv_gpu.cu.h", "hsv2rgb_cuda");
