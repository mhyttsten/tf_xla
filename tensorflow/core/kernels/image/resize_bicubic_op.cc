...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc() {
      // Check if tracing is enabled
...
const float* InitCoeffsTable(const double a) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "InitCoeffsTable");
...
const float* GetCoeffsTable(const bool use_keys_cubic) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_1(mht_1_v, 226, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "GetCoeffsTable");
...
inline int64_t Bound(int64_t val, int64_t limit) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_2(mht_2_v, 244, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "Bound");
...
inline float Interpolate1D(const float weight_0, const float weight_1,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_3(mht_3_v, 319, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "Interpolate1D");
...
static float Compute(float values_[4], const float xw_0, const float xw_1,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_4(mht_4_v, 331, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "Compute");
...
class CachedInterpolationCalculator {
 public:
  CachedInterpolationCalculator() : indexes_{-1, -1, -1, -1} {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_5(mht_5_v, 347, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "CachedInterpolationCalculator");
}
  ...
  inline int Advance(const int64_t x_0, const int64_t x_1, const int64_t x_2,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_6(mht_6_v, 357, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "Advance");
...
static void ComputeXWeightsAndIndices(const ImageResizerState& resizer_state,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_7(mht_7_v, 401, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "ComputeXWeightsAndIndices");
...
static void ComputeGradientXWeightsAndIndices(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_8(mht_8_v, 434, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "ComputeGradientXWeightsAndIndices");
...
static EIGEN_ALWAYS_INLINE float ComputeYInterpolation(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_9(mht_9_v, 467, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "ComputeYInterpolation");
...
inline void interpolate_with_caching(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_10(mht_10_v, 496, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "interpolate_with_caching");
...
inline void ResizeBicubicGrad(typename TTypes<float, 4>::ConstTensor input_grad,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_11(mht_11_v, 678, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "ResizeBicubicGrad");
...
class ResizeBicubicOp : public OpKernel {
 public:
  explicit ResizeBicubicOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_12(mht_12_v, 758, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "ResizeBicubicOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_13(mht_13_v, 767, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "Compute");
...
class ResizeBicubicOpGrad : public OpKernel {
 public:
  explicit ResizeBicubicOpGrad(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_14(mht_14_v, 793, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "ResizeBicubicOpGrad");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSresize_bicubic_opDTcc mht_15(mht_15_v, 802, "", "./tensorflow/core/kernels/image/resize_bicubic_op.cc", "Compute");
