...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSrandom_crop_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSrandom_crop_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSrandom_crop_opDTcc() {
      // Check if tracing is enabled
...
class RandomCropOp : public OpKernel {
 public:
  explicit RandomCropOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSrandom_crop_opDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/kernels/image/random_crop_op.cc", "RandomCropOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSrandom_crop_opDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/kernels/image/random_crop_op.cc", "Compute");
