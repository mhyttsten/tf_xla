...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSsampling_kernelsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSsampling_kernelsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSsampling_kernelsDTcc() {
      // Check if tracing is enabled
...
SamplingKernelType SamplingKernelTypeFromString(const StringPiece str) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSsampling_kernelsDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/kernels/image/sampling_kernels.cc", "SamplingKernelTypeFromString");
