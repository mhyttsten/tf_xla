...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__global__ void CropAndResizeKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_gpuDTcuDTcc mht_0(mht_0_v, 214, "", "./tensorflow/core/kernels/image/crop_and_resize_op_gpu.cu.cc", "CropAndResizeKernel");
...
__global__ void CropAndResizeBackpropImageKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_gpuDTcuDTcc mht_1(mht_1_v, 321, "", "./tensorflow/core/kernels/image/crop_and_resize_op_gpu.cu.cc", "CropAndResizeBackpropImageKernel");
...
__global__ void CropAndResizeBackpropBoxesKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePScrop_and_resize_op_gpuDTcuDTcc mht_2(mht_2_v, 420, "", "./tensorflow/core/kernels/image/crop_and_resize_op_gpu.cu.cc", "CropAndResizeBackpropBoxesKernel");
