...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc() {
      // Check if tracing is enabled
...
FileFormat ClassifyFileFormat(StringPiece data) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_0(mht_0_v, 233, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "ClassifyFileFormat");
...
class DecodeImageV2Op : public OpKernel {
 public:
  explicit DecodeImageV2Op(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_1(mht_1_v, 249, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "DecodeImageV2Op");
  ...
  inline int32 ByteSwapInt32ForBigEndian(int32_t x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_2(mht_2_v, 346, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "ByteSwapInt32ForBigEndian");
  ...
  inline int16 ByteSwapInt16ForBigEndian(int16_t x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_3(mht_3_v, 358, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "ByteSwapInt16ForBigEndian");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_4(mht_4_v, 369, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "Compute");
  ...
  void DecodeJpegV2(OpKernelContext* context, StringPiece input) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_5(mht_5_v, 407, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "DecodeJpegV2");
  ...
  void DecodePngV2(OpKernelContext* context, StringPiece input) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_6(mht_6_v, 511, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "DecodePngV2");
  ...
  void DecodeGifV2(OpKernelContext* context, StringPiece input) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_7(mht_7_v, 618, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "DecodeGifV2");
  ...
  void DecodeBmpV2(OpKernelContext* context, StringPiece input) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_8(mht_8_v, 722, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "DecodeBmpV2");
...
void DecodeImageV2Op::DecodeBMP(const uint8* input, const int row_size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSdecode_image_opDTcc mht_9(mht_9_v, 883, "", "./tensorflow/core/kernels/image/decode_image_op.cc", "DecodeImageV2Op::DecodeBMP");
