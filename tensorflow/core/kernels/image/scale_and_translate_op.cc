...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc() {
      // Check if tracing is enabled
...
inline const T& Clamp(const T& low, const T& high, const T& value) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_0(mht_0_v, 213, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "Clamp");
...
Status ComputeSpansCore(OpKernelContext* context, const Kernel& kernel,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_1(mht_1_v, 226, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "ComputeSpansCore");
...
Status ComputeGradSpansCore(OpKernelContext* context, const Spans& spans,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_2(mht_2_v, 304, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "ComputeGradSpansCore");
...
Status ComputeSpans(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_3(mht_3_v, 372, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "ComputeSpans");
...
Status ComputeGradSpans(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_4(mht_4_v, 424, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "ComputeGradSpans");
...
void GetValues(OpKernelContext* context, int input_index, float* v_1,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_5(mht_5_v, 437, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "GetValues");
...
class ScaleAndTranslateOp : public OpKernel {
 public:
  explicit ScaleAndTranslateOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_6(mht_6_v, 459, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "ScaleAndTranslateOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_7(mht_7_v, 472, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "Compute");
...
class ScaleAndTranslateGradOp : public OpKernel {
 public:
  explicit ScaleAndTranslateGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_8(mht_8_v, 575, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "ScaleAndTranslateGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_9(mht_9_v, 588, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "Compute");
...
void GatherColumns(int span_size, const int32* starts, const float* weights,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_10(mht_10_v, 688, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "GatherColumns");
...
inline void AddScaledVector(const T* in_vec, int vec_len, float weight,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_11(mht_11_v, 722, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "AddScaledVector");
...
void GatherRows(int span_size, const int32* starts, const float* weights,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSscale_and_translate_opDTcc mht_12(mht_12_v, 736, "", "./tensorflow/core/kernels/image/scale_and_translate_op.cc", "GatherRows");
