...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh() {
      // Check if tracing is enabled
...
class TensorMirrorPadOp
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorMirrorPadOp(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_0(mht_0_v, 238, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "TensorMirrorPadOp");
}

  EIGEN_DEVICE_FUNC
  const PaddingDimensions& padding() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_1(mht_1_v, 244, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "padding");
 return padding_dims_; }

  EIGEN_DEVICE_FUNC
  Index offset() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_2(mht_2_v, 250, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "offset");
 return offset_; }
  ...
  expression() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_3(mht_3_v, 257, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "expression");
...
struct TensorEvaluator<const TensorMirrorPadOp<PaddingDimensions, ArgType>,
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorEvaluator(const XprType& op,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_4(mht_4_v, 300, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "TensorEvaluator");
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const Dimensions& dimensions() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_5(mht_5_v, 339, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "dimensions");
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE bool evalSubExprsIfNeeded(Scalar*) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_6(mht_6_v, 346, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "evalSubExprsIfNeeded");
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void cleanup() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_7(mht_7_v, 354, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "cleanup");
 impl_.cleanup(); }

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE CoeffReturnType
  coeff(Index index) const {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_8(mht_8_v, 360, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "coeff");
  ...
  coeff(array<Index, Dims> coords) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_9(mht_9_v, 370, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "coeff");
  ...
  packet(Index index) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_10(mht_10_v, 383, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "packet");
  ...
  costPerCoeff(bool vectorized) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_11(mht_11_v, 445, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "costPerCoeff");
  ...
  EIGEN_DEVICE_FUNC Scalar* data() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_12(mht_12_v, 459, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "data");
 return nullptr; }
 ...
 protected:
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE Index ToInputCoord(Index k,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_13(mht_13_v, 495, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "ToInputCoord");
  ...
  ToInputIndex(const Coords& coords) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_14(mht_14_v, 511, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "ToInputIndex");
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Index ToInputIndex(Index index) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimagePSmirror_pad_opDTh mht_15(mht_15_v, 522, "", "./tensorflow/core/kernels/image/mirror_pad_op.h", "ToInputIndex");
