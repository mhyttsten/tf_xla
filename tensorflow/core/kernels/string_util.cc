...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_utilDTcc() {
      // Check if tracing is enabled
...
Status ParseUnicodeEncoding(const string& str, UnicodeEncoding* encoding) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_utilDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/kernels/string_util.cc", "ParseUnicodeEncoding");
...
Status ParseCharUnit(const string& str, CharUnit* unit) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_utilDTcc mht_1(mht_1_v, 212, "", "./tensorflow/core/kernels/string_util.cc", "ParseCharUnit");
...
int32 UTF8StrLen(const string& str) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_utilDTcc mht_2(mht_2_v, 230, "", "./tensorflow/core/kernels/string_util.cc", "UTF8StrLen");
