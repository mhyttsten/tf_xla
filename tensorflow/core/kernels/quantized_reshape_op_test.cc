...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSquantized_reshape_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_reshape_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSquantized_reshape_op_testDTcc() {
      // Check if tracing is enabled
...
class QuantizedReshapeTest : public OpsTestBase {
 protected:
  QuantizedReshapeTest() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_reshape_op_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/kernels/quantized_reshape_op_test.cc", "QuantizedReshapeTest");
}
};
