...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSreverse_sequence_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSreverse_sequence_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSreverse_sequence_opDTh() {
      // Check if tracing is enabled
...
class ReverseGenerator {
 public:
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE ReverseGenerator(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSreverse_sequence_opDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/kernels/reverse_sequence_op.h", "ReverseGenerator");
}
...
struct ReverseSequence {
  EIGEN_ALWAYS_INLINE static void Compute(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSreverse_sequence_opDTh mht_1(mht_1_v, 239, "", "./tensorflow/core/kernels/reverse_sequence_op.h", "Compute");
