...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
class L2LossOp<GPUDevice, T> : public OpKernel {
 public:
  explicit L2LossOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_op_gpuDTcuDTcc mht_0(mht_0_v, 210, "", "./tensorflow/core/kernels/l2loss_op_gpu.cu.cc", "L2LossOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_op_gpuDTcuDTcc mht_1(mht_1_v, 215, "", "./tensorflow/core/kernels/l2loss_op_gpu.cu.cc", "Compute");
