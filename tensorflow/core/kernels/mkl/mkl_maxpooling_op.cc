...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc() {
      // Check if tracing is enabled
...
class MklMaxPoolingOp : public MklPoolingForwardOpBase<T> {
 public:
  explicit MklMaxPoolingOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc mht_0(mht_0_v, 211, "", "./tensorflow/core/kernels/mkl/mkl_maxpooling_op.cc", "MklMaxPoolingOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc mht_1(mht_1_v, 221, "", "./tensorflow/core/kernels/mkl/mkl_maxpooling_op.cc", "Compute");
 ...
 private:
  ...
  void AllocateWorkspaceTensor(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc mht_2(mht_2_v, 376, "", "./tensorflow/core/kernels/mkl/mkl_maxpooling_op.cc", "AllocateWorkspaceTensor");
...
class MklMaxPoolingGradOp : public MklPoolingBackwardOpBase<T> {
 public:
  explicit MklMaxPoolingGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc mht_3(mht_3_v, 406, "", "./tensorflow/core/kernels/mkl/mkl_maxpooling_op.cc", "MklMaxPoolingGradOp");

    this->native_format_ = native_format;
  }
  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_maxpooling_opDTcc mht_4(mht_4_v, 412, "", "./tensorflow/core/kernels/mkl/mkl_maxpooling_op.cc", "Compute");
