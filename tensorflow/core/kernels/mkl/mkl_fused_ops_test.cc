...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc() {
      // Check if tracing is enabled
...
class CommonTestUtilities : public OpsTestBase {
 public:
  void PerformConversion(DataType dtype, const Tensor& tensor,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_0(mht_0_v, 234, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "PerformConversion");
  ...
  static void RunAndFetch(const tensorflow::Scope& root, const string& fetch,
   ...
   mht_1_v.push_back("fetch: \"" + fetch + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_1(mht_1_v, 258, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunAndFetch");
  ...
  void ConvertAndCompare(DataType dtype, const Tensor& tensor,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_2(mht_2_v, 277, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "ConvertAndCompare");
  ...
  void ConvertAndCompareIntegral(DataType dtype, const Tensor& tensor,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_3(mht_3_v, 288, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "ConvertAndCompareIntegral");
  ...
  void TestBody() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_4(mht_4_v, 296, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "TestBody");
}
  ...
  static void VerifyBiasAddTensorsClose(int depth, int image_width,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_5(mht_5_v, 305, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyBiasAddTensorsClose");
  ...
  static void VerifyFusedTensorsClose(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_6(mht_6_v, 338, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyFusedTensorsClose");
  ...
  static void VerifyFusedMatrixClose(int depth, int batch, int weight_count,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_7(mht_7_v, 368, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyFusedMatrixClose");
...
class MklFusedConv2DOpTest : public OpsTestBase {
 protected:
  ...
  void RunConv2DUnfused(const Tensor& input_data, const Tensor& filter_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_8(mht_8_v, 412, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunConv2DUnfused");
  ...
  void RunMklFusedConv2DOp(const Tensor& image, const Tensor& filter,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_9(mht_9_v, 481, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunMklFusedConv2DOp");
  ...
  void VerifyFusedConv2D(int filter_size, int filter_count,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_10(mht_10_v, 548, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyFusedConv2D");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_11(mht_11_v, 555, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_12(mht_12_v, 566, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
...
class MklFusedDepthwiseConv2DOpTest : public OpsTestBase {
 protected:
  ...
  void RunDepthwiseConv2DUnfused(const Tensor& input_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_13(mht_13_v, 767, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunDepthwiseConv2DUnfused");
  ...
  void RunMklFusedDepthwiseConv2DOp(const Tensor& image, const Tensor& filter,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_14(mht_14_v, 812, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunMklFusedDepthwiseConv2DOp");
  ...
  void VerifyFusedDepthwiseConv2D(int filter_size, int filter_count,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_15(mht_15_v, 886, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyFusedDepthwiseConv2D");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_16(mht_16_v, 893, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_17(mht_17_v, 904, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
...
class FusedPadConvOpTest : public OpsTestBase {
 public:
  void Run(const string data_format) {
   ...
   mht_18_v.push_back("data_format: \"" + data_format + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_18(mht_18_v, 1011, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "Run");
...
class FilterCacheTest : public OpsTestBase {
 public:
  ...
  void Run(DataType dtype, Tensor& image, Tensor& filter, Tensor& expected,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_19(mht_19_v, 1126, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "Run");
...
class MklFusedMatMulOpTest : public OpsTestBase {
 private:
  void RunMklFusedMatMulOp(const Tensor& input, const Tensor& weight,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_20(mht_20_v, 1224, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunMklFusedMatMulOp");
 ...
 protected:
  void VerifyFusedMatMul(const int kBatch, const int kInputChannel,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_21(mht_21_v, 1291, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyFusedMatMul");

    const FusedMatMulRunner run_default =
        [this](const Tensor& input, const Tensor& weight, const Tensor& bias,
               const std::vector<string>& fused_ops, Tensor* output) {
   std::vector<std::string> mht_22_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_22(mht_22_v, 1297, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_23(mht_23_v, 1365, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
...
class BiasCacheTest : public OpsTestBase {
 public:
  ...
  void Run(DataType dtype, Tensor& image, Tensor& filter, Tensor& bias,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_24(mht_24_v, 1584, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "Run");
...
class MklPadWithFusedConv2DOpTest : public OpsTestBase {
 protected:
  ...
  void VerifyPadAndConv2DWithBias(int filter_size, int filter_count,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_25(mht_25_v, 1705, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyPadAndConv2DWithBias");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_26(mht_26_v, 1712, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_27(mht_27_v, 1721, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
  ...
  void VerifyPadAndConv2DWithBiasRelu(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_28(mht_28_v, 1739, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "VerifyPadAndConv2DWithBiasRelu");

    const BiasAddGraphRunner run_default =
        [this](const Tensor& input_data, const Tensor& filter_data,
               const Tensor& bias_data, Tensor* out) {
   std::vector<std::string> mht_29_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_29(mht_29_v, 1745, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_30(mht_30_v, 1755, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "lambda");
  ...
  void RunMklPadWithFusedConv2DAndBias(const Tensor& input_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_31(mht_31_v, 1771, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunMklPadWithFusedConv2DAndBias");
  ...
  void RunMklPadWithFusedConv2DAndBiasRelu(const Tensor& input_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_32(mht_32_v, 1802, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunMklPadWithFusedConv2DAndBiasRelu");
  ...
  void RunMklFusedConv2DWithPadOp(const Tensor& image, const Tensor& filter,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_33(mht_33_v, 1835, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "RunMklFusedConv2DWithPadOp");
 ...
 public:
  void SetPaddingList(int top, int bottom, int left, int right) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_ops_testDTcc mht_34(mht_34_v, 1908, "", "./tensorflow/core/kernels/mkl/mkl_fused_ops_test.cc", "SetPaddingList");
