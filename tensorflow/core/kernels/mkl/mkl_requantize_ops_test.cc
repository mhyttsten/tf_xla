...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_requantize_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_requantize_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_requantize_ops_testDTcc() {
      // Check if tracing is enabled
...
void MklRequantizatedOpsTestHelper::Setup(Tensor &input_tensor_qint32,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_requantize_ops_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/core/kernels/mkl/mkl_requantize_ops_test.cc", "MklRequantizatedOpsTestHelper::Setup");
