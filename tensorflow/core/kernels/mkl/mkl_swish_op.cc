...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_swish_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_swish_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_swish_opDTcc() {
      // Check if tracing is enabled
...
class MklSwishOp
 ...
 public:
  ~MklSwishOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_swish_opDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/kernels/mkl/mkl_swish_op.cc", "~MklSwishOp");
}
  ...
  explicit MklSwishOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_swish_opDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/kernels/mkl/mkl_swish_op.cc", "MklSwishOp");
}

  virtual void Compute_Scalar(OpKernelContext* context) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_swish_opDTcc mht_2(mht_2_v, 211, "", "./tensorflow/core/kernels/mkl/mkl_swish_op.cc", "Compute_Scalar");
