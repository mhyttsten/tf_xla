...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc() {
      // Check if tracing is enabled
...
class MklDnnQuantizedMatMulOp : public MklDnnMatMulOpBase<Tweight, Toutput> {
 public:
  virtual ~MklDnnQuantizedMatMulOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_0(mht_0_v, 286, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "~MklDnnQuantizedMatMulOp");
  ...
  float* GetCompBiasBuffer(int size) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_1(mht_1_v, 304, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "GetCompBiasBuffer");
  ...
  explicit MklDnnQuantizedMatMulOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_2(mht_2_v, 315, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "MklDnnQuantizedMatMulOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_3(mht_3_v, 337, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "Compute");
 ...
 protected:
  void ComputeOutputRangeForInt32(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_4(mht_4_v, 527, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "ComputeOutputRangeForInt32");
  ...
  virtual void ExtendMklDnnMatMulFwdParams(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_5(mht_5_v, 541, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "ExtendMklDnnMatMulFwdParams");
  ...
  Tbias* GetBiasHandle(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_6(mht_6_v, 593, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "GetBiasHandle");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_7(mht_7_v, 632, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "lambda");
...
class MklDnnQuantizedMatMulReluOp
 ...
 public:
  virtual ~MklDnnQuantizedMatMulReluOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_8(mht_8_v, 717, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "~MklDnnQuantizedMatMulReluOp");
}
  ...
  explicit MklDnnQuantizedMatMulReluOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_9(mht_9_v, 724, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "MklDnnQuantizedMatMulReluOp");
}
 ...
 protected:
  void ExtendMklDnnMatMulFwdParams(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_qmatmul_opDTcc mht_10(mht_10_v, 731, "", "./tensorflow/core/kernels/mkl/mkl_qmatmul_op.cc", "ExtendMklDnnMatMulFwdParams");
