...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_mish_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_mish_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_mish_opDTcc() {
      // Check if tracing is enabled
...
class MklFusedMishOp
 ...
 public:
  ~MklFusedMishOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_mish_opDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/kernels/mkl/mkl_fused_mish_op.cc", "~MklFusedMishOp");
}
  ...
  explicit MklFusedMishOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_mish_opDTcc mht_1(mht_1_v, 205, "", "./tensorflow/core/kernels/mkl/mkl_fused_mish_op.cc", "MklFusedMishOp");
}

  virtual void Compute_Scalar(OpKernelContext* context) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_fused_mish_opDTcc mht_2(mht_2_v, 210, "", "./tensorflow/core/kernels/mkl/mkl_fused_mish_op.cc", "Compute_Scalar");
