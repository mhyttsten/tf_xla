...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc() {
      // Check if tracing is enabled
...
struct MklConvBwdFilterParams {
  ...
  MklConvBwdFilterParams(memory::dims src_dims, memory::dims diff_filter_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_0(mht_0_v, 238, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "MklConvBwdFilterParams");
}
};
...
class MklConvBwdFilterPrimitive : public MklPrimitive {
 public:
  explicit MklConvBwdFilterPrimitive(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_1(mht_1_v, 249, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "MklConvBwdFilterPrimitive");
  ...
  ~MklConvBwdFilterPrimitive() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_2(mht_2_v, 259, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "~MklConvBwdFilterPrimitive");
}
  ...
  void Execute(const T* src_data, const T* diff_filter_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_3(mht_3_v, 271, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "Execute");
  ...
  void Execute(const T* src_data, const T* diff_filter_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_4(mht_4_v, 321, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "Execute");
 ...
 private:
  ...
  struct ConvBwdFilterContext {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_5(mht_5_v, 375, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "ConvBwdFilterContext");
}
  };

  void Setup(const MklConvBwdFilterParams& convBwdFilterDims) {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_6(mht_6_v, 381, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "Setup");
...
class MklConvBwdFilterPrimitiveFactory : public MklPrimitiveFactory<T> {
 public:
  static MklConvBwdFilterPrimitive<T>* Get(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_7(mht_7_v, 482, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "Get");
 ...
 private:
  MklConvBwdFilterPrimitiveFactory() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_8(mht_8_v, 507, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "MklConvBwdFilterPrimitiveFactory");
}
  ~MklConvBwdFilterPrimitiveFactory() {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_9(mht_9_v, 511, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "~MklConvBwdFilterPrimitiveFactory");
}

  static MklConvBwdFilterPrimitiveFactory& GetInstance() {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_10(mht_10_v, 516, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "GetInstance");
  ...
  static string CreateKey(const MklConvBwdFilterParams& convBwdFilterDims) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_11(mht_11_v, 524, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "CreateKey");
  ...
  MklPrimitive* GetConvBwdFilter(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_12(mht_12_v, 546, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "GetConvBwdFilter");
  ...
  void SetConvBwdFilter(const MklConvBwdFilterParams& convBwdFilterDims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_13(mht_13_v, 555, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "SetConvBwdFilter");
...
class MklConvCustomBackpropFilterOp
 ...
 public:
  explicit MklConvCustomBackpropFilterOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_14(mht_14_v, 570, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "MklConvCustomBackpropFilterOp");
}

  ~MklConvCustomBackpropFilterOp() {
   std::vector<std::string> mht_15_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_15(mht_15_v, 575, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "~MklConvCustomBackpropFilterOp");
}

  void Compute(OpKernelContext* context) {
   std::vector<std::string> mht_16_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_16(mht_16_v, 580, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "Compute");
 ...
 private:
  ...
  void ValidateMklShapes(const MklDnnShape& input_mkl_shape,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_17(mht_17_v, 866, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "ValidateMklShapes");
  ...
  TensorShape MakeInputTfShape(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_18(mht_18_v, 876, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "MakeInputTfShape");
  ...
  TensorShape MakeFilterTfShape(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_19(mht_19_v, 886, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "MakeFilterTfShape");
  ...
  TensorShape GetOutputTfShape(const TensorShape& input_shape,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_20(mht_20_v, 903, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "GetOutputTfShape");
  ...
  const memory::dims& GetOutputDims(const memory::dims& fwd_input_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_21(mht_21_v, 914, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "GetOutputDims");
  ...
  void AllocateOutputTensor(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_22(mht_22_v, 923, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "AllocateOutputTensor");
  ...
  void AllocateBiasGradTensor(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_conv_grad_filter_opsDTcc mht_23(mht_23_v, 949, "", "./tensorflow/core/kernels/mkl/mkl_conv_grad_filter_ops.cc", "AllocateBiasGradTensor");
