...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc() {
      // Check if tracing is enabled
...
struct RequantizeCopier {
  RequantizeCopier(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_0(mht_0_v, 230, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "RequantizeCopier");
  ...
  inline void Copy(T* dst, const T* src, int input_index, size_t n) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_1(mht_1_v, 238, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Copy");
...
class EigenConcatBaseOp : public OpKernel {
 public:
  ...
  explicit EigenConcatBaseOp(OpKernelConstruction* c) : OpKernel(c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_2(mht_2_v, 275, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "EigenConcatBaseOp");
}
  ...
  void CalculateInputAndOutputRange(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_3(mht_3_v, 284, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "CalculateInputAndOutputRange");
  ...
  void Compute(OpKernelContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_4(mht_4_v, 315, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Compute");
}
  ...
  void Compute(OpKernelContext* c, const std::vector<Tensor>& values,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_5(mht_5_v, 323, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Compute");
...
struct MklConcatFwdParams {
  ...
  MklConcatFwdParams(std::vector<memory::dims>& src_dims_pt,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_6(mht_6_v, 442, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "MklConcatFwdParams");
...
class MklConcatFwdPrimitive : public MklPrimitive {
 public:
  explicit MklConcatFwdPrimitive(const MklConcatFwdParams& concat_fwd_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_7(mht_7_v, 461, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "MklConcatFwdPrimitive");
  ...
  ~MklConcatFwdPrimitive() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_8(mht_8_v, 469, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "~MklConcatFwdPrimitive");
}
  ...
  void Execute(const std::vector<dnnl::memory>& in_data,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_9(mht_9_v, 480, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Execute");
 ...
 private:
  ...
  struct ConcatFwdContext {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_10(mht_10_v, 542, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "ConcatFwdContext");
}
  };
  ...
  void Setup(const MklConcatFwdParams& concat_fwd_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_11(mht_11_v, 551, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Setup");
...
class MklConcatFwdPrimitiveFactory : public MklPrimitiveFactory<T> {
 public:
  static MklConcatFwdPrimitive<T>* Get(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_12(mht_12_v, 602, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Get");
 ...
 private:
  MklConcatFwdPrimitiveFactory() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_13(mht_13_v, 627, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "MklConcatFwdPrimitiveFactory");
}
  ~MklConcatFwdPrimitiveFactory() {
   std::vector<std::string> mht_14_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_14(mht_14_v, 631, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "~MklConcatFwdPrimitiveFactory");
}

  static MklConcatFwdPrimitiveFactory& GetInstance() {
   std::vector<std::string> mht_15_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_15(mht_15_v, 636, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "GetInstance");
  ...
  static string CreateKey(const MklConcatFwdParams& concat_fwd_dims) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_16(mht_16_v, 644, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "CreateKey");
  ...
  MklPrimitive* GetConcatFwd(const MklConcatFwdParams& concat_fwd_dims) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_17(mht_17_v, 658, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "GetConcatFwd");
  ...
  void SetConcatFwd(const MklConcatFwdParams& concat_fwd_dims,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_18(mht_18_v, 667, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "SetConcatFwd");
...
class MklConcatOp : public OpKernel {
 ...
 public:
  ...
  explicit MklConcatOp(OpKernelConstruction* c)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_19(mht_19_v, 690, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "MklConcatOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_20_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_20(mht_20_v, 695, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "Compute");
  ...
  void CallEigenVersion(OpKernelContext* context, const OpInputList& values,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_21(mht_21_v, 1068, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "CallEigenVersion");
  ...
  memory::format_tag FindMklCommonFormat(const MklDnnShapeList& input_shapes,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_concat_opDTcc mht_22(mht_22_v, 1124, "", "./tensorflow/core/kernels/mkl/mkl_concat_op.cc", "FindMklCommonFormat");
