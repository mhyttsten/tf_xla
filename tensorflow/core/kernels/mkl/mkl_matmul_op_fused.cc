...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_matmul_op_fusedDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_matmul_op_fusedDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_matmul_op_fusedDTcc() {
      // Check if tracing is enabled
...
class MklFusedMatMulOp : public MklDnnMatMulOpBase<T, T> {
 public:
  explicit MklFusedMatMulOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_matmul_op_fusedDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/kernels/mkl/mkl_matmul_op_fused.cc", "MklFusedMatMulOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_matmul_op_fusedDTcc mht_1(mht_1_v, 233, "", "./tensorflow/core/kernels/mkl/mkl_matmul_op_fused.cc", "Compute");
  ...
  void ExtendMklDnnMatMulFwdParams(OpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmklPSmkl_matmul_op_fusedDTcc mht_2(mht_2_v, 453, "", "./tensorflow/core/kernels/mkl/mkl_matmul_op_fused.cc", "ExtendMklDnnMatMulFwdParams");
