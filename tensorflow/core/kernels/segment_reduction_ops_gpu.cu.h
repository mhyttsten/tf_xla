...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsegment_reduction_ops_gpuDTcuDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsegment_reduction_ops_gpuDTcuDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsegment_reduction_ops_gpuDTcuDTh() {
      // Check if tracing is enabled
...
__global__ void SegmentOffsetsKernel(
  ...
  GPU_1D_KERNEL_LOOP(i, size + 1) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsegment_reduction_ops_gpuDTcuDTh mht_0(mht_0_v, 371, "", "./tensorflow/core/kernels/segment_reduction_ops_gpu.cu.h", "lambda");
...
struct LookupAndScaleAndCastInputsFunctor {
  LookupAndScaleAndCastInputsFunctor(const Tvec* input_vec,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsegment_reduction_ops_gpuDTcuDTh mht_1(mht_1_v, 627, "", "./tensorflow/core/kernels/segment_reduction_ops_gpu.cu.h", "LookupAndScaleAndCastInputsFunctor");
}
...
MakeLookupAndScaleAndCastInputsIterator(const Tvec* input_vec,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsegment_reduction_ops_gpuDTcuDTh mht_2(mht_2_v, 658, "", "./tensorflow/core/kernels/segment_reduction_ops_gpu.cu.h", "MakeLookupAndScaleAndCastInputsIterator");
