...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc() {
      // Check if tracing is enabled
...
class TextLineReader : public ReaderBase {
 public:
  TextLineReader(const string& node_name, int skip_header_lines, Env* env)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/text_line_reader_op.cc", "TextLineReader");
}

  Status OnWorkStartedLocked() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/kernels/text_line_reader_op.cc", "OnWorkStartedLocked");
  ...
  Status OnWorkFinishedLocked() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc mht_2(mht_2_v, 230, "", "./tensorflow/core/kernels/text_line_reader_op.cc", "OnWorkFinishedLocked");
  ...
  Status ReadLocked(tstring* key, tstring* value, bool* produced,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc mht_3(mht_3_v, 239, "", "./tensorflow/core/kernels/text_line_reader_op.cc", "ReadLocked");
  ...
  Status ResetLocked() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc mht_4(mht_4_v, 258, "", "./tensorflow/core/kernels/text_line_reader_op.cc", "ResetLocked");
...
class TextLineReaderOp : public ReaderOpKernel {
 public:
  explicit TextLineReaderOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStext_line_reader_opDTcc mht_5(mht_5_v, 283, "", "./tensorflow/core/kernels/text_line_reader_op.cc", "TextLineReaderOp");
