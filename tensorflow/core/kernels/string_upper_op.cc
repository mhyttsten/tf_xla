...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_upper_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_upper_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_upper_opDTcc() {
      // Check if tracing is enabled
...
class StringUpperOp : public OpKernel {
 public:
  explicit StringUpperOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_upper_opDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/string_upper_op.cc", "StringUpperOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_upper_opDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/kernels/string_upper_op.cc", "Compute");
