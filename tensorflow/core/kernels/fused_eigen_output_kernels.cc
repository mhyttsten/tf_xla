...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfused_eigen_output_kernelsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_eigen_output_kernelsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfused_eigen_output_kernelsDTcc() {
      // Check if tracing is enabled
...
Status InitializeFusedComputation(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_eigen_output_kernelsDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/fused_eigen_output_kernels.cc", "InitializeFusedComputation");
