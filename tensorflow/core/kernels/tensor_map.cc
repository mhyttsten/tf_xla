...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc() {
      // Check if tracing is enabled
...
TensorMap::~TensorMap() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/kernels/tensor_map.cc", "TensorMap::~TensorMap");
...
void TensorMap::Encode(VariantTensorData* data) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc mht_1(mht_1_v, 201, "", "./tensorflow/core/kernels/tensor_map.cc", "TensorMap::Encode");
...
static Status TensorMapDeviceCopy(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc mht_2(mht_2_v, 223, "", "./tensorflow/core/kernels/tensor_map.cc", "TensorMapDeviceCopy");
...
bool TensorMap::Decode(const VariantTensorData& data) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStensor_mapDTcc mht_3(mht_3_v, 247, "", "./tensorflow/core/kernels/tensor_map.cc", "TensorMap::Decode");
