...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSspectrogram_convert_test_dataDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspectrogram_convert_test_dataDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSspectrogram_convert_test_dataDTcc() {
      // Check if tracing is enabled
...
Status ConvertCsvToRaw(const string& input_filename) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspectrogram_convert_test_dataDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/kernels/spectrogram_convert_test_data.cc", "ConvertCsvToRaw");
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspectrogram_convert_test_dataDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/kernels/spectrogram_convert_test_data.cc", "main");
