...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_dctDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_dctDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_dctDTcc() {
      // Check if tracing is enabled
...
MfccDct::MfccDct() : initialized_(false) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_dctDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/kernels/mfcc_dct.cc", "MfccDct::MfccDct");
}

bool MfccDct::Initialize(int input_length, int coefficient_count) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_dctDTcc mht_1(mht_1_v, 197, "", "./tensorflow/core/kernels/mfcc_dct.cc", "MfccDct::Initialize");
...
void MfccDct::Compute(const std::vector<double> &input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_dctDTcc mht_2(mht_2_v, 236, "", "./tensorflow/core/kernels/mfcc_dct.cc", "MfccDct::Compute");
