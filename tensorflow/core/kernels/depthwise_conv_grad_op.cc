...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc() {
      // Check if tracing is enabled
...
static void CopyOutputBackpropRegion(const DepthwiseArgs& args,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_0(mht_0_v, 364, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "CopyOutputBackpropRegion");
...
static void ComputeBackpropInput(const DepthwiseArgs& args,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_1(mht_1_v, 466, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "ComputeBackpropInput");
...
struct LaunchDepthwiseConvBackpropInputOp<CPUDevice, T> {
  ...
  void operator()(OpKernelContext* ctx, const DepthwiseArgs& args,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_2(mht_2_v, 596, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "lambda");
...
static void DepthwiseConvBackpropInputReference(const DepthwiseArgs& args,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_3(mht_3_v, 656, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "DepthwiseConvBackpropInputReference");
...
class DepthwiseConv2dNativeBackpropInputOp : public OpKernel {
 public:
  explicit DepthwiseConv2dNativeBackpropInputOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_4(mht_4_v, 736, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "DepthwiseConv2dNativeBackpropInputOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_5(mht_5_v, 795, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "Compute");
...
class DepthwiseConv2dGroupedConvBackpropInputOp
 ...
 public:
  DepthwiseConv2dGroupedConvBackpropInputOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_6(mht_6_v, 931, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "DepthwiseConv2dGroupedConvBackpropInputOp");
...
struct LaunchDepthwiseConvBackpropFilterOp<CPUDevice, T> {
  ...
  void operator()(OpKernelContext* ctx, const DepthwiseArgs& args,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_7(mht_7_v, 1088, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "lambda");
...
static void DepthwiseConvBackpropFilterReference(const DepthwiseArgs& args,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_8(mht_8_v, 1182, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "DepthwiseConvBackpropFilterReference");
...
class DepthwiseConv2dNativeBackpropFilterOp : public OpKernel {
 public:
  explicit DepthwiseConv2dNativeBackpropFilterOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_9(mht_9_v, 1254, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "DepthwiseConv2dNativeBackpropFilterOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_10(mht_10_v, 1308, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "Compute");
...
class DepthwiseConv2dGroupedConvBackpropFilterOp
 ...
 public:
  DepthwiseConv2dGroupedConvBackpropFilterOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_grad_opDTcc mht_11(mht_11_v, 1477, "", "./tensorflow/core/kernels/depthwise_conv_grad_op.cc", "DepthwiseConv2dGroupedConvBackpropFilterOp");
