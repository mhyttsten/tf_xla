...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc() {
      // Check if tracing is enabled
...
void SwapDimSizes(const int dim_a, const int dim_b, TensorShape* shape) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_0(mht_0_v, 222, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "SwapDimSizes");
...
class CSRSparseMatMulCPUOp : public OpKernel {
 ...
 public:
  explicit CSRSparseMatMulCPUOp(OpKernelConstruction* c) : OpKernel(c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_1(mht_1_v, 262, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "CSRSparseMatMulCPUOp");
  ...
  void Compute(OpKernelContext* ctx) final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_2(mht_2_v, 278, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "Compute");
...
class CSRSparseMatMulGPUOp : public OpKernel {
 public:
  explicit CSRSparseMatMulGPUOp(OpKernelConstruction* c) : OpKernel(c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_3(mht_3_v, 473, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "CSRSparseMatMulGPUOp");
  ...
  void Compute(OpKernelContext* ctx) final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_4(mht_4_v, 495, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "Compute");
...
struct CSRSparseSparseMatrixMatMul<GPUDevice, T>
  ...
  explicit CSRSparseSparseMatrixMatMul(OpKernelContext* ctx, bool transpose_a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_5(mht_5_v, 744, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "CSRSparseSparseMatrixMatMul");
  ...
  Status GetWorkspaceSize(const ConstCSRComponent<T>& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_6(mht_6_v, 787, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "GetWorkspaceSize");
  ...
  Status GetOutputStructure(const ConstCSRComponent<T>& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_7(mht_7_v, 821, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "GetOutputStructure");
  ...
  Status Compute(const ConstCSRComponent<T>& a, const ConstCSRComponent<T>& b,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSsparse_mat_mul_opDTcc mht_8(mht_8_v, 867, "", "./tensorflow/core/kernels/sparse/sparse_mat_mul_op.cc", "Compute");
