...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc() {
      // Check if tracing is enabled
...
class DenseToCSRSparseMatrixCPUOp : public OpKernel {
 public:
  explicit DenseToCSRSparseMatrixCPUOp(OpKernelConstruction* c) : OpKernel(c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc mht_0(mht_0_v, 234, "", "./tensorflow/core/kernels/sparse/dense_to_csr_sparse_matrix_op.cc", "DenseToCSRSparseMatrixCPUOp");
}

  void Compute(OpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc mht_1(mht_1_v, 239, "", "./tensorflow/core/kernels/sparse/dense_to_csr_sparse_matrix_op.cc", "Compute");
...
class DenseToCSRSparseMatrixGPUOp : public AsyncOpKernel {
 public:
  explicit DenseToCSRSparseMatrixGPUOp(OpKernelConstruction* c)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc mht_2(mht_2_v, 328, "", "./tensorflow/core/kernels/sparse/dense_to_csr_sparse_matrix_op.cc", "DenseToCSRSparseMatrixGPUOp");
}

  void ComputeAsync(OpKernelContext* c, DoneCallback done) final {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc mht_3(mht_3_v, 333, "", "./tensorflow/core/kernels/sparse/dense_to_csr_sparse_matrix_op.cc", "ComputeAsync");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSdense_to_csr_sparse_matrix_opDTcc mht_4(mht_4_v, 405, "", "./tensorflow/core/kernels/sparse/dense_to_csr_sparse_matrix_op.cc", "lambda");
