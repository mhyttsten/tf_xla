...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSzeros_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSzeros_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSzeros_opDTcc() {
      // Check if tracing is enabled
...
class CSRZerosOp : public OpKernel {
 public:
  explicit CSRZerosOp(OpKernelConstruction* c) : OpKernel(c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSzeros_opDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/kernels/sparse/zeros_op.cc", "CSRZerosOp");
  ...
  void Compute(OpKernelContext* c) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSzeros_opDTcc mht_1(mht_1_v, 219, "", "./tensorflow/core/kernels/sparse/zeros_op.cc", "Compute");
...
Status CSRSparseMatrixZerosLikeHelper(OpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparsePSzeros_opDTcc mht_2(mht_2_v, 245, "", "./tensorflow/core/kernels/sparse/zeros_op.cc", "CSRSparseMatrixZerosLikeHelper");
