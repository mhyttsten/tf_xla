...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSredux_functorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSredux_functorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSredux_functorDTh() {
      // Check if tracing is enabled
...
struct ReduceOuterDimensions {
  ReduceOuterDimensions() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSredux_functorDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/kernels/redux_functor.h", "ReduceOuterDimensions");
}
...
struct ReduceMiddleDimensions {
  ReduceMiddleDimensions() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSredux_functorDTh mht_1(mht_1_v, 381, "", "./tensorflow/core/kernels/redux_functor.h", "ReduceMiddleDimensions");
}
