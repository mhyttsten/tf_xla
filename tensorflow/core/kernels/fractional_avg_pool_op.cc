...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc() {
      // Check if tracing is enabled
...
class FractionalAvgPoolOp : public OpKernel {
 public:
  explicit FractionalAvgPoolOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/fractional_avg_pool_op.cc", "FractionalAvgPoolOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc mht_1(mht_1_v, 239, "", "./tensorflow/core/kernels/fractional_avg_pool_op.cc", "Compute");
...
class FractionalAvgPoolGradOp : public OpKernel {
 public:
  explicit FractionalAvgPoolGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc mht_2(mht_2_v, 387, "", "./tensorflow/core/kernels/fractional_avg_pool_op.cc", "FractionalAvgPoolGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfractional_avg_pool_opDTcc mht_3(mht_3_v, 394, "", "./tensorflow/core/kernels/fractional_avg_pool_op.cc", "Compute");
