...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh() {
      // Check if tracing is enabled
...
PHILOX_DEVICE_INLINE void Uint64ToUint32s(uint64 input, uint32* output1,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_0(mht_0_v, 199, "", "./tensorflow/core/kernels/random_ops_util.h", "Uint64ToUint32s");
...
PHILOX_DEVICE_INLINE uint64 Uint32sToUint64(uint32 input1, uint32 input2) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_1(mht_1_v, 207, "", "./tensorflow/core/kernels/random_ops_util.h", "Uint32sToUint64");
...
PHILOX_DEVICE_INLINE PhiloxRandom::ResultType GetCounterFromMem(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_2(mht_2_v, 217, "", "./tensorflow/core/kernels/random_ops_util.h", "GetCounterFromMem");
...
PHILOX_DEVICE_INLINE void WriteCounterToMem(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_3(mht_3_v, 228, "", "./tensorflow/core/kernels/random_ops_util.h", "WriteCounterToMem");
...
PHILOX_DEVICE_INLINE PhiloxRandom::Key GetKeyFromMem(uint64 const* ptr) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_4(mht_4_v, 236, "", "./tensorflow/core/kernels/random_ops_util.h", "GetKeyFromMem");
...
PHILOX_DEVICE_INLINE void WriteKeyToMem(PhiloxRandom::Key const& key,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_5(mht_5_v, 246, "", "./tensorflow/core/kernels/random_ops_util.h", "WriteKeyToMem");
...
PHILOX_DEVICE_INLINE PhiloxRandom GetPhiloxRandomFromCounterKeyMem(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_ops_utilDTh mht_6(mht_6_v, 254, "", "./tensorflow/core/kernels/random_ops_util.h", "GetPhiloxRandomFromCounterKeyMem");
