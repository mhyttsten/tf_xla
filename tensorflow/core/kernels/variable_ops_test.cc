...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSvariable_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSvariable_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSvariable_ops_testDTcc() {
      // Check if tracing is enabled
...
void ManyManyVariablesHelper(int threads, int variables,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSvariable_ops_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/kernels/variable_ops_test.cc", "ManyManyVariablesHelper");
...
void BM_ManyManyVariablesManyThreads(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSvariable_ops_testDTcc mht_1(mht_1_v, 231, "", "./tensorflow/core/kernels/variable_ops_test.cc", "BM_ManyManyVariablesManyThreads");
