...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc() {
      // Check if tracing is enabled
...
void ColMeanAndVariance(const uint8_t* input, const uint32_t rows,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc mht_0(mht_0_v, 211, "", "./tensorflow/core/kernels/quantized_instance_norm.cc", "ColMeanAndVariance");
...
void MinAndMax(const uint8_t* input, const uint32_t rows, const uint32_t cols,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc mht_1(mht_1_v, 312, "", "./tensorflow/core/kernels/quantized_instance_norm.cc", "MinAndMax");
...
void InstanceNorm(const uint8_t* input, const uint32_t rows,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc mht_2(mht_2_v, 372, "", "./tensorflow/core/kernels/quantized_instance_norm.cc", "InstanceNorm");
...
class QuantizedInstanceNorm : public OpKernel {
 public:
  explicit QuantizedInstanceNorm(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc mht_3(mht_3_v, 435, "", "./tensorflow/core/kernels/quantized_instance_norm.cc", "QuantizedInstanceNorm");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_instance_normDTcc mht_4(mht_4_v, 455, "", "./tensorflow/core/kernels/quantized_instance_norm.cc", "Compute");
