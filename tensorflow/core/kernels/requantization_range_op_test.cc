...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrequantization_range_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrequantization_range_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrequantization_range_op_testDTcc() {
      // Check if tracing is enabled
...
static void BM_RequantizationRange(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrequantization_range_op_testDTcc mht_0(mht_0_v, 239, "", "./tensorflow/core/kernels/requantization_range_op_test.cc", "BM_RequantizationRange");
