...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_cpuDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_cpuDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_cpuDTh() {
      // Check if tracing is enabled
...
void TileSimple(const Eigen::ThreadPoolDevice& d, Tensor* out,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_cpuDTh mht_0(mht_0_v, 219, "", "./tensorflow/core/kernels/tile_functor_cpu.h", "TileSimple");
