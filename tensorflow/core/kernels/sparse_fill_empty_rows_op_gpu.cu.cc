...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
bool to_pointers(bool x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_0(mht_0_v, 215, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "to_pointers");
 return x; }
int32 to_pointers(int32 x) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_1(mht_1_v, 219, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "to_pointers");
 return x; }
int64 to_pointers(int64 x) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_2(mht_2_v, 223, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "to_pointers");
 return x; }
template <class T>
T* to_pointers(T* x) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_3(mht_3_v, 228, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "to_pointers");
...
typename T::PointerType to_pointers(T& x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_4(mht_4_v, 235, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "to_pointers");
...
typename T::ConstPointerType to_pointers(const T& x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_5(mht_5_v, 242, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "to_pointers");
...
struct SparseFillEmptyRows<GPUDevice, T, Tindex> {
 ...
 private:
  Status AllocateOutputsExceptEmptyRowIndicator(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_6(mht_6_v, 616, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "AllocateOutputsExceptEmptyRowIndicator");
  ...
  Status ArgSortByRows(OpKernelContext* context, const GPUDevice& device,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_7(mht_7_v, 647, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "ArgSortByRows");
...
struct ZeroMaskedValues {
  ZeroMaskedValues(const bool* _mask, const T* _values)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_fill_empty_rows_op_gpuDTcuDTcc mht_8(mht_8_v, 695, "", "./tensorflow/core/kernels/sparse_fill_empty_rows_op_gpu.cu.cc", "ZeroMaskedValues");
}
