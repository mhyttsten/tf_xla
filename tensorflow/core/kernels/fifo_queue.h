...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfifo_queueDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfifo_queueDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfifo_queueDTh() {
      // Check if tracing is enabled
...
class FIFOQueue : public TypedQueue<std::deque<Tensor> > {
 public:
  ...
  int32 size() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfifo_queueDTh mht_0(mht_0_v, 221, "", "./tensorflow/core/kernels/fifo_queue.h", "size");
 ...
 protected:
  ~FIFOQueue() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfifo_queueDTh mht_1(mht_1_v, 230, "", "./tensorflow/core/kernels/fifo_queue.h", "~FIFOQueue");
}
