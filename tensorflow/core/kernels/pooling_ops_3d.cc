...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc() {
      // Check if tracing is enabled
...
Pool3dParameters::Pool3dParameters(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_0(mht_0_v, 221, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Pool3dParameters::Pool3dParameters");
...
TensorShape Pool3dParameters::forward_output_shape() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_1(mht_1_v, 262, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Pool3dParameters::forward_output_shape");
...
struct LaunchPoolingOp<CPUDevice, T, AVG> {
  static void launch(OpKernelContext* context, const Tensor& tensor_in,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_2(mht_2_v, 277, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
struct LaunchPoolingOp<CPUDevice, T, MAX> {
  static void launch(OpKernelContext* context, const Tensor& tensor_in,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_3(mht_3_v, 295, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
class Pooling3DOp : public UnaryOp<T> {
 public:
  explicit Pooling3DOp(OpKernelConstruction* context) : UnaryOp<T>(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_4(mht_4_v, 309, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Pooling3DOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_5(mht_5_v, 350, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Compute");
...
struct LaunchMaxPooling3dGradOp<CPUDevice, T> {
  static void launch(OpKernelContext* context, const Tensor& tensor_in,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_6(mht_6_v, 402, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
class MaxPooling3dGradOp : public OpKernel {
 public:
  explicit MaxPooling3dGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_7(mht_7_v, 493, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "MaxPooling3dGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_8(mht_8_v, 529, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Compute");
...
struct LaunchAvgPooling3dGradOp<CPUDevice, T> {
  static void launch(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_9(mht_9_v, 595, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
class AvgPooling3dGradOp : public OpKernel {
 public:
  explicit AvgPooling3dGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_10(mht_10_v, 678, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "AvgPooling3dGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_11(mht_11_v, 714, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Compute");
...
struct LaunchMaxPooling3dGradGradOp<CPUDevice, T> {
  static void launch(OpKernelContext* context, const Pool3dParameters& params,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_12(mht_12_v, 770, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_13(mht_13_v, 804, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "lambda");
...
class MaxPooling3dGradGradOp : public OpKernel {
 public:
  explicit MaxPooling3dGradGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_14(mht_14_v, 889, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "MaxPooling3dGradGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_15(mht_15_v, 916, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "Compute");
...
struct LaunchPoolingOp<GPUDevice, T, AVG> {
  static void launch(OpKernelContext* context, const Tensor& tensor_in,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_16(mht_16_v, 1019, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
struct LaunchPoolingOp<GPUDevice, T, MAX> {
  static void launch(OpKernelContext* context, const Tensor& tensor_in,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_17(mht_17_v, 1035, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
struct LaunchMaxPooling3dGradOp<GPUDevice, T> {
  static void launch(OpKernelContext* context, const Tensor& tensor_in,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_18(mht_18_v, 1052, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
struct LaunchAvgPooling3dGradOp<GPUDevice, T> {
  static void launch(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_19(mht_19_v, 1073, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
...
struct LaunchMaxPooling3dGradGradOp<GPUDevice, T> {
  static void launch(OpKernelContext* context, const Pool3dParameters& params,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_3dDTcc mht_20(mht_20_v, 1088, "", "./tensorflow/core/kernels/pooling_ops_3d.cc", "launch");
