...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsearchsorted_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsearchsorted_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsearchsorted_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
struct UpperBoundFunctor<GPUDevice, T, OutType> {
  static Status Compute(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsearchsorted_op_gpuDTcuDTcc mht_0(mht_0_v, 236, "", "./tensorflow/core/kernels/searchsorted_op_gpu.cu.cc", "Compute");
...
struct LowerBoundFunctor<GPUDevice, T, OutType> {
  static Status Compute(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsearchsorted_op_gpuDTcuDTcc mht_1(mht_1_v, 262, "", "./tensorflow/core/kernels/searchsorted_op_gpu.cu.cc", "Compute");
