...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSidentity_n_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSidentity_n_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSidentity_n_opDTh() {
      // Check if tracing is enabled
...
class IdentityNOp : public OpKernel {
 public:
  explicit IdentityNOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSidentity_n_opDTh mht_0(mht_0_v, 196, "", "./tensorflow/core/kernels/identity_n_op.h", "IdentityNOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSidentity_n_opDTh mht_1(mht_1_v, 201, "", "./tensorflow/core/kernels/identity_n_op.h", "Compute");
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSidentity_n_opDTh mht_2(mht_2_v, 221, "", "./tensorflow/core/kernels/identity_n_op.h", "IsExpensive");
 return false; }
};
