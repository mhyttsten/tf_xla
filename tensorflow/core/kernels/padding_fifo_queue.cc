...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc() {
      // Check if tracing is enabled
...
PaddingFIFOQueue::PaddingFIFOQueue(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::PaddingFIFOQueue");
}

Status PaddingFIFOQueue::Initialize() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_1(mht_1_v, 217, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::Initialize");
...
Status PaddingFIFOQueue::GetElementComponent(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_2(mht_2_v, 237, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::GetElementComponent");
...
void PaddingFIFOQueue::TryDequeueMany(int num_elements, OpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_3(mht_3_v, 250, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::TryDequeueMany");
  ...
  bool already_cancelled;
  {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_4(mht_4_v, 283, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_5(mht_5_v, 403, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "lambda");
...
Status PaddingFIFOQueue::ValidateTuple(const Tuple& tuple) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_6(mht_6_v, 424, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::ValidateTuple");
...
Status PaddingFIFOQueue::ValidateManyTuple(const Tuple& tuple) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_7(mht_7_v, 440, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::ValidateManyTuple");
...
Status PaddingFIFOQueue::CompatibleNodeDefShapes(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_8(mht_8_v, 461, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::CompatibleNodeDefShapes");
...
Status PaddingFIFOQueue::MatchesNodeDef(const NodeDef& node_def) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_9(mht_9_v, 479, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::MatchesNodeDef");
...
static Status ValidateElementToLargerSlice(const Tensor& element,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_10(mht_10_v, 495, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "ValidateElementToLargerSlice");
...
Status HandleElementToLargerSliceWithRank(const Tensor& element, Tensor* parent,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_11(mht_11_v, 539, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "HandleElementToLargerSliceWithRank");
...
Status PaddingFIFOQueue::CopyElementToLargerSlice(const Tensor& element,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_12(mht_12_v, 561, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::CopyElementToLargerSlice");
...
Status PaddingFIFOQueue::SetElementZero(Tensor* element) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_13(mht_13_v, 593, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::SetElementZero");
...
std::vector<TensorShape> PaddingFIFOQueue::ConvertShapesPartialDimensionsToZero(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpadding_fifo_queueDTcc mht_14(mht_14_v, 609, "", "./tensorflow/core/kernels/padding_fifo_queue.cc", "PaddingFIFOQueue::ConvertShapesPartialDimensionsToZero");
