...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTh() {
      // Check if tracing is enabled
...
class StringToKeyedHashBucketOp : public OpKernel {
 public:
  explicit StringToKeyedHashBucketOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTh mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/string_to_hash_bucket_op.h", "StringToKeyedHashBucketOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/kernels/string_to_hash_bucket_op.h", "Compute");
