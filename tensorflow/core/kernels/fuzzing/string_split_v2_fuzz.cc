...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSstring_split_v2_fuzzDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSstring_split_v2_fuzzDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSstring_split_v2_fuzzDTcc() {
      // Check if tracing is enabled
...
class FuzzStringSplitV2 : public FuzzSession {
  void BuildGraph(const Scope& scope) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSstring_split_v2_fuzzDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/kernels/fuzzing/string_split_v2_fuzz.cc", "BuildGraph");
  ...
  void FuzzImpl(const uint8_t* data, size_t size) final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSstring_split_v2_fuzzDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/kernels/fuzzing/string_split_v2_fuzz.cc", "FuzzImpl");
