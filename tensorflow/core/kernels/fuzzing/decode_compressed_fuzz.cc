...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSdecode_compressed_fuzzDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSdecode_compressed_fuzzDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSdecode_compressed_fuzzDTcc() {
      // Check if tracing is enabled
...
class FuzzDecodeCompressed : public FuzzStringInputOp {
  void BuildGraph(const Scope& scope) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSdecode_compressed_fuzzDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/kernels/fuzzing/decode_compressed_fuzz.cc", "BuildGraph");
