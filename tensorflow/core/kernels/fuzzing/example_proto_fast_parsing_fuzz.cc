...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSexample_proto_fast_parsing_fuzzDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSexample_proto_fast_parsing_fuzzDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSexample_proto_fast_parsing_fuzzDTcc() {
      // Check if tracing is enabled
...
class FuzzExampleProtoFastParsing : public FuzzSession {
  void BuildGraph(const Scope& scope) final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSexample_proto_fast_parsing_fuzzDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/kernels/fuzzing/example_proto_fast_parsing_fuzz.cc", "BuildGraph");
  ...
  void FuzzImpl(const uint8_t* data, size_t size) final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfuzzingPSexample_proto_fast_parsing_fuzzDTcc mht_1(mht_1_v, 223, "", "./tensorflow/core/kernels/fuzzing/example_proto_fast_parsing_fuzz.cc", "FuzzImpl");
