...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPScross_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScross_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPScross_op_testDTcc() {
      // Check if tracing is enabled
...
class CrossOpTest : public OpsTestBase {
 protected:
  CrossOpTest() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScross_op_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/cross_op_test.cc", "CrossOpTest");
...
class CrossOpIntTest : public OpsTestBase {
 protected:
  CrossOpIntTest() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScross_op_testDTcc mht_1(mht_1_v, 252, "", "./tensorflow/core/kernels/cross_op_test.cc", "CrossOpIntTest");
