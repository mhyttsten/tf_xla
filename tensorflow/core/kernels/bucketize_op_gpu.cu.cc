...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSbucketize_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbucketize_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSbucketize_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
struct BucketizeFunctor<GPUDevice, T> {
  ...
  static Status Compute(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbucketize_op_gpuDTcuDTcc mht_0(mht_0_v, 253, "", "./tensorflow/core/kernels/bucketize_op_gpu.cu.cc", "Compute");
