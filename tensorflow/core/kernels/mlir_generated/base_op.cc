...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc() {
      // Check if tracing is enabled
...
class MlirTensorBuffer : public TensorBuffer {
 public:
  MlirTensorBuffer(const void* ptr, size_t size, Allocator* allocator)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "MlirTensorBuffer");
}

  ~MlirTensorBuffer() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_1(mht_1_v, 205, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "~MlirTensorBuffer");
  ...
  size_t size() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_2(mht_2_v, 214, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "size");
 return size_; }

  TensorBuffer* root_buffer() override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_3(mht_3_v, 219, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "root_buffer");
 return this; }

  void FillAllocationDescription(AllocationDescription* proto) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_4(mht_4_v, 224, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "FillAllocationDescription");
...
TensorBuffer* GetMlirTensorBuffer(const void* ptr, size_t size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_5(mht_5_v, 252, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "GetMlirTensorBuffer");
...
UnrankedMemRef ConvertTensorToDescriptor(const Tensor& tensor,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_6(mht_6_v, 262, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "ConvertTensorToDescriptor");
...
TensorShape ExtractShapeFromDescriptor(UnrankedMemRef unranked_descriptor) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSbase_opDTcc mht_7(mht_7_v, 297, "", "./tensorflow/core/kernels/mlir_generated/base_op.cc", "ExtractShapeFromDescriptor");
