...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc() {
      // Check if tracing is enabled
...
class BinaryOpsTest : public BinaryOpsTestBase {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "SetUp");
...
T baseline_add(T lhs, T rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_add");
...
Eigen::half baseline_atan2(Eigen::half lhs, Eigen::half rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_2(mht_2_v, 289, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_atan2");
...
T baseline_bitwise_and(T lhs, T rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_3(mht_3_v, 357, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_bitwise_and");
...
double baseline_polygamma(double n, double x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_4(mht_4_v, 1353, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_polygamma");
...
T baseline_pow(T lhs, T rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_5(mht_5_v, 1425, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_pow");
...
Eigen::half baseline_pow(Eigen::half lhs, Eigen::half rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_6(mht_6_v, 1447, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_pow");
...
T baseline_right_shift(T lhs, T rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_7(mht_7_v, 1526, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_right_shift");
...
T baseline_xlogy(T x, T y) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_8(mht_8_v, 1643, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_xlogy");
...
double baseline_zeta(double x, double q) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_9(mht_9_v, 1767, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "baseline_zeta");
  ...
  auto close_to = [](double a, double b) {
   std::vector<std::string> mht_10_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_binary_ops_testDTcc mht_10(mht_10_v, 1788, "", "./tensorflow/core/kernels/mlir_generated/gpu_binary_ops_test.cc", "lambda");
