...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc() {
      // Check if tracing is enabled
...
class UnaryOpsTest : public UnaryOpsTestBase {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "SetUp");
...
T baseline_abs(T x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_1(mht_1_v, 215, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "baseline_abs");
...
typename T::value_type baseline_angle(T x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_2(mht_2_v, 280, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "baseline_angle");
...
typename T::value_type baseline_complex_abs(T x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_3(mht_3_v, 437, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "baseline_complex_abs");
...
typename T::value_type baseline_imag(T x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_4(mht_4_v, 718, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "baseline_imag");
...
typename T::value_type baseline_real(T x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_5(mht_5_v, 989, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "baseline_real");
...
T baseline_square(T x) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmlir_generatedPSgpu_unary_ops_testDTcc mht_6(mht_6_v, 1347, "", "./tensorflow/core/kernels/mlir_generated/gpu_unary_ops_test.cc", "baseline_square");
