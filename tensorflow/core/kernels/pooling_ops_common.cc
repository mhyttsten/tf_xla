...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc() {
      // Check if tracing is enabled
...
Status CheckPaddingSize(int64_t window_rows, int64_t window_cols,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc mht_0(mht_0_v, 258, "", "./tensorflow/core/kernels/pooling_ops_common.cc", "CheckPaddingSize");
...
PoolParameters::PoolParameters(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc mht_1(mht_1_v, 295, "", "./tensorflow/core/kernels/pooling_ops_common.cc", "PoolParameters::PoolParameters");
...
TensorShape PoolParameters::forward_output_shape() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc mht_2(mht_2_v, 376, "", "./tensorflow/core/kernels/pooling_ops_common.cc", "PoolParameters::forward_output_shape");
...
void DnnPoolingGradOp<T>::Compute(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpooling_ops_commonDTcc mht_3(mht_3_v, 628, "", "./tensorflow/core/kernels/pooling_ops_common.cc", "DnnPoolingGradOp<T>::Compute");
