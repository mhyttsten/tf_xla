...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTcc() {
      // Check if tracing is enabled
...
EIGEN_DEVICE_FUNC EIGEN_DONT_INLINE bool UseCustomContractionKernels() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTcc mht_0(mht_0_v, 216, "", "./tensorflow/core/kernels/eigen_contraction_kernel.cc", "UseCustomContractionKernels");
