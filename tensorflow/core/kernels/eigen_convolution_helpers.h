...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_convolution_helpersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_convolution_helpersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_convolution_helpersDTh() {
      // Check if tracing is enabled
...
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_convolution_helpersDTh mht_0(mht_0_v, 244, "", "./tensorflow/core/kernels/eigen_convolution_helpers.h", "mask");
