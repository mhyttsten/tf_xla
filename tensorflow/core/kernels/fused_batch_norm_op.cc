...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc() {
      // Check if tracing is enabled
...
Status ParseActivationMode(OpKernelConstruction* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_0(mht_0_v, 236, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "ParseActivationMode");
...
bool BatchnormSpatialPersistentEnabled() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_1(mht_1_v, 796, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "BatchnormSpatialPersistentEnabled");
 return false; }
}  // namespace
#endif
...
se::dnn::ActivationMode AsDnnActivationMode(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_2(mht_2_v, 808, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "AsDnnActivationMode");
...
class CudnnBatchNormAllocatorInTemp : public ScratchAllocator {
 public:
  ...
  explicit CudnnBatchNormAllocatorInTemp(OpKernelContext* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_3(mht_3_v, 857, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "CudnnBatchNormAllocatorInTemp");
}

  int64_t GetMemoryLimitInBytes() override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_4(mht_4_v, 862, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "GetMemoryLimitInBytes");
  ...
  int64_t TotalByteSize() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_5(mht_5_v, 888, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "TotalByteSize");
 return total_byte_size_; }

  Tensor get_allocated_tensor(int index) const {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_6(mht_6_v, 893, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "get_allocated_tensor");
...
class CudnnBatchNormAllocatorInOutput : public ScratchAllocator {
 public:
  ~CudnnBatchNormAllocatorInOutput() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_7(mht_7_v, 913, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "~CudnnBatchNormAllocatorInOutput");
  ...
  CudnnBatchNormAllocatorInOutput(OpKernelContext* context, int output_index)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_8(mht_8_v, 925, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "CudnnBatchNormAllocatorInOutput");
}

  int64_t GetMemoryLimitInBytes() override {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_9(mht_9_v, 930, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "GetMemoryLimitInBytes");
  ...
  int64_t TotalByteSize() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_10(mht_10_v, 957, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "TotalByteSize");
 return total_byte_size_; }
...
class FusedBatchNormOpBase : public OpKernel {
 ...
 protected:
  explicit FusedBatchNormOpBase(OpKernelConstruction* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_11(mht_11_v, 1414, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormOpBase");
  ...
  virtual void ComputeWithReservedSpace(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_12(mht_12_v, 1474, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "ComputeWithReservedSpace");
...
class FusedBatchNormOp : public FusedBatchNormOpBase<Device, T, U> {
 public:
  explicit FusedBatchNormOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_13(mht_13_v, 1611, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_14_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_14(mht_14_v, 1616, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "Compute");
...
class FusedBatchNormOpV3 : public FusedBatchNormOpBase<Device, T, U> {
 public:
  explicit FusedBatchNormOpV3(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_15(mht_15_v, 1629, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormOpV3");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_16_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_16(mht_16_v, 1634, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "Compute");
...
class FusedBatchNormOpEx : public FusedBatchNormOpBase<Device, T, U> {
 ...
 public:
  explicit FusedBatchNormOpEx(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_17(mht_17_v, 1649, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormOpEx");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_18_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_18(mht_18_v, 1654, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "Compute");
...
class FusedBatchNormGradOpBase : public OpKernel {
 ...
 protected:
  explicit FusedBatchNormGradOpBase(OpKernelConstruction* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_19(mht_19_v, 1669, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormGradOpBase");
  ...
  virtual void ComputeWithReservedSpace(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_20(mht_20_v, 1720, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "ComputeWithReservedSpace");
...
class FusedBatchNormGradOp : public FusedBatchNormGradOpBase<Device, T, U> {
 public:
  explicit FusedBatchNormGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_21(mht_21_v, 1884, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormGradOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_22_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_22(mht_22_v, 1889, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "Compute");
...
class FusedBatchNormGradOpV3 : public FusedBatchNormGradOpBase<Device, T, U> {
 public:
  explicit FusedBatchNormGradOpV3(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_23(mht_23_v, 1902, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormGradOpV3");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_24_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_24(mht_24_v, 1907, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "Compute");
...
class FusedBatchNormGradOpEx : public FusedBatchNormGradOpBase<Device, T, U> {
 ...
 public:
  explicit FusedBatchNormGradOpEx(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_25(mht_25_v, 1923, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "FusedBatchNormGradOpEx");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_26_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_opDTcc mht_26(mht_26_v, 1928, "", "./tensorflow/core/kernels/fused_batch_norm_op.cc", "Compute");
