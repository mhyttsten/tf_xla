...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc() {
      // Check if tracing is enabled
...
static bool ValidShapes(const Tensor& params, const Tensor& updates,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/scatter_op.cc", "ValidShapes");
...
static void DoValidationChecking(OpKernelContext* c, const Tensor& params,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc mht_1(mht_1_v, 224, "", "./tensorflow/core/kernels/scatter_op.cc", "DoValidationChecking");
...
class ScatterUpdateOp : public OpKernel {
 public:
  ...
  explicit ScatterUpdateOp(OpKernelConstruction* c) : OpKernel(c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc mht_2(mht_2_v, 250, "", "./tensorflow/core/kernels/scatter_op.cc", "ScatterUpdateOp");
  ...
  void Compute(OpKernelContext* c) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc mht_3(mht_3_v, 266, "", "./tensorflow/core/kernels/scatter_op.cc", "Compute");
 ...
 private:
  ...
  void DoCompute(OpKernelContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSscatter_opDTcc mht_4(mht_4_v, 282, "", "./tensorflow/core/kernels/scatter_op.cc", "DoCompute");
