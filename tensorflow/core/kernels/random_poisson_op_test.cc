...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrandom_poisson_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_poisson_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrandom_poisson_op_testDTcc() {
      // Check if tracing is enabled
...
Tensor VecShape(int64_t v) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_poisson_op_testDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/kernels/random_poisson_op_test.cc", "VecShape");
...
Tensor VecLam32(int64_t n, int magnitude) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_poisson_op_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/kernels/random_poisson_op_test.cc", "VecLam32");
...
Tensor VecLam64(int64_t n, int magnitude) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_poisson_op_testDTcc mht_2(mht_2_v, 224, "", "./tensorflow/core/kernels/random_poisson_op_test.cc", "VecLam64");
