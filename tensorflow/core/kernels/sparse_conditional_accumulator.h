...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh() {
      // Check if tracing is enabled
...
class SparseConditionalAccumulator
 ...
 public:
  SparseConditionalAccumulator(const DataType& dtype,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_0(mht_0_v, 228, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "SparseConditionalAccumulator");
}
 ...
 protected:
  ...
  Status ValidateShape(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_1(mht_1_v, 248, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "ValidateShape");
  ...
  void AllocateAndAssignToAccumGradFunction(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_2(mht_2_v, 325, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "AllocateAndAssignToAccumGradFunction");
  ...
  void AddToAccumGradFunction(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_3(mht_3_v, 356, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "AddToAccumGradFunction");
  ...
  bool SetOutput(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_4(mht_4_v, 506, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "SetOutput");
  ...
  void CleanUpGradTensor(std::tuple<const Tensor*, const Tensor*,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_5(mht_5_v, 566, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "CleanUpGradTensor");
 ...
 private:
  inline int cmp(std::vector<int64_t>* a_idx, const Tensor* b_idx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_6(mht_6_v, 575, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "cmp");
  ...
  inline bool ReturnIdxTensor(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_7(mht_7_v, 589, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "ReturnIdxTensor");
  ...
  inline bool ReturnValTensor(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_8(mht_8_v, 605, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "ReturnValTensor");
  ...
  inline bool ReturnShapeTensor(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_conditional_accumulatorDTh mht_9(mht_9_v, 613, "", "./tensorflow/core/kernels/sparse_conditional_accumulator.h", "ReturnShapeTensor");
