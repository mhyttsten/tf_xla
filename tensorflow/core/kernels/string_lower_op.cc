...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_lower_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_lower_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_lower_opDTcc() {
      // Check if tracing is enabled
...
class StringLowerOp : public OpKernel {
 public:
  explicit StringLowerOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_lower_opDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/string_lower_op.cc", "StringLowerOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_lower_opDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/kernels/string_lower_op.cc", "Compute");
