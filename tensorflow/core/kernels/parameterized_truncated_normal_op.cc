...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc() {
      // Check if tracing is enabled
...
struct TruncatedNormalFunctor<CPUDevice, T> {
  void operator()(OpKernelContext* ctx, const CPUDevice& d, int64_t num_batches,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc mht_0(mht_0_v, 243, "", "./tensorflow/core/kernels/parameterized_truncated_normal_op.cc", "lambda");
...
struct TruncatedNormalFunctorV2<CPUDevice, T> {
  void operator()(OpKernelContext* ctx, const CPUDevice& d, int64_t num_batches,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc mht_1(mht_1_v, 509, "", "./tensorflow/core/kernels/parameterized_truncated_normal_op.cc", "lambda");
...
class ParameterizedTruncatedNormalOp : public OpKernel {
 ...
 public:
  explicit ParameterizedTruncatedNormalOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc mht_2(mht_2_v, 790, "", "./tensorflow/core/kernels/parameterized_truncated_normal_op.cc", "ParameterizedTruncatedNormalOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc mht_3(mht_3_v, 797, "", "./tensorflow/core/kernels/parameterized_truncated_normal_op.cc", "Compute");
...
class StatelessParameterizedTruncatedNormal : public OpKernel {
 ...
 public:
  explicit StatelessParameterizedTruncatedNormal(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc mht_4(mht_4_v, 922, "", "./tensorflow/core/kernels/parameterized_truncated_normal_op.cc", "StatelessParameterizedTruncatedNormal");
}

  void Compute(OpKernelContext* ctx) override {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSparameterized_truncated_normal_opDTcc mht_5(mht_5_v, 927, "", "./tensorflow/core/kernels/parameterized_truncated_normal_op.cc", "Compute");
