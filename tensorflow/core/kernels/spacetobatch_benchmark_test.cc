...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSspacetobatch_benchmark_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspacetobatch_benchmark_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSspacetobatch_benchmark_testDTcc() {
      // Check if tracing is enabled
...
static Graph* ConstructSpaceToBatchGraph(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspacetobatch_benchmark_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/kernels/spacetobatch_benchmark_test.cc", "ConstructSpaceToBatchGraph");
