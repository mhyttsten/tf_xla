...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsequence_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsequence_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsequence_ops_testDTcc() {
      // Check if tracing is enabled
...
class RangeOpTest : public OpsTestBase {
 protected:
  void MakeOp(DataType input_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsequence_ops_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/kernels/sequence_ops_test.cc", "MakeOp");
...
class LinSpaceOpTest : public OpsTestBase {
 protected:
  void MakeOp(DataType input_type, DataType index_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsequence_ops_testDTcc mht_1(mht_1_v, 218, "", "./tensorflow/core/kernels/sequence_ops_test.cc", "MakeOp");
