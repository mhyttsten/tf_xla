...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh() {
      // Check if tracing is enabled
...
class Mfcc {
 public:
  ...
  void set_upper_frequency_limit(double upper_frequency_limit) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/kernels/mfcc.h", "set_upper_frequency_limit");
  ...
  void set_lower_frequency_limit(double lower_frequency_limit) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh mht_1(mht_1_v, 220, "", "./tensorflow/core/kernels/mfcc.h", "set_lower_frequency_limit");
  ...
  void set_filterbank_channel_count(int filterbank_channel_count) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh mht_2(mht_2_v, 228, "", "./tensorflow/core/kernels/mfcc.h", "set_filterbank_channel_count");
  ...
  void set_dct_coefficient_count(int dct_coefficient_count) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTh mht_3(mht_3_v, 236, "", "./tensorflow/core/kernels/mfcc.h", "set_dct_coefficient_count");
