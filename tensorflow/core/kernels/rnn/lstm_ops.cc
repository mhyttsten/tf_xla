...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc() {
      // Check if tracing is enabled
...
class LSTMBlockCellOp : public OpKernel {
 public:
  explicit LSTMBlockCellOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_0(mht_0_v, 469, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "LSTMBlockCellOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_1(mht_1_v, 478, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "Compute");
...
class LSTMBlockCellGradOp : public OpKernel {
 public:
  explicit LSTMBlockCellGradOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_2(mht_2_v, 694, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "LSTMBlockCellGradOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_3(mht_3_v, 701, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "Compute");
...
class SliceHelper {
 public:
  explicit SliceHelper(OpKernelContext* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_4(mht_4_v, 973, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "SliceHelper");
}

  ~SliceHelper() {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_5(mht_5_v, 978, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "~SliceHelper");
  ...
  const Tensor InputSlice(const Tensor& t, int pos, const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_6(mht_6_v, 991, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "InputSlice");
  ...
  Tensor OutputSlice(Tensor* t, int pos, const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_7(mht_7_v, 1006, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "OutputSlice");
  ...
  void FinishTimeStep() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_8(mht_8_v, 1020, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "FinishTimeStep");
 ...
 private:
  ...
  Tensor UnalignedSlice(const Tensor& t, int pos) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_9(mht_9_v, 1041, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "UnalignedSlice");
  ...
  Tensor AlignTensor(const Tensor& t, const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_10(mht_10_v, 1054, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "AlignTensor");
...
class BlockLSTMOp : public OpKernel {
 public:
  explicit BlockLSTMOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_11(mht_11_v, 1095, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "BlockLSTMOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_12(mht_12_v, 1109, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "Compute");
...
class BlockLSTMGradOp : public OpKernel {
 public:
  explicit BlockLSTMGradOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_13(mht_13_v, 1342, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "BlockLSTMGradOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_opsDTcc mht_14(mht_14_v, 1349, "", "./tensorflow/core/kernels/rnn/lstm_ops.cc", "Compute");
