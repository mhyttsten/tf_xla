...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_ops_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_ops_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_ops_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__host__ __device__ EIGEN_STRONG_INLINE
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_ops_gpuDTcuDTcc mht_0(mht_0_v, 217, "", "./tensorflow/core/kernels/rnn/lstm_ops_gpu.cu.cc", "strict_cast");
...
__global__ void concat_xh(T* xh, const T* x, const T* h_prev,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSlstm_ops_gpuDTcuDTcc mht_1(mht_1_v, 373, "", "./tensorflow/core/kernels/rnn/lstm_ops_gpu.cu.cc", "concat_xh");
