...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSblas_gemmDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSblas_gemmDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSblas_gemmDTh() {
      // Check if tracing is enabled
...
struct TensorBlasGemm<Device, T, true /* USE_CUBLAS */> {
  static void compute(OpKernelContext* ctx, const Device& d, bool transa,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSblas_gemmDTh mht_0(mht_0_v, 228, "", "./tensorflow/core/kernels/rnn/blas_gemm.h", "compute");
...
struct TensorBlasGemm<Device, T, false /* USE_CUBLAS */> {
  static void compute(OpKernelContext* ctx, const Device& d, bool transa,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrnnPSblas_gemmDTh mht_1(mht_1_v, 249, "", "./tensorflow/core/kernels/rnn/blas_gemm.h", "compute");
