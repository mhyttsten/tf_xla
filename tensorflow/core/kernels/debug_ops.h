...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh() {
      // Check if tracing is enabled
...
class CopyOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_0(mht_0_v, 241, "", "./tensorflow/core/kernels/debug_ops.h", "Compute");
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_1(mht_1_v, 283, "", "./tensorflow/core/kernels/debug_ops.h", "IsExpensive");
 return false; }
...
class BaseDebugOp : public OpKernel {
 public:
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_2(mht_2_v, 327, "", "./tensorflow/core/kernels/debug_ops.h", "IsExpensive");
 return false; }
 ...
 protected:
  ...
  bool ApplyGrpcGating(OpKernelContext* context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_3(mht_3_v, 338, "", "./tensorflow/core/kernels/debug_ops.h", "ApplyGrpcGating");
  ...
  Status PublishTensor(const Tensor& tensor) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_4(mht_4_v, 361, "", "./tensorflow/core/kernels/debug_ops.h", "PublishTensor");
...
class DebugIdentityOp : public BaseDebugOp {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_5(mht_5_v, 398, "", "./tensorflow/core/kernels/debug_ops.h", "Compute");
...
class DebugNanCountOp : public BaseDebugOp {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_6(mht_6_v, 418, "", "./tensorflow/core/kernels/debug_ops.h", "Compute");
...
class DebugNumericSummaryOp : public BaseDebugOp {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_7(mht_7_v, 464, "", "./tensorflow/core/kernels/debug_ops.h", "Compute");
...
class DebugIdentityV2Op : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_8(mht_8_v, 624, "", "./tensorflow/core/kernels/debug_ops.h", "Compute");
...
class DebugNumericSummaryV2Op<CPUDevice, Tin, Tout> : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_9(mht_9_v, 719, "", "./tensorflow/core/kernels/debug_ops.h", "Compute");
...
class DebugNumericSummaryV2Op<GPUDevice, Tin, Tout> : public AsyncOpKernel {
 public:
  ...
  void ComputeAsync(OpKernelContext* context, DoneCallback done) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_10(mht_10_v, 907, "", "./tensorflow/core/kernels/debug_ops.h", "ComputeAsync");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_opsDTh mht_11(mht_11_v, 917, "", "./tensorflow/core/kernels/debug_ops.h", "lambda");
 done(); };
    // Disregard lossy cast if mode is REDUCE_INF_NAN_THREE_SLOTS because
    // that mode does not make use of tensor_id.
    if (tensor_debug_mode_ != 8) {
