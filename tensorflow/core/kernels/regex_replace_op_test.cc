...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc() {
      // Check if tracing is enabled
...
Tensor GetTestTensor(int batch) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc mht_0(mht_0_v, 229, "", "./tensorflow/core/kernels/regex_replace_op_test.cc", "GetTestTensor");
...
Graph* SetupRegexReplaceGraph(const Tensor& input, const string& input_pattern,
   ...
   mht_1_v.push_back("input_pattern: \"" + input_pattern + "\"");
   mht_1_v.push_back("input_rewrite: \"" + input_rewrite + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc mht_1(mht_1_v, 245, "", "./tensorflow/core/kernels/regex_replace_op_test.cc", "SetupRegexReplaceGraph");
...
static void BM_RegexReplace(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc mht_2(mht_2_v, 264, "", "./tensorflow/core/kernels/regex_replace_op_test.cc", "BM_RegexReplace");
...
Graph* SetupStaticGraph(const Tensor& input, const string& input_pattern,
   ...
   mht_3_v.push_back("input_pattern: \"" + input_pattern + "\"");
   mht_3_v.push_back("rewrite: \"" + rewrite + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc mht_3(mht_3_v, 289, "", "./tensorflow/core/kernels/regex_replace_op_test.cc", "SetupStaticGraph");
...
static void BM_StaticRegexReplace(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSregex_replace_op_testDTcc mht_4(mht_4_v, 303, "", "./tensorflow/core/kernels/regex_replace_op_test.cc", "BM_StaticRegexReplace");
