...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_ngrams_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_ngrams_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_ngrams_op_testDTcc() {
      // Check if tracing is enabled
...
class NgramKernelTest : public tensorflow::OpsTestBase {
 public:
  void MakeOp(string separator, std::vector<int> ngram_width, string left_pad,
   ...
   mht_0_v.push_back("separator: \"" + separator + "\"");
   mht_0_v.push_back("left_pad: \"" + left_pad + "\"");
   mht_0_v.push_back("right_pad: \"" + right_pad + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_ngrams_op_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/kernels/string_ngrams_op_test.cc", "MakeOp");
  ...
  void assert_string_equal(const std::vector<tstring> &expected,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_ngrams_op_testDTcc mht_1(mht_1_v, 230, "", "./tensorflow/core/kernels/string_ngrams_op_test.cc", "assert_string_equal");
  ...
  void assert_int64_equal(const std::vector<int64_t> &expected,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_ngrams_op_testDTcc mht_2(mht_2_v, 241, "", "./tensorflow/core/kernels/string_ngrams_op_test.cc", "assert_int64_equal");
