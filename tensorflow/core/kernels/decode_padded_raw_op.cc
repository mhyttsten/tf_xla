...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdecode_padded_raw_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdecode_padded_raw_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdecode_padded_raw_opDTcc() {
      // Check if tracing is enabled
...
class DecodePaddedRawOp : public OpKernel {
 public:
  explicit DecodePaddedRawOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdecode_padded_raw_opDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/kernels/decode_padded_raw_op.cc", "DecodePaddedRawOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdecode_padded_raw_opDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/kernels/decode_padded_raw_op.cc", "Compute");
