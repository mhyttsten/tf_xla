...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh() {
      // Check if tracing is enabled
...
class LaunchFusedConv2DWithOutputKernel {
 public:
  LaunchFusedConv2DWithOutputKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh mht_0(mht_0_v, 274, "", "./tensorflow/core/kernels/conv_ops_fused_impl.h", "LaunchFusedConv2DWithOutputKernel");
}
 ...
 private:
  ...
  struct OutputKernelWrapper {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh mht_1(mht_1_v, 360, "", "./tensorflow/core/kernels/conv_ops_fused_impl.h", "OutputKernelWrapper");
}
...
class FusedConv2DOp : public OpKernel {
 public:
  explicit FusedConv2DOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh mht_2(mht_2_v, 807, "", "./tensorflow/core/kernels/conv_ops_fused_impl.h", "FusedConv2DOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_implDTh mht_3(mht_3_v, 847, "", "./tensorflow/core/kernels/conv_ops_fused_impl.h", "Compute");
