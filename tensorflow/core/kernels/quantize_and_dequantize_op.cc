...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc() {
      // Check if tracing is enabled
...
class QuantizeAndDequantizeV2Op : public OpKernel {
 public:
  explicit QuantizeAndDequantizeV2Op(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_0(mht_0_v, 216, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "QuantizeAndDequantizeV2Op");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_1(mht_1_v, 245, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "Compute");
...
class QuantizeAndDequantizeV4GradientOp : public OpKernel {
 public:
  explicit QuantizeAndDequantizeV4GradientOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_2(mht_2_v, 326, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "QuantizeAndDequantizeV4GradientOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_3(mht_3_v, 333, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "Compute");
...
class QuantizeAndDequantizeV3Op : public OpKernel {
 public:
  explicit QuantizeAndDequantizeV3Op(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_4(mht_4_v, 426, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "QuantizeAndDequantizeV3Op");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_5(mht_5_v, 436, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "Compute");
...
class QuantizeAndDequantizeOp : public OpKernel {
 public:
  explicit QuantizeAndDequantizeOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_6(mht_6_v, 517, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "QuantizeAndDequantizeOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantize_and_dequantize_opDTcc mht_7(mht_7_v, 537, "", "./tensorflow/core/kernels/quantize_and_dequantize_op.cc", "Compute");
