...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutionsDTh() {
      // Check if tracing is enabled
...
struct FinalizeDataMapperCoeffs {
  EIGEN_ALWAYS_INLINE static Index finalize(Scalar* block,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutionsDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/eigen_spatial_convolutions.h", "finalize");
...
struct FinalizeDataMapperCoeffs<Scalar, DataMapper, packet_size,
  ...
  EIGEN_ALWAYS_INLINE static Index finalize(Scalar* block,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutionsDTh mht_1(mht_1_v, 230, "", "./tensorflow/core/kernels/eigen_spatial_convolutions.h", "finalize");
...
struct gemm_pack_colmajor_block<
 ...
 private:
  ...
  EIGEN_ALWAYS_INLINE void packNonStandardPatches(Scalar* __restrict block,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutionsDTh mht_2(mht_2_v, 530, "", "./tensorflow/core/kernels/eigen_spatial_convolutions.h", "packNonStandardPatches");
