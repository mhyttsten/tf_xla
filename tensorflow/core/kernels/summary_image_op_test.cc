...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsummary_image_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsummary_image_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsummary_image_op_testDTcc() {
      // Check if tracing is enabled
...
static void EXPECT_SummaryMatches(const Summary& actual,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsummary_image_op_testDTcc mht_0(mht_0_v, 210, "", "./tensorflow/core/kernels/summary_image_op_test.cc", "EXPECT_SummaryMatches");
...
class SummaryImageOpTest : public OpsTestBase {
 protected:
  void MakeOp(int max_images) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsummary_image_op_testDTcc mht_1(mht_1_v, 224, "", "./tensorflow/core/kernels/summary_image_op_test.cc", "MakeOp");
  ...
  void CheckAndRemoveEncodedImages(Summary* summary) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsummary_image_op_testDTcc mht_2(mht_2_v, 236, "", "./tensorflow/core/kernels/summary_image_op_test.cc", "CheckAndRemoveEncodedImages");
