...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfunction_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfunction_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfunction_opsDTh() {
      // Check if tracing is enabled
...
class ArgOp : public OpKernel {
 public:
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfunction_opsDTh mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/function_ops.h", "IsExpensive");
 return false; }
...
class RetvalOp : public OpKernel {
 public:
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfunction_opsDTh mht_1(mht_1_v, 222, "", "./tensorflow/core/kernels/function_ops.h", "IsExpensive");
 return false; }
