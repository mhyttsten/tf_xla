...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh() {
      // Check if tracing is enabled
...
void Col2im(const T* col_data, const int depth, const int height,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh mht_0(mht_0_v, 249, "", "./tensorflow/core/kernels/conv_grad_input_ops.h", "Col2im");
...
class Conv2DBackpropInputOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh mht_1(mht_1_v, 591, "", "./tensorflow/core/kernels/conv_grad_input_ops.h", "Compute");
...
class Conv2DCustomBackpropInputOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh mht_2(mht_2_v, 691, "", "./tensorflow/core/kernels/conv_grad_input_ops.h", "Compute");
...
// LaunchConv2DBackpropInputOp functor.
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_input_opsDTh mht_3(mht_3_v, 911, "", "./tensorflow/core/kernels/conv_grad_input_ops.h", "lambda");
