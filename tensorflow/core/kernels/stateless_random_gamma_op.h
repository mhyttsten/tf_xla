...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_gamma_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_gamma_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_gamma_opDTh() {
      // Check if tracing is enabled
...
class RandomSampleBuffer {
 public:
  ...
  explicit RandomSampleBuffer(Distribution* distribution)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_gamma_opDTh mht_0(mht_0_v, 227, "", "./tensorflow/core/kernels/stateless_random_gamma_op.h", "RandomSampleBuffer");
}
  ...
  void Clear() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_gamma_opDTh mht_1(mht_1_v, 246, "", "./tensorflow/core/kernels/stateless_random_gamma_op.h", "Clear");
 remaining_numbers_ = 0; }
