...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc() {
      // Check if tracing is enabled
...
class FusedBatchNormExOpTestBase : public OpsTestBase {
 public:
  FusedBatchNormExOpTestBase() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "FusedBatchNormExOpTestBase");
 ...
 protected:
  ...
  void RunFusedBatchNorm(const Tensor& y_backprop_data,
   ...
   mht_1_v.push_back("activation_mode: \"" + activation_mode + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_1(mht_1_v, 317, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "RunFusedBatchNorm");
  ...
  void RunFusedBatchNormEx(const Tensor& y_backprop_data,
   ...
   mht_2_v.push_back("activation_mode: \"" + activation_mode + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_2(mht_2_v, 409, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "RunFusedBatchNormEx");
  ...
  void VerifyTensorsNear(int batch, int height, int width, int channels,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_3(mht_3_v, 540, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "VerifyTensorsNear");
  ...
  void VerifyFusedBatchNormEx(int batch, int height, int width, int channels,
   ...
   mht_4_v.push_back("activation_mode: \"" + activation_mode + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_4(mht_4_v, 635, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "VerifyFusedBatchNormEx");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_5(mht_5_v, 644, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_6(mht_6_v, 659, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "lambda");
...
SideInputAndActivation Identity() {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_7(mht_7_v, 759, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "Identity");
 return {false, "Identity"}; }
SideInputAndActivation Relu() {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_8(mht_8_v, 763, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "Relu");
 return {false, "Relu"}; }
SideInputAndActivation AddAndRelu() {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_9(mht_9_v, 767, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "AddAndRelu");
 return {true, "Relu"}; }
...
static Graph* FusedBatchNormEx(int n, int h, int w, int c,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfused_batch_norm_ex_op_testDTcc mht_10(mht_10_v, 775, "", "./tensorflow/core/kernels/fused_batch_norm_ex_op_test.cc", "FusedBatchNormEx");
