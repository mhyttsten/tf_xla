...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh() {
      // Check if tracing is enabled
...
class ReluOp : public UnaryElementWiseOp<T, ReluOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& input, Tensor* output) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_0(mht_0_v, 207, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
struct ReluHelpers {
  static void ValidateSameSizeHelper(OpKernelContext* context, const Tensor& g,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_1(mht_1_v, 222, "", "./tensorflow/core/kernels/relu_op.h", "ValidateSameSizeHelper");
  ...
  static bool ValidateSameSize(OpKernelContext* context, const Tensor& g,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_2(mht_2_v, 230, "", "./tensorflow/core/kernels/relu_op.h", "ValidateSameSize");
...
class ReluGradOp : public BinaryElementWiseOp<T, ReluGradOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& g, const Tensor& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_3(mht_3_v, 255, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class Relu6Op : public UnaryElementWiseOp<T, Relu6Op<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& input, Tensor* output) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_4(mht_4_v, 278, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class Relu6GradOp : public BinaryElementWiseOp<T, Relu6GradOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& g, const Tensor& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_5(mht_5_v, 303, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class LeakyReluOp : public UnaryElementWiseOp<T, LeakyReluOp<Device, T>> {
 public:
  explicit LeakyReluOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_6(mht_6_v, 325, "", "./tensorflow/core/kernels/relu_op.h", "LeakyReluOp");
  ...
  void Operate(OpKernelContext* context, const Tensor& input, Tensor* output) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_7(mht_7_v, 334, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class LeakyReluGradOp
 ...
 public:
  explicit LeakyReluGradOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_8(mht_8_v, 352, "", "./tensorflow/core/kernels/relu_op.h", "LeakyReluGradOp");
  ...
  void Operate(OpKernelContext* context, const Tensor& g, const Tensor& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_9(mht_9_v, 372, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class EluOp : public UnaryElementWiseOp<T, EluOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& input, Tensor* output) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_10(mht_10_v, 399, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class EluGradOp : public BinaryElementWiseOp<T, EluGradOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& g, const Tensor& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_11(mht_11_v, 424, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class SeluOp : public UnaryElementWiseOp<T, SeluOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& input, Tensor* output) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_12(mht_12_v, 447, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
...
class SeluGradOp : public BinaryElementWiseOp<T, SeluGradOp<Device, T>> {
 public:
  ...
  void Operate(OpKernelContext* context, const Tensor& g, const Tensor& a,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrelu_opDTh mht_13(mht_13_v, 472, "", "./tensorflow/core/kernels/relu_op.h", "Operate");
