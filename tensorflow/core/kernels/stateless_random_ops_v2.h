...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_ops_v2DTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_ops_v2DTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_ops_v2DTh() {
      // Check if tracing is enabled
...
inline Status CheckKeyCounterShape(Algorithm const& alg,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstateless_random_ops_v2DTh mht_0(mht_0_v, 195, "", "./tensorflow/core/kernels/stateless_random_ops_v2.h", "CheckKeyCounterShape");
