...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__global__ void CheckNumericsKernel(const T* __restrict__ data, int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/kernels/check_numerics_op_gpu.cu.cc", "CheckNumericsKernel");
...
__global__ void CheckNumericsKernelV2(const T* __restrict__ data, int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc mht_1(mht_1_v, 235, "", "./tensorflow/core/kernels/check_numerics_op_gpu.cu.cc", "CheckNumericsKernelV2");
...
struct CheckNumericsLaunch {
  void Run(const GPUDevice& d, const T* data, int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc mht_2(mht_2_v, 262, "", "./tensorflow/core/kernels/check_numerics_op_gpu.cu.cc", "Run");
...
struct CheckNumericsLaunchV2 {
  void Run(const GPUDevice& d, const T* data, int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScheck_numerics_op_gpuDTcuDTcc mht_3(mht_3_v, 283, "", "./tensorflow/core/kernels/check_numerics_op_gpu.cu.cc", "Run");
