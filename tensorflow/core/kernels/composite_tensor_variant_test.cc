...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPScomposite_tensor_variant_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScomposite_tensor_variant_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPScomposite_tensor_variant_testDTcc() {
      // Check if tracing is enabled
...
CompositeTensorVariant Make2DRaggedTensor(const std::vector<int32>& values,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScomposite_tensor_variant_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/core/kernels/composite_tensor_variant_test.cc", "Make2DRaggedTensor");
