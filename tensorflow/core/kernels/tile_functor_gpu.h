...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_gpuDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_gpuDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_gpuDTh() {
      // Check if tracing is enabled
...
__global__ void TileKernel(int nthreads, const T* __restrict__ src,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_gpuDTh mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/tile_functor_gpu.h", "TileKernel");
...
void TileSimple(const Eigen::GpuDevice& d, Tensor* out, const Tensor& in) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPStile_functor_gpuDTh mht_1(mht_1_v, 223, "", "./tensorflow/core/kernels/tile_functor_gpu.h", "TileSimple");
