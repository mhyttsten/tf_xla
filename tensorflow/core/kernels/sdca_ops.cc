...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc() {
      // Check if tracing is enabled
...
struct ComputeOptions {
  explicit ComputeOptions(OpKernelConstruction* const context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_0(mht_0_v, 238, "", "./tensorflow/core/kernels/sdca_ops.cc", "ComputeOptions");
...
void DoCompute(const ComputeOptions& options, OpKernelContext* const context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_1(mht_1_v, 303, "", "./tensorflow/core/kernels/sdca_ops.cc", "DoCompute");
  ...
  auto train_step = [&](const int64_t begin, const int64_t end) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_2(mht_2_v, 347, "", "./tensorflow/core/kernels/sdca_ops.cc", "lambda");
...
class SdcaOptimizer : public OpKernel {
 public:
  explicit SdcaOptimizer(OpKernelConstruction* const context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_3(mht_3_v, 417, "", "./tensorflow/core/kernels/sdca_ops.cc", "SdcaOptimizer");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_4(mht_4_v, 422, "", "./tensorflow/core/kernels/sdca_ops.cc", "Compute");
...
class SdcaShrinkL1 : public OpKernel {
 public:
  explicit SdcaShrinkL1(OpKernelConstruction* const context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_5(mht_5_v, 443, "", "./tensorflow/core/kernels/sdca_ops.cc", "SdcaShrinkL1");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_6(mht_6_v, 450, "", "./tensorflow/core/kernels/sdca_ops.cc", "Compute");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_7(mht_7_v, 458, "", "./tensorflow/core/kernels/sdca_ops.cc", "lambda");
...
class SdcaFprint : public OpKernel {
 public:
  explicit SdcaFprint(OpKernelConstruction* const context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_8(mht_8_v, 497, "", "./tensorflow/core/kernels/sdca_ops.cc", "SdcaFprint");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSsdca_opsDTcc mht_9(mht_9_v, 502, "", "./tensorflow/core/kernels/sdca_ops.cc", "Compute");
