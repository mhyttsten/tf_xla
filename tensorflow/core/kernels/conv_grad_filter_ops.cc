...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc() {
      // Check if tracing is enabled
...
void Im2col(const T* input_data, const int depth, const int height,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_0(mht_0_v, 245, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "Im2col");
...
class Conv2DBackpropFilterOp : public OpKernel {
 public:
  explicit Conv2DBackpropFilterOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_1(mht_1_v, 439, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "Conv2DBackpropFilterOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_2(mht_2_v, 497, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "Compute");
...
class Conv2DCustomBackpropFilterOp : public OpKernel {
 public:
  explicit Conv2DCustomBackpropFilterOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_3(mht_3_v, 565, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "Conv2DCustomBackpropFilterOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_4(mht_4_v, 611, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "Compute");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_5(mht_5_v, 769, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "lambda");
...
struct ConvBackwardFilterAutotuneGroup {
  static string name() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_grad_filter_opsDTcc mht_6(mht_6_v, 846, "", "./tensorflow/core/kernels/conv_grad_filter_ops.cc", "name");
