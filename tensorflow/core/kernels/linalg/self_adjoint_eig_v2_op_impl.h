...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSself_adjoint_eig_v2_op_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSself_adjoint_eig_v2_op_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSself_adjoint_eig_v2_op_implDTh() {
      // Check if tracing is enabled
...
class SelfAdjointEigV2Op : public LinearAlgebraOp<Scalar> {
 public:
  ...
  explicit SelfAdjointEigV2Op(OpKernelConstruction* context) : Base(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSself_adjoint_eig_v2_op_implDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/linalg/self_adjoint_eig_v2_op_impl.h", "SelfAdjointEigV2Op");
  ...
  TensorShapes GetOutputMatrixShapes(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSself_adjoint_eig_v2_op_implDTh mht_1(mht_1_v, 222, "", "./tensorflow/core/kernels/linalg/self_adjoint_eig_v2_op_impl.h", "GetOutputMatrixShapes");
  ...
  void ComputeMatrix(OpKernelContext* context, const ConstMatrixMaps& inputs,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSself_adjoint_eig_v2_op_implDTh mht_2(mht_2_v, 235, "", "./tensorflow/core/kernels/linalg/self_adjoint_eig_v2_op_impl.h", "ComputeMatrix");
