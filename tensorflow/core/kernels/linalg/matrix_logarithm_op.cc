...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_logarithm_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_logarithm_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_logarithm_opDTcc() {
      // Check if tracing is enabled
...
class MatrixLogarithmOp : public LinearAlgebraOp<Scalar> {
 public:
  ...
  explicit MatrixLogarithmOp(OpKernelConstruction* context) : Base(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_logarithm_opDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/kernels/linalg/matrix_logarithm_op.cc", "MatrixLogarithmOp");
}

  void ComputeMatrix(OpKernelContext* context, const ConstMatrixMaps& inputs,
                     MatrixMaps* outputs) final {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_logarithm_opDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/kernels/linalg/matrix_logarithm_op.cc", "ComputeMatrix");
