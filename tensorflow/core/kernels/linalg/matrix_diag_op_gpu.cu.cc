...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__device__ inline int ComputeContentOffset(const int diag_index,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/kernels/linalg/matrix_diag_op_gpu.cu.cc", "ComputeContentOffset");
...
__global__ void MatrixDiagKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc mht_1(mht_1_v, 222, "", "./tensorflow/core/kernels/linalg/matrix_diag_op_gpu.cu.cc", "MatrixDiagKernel");
...
struct MatrixDiag<GPUDevice, T> {
  static void Compute(OpKernelContext* context, const GPUDevice& device,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc mht_2(mht_2_v, 256, "", "./tensorflow/core/kernels/linalg/matrix_diag_op_gpu.cu.cc", "Compute");
...
__global__ void MatrixDiagPartKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc mht_3(mht_3_v, 285, "", "./tensorflow/core/kernels/linalg/matrix_diag_op_gpu.cu.cc", "MatrixDiagPartKernel");
...
struct MatrixDiagPart<GPUDevice, T> {
  static void Compute(OpKernelContext* context, const GPUDevice& device,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_diag_op_gpuDTcuDTcc mht_4(mht_4_v, 323, "", "./tensorflow/core/kernels/linalg/matrix_diag_op_gpu.cu.cc", "Compute");
