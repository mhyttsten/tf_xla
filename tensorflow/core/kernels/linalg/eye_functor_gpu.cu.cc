...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeye_functor_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeye_functor_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeye_functor_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__global__ void EyeKernel(int num_threads, int batch_size, int m, int n,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeye_functor_gpuDTcuDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/linalg/eye_functor_gpu.cu.cc", "EyeKernel");
