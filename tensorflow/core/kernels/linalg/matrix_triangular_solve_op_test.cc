...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_triangular_solve_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_triangular_solve_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_triangular_solve_op_testDTcc() {
      // Check if tracing is enabled
...
Node* BroadcastTo(Graph* g, Node* input, Node* shape) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_triangular_solve_op_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/kernels/linalg/matrix_triangular_solve_op_test.cc", "BroadcastTo");
...
Node* MatrixTriangularSolve(Graph* g, Node* in0, Node* in1, bool adjoint) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_triangular_solve_op_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/kernels/linalg/matrix_triangular_solve_op_test.cc", "MatrixTriangularSolve");
...
static Graph* MatrixTriangularSolveWithBroadcast(int64_t b0, int64_t b1,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_triangular_solve_op_testDTcc mht_2(mht_2_v, 232, "", "./tensorflow/core/kernels/linalg/matrix_triangular_solve_op_test.cc", "MatrixTriangularSolveWithBroadcast");
