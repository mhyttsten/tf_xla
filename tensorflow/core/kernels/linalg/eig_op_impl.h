...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeig_op_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeig_op_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeig_op_implDTh() {
      // Check if tracing is enabled
...
class EigOp : public LinearAlgebraOp<InputScalar, OutputScalar> {
 public:
  ...
  explicit EigOp(OpKernelConstruction* context) : Base(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeig_op_implDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/linalg/eig_op_impl.h", "EigOp");
  ...
  TensorShapes GetOutputMatrixShapes(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeig_op_implDTh mht_1(mht_1_v, 227, "", "./tensorflow/core/kernels/linalg/eig_op_impl.h", "GetOutputMatrixShapes");
  ...
  void ComputeMatrix(OpKernelContext* context,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSeig_op_implDTh mht_2(mht_2_v, 241, "", "./tensorflow/core/kernels/linalg/eig_op_impl.h", "ComputeMatrix");
