...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc() {
      // Check if tracing is enabled
...
Scalar eigen_conj(const Scalar& scalar) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "eigen_conj");
...
struct SequentialBandedTriangularSolveKernel {
  ...
  static ConstMatrixMap ConstTensorSliceToEigenMatrix(const Tensor& t,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_1(mht_1_v, 222, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "ConstTensorSliceToEigenMatrix");
  ...
  static MatrixMap TensorSliceToEigenMatrix(Tensor* t, int slice) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_2(mht_2_v, 231, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "TensorSliceToEigenMatrix");
  ...
  static void Run(const Tensor& in_x, const Tensor& in_y, bool lower,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_3(mht_3_v, 242, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "Run");
...
struct LaunchBatchBandedTriangularSolve {
  static void Launch(OpKernelContext* context, const Tensor& in_x,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_4(mht_4_v, 351, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "Launch");
...
class BandedTriangularSolveOpCpu : public OpKernel {
 public:
  explicit BandedTriangularSolveOpCpu(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_5(mht_5_v, 392, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "BandedTriangularSolveOpCpu");
  ...
  ~BandedTriangularSolveOpCpu() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_6(mht_6_v, 400, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "~BandedTriangularSolveOpCpu");
}

  void Compute(OpKernelContext* ctx) override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_7(mht_7_v, 405, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "Compute");
 ...
 private:
  void ValidateInputTensors(OpKernelContext* ctx, const Tensor& in0,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSbanded_triangular_solve_opDTcc mht_8(mht_8_v, 464, "", "./tensorflow/core/kernels/linalg/banded_triangular_solve_op.cc", "ValidateInputTensors");
