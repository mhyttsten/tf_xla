...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc() {
      // Check if tracing is enabled
...
class MatrixSetDiagOp : public OpKernel {
 public:
  explicit MatrixSetDiagOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc mht_0(mht_0_v, 215, "", "./tensorflow/core/kernels/linalg/matrix_set_diag_op.cc", "MatrixSetDiagOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc mht_1(mht_1_v, 226, "", "./tensorflow/core/kernels/linalg/matrix_set_diag_op.cc", "Compute");
...
struct MatrixSetDiag<CPUDevice, T> {
  static void Compute(OpKernelContext* context, const CPUDevice& device,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc mht_2(mht_2_v, 390, "", "./tensorflow/core/kernels/linalg/matrix_set_diag_op.cc", "Compute");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSlinalgPSmatrix_set_diag_opDTcc mht_3(mht_3_v, 401, "", "./tensorflow/core/kernels/linalg/matrix_set_diag_op.cc", "lambda");
