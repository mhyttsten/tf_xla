...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc() {
      // Check if tracing is enabled
...
class CountUpToOp : public OpKernel {
 public:
  explicit CountUpToOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/count_up_to_op.cc", "CountUpToOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/kernels/count_up_to_op.cc", "Compute");
...
class ResourceCountUpToOp : public OpKernel {
 public:
  explicit ResourceCountUpToOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc mht_2(mht_2_v, 238, "", "./tensorflow/core/kernels/count_up_to_op.cc", "ResourceCountUpToOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScount_up_to_opDTcc mht_3(mht_3_v, 246, "", "./tensorflow/core/kernels/count_up_to_op.cc", "Compute");
