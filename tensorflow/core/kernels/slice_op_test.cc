...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSslice_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSslice_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSslice_op_testDTcc() {
      // Check if tracing is enabled
...
static void SliceHelper(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSslice_op_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/kernels/slice_op_test.cc", "SliceHelper");
...
void BM_SliceFloat(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSslice_op_testDTcc mht_1(mht_1_v, 247, "", "./tensorflow/core/kernels/slice_op_test.cc", "BM_SliceFloat");
...
void BM_SliceBFloat16(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSslice_op_testDTcc mht_2(mht_2_v, 256, "", "./tensorflow/core/kernels/slice_op_test.cc", "BM_SliceBFloat16");
