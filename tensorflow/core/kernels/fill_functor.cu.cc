...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfill_functorDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfill_functorDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfill_functorDTcuDTcc() {
      // Check if tracing is enabled
...
struct scalar_const_op {
  ...
  scalar_const_op(const scalar_const_op& x)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfill_functorDTcuDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/kernels/fill_functor.cu.cc", "scalar_const_op");
}

  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE scalar_const_op(const T* v) : val(v) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSfill_functorDTcuDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/kernels/fill_functor.cu.cc", "scalar_const_op");
}
