...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc() {
      // Check if tracing is enabled
...
static int ceil_div(int a, int b) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/kernels/eigen_spatial_convolutions_test.cc", "ceil_div");
 return (a + b - 1) / b; }
...
static void PackRhsHelper(::testing::benchmark::State& state,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc mht_1(mht_1_v, 1564, "", "./tensorflow/core/kernels/eigen_spatial_convolutions_test.cc", "PackRhsHelper");
  ...
  const auto round_up = [](const Index idx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc mht_2(mht_2_v, 1718, "", "./tensorflow/core/kernels/eigen_spatial_convolutions_test.cc", "lambda");
...
static void PackLhsHelper(::testing::benchmark::State& state,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc mht_3(mht_3_v, 1762, "", "./tensorflow/core/kernels/eigen_spatial_convolutions_test.cc", "PackLhsHelper");
  ...
  const auto round_up = [](const Index idx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_spatial_convolutions_testDTcc mht_4(mht_4_v, 1883, "", "./tensorflow/core/kernels/eigen_spatial_convolutions_test.cc", "lambda");
