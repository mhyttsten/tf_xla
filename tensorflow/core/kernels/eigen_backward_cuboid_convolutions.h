...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_cuboid_convolutionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_cuboid_convolutionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_cuboid_convolutionsDTh() {
      // Check if tracing is enabled
...
CuboidConvolutionBackwardInput(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_cuboid_convolutionsDTh mht_0(mht_0_v, 262, "", "./tensorflow/core/kernels/eigen_backward_cuboid_convolutions.h", "CuboidConvolutionBackwardInput");
...
CuboidConvolutionBackwardKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_cuboid_convolutionsDTh mht_1(mht_1_v, 567, "", "./tensorflow/core/kernels/eigen_backward_cuboid_convolutions.h", "CuboidConvolutionBackwardKernel");
