...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTcc() {
      // Check if tracing is enabled
...
class LegacyStringToHashBucketOp : public OpKernel {
 public:
  explicit LegacyStringToHashBucketOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/string_to_hash_bucket_op.cc", "LegacyStringToHashBucketOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_hash_bucket_opDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/kernels/string_to_hash_bucket_op.cc", "Compute");
