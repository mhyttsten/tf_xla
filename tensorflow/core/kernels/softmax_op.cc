...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsoftmax_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsoftmax_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsoftmax_opDTcc() {
      // Check if tracing is enabled
...
class SoftmaxOp : public OpKernel {
 public:
  explicit SoftmaxOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsoftmax_opDTcc mht_0(mht_0_v, 220, "", "./tensorflow/core/kernels/softmax_op.cc", "SoftmaxOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsoftmax_opDTcc mht_1(mht_1_v, 227, "", "./tensorflow/core/kernels/softmax_op.cc", "Compute");
