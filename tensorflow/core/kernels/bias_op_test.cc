...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSbias_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbias_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSbias_op_testDTcc() {
      // Check if tracing is enabled
...
static Graph* BiasAdd(int d0, int d1, int d2, int d3) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbias_op_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/kernels/bias_op_test.cc", "BiasAdd");
...
static Graph* BiasAddGrad(int d0, int d1, int d2, int d3) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbias_op_testDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/kernels/bias_op_test.cc", "BiasAddGrad");
