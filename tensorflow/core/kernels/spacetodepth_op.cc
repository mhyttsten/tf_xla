...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSspacetodepth_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspacetodepth_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSspacetodepth_opDTcc() {
      // Check if tracing is enabled
...
class SpaceToDepthOp : public OpKernel {
 public:
  explicit SpaceToDepthOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspacetodepth_opDTcc mht_0(mht_0_v, 230, "", "./tensorflow/core/kernels/spacetodepth_op.cc", "SpaceToDepthOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSspacetodepth_opDTcc mht_1(mht_1_v, 252, "", "./tensorflow/core/kernels/spacetodepth_op.cc", "Compute");
