...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_op_gpuDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_op_gpuDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_op_gpuDTh() {
      // Check if tracing is enabled
...
inline EIGEN_DEVICE_FUNC bool CanLaunchDepthwiseConv2dGPUSmall(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_op_gpuDTh mht_0(mht_0_v, 225, "", "./tensorflow/core/kernels/depthwise_conv_op_gpu.h", "CanLaunchDepthwiseConv2dGPUSmall");
...
inline EIGEN_DEVICE_FUNC bool CanLaunchDepthwiseConv2dBackpropFilterGPUSmall(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_op_gpuDTh mht_1(mht_1_v, 241, "", "./tensorflow/core/kernels/depthwise_conv_op_gpu.h", "CanLaunchDepthwiseConv2dBackpropFilterGPUSmall");
...
inline bool HasFastHalfMath(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdepthwise_conv_op_gpuDTh mht_2(mht_2_v, 850, "", "./tensorflow/core/kernels/depthwise_conv_op_gpu.h", "HasFastHalfMath");
