...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdiag_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdiag_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdiag_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__global__ void DiagGpuKernel(const int num_threads, const int64 size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdiag_op_gpuDTcuDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/diag_op_gpu.cu.cc", "DiagGpuKernel");
...
__global__ void DiagPartGpuKernel(const int num_threads, const int64 size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdiag_op_gpuDTcuDTcc mht_1(mht_1_v, 256, "", "./tensorflow/core/kernels/diag_op_gpu.cu.cc", "DiagPartGpuKernel");
