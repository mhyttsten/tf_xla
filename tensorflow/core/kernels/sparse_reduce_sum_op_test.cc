...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reduce_sum_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reduce_sum_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reduce_sum_op_testDTcc() {
      // Check if tracing is enabled
...
class SparseReduceSumOpTest : public OpsTestBase {
 protected:
  ...
  void MakeOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reduce_sum_op_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/kernels/sparse_reduce_sum_op_test.cc", "MakeOp");
...
class SparseReduceSumSparseOpTest : public OpsTestBase {
 protected:
  ...
  void MakeOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_reduce_sum_op_testDTcc mht_1(mht_1_v, 247, "", "./tensorflow/core/kernels/sparse_reduce_sum_op_test.cc", "MakeOp");
