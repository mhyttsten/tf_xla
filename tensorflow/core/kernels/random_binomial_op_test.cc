...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc() {
      // Check if tracing is enabled
...
static Graph* RandomBinomialGraph(double count, double prob, int num_batches,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/random_binomial_op_test.cc", "RandomBinomialGraph");
...
static Graph* RandomBinomialInv(int num_batches, int samples_per_batch) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc mht_1(mht_1_v, 220, "", "./tensorflow/core/kernels/random_binomial_op_test.cc", "RandomBinomialInv");
...
static Graph* RandomBinomialRej(int num_batches, int samples_per_batch) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc mht_2(mht_2_v, 228, "", "./tensorflow/core/kernels/random_binomial_op_test.cc", "RandomBinomialRej");
...
static Graph* RandomBinomialInvComplement(int num_batches,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc mht_3(mht_3_v, 237, "", "./tensorflow/core/kernels/random_binomial_op_test.cc", "RandomBinomialInvComplement");
...
static Graph* RandomBinomialRejComplement(int num_batches,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_binomial_op_testDTcc mht_4(mht_4_v, 246, "", "./tensorflow/core/kernels/random_binomial_op_test.cc", "RandomBinomialRejComplement");
