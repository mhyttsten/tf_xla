...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTcc() {
      // Check if tracing is enabled
...
Mfcc::Mfcc()
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/mfcc.cc", "Mfcc::Mfcc");
}

bool Mfcc::Initialize(int input_length, double input_sample_rate) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/kernels/mfcc.cc", "Mfcc::Initialize");
...
void Mfcc::Compute(const std::vector<double>& spectrogram_frame,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfccDTcc mht_2(mht_2_v, 223, "", "./tensorflow/core/kernels/mfcc.cc", "Mfcc::Compute");
