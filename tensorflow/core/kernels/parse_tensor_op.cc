...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSparse_tensor_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparse_tensor_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSparse_tensor_opDTcc() {
      // Check if tracing is enabled
...
class ParseTensorOp : public OpKernel {
 public:
  explicit ParseTensorOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparse_tensor_opDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/kernels/parse_tensor_op.cc", "ParseTensorOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparse_tensor_opDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/kernels/parse_tensor_op.cc", "Compute");
...
class SerializeTensorOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSparse_tensor_opDTcc mht_2(mht_2_v, 249, "", "./tensorflow/core/kernels/parse_tensor_op.cc", "Compute");
