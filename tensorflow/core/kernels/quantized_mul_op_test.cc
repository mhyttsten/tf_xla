...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc() {
      // Check if tracing is enabled
...
void TestMul(const std::vector<int64_t>& x_shape,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestMul");
...
void TestMulShape(const std::vector<int64_t>& x_shape,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_1(mht_1_v, 260, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestMulShape");
...
void TimeMul(const std::vector<int64_t>& x_shape,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_2(mht_2_v, 313, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TimeMul");
...
void TestManualScalar() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_3(mht_3_v, 363, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestManualScalar");
...
void TestScalar() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_4(mht_4_v, 380, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestScalar");
...
void TestManualVector() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_5(mht_5_v, 388, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestManualVector");
...
void TestVector() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_6(mht_6_v, 400, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestVector");
 TestMulShape({100}, {100}); }

void TestManualVectorTimesTensor() {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_7(mht_7_v, 405, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestManualVectorTimesTensor");
...
void TestVectorTimesTensor() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_8(mht_8_v, 439, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "TestVectorTimesTensor");
...
void BenchmarkTensorScalar() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_9(mht_9_v, 448, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "BenchmarkTensorScalar");
...
void BenchmarkVector() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_10(mht_10_v, 458, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "BenchmarkVector");
...
void BenchmarkVectorTimesTensor() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSquantized_mul_op_testDTcc mht_11(mht_11_v, 468, "", "./tensorflow/core/kernels/quantized_mul_op_test.cc", "BenchmarkVectorTimesTensor");
