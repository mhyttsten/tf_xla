...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc() {
      // Check if tracing is enabled
...
class SaveOpTest : public OpsTestBase {
 protected:
  void MakeOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc mht_0(mht_0_v, 216, "", "./tensorflow/core/kernels/save_op_test.cc", "MakeOp");
...
class SaveSlicesOpTest : public OpsTestBase {
 protected:
  void MakeOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc mht_1(mht_1_v, 571, "", "./tensorflow/core/kernels/save_op_test.cc", "MakeOp");
...
class SaveOpSlices2Test : public OpsTestBase {
 protected:
  void MakeOp() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc mht_2(mht_2_v, 734, "", "./tensorflow/core/kernels/save_op_test.cc", "MakeOp");
...
void BM_LargeTensorWrite(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsave_op_testDTcc mht_3(mht_3_v, 844, "", "./tensorflow/core/kernels/save_op_test.cc", "BM_LargeTensorWrite");
