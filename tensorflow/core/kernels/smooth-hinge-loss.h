...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh() {
      // Check if tracing is enabled
...
class SmoothHingeLossUpdater : public DualLossUpdater {
 public:
  ...
  double ComputeUpdatedDual(const int num_partitions, const double label,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/kernels/smooth-hinge-loss.h", "ComputeUpdatedDual");
  ...
  double ComputeDualLoss(const double current_dual, const double example_label,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh mht_1(mht_1_v, 229, "", "./tensorflow/core/kernels/smooth-hinge-loss.h", "ComputeDualLoss");
  ...
  double ComputePrimalLoss(const double wx, const double example_label,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh mht_2(mht_2_v, 244, "", "./tensorflow/core/kernels/smooth-hinge-loss.h", "ComputePrimalLoss");
  ...
  Status ConvertLabel(float* const example_label) const final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh mht_3(mht_3_v, 256, "", "./tensorflow/core/kernels/smooth-hinge-loss.h", "ConvertLabel");
  ...
  double PrimalLossDerivative(const double wx, const double label,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh mht_4(mht_4_v, 274, "", "./tensorflow/core/kernels/smooth-hinge-loss.h", "PrimalLossDerivative");
  ...
  double SmoothnessConstant() const final {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsmoothSLhingeSLlossDTh mht_5(mht_5_v, 287, "", "./tensorflow/core/kernels/smooth-hinge-loss.h", "SmoothnessConstant");
 return gamma; }
