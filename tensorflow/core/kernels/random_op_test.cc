...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc() {
      // Check if tracing is enabled
...
Tensor VecShape(int64_t v) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/random_op_test.cc", "VecShape");
...
Graph* RandomUniform(int64_t n) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_1(mht_1_v, 212, "", "./tensorflow/core/kernels/random_op_test.cc", "RandomUniform");
...
Graph* RandomNormal(int64_t n) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_2(mht_2_v, 222, "", "./tensorflow/core/kernels/random_op_test.cc", "RandomNormal");
...
Graph* TruncatedNormal(int64_t n) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_3(mht_3_v, 232, "", "./tensorflow/core/kernels/random_op_test.cc", "TruncatedNormal");
...
Tensor VecAlphas(int64_t n) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_4(mht_4_v, 260, "", "./tensorflow/core/kernels/random_op_test.cc", "VecAlphas");
...
void BM_cpu_RandomGamma(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_5(mht_5_v, 274, "", "./tensorflow/core/kernels/random_op_test.cc", "BM_cpu_RandomGamma");
...
void BM_PhiloxRandom(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_6(mht_6_v, 290, "", "./tensorflow/core/kernels/random_op_test.cc", "BM_PhiloxRandom");
...
void BM_StdMTRandom(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_op_testDTcc mht_7(mht_7_v, 309, "", "./tensorflow/core/kernels/random_op_test.cc", "BM_StdMTRandom");
