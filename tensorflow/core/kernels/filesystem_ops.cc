...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSfilesystem_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfilesystem_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSfilesystem_opsDTcc() {
      // Check if tracing is enabled
...
class FileSystemSetConfigurationOp : public OpKernel {
 public:
  explicit FileSystemSetConfigurationOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfilesystem_opsDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/kernels/filesystem_ops.cc", "FileSystemSetConfigurationOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSfilesystem_opsDTcc mht_1(mht_1_v, 200, "", "./tensorflow/core/kernels/filesystem_ops.cc", "Compute");
