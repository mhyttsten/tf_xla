...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc() {
      // Check if tracing is enabled
...
class TestReadOnlyMemoryRegion : public ReadOnlyMemoryRegion {
 public:
  ...
  explicit TestReadOnlyMemoryRegion(uint64 length)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_0(mht_0_v, 214, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "TestReadOnlyMemoryRegion");
}
  ~TestReadOnlyMemoryRegion() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_1(mht_1_v, 218, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "~TestReadOnlyMemoryRegion");

    cpu_allocator()->DeallocateRaw(memptr_);
  }
  const void* data() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_2(mht_2_v, 224, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "data");
 return memptr_; }
  float* GetWritableDataStart() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_3(mht_3_v, 228, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "GetWritableDataStart");
 return reinterpret_cast<float*>(memptr_); }
  uint64 length() override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_4(mht_4_v, 232, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "length");
 return length_; }
...
class TestFileSystem : public NullFileSystem {
 public:
  ...
  Status NewReadOnlyMemoryRegionFromFile(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_5(mht_5_v, 254, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "NewReadOnlyMemoryRegionFromFile");
...
Status CreateTempFileFloat(Env* env, float value, uint64 size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_6(mht_6_v, 338, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "CreateTempFileFloat");
...
Status CreateTempFileBadString(Env* env, char value, uint64 size,
   ...
   mht_7_v.push_back("value: '" + std::string(1, value) + "'");
   mht_7_v.push_back("suffix: \"" + suffix + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_op_testDTcc mht_7(mht_7_v, 388, "", "./tensorflow/core/kernels/immutable_constant_op_test.cc", "CreateTempFileBadString");
