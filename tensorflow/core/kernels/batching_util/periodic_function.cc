...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc() {
      // Check if tracing is enabled
...
PeriodicFunction::PeriodicFunction(const std::function<void()>& function,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc mht_0(mht_0_v, 210, "", "./tensorflow/core/kernels/batching_util/periodic_function.cc", "PeriodicFunction::PeriodicFunction");
...
PeriodicFunction::~PeriodicFunction() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc mht_1(mht_1_v, 226, "", "./tensorflow/core/kernels/batching_util/periodic_function.cc", "PeriodicFunction::~PeriodicFunction");
...
void PeriodicFunction::NotifyStop() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc mht_2(mht_2_v, 236, "", "./tensorflow/core/kernels/batching_util/periodic_function.cc", "PeriodicFunction::NotifyStop");
...
void PeriodicFunction::RunLoop(const int64_t start) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSperiodic_functionDTcc mht_3(mht_3_v, 245, "", "./tensorflow/core/kernels/batching_util/periodic_function.cc", "PeriodicFunction::RunLoop");
