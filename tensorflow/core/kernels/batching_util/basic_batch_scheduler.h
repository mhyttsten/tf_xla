...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh() {
      // Check if tracing is enabled
...
class BasicBatchScheduler : public BatchScheduler<TaskType> {
 public:
  ...
  size_t max_task_size() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh mht_0(mht_0_v, 453, "", "./tensorflow/core/kernels/batching_util/basic_batch_scheduler.h", "max_task_size");
...
Status BasicBatchScheduler<TaskType>::Create(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh mht_1(mht_1_v, 479, "", "./tensorflow/core/kernels/batching_util/basic_batch_scheduler.h", "BasicBatchScheduler<TaskType>::Create");
...
Status BasicBatchScheduler<TaskType>::Schedule(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh mht_2(mht_2_v, 524, "", "./tensorflow/core/kernels/batching_util/basic_batch_scheduler.h", "BasicBatchScheduler<TaskType>::Schedule");
...
size_t BasicBatchScheduler<TaskType>::NumEnqueuedTasks() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh mht_3(mht_3_v, 532, "", "./tensorflow/core/kernels/batching_util/basic_batch_scheduler.h", "BasicBatchScheduler<TaskType>::NumEnqueuedTasks");
...
size_t BasicBatchScheduler<TaskType>::SchedulingCapacity() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh mht_4(mht_4_v, 540, "", "./tensorflow/core/kernels/batching_util/basic_batch_scheduler.h", "BasicBatchScheduler<TaskType>::SchedulingCapacity");
...
BasicBatchScheduler<TaskType>::BasicBatchScheduler(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbatching_utilPSbasic_batch_schedulerDTh mht_5(mht_5_v, 550, "", "./tensorflow/core/kernels/batching_util/basic_batch_scheduler.h", "BasicBatchScheduler<TaskType>::BasicBatchScheduler");
}
