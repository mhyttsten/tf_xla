...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdecode_wav_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdecode_wav_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdecode_wav_opDTcc() {
      // Check if tracing is enabled
...
class DecodeWavOp : public OpKernel {
 public:
  explicit DecodeWavOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdecode_wav_opDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/kernels/decode_wav_op.cc", "DecodeWavOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdecode_wav_opDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/kernels/decode_wav_op.cc", "Compute");
