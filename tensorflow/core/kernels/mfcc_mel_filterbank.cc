...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc() {
      // Check if tracing is enabled
...
MfccMelFilterbank::MfccMelFilterbank() : initialized_(false) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/mfcc_mel_filterbank.cc", "MfccMelFilterbank::MfccMelFilterbank");
}
...
bool MfccMelFilterbank::Initialize(int input_length, double input_sample_rate,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/kernels/mfcc_mel_filterbank.cc", "MfccMelFilterbank::Initialize");
...
void MfccMelFilterbank::Compute(const std::vector<double> &input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc mht_2(mht_2_v, 347, "", "./tensorflow/core/kernels/mfcc_mel_filterbank.cc", "MfccMelFilterbank::Compute");
...
double MfccMelFilterbank::FreqToMel(double freq) const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSmfcc_mel_filterbankDTcc mht_3(mht_3_v, 376, "", "./tensorflow/core/kernels/mfcc_mel_filterbank.cc", "MfccMelFilterbank::FreqToMel");
