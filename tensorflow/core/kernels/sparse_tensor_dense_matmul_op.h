...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSsparse_tensor_dense_matmul_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_tensor_dense_matmul_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSsparse_tensor_dense_matmul_opDTh() {
      // Check if tracing is enabled
...
class MaybeAdjoint<MATRIX, false> {
 public:
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE MaybeAdjoint(MATRIX m) : m_(m) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_tensor_dense_matmul_opDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/kernels/sparse_tensor_dense_matmul_op.h", "MaybeAdjoint");
}
...
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE T MaybeConj(T v) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_tensor_dense_matmul_opDTh mht_1(mht_1_v, 227, "", "./tensorflow/core/kernels/sparse_tensor_dense_matmul_op.h", "MaybeConj");
...
class MaybeAdjoint<MATRIX, true> {
 public:
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE MaybeAdjoint(MATRIX m) : m_(m) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSsparse_tensor_dense_matmul_opDTh mht_2(mht_2_v, 237, "", "./tensorflow/core/kernels/sparse_tensor_dense_matmul_op.h", "MaybeAdjoint");
}
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE typename MATRIX::Scalar operator()(
      const typename MATRIX::Index i, const typename MATRIX::Index j) const {
