...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_spatial_convolutionsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_spatial_convolutionsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_spatial_convolutionsDTh() {
      // Check if tracing is enabled
...
SpatialConvolutionBackwardInput(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_spatial_convolutionsDTh mht_0(mht_0_v, 269, "", "./tensorflow/core/kernels/eigen_backward_spatial_convolutions.h", "SpatialConvolutionBackwardInput");
...
SpatialConvolutionBackwardKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_backward_spatial_convolutionsDTh mht_1(mht_1_v, 557, "", "./tensorflow/core/kernels/eigen_backward_spatial_convolutions.h", "SpatialConvolutionBackwardKernel");
