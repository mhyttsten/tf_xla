...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh() {
      // Check if tracing is enabled
...
class GpuDeviceArrayOnHost {
 public:
  GpuDeviceArrayOnHost(OpKernelContext* context, int32_t size)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh mht_0(mht_0_v, 216, "", "./tensorflow/core/kernels/gpu_device_array.h", "GpuDeviceArrayOnHost");
  ...
  Status Init() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh mht_1(mht_1_v, 223, "", "./tensorflow/core/kernels/gpu_device_array.h", "Init");
  ...
  void Set(int index, ValueType val) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh mht_2(mht_2_v, 244, "", "./tensorflow/core/kernels/gpu_device_array.h", "Set");
  ...
  Status Finalize() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh mht_3(mht_3_v, 253, "", "./tensorflow/core/kernels/gpu_device_array.h", "Finalize");
 ...
 private:
  bool inlined() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSgpu_device_arrayDTh mht_4(mht_4_v, 288, "", "./tensorflow/core/kernels/gpu_device_array.h", "inlined");
