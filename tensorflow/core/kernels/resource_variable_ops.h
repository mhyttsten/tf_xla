...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSresource_variable_opsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSresource_variable_opsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSresource_variable_opsDTh() {
      // Check if tracing is enabled
...
class VarHandleOp : public OpKernel {
 public:
  ...
  const Tensor* const_tensor() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSresource_variable_opsDTh mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/resource_variable_ops.h", "const_tensor");
...
class ReadVariablesOp : public OpKernel {
 public:
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSresource_variable_opsDTh mht_1(mht_1_v, 227, "", "./tensorflow/core/kernels/resource_variable_ops.h", "IsExpensive");
 return false; }
...
class VariableShapeOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSresource_variable_opsDTh mht_2(mht_2_v, 250, "", "./tensorflow/core/kernels/resource_variable_ops.h", "Compute");
