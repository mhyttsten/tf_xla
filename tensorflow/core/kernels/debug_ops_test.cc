...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc() {
      // Check if tracing is enabled
...
class DebugIdentityOpTest : public OpsTestBase {
 protected:
  Status Init(DataType input_type, const std::vector<string>& debug_urls) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/kernels/debug_ops_test.cc", "Init");
  ...
  Status Init(DataType input_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_1(mht_1_v, 226, "", "./tensorflow/core/kernels/debug_ops_test.cc", "Init");
...
class DebugNanCountOpTest : public OpsTestBase {
 protected:
  Status Init(DataType input_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_2(mht_2_v, 356, "", "./tensorflow/core/kernels/debug_ops_test.cc", "Init");
...
class DebugNumericSummaryOpTest : public OpsTestBase {
 protected:
  Status Init(DataType input_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_3(mht_3_v, 422, "", "./tensorflow/core/kernels/debug_ops_test.cc", "Init");
  ...
  Status InitGated(DataType input_type, const std::vector<string>& debug_urls) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_4(mht_4_v, 433, "", "./tensorflow/core/kernels/debug_ops_test.cc", "InitGated");
...
class DebugNumericSummaryOpCustomLowerBoundTest : public OpsTestBase {
 protected:
  Status Init(DataType input_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_5(mht_5_v, 819, "", "./tensorflow/core/kernels/debug_ops_test.cc", "Init");
...
class DebugNumericSummaryOpCustomLowerUpperBoundsTest : public OpsTestBase {
 protected:
  Status Init(DataType input_type) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdebug_ops_testDTcc mht_6(mht_6_v, 874, "", "./tensorflow/core/kernels/debug_ops_test.cc", "Init");
