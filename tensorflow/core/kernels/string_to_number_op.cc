...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_number_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_number_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_number_opDTcc() {
      // Check if tracing is enabled
...
class StringToNumberOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSstring_to_number_opDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/kernels/string_to_number_op.cc", "Compute");
