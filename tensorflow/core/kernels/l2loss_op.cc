...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_opDTcc() {
      // Check if tracing is enabled
...
class L2LossOp<CPUDevice, T> : public OpKernel {
 public:
  explicit L2LossOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_opDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/l2loss_op.cc", "L2LossOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSl2loss_opDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/kernels/l2loss_op.cc", "Compute");
