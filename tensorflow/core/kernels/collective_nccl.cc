...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPScollective_ncclDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScollective_ncclDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPScollective_ncclDTcc() {
      // Check if tracing is enabled
...
NcclBase::NcclBase(CollectiveType type, const string& name)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScollective_ncclDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/kernels/collective_nccl.cc", "NcclBase::NcclBase");
}

Status NcclBase::InitializeCollectiveParams(CollectiveParams* col_params) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPScollective_ncclDTcc mht_1(mht_1_v, 202, "", "./tensorflow/core/kernels/collective_nccl.cc", "NcclBase::InitializeCollectiveParams");
...
Status NcclBase::InitializeCollectiveContext(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPScollective_ncclDTcc mht_2(mht_2_v, 238, "", "./tensorflow/core/kernels/collective_nccl.cc", "NcclBase::InitializeCollectiveContext");
