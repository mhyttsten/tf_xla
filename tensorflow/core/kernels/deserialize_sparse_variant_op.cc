...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc() {
      // Check if tracing is enabled
...
class DeserializeSparseOp : public OpKernel {
 public:
  explicit DeserializeSparseOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/kernels/deserialize_sparse_variant_op.cc", "DeserializeSparseOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/kernels/deserialize_sparse_variant_op.cc", "Compute");
...
#undef HANDLE_TYPE
 ...
 private:
  Status GetAndValidateSparseTensorShape(const Variant& serialized_values,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc mht_2(mht_2_v, 454, "", "./tensorflow/core/kernels/deserialize_sparse_variant_op.cc", "GetAndValidateSparseTensorShape");
  ...
  Status GetAndValidateSparseTensorIndicesAndValues(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdeserialize_sparse_variant_opDTcc mht_3(mht_3_v, 483, "", "./tensorflow/core/kernels/deserialize_sparse_variant_op.cc", "GetAndValidateSparseTensorIndicesAndValues");
