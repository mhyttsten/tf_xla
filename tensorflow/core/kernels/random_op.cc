...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc() {
      // Check if tracing is enabled
...
static Status AllocateOutputWithShape(OpKernelContext* ctx, const Tensor& shape,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_0(mht_0_v, 224, "", "./tensorflow/core/kernels/random_op.cc", "AllocateOutputWithShape");
...
class PhiloxRandomOp : public OpKernel {
 public:
  ...
  explicit PhiloxRandomOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_1(mht_1_v, 239, "", "./tensorflow/core/kernels/random_op.cc", "PhiloxRandomOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_2(mht_2_v, 246, "", "./tensorflow/core/kernels/random_op.cc", "Compute");
...
class RandomUniformIntOp : public OpKernel {
 public:
  explicit RandomUniformIntOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_3(mht_3_v, 269, "", "./tensorflow/core/kernels/random_op.cc", "RandomUniformIntOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_4(mht_4_v, 276, "", "./tensorflow/core/kernels/random_op.cc", "Compute");
...
class RandomGammaOp : public OpKernel {
 public:
  explicit RandomGammaOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_5(mht_5_v, 326, "", "./tensorflow/core/kernels/random_op.cc", "RandomGammaOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_6(mht_6_v, 333, "", "./tensorflow/core/kernels/random_op.cc", "Compute");
...
#define UNIFORM(X)                                    \
  ...
  double X = uniform_result[uniform_remaining]
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_opDTcc mht_7(mht_7_v, 395, "", "./tensorflow/core/kernels/random_op.cc", "lambda");
