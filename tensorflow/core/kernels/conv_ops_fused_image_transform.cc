...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc() {
      // Check if tracing is enabled
...
void FusedConvParallelFor(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_0(mht_0_v, 250, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "FusedConvParallelFor");
...
struct ResizeTaskParameters {
  ResizeTaskParameters() : st(false, false) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_1(mht_1_v, 278, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "ResizeTaskParameters");
}
...
struct PerCacheLineParameters {
  PerCacheLineParameters() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_2(mht_2_v, 303, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "PerCacheLineParameters");
}
  PerCacheLineParameters(const PerCacheLineParameters<T1>& other)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_3(mht_3_v, 311, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "PerCacheLineParameters");
}
...
struct SampleRect {
  EIGEN_ALWAYS_INLINE SampleRect(const T1* in_top_left, const T1* in_top_right,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_4(mht_4_v, 331, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "SampleRect");
}

  EIGEN_ALWAYS_INLINE T1 BilinearSample(int channel, T1 x_lerp,
                                        T1 y_lerp) const {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_5(mht_5_v, 337, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "BilinearSample");
...
struct PerCachePixelParameters {
  PerCachePixelParameters() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_6(mht_6_v, 398, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "PerCachePixelParameters");
}
  PerCachePixelParameters(const PerCachePixelParameters<T1>& other)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_7(mht_7_v, 406, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "PerCachePixelParameters");
}
...
class FusedResizeAndPadConvFunctor {
 public:
  void operator()(OpKernelContext* context, const Tensor& input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_8(mht_8_v, 538, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_9(mht_9_v, 579, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "lambda");
...
class FusedResizeConv2DUsingGemmOp : public OpKernel {
 public:
  explicit FusedResizeConv2DUsingGemmOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_10(mht_10_v, 811, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "FusedResizeConv2DUsingGemmOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_ops_fused_image_transformDTcc mht_11(mht_11_v, 849, "", "./tensorflow/core/kernels/conv_ops_fused_image_transform.cc", "Compute");
