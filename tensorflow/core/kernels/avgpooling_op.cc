...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc() {
      // Check if tracing is enabled
...
class AvgPoolingOp : public UnaryOp<T> {
 public:
  explicit AvgPoolingOp(OpKernelConstruction* context) : UnaryOp<T>(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_0(mht_0_v, 227, "", "./tensorflow/core/kernels/avgpooling_op.cc", "AvgPoolingOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_1(mht_1_v, 259, "", "./tensorflow/core/kernels/avgpooling_op.cc", "Compute");
...
class AvgPoolingOp<GPUDevice, T> : public UnaryOp<T> {
 public:
  ...
  explicit AvgPoolingOp(OpKernelConstruction* context) : UnaryOp<T>(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_2(mht_2_v, 311, "", "./tensorflow/core/kernels/avgpooling_op.cc", "AvgPoolingOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_3(mht_3_v, 340, "", "./tensorflow/core/kernels/avgpooling_op.cc", "Compute");
...
class AvgPoolingGradOp : public OpKernel {
 public:
  explicit AvgPoolingGradOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_4(mht_4_v, 438, "", "./tensorflow/core/kernels/avgpooling_op.cc", "AvgPoolingGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_5(mht_5_v, 465, "", "./tensorflow/core/kernels/avgpooling_op.cc", "Compute");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_6(mht_6_v, 530, "", "./tensorflow/core/kernels/avgpooling_op.cc", "lambda");
...
class AvgPoolingGradOp<GPUDevice, T> : public OpKernel {
 public:
  ...
  explicit AvgPoolingGradOp(OpKernelConstruction* context) : OpKernel(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_7(mht_7_v, 613, "", "./tensorflow/core/kernels/avgpooling_op.cc", "AvgPoolingGradOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_8(mht_8_v, 637, "", "./tensorflow/core/kernels/avgpooling_op.cc", "Compute");
...
class AvgPoolingGradOpCustomGPUKernel : public OpKernel {
 public:
  ...
  explicit AvgPoolingGradOpCustomGPUKernel(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_9(mht_9_v, 706, "", "./tensorflow/core/kernels/avgpooling_op.cc", "AvgPoolingGradOpCustomGPUKernel");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSavgpooling_opDTcc mht_10(mht_10_v, 730, "", "./tensorflow/core/kernels/avgpooling_op.cc", "Compute");
