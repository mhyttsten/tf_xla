...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_opDTh() {
      // Check if tracing is enabled
...
class ImmutableConstantOp : public OpKernel {
 public:
  ...
  bool IsExpensive() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSimmutable_constant_opDTh mht_0(mht_0_v, 201, "", "./tensorflow/core/kernels/immutable_constant_op.h", "IsExpensive");
 return false; }
