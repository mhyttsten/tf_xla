...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc() {
      // Check if tracing is enabled
...
void GetModelDatasetParams(const Options& options,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/kernels/data/finalize_dataset_op.cc", "GetModelDatasetParams");
...
void MakeDatasetHelper(OpKernelContext* ctx, bool has_captured_ref,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc mht_1(mht_1_v, 219, "", "./tensorflow/core/kernels/data/finalize_dataset_op.cc", "MakeDatasetHelper");
...
FinalizeDatasetOp::FinalizeDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc mht_2(mht_2_v, 280, "", "./tensorflow/core/kernels/data/finalize_dataset_op.cc", "FinalizeDatasetOp::FinalizeDatasetOp");
...
void FinalizeDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTcc mht_3(mht_3_v, 292, "", "./tensorflow/core/kernels/data/finalize_dataset_op.cc", "FinalizeDatasetOp::MakeDataset");
