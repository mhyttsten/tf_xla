...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc() {
      // Check if tracing is enabled
...
class ConcatenateDatasetOp::Dataset : public DatasetBase {
 public:
  ...
  ~Dataset() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_0(mht_0_v, 228, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "~Dataset");
  ...
  Status MakeSplitProviders(std::vector<std::unique_ptr<SplitProvider>>*
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_1(mht_1_v, 243, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "MakeSplitProviders");
  ...
  const DataTypeVector& output_dtypes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_2(mht_2_v, 251, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "output_dtypes");
  ...
  const std::vector<PartialTensorShape>& output_shapes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_3(mht_3_v, 258, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "output_shapes");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_4(mht_4_v, 265, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "DebugString");
  ...
  int64_t CardinalityInternal() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_5(mht_5_v, 272, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "CardinalityInternal");
  ...
  int64_t CardinalityInternal(CardinalityOptions options) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_6(mht_6_v, 287, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "CardinalityInternal");
  ...
  Status InputDatasets(std::vector<const DatasetBase*>* inputs) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_7(mht_7_v, 305, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "InputDatasets");
  ...
  Status CheckExternalState() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_8(mht_8_v, 314, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "CheckExternalState");
  ...
  Status Get(OpKernelContext* ctx, int64 index,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_9(mht_9_v, 323, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "Get");
 ...
 protected:
  Status AsGraphDefInternal(SerializationContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_10(mht_10_v, 340, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "AsGraphDefInternal");
 ...
 private:
  class Iterator : public DatasetIterator<Dataset> {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_11(mht_11_v, 358, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "Iterator");
}

    Status Initialize(IteratorContext* ctx) override {
   std::vector<std::string> mht_12_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_12(mht_12_v, 363, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_13(mht_13_v, 376, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_14(mht_14_v, 410, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_15(mht_15_v, 426, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "RestoreInternal");
  ...
  static PartialTensorShape MostSpecificCompatibleShape(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_16(mht_16_v, 458, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "MostSpecificCompatibleShape");
...
ConcatenateDatasetOp::ConcatenateDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_17(mht_17_v, 484, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "ConcatenateDatasetOp::ConcatenateDatasetOp");
}
...
void ConcatenateDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSconcatenate_dataset_opDTcc mht_18(mht_18_v, 491, "", "./tensorflow/core/kernels/data/concatenate_dataset_op.cc", "ConcatenateDatasetOp::MakeDataset");
