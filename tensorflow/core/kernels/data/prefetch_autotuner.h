...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTh() {
      // Check if tracing is enabled
...
class PrefetchAutotuner {
 public:
  ...
  int64_t buffer_limit() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/kernels/data/prefetch_autotuner.h", "buffer_limit");
 return buffer_limit_; }

  void RecordConsumption(size_t current_buffer_size);
  void RecordEmpty() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTh mht_1(mht_1_v, 220, "", "./tensorflow/core/kernels/data/prefetch_autotuner.h", "RecordEmpty");
 RecordConsumption(0); }
