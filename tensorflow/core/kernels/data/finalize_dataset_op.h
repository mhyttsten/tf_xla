...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTh() {
      // Check if tracing is enabled
...
class FinalizeDatasetNoopOp : public UnaryDatasetOpKernel {
 public:
  explicit FinalizeDatasetNoopOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/kernels/data/finalize_dataset_op.h", "FinalizeDatasetNoopOp");
}
 ...
 protected:
  void MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSfinalize_dataset_opDTh mht_1(mht_1_v, 221, "", "./tensorflow/core/kernels/data/finalize_dataset_op.h", "MakeDataset");
