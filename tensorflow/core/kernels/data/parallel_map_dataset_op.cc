...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc() {
      // Check if tracing is enabled
...
class ParallelMapDatasetOp::Dataset : public DatasetBase {
 public:
  ...
  ~Dataset() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_0(mht_0_v, 274, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "~Dataset");
 input_->Unref(); }
  ...
  const DataTypeVector& output_dtypes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_1(mht_1_v, 287, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "output_dtypes");
 return output_types_; }

  const std::vector<PartialTensorShape>& output_shapes() const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_2(mht_2_v, 292, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "output_shapes");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_3(mht_3_v, 299, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "DebugString");
  ...
  int64_t CardinalityInternal() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_4(mht_4_v, 309, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "CardinalityInternal");
  ...
  int64_t CardinalityInternal(CardinalityOptions options) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_5(mht_5_v, 320, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "CardinalityInternal");
  ...
  Status Get(OpKernelContext* ctx, int64 index,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_6(mht_6_v, 332, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "Get");
  ...
  Status InputDatasets(std::vector<const DatasetBase*>* inputs) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_7(mht_7_v, 347, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "InputDatasets");
  ...
  Status CheckExternalState() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_8(mht_8_v, 355, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "CheckExternalState");
 ...
 protected:
  Status AsGraphDefInternal(SerializationContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_9(mht_9_v, 366, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "AsGraphDefInternal");
 ...
 private:
  class Iterator : public DatasetIterator<Dataset> {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_10(mht_10_v, 445, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "Iterator");
}

    ~Iterator() override {
   std::vector<std::string> mht_11_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_11(mht_11_v, 450, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "~Iterator");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_12(mht_12_v, 459, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_13(mht_13_v, 483, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_14(mht_14_v, 521, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_15(mht_15_v, 562, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "RestoreInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_16(mht_16_v, 605, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "GetTraceMeMetadata");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_17(mht_17_v, 634, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "InvocationResult");
}
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_18(mht_18_v, 658, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "EnsureThreadsStarted");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_19(mht_19_v, 700, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_20(mht_20_v, 781, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_21(mht_21_v, 817, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "ShouldWait");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_22(mht_22_v, 849, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "StatsThread");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_23(mht_23_v, 883, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "WriteStatusLocked");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_24(mht_24_v, 898, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "ReadStatusLocked");
...
ParallelMapDatasetOp::ParallelMapDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_25(mht_25_v, 970, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "ParallelMapDatasetOp::ParallelMapDatasetOp");
...
void ParallelMapDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSparallel_map_dataset_opDTcc mht_26(mht_26_v, 1002, "", "./tensorflow/core/kernels/data/parallel_map_dataset_op.cc", "ParallelMapDatasetOp::MakeDataset");
