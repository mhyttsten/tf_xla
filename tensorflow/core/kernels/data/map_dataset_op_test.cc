...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSmap_dataset_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSmap_dataset_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSmap_dataset_op_testDTcc() {
      // Check if tracing is enabled
...
MapDatasetParams MapDatasetParams1() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSmap_dataset_op_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/kernels/data/map_dataset_op_test.cc", "MapDatasetParams1");
...
MapDatasetParams MapDatasetParams2() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSmap_dataset_op_testDTcc mht_1(mht_1_v, 226, "", "./tensorflow/core/kernels/data/map_dataset_op_test.cc", "MapDatasetParams2");
...
MapDatasetParams MapDatasetParams3() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSmap_dataset_op_testDTcc mht_2(mht_2_v, 254, "", "./tensorflow/core/kernels/data/map_dataset_op_test.cc", "MapDatasetParams3");
