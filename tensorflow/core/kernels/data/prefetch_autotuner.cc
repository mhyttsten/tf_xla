...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTcc() {
      // Check if tracing is enabled
...
PrefetchAutotuner::PrefetchAutotuner(int64_t initial_buffer_size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/kernels/data/prefetch_autotuner.cc", "PrefetchAutotuner::PrefetchAutotuner");
...
void PrefetchAutotuner::RecordConsumption(size_t current_buffer_size) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSprefetch_autotunerDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/kernels/data/prefetch_autotuner.cc", "PrefetchAutotuner::RecordConsumption");
