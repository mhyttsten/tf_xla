...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc() {
      // Check if tracing is enabled
...
class PaddedBatchDatasetOp::Dataset : public DatasetBase {
 public:
  ...
  ~Dataset() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_0(mht_0_v, 260, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "~Dataset");
 input_->Unref(); }
  ...
  const DataTypeVector& output_dtypes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_1(mht_1_v, 273, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "output_dtypes");
  ...
  const std::vector<PartialTensorShape>& output_shapes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_2(mht_2_v, 280, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "output_shapes");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_3(mht_3_v, 287, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "DebugString");
  ...
  int64_t CardinalityInternal() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_4(mht_4_v, 297, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "CardinalityInternal");
  ...
  Status InputDatasets(std::vector<const DatasetBase*>* inputs) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_5(mht_5_v, 308, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "InputDatasets");
  ...
  Status CheckExternalState() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_6(mht_6_v, 316, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "CheckExternalState");
 ...
 protected:
  Status AsGraphDefInternal(SerializationContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_7(mht_7_v, 326, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "AsGraphDefInternal");
 ...
 private:
  class Iterator : public DatasetIterator<Dataset> {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_8(mht_8_v, 381, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "Iterator");
}

    Status Initialize(IteratorContext* ctx) override {
   std::vector<std::string> mht_9_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_9(mht_9_v, 386, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_10(mht_10_v, 395, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_11(mht_11_v, 448, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_12(mht_12_v, 461, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "RestoreInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_13(mht_13_v, 476, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "GetTraceMeMetadata");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_14(mht_14_v, 493, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "CopyBatch");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_15(mht_15_v, 562, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "lambda");
...
PaddedBatchDatasetOp::PaddedBatchDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_16(mht_16_v, 635, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "PaddedBatchDatasetOp::PaddedBatchDatasetOp");
...
void PaddedBatchDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSpadded_batch_dataset_opDTcc mht_17(mht_17_v, 645, "", "./tensorflow/core/kernels/data/padded_batch_dataset_op.cc", "PaddedBatchDatasetOp::MakeDataset");
