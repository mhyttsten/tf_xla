...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc() {
      // Check if tracing is enabled
...
class BatchDatasetOp::Dataset : public DatasetBase {
 public:
  ...
  ~Dataset() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_0(mht_0_v, 256, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "~Dataset");
 input_->Unref(); }
  ...
  const DataTypeVector& output_dtypes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_1(mht_1_v, 269, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "output_dtypes");
  ...
  const std::vector<PartialTensorShape>& output_shapes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_2(mht_2_v, 276, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "output_shapes");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_3(mht_3_v, 283, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "DebugString");
  ...
  int64_t CardinalityInternal() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_4(mht_4_v, 293, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "CardinalityInternal");
  ...
  int64_t CardinalityInternal(CardinalityOptions options) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_5(mht_5_v, 304, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "CardinalityInternal");
  ...
  Status InputDatasets(std::vector<const DatasetBase*>* inputs) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_6(mht_6_v, 315, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "InputDatasets");
  ...
  Status CheckExternalState() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_7(mht_7_v, 323, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "CheckExternalState");
  ...
  Status Get(OpKernelContext* ctx, int64 index,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_8(mht_8_v, 331, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "Get");
 ...
 protected:
  Status AsGraphDefInternal(SerializationContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_9(mht_9_v, 358, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "AsGraphDefInternal");
 ...
 private:
  class Iterator : public DatasetIterator<Dataset> {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_10(mht_10_v, 380, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "Iterator");
}

    Status Initialize(IteratorContext* ctx) override {
   std::vector<std::string> mht_11_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_11(mht_11_v, 385, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_12(mht_12_v, 394, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_13(mht_13_v, 455, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_14(mht_14_v, 469, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "RestoreInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_15(mht_15_v, 482, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "GetTraceMeMetadata");
...
BatchDatasetOp::BatchDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_16(mht_16_v, 506, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "BatchDatasetOp::BatchDatasetOp");
...
void BatchDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSbatch_dataset_opDTcc mht_17(mht_17_v, 516, "", "./tensorflow/core/kernels/data/batch_dataset_op.cc", "BatchDatasetOp::MakeDataset");
