...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc() {
      // Check if tracing is enabled
...
class FlatMapDatasetParams : public DatasetParams {
 public:
  ...
  FlatMapDatasetParams(T input_dataset_params,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/data/flat_map_dataset_op_test.cc", "FlatMapDatasetParams");
  ...
  Status GetInputNames(std::vector<string>* input_names) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc mht_1(mht_1_v, 222, "", "./tensorflow/core/kernels/data/flat_map_dataset_op_test.cc", "GetInputNames");
  ...
  Status GetAttributes(AttributeVector* attr_vector) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc mht_2(mht_2_v, 234, "", "./tensorflow/core/kernels/data/flat_map_dataset_op_test.cc", "GetAttributes");
  ...
  string dataset_type() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc mht_3(mht_3_v, 246, "", "./tensorflow/core/kernels/data/flat_map_dataset_op_test.cc", "dataset_type");
...
FlatMapDatasetParams FlatMapDatasetParams1() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc mht_4(mht_4_v, 265, "", "./tensorflow/core/kernels/data/flat_map_dataset_op_test.cc", "FlatMapDatasetParams1");
...
FlatMapDatasetParams InvalidFlatMapDatasetParams() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_op_testDTcc mht_5(mht_5_v, 291, "", "./tensorflow/core/kernels/data/flat_map_dataset_op_test.cc", "InvalidFlatMapDatasetParams");
