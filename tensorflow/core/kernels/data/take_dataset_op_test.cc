...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc() {
      // Check if tracing is enabled
...
TakeDatasetParams TakeLessTakeDatasetParams() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/kernels/data/take_dataset_op_test.cc", "TakeLessTakeDatasetParams");
...
TakeDatasetParams TakeMoreTakeDatasetParams() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/kernels/data/take_dataset_op_test.cc", "TakeMoreTakeDatasetParams");
...
TakeDatasetParams TakeAllTakeDatasetParams() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc mht_2(mht_2_v, 218, "", "./tensorflow/core/kernels/data/take_dataset_op_test.cc", "TakeAllTakeDatasetParams");
...
TakeDatasetParams TakeNothingTakeDatasetParams() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPStake_dataset_op_testDTcc mht_3(mht_3_v, 230, "", "./tensorflow/core/kernels/data/take_dataset_op_test.cc", "TakeNothingTakeDatasetParams");
