...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc() {
      // Check if tracing is enabled
...
class ZipDatasetOp::Dataset : public DatasetBase {
 public:
  ...
  ~Dataset() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_0(mht_0_v, 227, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "~Dataset");
  ...
  Status MakeSplitProviders(std::vector<std::unique_ptr<SplitProvider>>*
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_1(mht_1_v, 243, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "MakeSplitProviders");
  ...
  const DataTypeVector& output_dtypes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_2(mht_2_v, 251, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "output_dtypes");
  ...
  const std::vector<PartialTensorShape>& output_shapes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_3(mht_3_v, 258, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "output_shapes");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_4(mht_4_v, 265, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "DebugString");
  ...
  int64_t CardinalityInternal() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_5(mht_5_v, 272, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "CardinalityInternal");
  ...
  int64_t CardinalityInternal(CardinalityOptions options) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_6(mht_6_v, 290, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "CardinalityInternal");
  ...
  Status InputDatasets(std::vector<const DatasetBase*>* inputs) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_7(mht_7_v, 308, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "InputDatasets");
  ...
  Status CheckExternalState() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_8(mht_8_v, 318, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "CheckExternalState");
  ...
  Status Get(OpKernelContext* ctx, int64 index,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_9(mht_9_v, 329, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "Get");
 ...
 protected:
  Status AsGraphDefInternal(SerializationContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_10(mht_10_v, 347, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "AsGraphDefInternal");
 ...
 private:
  class Iterator : public DatasetIterator<Dataset> {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_11(mht_11_v, 367, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "Iterator");
}

    Status Initialize(IteratorContext* ctx) override {
   std::vector<std::string> mht_12_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_12(mht_12_v, 372, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_13(mht_13_v, 390, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_14(mht_14_v, 448, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_15(mht_15_v, 464, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "RestoreInternal");
...
ZipDatasetOp::ZipDatasetOp(OpKernelConstruction* ctx) : DatasetOpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_16(mht_16_v, 490, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "ZipDatasetOp::ZipDatasetOp");
}

void ZipDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase** output) {
   std::vector<std::string> mht_17_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSzip_dataset_opDTcc mht_17(mht_17_v, 495, "", "./tensorflow/core/kernels/data/zip_dataset_op.cc", "ZipDatasetOp::MakeDataset");
