...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc() {
      // Check if tracing is enabled
...
class CSVDatasetOp : public DatasetOpKernel {
 public:
  explicit CSVDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "CSVDatasetOp");
  ...
  void MakeDataset(OpKernelContext* ctx, DatasetBase** output) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "MakeDataset");
 ...
 private:
  class Dataset : public DatasetBase {
   ...
   mht_2_v.push_back("na_value: \"" + na_value + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_2(mht_2_v, 365, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "Dataset");
}
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_3(mht_3_v, 376, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "output_dtypes");
 return out_type_; }

    const std::vector<PartialTensorShape>& output_shapes() const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_4(mht_4_v, 381, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "output_shapes");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_5(mht_5_v, 388, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "DebugString");
 return "CSVDatasetOp::Dataset"; }

    Status CheckExternalState() const override {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_6(mht_6_v, 393, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "CheckExternalState");
 return Status::OK(); }

    Status InputDatasets(
        std::vector<const DatasetBase*>* inputs) const override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_7(mht_7_v, 399, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "InputDatasets");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_8(mht_8_v, 410, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "AsGraphDefInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_9(mht_9_v, 478, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "Iterator");
}
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_10(mht_10_v, 485, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_11(mht_11_v, 535, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_12(mht_12_v, 555, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "RestoreInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_13(mht_13_v, 609, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "ReadRecord");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_14(mht_14_v, 656, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "ParseOneField");
   ...
   mht_15_v.push_back("buffer: \"" + buffer + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_15(mht_15_v, 695, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "Piece");
}
      };
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_16(mht_16_v, 706, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "SaveAndFillBuffer");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_17(mht_17_v, 729, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "ParseQuotedField");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_18(mht_18_v, 804, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "QuotedFieldToOutput");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_19(mht_19_v, 844, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "AppendUnescapedPiece");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_20(mht_20_v, 872, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "ParseUnquotedField");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_21(mht_21_v, 926, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "FillBuffer");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_22(mht_22_v, 944, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "FieldToOutput");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_23(mht_23_v, 1049, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "SkipNewLineIfNecessary");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_24(mht_24_v, 1072, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "UnquotedFieldToOutput");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_25(mht_25_v, 1098, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "SetupStreamsLocked");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPScsv_dataset_opDTcc mht_26(mht_26_v, 1141, "", "./tensorflow/core/kernels/data/experimental/csv_dataset_op.cc", "ResetStreamsLocked");
