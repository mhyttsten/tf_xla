...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSdata_service_dataset_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSdata_service_dataset_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSdata_service_dataset_opDTh() {
      // Check if tracing is enabled
...
class IterationCounter : public ResourceBase {
 public:
  IterationCounter() : counter_(0) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSdata_service_dataset_opDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/data/experimental/data_service_dataset_op.h", "IterationCounter");
}

  std::string DebugString() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSdata_service_dataset_opDTh mht_1(mht_1_v, 213, "", "./tensorflow/core/kernels/data/experimental/data_service_dataset_op.h", "DebugString");
  ...
  int64_t GetAndIncrement() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSdata_service_dataset_opDTh mht_2(mht_2_v, 221, "", "./tensorflow/core/kernels/data/experimental/data_service_dataset_op.h", "GetAndIncrement");
