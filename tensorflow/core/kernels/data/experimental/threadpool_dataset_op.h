...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSthreadpool_dataset_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSthreadpool_dataset_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSthreadpool_dataset_opDTh() {
      // Check if tracing is enabled
...
class MaxIntraOpParallelismDatasetOp : public UnaryDatasetOpKernel {
 public:
  ...
  explicit MaxIntraOpParallelismDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSthreadpool_dataset_opDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/kernels/data/experimental/threadpool_dataset_op.h", "MaxIntraOpParallelismDatasetOp");
}
...
class PrivateThreadPoolDatasetOp : public UnaryDatasetOpKernel {
 public:
  ...
  explicit PrivateThreadPoolDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSthreadpool_dataset_opDTh mht_1(mht_1_v, 232, "", "./tensorflow/core/kernels/data/experimental/threadpool_dataset_op.h", "PrivateThreadPoolDatasetOp");
}
