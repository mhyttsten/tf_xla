...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSrandom_access_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSrandom_access_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSrandom_access_opsDTcc() {
      // Check if tracing is enabled
...
Status GetElementAtIndexOp::DoCompute(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSrandom_access_opsDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/kernels/data/experimental/random_access_ops.cc", "GetElementAtIndexOp::DoCompute");
