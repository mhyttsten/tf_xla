...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSsqlPSquery_connectionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSsqlPSquery_connectionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSsqlPSquery_connectionDTh() {
      // Check if tracing is enabled
...
class QueryConnection {
 public:
  virtual ~QueryConnection() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSsqlPSquery_connectionDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/kernels/data/experimental/sql/query_connection.h", "~QueryConnection");
}
