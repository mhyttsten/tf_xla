...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc() {
      // Check if tracing is enabled
...
AutoShardDatasetOp::AutoShardDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/kernels/data/experimental/auto_shard_dataset_op.cc", "AutoShardDatasetOp::AutoShardDatasetOp");
...
void AutoShardDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc mht_1(mht_1_v, 218, "", "./tensorflow/core/kernels/data/experimental/auto_shard_dataset_op.cc", "AutoShardDatasetOp::MakeDataset");
  ...
  auto config_factory = [num_workers, index, auto_shard_policy,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc mht_2(mht_2_v, 241, "", "./tensorflow/core/kernels/data/experimental/auto_shard_dataset_op.cc", "lambda");
...
RewriterConfig AutoShardDatasetOp::CreateConfig(int64_t num_workers,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSauto_shard_dataset_opDTcc mht_3(mht_3_v, 261, "", "./tensorflow/core/kernels/data/experimental/auto_shard_dataset_op.cc", "AutoShardDatasetOp::CreateConfig");
