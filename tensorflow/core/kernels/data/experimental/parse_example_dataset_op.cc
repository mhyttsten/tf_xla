...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc() {
      // Check if tracing is enabled
...
class ParseExampleDatasetOp : public UnaryDatasetOpKernel {
 public:
  ...
  explicit ParseExampleDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_0(mht_0_v, 221, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "ParseExampleDatasetOp");
 ...
 protected:
  void MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_1(mht_1_v, 292, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "MakeDataset");
 ...
 private:
  class Dataset : public DatasetBase {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_2(mht_2_v, 419, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "Dataset");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_3(mht_3_v, 426, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "~Dataset");
 input_->Unref(); }
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_4(mht_4_v, 439, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "output_dtypes");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_5(mht_5_v, 446, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "output_shapes");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_6(mht_6_v, 453, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "DebugString");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_7(mht_7_v, 462, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "CardinalityInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_8(mht_8_v, 470, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "InputDatasets");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_9(mht_9_v, 478, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "CheckExternalState");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_10(mht_10_v, 488, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "AsGraphDefInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_11(mht_11_v, 576, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "Iterator");

      }

      ~Iterator() override {
   std::vector<std::string> mht_12_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_12(mht_12_v, 582, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "~Iterator");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_13(mht_13_v, 590, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_14(mht_14_v, 607, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_15(mht_15_v, 645, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_16(mht_16_v, 686, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "RestoreInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_17(mht_17_v, 733, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "GetTraceMeMetadata");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_18(mht_18_v, 760, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "InvocationResult");
}
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_19(mht_19_v, 783, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "EnsureThreadsStarted");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_20(mht_20_v, 826, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_21(mht_21_v, 862, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "CheckOutputTensor");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_22(mht_22_v, 885, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "ParseExample");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_23(mht_23_v, 997, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "lambda");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_24(mht_24_v, 1036, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "ShouldWait");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_25(mht_25_v, 1068, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "StatsThread");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_26(mht_26_v, 1101, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "WriteStatusLocked");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_27(mht_27_v, 1116, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "ReadStatusLocked");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_28(mht_28_v, 1135, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "CodeKey");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSparse_example_dataset_opDTcc mht_29(mht_29_v, 1143, "", "./tensorflow/core/kernels/data/experimental/parse_example_dataset_op.cc", "ErrorMessageKey");
