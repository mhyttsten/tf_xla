...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSprefetching_kernelsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSprefetching_kernelsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSprefetching_kernelsDTcc() {
      // Check if tracing is enabled
...
class IteratorGetDeviceOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSexperimentalPSprefetching_kernelsDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/kernels/data/experimental/prefetching_kernels.cc", "Compute");
