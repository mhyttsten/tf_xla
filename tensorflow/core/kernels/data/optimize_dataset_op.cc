...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc() {
      // Check if tracing is enabled
...
void MakeDatasetHelper(OpKernelContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_0(mht_0_v, 225, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "MakeDatasetHelper");
  ...
  auto config_factory = [&optimizations, &optimization_configs]() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_1(mht_1_v, 253, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "lambda");
...
void OptimizeDatasetOp::MakeDatasetFromOptions(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_2(mht_2_v, 285, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "OptimizeDatasetOp::MakeDatasetFromOptions");
...
OptimizeDatasetOp::OptimizeDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_3(mht_3_v, 298, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "OptimizeDatasetOp::OptimizeDatasetOp");
...
void OptimizeDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_4(mht_4_v, 316, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "OptimizeDatasetOp::MakeDataset");
...
void OptimizeDatasetOp::MakeDatasetFromOptions(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_5(mht_5_v, 370, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "OptimizeDatasetOp::MakeDatasetFromOptions");
...
OptimizeDatasetOp::OptimizeDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_6(mht_6_v, 379, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "OptimizeDatasetOp::OptimizeDatasetOp");
}

void OptimizeDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
                                    DatasetBase** output) {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_opDTcc mht_7(mht_7_v, 385, "", "./tensorflow/core/kernels/data/optimize_dataset_op.cc", "OptimizeDatasetOp::MakeDataset");
