...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc() {
      // Check if tracing is enabled
...
class FlatMapDatasetOp::Dataset : public DatasetBase {
 public:
  ...
  ~Dataset() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_0(mht_0_v, 238, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "~Dataset");
 input_->Unref(); }
  ...
  const DataTypeVector& output_dtypes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_1(mht_1_v, 249, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "output_dtypes");
 return output_types_; }

  const std::vector<PartialTensorShape>& output_shapes() const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_2(mht_2_v, 254, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "output_shapes");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_3(mht_3_v, 261, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "DebugString");
  ...
  Status InputDatasets(std::vector<const DatasetBase*>* inputs) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_4(mht_4_v, 268, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "InputDatasets");
  ...
  Status CheckExternalState() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_5(mht_5_v, 276, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "CheckExternalState");
 ...
 protected:
  Status AsGraphDefInternal(SerializationContext* ctx,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_6(mht_6_v, 287, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "AsGraphDefInternal");
 ...
 private:
  class Iterator : public DatasetIterator<Dataset> {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_7(mht_7_v, 315, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "Iterator");
}

    Status Initialize(IteratorContext* ctx) override {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_8(mht_8_v, 320, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "Initialize");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_9(mht_9_v, 332, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "GetNextInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_10(mht_10_v, 374, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "SkipInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_11(mht_11_v, 421, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "SaveInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_12(mht_12_v, 451, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "RestoreInternal");
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_13(mht_13_v, 500, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "BuildCurrentElementIteratorLocked");
...
FlatMapDatasetOp::FlatMapDatasetOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_14(mht_14_v, 532, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "FlatMapDatasetOp::FlatMapDatasetOp");
...
void FlatMapDatasetOp::MakeDataset(OpKernelContext* ctx, DatasetBase* input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSflat_map_dataset_opDTcc mht_15(mht_15_v, 543, "", "./tensorflow/core/kernels/data/flat_map_dataset_op.cc", "FlatMapDatasetOp::MakeDataset");
