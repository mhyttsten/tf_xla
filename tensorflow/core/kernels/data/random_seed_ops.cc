...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc() {
      // Check if tracing is enabled
...
string SeedGeneratorManager::DebugString() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "SeedGeneratorManager::DebugString");
 return kSeedGenerator; }

void FixedSeedGenerator::GenerateSeeds(int64_t* seed1, int64_t* seed2) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "FixedSeedGenerator::GenerateSeeds");
...
void RandomSeedGenerator::GenerateSeeds(int64_t* seed1, int64_t* seed2) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_2(mht_2_v, 221, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "RandomSeedGenerator::GenerateSeeds");
...
void RandomSeedGenerator::Reset() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_3(mht_3_v, 232, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "RandomSeedGenerator::Reset");
...
AnonymousSeedGeneratorHandleOp::AnonymousSeedGeneratorHandleOp(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_4(mht_4_v, 248, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "AnonymousSeedGeneratorHandleOp::AnonymousSeedGeneratorHandleOp");
}

void AnonymousSeedGeneratorHandleOp::Compute(OpKernelContext* ctx) {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_5(mht_5_v, 253, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "AnonymousSeedGeneratorHandleOp::Compute");
...
std::string AnonymousSeedGeneratorHandleOp::name() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_6(mht_6_v, 268, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "AnonymousSeedGeneratorHandleOp::name");
 return kSeedGenerator; }
...
Status AnonymousSeedGeneratorHandleOp::CreateResource(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_7(mht_7_v, 277, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "AnonymousSeedGeneratorHandleOp::CreateResource");
...
void DeleteSeedGeneratorOp::Compute(OpKernelContext* ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSrandom_seed_opsDTcc mht_8(mht_8_v, 290, "", "./tensorflow/core/kernels/data/random_seed_ops.cc", "DeleteSeedGeneratorOp::Compute");
