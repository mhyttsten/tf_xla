...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc() {
      // Check if tracing is enabled
...
class OptimizeDatasetParams : public DatasetParams {
 public:
  ...
  OptimizeDatasetParams(T input_dataset_params, string optimizations,
   ...
   mht_0_v.push_back("optimizations: \"" + optimizations + "\"");
   mht_0_v.push_back("node_name: \"" + node_name + "\"");
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/kernels/data/optimize_dataset_op_test.cc", "OptimizeDatasetParams");
  ...
  Status GetInputNames(std::vector<string>* input_names) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc mht_1(mht_1_v, 221, "", "./tensorflow/core/kernels/data/optimize_dataset_op_test.cc", "GetInputNames");
  ...
  Status GetAttributes(AttributeVector* attr_vector) const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc mht_2(mht_2_v, 230, "", "./tensorflow/core/kernels/data/optimize_dataset_op_test.cc", "GetAttributes");
  ...
  string dataset_type() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptimize_dataset_op_testDTcc mht_3(mht_3_v, 241, "", "./tensorflow/core/kernels/data/optimize_dataset_op_test.cc", "dataset_type");
