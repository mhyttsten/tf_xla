...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptions_dataset_op_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptions_dataset_op_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptions_dataset_op_testDTcc() {
      // Check if tracing is enabled
...
OptionsDatasetParams OptionsDatasetParams0() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptions_dataset_op_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/kernels/data/options_dataset_op_test.cc", "OptionsDatasetParams0");
...
OptionsDatasetParams OptionsDatasetParams1() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptions_dataset_op_testDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/kernels/data/options_dataset_op_test.cc", "OptionsDatasetParams1");
...
OptionsDatasetParams OptionsDatasetParams2() {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSdataPSoptions_dataset_op_testDTcc mht_2(mht_2_v, 227, "", "./tensorflow/core/kernels/data/options_dataset_op_test.cc", "OptionsDatasetParams2");
