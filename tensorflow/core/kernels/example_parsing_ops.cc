...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc() {
      // Check if tracing is enabled
...
class ParseExampleOp : public OpKernel {
 public:
  explicit ParseExampleOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_0(mht_0_v, 220, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ParseExampleOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_1(mht_1_v, 227, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "Compute");
 ...
 protected:
  ...
  Status GetTensorKeys(OpKernelContext* ctx, StringPiece input_name,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_2(mht_2_v, 277, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "GetTensorKeys");
  ...
  Status GetInputListKeys(OpKernelContext* ctx, StringPiece input_name,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_3(mht_3_v, 293, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "GetInputListKeys");
  ...
  Status CheckInputShapes(const Tensor* serialized, const Tensor* names,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_4(mht_4_v, 311, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "CheckInputShapes");
  ...
  example::FastParseExampleConfig MakeConfig(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_5(mht_5_v, 396, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "MakeConfig");
  ...
  Status ParseExampleScalar(const example::FastParseExampleConfig& config,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_6(mht_6_v, 423, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ParseExampleScalar");
  ...
  Status ParseExampleVector(const example::FastParseExampleConfig& config,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_7(mht_7_v, 435, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ParseExampleVector");
  ...
  Status WriteOutput(const example::Result& result,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_8(mht_8_v, 449, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "WriteOutput");
...
class ParseSingleExampleOp : public OpKernel {
 public:
  explicit ParseSingleExampleOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_9(mht_9_v, 494, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ParseSingleExampleOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_10(mht_10_v, 503, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "Compute");
...
class ParseSequenceExampleOp : public OpKernel {
 public:
  explicit ParseSequenceExampleOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_11(mht_11_v, 600, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ParseSequenceExampleOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_12(mht_12_v, 611, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "Compute");
 ...
 protected:
  Status CheckInputShapes(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_13(mht_13_v, 703, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "CheckInputShapes");
  ...
  example::FastParseExampleConfig MakeContextConfig(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_14(mht_14_v, 782, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "MakeContextConfig");
  ...
  static Tensor ConstructDefaultScalar(DataType dtype) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_15(mht_15_v, 828, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ConstructDefaultScalar");
  ...
  example::FastParseExampleConfig MakeFeatureListConfig(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_16(mht_16_v, 847, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "MakeFeatureListConfig");
  ...
  Status WriteOutput(const example::Result& context_result,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_17(mht_17_v, 908, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "WriteOutput");
...
class ParseSingleSequenceExampleOp : public OpKernel {
 public:
  explicit ParseSingleSequenceExampleOp(OpKernelConstruction* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_18(mht_18_v, 1003, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "ParseSingleSequenceExampleOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_19(mht_19_v, 1010, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "Compute");
...
class DecodeJSONExampleOp : public OpKernel {
 public:
  explicit DecodeJSONExampleOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_20(mht_20_v, 1428, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "DecodeJSONExampleOp");
  ...
  void Compute(OpKernelContext* ctx) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSexample_parsing_opsDTcc mht_21(mht_21_v, 1436, "", "./tensorflow/core/kernels/example_parsing_ops.cc", "Compute");
