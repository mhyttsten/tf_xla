...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSrandom_index_shuffle_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_index_shuffle_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSrandom_index_shuffle_opsDTcc() {
      // Check if tracing is enabled
...
Status GetSeed(const Tensor& seed_t, const int row,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_index_shuffle_opsDTcc mht_0(mht_0_v, 217, "", "./tensorflow/core/kernels/random_index_shuffle_ops.cc", "GetSeed");
...
class RandomIndexShuffleOp : public OpKernel {
 public:
  explicit RandomIndexShuffleOp(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_index_shuffle_opsDTcc mht_1(mht_1_v, 240, "", "./tensorflow/core/kernels/random_index_shuffle_ops.cc", "RandomIndexShuffleOp");
}

  void Compute(OpKernelContext* context) override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSrandom_index_shuffle_opsDTcc mht_2(mht_2_v, 245, "", "./tensorflow/core/kernels/random_index_shuffle_ops.cc", "Compute");
