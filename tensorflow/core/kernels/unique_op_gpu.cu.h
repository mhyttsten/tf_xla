...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh() {
      // Check if tracing is enabled
...
struct SegmentIndicatorFunctor {
  ...
  SegmentIndicatorFunctor(const T* sorted_input_ptr)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_0(mht_0_v, 221, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "SegmentIndicatorFunctor");
}
...
__global__ void ExtractFirstOccurrenceIndicesKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_1(mht_1_v, 235, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "ExtractFirstOccurrenceIndicesKernel");
...
Status ExtractFirstOccurrenceIndices(const GPUDevice& d, int64_t input_size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_2(mht_2_v, 266, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "ExtractFirstOccurrenceIndices");
...
__global__ void LookupAndScatterUniqueIdsKernel(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_3(mht_3_v, 326, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "LookupAndScatterUniqueIdsKernel");
...
Status LookupAndScatterUniqueIds(const GPUDevice& d, int64_t input_size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_4(mht_4_v, 343, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "LookupAndScatterUniqueIds");
...
class UniqueOpGPU : public AsyncOpKernel {
 public:
  explicit UniqueOpGPU(OpKernelConstruction* context)
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_5(mht_5_v, 364, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "UniqueOpGPU");
}
  ...
  void AllocateTemp(OpKernelContext* context, int64_t size, Tensor* tensor,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_6(mht_6_v, 371, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "AllocateTemp");
  ...
  void ComputeAsync(OpKernelContext* context, DoneCallback done) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSunique_op_gpuDTcuDTh mht_7(mht_7_v, 382, "", "./tensorflow/core/kernels/unique_op_gpu.cu.h", "ComputeAsync");
