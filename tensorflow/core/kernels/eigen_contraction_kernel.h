...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh() {
      // Check if tracing is enabled
...
class TensorContractionBlocking<float, float, float, StorageIndex,
 ...
 public:
  TensorContractionBlocking(StorageIndex k, StorageIndex m, StorageIndex n,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_0(mht_0_v, 465, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "TensorContractionBlocking");
  ...
  EIGEN_ALWAYS_INLINE StorageIndex kc() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_1(mht_1_v, 503, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "kc");
 return kc_; }
  EIGEN_ALWAYS_INLINE StorageIndex mc() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_2(mht_2_v, 507, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "mc");
 return mc_; }
  EIGEN_ALWAYS_INLINE StorageIndex nc() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_3(mht_3_v, 511, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "nc");
 return nc_; }
...
class TensorContractionBlocking<Eigen::QInt32, Eigen::QInt8, Eigen::QUInt8,
 ...
 public:
  TensorContractionBlocking(StorageIndex k, StorageIndex m, StorageIndex n,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_4(mht_4_v, 543, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "TensorContractionBlocking");
  ...
  EIGEN_ALWAYS_INLINE StorageIndex kc() const {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_5(mht_5_v, 553, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "kc");
 return kc_; }
  EIGEN_ALWAYS_INLINE StorageIndex mc() const {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_6(mht_6_v, 557, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "mc");
 return mc_; }
  EIGEN_ALWAYS_INLINE StorageIndex nc() const {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSkernelsPSeigen_contraction_kernelDTh mht_7(mht_7_v, 561, "", "./tensorflow/core/kernels/eigen_contraction_kernel.h", "nc");
 return nc_; }
