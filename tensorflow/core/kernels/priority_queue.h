...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSpriority_queueDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpriority_queueDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSpriority_queueDTh() {
      // Check if tracing is enabled
...
class PriorityQueue
 ...
 public:
  ...
  int32 size() const override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpriority_queueDTh mht_0(mht_0_v, 240, "", "./tensorflow/core/kernels/priority_queue.h", "size");
 ...
 private:
  ~PriorityQueue() override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpriority_queueDTh mht_1(mht_1_v, 249, "", "./tensorflow/core/kernels/priority_queue.h", "~PriorityQueue");
}
