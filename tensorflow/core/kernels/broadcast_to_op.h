...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSbroadcast_to_opDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbroadcast_to_opDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSbroadcast_to_opDTh() {
      // Check if tracing is enabled
...
struct BroadcastTo {
  ...
  void DoBCast(
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbroadcast_to_opDTh mht_0(mht_0_v, 207, "", "./tensorflow/core/kernels/broadcast_to_op.h", "DoBCast");
  ...
  void ReshapeAndBCast(const Device &device, Tensor &output_tensor,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSbroadcast_to_opDTh mht_1(mht_1_v, 220, "", "./tensorflow/core/kernels/broadcast_to_op.h", "ReshapeAndBCast");
