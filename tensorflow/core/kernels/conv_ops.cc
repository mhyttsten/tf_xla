...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc() {
      // Check if tracing is enabled
...
struct LaunchGrouped {
  void operator()(OpKernelContext* ctx, const Tensor& input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_0(mht_0_v, 352, "", "./tensorflow/core/kernels/conv_ops.cc", "lambda");
...
class LaunchDeepConvOp {
 public:
  static bool Run(OpKernelContext* ctx, const Tensor& input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_1(mht_1_v, 543, "", "./tensorflow/core/kernels/conv_ops.cc", "Run");
...
class LaunchDeepConvOp<CPUDevice, float> {
 public:
  static bool Run(OpKernelContext* ctx, const Tensor& input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_2(mht_2_v, 561, "", "./tensorflow/core/kernels/conv_ops.cc", "Run");
...
class LaunchXsmmConvOp {
 public:
  static bool Run(OpKernelContext* ctx, const Tensor& input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_3(mht_3_v, 605, "", "./tensorflow/core/kernels/conv_ops.cc", "Run");
...
class LaunchXsmmConvOp<CPUDevice, float> {
 public:
  static bool Run(OpKernelContext* ctx, const Tensor& input,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_4(mht_4_v, 622, "", "./tensorflow/core/kernels/conv_ops.cc", "Run");
...
Status ComputeConv2DDimension(const Conv2DParameters& params,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_5(mht_5_v, 731, "", "./tensorflow/core/kernels/conv_ops.cc", "ComputeConv2DDimension");
...
class Conv2DOp : public BinaryOp<T> {
 public:
  explicit Conv2DOp(OpKernelConstruction* context) : BinaryOp<T>(context) {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_6(mht_6_v, 844, "", "./tensorflow/core/kernels/conv_ops.cc", "Conv2DOp");
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSconv_opsDTcc mht_7(mht_7_v, 854, "", "./tensorflow/core/kernels/conv_ops.cc", "Compute");
