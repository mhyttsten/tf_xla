...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc() {
      // Check if tracing is enabled
...
__global__ void PopulationCountKernel(const int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/kernels/population_count_op_gpu.cu.cc", "PopulationCountKernel");
...
__global__ void PopulationCountKernel(const int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc mht_1(mht_1_v, 217, "", "./tensorflow/core/kernels/population_count_op_gpu.cu.cc", "PopulationCountKernel");
...
__global__ void PopulationCountKernel(const int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc mht_2(mht_2_v, 230, "", "./tensorflow/core/kernels/population_count_op_gpu.cu.cc", "PopulationCountKernel");
...
__global__ void PopulationCountKernel<int64_t>(const int size,
   ...
   MHTracer_DTPStensorflowPScorePSkernelsPSpopulation_count_op_gpuDTcuDTcc mht_3(mht_3_v, 243, "", "./tensorflow/core/kernels/population_count_op_gpu.cu.cc", "PopulationCountKernel<int64_t>");
