...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSruntime_fallback_tensorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSruntime_fallback_tensorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSruntime_fallback_tensorDTh() {
      // Check if tracing is enabled
...
class RuntimeFallbackTensor final
 ...
 public:
  ...
  TensorHandle* GetTensorHandle() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSruntime_fallback_tensorDTh mht_0(mht_0_v, 211, "", "./tensorflow/core/runtime_fallback/runtime/runtime_fallback_tensor.h", "GetTensorHandle");
 return tensor_handle_.get(); }

  // Tensor type name for RuntimeFallbackTensor.
  static const char* name() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSruntime_fallback_tensorDTh mht_1(mht_1_v, 217, "", "./tensorflow/core/runtime_fallback/runtime/runtime_fallback_tensor.h", "name");
 ...
 private:
  ...
  static void PrintTensorValues(void* data, ssize_t size,
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSruntime_fallback_tensorDTh mht_2(mht_2_v, 225, "", "./tensorflow/core/runtime_fallback/runtime/runtime_fallback_tensor.h", "PrintTensorValues");
