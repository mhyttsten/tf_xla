...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSstatic_registrationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSstatic_registrationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSstatic_registrationDTcc() {
      // Check if tracing is enabled
...
static bool runtime_fallback_conversion_fn_registration = []() {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSstatic_registrationDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/runtime_fallback/runtime/static_registration.cc", "lambda");
