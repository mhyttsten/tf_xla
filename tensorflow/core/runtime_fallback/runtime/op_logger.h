...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSop_loggerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSop_loggerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSop_loggerDTh() {
      // Check if tracing is enabled
...
class OpLogger : public tfrt::SharedContext {
 public:
  explicit OpLogger(tfrt::HostContext* host)
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSop_loggerDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/runtime_fallback/runtime/op_logger.h", "OpLogger");
}

  void LogOp(tfrt::string_view op_name) {
   std::vector<std::string> mht_1_v;
   mht_1_v.push_back("op_name: \"" + std::string(op_name.data(), op_name.size()) + "\"");
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSop_loggerDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/runtime_fallback/runtime/op_logger.h", "LogOp");
  ...
  void Clear() {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSruntimePSop_loggerDTh mht_2(mht_2_v, 227, "", "./tensorflow/core/runtime_fallback/runtime/op_logger.h", "Clear");
