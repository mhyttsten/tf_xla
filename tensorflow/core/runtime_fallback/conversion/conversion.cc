...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSconversionPSconversionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSconversionPSconversionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSconversionPSconversionDTcc() {
      // Check if tracing is enabled
...
static RuntimeFallbackTensor ConvertKernelFallbackToRuntimeFallbackTensor(
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSconversionPSconversionDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/runtime_fallback/conversion/conversion.cc", "ConvertKernelFallbackToRuntimeFallbackTensor");
...
void RegisterRuntimeFallbackTensorToKernelFallbackConversionFn(
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSconversionPSconversionDTcc mht_1(mht_1_v, 249, "", "./tensorflow/core/runtime_fallback/conversion/conversion.cc", "RegisterRuntimeFallbackTensorToKernelFallbackConversionFn");
