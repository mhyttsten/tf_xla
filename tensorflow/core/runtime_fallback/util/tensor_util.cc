...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStensor_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStensor_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStensor_utilDTcc() {
      // Check if tracing is enabled
...
tensorflow::Tensor MoveHostBufferToTfTensor(RCReference<HostBuffer> host_buffer,
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStensor_utilDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/runtime_fallback/util/tensor_util.cc", "MoveHostBufferToTfTensor");
  ...
  auto deallocator = [](void* data, size_t len, void* arg) {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStensor_utilDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/runtime_fallback/util/tensor_util.cc", "lambda");
...
tensorflow::Tensor CopyShtToTfTensor(const StringHostTensor& sht) {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStensor_utilDTcc mht_2(mht_2_v, 227, "", "./tensorflow/core/runtime_fallback/util/tensor_util.cc", "CopyShtToTfTensor");
