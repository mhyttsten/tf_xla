...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStype_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStype_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStype_utilDTh() {
      // Check if tracing is enabled
...
inline DataType GetTfDataType(tfrt::DType dtype) {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStype_utilDTh mht_0(mht_0_v, 196, "", "./tensorflow/core/runtime_fallback/util/type_util.h", "GetTfDataType");
...
inline tfrt::DType GetTfrtDtype(DataType dtype) {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSutilPStype_utilDTh mht_1(mht_1_v, 213, "", "./tensorflow/core/runtime_fallback/util/type_util.h", "GetTfrtDtype");
