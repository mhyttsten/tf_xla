...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTh() {
      // Check if tracing is enabled
...
struct HostAllocatorTypeWrapper {
  HostAllocatorTypeWrapper(HostAllocatorType type) : type(type) {
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTh mht_0(mht_0_v, 196, "", "./tensorflow/core/runtime_fallback/bef_executor_flags.h", "HostAllocatorTypeWrapper");
}
  operator HostAllocatorType() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTh mht_1(mht_1_v, 200, "", "./tensorflow/core/runtime_fallback/bef_executor_flags.h", "HostAllocatorType");
 return type; }
