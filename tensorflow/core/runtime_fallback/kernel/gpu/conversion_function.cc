...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSkernelPSgpuPSconversion_functionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSkernelPSgpuPSconversion_functionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSkernelPSgpuPSconversion_functionDTcc() {
      // Check if tracing is enabled
...
void RegisterTFKernelFallbackTensorToGpuConversionFn(
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSkernelPSgpuPSconversion_functionDTcc mht_0(mht_0_v, 267, "", "./tensorflow/core/runtime_fallback/kernel/gpu/conversion_function.cc", "RegisterTFKernelFallbackTensorToGpuConversionFn");
