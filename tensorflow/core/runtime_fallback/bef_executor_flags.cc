...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTcc() {
      // Check if tracing is enabled
...
bool AbslParseFlag(absl::string_view text,
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTcc mht_0(mht_0_v, 216, "", "./tensorflow/core/runtime_fallback/bef_executor_flags.cc", "AbslParseFlag");
...
std::string AbslUnparseFlag(
   ...
   MHTracer_DTPStensorflowPScorePSruntime_fallbackPSbef_executor_flagsDTcc mht_1(mht_1_v, 237, "", "./tensorflow/core/runtime_fallback/bef_executor_flags.cc", "AbslUnparseFlag");
