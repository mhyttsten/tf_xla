...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc() {
      // Check if tracing is enabled
...
class GraphPropertiesTest : public ::testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_0(mht_0_v, 231, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_1(mht_1_v, 264, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "TearDown");
 ...
 protected:
  ...
  string PropToString(const OpInfo::TensorProperties& p) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_2(mht_2_v, 275, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "PropToString");
  ...
  void ExpectTensorValues(const std::vector<int64_t>& expected,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_3(mht_3_v, 296, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "ExpectTensorValues");
  ...
  void ExpectFloatTensorValues(const std::vector<float>& expected,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_4(mht_4_v, 320, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "ExpectFloatTensorValues");
...
class ConstTensorSkipTestCase {
 public:
  ConstTensorSkipTestCase(const DataType data_type,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_5(mht_5_v, 502, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "ConstTensorSkipTestCase");
}

  void RunTestAndValidate() const {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_properties_testDTcc mht_6(mht_6_v, 507, "", "./tensorflow/core/grappler/costs/graph_properties_test.cc", "RunTestAndValidate");
