...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_memoryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_memoryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_memoryDTh() {
      // Check if tracing is enabled
...
class GraphMemory {
 public:
  ...
  explicit GraphMemory(const GrapplerItem& item)
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_memoryDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/grappler/costs/graph_memory.h", "GraphMemory");
}
  ...
  const MemoryUsage& GetPeakMemoryUsage(const string& device) const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSgraph_memoryDTh mht_1(mht_1_v, 228, "", "./tensorflow/core/grappler/costs/graph_memory.h", "GetPeakMemoryUsage");
