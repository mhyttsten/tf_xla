...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh() {
      // Check if tracing is enabled
...
struct NodeCosts {
  ...
  int64_t num_total_input_bytes() const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_0(mht_0_v, 223, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "num_total_input_bytes");
  ...
  int64_t num_total_read_bytes() const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_1(mht_1_v, 230, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "num_total_read_bytes");

    return num_total_input_bytes() + internal_read_bytes;
  }
  int64_t num_total_output_bytes() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_2(mht_2_v, 236, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "num_total_output_bytes");
  ...
  int64_t num_total_write_bytes() const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_3(mht_3_v, 243, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "num_total_write_bytes");

    return num_total_output_bytes() + internal_write_bytes;
  }
  int64_t num_bytes_accessed() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_4(mht_4_v, 249, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "num_bytes_accessed");
...
class OpLevelCostEstimator {
 public:
  ...
  virtual ~OpLevelCostEstimator() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_5(mht_5_v, 278, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "~OpLevelCostEstimator");
}
 ...
 protected:
  ...
  static double SafeDiv(const double lhs, const double rhs) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_level_cost_estimatorDTh mht_6(mht_6_v, 382, "", "./tensorflow/core/grappler/costs/op_level_cost_estimator.h", "SafeDiv");
