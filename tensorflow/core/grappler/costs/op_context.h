...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_contextDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_contextDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_contextDTh() {
      // Check if tracing is enabled
...
struct OpContext {
  ...
  OpContext() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSop_contextDTh mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/costs/op_context.h", "OpContext");
