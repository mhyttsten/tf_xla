...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSmeasuring_cost_estimatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSmeasuring_cost_estimatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSmeasuring_cost_estimatorDTh() {
      // Check if tracing is enabled
...
class MeasuringCostEstimator : public CostEstimator {
 public:
  ...
  ~MeasuringCostEstimator() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSmeasuring_cost_estimatorDTh mht_0(mht_0_v, 220, "", "./tensorflow/core/grappler/costs/measuring_cost_estimator.h", "~MeasuringCostEstimator");
}
