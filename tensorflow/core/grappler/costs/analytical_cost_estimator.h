...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSanalytical_cost_estimatorDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSanalytical_cost_estimatorDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSanalytical_cost_estimatorDTh() {
      // Check if tracing is enabled
...
class AnalyticalCostEstimator : public CostEstimator {
 public:
  ...
  ~AnalyticalCostEstimator() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSanalytical_cost_estimatorDTh mht_0(mht_0_v, 225, "", "./tensorflow/core/grappler/costs/analytical_cost_estimator.h", "~AnalyticalCostEstimator");
}
  ...
  const VirtualScheduler* GetScheduler() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSanalytical_cost_estimatorDTh mht_1(mht_1_v, 239, "", "./tensorflow/core/grappler/costs/analytical_cost_estimator.h", "GetScheduler");
