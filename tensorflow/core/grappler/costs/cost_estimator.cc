...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPScost_estimatorDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPScost_estimatorDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPScost_estimatorDTcc() {
      // Check if tracing is enabled
...
Costs CombineCosts(const Costs& left, const Costs& right) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPScost_estimatorDTcc mht_0(mht_0_v, 190, "", "./tensorflow/core/grappler/costs/cost_estimator.cc", "CombineCosts");
...
Costs MultiplyCosts(const Costs& costs, int multiplier) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPScost_estimatorDTcc mht_1(mht_1_v, 230, "", "./tensorflow/core/grappler/costs/cost_estimator.cc", "MultiplyCosts");
