...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSrobust_stats_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSrobust_stats_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSrobust_stats_testDTcc() {
      // Check if tracing is enabled
...
class RobustStatsTest : public ::testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPScostsPSrobust_stats_testDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/grappler/costs/robust_stats_test.cc", "SetUp");
