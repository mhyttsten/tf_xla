...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSinputsPSutils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSinputsPSutils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSinputsPSutils_testDTcc() {
      // Check if tracing is enabled
...
class UtilsTest : public ::testing::Test {
 protected:
  string BaseDir() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSinputsPSutils_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/grappler/inputs/utils_test.cc", "BaseDir");
 return io::JoinPath(testing::TmpDir(), "base_dir"); }

  void SetUp() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSinputsPSutils_testDTcc mht_1(mht_1_v, 201, "", "./tensorflow/core/grappler/inputs/utils_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSinputsPSutils_testDTcc mht_2(mht_2_v, 230, "", "./tensorflow/core/grappler/inputs/utils_test.cc", "TearDown");
