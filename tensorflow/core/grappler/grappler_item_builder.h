...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTh() {
      // Check if tracing is enabled
...
struct ItemConfig {
  ItemConfig() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTh mht_0(mht_0_v, 202, "", "./tensorflow/core/grappler/grappler_item_builder.h", "ItemConfig");
}
