...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc() {
      // Check if tracing is enabled
...
inline void SortAndRemoveDuplicates(T* v) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/grappler/graph_topology_view.cc", "SortAndRemoveDuplicates");
...
Status GraphTopologyView::InitializeFromGraph(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::InitializeFromGraph");
...
Status GraphTopologyView::InitializeFromGraph(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_2(mht_2_v, 320, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::InitializeFromGraph");
...
Status GraphTopologyView::InitializeFromGraph(const GraphDef& graph,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_3(mht_3_v, 329, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::InitializeFromGraph");
...
Status GraphTopologyView::InitializeFromGraph(const GraphDef& graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_4(mht_4_v, 337, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::InitializeFromGraph");
...
bool GraphTopologyView::HasNode(const absl::string_view node_name) const {
   ...
   mht_5_v.push_back("node_name: \"" + std::string(node_name.data(), node_name.size()) + "\"");
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_5(mht_5_v, 346, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::HasNode");
...
const NodeDef* GraphTopologyView::GetNode(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_6(mht_6_v, 357, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::GetNode");
...
const NodeDef* GraphTopologyView::GetNode(int node_idx) const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_7(mht_7_v, 366, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::GetNode");
...
const absl::optional<int> GraphTopologyView::GetNodeIndex(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_8(mht_8_v, 377, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::GetNodeIndex");
...
const absl::optional<int> GraphTopologyView::GetNodeIndex(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTcc mht_9(mht_9_v, 389, "", "./tensorflow/core/grappler/graph_topology_view.cc", "GraphTopologyView::GetNodeIndex");
