...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc() {
      // Check if tracing is enabled
...
void InitializeTensor(DataType type, Tensor* tensor) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc mht_0(mht_0_v, 224, "", "./tensorflow/core/grappler/grappler_item_builder.cc", "InitializeTensor");
...
Status PruneGraph(GrapplerItem* item) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc mht_1(mht_1_v, 253, "", "./tensorflow/core/grappler/grappler_item_builder.cc", "PruneGraph");
...
Status ReplaceUnknownShapeDim(const ItemConfig& cfg,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc mht_2(mht_2_v, 270, "", "./tensorflow/core/grappler/grappler_item_builder.cc", "ReplaceUnknownShapeDim");
...
Status UpdatePlaceholderShape(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc mht_3(mht_3_v, 297, "", "./tensorflow/core/grappler/grappler_item_builder.cc", "UpdatePlaceholderShape");
...
Status RuntimeGraphOptimizer(const GraphDef& graph_def_arg,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgrappler_item_builderDTcc mht_4(mht_4_v, 389, "", "./tensorflow/core/grappler/grappler_item_builder.cc", "RuntimeGraphOptimizer");
