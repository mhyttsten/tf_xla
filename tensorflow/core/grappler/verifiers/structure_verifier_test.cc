...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifier_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifier_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifier_testDTcc() {
      // Check if tracing is enabled
...
class StructureVerifierTest : public ::testing::Test {
 protected:
  StructureVerifierTest() {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifier_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/grappler/verifiers/structure_verifier_test.cc", "StructureVerifierTest");
 verifier_.reset(new StructureVerifier()); }
  void SetGraph(const string& gdef_ascii) {
   std::vector<std::string> mht_1_v;
   mht_1_v.push_back("gdef_ascii: \"" + gdef_ascii + "\"");
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifier_testDTcc mht_1(mht_1_v, 211, "", "./tensorflow/core/grappler/verifiers/structure_verifier_test.cc", "SetGraph");
...
Status Scalars(shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifier_testDTcc mht_2(mht_2_v, 221, "", "./tensorflow/core/grappler/verifiers/structure_verifier_test.cc", "Scalars");
