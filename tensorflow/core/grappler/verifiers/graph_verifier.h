...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSgraph_verifierDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSgraph_verifierDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSgraph_verifierDTh() {
      // Check if tracing is enabled
...
class GraphVerifier {
 public:
  GraphVerifier() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSgraph_verifierDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/grappler/verifiers/graph_verifier.h", "GraphVerifier");
}
  virtual ~GraphVerifier() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSgraph_verifierDTh mht_1(mht_1_v, 213, "", "./tensorflow/core/grappler/verifiers/graph_verifier.h", "~GraphVerifier");
}
