...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifierDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifierDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifierDTcc() {
      // Check if tracing is enabled
...
Status StructureVerifier::Verify(const GraphDef& graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSverifiersPSstructure_verifierDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/grappler/verifiers/structure_verifier.cc", "StructureVerifier::Verify");
