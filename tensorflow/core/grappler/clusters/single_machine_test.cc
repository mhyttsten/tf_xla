...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc() {
      // Check if tracing is enabled
...
class SingleMachineTest : public ::testing::Test {
 public:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/grappler/clusters/single_machine_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc mht_1(mht_1_v, 230, "", "./tensorflow/core/grappler/clusters/single_machine_test.cc", "TearDown");
...
static void RunInfiniteTFLoop() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc mht_2(mht_2_v, 429, "", "./tensorflow/core/grappler/clusters/single_machine_test.cc", "RunInfiniteTFLoop");
...
inline void SetNodeAttr(const string& key, const T& value, NodeDef* node) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc mht_3(mht_3_v, 573, "", "./tensorflow/core/grappler/clusters/single_machine_test.cc", "SetNodeAttr");
...
inline void SetNodeAttr(const string& key, const Tensor& tensor,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc mht_4(mht_4_v, 585, "", "./tensorflow/core/grappler/clusters/single_machine_test.cc", "SetNodeAttr");
...
GrapplerItem CreateGrapplerItemWithResourceMemory() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machine_testDTcc mht_5(mht_5_v, 691, "", "./tensorflow/core/grappler/clusters/single_machine_test.cc", "CreateGrapplerItemWithResourceMemory");
