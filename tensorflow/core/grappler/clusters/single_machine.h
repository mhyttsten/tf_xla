...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machineDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machineDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machineDTh() {
      // Check if tracing is enabled
...
class SingleMachine : public Cluster {
 public:
  ...
  string type() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machineDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/grappler/clusters/single_machine.h", "type");
 return "single_machine"; }
  ...
  const DeviceSet* GetDeviceSet() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSsingle_machineDTh mht_1(mht_1_v, 218, "", "./tensorflow/core/grappler/clusters/single_machine.h", "GetDeviceSet");
