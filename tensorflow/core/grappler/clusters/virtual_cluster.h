...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSvirtual_clusterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSvirtual_clusterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSvirtual_clusterDTh() {
      // Check if tracing is enabled
...
class VirtualCluster : public Cluster {
 public:
  ...
  string type() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSvirtual_clusterDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/grappler/clusters/virtual_cluster.h", "type");
 return "virtual"; }
  ...
  const DeviceSet* GetDeviceSet() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSclustersPSvirtual_clusterDTh mht_1(mht_1_v, 225, "", "./tensorflow/core/grappler/clusters/virtual_cluster.h", "GetDeviceSet");
 return device_set_; }
