...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc() {
      // Check if tracing is enabled
...
GrapplerItem ConditionalAdd() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc mht_0(mht_0_v, 1408, "", "./tensorflow/core/grappler/optimizers/function_optimizer_test.cc", "ConditionalAdd");
...
TEST_F(FunctionOptimizerTest, InlineIndirectFunctionWithFunctionalControlFlow) {
  ...
  const auto count_nodes_with_op = [&](const string& op) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc mht_1(mht_1_v, 1484, "", "./tensorflow/core/grappler/optimizers/function_optimizer_test.cc", "lambda");
  ...
  const auto feed_args = [&](bool is_add) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc mht_2(mht_2_v, 1506, "", "./tensorflow/core/grappler/optimizers/function_optimizer_test.cc", "lambda");
...
TEST_F(FunctionOptimizerTest, InlineIndirectFunctionDontLowerControlFlow) {
  ...
  const auto count_nodes_with_op = [&](const string& op) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc mht_3(mht_3_v, 1554, "", "./tensorflow/core/grappler/optimizers/function_optimizer_test.cc", "lambda");
  ...
  const auto feed_args = [&](bool is_add) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizer_testDTcc mht_4(mht_4_v, 1576, "", "./tensorflow/core/grappler/optimizers/function_optimizer_test.cc", "lambda");
