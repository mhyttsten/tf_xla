...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelizationDTcc() {
      // Check if tracing is enabled
...
NodeDef MakeParallelMap(const string& name, MutableGraphView* graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelizationDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/optimizers/data/map_parallelization.cc", "MakeParallelMap");
...
Status MapParallelization::OptimizeAndCollectStats(Cluster* cluster,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelizationDTcc mht_1(mht_1_v, 233, "", "./tensorflow/core/grappler/optimizers/data/map_parallelization.cc", "MapParallelization::OptimizeAndCollectStats");
