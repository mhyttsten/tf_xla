...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descent_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descent_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descent_testDTcc() {
      // Check if tracing is enabled
...
Status OptimizeWithEnableGradientDescent(const GrapplerItem &item,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descent_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/grappler/optimizers/data/enable_gradient_descent_test.cc", "OptimizeWithEnableGradientDescent");
