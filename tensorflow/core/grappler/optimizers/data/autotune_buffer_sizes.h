...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSautotune_buffer_sizesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSautotune_buffer_sizesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSautotune_buffer_sizesDTh() {
      // Check if tracing is enabled
...
class AutotuneBufferSizes : public TFDataOptimizerBase {
 public:
  ...
  string name() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSautotune_buffer_sizesDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/grappler/optimizers/data/autotune_buffer_sizes.h", "name");
 return "autotune_buffer_sizes"; };

  bool UsesFunctionLibrary() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSautotune_buffer_sizesDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/grappler/optimizers/data/autotune_buffer_sizes.h", "UsesFunctionLibrary");
 return false; }

  Status Init(
      const tensorflow::RewriterConfig_CustomGraphOptimizer* config) override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSautotune_buffer_sizesDTh mht_2(mht_2_v, 221, "", "./tensorflow/core/grappler/optimizers/data/autotune_buffer_sizes.h", "Init");
