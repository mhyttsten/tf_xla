...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_parallelizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_parallelizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_parallelizationDTcc() {
      // Check if tracing is enabled
...
NodeDef MakeParallelFilter(const string& name, MutableGraphView* graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_parallelizationDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/optimizers/data/filter_parallelization.cc", "MakeParallelFilter");
...
Status FilterParallelization::OptimizeAndCollectStats(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_parallelizationDTcc mht_1(mht_1_v, 232, "", "./tensorflow/core/grappler/optimizers/data/filter_parallelization.cc", "FilterParallelization::OptimizeAndCollectStats");
