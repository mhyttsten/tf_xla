...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_fusionDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_fusionDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_fusionDTcc() {
      // Check if tracing is enabled
...
NodeDef MakeFusedFilterNode(const NodeDef& first_filter_node,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_fusionDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/grappler/optimizers/data/filter_fusion.cc", "MakeFusedFilterNode");
...
Status FilterFusion::OptimizeAndCollectStats(Cluster* cluster,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSfilter_fusionDTcc mht_1(mht_1_v, 238, "", "./tensorflow/core/grappler/optimizers/data/filter_fusion.cc", "FilterFusion::OptimizeAndCollectStats");
