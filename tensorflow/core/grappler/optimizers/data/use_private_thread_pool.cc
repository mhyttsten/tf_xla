...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSuse_private_thread_poolDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSuse_private_thread_poolDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSuse_private_thread_poolDTcc() {
      // Check if tracing is enabled
...
Status UsePrivateThreadPool::OptimizeAndCollectStats(Cluster* cluster,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSuse_private_thread_poolDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/grappler/optimizers/data/use_private_thread_pool.cc", "UsePrivateThreadPool::OptimizeAndCollectStats");
