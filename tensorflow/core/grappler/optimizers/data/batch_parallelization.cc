...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSbatch_parallelizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSbatch_parallelizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSbatch_parallelizationDTcc() {
      // Check if tracing is enabled
...
NodeDef MakeParallelBatch(const string& name, MutableGraphView* graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSbatch_parallelizationDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/optimizers/data/batch_parallelization.cc", "MakeParallelBatch");
...
Status BatchParallelization::OptimizeAndCollectStats(Cluster* cluster,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSbatch_parallelizationDTcc mht_1(mht_1_v, 234, "", "./tensorflow/core/grappler/optimizers/data/batch_parallelization.cc", "BatchParallelization::OptimizeAndCollectStats");
