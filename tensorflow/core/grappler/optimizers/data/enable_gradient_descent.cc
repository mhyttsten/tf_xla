...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descentDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descentDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descentDTcc() {
      // Check if tracing is enabled
...
Status EnableGradientDescent::OptimizeAndCollectStats(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSenable_gradient_descentDTcc mht_0(mht_0_v, 211, "", "./tensorflow/core/grappler/optimizers/data/enable_gradient_descent.cc", "EnableGradientDescent::OptimizeAndCollectStats");
