...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSdisable_intra_op_parallelismDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSdisable_intra_op_parallelismDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSdisable_intra_op_parallelismDTcc() {
      // Check if tracing is enabled
...
Status DisableIntraOpParallelism::OptimizeAndCollectStats(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSdisable_intra_op_parallelismDTcc mht_0(mht_0_v, 213, "", "./tensorflow/core/grappler/optimizers/data/disable_intra_op_parallelism.cc", "DisableIntraOpParallelism::OptimizeAndCollectStats");
