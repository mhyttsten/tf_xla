...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelization_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelization_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelization_testDTcc() {
      // Check if tracing is enabled
...
Status OptimizeWithMapParallelization(const GrapplerItem& item,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmap_parallelization_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/grappler/optimizers/data/map_parallelization_test.cc", "OptimizeWithMapParallelization");
