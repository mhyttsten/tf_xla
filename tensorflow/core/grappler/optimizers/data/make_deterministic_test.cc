...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmake_deterministic_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmake_deterministic_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmake_deterministic_testDTcc() {
      // Check if tracing is enabled
...
FunctionDef OuterXTimesTwo() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmake_deterministic_testDTcc mht_0(mht_0_v, 383, "", "./tensorflow/core/grappler/optimizers/data/make_deterministic_test.cc", "OuterXTimesTwo");
...
FunctionDef OuterRandomUniform() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmake_deterministic_testDTcc mht_1(mht_1_v, 406, "", "./tensorflow/core/grappler/optimizers/data/make_deterministic_test.cc", "OuterRandomUniform");
...
FunctionDef OuterReadResourceVariable() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSmake_deterministic_testDTcc mht_2(mht_2_v, 429, "", "./tensorflow/core/grappler/optimizers/data/make_deterministic_test.cc", "OuterReadResourceVariable");
