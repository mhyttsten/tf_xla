...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSinject_prefetch_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSinject_prefetch_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSinject_prefetch_testDTcc() {
      // Check if tracing is enabled
...
Status Optimize(InjectPrefetch &optimizer, const GrapplerItem &item,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSinject_prefetch_testDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/optimizers/data/inject_prefetch_test.cc", "Optimize");
...
Status OptimizeWithInjectPrefetch(const GrapplerItem &item, GraphDef *output,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSinject_prefetch_testDTcc mht_1(mht_1_v, 222, "", "./tensorflow/core/grappler/optimizers/data/inject_prefetch_test.cc", "OptimizeWithInjectPrefetch");
...
Status OptimizeWithInjectPrefetchEligible(const GrapplerItem &item,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdataPSinject_prefetch_testDTcc mht_2(mht_2_v, 231, "", "./tensorflow/core/grappler/optimizers/data/inject_prefetch_test.cc", "OptimizeWithInjectPrefetchEligible");
