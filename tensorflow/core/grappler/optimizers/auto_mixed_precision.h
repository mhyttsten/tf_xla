...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh() {
      // Check if tracing is enabled
...
class AutoMixedPrecision : public GraphOptimizer {
 public:
  ...
  explicit AutoMixedPrecision(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/grappler/optimizers/auto_mixed_precision.h", "AutoMixedPrecision");
}

  ~AutoMixedPrecision() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh mht_1(mht_1_v, 214, "", "./tensorflow/core/grappler/optimizers/auto_mixed_precision.h", "~AutoMixedPrecision");
}

  string name() const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh mht_2(mht_2_v, 219, "", "./tensorflow/core/grappler/optimizers/auto_mixed_precision.h", "name");
  ...
  bool UsesFunctionLibrary() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSauto_mixed_precisionDTh mht_3(mht_3_v, 236, "", "./tensorflow/core/grappler/optimizers/auto_mixed_precision.h", "UsesFunctionLibrary");
 return false; }
