...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hookDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hookDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hookDTh() {
      // Check if tracing is enabled
...
class TFGGrapplerOptimizer : public tensorflow::grappler::GraphOptimizer {
 public:
  ...
  bool UsesFunctionLibrary() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hookDTh mht_0(mht_0_v, 216, "", "./tensorflow/core/grappler/optimizers/tfg_optimizer_hook.h", "UsesFunctionLibrary");
 return true; }
