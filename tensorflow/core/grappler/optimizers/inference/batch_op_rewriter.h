...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSinferencePSbatch_op_rewriterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSinferencePSbatch_op_rewriterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSinferencePSbatch_op_rewriterDTh() {
      // Check if tracing is enabled
...
class BatchOpRewriter : public ::tensorflow::grappler::CustomGraphOptimizer {
 public:
  ...
  std::string name() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSinferencePSbatch_op_rewriterDTh mht_0(mht_0_v, 218, "", "./tensorflow/core/grappler/optimizers/inference/batch_op_rewriter.h", "name");
 return "batch_op_rewriter"; }

  bool UsesFunctionLibrary() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSinferencePSbatch_op_rewriterDTh mht_1(mht_1_v, 223, "", "./tensorflow/core/grappler/optimizers/inference/batch_op_rewriter.h", "UsesFunctionLibrary");
 return false; }
