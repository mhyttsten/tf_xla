...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc() {
      // Check if tracing is enabled
...
bool RemoveControlInput(NodeDef* node, const string& control_input_to_remove,
   ...
   mht_0_v.push_back("control_input_to_remove: \"" + control_input_to_remove + "\"");
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_0(mht_0_v, 213, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "RemoveControlInput");
...
bool DependencyOptimizer::SafeToRemoveIdentity(const NodeDef& node) const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_1(mht_1_v, 232, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::SafeToRemoveIdentity");
...
bool DependencyOptimizer::SafeToConvertToNoOp(const NodeDef& node) const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_2(mht_2_v, 278, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::SafeToConvertToNoOp");
...
int DependencyOptimizer::NumEdgesIfBypassed(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_3(mht_3_v, 338, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::NumEdgesIfBypassed");
...
bool DependencyOptimizer::BypassingNodeIsBeneficial(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_4(mht_4_v, 379, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::BypassingNodeIsBeneficial");
...
void DependencyOptimizer::OptimizeNode(int node_idx,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_5(mht_5_v, 441, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::OptimizeNode");
...
void DependencyOptimizer::CleanControlInputs() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_6(mht_6_v, 656, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::CleanControlInputs");
...
Status DependencyOptimizer::OptimizeDependencies() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_7(mht_7_v, 665, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::OptimizeDependencies");
...
void LongestPathsLowerBounds(
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_8(mht_8_v, 704, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "LongestPathsLowerBounds");
...
Status DependencyOptimizer::TransitiveReduction() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_9(mht_9_v, 731, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::TransitiveReduction");
...
void DependencyOptimizer::BuildNodeToIdx() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_10(mht_10_v, 831, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::BuildNodeToIdx");
...
void DependencyOptimizer::GroupCrossDeviceControlEdges(bool host_granularity) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_11(mht_11_v, 850, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::GroupCrossDeviceControlEdges");
...
Status DependencyOptimizer::Optimize(Cluster* cluster, const GrapplerItem& item,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizerDTcc mht_12(mht_12_v, 956, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer.cc", "DependencyOptimizer::Optimize");
