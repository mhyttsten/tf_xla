...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc() {
      // Check if tracing is enabled
...
class ScopedAllocatorOptimizerTest : public ::testing::Test {
  ...
  */
  void BuildAbsGraph(GraphDef* graph_def, bool forward) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_0(mht_0_v, 252, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "BuildAbsGraph");
  ...
  */
  void BuildAbsGraphWithInputDependencies(GraphDef* graph_def) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_1(mht_1_v, 305, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "BuildAbsGraphWithInputDependencies");
  ...
  */
  void BuildAbsGraphWithInputAndOutputControlEdges(GraphDef* graph_def) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_2(mht_2_v, 343, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "BuildAbsGraphWithInputAndOutputControlEdges");
  ...
  */
  void BuildGraphWithMultipleScopes(GraphDef* graph_def) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_3(mht_3_v, 389, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "BuildGraphWithMultipleScopes");
  ...
  */
  void BuildConstGraph(GraphDef* graph_def, bool forward) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_4(mht_4_v, 436, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "BuildConstGraph");
  ...
  void SetShapes(GraphDef* graph_def) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_5(mht_5_v, 454, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "SetShapes");
  ...
  void ExecuteGraph(const GraphDef& graph_def,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_6(mht_6_v, 473, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "ExecuteGraph");
  ...
  void ValidateValues(const std::vector<Tensor>& outputs,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_7(mht_7_v, 502, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "ValidateValues");
  ...
  void GetNode(NodeMap* node_map, const string& node_name, NodeDef** node_def) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_8(mht_8_v, 515, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "GetNode");
  ...
  NodeDef* ValidateSAControlInput(GraphDef* graph, NodeMap* node_map,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_9(mht_9_v, 527, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "ValidateSAControlInput");
  ...
  int NumControlInputs(NodeMap* node_map, const string& node_name) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSscoped_allocator_optimizer_testDTcc mht_10(mht_10_v, 549, "", "./tensorflow/core/grappler/optimizers/scoped_allocator_optimizer_test.cc", "NumControlInputs");
