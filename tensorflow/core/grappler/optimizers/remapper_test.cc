...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc() {
      // Check if tracing is enabled
...
class RemapperTest : public GrapplerTest {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "SetUp");
...
class RemapperFuseSoftplusTanhMul : public RemapperTest {
 public:
  ...
  void RunTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_1(mht_1_v, 1385, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "RunTest");
...
class RemapperTensorToHashBucketTest : public RemapperTest {
 public:
  ...
  void RunTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_2(mht_2_v, 1463, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "RunTest");
...
class RemapperFuseMatMulWithBiasTest : public RemapperTest {
 public:
  ...
  void RunTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_3(mht_3_v, 1534, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "RunTest");
...
class RemapperFuseMatMulWithBiasAndActivationTest : public RemapperTest {
 public:
  ...
  void RunTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_4(mht_4_v, 1688, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "RunTest");
...
class RemapperFusePadConv3D : public RemapperTest {
 public:
  ...
  void RunTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_5(mht_5_v, 2330, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "RunTest");
...
class RemapperFusePadWithFusedConv3D : public RemapperTest {
 public:
  ...
  void RunTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSremapper_testDTcc mht_6(mht_6_v, 2410, "", "./tensorflow/core/grappler/optimizers/remapper_test.cc", "RunTest");
