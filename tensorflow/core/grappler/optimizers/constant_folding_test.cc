...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc() {
      // Check if tracing is enabled
...
class ConstantFoldingTest : public GrapplerTest {
 protected:
  ...
  void SimpleNeutralElementTest() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "SimpleNeutralElementTest");
  ...
  void MulConvPushDownTest(const TensorShape& input_shape,
   ...
   mht_1_v.push_back("padding: \"" + (padding == nullptr ? std::string("nullptr") : std::string((char*)padding)) + "\"");
   mht_1_v.push_back("data_format: \"" + (data_format == nullptr ? std::string("nullptr") : std::string((char*)data_format)) + "\"");
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_1(mht_1_v, 308, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "MulConvPushDownTest");
  ...
  void PaddingWithZeroSize() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_2(mht_2_v, 402, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "PaddingWithZeroSize");
...
TEST_F(ConstantFoldingTest, PartialFolding_AssociativeAndCommutative) {
  std::function<Output(const Scope&, InputList)> addn_fun =
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_3(mht_3_v, 3595, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "lambda");
  ...
  std::function<Output(const Scope&, InputList)> accumulate_fun =
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_4(mht_4_v, 3602, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "lambda");
...
class ConstantFoldingCastConstTest : public GrapplerTest {
 protected:
  void ConstantFoldingCastConst(bool fetch_const, bool fetch_cast,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_5(mht_5_v, 4089, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "ConstantFoldingCastConst");
 ...
 private:
  void CreateCastConstGraph(const tensorflow::Scope& s) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_6(mht_6_v, 4112, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "CreateCastConstGraph");
  ...
  int SetFetch(GrapplerItem* item, bool fetch_const, bool fetch_cast,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_7(mht_7_v, 4123, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "SetFetch");
  ...
  GraphDef ConstantFoldingOptimize(const GrapplerItem& item) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_8(mht_8_v, 4147, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "ConstantFoldingOptimize");
  ...
  void EvaluateAndCompareUnoptimized(const GraphDef& unoptimized_graph,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSconstant_folding_testDTcc mht_9(mht_9_v, 4160, "", "./tensorflow/core/grappler/optimizers/constant_folding_test.cc", "EvaluateAndCompareUnoptimized");
