...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factoryDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factoryDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factoryDTh() {
      // Check if tracing is enabled
...
class TransposerFactory {
 public:
  explicit TransposerFactory() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factoryDTh mht_0(mht_0_v, 198, "", "./tensorflow/core/grappler/optimizers/generic_layout_optimizer_transposer_factory.h", "TransposerFactory");
}
