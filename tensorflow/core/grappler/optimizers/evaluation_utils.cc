...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc() {
      // Check if tracing is enabled
...
DeviceSimple::DeviceSimple() : DeviceBase(Env::Default()) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/grappler/optimizers/evaluation_utils.cc", "DeviceSimple::DeviceSimple");
...
DeviceSimple::~DeviceSimple() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc mht_1(mht_1_v, 217, "", "./tensorflow/core/grappler/optimizers/evaluation_utils.cc", "DeviceSimple::~DeviceSimple");
...
Status DeviceSimple::MakeTensorFromProto(const TensorProto& tensor_proto,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc mht_2(mht_2_v, 227, "", "./tensorflow/core/grappler/optimizers/evaluation_utils.cc", "DeviceSimple::MakeTensorFromProto");
...
Status EvaluateNode(const NodeDef& node, const TensorVector& inputs,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSevaluation_utilsDTcc mht_3(mht_3_v, 241, "", "./tensorflow/core/grappler/optimizers/evaluation_utils.cc", "EvaluateNode");
