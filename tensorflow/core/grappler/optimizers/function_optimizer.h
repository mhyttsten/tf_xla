...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizerDTh() {
      // Check if tracing is enabled
...
class FunctionOptimizer : public GraphOptimizer {
 public:
  explicit FunctionOptimizer(RewriterConfig::Toggle opt_level,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizerDTh mht_0(mht_0_v, 200, "", "./tensorflow/core/grappler/optimizers/function_optimizer.h", "FunctionOptimizer");
}
  ~FunctionOptimizer() override = default;

  string name() const override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizerDTh mht_1(mht_1_v, 206, "", "./tensorflow/core/grappler/optimizers/function_optimizer.h", "name");
 return "function_optimizer"; };

  bool UsesFunctionLibrary() const override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSfunction_optimizerDTh mht_2(mht_2_v, 211, "", "./tensorflow/core/grappler/optimizers/function_optimizer.h", "UsesFunctionLibrary");
 return true; }
