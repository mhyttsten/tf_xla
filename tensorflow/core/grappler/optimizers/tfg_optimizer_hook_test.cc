...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hook_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hook_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hook_testDTcc() {
      // Check if tracing is enabled
...
class TestPass : public PassWrapper<TestPass, OperationPass<GraphOp>> {
  StringRef getArgument() const override {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hook_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/grappler/optimizers/tfg_optimizer_hook_test.cc", "getArgument");
 return "grappler-hook-test-pass"; }
  void runOnOperation() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPStfg_optimizer_hook_testDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/grappler/optimizers/tfg_optimizer_hook_test.cc", "runOnOperation");
