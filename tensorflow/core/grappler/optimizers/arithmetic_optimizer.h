...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh() {
      // Check if tracing is enabled
...
class ArithmeticOptimizer : public GraphOptimizer {
 public:
  ArithmeticOptimizer()
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer.h", "ArithmeticOptimizer");
}
  ...
  explicit ArithmeticOptimizer(RewriterConfig::Toggle opt_level)
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh mht_1(mht_1_v, 214, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer.h", "ArithmeticOptimizer");
}

  ~ArithmeticOptimizer() override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh mht_2(mht_2_v, 219, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer.h", "~ArithmeticOptimizer");
}

  string name() const override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh mht_3(mht_3_v, 224, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer.h", "name");
 return "arithmetic_optimizer"; };

  bool UsesFunctionLibrary() const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh mht_4(mht_4_v, 229, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer.h", "UsesFunctionLibrary");
 return false; }
 ...
 private:
  ...
  struct ArithmeticOptimizerOptions {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizerDTh mht_5(mht_5_v, 279, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer.h", "Default");
