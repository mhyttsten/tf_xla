...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizer_testDTcc() {
      // Check if tracing is enabled
...
void VerifyGraphsEqual(const GraphDef& original_graph,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdependency_optimizer_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/grappler/optimizers/dependency_optimizer_test.cc", "VerifyGraphsEqual");
