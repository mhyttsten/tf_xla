...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factory_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factory_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factory_testDTcc() {
      // Check if tracing is enabled
...
void CheckSameTransposerForOps(absl::Span<const string> ops,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSgeneric_layout_optimizer_transposer_factory_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/grappler/optimizers/generic_layout_optimizer_transposer_factory_test.cc", "CheckSameTransposerForOps");
