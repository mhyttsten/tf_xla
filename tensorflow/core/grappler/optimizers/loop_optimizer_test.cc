...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc() {
      // Check if tracing is enabled
...
class LoopOptimizerTest : public GrapplerTest {
 protected:
  ...
  void AddEnterNode(const string& name, const string& frame,
   ...
   mht_0_v.push_back("frame: \"" + frame + "\"");
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/grappler/optimizers/loop_optimizer_test.cc", "AddEnterNode");
  ...
  void AddSimpleNode(const string& name, const string& op,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc mht_1(mht_1_v, 231, "", "./tensorflow/core/grappler/optimizers/loop_optimizer_test.cc", "AddSimpleNode");
  ...
  void EnableOnlyLoopInvariantNodeMotion(LoopOptimizer* optimizer) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc mht_2(mht_2_v, 242, "", "./tensorflow/core/grappler/optimizers/loop_optimizer_test.cc", "EnableOnlyLoopInvariantNodeMotion");
  ...
  void EnableOnlyStackPushRemoval(LoopOptimizer* optimizer) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc mht_3(mht_3_v, 250, "", "./tensorflow/core/grappler/optimizers/loop_optimizer_test.cc", "EnableOnlyStackPushRemoval");
 ...
 private:
  void DisableAllStages(LoopOptimizer* optimizer) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc mht_4(mht_4_v, 259, "", "./tensorflow/core/grappler/optimizers/loop_optimizer_test.cc", "DisableAllStages");
...
void VerifyGraphsEqual(const GraphDef& original_graph,
   ...
   mht_5_v.push_back("func: \"" + func + "\"");
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSloop_optimizer_testDTcc mht_5(mht_5_v, 806, "", "./tensorflow/core/grappler/optimizers/loop_optimizer_test.cc", "VerifyGraphsEqual");
