...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc() {
      // Check if tracing is enabled
...
string HoistMulName(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc mht_0(mht_0_v, 227, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer_test.cc", "HoistMulName");
...
string HoistDivName(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc mht_1(mht_1_v, 236, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer_test.cc", "HoistDivName");
...
string HoistAddName(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc mht_2(mht_2_v, 245, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer_test.cc", "HoistAddName");
...
string AggregationConstName(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc mht_3(mht_3_v, 254, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer_test.cc", "AggregationConstName");
...
string AggregationMulName(const string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc mht_4(mht_4_v, 263, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer_test.cc", "AggregationMulName");
...
void VerifyGraphsMatch(const GraphDef& original_graph,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSarithmetic_optimizer_testDTcc mht_5(mht_5_v, 271, "", "./tensorflow/core/grappler/optimizers/arithmetic_optimizer_test.cc", "VerifyGraphsMatch");
