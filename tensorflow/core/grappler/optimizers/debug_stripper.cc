...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdebug_stripperDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdebug_stripperDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdebug_stripperDTcc() {
      // Check if tracing is enabled
...
Status DebugStripper::Optimize(Cluster* cluster, const GrapplerItem& item,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSoptimizersPSdebug_stripperDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/grappler/optimizers/debug_stripper.cc", "DebugStripper::Optimize");
