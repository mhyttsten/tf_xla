...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh() {
      // Check if tracing is enabled
...
class GraphTopologyView {
 public:
  ...
  explicit GraphTopologyView(bool skip_invalid_edges)
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh mht_0(mht_0_v, 220, "", "./tensorflow/core/grappler/graph_topology_view.h", "GraphTopologyView");
}
  ...
  bool is_initialized() const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh mht_1(mht_1_v, 238, "", "./tensorflow/core/grappler/graph_topology_view.h", "is_initialized");
 return graph_ != nullptr; }
  int num_nodes() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh mht_2(mht_2_v, 242, "", "./tensorflow/core/grappler/graph_topology_view.h", "num_nodes");
 return num_nodes_; }
  const GraphDef* graph() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_topology_viewDTh mht_3(mht_3_v, 246, "", "./tensorflow/core/grappler/graph_topology_view.h", "graph");
 return graph_; }
