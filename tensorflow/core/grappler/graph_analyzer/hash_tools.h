...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_analyzerPShash_toolsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_analyzerPShash_toolsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_analyzerPShash_toolsDTh() {
      // Check if tracing is enabled
...
inline void CombineHash(size_t from, size_t* to) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_analyzerPShash_toolsDTh mht_0(mht_0_v, 198, "", "./tensorflow/core/grappler/graph_analyzer/hash_tools.h", "CombineHash");
...
inline void CombineHashCommutative(size_t from, size_t* to) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSgraph_analyzerPShash_toolsDTh mht_1(mht_1_v, 211, "", "./tensorflow/core/grappler/graph_analyzer/hash_tools.h", "CombineHashCommutative");
