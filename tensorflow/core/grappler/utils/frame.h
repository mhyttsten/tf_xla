...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSframeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSframeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSframeDTh() {
      // Check if tracing is enabled
...
class FrameView {
 public:
  FrameView() : is_inferred_(false), num_frames_(0) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSframeDTh mht_0(mht_0_v, 207, "", "./tensorflow/core/grappler/utils/frame.h", "FrameView");
}
  ...
  int num_frames() const {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSframeDTh mht_1(mht_1_v, 229, "", "./tensorflow/core/grappler/utils/frame.h", "num_frames");
 return num_frames_; }
  bool is_inferred() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSframeDTh mht_2(mht_2_v, 233, "", "./tensorflow/core/grappler/utils/frame.h", "is_inferred");
 return is_inferred_; }
