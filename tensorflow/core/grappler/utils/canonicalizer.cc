...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPScanonicalizerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPScanonicalizerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPScanonicalizerDTcc() {
      // Check if tracing is enabled
...
void CanonicalizeNode(NodeDef* node) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPScanonicalizerDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/grappler/utils/canonicalizer.cc", "CanonicalizeNode");
...
void CanonicalizeGraph(GraphDef* graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPScanonicalizerDTcc mht_1(mht_1_v, 221, "", "./tensorflow/core/grappler/utils/canonicalizer.cc", "CanonicalizeGraph");
...
void CompressConstants(GraphDef* graph) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPScanonicalizerDTcc mht_2(mht_2_v, 230, "", "./tensorflow/core/grappler/utils/canonicalizer.cc", "CompressConstants");
