...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSgraph_view_internal_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSgraph_view_internal_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSgraph_view_internal_testDTcc() {
      // Check if tracing is enabled
...
GraphDef SimpleTestGraphForMutation() {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPSgraph_view_internal_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/grappler/utils/graph_view_internal_test.cc", "SimpleTestGraphForMutation");
