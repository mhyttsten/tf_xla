...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc() {
      // Check if tracing is enabled
...
DfsCallbacks MkCallbacks(std::vector<string>* pre_order,
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/grappler/utils/traversal_test.cc", "MkCallbacks");

  return {[pre_order](const NodeDef* n) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc mht_1(mht_1_v, 203, "", "./tensorflow/core/grappler/utils/traversal_test.cc", "lambda");
 pre_order->push_back(n->name()); },
          [post_order](const NodeDef* n) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc mht_2(mht_2_v, 207, "", "./tensorflow/core/grappler/utils/traversal_test.cc", "lambda");
 post_order->push_back(n->name()); },
          [back_edges](const NodeDef* src, const NodeDef* dst) {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc mht_3(mht_3_v, 211, "", "./tensorflow/core/grappler/utils/traversal_test.cc", "lambda");
...
TEST(TraversalTest, DfsWithEnterPredicate) {
  ...
  const auto enter = [](const NodeDef* node) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc mht_4(mht_4_v, 356, "", "./tensorflow/core/grappler/utils/traversal_test.cc", "lambda");
...
TEST(TraversalTest, DfsWithAdvancePredicate) {
  ...
  const auto advance = [](const NodeDef* node) {
   ...
   MHTracer_DTPStensorflowPScorePSgrapplerPSutilsPStraversal_testDTcc mht_5(mht_5_v, 396, "", "./tensorflow/core/grappler/utils/traversal_test.cc", "lambda");
