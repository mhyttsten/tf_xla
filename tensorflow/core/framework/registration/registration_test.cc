...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSregistrationPSregistration_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSregistrationPSregistration_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSregistrationPSregistration_testDTcc() {
      // Check if tracing is enabled
...
InitOnStartupMarker const kUnconditionalInitMarker =
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSregistrationPSregistration_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/framework/registration/registration_test.cc", "lambda");
...
InitOnStartupMarker const kConditionalInitMarker =
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSregistrationPSregistration_testDTcc mht_1(mht_1_v, 225, "", "./tensorflow/core/framework/registration/registration_test.cc", "lambda");
