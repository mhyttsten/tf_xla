...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc() {
      // Check if tracing is enabled
...
static void CanonicalizeAttrTypeListOrder(OpDef* def) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/framework/op_def_builder_test.cc", "CanonicalizeAttrTypeListOrder");
...
class OpDefBuilderTest : public ::testing::Test {
 protected:
  OpDefBuilder b() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_1(mht_1_v, 213, "", "./tensorflow/core/framework/op_def_builder_test.cc", "b");
 return OpDefBuilder("Test"); }

  void ExpectSuccess(const OpDefBuilder& builder, StringPiece proto,
                     OpShapeInferenceFn* shape_fn_out = nullptr) {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_2(mht_2_v, 219, "", "./tensorflow/core/framework/op_def_builder_test.cc", "ExpectSuccess");
  ...
  void ExpectOrdered(const OpDefBuilder& builder, StringPiece proto) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_3(mht_3_v, 242, "", "./tensorflow/core/framework/op_def_builder_test.cc", "ExpectOrdered");
  ...
  void ExpectFailure(const OpDefBuilder& builder, const string& error) {
   ...
   mht_4_v.push_back("error: \"" + error + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_4(mht_4_v, 259, "", "./tensorflow/core/framework/op_def_builder_test.cc", "ExpectFailure");
...
TEST_F(OpDefBuilderTest, SetShapeFn) {
  auto fn = [](shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_5(mht_5_v, 794, "", "./tensorflow/core/framework/op_def_builder_test.cc", "lambda");
...
TEST_F(OpDefBuilderTest, SetShapeFnCalledTwiceFailure) {
  auto fn = [](shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_def_builder_testDTcc mht_6(mht_6_v, 810, "", "./tensorflow/core/framework/op_def_builder_test.cc", "lambda");
