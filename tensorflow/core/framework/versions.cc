...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSversionsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSversionsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSversionsDTcc() {
      // Check if tracing is enabled
...
Status CheckVersions(const VersionDef& versions, int consumer, int min_producer,
   ...
   mht_0_v.push_back("upper_name: \"" + (upper_name == nullptr ? std::string("nullptr") : std::string((char*)upper_name)) + "\"");
   mht_0_v.push_back("lower_name: \"" + (lower_name == nullptr ? std::string("nullptr") : std::string((char*)lower_name)) + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSversionsDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/framework/versions.cc", "CheckVersions");
