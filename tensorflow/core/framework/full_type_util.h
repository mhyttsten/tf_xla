...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSfull_type_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSfull_type_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSfull_type_utilDTh() {
      // Check if tracing is enabled
...
inline bool IsHostMemoryType(const FullTypeDef& t) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSfull_type_utilDTh mht_0(mht_0_v, 257, "", "./tensorflow/core/framework/full_type_util.h", "IsHostMemoryType");
