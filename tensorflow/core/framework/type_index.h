...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh() {
      // Check if tracing is enabled
...
class TypeIndex {
 public:
  TypeIndex(const TypeIndex& src) : hash_(src.hash_), name_(src.name_) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/framework/type_index.h", "TypeIndex");
}
  TypeIndex& operator=(const TypeIndex& src) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_1(mht_1_v, 214, "", "./tensorflow/core/framework/type_index.h", "=");
  ...
  ~TypeIndex() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_2(mht_2_v, 224, "", "./tensorflow/core/framework/type_index.h", "~TypeIndex");
}

  const char* name() const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_3(mht_3_v, 229, "", "./tensorflow/core/framework/type_index.h", "name");
 return name_; }

  uint64 hash_code() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_4(mht_4_v, 234, "", "./tensorflow/core/framework/type_index.h", "hash_code");
 return hash_; }
  ...
  static TypeIndex Make() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_5(mht_5_v, 241, "", "./tensorflow/core/framework/type_index.h", "Make");
...
#warning \
 ...
 private:
  ...
  explicit TypeIndex(const uint64 hash, const char* name)
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStype_indexDTh mht_6(mht_6_v, 276, "", "./tensorflow/core/framework/type_index.h", "TypeIndex");
}
  uint64 hash_;
  const char* name_;
};
