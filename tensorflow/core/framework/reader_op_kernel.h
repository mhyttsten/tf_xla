...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh() {
      // Check if tracing is enabled
...
class ReaderOpKernel : public ResourceOpKernel<ReaderInterface> {
 public:
  ...
  void Compute(OpKernelContext* context) override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh mht_0(mht_0_v, 219, "", "./tensorflow/core/framework/reader_op_kernel.h", "Compute");
 ...
 private:
  virtual bool IsCancellable() const {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh mht_1(mht_1_v, 241, "", "./tensorflow/core/framework/reader_op_kernel.h", "IsCancellable");
 return false; }
  virtual void Cancel() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh mht_2(mht_2_v, 245, "", "./tensorflow/core/framework/reader_op_kernel.h", "Cancel");
}

  Status CreateResource(ReaderInterface** reader)
      TF_EXCLUSIVE_LOCKS_REQUIRED(mu_) override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_op_kernelDTh mht_3(mht_3_v, 251, "", "./tensorflow/core/framework/reader_op_kernel.h", "CreateResource");
