...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSrng_algDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSrng_algDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSrng_algDTh() {
      // Check if tracing is enabled
...
inline int GetCounterSize(Algorithm alg) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSrng_algDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/framework/rng_alg.h", "GetCounterSize");
