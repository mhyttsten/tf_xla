...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSresource_baseDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_baseDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSresource_baseDTh() {
      // Check if tracing is enabled
...
class ResourceBase : public core::WeakRefCounted {
 public:
  ...
  virtual int64_t MemoryUsed() const {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_baseDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/framework/resource_base.h", "MemoryUsed");
 return 0; }
  ...
  virtual Status AsGraphDef(GraphDefBuilder* builder, Node** out) const {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_baseDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/framework/resource_base.h", "AsGraphDef");
