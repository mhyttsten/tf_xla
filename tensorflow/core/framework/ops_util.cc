...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSops_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSops_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSops_utilDTcc() {
      // Check if tracing is enabled
...
Eigen::PaddingType BrainPadding2EigenPadding(Padding padding) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSops_utilDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/framework/ops_util.cc", "BrainPadding2EigenPadding");
...
Status GetBroadcastSize(const int index, const int in_size, const int ksize,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSops_utilDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/framework/ops_util.cc", "GetBroadcastSize");
...
string SanitizeThreadSuffix(string suffix) {
   ...
   mht_2_v.push_back("suffix: \"" + suffix + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSops_utilDTcc mht_2(mht_2_v, 241, "", "./tensorflow/core/framework/ops_util.cc", "SanitizeThreadSuffix");
