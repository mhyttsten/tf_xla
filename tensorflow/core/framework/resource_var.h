...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh() {
      // Check if tracing is enabled
...
class Var : public ResourceBase {
 public:
  explicit Var(DataType dtype) : tensor_(dtype) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh mht_0(mht_0_v, 237, "", "./tensorflow/core/framework/resource_var.h", "Var");
}
  ...
  mutex* mu() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh mht_1(mht_1_v, 245, "", "./tensorflow/core/framework/resource_var.h", "mu");
 return &mu_; }
  Tensor* tensor() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh mht_2(mht_2_v, 249, "", "./tensorflow/core/framework/resource_var.h", "tensor");
 return &tensor_; }
  ...
  void Uninitialize() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh mht_3(mht_3_v, 256, "", "./tensorflow/core/framework/resource_var.h", "Uninitialize");
  ...
  std::string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh mht_4(mht_4_v, 267, "", "./tensorflow/core/framework/resource_var.h", "DebugString");
 ...
 private:
  ...
  ~Var() override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_varDTh mht_5(mht_5_v, 294, "", "./tensorflow/core/framework/resource_var.h", "~Var");
}
