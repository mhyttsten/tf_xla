...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSnode_propertiesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_propertiesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSnode_propertiesDTh() {
      // Check if tracing is enabled
...
struct NodeProperties {
 public:
  NodeProperties(const OpDef* op_def, NodeDef node_def,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_propertiesDTh mht_0(mht_0_v, 204, "", "./tensorflow/core/framework/node_properties.h", "NodeProperties");
}
  ...
  NodeProperties(const OpDef* _op_def, NodeDef&& _node_def,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_propertiesDTh mht_1(mht_1_v, 212, "", "./tensorflow/core/framework/node_properties.h", "NodeProperties");
}
  ...
  NodeProperties(const OpDef* _op_def, NodeDef&& _node_def,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_propertiesDTh mht_2(mht_2_v, 226, "", "./tensorflow/core/framework/node_properties.h", "NodeProperties");
}
