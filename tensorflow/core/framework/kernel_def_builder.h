...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_builderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_builderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_builderDTh() {
      // Check if tracing is enabled
...
KernelDefBuilder& KernelDefBuilder::TypeConstraint(const char* attr_name) {
   ...
   mht_0_v.push_back("attr_name: \"" + (attr_name == nullptr ? std::string("nullptr") : std::string((char*)attr_name)) + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_builderDTh mht_0(mht_0_v, 265, "", "./tensorflow/core/framework/kernel_def_builder.h", "KernelDefBuilder::TypeConstraint");
