...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSbfloat16_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSbfloat16_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSbfloat16_testDTcc() {
      // Check if tracing is enabled
...
void BM_FloatToBFloat16(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSbfloat16_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/core/framework/bfloat16_test.cc", "BM_FloatToBFloat16");
...
void BM_RoundFloatToBFloat16(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSbfloat16_testDTcc mht_1(mht_1_v, 233, "", "./tensorflow/core/framework/bfloat16_test.cc", "BM_RoundFloatToBFloat16");
...
void BM_BFloat16ToFloat(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSbfloat16_testDTcc mht_2(mht_2_v, 257, "", "./tensorflow/core/framework/bfloat16_test.cc", "BM_BFloat16ToFloat");
