...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_utilDTcc() {
      // Check if tracing is enabled
...
bool InTypeList(DataType dt, const AttrValue& type_list) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_utilDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/framework/kernel_def_util.cc", "InTypeList");
...
Status KernelAttrsMatch(const KernelDef& kernel_def, AttrSlice attrs,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_utilDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/framework/kernel_def_util.cc", "KernelAttrsMatch");
