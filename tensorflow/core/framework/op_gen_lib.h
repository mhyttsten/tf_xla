...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSop_gen_libDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_gen_libDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSop_gen_libDTh() {
      // Check if tracing is enabled
...
inline string Spaces(int n) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_gen_libDTh mht_0(mht_0_v, 201, "", "./tensorflow/core/framework/op_gen_lib.h", "Spaces");
 return string(n, ' '); }
