...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSmodel_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodel_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSmodel_testDTcc() {
      // Check if tracing is enabled
...
int64_t CountParametersOnNode(const string& node_name,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodel_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/framework/model_test.cc", "CountParametersOnNode");
...
double weighted_processing_time(int64_t num_elements, double processing_time,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodel_testDTcc mht_1(mht_1_v, 786, "", "./tensorflow/core/framework/model_test.cc", "weighted_processing_time");
