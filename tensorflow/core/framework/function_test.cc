...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc() {
      // Check if tracing is enabled
...
class Attrs {
 public:
  Attrs(const std::initializer_list<  // NOLINT(runtime/explicit)
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_0(mht_0_v, 211, "", "./tensorflow/core/framework/function_test.cc", "Attrs");
  ...
  operator AttrSlice() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_1(mht_1_v, 220, "", "./tensorflow/core/framework/function_test.cc", "AttrSlice");
...
Status GetOpSig(const string& op, const OpDef** sig) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_2(mht_2_v, 232, "", "./tensorflow/core/framework/function_test.cc", "GetOpSig");
...
static void HasError(const Status& s, const string& substr) {
   ...
   mht_3_v.push_back("substr: \"" + substr + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_3(mht_3_v, 800, "", "./tensorflow/core/framework/function_test.cc", "HasError");
...
GradientDef MakeGradDef(const string& f, const string& g) {
   ...
   mht_4_v.push_back("f: \"" + f + "\"");
   mht_4_v.push_back("g: \"" + g + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_4(mht_4_v, 1381, "", "./tensorflow/core/framework/function_test.cc", "MakeGradDef");
...
void SetAttrValue(FunctionDef* fdef, const string& attr, const T& value) {
   ...
   mht_5_v.push_back("attr: \"" + attr + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_5(mht_5_v, 1554, "", "./tensorflow/core/framework/function_test.cc", "SetAttrValue");
...
TEST(FunctionLibraryDefinitionTest, ReachableDefinitions) {
  ...
  const auto make_simple_fdef = [](const string& name,
   ...
   mht_6_v.push_back("interface_name: \"" + interface_name + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSfunction_testDTcc mht_6(mht_6_v, 1623, "", "./tensorflow/core/framework/function_test.cc", "lambda");
