...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSresource_handle_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_handle_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSresource_handle_testDTcc() {
      // Check if tracing is enabled
...
class MockResource : public ResourceBase {
 public:
  MockResource(bool* alive, int payload) : alive_(alive), payload_(payload) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_handle_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/framework/resource_handle_test.cc", "MockResource");
  ...
  ~MockResource() override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_handle_testDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/framework/resource_handle_test.cc", "~MockResource");
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSresource_handle_testDTcc mht_2(mht_2_v, 215, "", "./tensorflow/core/framework/resource_handle_test.cc", "DebugString");
 return ""; }
  bool* alive_;
  int payload_;
};
