...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSnumeric_typesDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnumeric_typesDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSnumeric_typesDTh() {
      // Check if tracing is enabled
...
static inline tensorflow::bfloat16 FloatToBFloat16(float float_val) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnumeric_typesDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/framework/numeric_types.h", "FloatToBFloat16");
...
struct NumTraits<tensorflow::tstring> : GenericNumTraits<tensorflow::tstring> {
  ...
  static inline int digits10() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnumeric_typesDTh mht_1(mht_1_v, 237, "", "./tensorflow/core/framework/numeric_types.h", "digits10");
 return 0; }
