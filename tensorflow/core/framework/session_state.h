...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSsession_stateDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSsession_stateDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSsession_stateDTh() {
      // Check if tracing is enabled
...
class TensorStore {
 public:
  struct TensorAndKey {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSsession_stateDTh mht_0(mht_0_v, 235, "", "./tensorflow/core/framework/session_state.h", "GetHandle");
