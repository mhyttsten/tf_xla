...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh() {
      // Check if tracing is enabled
...
class AllowlistedStatefulOpRegistry {
 public:
  Status Add(string op_name) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh mht_0(mht_0_v, 198, "", "./tensorflow/core/framework/dataset_stateful_op_allowlist.h", "Add");
  ...
  Status Remove(string op_name) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh mht_1(mht_1_v, 207, "", "./tensorflow/core/framework/dataset_stateful_op_allowlist.h", "Remove");
  ...
  bool Contains(const string& op_name) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh mht_2(mht_2_v, 216, "", "./tensorflow/core/framework/dataset_stateful_op_allowlist.h", "Contains");
 return op_names_.count(op_name); }

  static AllowlistedStatefulOpRegistry* Global() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSdataset_stateful_op_allowlistDTh mht_3(mht_3_v, 221, "", "./tensorflow/core/framework/dataset_stateful_op_allowlist.h", "Global");
