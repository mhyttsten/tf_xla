...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPStensor_keyDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_keyDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPStensor_keyDTh() {
      // Check if tracing is enabled
...
class TensorKey : public Tensor {
 public:
  ...
  TensorKey(const Tensor& t) : Tensor(t) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_keyDTh mht_0(mht_0_v, 196, "", "./tensorflow/core/framework/tensor_key.h", "TensorKey");
}
  ...
  friend H AbslHashValue(H h, const TensorKey& k) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_keyDTh mht_1(mht_1_v, 230, "", "./tensorflow/core/framework/tensor_key.h", "AbslHashValue");
