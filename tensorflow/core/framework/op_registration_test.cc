...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSop_registration_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_registration_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSop_registration_testDTcc() {
      // Check if tracing is enabled
...
void Register(const string& op_name, OpRegistry* registry) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSop_registration_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/framework/op_registration_test.cc", "Register");
