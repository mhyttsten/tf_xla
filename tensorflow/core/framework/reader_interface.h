...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSreader_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSreader_interfaceDTh() {
      // Check if tracing is enabled
...
class ReaderInterface : public ResourceBase {
 public:
  ...
  string DebugString() const override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_interfaceDTh mht_0(mht_0_v, 249, "", "./tensorflow/core/framework/reader_interface.h", "DebugString");
 return "a reader"; }

 protected:
  virtual ~ReaderInterface() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSreader_interfaceDTh mht_1(mht_1_v, 255, "", "./tensorflow/core/framework/reader_interface.h", "~ReaderInterface");
}
};
