...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPScontrol_flowDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPScontrol_flowDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPScontrol_flowDTh() {
      // Check if tracing is enabled
...
struct FrameAndIter {
  ...
  FrameAndIter() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPScontrol_flowDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/framework/control_flow.h", "FrameAndIter");
}

  FrameAndIter(uint64 frame, int64_t iter) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSframeworkPScontrol_flowDTh mht_1(mht_1_v, 210, "", "./tensorflow/core/framework/control_flow.h", "FrameAndIter");
