...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSlocal_rendezvousDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlocal_rendezvousDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSlocal_rendezvousDTh() {
      // Check if tracing is enabled
...
class LocalRendezvous {
 public:
  ...
  explicit LocalRendezvous(Rendezvous* owner)
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlocal_rendezvousDTh mht_0(mht_0_v, 212, "", "./tensorflow/core/framework/local_rendezvous.h", "LocalRendezvous");
}
  ~LocalRendezvous();
