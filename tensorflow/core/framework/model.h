...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh() {
      // Check if tracing is enabled
...
struct SharedState {
 public:
  SharedState(int64_t value, std::shared_ptr<mutex> mu,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_0(mht_0_v, 241, "", "./tensorflow/core/framework/model.h", "SharedState");
}
...
struct Parameter {
  Parameter(const string& name, std::shared_ptr<SharedState> state, double min,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_1(mht_1_v, 268, "", "./tensorflow/core/framework/model.h", "Parameter");
}
...
class Node {
 public:
  ...
  explicit Node(Args args)
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_2(mht_2_v, 344, "", "./tensorflow/core/framework/model.h", "Node");
}

  virtual ~Node() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_3(mht_3_v, 349, "", "./tensorflow/core/framework/model.h", "~Node");
  ...
  string long_name() const {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_4(mht_4_v, 431, "", "./tensorflow/core/framework/model.h", "long_name");
 return strings::StrCat(name_, "(id:", id_, ")"); }

  // Returns the node name.
  const string& name() const {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_5(mht_5_v, 437, "", "./tensorflow/core/framework/model.h", "name");
 return name_; }
  ...
  Node* output() const {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_6(mht_6_v, 446, "", "./tensorflow/core/framework/model.h", "output");
 return output_; }
  ...
  void record_bytes_consumed(int64_t num_bytes) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_7(mht_7_v, 463, "", "./tensorflow/core/framework/model.h", "record_bytes_consumed");
  ...
  void record_bytes_produced(int64_t num_bytes) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_8(mht_8_v, 471, "", "./tensorflow/core/framework/model.h", "record_bytes_produced");
  ...
  void record_buffer_event(int64_t bytes_delta, int64_t elements_delta) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_9(mht_9_v, 479, "", "./tensorflow/core/framework/model.h", "record_buffer_event");
 ...
 protected:
  ...
  class Metrics {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_10(mht_10_v, 603, "", "./tensorflow/core/framework/model.h", "Metrics");
}
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_11(mht_11_v, 610, "", "./tensorflow/core/framework/model.h", "record_bytes_consumed");
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_12(mht_12_v, 621, "", "./tensorflow/core/framework/model.h", "record_bytes_produced");
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSmodelDTh mht_13(mht_13_v, 632, "", "./tensorflow/core/framework/model.h", "record_num_elements");
