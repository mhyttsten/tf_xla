...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_util_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_util_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_util_testDTcc() {
      // Check if tracing is enabled
...
NodeDef NodeDefFromText(const string& text) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_util_testDTcc mht_0(mht_0_v, 197, "", "./tensorflow/core/framework/kernel_def_util_test.cc", "NodeDefFromText");
...
KernelDef KernelDefFromText(const string& text) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_util_testDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/framework/kernel_def_util_test.cc", "KernelDefFromText");
...
class AttrsMatchTest : public ::testing::Test {
 protected:
  void ExpectStatus(const string& node_def_str, const string& kernel_def_str,
   ...
   mht_2_v.push_back("node_def_str: \"" + node_def_str + "\"");
   mht_2_v.push_back("kernel_def_str: \"" + kernel_def_str + "\"");
   MHTracer_DTPStensorflowPScorePSframeworkPSkernel_def_util_testDTcc mht_2(mht_2_v, 221, "", "./tensorflow/core/framework/kernel_def_util_test.cc", "ExpectStatus");
