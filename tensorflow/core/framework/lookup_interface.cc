...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc() {
      // Check if tracing is enabled
...
Status LookupInterface::CheckKeyShape(const TensorShape& shape) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckKeyShape");
...
Status LookupInterface::CheckKeyAndValueTypes(const Tensor& keys,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckKeyAndValueTypes");
...
Status LookupInterface::CheckKeyAndValueTensorsHelper(const Tensor& keys,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_2(mht_2_v, 222, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckKeyAndValueTensorsHelper");
...
Status LookupInterface::CheckKeyAndValueTensorsForInsert(const Tensor& keys,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_3(mht_3_v, 243, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckKeyAndValueTensorsForInsert");
...
Status LookupInterface::CheckKeyAndValueTensorsForImport(const Tensor& keys,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_4(mht_4_v, 251, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckKeyAndValueTensorsForImport");
...
Status LookupInterface::CheckKeyTensorForRemove(const Tensor& keys) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_5(mht_5_v, 258, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckKeyTensorForRemove");
...
Status LookupInterface::CheckFindArguments(const Tensor& key,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSlookup_interfaceDTcc mht_6(mht_6_v, 270, "", "./tensorflow/core/framework/lookup_interface.cc", "LookupInterface::CheckFindArguments");
