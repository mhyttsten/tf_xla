...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc() {
      // Check if tracing is enabled
...
class TestableSizeTrackingAllocator : public Allocator {
 public:
  string Name() override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "Name");
 return "test"; }
  void* AllocateRaw(size_t /*alignment*/, size_t num_bytes) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_1(mht_1_v, 202, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "AllocateRaw");
  ...
  void DeallocateRaw(void* ptr) override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_2(mht_2_v, 210, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "DeallocateRaw");
  ...
  bool TracksAllocationSizes() const override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_3(mht_3_v, 219, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "TracksAllocationSizes");
 return true; }
  size_t RequestedSize(const void* ptr) const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_4(mht_4_v, 223, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "RequestedSize");
...
class NoMemoryAllocator : public Allocator {
 public:
  string Name() override {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_5(mht_5_v, 239, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "Name");
 return "test"; }
  void* AllocateRaw(size_t /*alignment*/, size_t num_bytes) override {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_6(mht_6_v, 243, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "AllocateRaw");

    return nullptr;
  }
  void DeallocateRaw(void* ptr) override {
   std::vector<std::string> mht_7_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_7(mht_7_v, 249, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "DeallocateRaw");
}
  bool TracksAllocationSizes() const override {
   std::vector<std::string> mht_8_v;
   MHTracer_DTPStensorflowPScorePSframeworkPStracking_allocator_testDTcc mht_8(mht_8_v, 253, "", "./tensorflow/core/framework/tracking_allocator_test.cc", "TracksAllocationSizes");
 return true; }
  absl::optional<AllocatorStats> GetStats() override { return absl::nullopt; }
};
