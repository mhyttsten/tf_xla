...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc() {
      // Check if tracing is enabled
...
class NodeDefBuilderTest : public ::testing::Test {
 protected:
  ...
  void Op(const OpDefBuilder& op_def_builder) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/framework/node_def_builder_test.cc", "Op");
  ...
  NodeDefBuilder& Builder() {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/framework/node_def_builder_test.cc", "Builder");
  ...
  void ExpectSuccess(NodeDefBuilder& builder,  // NOLINT
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc mht_2(mht_2_v, 229, "", "./tensorflow/core/framework/node_def_builder_test.cc", "ExpectSuccess");
  ...
  void ExpectFailures(NodeDefBuilder& builder,  // NOLINT
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc mht_3(mht_3_v, 259, "", "./tensorflow/core/framework/node_def_builder_test.cc", "ExpectFailures");
  ...
  void ExpectFailure(NodeDefBuilder& builder,  // NOLINT
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc mht_4(mht_4_v, 277, "", "./tensorflow/core/framework/node_def_builder_test.cc", "ExpectFailure");
  ...
  void ExpectInvalid(NodeDefBuilder& builder,  // NOLINT
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPSnode_def_builder_testDTcc mht_5(mht_5_v, 288, "", "./tensorflow/core/framework/node_def_builder_test.cc", "ExpectInvalid");
