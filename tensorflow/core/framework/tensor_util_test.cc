...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc() {
      // Check if tracing is enabled
...
void VectorWithConstantTail(int size, int tail_length, std::vector<T>* v) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc mht_0(mht_0_v, 693, "", "./tensorflow/core/framework/tensor_util_test.cc", "VectorWithConstantTail");
...
void VectorWithConstantTail(int size, int tail_length,
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc mht_1(mht_1_v, 707, "", "./tensorflow/core/framework/tensor_util_test.cc", "VectorWithConstantTail");
...
TensorProto CreateAsProtoTensorContent(int size, int tail_length) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc mht_2(mht_2_v, 721, "", "./tensorflow/core/framework/tensor_util_test.cc", "CreateAsProtoTensorContent");
...
TensorProto CreateAsProtoField(int size, int tail_length) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc mht_3(mht_3_v, 735, "", "./tensorflow/core/framework/tensor_util_test.cc", "CreateAsProtoField");
...
void CompareTensorValues(const TensorProto& x, const TensorProto& y) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc mht_4(mht_4_v, 749, "", "./tensorflow/core/framework/tensor_util_test.cc", "CompareTensorValues");
...
void ConstantTailTest(int64_t length, int64_t tail_length, bool as_field) {
   ...
   MHTracer_DTPStensorflowPScorePSframeworkPStensor_util_testDTcc mht_5(mht_5_v, 761, "", "./tensorflow/core/framework/tensor_util_test.cc", "ConstantTailTest");
