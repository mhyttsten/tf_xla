...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc() {
      // Check if tracing is enabled
...
string ExecutionTimeHistogramName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/data/stats_utils.cc", "ExecutionTimeHistogramName");
...
string ThreadUtilizationScalarName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/data/stats_utils.cc", "ThreadUtilizationScalarName");
...
string BufferSizeScalarName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_2(mht_2_v, 222, "", "./tensorflow/core/data/stats_utils.cc", "BufferSizeScalarName");
...
string BufferCapacityScalarName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_3(mht_3_v, 230, "", "./tensorflow/core/data/stats_utils.cc", "BufferCapacityScalarName");
...
string BufferUtilizationHistogramName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_4(mht_4_v, 238, "", "./tensorflow/core/data/stats_utils.cc", "BufferUtilizationHistogramName");
...
string FilterdElementsScalarName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_5(mht_5_v, 246, "", "./tensorflow/core/data/stats_utils.cc", "FilterdElementsScalarName");
...
string DroppedElementsScalarName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_6(mht_6_v, 254, "", "./tensorflow/core/data/stats_utils.cc", "DroppedElementsScalarName");
...
string FeatureHistogramName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_7(mht_7_v, 262, "", "./tensorflow/core/data/stats_utils.cc", "FeatureHistogramName");
...
string FeatureValueHistogramName(const string& prefix) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSstats_utilsDTcc mht_8(mht_8_v, 270, "", "./tensorflow/core/data/stats_utils.cc", "FeatureValueHistogramName");
