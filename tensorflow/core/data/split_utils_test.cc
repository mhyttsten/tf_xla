...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSsplit_utils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSsplit_utils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSsplit_utils_testDTcc() {
      // Check if tracing is enabled
...
std::string full_name(const std::string& name) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSsplit_utils_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/data/split_utils_test.cc", "full_name");
...
Status SaveAndRestore(SplitProvider* split_provider) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSsplit_utils_testDTcc mht_1(mht_1_v, 206, "", "./tensorflow/core/data/split_utils_test.cc", "SaveAndRestore");
...
Status CheckOutput(SplitProvider* split_provider,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSsplit_utils_testDTcc mht_2(mht_2_v, 220, "", "./tensorflow/core/data/split_utils_test.cc", "CheckOutput");
