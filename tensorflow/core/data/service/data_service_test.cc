...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_service_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_service_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_service_testDTcc() {
      // Check if tracing is enabled
...
tstring LocalTempFilename() {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_service_testDTcc mht_0(mht_0_v, 219, "", "./tensorflow/core/data/service/data_service_test.cc", "LocalTempFilename");
