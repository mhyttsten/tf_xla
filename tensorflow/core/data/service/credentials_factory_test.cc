...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePScredentials_factory_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePScredentials_factory_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePScredentials_factory_testDTcc() {
      // Check if tracing is enabled
...
class TestCredentialsFactory : public CredentialsFactory {
 public:
  std::string Protocol() override {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePScredentials_factory_testDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/data/service/credentials_factory_test.cc", "Protocol");
 return "test"; }

  Status CreateServerCredentials(
      std::shared_ptr<grpc::ServerCredentials>* out) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdataPSservicePScredentials_factory_testDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/data/service/credentials_factory_test.cc", "CreateServerCredentials");
  ...
  Status CreateClientCredentials(
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePScredentials_factory_testDTcc mht_2(mht_2_v, 215, "", "./tensorflow/core/data/service/credentials_factory_test.cc", "CreateClientCredentials");
