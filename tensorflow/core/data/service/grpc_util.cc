...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_utilDTcc() {
      // Check if tracing is enabled
...
Status WrapError(const std::string& message, const ::grpc::Status& status) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_utilDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/data/service/grpc_util.cc", "WrapError");
...
Status Retry(const std::function<Status()>& f, const std::string& description,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_utilDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/data/service/grpc_util.cc", "Retry");
...
Status Retry(const std::function<Status()>& f,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_utilDTcc mht_2(mht_2_v, 227, "", "./tensorflow/core/data/service/grpc_util.cc", "Retry");
