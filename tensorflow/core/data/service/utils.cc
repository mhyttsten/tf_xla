...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSutilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSutilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSutilsDTcc() {
      // Check if tracing is enabled
...
Status WriteDatasetDef(const std::string& path, const DatasetDef& dataset_def) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSutilsDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/data/service/utils.cc", "WriteDatasetDef");
...
Status ReadDatasetDef(const std::string& path, DatasetDef& dataset_def) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSutilsDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/data/service/utils.cc", "ReadDatasetDef");
