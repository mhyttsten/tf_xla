...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_dispatcher_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_dispatcher_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_dispatcher_implDTh() {
      // Check if tracing is enabled
...
class GrpcDispatcherImpl : public DispatcherService::Service {
 public:
  ...
  ~GrpcDispatcherImpl() override {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_dispatcher_implDTh mht_0(mht_0_v, 203, "", "./tensorflow/core/data/service/grpc_dispatcher_impl.h", "~GrpcDispatcherImpl");
}
