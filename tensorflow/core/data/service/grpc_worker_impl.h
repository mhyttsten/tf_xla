...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_worker_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_worker_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_worker_implDTh() {
      // Check if tracing is enabled
...
class GrpcWorkerImpl : public WorkerService::Service {
 public:
  ...
  ~GrpcWorkerImpl() override {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_worker_implDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/data/service/grpc_worker_impl.h", "~GrpcWorkerImpl");
 Stop(); }
  ...
  get_element_getter() {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSgrpc_worker_implDTh mht_1(mht_1_v, 219, "", "./tensorflow/core/data/service/grpc_worker_impl.h", "lambda");
