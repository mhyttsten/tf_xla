...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc() {
      // Check if tracing is enabled
...
class TestDataTransferServer : public DataTransferServer {
 public:
  explicit TestDataTransferServer(bool* called) : called_(called) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/data/service/data_transfer_test.cc", "TestDataTransferServer");
}
  Status Start() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/data/service/data_transfer_test.cc", "Start");
  ...
  int get_port() override {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc mht_2(mht_2_v, 215, "", "./tensorflow/core/data/service/data_transfer_test.cc", "get_port");
 return 0; }
...
GetElementResult MakeElementResult(T value) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSdata_transfer_testDTcc mht_3(mht_3_v, 225, "", "./tensorflow/core/data/service/data_transfer_test.cc", "MakeElementResult");
