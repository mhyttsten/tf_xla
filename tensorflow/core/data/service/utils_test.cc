...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSutils_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSutils_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSutils_testDTcc() {
      // Check if tracing is enabled
...
DatasetDef DatasetDefWithVersion(int32_t version) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSutils_testDTcc mht_0(mht_0_v, 198, "", "./tensorflow/core/data/service/utils_test.cc", "DatasetDefWithVersion");
