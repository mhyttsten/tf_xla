...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSsplit_providerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSsplit_providerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSsplit_providerDTh() {
      // Check if tracing is enabled
...
class DataServiceSplitProvider : public SplitProvider {
 public:
  DataServiceSplitProvider(const std::string& address,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSsplit_providerDTh mht_0(mht_0_v, 213, "", "./tensorflow/core/data/service/split_provider.h", "DataServiceSplitProvider");
}
