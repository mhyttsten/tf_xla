...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePSworker_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePSworker_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePSworker_clientDTh() {
      // Check if tracing is enabled
...
class DataServiceWorkerClient : public DataServiceClientBase {
 public:
  DataServiceWorkerClient(const std::string& address,
   ...
   mht_0_v.push_back("transfer_protocol: \"" + transfer_protocol + "\"");
   MHTracer_DTPStensorflowPScorePSdataPSservicePSworker_clientDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/data/service/worker_client.h", "DataServiceWorkerClient");
}
