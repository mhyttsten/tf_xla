...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh() {
      // Check if tracing is enabled
...
class ProtoStringMatcher {
 public:
  explicit ProtoStringMatcher(const tensorflow::protobuf::Message& expected)
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh mht_0(mht_0_v, 231, "", "./tensorflow/core/data/service/test_util.h", "ProtoStringMatcher");
}
  ...
  bool MatchAndExplain(const Message& p,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh mht_1(mht_1_v, 238, "", "./tensorflow/core/data/service/test_util.h", "MatchAndExplain");
  ...
  void DescribeTo(::std::ostream* os) const {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh mht_2(mht_2_v, 245, "", "./tensorflow/core/data/service/test_util.h", "DescribeTo");
 *os << expected_; }
  void DescribeNegationTo(::std::ostream* os) const {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTh mht_3(mht_3_v, 249, "", "./tensorflow/core/data/service/test_util.h", "DescribeNegationTo");
