...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc() {
      // Check if tracing is enabled
...
NodeDef GetMapNode(absl::string_view name, absl::string_view input_node_name,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_0(mht_0_v, 230, "", "./tensorflow/core/data/service/test_util.cc", "GetMapNode");
...
FunctionDef XTimesX() {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_1(mht_1_v, 242, "", "./tensorflow/core/data/service/test_util.cc", "XTimesX");
...
Status CreateTestFiles(const std::vector<tstring>& filenames,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_2(mht_2_v, 256, "", "./tensorflow/core/data/service/test_util.cc", "CreateTestFiles");
...
DatasetDef RangeDataset(int64_t range) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_3(mht_3_v, 271, "", "./tensorflow/core/data/service/test_util.cc", "RangeDataset");
...
DatasetDef RangeSquareDataset(const int64_t range) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_4(mht_4_v, 292, "", "./tensorflow/core/data/service/test_util.cc", "RangeSquareDataset");
...
DatasetDef RangeDatasetWithShardHint(const int64_t range) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_5(mht_5_v, 314, "", "./tensorflow/core/data/service/test_util.cc", "RangeDatasetWithShardHint");
...
Status WaitWhile(std::function<StatusOr<bool>()> f) {
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStest_utilDTcc mht_6(mht_6_v, 361, "", "./tensorflow/core/data/service/test_util.cc", "WaitWhile");
