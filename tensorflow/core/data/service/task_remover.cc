...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSservicePStask_removerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStask_removerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSservicePStask_removerDTcc() {
      // Check if tracing is enabled
...
TaskRemover::TaskRemover(int64_t num_consumers)
   ...
   MHTracer_DTPStensorflowPScorePSdataPSservicePStask_removerDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/data/service/task_remover.cc", "TaskRemover::TaskRemover");
}

bool TaskRemover::RequestRemoval(int64_t consumer_index, int64_t round) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdataPSservicePStask_removerDTcc mht_1(mht_1_v, 204, "", "./tensorflow/core/data/service/task_remover.cc", "TaskRemover::RequestRemoval");
