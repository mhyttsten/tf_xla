...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdataPSunbounded_thread_poolDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdataPSunbounded_thread_poolDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdataPSunbounded_thread_poolDTh() {
      // Check if tracing is enabled
...
class UnboundedThreadPool : public thread::ThreadPoolInterface {
 public:
  UnboundedThreadPool(Env* env, const string& thread_name)
   ...
   MHTracer_DTPStensorflowPScorePSdataPSunbounded_thread_poolDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/data/unbounded_thread_pool.h", "UnboundedThreadPool");
}
  UnboundedThreadPool(Env* env, const string& thread_name,
   ...
   MHTracer_DTPStensorflowPScorePSdataPSunbounded_thread_poolDTh mht_1(mht_1_v, 215, "", "./tensorflow/core/data/unbounded_thread_pool.h", "UnboundedThreadPool");
}
