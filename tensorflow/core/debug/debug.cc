...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdebugPSdebugDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdebugPSdebugDTcc() {
      // Check if tracing is enabled
...
class DebuggerStateRegistration {
 public:
  ...
  DebuggerStateRegistration() {
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugDTcc mht_0(mht_0_v, 208, "", "./tensorflow/core/debug/debug.cc", "DebuggerStateRegistration");
