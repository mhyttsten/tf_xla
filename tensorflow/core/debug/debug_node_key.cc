...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdebugPSdebug_node_keyDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebug_node_keyDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdebugPSdebug_node_keyDTcc() {
      // Check if tracing is enabled
...
DebugNodeKey::DebugNodeKey(const string& device_name, const string& node_name,
   ...
   mht_0_v.push_back("debug_op: \"" + debug_op + "\"");
   MHTracer_DTPStensorflowPScorePSdebugPSdebug_node_keyDTcc mht_0(mht_0_v, 207, "", "./tensorflow/core/debug/debug_node_key.cc", "DebugNodeKey::DebugNodeKey");
}
...
const string DebugNodeKey::DeviceNameToDevicePath(const string& device_name) {
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebug_node_keyDTcc mht_1(mht_1_v, 222, "", "./tensorflow/core/debug/debug_node_key.cc", "DebugNodeKey::DeviceNameToDevicePath");
