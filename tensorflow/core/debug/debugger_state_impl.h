...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTh() {
      // Check if tracing is enabled
...
class DebugGraphDecorator : public DebugGraphDecoratorInterface {
 public:
  DebugGraphDecorator(const DebugOptions& debug_options)
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTh mht_0(mht_0_v, 218, "", "./tensorflow/core/debug/debugger_state_impl.h", "DebugGraphDecorator");
}
  virtual ~DebugGraphDecorator() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTh mht_1(mht_1_v, 222, "", "./tensorflow/core/debug/debugger_state_impl.h", "~DebugGraphDecorator");
}
