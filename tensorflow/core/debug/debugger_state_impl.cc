...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc() {
      // Check if tracing is enabled
...
DebuggerState::DebuggerState(const DebugOptions& debug_options) {
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/debug/debugger_state_impl.cc", "DebuggerState::DebuggerState");
...
DebuggerState::~DebuggerState() {
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/debug/debugger_state_impl.cc", "DebuggerState::~DebuggerState");
...
Status DebuggerState::PublishDebugMetadata(
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc mht_2(mht_2_v, 220, "", "./tensorflow/core/debug/debugger_state_impl.cc", "DebuggerState::PublishDebugMetadata");
...
Status DebugGraphDecorator::DecorateGraph(Graph* graph, Device* device) {
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc mht_3(mht_3_v, 229, "", "./tensorflow/core/debug/debugger_state_impl.cc", "DebugGraphDecorator::DecorateGraph");
...
Status DebugGraphDecorator::PublishGraph(const Graph& graph,
   ...
   MHTracer_DTPStensorflowPScorePSdebugPSdebugger_state_implDTcc mht_4(mht_4_v, 240, "", "./tensorflow/core/debug/debugger_state_impl.cc", "DebugGraphDecorator::PublishGraph");
