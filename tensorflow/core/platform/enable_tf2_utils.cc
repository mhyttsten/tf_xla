...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSenable_tf2_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSenable_tf2_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSenable_tf2_utilsDTcc() {
      // Check if tracing is enabled
...
void set_tf2_execution(bool enabled) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSenable_tf2_utilsDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/platform/enable_tf2_utils.cc", "set_tf2_execution");
...
bool tf2_execution_enabled() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSenable_tf2_utilsDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/platform/enable_tf2_utils.cc", "tf2_execution_enabled");
