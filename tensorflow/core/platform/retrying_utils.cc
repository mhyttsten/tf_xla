...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc() {
      // Check if tracing is enabled
...
bool IsRetriable(error::Code code) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/platform/retrying_utils.cc", "IsRetriable");
...
Status RetryingUtils::CallWithRetries(const std::function<Status()>& f,
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc mht_1(mht_1_v, 214, "", "./tensorflow/core/platform/retrying_utils.cc", "RetryingUtils::CallWithRetries");
...
Status RetryingUtils::CallWithRetries(
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc mht_2(mht_2_v, 228, "", "./tensorflow/core/platform/retrying_utils.cc", "RetryingUtils::CallWithRetries");
...
Status RetryingUtils::DeleteWithRetries(
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSretrying_utilsDTcc mht_3(mht_3_v, 264, "", "./tensorflow/core/platform/retrying_utils.cc", "RetryingUtils::DeleteWithRetries");
