...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSwindowsPSenv_timeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSwindowsPSenv_timeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSwindowsPSenv_timeDTcc() {
      // Check if tracing is enabled
...
uint64 EnvTime::NowNanos() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSwindowsPSenv_timeDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/platform/windows/env_time.cc", "EnvTime::NowNanos");
