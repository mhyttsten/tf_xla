...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc() {
      // Check if tracing is enabled
...
static string GetDataFilePath(const string& relative_path) {
   ...
   mht_0_v.push_back("relative_path: \"" + relative_path + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc mht_0(mht_0_v, 210, "", "./tensorflow/core/platform/subprocess_test.cc", "GetDataFilePath");
...
string EchoProgram() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc mht_1(mht_1_v, 223, "", "./tensorflow/core/platform/subprocess_test.cc", "EchoProgram");
...
string EchoArgv1Program() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc mht_2(mht_2_v, 231, "", "./tensorflow/core/platform/subprocess_test.cc", "EchoArgv1Program");
...
string NoopProgram() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc mht_3(mht_3_v, 239, "", "./tensorflow/core/platform/subprocess_test.cc", "NoopProgram");
...
string StdErrProgram() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSsubprocess_testDTcc mht_4(mht_4_v, 247, "", "./tensorflow/core/platform/subprocess_test.cc", "StdErrProgram");
