...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc() {
      // Check if tracing is enabled
...
T locale_independent_strtonum(const char* str, const char** endptr) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_0(mht_0_v, 227, "", "./tensorflow/core/platform/numbers.cc", "locale_independent_strtonum");
...
StringToFloatConverter() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_1(mht_1_v, 290, "", "./tensorflow/core/platform/numbers.cc", "StringToFloatConverter");
...
size_t FastInt32ToBufferLeft(int32_t i, char* buffer) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_2(mht_2_v, 308, "", "./tensorflow/core/platform/numbers.cc", "FastInt32ToBufferLeft");
...
size_t FastUInt32ToBufferLeft(uint32 i, char* buffer) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_3(mht_3_v, 327, "", "./tensorflow/core/platform/numbers.cc", "FastUInt32ToBufferLeft");
...
size_t FastInt64ToBufferLeft(int64_t i, char* buffer) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_4(mht_4_v, 342, "", "./tensorflow/core/platform/numbers.cc", "FastInt64ToBufferLeft");
...
size_t FastUInt64ToBufferLeft(uint64 i, char* buffer) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_5(mht_5_v, 358, "", "./tensorflow/core/platform/numbers.cc", "FastUInt64ToBufferLeft");
...
size_t DoubleToBuffer(double value, char* buffer) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_6(mht_6_v, 375, "", "./tensorflow/core/platform/numbers.cc", "DoubleToBuffer");
...
char SafeFirstChar(StringPiece str) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_7(mht_7_v, 418, "", "./tensorflow/core/platform/numbers.cc", "SafeFirstChar");
...
void SkipSpaces(StringPiece* str) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_8(mht_8_v, 425, "", "./tensorflow/core/platform/numbers.cc", "SkipSpaces");
...
bool safe_strto64(StringPiece str, int64_t* value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_9(mht_9_v, 433, "", "./tensorflow/core/platform/numbers.cc", "safe_strto64");
...
bool safe_strtou64(StringPiece str, uint64* value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_10(mht_10_v, 477, "", "./tensorflow/core/platform/numbers.cc", "safe_strtou64");
...
bool safe_strto32(StringPiece str, int32* value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_11(mht_11_v, 501, "", "./tensorflow/core/platform/numbers.cc", "safe_strto32");
...
bool safe_strtou32(StringPiece str, uint32* value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_12(mht_12_v, 534, "", "./tensorflow/core/platform/numbers.cc", "safe_strtou32");
...
bool safe_strtof(StringPiece str, float* value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_13(mht_13_v, 557, "", "./tensorflow/core/platform/numbers.cc", "safe_strtof");
...
bool safe_strtod(StringPiece str, double* value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_14(mht_14_v, 573, "", "./tensorflow/core/platform/numbers.cc", "safe_strtod");
...
size_t FloatToBuffer(float value, char* buffer) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_15(mht_15_v, 590, "", "./tensorflow/core/platform/numbers.cc", "FloatToBuffer");
...
std::string FpToString(Fprint fp) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_16(mht_16_v, 626, "", "./tensorflow/core/platform/numbers.cc", "FpToString");
...
bool StringToFp(const std::string& s, Fprint* fp) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_17(mht_17_v, 636, "", "./tensorflow/core/platform/numbers.cc", "StringToFp");
...
StringPiece Uint64ToHexString(uint64 v, char* buf) {
   ...
   mht_18_v.push_back("buf: \"" + (buf == nullptr ? std::string("nullptr") : std::string((char*)buf)) + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_18(mht_18_v, 651, "", "./tensorflow/core/platform/numbers.cc", "Uint64ToHexString");
...
bool HexStringToUint64(const StringPiece& s, uint64* result) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_19(mht_19_v, 665, "", "./tensorflow/core/platform/numbers.cc", "HexStringToUint64");
...
std::string HumanReadableNum(int64_t value) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_20(mht_20_v, 689, "", "./tensorflow/core/platform/numbers.cc", "HumanReadableNum");
...
std::string HumanReadableNumBytes(int64_t num_bytes) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_21(mht_21_v, 716, "", "./tensorflow/core/platform/numbers.cc", "HumanReadableNumBytes");
...
std::string HumanReadableElapsedTime(double seconds) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSnumbersDTcc mht_22(mht_22_v, 754, "", "./tensorflow/core/platform/numbers.cc", "HumanReadableElapsedTime");
