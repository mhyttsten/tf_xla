...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPScloudPSgoogle_auth_providerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgoogle_auth_providerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPScloudPSgoogle_auth_providerDTh() {
      // Check if tracing is enabled
...
class GoogleAuthProvider : public AuthProvider {
 public:
  ...
  virtual ~GoogleAuthProvider() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgoogle_auth_providerDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/platform/cloud/google_auth_provider.h", "~GoogleAuthProvider");
}
