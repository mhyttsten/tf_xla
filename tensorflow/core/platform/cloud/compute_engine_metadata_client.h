...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPScloudPScompute_engine_metadata_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPScompute_engine_metadata_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPScloudPScompute_engine_metadata_clientDTh() {
      // Check if tracing is enabled
...
class ComputeEngineMetadataClient {
 public:
  ...
  virtual ~ComputeEngineMetadataClient() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPScompute_engine_metadata_clientDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/platform/cloud/compute_engine_metadata_client.h", "~ComputeEngineMetadataClient");
}
