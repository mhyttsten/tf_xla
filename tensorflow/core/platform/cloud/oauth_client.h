...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPScloudPSoauth_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSoauth_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPScloudPSoauth_clientDTh() {
      // Check if tracing is enabled
...
class OAuthClient {
 public:
  ...
  virtual ~OAuthClient() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSoauth_clientDTh mht_0(mht_0_v, 203, "", "./tensorflow/core/platform/cloud/oauth_client.h", "~OAuthClient");
}
