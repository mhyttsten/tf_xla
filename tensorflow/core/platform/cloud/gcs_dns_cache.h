...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_dns_cacheDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_dns_cacheDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_dns_cacheDTh() {
      // Check if tracing is enabled
...
class GcsDnsCache {
 public:
  ...
  GcsDnsCache() : GcsDnsCache(kDefaultRefreshRateSecs) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_dns_cacheDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/platform/cloud/gcs_dns_cache.h", "GcsDnsCache");
}
  ...
  GcsDnsCache(int64_t refresh_rate_secs)
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_dns_cacheDTh mht_1(mht_1_v, 212, "", "./tensorflow/core/platform/cloud/gcs_dns_cache.h", "GcsDnsCache");
}
  ...
  ~GcsDnsCache() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_dns_cacheDTh mht_2(mht_2_v, 219, "", "./tensorflow/core/platform/cloud/gcs_dns_cache.h", "~GcsDnsCache");
