...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc() {
      // Check if tracing is enabled
...
class FakeAuthProvider : public AuthProvider {
 public:
  Status GetToken(string* token) override {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "GetToken");
...
class FakeZoneProvider : public ZoneProvider {
 public:
  Status GetZone(string* zone) override {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_1(mht_1_v, 229, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "GetZone");
...
class TestGcsStats : public GcsStatsInterface {
 public:
  void Configure(GcsFileSystem* fs, GcsThrottle* throttle,
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_2(mht_2_v, 3902, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "Configure");
  ...
  void RecordBlockLoadRequest(const string& file, size_t offset) override {
   ...
   mht_3_v.push_back("file: \"" + file + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_3(mht_3_v, 3916, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "RecordBlockLoadRequest");
  ...
  void RecordBlockRetrieved(const string& file, size_t offset,
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_4(mht_4_v, 3925, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "RecordBlockRetrieved");

    block_retrieved_file_ = file;
    block_retrieved_bytes_transferred_ = bytes_transferred;
  }

  void RecordStatObjectRequest() override {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_5(mht_5_v, 3933, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "RecordStatObjectRequest");
 stat_object_request_count_++; }

  HttpRequest::RequestStats* HttpStats() override {
   std::vector<std::string> mht_6_v;
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSgcs_file_system_testDTcc mht_6(mht_6_v, 3938, "", "./tensorflow/core/platform/cloud/gcs_file_system_test.cc", "HttpStats");
 return nullptr; }
