...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPScloudPSexpiring_lru_cache_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSexpiring_lru_cache_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPScloudPSexpiring_lru_cache_testDTcc() {
      // Check if tracing is enabled
...
TEST(ExpiringLRUCacheTest, LookupOrCompute) {
  ...
  ExpiringLRUCache<int>::ComputeFunc compute_func =
   ...
   MHTracer_DTPStensorflowPScorePSplatformPScloudPSexpiring_lru_cache_testDTcc mht_0(mht_0_v, 265, "", "./tensorflow/core/platform/cloud/expiring_lru_cache_test.cc", "lambda");
