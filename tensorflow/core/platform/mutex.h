...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh() {
      // Check if tracing is enabled
...
class Condition {
 public:
  ...
  bool Eval() const {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_0(mht_0_v, 297, "", "./tensorflow/core/platform/mutex.h", "Eval");
...
class TF_SCOPED_LOCKABLE mutex_lock {
 public:
  ...
  mutex_type* mutex() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_1(mht_1_v, 344, "", "./tensorflow/core/platform/mutex.h", "mutex");
 return mu_; }

  explicit operator bool() const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_2(mht_2_v, 349, "", "./tensorflow/core/platform/mutex.h", "bool");
 return mu_ != nullptr; }
...
class TF_SCOPED_LOCKABLE tf_shared_lock {
 public:
  ...
  mutex_type* mutex() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_3(mht_3_v, 390, "", "./tensorflow/core/platform/mutex.h", "mutex");
 return mu_; }

  explicit operator bool() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_4(mht_4_v, 395, "", "./tensorflow/core/platform/mutex.h", "bool");
 return mu_ != nullptr; }
...
inline ConditionResult WaitForMilliseconds(mutex_lock* mu,
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_5(mht_5_v, 433, "", "./tensorflow/core/platform/mutex.h", "WaitForMilliseconds");
...
inline bool Condition::CallFunction(const Condition* cond) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_6(mht_6_v, 446, "", "./tensorflow/core/platform/mutex.h", "Condition::CallFunction");
...
inline Condition::Condition(bool (*func)(T*), T* arg)
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_7(mht_7_v, 459, "", "./tensorflow/core/platform/mutex.h", "Condition::Condition");
}
...
inline bool Condition::CallMethod(const Condition* cond) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_8(mht_8_v, 466, "", "./tensorflow/core/platform/mutex.h", "Condition::CallMethod");
...
inline Condition::Condition(T* obj, bool (T::*method)())
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_9(mht_9_v, 479, "", "./tensorflow/core/platform/mutex.h", "Condition::Condition");
}
...
inline Condition::Condition(T* obj, bool (T::*method)() const)
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_10(mht_10_v, 489, "", "./tensorflow/core/platform/mutex.h", "Condition::Condition");
}

// private static
inline bool Condition::ReturnBool(const Condition* cond) {
   std::vector<std::string> mht_11_v;
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_11(mht_11_v, 495, "", "./tensorflow/core/platform/mutex.h", "Condition::ReturnBool");
...
inline Condition::Condition(const bool* flag)
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSmutexDTh mht_12(mht_12_v, 506, "", "./tensorflow/core/platform/mutex.h", "Condition::Condition");
}
