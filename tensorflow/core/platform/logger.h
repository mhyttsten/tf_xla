...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSloggerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSloggerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSloggerDTh() {
      // Check if tracing is enabled
...
class Logger {
 public:
  ...
  static void SetSingletonFactory(FactoryFunc factory) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSloggerDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/platform/logger.h", "SetSingletonFactory");
  ...
  void LogProto(const ProtoType& proto) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSloggerDTh mht_1(mht_1_v, 228, "", "./tensorflow/core/platform/logger.h", "LogProto");
  ...
  void Flush() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSloggerDTh mht_2(mht_2_v, 238, "", "./tensorflow/core/platform/logger.h", "Flush");
 DoFlush(); }
