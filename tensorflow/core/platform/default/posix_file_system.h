...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSposix_file_systemDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSposix_file_systemDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSposix_file_systemDTh() {
      // Check if tracing is enabled
...
class PosixFileSystem : public FileSystem {
 public:
  PosixFileSystem() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSposix_file_systemDTh mht_0(mht_0_v, 195, "", "./tensorflow/core/platform/default/posix_file_system.h", "PosixFileSystem");
}

  ~PosixFileSystem() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSposix_file_systemDTh mht_1(mht_1_v, 200, "", "./tensorflow/core/platform/default/posix_file_system.h", "~PosixFileSystem");
}
...
class LocalPosixFileSystem : public PosixFileSystem {
 public:
  string TranslateName(const string& name) const override {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSposix_file_systemDTh mht_2(mht_2_v, 251, "", "./tensorflow/core/platform/default/posix_file_system.h", "TranslateName");
