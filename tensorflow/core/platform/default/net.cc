...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSnetDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSnetDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSnetDTcc() {
      // Check if tracing is enabled
...
bool IsPortAvailable(int* port, bool is_tcp) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSnetDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/platform/default/net.cc", "IsPortAvailable");
...
int PickUnusedPortOrDie() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSnetDTcc mht_1(mht_1_v, 277, "", "./tensorflow/core/platform/default/net.cc", "PickUnusedPortOrDie");
