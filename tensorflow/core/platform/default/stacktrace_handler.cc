...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSstacktrace_handlerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSstacktrace_handlerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSstacktrace_handlerDTcc() {
      // Check if tracing is enabled
...
static void StacktraceHandler(int sig, siginfo_t *si, void *v) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSstacktrace_handlerDTcc mht_0(mht_0_v, 229, "", "./tensorflow/core/platform/default/stacktrace_handler.cc", "StacktraceHandler");
...
void InstallStacktraceHandler() {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSstacktrace_handlerDTcc mht_1(mht_1_v, 272, "", "./tensorflow/core/platform/default/stacktrace_handler.cc", "InstallStacktraceHandler");
