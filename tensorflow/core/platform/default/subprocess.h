...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSsubprocessDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSsubprocessDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSsubprocessDTh() {
      // Check if tracing is enabled
...
class SubProcess {
 ...
 private:
  ...
  static bool chan_valid(int chan) {
   ...
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSsubprocessDTh mht_0(mht_0_v, 274, "", "./tensorflow/core/platform/default/subprocess.h", "chan_valid");
 return ((chan >= 0) && (chan < kNFds)); }
  static bool retry(int e) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSplatformPSdefaultPSsubprocessDTh mht_1(mht_1_v, 278, "", "./tensorflow/core/platform/default/subprocess.h", "retry");
