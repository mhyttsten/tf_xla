...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh() {
      // Check if tracing is enabled
...
inline void CopyToArray(const std::string& src, char* dst) {
   ...
   mht_0_v.push_back("dst: \"" + (dst == nullptr ? std::string("nullptr") : std::string((char*)dst)) + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh mht_0(mht_0_v, 208, "", "./tensorflow/core/platform/tensor_coding.h", "CopyToArray");
...
inline void CopySubrangeToArray(const std::string& src, size_t pos, size_t n,
   ...
   mht_1_v.push_back("dst: \"" + (dst == nullptr ? std::string("nullptr") : std::string((char*)dst)) + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh mht_1(mht_1_v, 221, "", "./tensorflow/core/platform/tensor_coding.h", "CopySubrangeToArray");
...
inline void CopyToArray(const absl::Cord& src, char* dst) {
   ...
   mht_2_v.push_back("dst: \"" + (dst == nullptr ? std::string("nullptr") : std::string((char*)dst)) + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh mht_2(mht_2_v, 286, "", "./tensorflow/core/platform/tensor_coding.h", "CopyToArray");
...
inline void CopySubrangeToArray(const absl::Cord& src, int64_t pos, int64_t n,
   ...
   mht_3_v.push_back("dst: \"" + (dst == nullptr ? std::string("nullptr") : std::string((char*)dst)) + "\"");
   MHTracer_DTPStensorflowPScorePSplatformPStensor_codingDTh mht_3(mht_3_v, 297, "", "./tensorflow/core/platform/tensor_coding.h", "CopySubrangeToArray");
