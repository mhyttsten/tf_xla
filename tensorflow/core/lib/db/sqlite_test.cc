...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSdbPSsqlite_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSdbPSsqlite_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSdbPSsqlite_testDTcc() {
      // Check if tracing is enabled
...
class SqliteTest : public ::testing::Test {
 protected:
  void SetUp() override {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSdbPSsqlite_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/lib/db/sqlite_test.cc", "SetUp");
  ...
  void TearDown() override {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSdbPSsqlite_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/lib/db/sqlite_test.cc", "TearDown");
 db_->Unref(); }
