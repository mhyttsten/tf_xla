...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSrandomPSdistribution_sampler_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSdistribution_sampler_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSrandomPSdistribution_sampler_testDTcc() {
      // Check if tracing is enabled
...
class DistributionSamplerTest : public ::testing::Test {
 protected:
  ...
  float TestWeights(const std::vector<float>& weights, int trials_per_bin) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSdistribution_sampler_testDTcc mht_0(mht_0_v, 203, "", "./tensorflow/core/lib/random/distribution_sampler_test.cc", "TestWeights");
  ...
  void TestDistribution(float* arr, int n) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSdistribution_sampler_testDTcc mht_1(mht_1_v, 228, "", "./tensorflow/core/lib/random/distribution_sampler_test.cc", "TestDistribution");
...
static void BM_DistributionSampler(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSdistribution_sampler_testDTcc mht_2(mht_2_v, 260, "", "./tensorflow/core/lib/random/distribution_sampler_test.cc", "BM_DistributionSampler");
