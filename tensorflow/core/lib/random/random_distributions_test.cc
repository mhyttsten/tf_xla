...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc() {
      // Check if tracing is enabled
...
void FillRandomsWithSingles(PhiloxRandom gen,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_0(mht_0_v, 218, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "FillRandomsWithSingles");
...
bool CheckSamplesMoments(const std::vector<T>& samples,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_1(mht_1_v, 252, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "CheckSamplesMoments");
...
void UniformMomentsTest(int count, int max_moments,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_2(mht_2_v, 326, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "UniformMomentsTest");
...
void NormalMomentsTest(int count, int max_moments,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_3(mht_3_v, 347, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "NormalMomentsTest");
...
void RandomParametersMomentsTest(int count, int max_moments,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_4(mht_4_v, 425, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "RandomParametersMomentsTest");
...
class MockGenerator {
 public:
  explicit MockGenerator(uint64 seed) : counter_(seed) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_5(mht_5_v, 491, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "MockGenerator");
}
...
void SingleSampleAdapterSkipTest() {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSrandomPSrandom_distributions_testDTcc mht_6(mht_6_v, 509, "", "./tensorflow/core/lib/random/random_distributions_test.cc", "SingleSampleAdapterSkipTest");
