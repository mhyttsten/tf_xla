...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc() {
      // Check if tracing is enabled
...
string RandomString(random::SimplePhilox* rnd, size_t len) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "RandomString");
...
void OCWriteIncreasing<string>(string* dest, const string& val) {
   ...
   mht_1_v.push_back("val: \"" + val + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_1(mht_1_v, 227, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCWriteIncreasing<string>");
...
bool OCReadIncreasing<string>(StringPiece* src, string* result) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_2(mht_2_v, 234, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCReadIncreasing<string>");
...
void OCWriteIncreasing<uint64>(string* dest, const uint64& val) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_3(mht_3_v, 243, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCWriteIncreasing<uint64>");
...
bool OCReadIncreasing<uint64>(StringPiece* src, uint64* result) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_4(mht_4_v, 250, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCReadIncreasing<uint64>");
...
void OCWriteIncreasing<int64_t>(string* dest, const int64_t& val) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_5(mht_5_v, 259, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCWriteIncreasing<int64_t>");
...
bool OCReadIncreasing<int64_t>(StringPiece* src, int64_t* result) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_6(mht_6_v, 266, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCReadIncreasing<int64_t>");
...
string OCWrite(T val) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_7(mht_7_v, 274, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCWrite");
...
void OCWriteToString(string* result, T val) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_8(mht_8_v, 284, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCWriteToString");
...
bool OCRead(StringPiece* s, T* val) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_9(mht_9_v, 292, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "OCRead");
...
T TestRead(const string& a) {
   ...
   mht_10_v.push_back("a: \"" + a + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_10(mht_10_v, 304, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "TestRead");
...
void TestWriteRead(T expected) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_11(mht_11_v, 323, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "TestWriteRead");
...
void TestNumbers(T multiplier) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_12(mht_12_v, 343, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "TestNumbers");
...
bool CompareStrings(const string& a, const string& b) {
   ...
   mht_13_v.push_back("a: \"" + a + "\"");
   mht_13_v.push_back("b: \"" + b + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_13(mht_13_v, 375, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "CompareStrings");
 return (a < b); }

template <typename T>
void TestNumberOrdering() {
   std::vector<std::string> mht_14_v;
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_14(mht_14_v, 381, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "TestNumberOrdering");
...
size_t FindSpecial(const string& x) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_15(mht_15_v, 421, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "FindSpecial");
...
string ByteSequence(const char (&arr)[N]) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_16(mht_16_v, 434, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "ByteSequence");
...
inline string StrNot(const string& s) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_17(mht_17_v, 524, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "StrNot");
...
void TestInvalidEncoding(const string& s) {
   ...
   mht_18_v.push_back("s: \"" + s + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_18(mht_18_v, 536, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "TestInvalidEncoding");
...
uint64 NextBits(random::SimplePhilox* rnd, int bits) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_19(mht_19_v, 605, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "NextBits");
...
void BM_WriteNum(::testing::benchmark::State& state, T multiplier) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_20(mht_20_v, 615, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "BM_WriteNum");
...
void BM_ReadNum(::testing::benchmark::State& state, T multiplier) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_21(mht_21_v, 637, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "BM_ReadNum");
...
void BM_WriteString(::testing::benchmark::State& state, int len) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_22(mht_22_v, 1458, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "BM_WriteString");
...
void BM_ReadString(::testing::benchmark::State& state, int len) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_23(mht_23_v, 1477, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "BM_ReadString");
...
void BM_WriteStringIncreasing(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_24(mht_24_v, 1499, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "BM_WriteStringIncreasing");

  BM_WriteString(state, state.range(0));
}
void BM_ReadStringIncreasing(::testing::benchmark::State& state) {
   std::vector<std::string> mht_25_v;
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSordered_code_testDTcc mht_25(mht_25_v, 1505, "", "./tensorflow/core/lib/strings/ordered_code_test.cc", "BM_ReadStringIncreasing");
