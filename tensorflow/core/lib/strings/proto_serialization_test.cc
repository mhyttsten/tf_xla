...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc() {
      // Check if tracing is enabled
...
GraphDef MakeGraphDef(int num_nodes) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/lib/strings/proto_serialization_test.cc", "MakeGraphDef");
...
static void BM_ProtoSerializationToString(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/lib/strings/proto_serialization_test.cc", "BM_ProtoSerializationToString");
...
static void BM_ProtoSerializationToBuffer(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc mht_2(mht_2_v, 233, "", "./tensorflow/core/lib/strings/proto_serialization_test.cc", "BM_ProtoSerializationToBuffer");
...
static void BM_DeterministicProtoHash64(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc mht_3(mht_3_v, 250, "", "./tensorflow/core/lib/strings/proto_serialization_test.cc", "BM_DeterministicProtoHash64");
...
static void BM_AreSerializedProtosEqual(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSstringsPSproto_serialization_testDTcc mht_4(mht_4_v, 264, "", "./tensorflow/core/lib/strings/proto_serialization_test.cc", "BM_AreSerializedProtosEqual");
