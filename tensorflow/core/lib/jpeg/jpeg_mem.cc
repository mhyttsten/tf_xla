...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc() {
      // Check if tracing is enabled
...
class FewerArgsForCompiler {
 public:
  FewerArgsForCompiler(int datasize, const UncompressFlags& flags,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_0(mht_0_v, 230, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "FewerArgsForCompiler");
...
bool IsCropWindowValid(const UncompressFlags& flags, int input_image_width,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_1(mht_1_v, 248, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "IsCropWindowValid");
...
uint8* Uncompress(const void* srcdata, int datasize,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_2(mht_2_v, 682, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "Uncompress");
...
uint8* Uncompress(const void* srcdata, int datasize,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_3(mht_3_v, 714, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "Uncompress");
...
bool GetImageInfo(const void* srcdata, int datasize, int* width, int* height,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_4(mht_4_v, 736, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "GetImageInfo");
...
bool CompressInternal(const uint8* srcdata, int width, int height,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_5(mht_5_v, 780, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "CompressInternal");
...
bool Compress(const void* srcdata, int width, int height,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_6(mht_6_v, 959, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "Compress");
...
tstring Compress(const void* srcdata, int width, int height,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSjpegPSjpeg_memDTcc mht_7(mht_7_v, 968, "", "./tensorflow/core/lib/jpeg/jpeg_mem.cc", "Compress");
