...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTh() {
      // Check if tracing is enabled
...
inline uint32 Mask(uint32 crc) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTh mht_0(mht_0_v, 222, "", "./tensorflow/core/lib/hash/crc32c.h", "Mask");
...
inline uint32 Unmask(uint32 masked_crc) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTh mht_1(mht_1_v, 231, "", "./tensorflow/core/lib/hash/crc32c.h", "Unmask");
