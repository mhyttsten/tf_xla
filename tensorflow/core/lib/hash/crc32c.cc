...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTcc() {
      // Check if tracing is enabled
...
static inline uint32_t LE_LOAD32(const uint8_t *p) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTcc mht_0(mht_0_v, 377, "", "./tensorflow/core/lib/hash/crc32c.cc", "LE_LOAD32");
...
uint32 Extend(uint32 crc, const char *buf, size_t size) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPShashPScrc32cDTcc mht_1(mht_1_v, 385, "", "./tensorflow/core/lib/hash/crc32c.cc", "Extend");
