...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc() {
      // Check if tracing is enabled
...
inline int16 FloatToInt16Sample(float data) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_0(mht_0_v, 242, "", "./tensorflow/core/lib/wav/wav_io.cc", "FloatToInt16Sample");
...
inline float Int16SampleToFloat(int16_t data) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_1(mht_1_v, 251, "", "./tensorflow/core/lib/wav/wav_io.cc", "Int16SampleToFloat");
...
Status IncrementOffset(int old_offset, size_t increment, size_t max_size,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_2(mht_2_v, 264, "", "./tensorflow/core/lib/wav/wav_io.cc", "IncrementOffset");
...
Status ExpectText(const std::string& data, const std::string& expected_text,
   ...
   mht_3_v.push_back("data: \"" + data + "\"");
   mht_3_v.push_back("expected_text: \"" + expected_text + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_3(mht_3_v, 292, "", "./tensorflow/core/lib/wav/wav_io.cc", "ExpectText");
...
Status ReadString(const std::string& data, int expected_length,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_4(mht_4_v, 311, "", "./tensorflow/core/lib/wav/wav_io.cc", "ReadString");
...
Status EncodeAudioAsS16LEWav(const float* audio, size_t sample_rate,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_5(mht_5_v, 326, "", "./tensorflow/core/lib/wav/wav_io.cc", "EncodeAudioAsS16LEWav");
...
Status DecodeLin16WaveAsFloatVector(const std::string& wav_string,
   ...
   mht_6_v.push_back("wav_string: \"" + wav_string + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSwavPSwav_ioDTcc mht_6(mht_6_v, 416, "", "./tensorflow/core/lib/wav/wav_io.cc", "DecodeLin16WaveAsFloatVector");
