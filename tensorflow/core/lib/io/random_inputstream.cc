...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc() {
      // Check if tracing is enabled
...
RandomAccessInputStream::RandomAccessInputStream(RandomAccessFile* file,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc mht_0(mht_0_v, 193, "", "./tensorflow/core/lib/io/random_inputstream.cc", "RandomAccessInputStream::RandomAccessInputStream");
}

RandomAccessInputStream::~RandomAccessInputStream() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc mht_1(mht_1_v, 198, "", "./tensorflow/core/lib/io/random_inputstream.cc", "RandomAccessInputStream::~RandomAccessInputStream");
...
Status RandomAccessInputStream::ReadNBytes(int64_t bytes_to_read,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc mht_2(mht_2_v, 208, "", "./tensorflow/core/lib/io/random_inputstream.cc", "RandomAccessInputStream::ReadNBytes");
...
Status RandomAccessInputStream::SkipNBytes(int64_t bytes_to_skip) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc mht_3(mht_3_v, 249, "", "./tensorflow/core/lib/io/random_inputstream.cc", "RandomAccessInputStream::SkipNBytes");
...
int64_t RandomAccessInputStream::Tell() const {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTcc mht_4(mht_4_v, 285, "", "./tensorflow/core/lib/io/random_inputstream.cc", "RandomAccessInputStream::Tell");
 return pos_; }
