...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTh() {
      // Check if tracing is enabled
...
class RandomAccessInputStream : public InputStreamInterface {
 public:
  ...
  Status Seek(int64_t position) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTh mht_0(mht_0_v, 215, "", "./tensorflow/core/lib/io/random_inputstream.h", "Seek");
  ...
  Status Reset() override {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrandom_inputstreamDTh mht_1(mht_1_v, 223, "", "./tensorflow/core/lib/io/random_inputstream.h", "Reset");
 return Seek(0); }
