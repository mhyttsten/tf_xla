...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc() {
      // Check if tracing is enabled
...
bool IsZlibCompressed(const RecordWriterOptions& options) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/lib/io/record_writer.cc", "IsZlibCompressed");
...
bool IsSnappyCompressed(const RecordWriterOptions& options) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_1(mht_1_v, 202, "", "./tensorflow/core/lib/io/record_writer.cc", "IsSnappyCompressed");
...
RecordWriterOptions RecordWriterOptions::CreateRecordWriterOptions(
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_2(mht_2_v, 212, "", "./tensorflow/core/lib/io/record_writer.cc", "RecordWriterOptions::CreateRecordWriterOptions");
...
RecordWriter::RecordWriter(WritableFile* dest,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_3(mht_3_v, 241, "", "./tensorflow/core/lib/io/record_writer.cc", "RecordWriter::RecordWriter");
...
RecordWriter::~RecordWriter() {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_4(mht_4_v, 272, "", "./tensorflow/core/lib/io/record_writer.cc", "RecordWriter::~RecordWriter");
...
Status RecordWriter::WriteRecord(StringPiece data) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_5(mht_5_v, 284, "", "./tensorflow/core/lib/io/record_writer.cc", "RecordWriter::WriteRecord");
...
Status RecordWriter::Flush() {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSrecord_writerDTcc mht_6(mht_6_v, 338, "", "./tensorflow/core/lib/io/record_writer.cc", "RecordWriter::Flush");
