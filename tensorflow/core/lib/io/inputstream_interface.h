...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSioPSinputstream_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSinputstream_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSioPSinputstream_interfaceDTh() {
      // Check if tracing is enabled
...
class InputStreamInterface {
 public:
  InputStreamInterface() {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSioPSinputstream_interfaceDTh mht_0(mht_0_v, 201, "", "./tensorflow/core/lib/io/inputstream_interface.h", "InputStreamInterface");
}
  virtual ~InputStreamInterface() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSlibPSioPSinputstream_interfaceDTh mht_1(mht_1_v, 205, "", "./tensorflow/core/lib/io/inputstream_interface.h", "~InputStreamInterface");
}
