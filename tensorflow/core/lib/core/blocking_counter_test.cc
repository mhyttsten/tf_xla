...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPScorePSblocking_counter_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPScorePSblocking_counter_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPScorePSblocking_counter_testDTcc() {
      // Check if tracing is enabled
...
static void BM_BlockingCounter(::testing::benchmark::State& state) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPScorePSblocking_counter_testDTcc mht_0(mht_0_v, 221, "", "./tensorflow/core/lib/core/blocking_counter_test.cc", "BM_BlockingCounter");
