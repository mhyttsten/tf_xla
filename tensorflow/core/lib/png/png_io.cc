...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc() {
      // Check if tracing is enabled
...
void WarningHandler(png_structp png_ptr, png_const_charp msg) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_0(mht_0_v, 256, "", "./tensorflow/core/lib/png/png_io.cc", "WarningHandler");
...
void StringReader(png_structp png_ptr, png_bytep data, png_size_t length) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_1(mht_1_v, 263, "", "./tensorflow/core/lib/png/png_io.cc", "StringReader");
...
void StringWriter(png_structp png_ptr, png_bytep data, png_size_t length) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_2(mht_2_v, 284, "", "./tensorflow/core/lib/png/png_io.cc", "StringWriter");
...
void StringWriterFlush(png_structp png_ptr) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_3(mht_3_v, 292, "", "./tensorflow/core/lib/png/png_io.cc", "StringWriterFlush");
}

char* check_metadata_string(const std::string& s) {
   std::vector<std::string> mht_4_v;
   mht_4_v.push_back("s: \"" + s + "\"");
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_4(mht_4_v, 298, "", "./tensorflow/core/lib/png/png_io.cc", "check_metadata_string");
...
void CommonFreeDecode(DecodeContext* context) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_5(mht_5_v, 314, "", "./tensorflow/core/lib/png/png_io.cc", "CommonFreeDecode");
...
bool DecodeHeader(StringPiece png_string, int* width, int* height,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_6(mht_6_v, 329, "", "./tensorflow/core/lib/png/png_io.cc", "DecodeHeader");
...
bool CommonInitDecode(StringPiece png_string, int desired_channels,
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_7(mht_7_v, 392, "", "./tensorflow/core/lib/png/png_io.cc", "CommonInitDecode");
...
bool CommonFinishDecode(png_bytep data, int row_bytes, DecodeContext* context) {
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_8(mht_8_v, 503, "", "./tensorflow/core/lib/png/png_io.cc", "CommonFinishDecode");
...
bool WriteImageToBuffer(
   ...
   MHTracer_DTPStensorflowPScorePSlibPSpngPSpng_ioDTcc mht_9(mht_9_v, 545, "", "./tensorflow/core/lib/png/png_io.cc", "WriteImageToBuffer");
