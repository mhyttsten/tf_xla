...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSactivity_watcherPSactivityDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSactivity_watcherPSactivityDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSactivity_watcherPSactivityDTh() {
      // Check if tracing is enabled
...
static tensorflow::string ToString(ActivityCategory category) {
   ...
   MHTracer_DTPStensorflowPScorePSactivity_watcherPSactivityDTh mht_0(mht_0_v, 204, "", "./tensorflow/core/activity_watcher/activity.h", "ToString");
...
struct Activity {
  ...
  Activity(tensorflow::string title, ActivityCategory category)
   ...
   mht_1_v.push_back("title: \"" + title + "\"");
   MHTracer_DTPStensorflowPScorePSactivity_watcherPSactivityDTh mht_1(mht_1_v, 225, "", "./tensorflow/core/activity_watcher/activity.h", "Activity");
}
};
