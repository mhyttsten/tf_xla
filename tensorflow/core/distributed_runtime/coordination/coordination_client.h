...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_clientDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_clientDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_clientDTh() {
      // Check if tracing is enabled
...
class CoordinationClient {
 public:
  virtual ~CoordinationClient() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_clientDTh mht_0(mht_0_v, 201, "", "./tensorflow/core/distributed_runtime/coordination/coordination_client.h", "~CoordinationClient");
}
...
class CoordinationClientCache {
 public:
  virtual ~CoordinationClientCache() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_clientDTh mht_1(mht_1_v, 261, "", "./tensorflow/core/distributed_runtime/coordination/coordination_client.h", "~CoordinationClientCache");
}
