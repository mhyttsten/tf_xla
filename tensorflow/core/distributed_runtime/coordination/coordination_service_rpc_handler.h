...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_service_rpc_handlerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_service_rpc_handlerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_service_rpc_handlerDTh() {
      // Check if tracing is enabled
...
class CoordinationServiceRpcHandler {
 public:
  explicit CoordinationServiceRpcHandler() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScoordinationPScoordination_service_rpc_handlerDTh mht_0(mht_0_v, 198, "", "./tensorflow/core/distributed_runtime/coordination/coordination_service_rpc_handler.h", "CoordinationServiceRpcHandler");
}
