...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePScancellable_callDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScancellable_callDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePScancellable_callDTh() {
      // Check if tracing is enabled
...
class CancellableCall {
 public:
  CancellableCall(CancellationManager* cancel_mgr, const string& remote_worker,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScancellable_callDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/distributed_runtime/cancellable_call.h", "CancellableCall");
}

  virtual ~CancellableCall() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScancellable_callDTh mht_1(mht_1_v, 211, "", "./tensorflow/core/distributed_runtime/cancellable_call.h", "~CancellableCall");
