...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrendezvous_mgr_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrendezvous_mgr_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrendezvous_mgr_interfaceDTh() {
      // Check if tracing is enabled
...
class RemoteRendezvous : public Rendezvous {
 ...
 protected:
  bool is_cross_process() override {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrendezvous_mgr_interfaceDTh mht_0(mht_0_v, 220, "", "./tensorflow/core/distributed_runtime/rendezvous_mgr_interface.h", "is_cross_process");
 return true; }
};
...
class RendezvousMgrInterface {
 public:
  RendezvousMgrInterface() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrendezvous_mgr_interfaceDTh mht_1(mht_1_v, 246, "", "./tensorflow/core/distributed_runtime/rendezvous_mgr_interface.h", "RendezvousMgrInterface");
}
  virtual ~RendezvousMgrInterface() {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrendezvous_mgr_interfaceDTh mht_2(mht_2_v, 250, "", "./tensorflow/core/distributed_runtime/rendezvous_mgr_interface.h", "~RendezvousMgrInterface");
}
