...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTh() {
      // Check if tracing is enabled
...
class WorkerCachePartial : public WorkerCacheInterface {
 public:
  ...
  ~WorkerCachePartial() override {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTh mht_0(mht_0_v, 209, "", "./tensorflow/core/distributed_runtime/worker_cache_partial.h", "~WorkerCachePartial");
}
