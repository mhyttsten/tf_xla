...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_envDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_envDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_envDTh() {
      // Check if tracing is enabled
...
struct WorkerCacheFactoryOptions {
  ...
  WorkerCacheFactoryOptions() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_envDTh mht_0(mht_0_v, 214, "", "./tensorflow/core/distributed_runtime/master_env.h", "WorkerCacheFactoryOptions");
}
  ...
  WorkerCacheFactoryOptions(const ServerDef& server_def) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_envDTh mht_1(mht_1_v, 222, "", "./tensorflow/core/distributed_runtime/master_env.h", "WorkerCacheFactoryOptions");
