...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrecent_request_idsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrecent_request_idsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrecent_request_idsDTcc() {
      // Check if tracing is enabled
...
RecentRequestIds::RecentRequestIds(int num_tracked_request_ids)
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrecent_request_idsDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/distributed_runtime/recent_request_ids.cc", "RecentRequestIds::RecentRequestIds");
...
bool RecentRequestIds::Insert(int64_t request_id) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrecent_request_idsDTcc mht_1(mht_1_v, 203, "", "./tensorflow/core/distributed_runtime/recent_request_ids.cc", "RecentRequestIds::Insert");
...
Status RecentRequestIds::TrackUnique(int64_t request_id,
   ...
   mht_2_v.push_back("method_name: \"" + method_name + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrecent_request_idsDTcc mht_2(mht_2_v, 234, "", "./tensorflow/core/distributed_runtime/recent_request_ids.cc", "RecentRequestIds::TrackUnique");
