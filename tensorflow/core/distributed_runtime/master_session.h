...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_sessionDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_sessionDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_sessionDTh() {
      // Check if tracing is enabled
...
class MasterSession : public core::RefCounted {
 public:
  ...
  const string& handle() const {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_sessionDTh mht_0(mht_0_v, 232, "", "./tensorflow/core/distributed_runtime/master_session.h", "handle");
 return handle_; }
  ...
  uint64 last_access_time_usec() const {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_sessionDTh mht_1(mht_1_v, 239, "", "./tensorflow/core/distributed_runtime/master_session.h", "last_access_time_usec");
