...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePScollective_rma_distributedDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScollective_rma_distributedDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePScollective_rma_distributedDTh() {
      // Check if tracing is enabled
...
class CollectiveRemoteAccessDistributed : public CollectiveRemoteAccessLocal {
 public:
  CollectiveRemoteAccessDistributed(
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScollective_rma_distributedDTh mht_0(mht_0_v, 206, "", "./tensorflow/core/distributed_runtime/collective_rma_distributed.h", "CollectiveRemoteAccessDistributed");
}

  ~CollectiveRemoteAccessDistributed() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScollective_rma_distributedDTh mht_1(mht_1_v, 211, "", "./tensorflow/core/distributed_runtime/collective_rma_distributed.h", "~CollectiveRemoteAccessDistributed");
}
