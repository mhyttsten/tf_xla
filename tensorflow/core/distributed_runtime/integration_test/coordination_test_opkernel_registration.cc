...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc() {
      // Check if tracing is enabled
...
class TestSetConfigKeyValueOp : public OpKernel {
 public:
  explicit TestSetConfigKeyValueOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc mht_0(mht_0_v, 205, "", "./tensorflow/core/distributed_runtime/integration_test/coordination_test_opkernel_registration.cc", "TestSetConfigKeyValueOp");
}
  void Compute(OpKernelContext* ctx) override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/distributed_runtime/integration_test/coordination_test_opkernel_registration.cc", "Compute");
...
class TestGetConfigKeyValueOp : public OpKernel {
 public:
  explicit TestGetConfigKeyValueOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc mht_2(mht_2_v, 249, "", "./tensorflow/core/distributed_runtime/integration_test/coordination_test_opkernel_registration.cc", "TestGetConfigKeyValueOp");
}
  void Compute(OpKernelContext* ctx) override {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSintegration_testPScoordination_test_opkernel_registrationDTcc mht_3(mht_3_v, 253, "", "./tensorflow/core/distributed_runtime/integration_test/coordination_test_opkernel_registration.cc", "Compute");
