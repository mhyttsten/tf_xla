...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh() {
      // Check if tracing is enabled
...
class WorkerCacheInterface {
 public:
  virtual ~WorkerCacheInterface() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/distributed_runtime/worker_cache.h", "~WorkerCacheInterface");
}
  ...
  virtual void ReleaseWorker(const string& target, WorkerInterface* worker) {
   ...
   mht_1_v.push_back("target: \"" + target + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh mht_1(mht_1_v, 228, "", "./tensorflow/core/distributed_runtime/worker_cache.h", "ReleaseWorker");
  ...
  virtual void SetLogging(bool active) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh mht_2(mht_2_v, 262, "", "./tensorflow/core/distributed_runtime/worker_cache.h", "SetLogging");
}

  // Discard any saved log data.
  virtual void ClearLogs() {
   std::vector<std::string> mht_3_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh mht_3(mht_3_v, 268, "", "./tensorflow/core/distributed_runtime/worker_cache.h", "ClearLogs");
}
  ...
  virtual bool RetrieveLogs(int64_t step_id, StepStats* ss) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cacheDTh mht_4(mht_4_v, 275, "", "./tensorflow/core/distributed_runtime/worker_cache.h", "RetrieveLogs");
 return false; }
};
}  // namespace tensorflow
