...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_loggerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_loggerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_loggerDTh() {
      // Check if tracing is enabled
...
class WorkerCacheLogger {
 public:
  ...
  bool LoggingActive() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_loggerDTh mht_0(mht_0_v, 221, "", "./tensorflow/core/distributed_runtime/worker_cache_logger.h", "LoggingActive");
