...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmessage_wrappersDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmessage_wrappersDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmessage_wrappersDTh() {
      // Check if tracing is enabled
...
class RunStepRequestWrapper {
 public:
  virtual ~RunStepRequestWrapper() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmessage_wrappersDTh mht_0(mht_0_v, 220, "", "./tensorflow/core/distributed_runtime/message_wrappers.h", "~RunStepRequestWrapper");
}
...
class RunGraphRequestWrapper {
 public:
  virtual ~RunGraphRequestWrapper() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmessage_wrappersDTh mht_1(mht_1_v, 424, "", "./tensorflow/core/distributed_runtime/message_wrappers.h", "~RunGraphRequestWrapper");
}
...
class MutableRunGraphResponseWrapper {
 public:
  virtual ~MutableRunGraphResponseWrapper() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmessage_wrappersDTh mht_2(mht_2_v, 652, "", "./tensorflow/core/distributed_runtime/message_wrappers.h", "~MutableRunGraphResponseWrapper");
}
