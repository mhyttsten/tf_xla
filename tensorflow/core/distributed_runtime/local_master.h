...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSlocal_masterDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSlocal_masterDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSlocal_masterDTh() {
      // Check if tracing is enabled
...
class LocalMaster : public MasterInterface {
 public:
  ~LocalMaster() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSlocal_masterDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/distributed_runtime/local_master.h", "~LocalMaster");
}
