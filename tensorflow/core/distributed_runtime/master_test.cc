...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc() {
      // Check if tracing is enabled
...
class MasterTest : public ::testing::Test {
 protected:
  MasterTest() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_0(mht_0_v, 215, "", "./tensorflow/core/distributed_runtime/master_test.cc", "MasterTest");
  ...
  Status CreateSession(const GraphDef& def, string* handle,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_1(mht_1_v, 237, "", "./tensorflow/core/distributed_runtime/master_test.cc", "CreateSession");
  ...
  Status ExtendSession(const string& handle, const GraphDef& def,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_2(mht_2_v, 257, "", "./tensorflow/core/distributed_runtime/master_test.cc", "ExtendSession");
  ...
  Status RunStep(const string& handle,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_3(mht_3_v, 277, "", "./tensorflow/core/distributed_runtime/master_test.cc", "RunStep");
  ...
  Status CloseSession(const string& handle) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_4(mht_4_v, 308, "", "./tensorflow/core/distributed_runtime/master_test.cc", "CloseSession");
  ...
  Status Reset() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_5(mht_5_v, 319, "", "./tensorflow/core/distributed_runtime/master_test.cc", "Reset");
...
TEST_F(MasterTest, ConcurrentExtendOnlyOneSucceeds) {
  ...
  auto extend_fn = [this, handle, def_1, initial_version, &n, &mu, &succeeded,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_6(mht_6_v, 455, "", "./tensorflow/core/distributed_runtime/master_test.cc", "lambda");
...
TEST_F(MasterTest, ConcurrentExtendAndRun) {
  ...
  auto get_a_fn = [this, handle, &extend_done]() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_7(mht_7_v, 509, "", "./tensorflow/core/distributed_runtime/master_test.cc", "lambda");
  ...
  auto get_a_and_b_fn = [this, handle, &extend_done, &extend_can_start]() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_8(mht_8_v, 521, "", "./tensorflow/core/distributed_runtime/master_test.cc", "lambda");
  ...
  auto extend_fn = [this, handle, def_1, initial_version, &extend_done,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSmaster_testDTcc mht_9(mht_9_v, 545, "", "./tensorflow/core/distributed_runtime/master_test.cc", "lambda");
