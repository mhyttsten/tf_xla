...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworkerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworkerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworkerDTh() {
      // Check if tracing is enabled
...
class Worker : public WorkerInterface {
 public:
  ...
  virtual ~Worker() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworkerDTh mht_0(mht_0_v, 215, "", "./tensorflow/core/distributed_runtime/worker.h", "~Worker");
}
