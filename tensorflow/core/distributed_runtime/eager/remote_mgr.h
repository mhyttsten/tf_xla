...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh() {
      // Check if tracing is enabled
...
class RemoteMgr {
 public:
  RemoteMgr(bool is_master, EagerContext* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh mht_0(mht_0_v, 204, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr.h", "RemoteMgr");
}

  ~RemoteMgr() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh mht_1(mht_1_v, 209, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr.h", "~RemoteMgr");
  ...
  bool IsMaster() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh mht_2(mht_2_v, 218, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr.h", "IsMaster");
 return is_master_; }
  ...
  uint64 NextOpId() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgrDTh mht_3(mht_3_v, 237, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr.h", "NextOpId");
