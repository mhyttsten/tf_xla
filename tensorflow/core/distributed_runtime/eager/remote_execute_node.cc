...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_execute_nodeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_execute_nodeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_execute_nodeDTcc() {
      // Check if tracing is enabled
...
void RemoteExecuteNode::RunAsync(StatusCallback done) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_execute_nodeDTcc mht_0(mht_0_v, 195, "", "./tensorflow/core/distributed_runtime/eager/remote_execute_node.cc", "RemoteExecuteNode::RunAsync");
