...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc() {
      // Check if tracing is enabled
...
class TestRemoteMgr : public RemoteMgr {
 public:
  TestRemoteMgr(bool is_master, EagerContext* ctx)
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc mht_0(mht_0_v, 202, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr_test.cc", "TestRemoteMgr");
}

  uint64 OpId() {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc mht_1(mht_1_v, 207, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr_test.cc", "OpId");
...
class RemoteMgrTest : public ::testing::Test {
 public:
  RemoteMgrTest() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc mht_2(mht_2_v, 218, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr_test.cc", "RemoteMgrTest");
  ...
  ~RemoteMgrTest() override {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSremote_mgr_testDTcc mht_3(mht_3_v, 238, "", "./tensorflow/core/distributed_runtime/eager/remote_mgr_test.cc", "~RemoteMgrTest");
 ctx_->Unref(); }
