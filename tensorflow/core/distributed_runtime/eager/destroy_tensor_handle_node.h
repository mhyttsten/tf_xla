...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh() {
      // Check if tracing is enabled
...
class DestroyTensorHandleNode : public tensorflow::AsyncEagerNode {
 public:
  DestroyTensorHandleNode(std::unique_ptr<EnqueueRequest> request,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh mht_0(mht_0_v, 207, "", "./tensorflow/core/distributed_runtime/eager/destroy_tensor_handle_node.h", "DestroyTensorHandleNode");
}

  ~DestroyTensorHandleNode() override {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh mht_1(mht_1_v, 212, "", "./tensorflow/core/distributed_runtime/eager/destroy_tensor_handle_node.h", "~DestroyTensorHandleNode");
}

  void RunAsync(StatusCallback done) override {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh mht_2(mht_2_v, 217, "", "./tensorflow/core/distributed_runtime/eager/destroy_tensor_handle_node.h", "RunAsync");
  ...
  void Abort(Status status) override {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh mht_3(mht_3_v, 245, "", "./tensorflow/core/distributed_runtime/eager/destroy_tensor_handle_node.h", "Abort");
}

  // Remote node deletions are best effort
  bool Fatal() const override {
   std::vector<std::string> mht_4_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh mht_4(mht_4_v, 251, "", "./tensorflow/core/distributed_runtime/eager/destroy_tensor_handle_node.h", "Fatal");
 return false; }

  string DebugString() const override {
   std::vector<std::string> mht_5_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSeagerPSdestroy_tensor_handle_nodeDTh mht_5(mht_5_v, 256, "", "./tensorflow/core/distributed_runtime/eager/destroy_tensor_handle_node.h", "DebugString");
