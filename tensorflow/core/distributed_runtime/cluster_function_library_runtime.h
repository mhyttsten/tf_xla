...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePScluster_function_library_runtimeDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScluster_function_library_runtimeDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePScluster_function_library_runtimeDTh() {
      // Check if tracing is enabled
...
class ClusterFunctionLibraryRuntime : public DistributedFunctionLibraryRuntime {
 public:
  ClusterFunctionLibraryRuntime(WorkerSession* worker_session,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScluster_function_library_runtimeDTh mht_0(mht_0_v, 205, "", "./tensorflow/core/distributed_runtime/cluster_function_library_runtime.h", "ClusterFunctionLibraryRuntime");
}
  ...
  DeviceMgr* remote_device_mgr() const override {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScluster_function_library_runtimeDTh mht_1(mht_1_v, 231, "", "./tensorflow/core/distributed_runtime/cluster_function_library_runtime.h", "remote_device_mgr");
 ...
 private:
  ...
  struct FunctionData {
   ...
   mht_2_v.push_back("graph_handle: \"" + graph_handle + "\"");
   mht_2_v.push_back("target: \"" + target + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePScluster_function_library_runtimeDTh mht_2(mht_2_v, 271, "", "./tensorflow/core/distributed_runtime/cluster_function_library_runtime.h", "FunctionData");
}
  };
