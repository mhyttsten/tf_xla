...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSschedulerDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSschedulerDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSschedulerDTh() {
      // Check if tracing is enabled
...
class SlackAnalysis {
 public:
  ...
  ~SlackAnalysis() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSschedulerDTh mht_0(mht_0_v, 204, "", "./tensorflow/core/distributed_runtime/scheduler.h", "~SlackAnalysis");
}
...
class GreedyScheduler {
 public:
  ...
  struct Event {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSschedulerDTh mht_1(mht_1_v, 240, "", "./tensorflow/core/distributed_runtime/scheduler.h", "operator<");
...
class PriorityScheduler {
 public:
  ...
  ~PriorityScheduler() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSschedulerDTh mht_2(mht_2_v, 273, "", "./tensorflow/core/distributed_runtime/scheduler.h", "~PriorityScheduler");
}
