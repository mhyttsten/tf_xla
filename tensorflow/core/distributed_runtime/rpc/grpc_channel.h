...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_channelDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_channelDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_channelDTh() {
      // Check if tracing is enabled
...
class GrpcChannelSpec {
 public:
  struct HostPortsJob {
   ...
   mht_0_v.push_back("job_id: \"" + job_id + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_channelDTh mht_0(mht_0_v, 210, "", "./tensorflow/core/distributed_runtime/rpc/grpc_channel.h", "HostPortsJob");
}
    const string job_id;
  ...
  const std::vector<HostPortsJob>& host_ports_jobs() const {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_channelDTh mht_1(mht_1_v, 224, "", "./tensorflow/core/distributed_runtime/rpc/grpc_channel.h", "host_ports_jobs");
...
class GrpcChannelCache {
 public:
  virtual ~GrpcChannelCache() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_channelDTh mht_2(mht_2_v, 238, "", "./tensorflow/core/distributed_runtime/rpc/grpc_channel.h", "~GrpcChannelCache");
}
