...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc() {
      // Check if tracing is enabled
...
static SessionOptions Devices(int num_cpus, int num_gpus) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_0(mht_0_v, 206, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "Devices");
...
void CreateGraphDef(GraphDef* graph_def, string node_names[3]) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "CreateGraphDef");
...
static void IsSingleFloatValue(const Tensor& val, float expected_val) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_2(mht_2_v, 240, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "IsSingleFloatValue");
...
static SessionOptions Options(const string& target, int placement_period) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_3(mht_3_v, 250, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "Options");
...
static Session* NewRemote(const SessionOptions& options) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_4(mht_4_v, 265, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "NewRemote");
...
void FindMaxEigen(const string& target) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_5(mht_5_v, 514, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "FindMaxEigen");
...
void SetDevice(GraphDef* graph, const string& name, const string& dev) {
   ...
   mht_6_v.push_back("dev: \"" + dev + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_6(mht_6_v, 590, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "SetDevice");
...
void CreateInvalidGraph(const string& graph_def_ascii,
   ...
   mht_7_v.push_back("graph_def_ascii: \"" + graph_def_ascii + "\"");
   mht_7_v.push_back("error_substring: \"" + error_substring + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_session_testDTcc mht_7(mht_7_v, 1062, "", "./tensorflow/core/distributed_runtime/rpc/grpc_session_test.cc", "CreateInvalidGraph");
