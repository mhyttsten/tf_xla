...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSasync_service_interfaceDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSasync_service_interfaceDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSasync_service_interfaceDTh() {
      // Check if tracing is enabled
...
class AsyncServiceInterface {
 public:
  virtual ~AsyncServiceInterface() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSasync_service_interfaceDTh mht_0(mht_0_v, 194, "", "./tensorflow/core/distributed_runtime/rpc/async_service_interface.h", "~AsyncServiceInterface");
}
