...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh() {
      // Check if tracing is enabled
...
class GrpcWorkerEnv {
 public:
  ...
  thread::ThreadPool* GetThreadPool() const {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh mht_0(mht_0_v, 202, "", "./tensorflow/core/distributed_runtime/rpc/grpc_worker_cache.h", "GetThreadPool");
 return threadpool_.get(); }

  size_t CompletionQueueSize() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh mht_1(mht_1_v, 207, "", "./tensorflow/core/distributed_runtime/rpc/grpc_worker_cache.h", "CompletionQueueSize");
 return threads_.size(); }

  ::grpc::CompletionQueue* GetCompletionQueue(size_t index) const {
   std::vector<std::string> mht_2_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh mht_2(mht_2_v, 212, "", "./tensorflow/core/distributed_runtime/rpc/grpc_worker_cache.h", "GetCompletionQueue");
 ...
 private:
  ...
  class GrpcWorkerCacheThread {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_worker_cacheDTh mht_3(mht_3_v, 228, "", "./tensorflow/core/distributed_runtime/rpc/grpc_worker_cache.h", "completion_queue");
