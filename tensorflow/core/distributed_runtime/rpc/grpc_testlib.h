...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTh() {
      // Check if tracing is enabled
...
class TestCluster {
 public:
  ...
  const std::vector<string>& targets() const {
   std::vector<std::string> mht_0_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTh mht_0(mht_0_v, 230, "", "./tensorflow/core/distributed_runtime/rpc/grpc_testlib.h", "targets");
 return targets_; }

  // Returns a vector of devices available in this test cluster.
  const std::vector<DeviceAttributes>& devices() const {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTh mht_1(mht_1_v, 236, "", "./tensorflow/core/distributed_runtime/rpc/grpc_testlib.h", "devices");
 return devices_; }
