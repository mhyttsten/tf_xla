...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTcc() {
      // Check if tracing is enabled
...
Status TestCluster::MakeTestCluster(const SessionOptions& options, int n,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTcc mht_0(mht_0_v, 196, "", "./tensorflow/core/distributed_runtime/rpc/grpc_testlib.cc", "TestCluster::MakeTestCluster");
...
Status TestCluster::MakeTestCluster(const string& binary_path,
   ...
   mht_1_v.push_back("binary_path: \"" + binary_path + "\"");
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTcc mht_1(mht_1_v, 209, "", "./tensorflow/core/distributed_runtime/rpc/grpc_testlib.cc", "TestCluster::MakeTestCluster");
...
TestCluster::~TestCluster() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSgrpc_testlibDTcc mht_2(mht_2_v, 265, "", "./tensorflow/core/distributed_runtime/rpc/grpc_testlib.cc", "TestCluster::~TestCluster");
