...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTcc() {
      // Check if tracing is enabled
...
GrpcCoordinationServiceImpl::GrpcCoordinationServiceImpl(
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTcc mht_0(mht_0_v, 194, "", "./tensorflow/core/distributed_runtime/rpc/coordination/grpc_coordination_service_impl.cc", "GrpcCoordinationServiceImpl::GrpcCoordinationServiceImpl");
...
void GrpcCoordinationServiceImpl::HandleRPCsLoop() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTcc mht_1(mht_1_v, 202, "", "./tensorflow/core/distributed_runtime/rpc/coordination/grpc_coordination_service_impl.cc", "GrpcCoordinationServiceImpl::HandleRPCsLoop");
...
void GrpcCoordinationServiceImpl::Shutdown() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTcc mht_2(mht_2_v, 253, "", "./tensorflow/core/distributed_runtime/rpc/coordination/grpc_coordination_service_impl.cc", "GrpcCoordinationServiceImpl::Shutdown");
