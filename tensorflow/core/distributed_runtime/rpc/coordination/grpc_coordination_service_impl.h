...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTh() {
      // Check if tracing is enabled
...
class GrpcCoordinationServiceImpl : public AsyncServiceInterface {
 public:
  ...
  ~GrpcCoordinationServiceImpl() override {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTh mht_0(mht_0_v, 222, "", "./tensorflow/core/distributed_runtime/rpc/coordination/grpc_coordination_service_impl.h", "~GrpcCoordinationServiceImpl");
}
  ...
  void SetCoordinationServiceAgentInstance(CoordinationServiceAgent* agent) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPScoordinationPSgrpc_coordination_service_implDTh mht_1(mht_1_v, 229, "", "./tensorflow/core/distributed_runtime/rpc/coordination/grpc_coordination_service_impl.h", "SetCoordinationServiceAgentInstance");
