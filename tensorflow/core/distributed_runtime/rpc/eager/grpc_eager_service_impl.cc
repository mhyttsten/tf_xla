...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc() {
      // Check if tracing is enabled
...
GrpcEagerServiceImpl::GrpcEagerServiceImpl(
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/distributed_runtime/rpc/eager/grpc_eager_service_impl.cc", "GrpcEagerServiceImpl::GrpcEagerServiceImpl");
...
Status GrpcEagerServiceImpl::CreateMasterContext(
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc mht_1(mht_1_v, 210, "", "./tensorflow/core/distributed_runtime/rpc/eager/grpc_eager_service_impl.cc", "GrpcEagerServiceImpl::CreateMasterContext");
...
void GrpcEagerServiceImpl::HandleRPCsLoop() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc mht_2(mht_2_v, 217, "", "./tensorflow/core/distributed_runtime/rpc/eager/grpc_eager_service_impl.cc", "GrpcEagerServiceImpl::HandleRPCsLoop");
...
void GrpcEagerServiceImpl::Shutdown() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpcPSeagerPSgrpc_eager_service_implDTcc mht_3(mht_3_v, 266, "", "./tensorflow/core/distributed_runtime/rpc/eager/grpc_eager_service_impl.cc", "GrpcEagerServiceImpl::Shutdown");
