...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSpartial_run_mgrDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSpartial_run_mgrDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSpartial_run_mgrDTcc() {
      // Check if tracing is enabled
...
bool PartialRunMgr::FindOrCreate(int step_id,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSpartial_run_mgrDTcc mht_0(mht_0_v, 192, "", "./tensorflow/core/distributed_runtime/partial_run_mgr.cc", "PartialRunMgr::FindOrCreate");
...
void PartialRunMgr::ExecutorDone(int step_id, const Status& executor_status) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSpartial_run_mgrDTcc mht_1(mht_1_v, 212, "", "./tensorflow/core/distributed_runtime/partial_run_mgr.cc", "PartialRunMgr::ExecutorDone");
...
void PartialRunMgr::PartialRunDone(int step_id, StatusCallback done,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSpartial_run_mgrDTcc mht_2(mht_2_v, 243, "", "./tensorflow/core/distributed_runtime/partial_run_mgr.cc", "PartialRunMgr::PartialRunDone");
