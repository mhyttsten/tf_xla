...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpc_collective_executor_mgr_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpc_collective_executor_mgr_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpc_collective_executor_mgr_testDTcc() {
      // Check if tracing is enabled
...
class RpcCollectiveExecutorMgrTest : public ::testing::Test {
 protected:
  RpcCollectiveExecutorMgrTest() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSrpc_collective_executor_mgr_testDTcc mht_0(mht_0_v, 209, "", "./tensorflow/core/distributed_runtime/rpc_collective_executor_mgr_test.cc", "RpcCollectiveExecutorMgrTest");
