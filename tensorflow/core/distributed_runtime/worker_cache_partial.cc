...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc() {
      // Check if tracing is enabled
...
bool WorkerCachePartial::GetDeviceLocalityNonBlocking(
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/distributed_runtime/worker_cache_partial.cc", "WorkerCachePartial::GetDeviceLocalityNonBlocking");
...
void WorkerCachePartial::GetDeviceLocalityAsync(const string& device_name,
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc mht_1(mht_1_v, 216, "", "./tensorflow/core/distributed_runtime/worker_cache_partial.cc", "WorkerCachePartial::GetDeviceLocalityAsync");
...
Status WorkerCachePartial::RefreshDeviceStatus(const string& device_name) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc mht_2(mht_2_v, 235, "", "./tensorflow/core/distributed_runtime/worker_cache_partial.cc", "WorkerCachePartial::RefreshDeviceStatus");
  ...
  auto deleter = [this, &task](WorkerInterface* wi) {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc mht_3(mht_3_v, 246, "", "./tensorflow/core/distributed_runtime/worker_cache_partial.cc", "lambda");
...
void WorkerCachePartial::FlushStatusCache() {
   ...
   MHTracer_DTPStensorflowPScorePSdistributed_runtimePSworker_cache_partialDTcc mht_4(mht_4_v, 272, "", "./tensorflow/core/distributed_runtime/worker_cache_partial.cc", "WorkerCachePartial::FlushStatusCache");
