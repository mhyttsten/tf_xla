...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSopsPSnn_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSopsPSnn_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSopsPSnn_opsDTcc() {
      // Check if tracing is enabled
...
Status FractionalPoolShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSnn_opsDTcc mht_0(mht_0_v, 204, "", "./tensorflow/core/ops/nn_ops.cc", "FractionalPoolShapeFn");
...
Status CommonFusedConvCalculations(InferenceContext* c, bool has_resize) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSnn_opsDTcc mht_1(mht_1_v, 628, "", "./tensorflow/core/ops/nn_ops.cc", "CommonFusedConvCalculations");
...
Status TopKShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSnn_opsDTcc mht_2(mht_2_v, 1499, "", "./tensorflow/core/ops/nn_ops.cc", "TopKShapeFn");
