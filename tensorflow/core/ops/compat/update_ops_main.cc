...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSopsPScompatPSupdate_ops_mainDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSopsPScompatPSupdate_ops_mainDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSopsPScompatPSupdate_ops_mainDTcc() {
      // Check if tracing is enabled
...
void WriteUpdateTo(const string& directory) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPScompatPSupdate_ops_mainDTcc mht_0(mht_0_v, 201, "", "./tensorflow/core/ops/compat/update_ops_main.cc", "WriteUpdateTo");
...
int main(int argc, char* argv[]) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPScompatPSupdate_ops_mainDTcc mht_1(mht_1_v, 245, "", "./tensorflow/core/ops/compat/update_ops_main.cc", "main");
