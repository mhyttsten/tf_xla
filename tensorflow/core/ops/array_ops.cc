...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc() {
      // Check if tracing is enabled
...
Status GetAxisForPackAndUnpack(InferenceContext* c, int32_t rank_after_pack,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_0(mht_0_v, 212, "", "./tensorflow/core/ops/array_ops.cc", "GetAxisForPackAndUnpack");
...
Status PadKnown(InferenceContext* c, ShapeHandle input,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_1(mht_1_v, 238, "", "./tensorflow/core/ops/array_ops.cc", "PadKnown");
...
Status PadShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_2(mht_2_v, 257, "", "./tensorflow/core/ops/array_ops.cc", "PadShapeFn");
...
Status TransposeShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_3(mht_3_v, 300, "", "./tensorflow/core/ops/array_ops.cc", "TransposeShapeFn");
...
Status SetOutputShapeForReshape(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_4(mht_4_v, 369, "", "./tensorflow/core/ops/array_ops.cc", "SetOutputShapeForReshape");
...
Status UniqueIdxShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_5(mht_5_v, 1652, "", "./tensorflow/core/ops/array_ops.cc", "UniqueIdxShapeFn");
...
Status ShapeShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_6(mht_6_v, 1760, "", "./tensorflow/core/ops/array_ops.cc", "ShapeShapeFn");
...
Status MirrorPadKnown(InferenceContext* c, ShapeHandle input,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_7(mht_7_v, 2186, "", "./tensorflow/core/ops/array_ops.cc", "MirrorPadKnown");
...
Status SpaceToBatchShapeHelper(InferenceContext* c, ShapeHandle input_shape,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_8(mht_8_v, 2463, "", "./tensorflow/core/ops/array_ops.cc", "SpaceToBatchShapeHelper");
...
Status BatchToSpaceShapeHelper(InferenceContext* c, ShapeHandle input_shape,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_9(mht_9_v, 2541, "", "./tensorflow/core/ops/array_ops.cc", "BatchToSpaceShapeHelper");
...
Status ScatterNdTensorShape(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSarray_opsDTcc mht_10(mht_10_v, 3331, "", "./tensorflow/core/ops/array_ops.cc", "ScatterNdTensorShape");
