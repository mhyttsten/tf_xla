...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc() {
      // Check if tracing is enabled
...
Status ArgOpShape(shape_inference::InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc mht_0(mht_0_v, 1243, "", "./tensorflow/core/ops/math_ops.cc", "ArgOpShape");
...
Status SegmentReductionShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc mht_1(mht_1_v, 1323, "", "./tensorflow/core/ops/math_ops.cc", "SegmentReductionShapeFn");
...
Status SparseSegmentReductionShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc mht_2(mht_2_v, 1342, "", "./tensorflow/core/ops/math_ops.cc", "SparseSegmentReductionShapeFn");
...
Status SparseSegmentReductionGradShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc mht_3(mht_3_v, 1369, "", "./tensorflow/core/ops/math_ops.cc", "SparseSegmentReductionGradShapeFn");
...
Status SparseSegmentReductionWithNumSegmentsShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc mht_4(mht_4_v, 1410, "", "./tensorflow/core/ops/math_ops.cc", "SparseSegmentReductionWithNumSegmentsShapeFn");
...
Status RangeSize(const Tensor* start_t, const Tensor* limit_t,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSmath_opsDTcc mht_5(mht_5_v, 1654, "", "./tensorflow/core/ops/math_ops.cc", "RangeSize");
