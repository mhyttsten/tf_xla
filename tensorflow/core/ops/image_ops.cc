...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc() {
      // Check if tracing is enabled
...
Status SetOutputToSizedImage(InferenceContext* c, DimensionHandle batch_dim,
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_0(mht_0_v, 200, "", "./tensorflow/core/ops/image_ops.cc", "SetOutputToSizedImage");
...
Status ResizeShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_1(mht_1_v, 234, "", "./tensorflow/core/ops/image_ops.cc", "ResizeShapeFn");
...
Status DecodeImageShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_2(mht_2_v, 244, "", "./tensorflow/core/ops/image_ops.cc", "DecodeImageShapeFn");
...
Status DecodeImageV2ShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_3(mht_3_v, 268, "", "./tensorflow/core/ops/image_ops.cc", "DecodeImageV2ShapeFn");
...
Status EncodeImageShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_4(mht_4_v, 305, "", "./tensorflow/core/ops/image_ops.cc", "EncodeImageShapeFn");
...
Status ColorspaceShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_5(mht_5_v, 315, "", "./tensorflow/core/ops/image_ops.cc", "ColorspaceShapeFn");
...
Status NMSShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_6(mht_6_v, 332, "", "./tensorflow/core/ops/image_ops.cc", "NMSShapeFn");
...
Status SoftNMSShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_7(mht_7_v, 358, "", "./tensorflow/core/ops/image_ops.cc", "SoftNMSShapeFn");
...
Status CombinedNMSShapeFn(InferenceContext* c) {
   ...
   MHTracer_DTPStensorflowPScorePSopsPSimage_opsDTcc mht_8(mht_8_v, 387, "", "./tensorflow/core/ops/image_ops.cc", "CombinedNMSShapeFn");
