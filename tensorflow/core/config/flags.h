...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSconfigPSflagsDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSconfigPSflagsDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSconfigPSflagsDTh() {
      // Check if tracing is enabled
...
class Flag {
 public:
  ...
  bool value() {
   ...
   MHTracer_DTPStensorflowPScorePSconfigPSflagsDTh mht_0(mht_0_v, 198, "", "./tensorflow/core/config/flags.h", "value");
 return value_; }
  void reset(bool value) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPScorePSconfigPSflagsDTh mht_1(mht_1_v, 202, "", "./tensorflow/core/config/flags.h", "reset");
 value_ = value; }
