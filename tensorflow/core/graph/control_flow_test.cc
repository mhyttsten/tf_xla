...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPScorePSgraphPScontrol_flow_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPScorePSgraphPScontrol_flow_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPScorePSgraphPScontrol_flow_testDTcc() {
      // Check if tracing is enabled
...
Status LessThanTenCond(const Scope& scope, const std::vector<Output>& inputs,
   ...
   MHTracer_DTPStensorflowPScorePSgraphPScontrol_flow_testDTcc mht_0(mht_0_v, 199, "", "./tensorflow/core/graph/control_flow_test.cc", "LessThanTenCond");
...
Status AddOneBody(const Scope& scope, const std::vector<Output>& inputs,
   ...
   MHTracer_DTPStensorflowPScorePSgraphPScontrol_flow_testDTcc mht_1(mht_1_v, 208, "", "./tensorflow/core/graph/control_flow_test.cc", "AddOneBody");
...
Status NestedLoopBody(const Scope& scope, const std::vector<Output>& inputs,
   ...
   MHTracer_DTPStensorflowPScorePSgraphPScontrol_flow_testDTcc mht_2(mht_2_v, 217, "", "./tensorflow/core/graph/control_flow_test.cc", "NestedLoopBody");
