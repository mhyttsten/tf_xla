...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSop_utilsDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSop_utilsDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSop_utilsDTcc() {
      // Check if tracing is enabled
...
uint64_t OpHash(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSop_utilsDTcc mht_0(mht_0_v, 201, "", "./tensorflow/dtensor/mlir/op_utils.cc", "OpHash");
...
void RemoveDTensorLayoutOp(mlir::TF::DTensorLayout layout) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSop_utilsDTcc mht_1(mht_1_v, 229, "", "./tensorflow/dtensor/mlir/op_utils.cc", "RemoveDTensorLayoutOp");
