...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSdesignate_resource_handle_meshDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdesignate_resource_handle_meshDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSdesignate_resource_handle_meshDTcc() {
      // Check if tracing is enabled
...
mlir::LogicalResult SetMeshForResourceCreatingCluster(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdesignate_resource_handle_meshDTcc mht_0(mht_0_v, 206, "", "./tensorflow/dtensor/mlir/designate_resource_handle_mesh.cc", "SetMeshForResourceCreatingCluster");
...
struct DTensorDesignateResourceHandleMesh
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdesignate_resource_handle_meshDTcc mht_1(mht_1_v, 240, "", "./tensorflow/dtensor/mlir/designate_resource_handle_mesh.cc", "runOnOperation");
