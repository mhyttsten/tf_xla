...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTh() {
      // Check if tracing is enabled
...
class SparseExpanderBase {
 public:
  virtual ~SparseExpanderBase() {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTh mht_0(mht_0_v, 205, "", "./tensorflow/dtensor/mlir/sparse_expander.h", "~SparseExpanderBase");
}
