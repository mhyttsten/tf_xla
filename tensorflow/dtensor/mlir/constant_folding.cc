...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSconstant_foldingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSconstant_foldingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSconstant_foldingDTcc() {
      // Check if tracing is enabled
...
mlir::LogicalResult FoldConstantOp(mlir::OperationFolder& folder,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSconstant_foldingDTcc mht_0(mht_0_v, 201, "", "./tensorflow/dtensor/mlir/constant_folding.cc", "FoldConstantOp");
...
struct DTensorConstantFolding
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSconstant_foldingDTcc mht_1(mht_1_v, 236, "", "./tensorflow/dtensor/mlir/constant_folding.cc", "runOnOperation");
