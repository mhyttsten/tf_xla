...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc() {
      // Check if tracing is enabled
...
bool DependsOn(mlir::Operation* successor, mlir::Operation* predecessor) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_0(mht_0_v, 224, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "DependsOn");
...
void MoveUsagesAfter(mlir::tf_device::ClusterOp cluster, mlir::Operation* a,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_1(mht_1_v, 275, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "MoveUsagesAfter");
...
mlir::LogicalResult MergeAllReduceGroup(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_2(mht_2_v, 324, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "MergeAllReduceGroup");
...
std::string DrawAllReduceDependencies(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_3(mht_3_v, 445, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "DrawAllReduceDependencies");
...
mlir::LogicalResult CombineAllReduceOpsOfSameTypeAndGroupAssignment(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_4(mht_4_v, 536, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "CombineAllReduceOpsOfSameTypeAndGroupAssignment");
...
bool same_group_assignments(mlir::Value group_assignment_a,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_5(mht_5_v, 672, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "same_group_assignments");
...
mlir::LogicalResult CombineAllReduceOpsOfSameType(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_6(mht_6_v, 697, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "CombineAllReduceOpsOfSameType");
...
struct DTensorAllReduceCombineOptimization
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_allreduce_combine_optimizationDTcc mht_7(mht_7_v, 736, "", "./tensorflow/dtensor/mlir/dtensor_allreduce_combine_optimization.cc", "runOnOperation");
