...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_location_testDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_location_testDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_location_testDTcc() {
      // Check if tracing is enabled
...
void CheckFileLineColLocation(mlir::Location loc, unsigned line,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_location_testDTcc mht_0(mht_0_v, 196, "", "./tensorflow/dtensor/mlir/dtensor_location_test.cc", "CheckFileLineColLocation");
