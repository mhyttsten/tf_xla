...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPScollectivesDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPScollectivesDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPScollectivesDTcc() {
      // Check if tracing is enabled
...
mlir::Value SelectScalarValueFromArray(int index, mlir::OpBuilder& builder,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPScollectivesDTcc mht_0(mht_0_v, 505, "", "./tensorflow/dtensor/mlir/collectives.cc", "SelectScalarValueFromArray");
...
int GetMeshDimensionOffsetWithNeighbor(const Mesh& mesh,
   ...
   mht_1_v.push_back("mesh_dim: \"" + mesh_dim + "\"");
   MHTracer_DTPStensorflowPSdtensorPSmlirPScollectivesDTcc mht_1(mht_1_v, 532, "", "./tensorflow/dtensor/mlir/collectives.cc", "GetMeshDimensionOffsetWithNeighbor");
