...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSfunction_renamingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSfunction_renamingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSfunction_renamingDTcc() {
      // Check if tracing is enabled
...
struct DTensorFunctionRenaming
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSfunction_renamingDTcc mht_0(mht_0_v, 205, "", "./tensorflow/dtensor/mlir/function_renaming.cc", "runOnOperation");
