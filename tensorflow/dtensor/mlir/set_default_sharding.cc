...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSset_default_shardingDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSset_default_shardingDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSset_default_shardingDTcc() {
      // Check if tracing is enabled
...
void SetDefaultSharding(mlir::tf_device::ClusterFuncOp cluster,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSset_default_shardingDTcc mht_0(mht_0_v, 205, "", "./tensorflow/dtensor/mlir/set_default_sharding.cc", "SetDefaultSharding");
...
struct DTensorSetDefaultSharding
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSset_default_shardingDTcc mht_1(mht_1_v, 227, "", "./tensorflow/dtensor/mlir/set_default_sharding.cc", "runOnOperation");
