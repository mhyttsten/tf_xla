...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc() {
      // Check if tracing is enabled
...
mlir::Location DTensorLocation(mlir::Location loc, llvm::StringRef file,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc mht_0(mht_0_v, 199, "", "./tensorflow/dtensor/mlir/dtensor_location.cc", "DTensorLocation");
...
mlir::Location DTensorLocation(mlir::Operation* op, llvm::StringRef file,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc mht_1(mht_1_v, 212, "", "./tensorflow/dtensor/mlir/dtensor_location.cc", "DTensorLocation");
...
std::string CreateLocalLocationString(mlir::FileLineColLoc loc) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc mht_2(mht_2_v, 219, "", "./tensorflow/dtensor/mlir/dtensor_location.cc", "CreateLocalLocationString");
...
std::string DTensorLocationToString(mlir::Location loc) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSdtensor_locationDTcc mht_3(mht_3_v, 228, "", "./tensorflow/dtensor/mlir/dtensor_location.cc", "DTensorLocationToString");
