...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expander_commonDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expander_commonDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expander_commonDTcc() {
      // Check if tracing is enabled
...
bool IsSparseValue(mlir::Value value) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expander_commonDTcc mht_0(mht_0_v, 208, "", "./tensorflow/dtensor/mlir/sparse_expander_common.cc", "IsSparseValue");
 return GetSparseToDenseOp(value).ok(); }

bool HasAnySparseInput(mlir::Operation* op) {
   std::vector<std::string> mht_1_v;
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expander_commonDTcc mht_1(mht_1_v, 213, "", "./tensorflow/dtensor/mlir/sparse_expander_common.cc", "HasAnySparseInput");
...
bool AllSparseInput(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expander_commonDTcc mht_2(mht_2_v, 222, "", "./tensorflow/dtensor/mlir/sparse_expander_common.cc", "AllSparseInput");
