...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc() {
      // Check if tracing is enabled
...
SparseExpanderRegistry* SparseExpanderRegistry::Global() {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc mht_0(mht_0_v, 199, "", "./tensorflow/dtensor/mlir/sparse_expander.cc", "SparseExpanderRegistry::Global");
...
SparseExpanderBase* SparseExpanderRegistry::GetSparseExpansionFnForOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc mht_1(mht_1_v, 208, "", "./tensorflow/dtensor/mlir/sparse_expander.cc", "SparseExpanderRegistry::GetSparseExpansionFnForOp");
...
InitOnStartupMarker SparseExpanderRegistry::RegisterSparseExpansionFn(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc mht_2(mht_2_v, 220, "", "./tensorflow/dtensor/mlir/sparse_expander.cc", "SparseExpanderRegistry::RegisterSparseExpansionFn");
...
Status RunSparseExpansion(mlir::Operation* op, mlir::Operation** output) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expanderDTcc mht_3(mht_3_v, 230, "", "./tensorflow/dtensor/mlir/sparse_expander.cc", "RunSparseExpansion");
