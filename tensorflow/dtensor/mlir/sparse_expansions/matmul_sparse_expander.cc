...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expansionsPSmatmul_sparse_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expansionsPSmatmul_sparse_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expansionsPSmatmul_sparse_expanderDTcc() {
      // Check if tracing is enabled
...
StatusOr<mlir::Operation*> MatMulSparseExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSsparse_expansionsPSmatmul_sparse_expanderDTcc mht_0(mht_0_v, 194, "", "./tensorflow/dtensor/mlir/sparse_expansions/matmul_sparse_expander.cc", "MatMulSparseExpander::ExpandOp");
