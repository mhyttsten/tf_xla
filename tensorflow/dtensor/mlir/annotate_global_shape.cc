...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSannotate_global_shapeDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSannotate_global_shapeDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSannotate_global_shapeDTcc() {
      // Check if tracing is enabled
...
void AnnotateFunctionArgRetvalGlobalShapes(mlir::func::FuncOp function,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSannotate_global_shapeDTcc mht_0(mht_0_v, 210, "", "./tensorflow/dtensor/mlir/annotate_global_shape.cc", "AnnotateFunctionArgRetvalGlobalShapes");
...
void AnnotateOperationGlobalShape(mlir::Operation* op,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSannotate_global_shapeDTcc mht_1(mht_1_v, 248, "", "./tensorflow/dtensor/mlir/annotate_global_shape.cc", "AnnotateOperationGlobalShape");
...
struct DTensorAnnotateGlobalShape
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSannotate_global_shapeDTcc mht_2(mht_2_v, 267, "", "./tensorflow/dtensor/mlir/annotate_global_shape.cc", "runOnOperation");
