...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc() {
      // Check if tracing is enabled
...
void AddMetadataToTPUCluster(const Mesh& mesh_config,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc mht_0(mht_0_v, 227, "", "./tensorflow/dtensor/mlir/tpu_integration.cc", "AddMetadataToTPUCluster");
...
void IdentifyTPUFunctions(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc mht_1(mht_1_v, 248, "", "./tensorflow/dtensor/mlir/tpu_integration.cc", "IdentifyTPUFunctions");
...
mlir::LogicalResult CreateTPUCluster(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc mht_2(mht_2_v, 275, "", "./tensorflow/dtensor/mlir/tpu_integration.cc", "CreateTPUCluster");
...
struct DTensorTPUIntegration
  ...
  void getDependentDialects(mlir::DialectRegistry& registry) const override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc mht_3(mht_3_v, 309, "", "./tensorflow/dtensor/mlir/tpu_integration.cc", "getDependentDialects");
  ...
  void runOnOperation() override {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPStpu_integrationDTcc mht_4(mht_4_v, 317, "", "./tensorflow/dtensor/mlir/tpu_integration.cc", "runOnOperation");
