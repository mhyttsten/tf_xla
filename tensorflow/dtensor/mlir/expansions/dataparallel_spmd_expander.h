...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTh() {
      // Check if tracing is enabled
...
class DataparallelSPMDExpander : public SPMDExpanderBase {
 ...
 public:
  explicit DataparallelSPMDExpander(llvm::DenseMap<int, int> batchable_operands,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTh mht_0(mht_0_v, 222, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.h", "DataparallelSPMDExpander");
}
