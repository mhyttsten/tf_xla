...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSreplicated_spmd_expanderDTh {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSreplicated_spmd_expanderDTh(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSreplicated_spmd_expanderDTh() {
      // Check if tracing is enabled
...
class ReplicatedOpSPMDExpander : public SPMDExpanderBase {
 ...
 public:
  explicit ReplicatedOpSPMDExpander(bool relayout_when_sharded = false) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSreplicated_spmd_expanderDTh mht_0(mht_0_v, 220, "", "./tensorflow/dtensor/mlir/expansions/replicated_spmd_expander.h", "ReplicatedOpSPMDExpander");
