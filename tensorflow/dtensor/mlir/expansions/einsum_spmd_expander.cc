...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
bool Equal(const ShardingSpec& a, const ShardingSpec& b) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc mht_0(mht_0_v, 204, "", "./tensorflow/dtensor/mlir/expansions/einsum_spmd_expander.cc", "Equal");
...
StatusOr<mlir::Operation*> EinsumSPMDExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc mht_1(mht_1_v, 215, "", "./tensorflow/dtensor/mlir/expansions/einsum_spmd_expander.cc", "EinsumSPMDExpander::ExpandOp");
...
Status ExtractEquationRelations(
   ...
   mht_2_v.push_back("equation: \"" + std::string(equation.data(), equation.size()) + "\"");
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc mht_2(mht_2_v, 274, "", "./tensorflow/dtensor/mlir/expansions/einsum_spmd_expander.cc", "ExtractEquationRelations");
...
Status EinsumSPMDExpander::MaybeRelayoutInputs(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSeinsum_spmd_expanderDTcc mht_3(mht_3_v, 569, "", "./tensorflow/dtensor/mlir/expansions/einsum_spmd_expander.cc", "EinsumSPMDExpander::MaybeRelayoutInputs");
