...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSconv_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSconv_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSconv_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
Status VerifyConv2DLayout(const Layout& input_layout,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSconv_spmd_expanderDTcc mht_0(mht_0_v, 213, "", "./tensorflow/dtensor/mlir/expansions/conv_spmd_expander.cc", "VerifyConv2DLayout");
...
StatusOr<mlir::Operation*> ConvSPMDExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSconv_spmd_expanderDTcc mht_1(mht_1_v, 390, "", "./tensorflow/dtensor/mlir/expansions/conv_spmd_expander.cc", "ConvSPMDExpander::ExpandOp");
