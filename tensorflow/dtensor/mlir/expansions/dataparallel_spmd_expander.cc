...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
bool AllReplicated(const std::vector<Layout>& layouts) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc mht_0(mht_0_v, 219, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.cc", "AllReplicated");
...
bool AllBatchParallel(const std::vector<Layout>& layouts,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc mht_1(mht_1_v, 231, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.cc", "AllBatchParallel");
...
bool SameBatchRank(const std::vector<Layout>& layouts,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc mht_2(mht_2_v, 242, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.cc", "SameBatchRank");
...
bool AnyLayoutExist(const llvm::DenseMap<int, Layout>& layouts,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc mht_3(mht_3_v, 258, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.cc", "AnyLayoutExist");
...
StatusOr<mlir::Operation*> DataparallelSPMDExpander::RelayoutOperandsAndOutputs(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc mht_4(mht_4_v, 389, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.cc", "DataparallelSPMDExpander::RelayoutOperandsAndOutputs");
...
StatusOr<mlir::Operation*> DataparallelSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdataparallel_spmd_expanderDTcc mht_5(mht_5_v, 464, "", "./tensorflow/dtensor/mlir/expansions/dataparallel_spmd_expander.cc", "DataparallelSPMDExpander::ExpandOp");
