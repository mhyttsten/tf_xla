...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSidentity_n_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSidentity_n_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSidentity_n_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
StatusOr<mlir::Operation*> IdentityNSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSidentity_n_spmd_expanderDTcc mht_0(mht_0_v, 196, "", "./tensorflow/dtensor/mlir/expansions/identity_n_spmd_expander.cc", "IdentityNSPMDExpander::ExpandOp");
