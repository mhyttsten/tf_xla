...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
Status ComputeExpAndSum(mlir::OpBuilder& builder, const mlir::Value& logits,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_0(mht_0_v, 274, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "ComputeExpAndSum");
...
mlir::Value ComputeSoftmax(mlir::OpBuilder& builder,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_1(mht_1_v, 316, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "ComputeSoftmax");
...
mlir::Value ComputeLogSoftmax(mlir::OpBuilder& builder,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_2(mht_2_v, 330, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "ComputeLogSoftmax");
...
StatusOr<mlir::Operation*> SoftmaxOpSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_3(mht_3_v, 501, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "SoftmaxOpSPMDExpander::ExpandOp");
...
StatusOr<Layout> SoftmaxLossOpSPMDExpander::MaybeRelayoutInputs(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_4(mht_4_v, 556, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "SoftmaxLossOpSPMDExpander::MaybeRelayoutInputs");
...
StatusOr<mlir::Operation*> SoftmaxLossOpSPMDExpander::MaybeRelayoutOutputs(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_5(mht_5_v, 654, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "SoftmaxLossOpSPMDExpander::MaybeRelayoutOutputs");
...
StatusOr<mlir::Operation*> SoftmaxLossOpSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsoftmax_spmd_expanderDTcc mht_6(mht_6_v, 699, "", "./tensorflow/dtensor/mlir/expansions/softmax_spmd_expander.cc", "SoftmaxLossOpSPMDExpander::ExpandOp");
