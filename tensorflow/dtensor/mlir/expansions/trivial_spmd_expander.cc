...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStrivial_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStrivial_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStrivial_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
StatusOr<mlir::Operation*> TerminatorSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStrivial_spmd_expanderDTcc mht_0(mht_0_v, 204, "", "./tensorflow/dtensor/mlir/expansions/trivial_spmd_expander.cc", "TerminatorSPMDExpander::ExpandOp");
...
StatusOr<mlir::Operation*> MetadataSPMDExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStrivial_spmd_expanderDTcc mht_1(mht_1_v, 221, "", "./tensorflow/dtensor/mlir/expansions/trivial_spmd_expander.cc", "MetadataSPMDExpander::ExpandOp");
