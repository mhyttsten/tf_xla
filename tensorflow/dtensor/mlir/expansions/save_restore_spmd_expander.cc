...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsave_restore_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsave_restore_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsave_restore_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
mlir::Value DeviceIdToLocalBranchIndex(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsave_restore_spmd_expanderDTcc mht_0(mht_0_v, 255, "", "./tensorflow/dtensor/mlir/expansions/save_restore_spmd_expander.cc", "DeviceIdToLocalBranchIndex");
...
StatusOr<mlir::Operation*> SaveRestoreSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSsave_restore_spmd_expanderDTcc mht_1(mht_1_v, 815, "", "./tensorflow/dtensor/mlir/expansions/save_restore_spmd_expander.cc", "SaveRestoreSPMDExpander::ExpandOp");
