...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
Status ValidateSendRecvLayoutConfiguration(mlir::TF::DTensorSend dtensor_send,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc mht_0(mht_0_v, 229, "", "./tensorflow/dtensor/mlir/expansions/dtensor_op_spmd_expander.cc", "ValidateSendRecvLayoutConfiguration");
...
bool SendRecvOpUsesXla(const Mesh& send_mesh, const Mesh& recv_mesh) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc mht_1(mht_1_v, 295, "", "./tensorflow/dtensor/mlir/expansions/dtensor_op_spmd_expander.cc", "SendRecvOpUsesXla");
...
StatusOr<mlir::Operation*> RelayoutSPMDExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc mht_2(mht_2_v, 349, "", "./tensorflow/dtensor/mlir/expansions/dtensor_op_spmd_expander.cc", "RelayoutSPMDExpander::ExpandOp");
...
bool IsOneToOneHostMeshTransfer(const Layout& send_layout,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc mht_3(mht_3_v, 417, "", "./tensorflow/dtensor/mlir/expansions/dtensor_op_spmd_expander.cc", "IsOneToOneHostMeshTransfer");
...
StatusOr<mlir::Operation*> DTensorSendSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc mht_4(mht_4_v, 447, "", "./tensorflow/dtensor/mlir/expansions/dtensor_op_spmd_expander.cc", "DTensorSendSPMDExpander::ExpandOp");
...
StatusOr<mlir::Operation*> DTensorRecvSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSdtensor_op_spmd_expanderDTcc mht_5(mht_5_v, 572, "", "./tensorflow/dtensor/mlir/expansions/dtensor_op_spmd_expander.cc", "DTensorRecvSPMDExpander::ExpandOp");
