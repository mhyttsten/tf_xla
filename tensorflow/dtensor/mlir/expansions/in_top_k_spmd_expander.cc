...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSin_top_k_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSin_top_k_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSin_top_k_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
StatusOr<mlir::Operation*> InTopKSPMDExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSin_top_k_spmd_expanderDTcc mht_0(mht_0_v, 229, "", "./tensorflow/dtensor/mlir/expansions/in_top_k_spmd_expander.cc", "InTopKSPMDExpander::ExpandOp");
