...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
Status GetSliceOpArguments(mlir::TF::SliceOp slice_op,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_0(mht_0_v, 212, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "GetSliceOpArguments");
...
Status GetInputOrientedData(T strided_slice,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_1(mht_1_v, 313, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "GetInputOrientedData");
...
mlir::Value IntConstWithMatchingType(mlir::OpBuilder& builder,
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_2(mht_2_v, 613, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "IntConstWithMatchingType");
...
StatusOr<mlir::Operation*> SliceSPMDExpander::ExpandOp(mlir::Operation* op) {
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_3(mht_3_v, 627, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "SliceSPMDExpander::ExpandOp");
...
StatusOr<mlir::Operation*> StridedSliceSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_4(mht_4_v, 762, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "StridedSliceSPMDExpander::ExpandOp");
...
StatusOr<mlir::Operation*> TensorStridedSliceUpdateSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_5(mht_5_v, 894, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "TensorStridedSliceUpdateSPMDExpander::ExpandOp");
...
StatusOr<mlir::Operation*> StridedSliceGradSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPSslice_spmd_expanderDTcc mht_6(mht_6_v, 1047, "", "./tensorflow/dtensor/mlir/expansions/slice_spmd_expander.cc", "StridedSliceGradSPMDExpander::ExpandOp");
