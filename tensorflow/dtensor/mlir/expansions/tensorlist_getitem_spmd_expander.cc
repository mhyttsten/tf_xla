...
#include <stdlib.h>
#include <unistd.h>
class MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStensorlist_getitem_spmd_expanderDTcc {
public:
   std::string _s;
   int _indent = 0;
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStensorlist_getitem_spmd_expanderDTcc(std::vector<std::string> params, int lineNumber, std::string prefix, std::string fileName, std::string functionName) {
   ...
   ~MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStensorlist_getitem_spmd_expanderDTcc() {
      // Check if tracing is enabled
...
StatusOr<mlir::Operation*> TensorListGetItemSPMDExpander::ExpandOp(
   ...
   MHTracer_DTPStensorflowPSdtensorPSmlirPSexpansionsPStensorlist_getitem_spmd_expanderDTcc mht_0(mht_0_v, 195, "", "./tensorflow/dtensor/mlir/expansions/tensorlist_getitem_spmd_expander.cc", "TensorListGetItemSPMDExpander::ExpandOp");
